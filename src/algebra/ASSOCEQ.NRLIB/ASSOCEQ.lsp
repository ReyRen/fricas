...
(SDEFUN |ASSOCEQ;makeMatrix|
        ...
        (SPROG ((#1=#:G387 NIL) (|i| NIL) (#2=#:G386 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |ASSOCEQ;associatedSystem;LPiR;2|
        ...
        (SPROG
         ((|u| (|Union| S #1="failed")) (#2=#:G409 NIL) (#3=#:G404 NIL)
          (#4=#:G424 NIL) (|j| NIL) (#5=#:G397 NIL) (#6=#:G423 NIL) (|k| NIL)
          (|wi| (S)) (|eq| (|Vector| R)) (#7=#:G422 NIL) (|i| NIL)
          (|a| (|Vector| R)) (#8=#:G393 NIL) (#9=#:G421 NIL) (#10=#:G420 NIL)
          (|an| (R)) (|m1| (|PositiveInteger|)) (#11=#:G391 NIL)
...
(SDEFUN |ASSOCEQ;uncouplingMatrices;MV;3|
        ...
        (SPROG
         ((#2=#:G431 NIL) (#3=#:G433 NIL) (|i| NIL) (#4=#:G432 NIL) (|mi| #1#)
          (#5=#:G430 NIL) (|v| (|Vector| (|Matrix| R)))
...
(SDEFUN |ASSOCEQ;makeeq|
        ((|v| |Vector| (|List| (|PositiveInteger|))) (|m| |Matrix| R)
         ...
         ($ |Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
          ...
          (|:| |ops| (|List| L))))
        (SPROG
         ((#1=#:G441 NIL) (|j| NIL) (#2=#:G440 NIL) (#3=#:G439 NIL)
          (#4=#:G438 NIL))
         (SEQ
           ...
           (|Join| (|Finite|)
                   (CATEGORY |domain|
                    ...
                    (SIGNATURE |delta|
                     ((|NonNegativeInteger|) $ (|PositiveInteger|)
                      (|PositiveInteger|))))))
          (#3=#:G446 NIL) (|v| (|Union| (|Matrix| R) "failed"))
...
(SDEFUN |ASSOCEQ;computeIt|
        ((|op| L) (|m| |PositiveInteger|) (|k| |NonNegativeInteger|)
         ($ |Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
          ...
          (|:| |ops| (|List| L))))
        (SPROG
         ((#1=#:G463 NIL) (#2=#:G464 NIL) (|u| (|Union| (|Matrix| R) "failed"))
          (#3=#:G465 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (|a| (|Vector| (|Matrix| R)))
          (|rec|
           (|Record| (|:| |mat| (|Matrix| R))
                     (|:| |vec| (|Vector| (|List| (|PositiveInteger|)))))))
...
(DEFUN |AssociatedEquations| (&REST #1=#:G470)
  (SPROG NIL
         (PROG (#2=#:G471)
           (RETURN
            (COND
