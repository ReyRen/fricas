                                    ...
                                    (|Record| (|:| |k| (|NonNegativeInteger|))
                                              (|:| |c|
                                                   (|SparseMultivariatePolynomial|
                                                    R |VarSet1|))))))))
          (#3=#:G407 NIL) (|t0| NIL) (|pu1| #1#) (#4=#:G406 NIL)
...
(SDEFUN |SMPCOER;find_var|
        ...
        (SPROG ((#1=#:G413 NIL) (#2=#:G414 NIL) (|y| NIL))
               (SEQ
                (EXIT
                 (SEQ
         ...
         ((|pl2|
           (|List|
            (|Record| (|:| |elt1| |VarSet1|)
                      (|:| |elt2|
                           (|SparseMultivariatePolynomial| R |VarSet2|)))))
          (#1=#:G444 NIL) (|el1| NIL) (#2=#:G445 NIL) (|el2| NIL)
          (#3=#:G443 NIL) (#4=#:G442 NIL) (|x| NIL) (#5=#:G441 NIL)
          (#6=#:G440 NIL) (#7=#:G439 NIL)
          (|pl|
           (|List| (|Record| (|:| |elt1| |VarSet1|) (|:| |elt2| |VarSet2|))))
          (#8=#:G437 NIL) (#9=#:G438 NIL) (#10=#:G436 NIL)
...
(DEFUN |SparsePolynomialCoercionHelpers| (&REST #1=#:G446)
  (SPROG NIL
         (PROG (#2=#:G447)
           (RETURN
            (COND
