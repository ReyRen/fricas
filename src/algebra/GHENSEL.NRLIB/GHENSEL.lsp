...
(SDEFUN |GHENSEL;GenExEuclid|
        ...
        (SPROG
         ((#1=#:G437 NIL) (|clp| NIL) (#2=#:G438 NIL) (|flp| NIL)
          (#3=#:G436 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |GHENSEL;genFact|
        ((|fln| |List| TP) (|factlist| |List| (|List| TP))
         ($ |List| (|List| TP)))
        (SPROG
         ((|auxfl| (|List| (|List| TP))) (#1=#:G509 NIL)
          (#2=#:G508 #3=(|NonNegativeInteger|)) (#4=#:G510 #3#) (#5=#:G524 NIL)
          (|f| NIL) (#6=#:G523 NIL) (|term| NIL) (|dp| #3#) (#7=#:G522 NIL)
          (#8=#:G521 NIL) (#9=#:G520 NIL) (|poly| NIL)
          (|maxd| (|NonNegativeInteger|)) (#10=#:G480 NIL) (#11=#:G479 #3#)
          (#12=#:G481 #3#) (#13=#:G519 NIL) (#14=#:G518 NIL) (|pol| NIL)
          (#15=#:G517 NIL))
         (SEQ
          (COND
...
(SDEFUN |GHENSEL;HenselLift1|
        ...
        (SPROG
         ((#1=#:G534 NIL) (|flp| NIL) (#2=#:G535 NIL) (|vlp| NIL)
          (#3=#:G533 NIL) (|vl| (|List| FP)) (|lcinv| (FP)) (|rhs| (FP))
          (#4=#:G526 NIL) (#5=#:G525 (TP)) (#6=#:G527 (TP)) (#7=#:G532 NIL)
          (#8=#:G382 NIL) (|lcp| (RP)))
...
(SDEFUN |GHENSEL;HenselLift;TPLRPPiR;10|
        ...
        (SPROG
         ((|fln| (|List| TP)) (|Modulus| (RP)) (#1=#:G569 NIL) (|err| (TP))
          (#2=#:G560 NIL) (#3=#:G559 (TP)) (#4=#:G561 (TP)) (#5=#:G574 NIL)
          (#6=#:G383 NIL) (|nfln| (|List| TP)) (|lcinv| (RP)) (#7=#:G573 NIL)
          (|ffl1| NIL) (#8=#:G572 NIL) (|cl1| (|List| FP)) (#9=#:G541 NIL)
          (|fl1| (|List| FP)) (#10=#:G571 NIL) (|ttl| NIL) (#11=#:G570 NIL)
          (|constp| (TP)))
                       ...
                       ((SPADCALL |fln| |nfln| (QREFELT $ 55))
                        (COND
                         ((SPADCALL
                           ...
                           (QREFELT $ 56))
                          (EXIT
                           (PROGN (LETT #1# |$NoValue|) (GO #12=#:G564)))))))
                      (LETT |fln| |nfln|)
                      (EXIT
                       (LETT |Modulus|
...
(SDEFUN |GHENSEL;completeHensel;TPLRPPiL;11|
        ...
        (SPROG
         ((|finallist| (|List| TP)) (|factlist| (|List| #1=(|List| TP)))
          (|fln| #2=(|List| TP)) (#3=#:G603 NIL) (|term| NIL) (#4=#:G602 NIL)
          (|auxfl| (|List| #1#)) (#5=#:G601 NIL) (#6=#:G600 NIL)
          (|aux| (|List| TP)) (#7=#:G599 NIL) (|poly| (TP))
          (|dfn| #8=(|NonNegativeInteger|)) (|mm| (TP)) (|lcm1| (RP))
          (|poly1| (TP)) (|u| (|Union| TP "failed")) (|pol| (TP))
          (#9=#:G580 NIL) (#10=#:G579 (TP)) (#11=#:G581 (TP)) (#12=#:G598 NIL)
          (|tc| (RP)) (#13=#:G577 NIL) (#14=#:G576 (RP)) (#15=#:G578 (RP))
          (#16=#:G597 NIL) (|auxl| (|List| TP)) (|nm| #8#) (|Modulus| (RP))
...
(DEFUN |GeneralHenselPackage| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
