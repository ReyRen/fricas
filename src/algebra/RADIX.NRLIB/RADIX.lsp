...
(SDEFUN |RADIX;wholePart;$I;23| ((|a| $) ($ |Integer|))
        (SPROG ((|n0| (|Integer|)) (#1=#:G462 NIL) (|r| NIL))
               (SEQ (LETT |n0| 0)
...
(SDEFUN |RADIX;fractionPart;$F;24| ((|a| $) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|d| (|Integer|)) (|n| (|Integer|)) (|n1| (|Integer|))
          (#1=#:G469 NIL) (|r| NIL) (|n0| (|Integer|)) (#2=#:G468 NIL))
         (SEQ (LETT |n0| 0)
...
(SDEFUN |RADIX;intgroup| ((|li| |List| (|Integer|)) ($ |OutputForm|))
        (SPROG
         ((#1=#:G497 NIL) (|i| NIL) (#2=#:G496 NIL) (#3=#:G495 NIL)
          (#4=#:G494 NIL) (#5=#:G493 NIL) (#6=#:G492 NIL))
         (SEQ
         ...
         ((|rits|
           (|List|
            #1=(|Record| (|:| |quotient| (|Integer|))
                         (|:| |remainder| (|Integer|)))))
          (|ritscyc| (|List| (|Integer|))) (#2=#:G538 NIL) (|i| (|Integer|))
          (|ritspfx| (|List| (|Integer|))) (#3=#:G537 NIL) (|c| (|Integer|))
          (|cfound| (|Boolean|))
          (|ritsn|
           #4=(|List|
               (|Record| (|:| |quotient| (|Integer|))
          ...
          (|rn|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#6=#:G535 NIL) (|p| #7=(|Integer|)) (|ritsi| #4#) (#8=#:G534 NIL)
          (|n| #7#) (|qr2i| #1#) (|qrt| #1#) (|qr1i| #1#) (#9=#:G533 NIL)
          (|qr| #1#))
         (SEQ (LETT |qr| (DIVIDE2 (* |bas| |num|) |den|)) (LETT |i| 0)
              ...
              (SEQ (LETT #9# NIL) G190 (COND (#9# (GO G191)))
                   (SEQ (LETT |qr1i| (DIVIDE2 (* |bas| (QCDR |qr1i|)) |den|))
                        ...
                        (EXIT (LETT |i| (+ |i| 1))))
                   (LETT #9# (SPADCALL |qr1i| |qr2i| (QREFELT $ 82))) (GO G190)
                   G191 (EXIT NIL))
...
(DEFUN |RadixExpansion;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G565 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|QuotientFieldCategory| 23) (|Field|) (|EuclideanDomain|)
                 ...
                 (|PatternMatchable| 23) (|Patternable| 23) (|CommutativeStar|)
                 (|SetCategory|) (|RealConstant|) (|Evalable| 23) (|Type|)
                 (|RetractableTo| 23) (|canonicalsClosed|)
                 (|canonicalUnitNormal|) (|noZeroDivisors|) (|TwoSidedRecip|)
                 (|unitsKnown|) (|BasicType|) (|CoercibleTo| 65)
                 (|RetractableTo| 92) (|ConvertibleTo| 87)
                 (|ConvertibleTo| 105) (|ConvertibleTo| 104) (|PartialOrder|)
                 (|RetractableTo| 16) (|InnerEvalable| 92 23)
                 (|InnerEvalable| 23 23) (|Eltable| 23 $$) (|ConvertibleTo| 88)
                 (|ConvertibleTo| 89))
