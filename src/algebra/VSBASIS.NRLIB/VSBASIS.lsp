...
(SDEFUN |VSBASIS;column2matrix| ((|Lv| |List| (|Vector| R)) ($ |Matrix| R))
        (SPROG
         ((#1=#:G403 NIL) (|k| NIL) (#2=#:G404 NIL) (|v| NIL) (M (|Matrix| R))
...
(SDEFUN |VSBASIS;subVector|
        ...
        (SPROG ((#1=#:G418 NIL) (|k| NIL) (|vv| (|Vector| R)) (#2=#:G414 NIL))
               (SEQ
                (LETT |vv|
                      (MAKEARR1
                       (PROG1 (LETT #2# (+ (- |b| |a|) 1))
...
(SDEFUN |VSBASIS;linearSum|
        ...
        (SPROG
         ((#1=#:G426 NIL) (|j| NIL) (|t2| (R)) (#2=#:G424 NIL) (|k| NIL)
          (#3=#:G425 NIL) (|v2| NIL) (|vv| (|Vector| R)))
         (SEQ
          (LETT |vv|
...
(SDEFUN |VSBASIS;intBasis0|
        ((|Lv| |List| (|Vector| R)) (|Lw| |List| (|Vector| R)) ($ $))
        (SPROG
         ((#1=#:G443 NIL) (|cc| NIL) (#2=#:G442 NIL)
          (|LcoeffB1| (|List| (|Vector| R))) (#3=#:G441 NIL) (|kv| NIL)
          (#4=#:G440 NIL) (|lker| (|List| (|Vector| R))) (#5=#:G438 NIL)
          (|k| NIL) (#6=#:G439 NIL) (|v| NIL) (#7=#:G436 NIL) (#8=#:G437 NIL)
...
(SDEFUN |VSBASIS;*;3$;20| ((B1 $) (B2 $) ($ $)) (SPADCALL B1 B2 (QREFELT $ 46))) 
...
(SDEFUN |VSBASIS;=;2$B;25| ((B1 $) (B2 $) ($ |Boolean|))
        (SPROG
         ((|rks| #1=(|NonNegativeInteger|)) (#2=#:G465 NIL) (|rk2| #1#)
          (|rk1| #1#))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |VSBASIS;canonicalBasis;Nni$;26| ((|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((L (|List| (|Vector| R))) (|v| (|Vector| R)) (#1=#:G470 NIL)
          (|k| NIL))
         (SEQ (LETT L NIL)
...
(SDEFUN |VSBASIS;complementSpace;L$;27| ((|Lv| |List| (|Vector| R)) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G480 NIL) (|k| NIL)
          (#2=#:G481 NIL) (|v| NIL) (#3=#:G478 NIL) (#4=#:G479 NIL)
...
(SDEFUN |VSBASIS;complementSpace;2$;29| ((B $) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G489 NIL) (|k| NIL)
          (#2=#:G490 NIL) (|v| NIL) (|n| (|NonNegativeInteger|))
