...
(SDEFUN |TRIMAT;UpTriBddDenomInv;MRM;1| ((A M) (|denom| R) ($ M))
        (SPROG
         ((#1=#:G383 NIL) (#2=#:G393 NIL) (#3=#:G392 (R)) (#4=#:G394 (R))
          (#5=#:G403 NIL) (|k| NIL) (#6=#:G402 NIL) (|j| NIL) (#7=#:G401 NIL)
          (|i| NIL) (#8=#:G399 NIL) (#9=#:G400 NIL) (|offset| (|Integer|))
          (AI (M)))
         (SEQ
          (LETT AI
...
(SDEFUN |TRIMAT;LowTriBddDenomInv;MRM;2| ((A M) (|denom| R) ($ M))
        (SPROG
         ((#1=#:G405 NIL) (#2=#:G415 NIL) (#3=#:G414 (R)) (#4=#:G416 (R))
          (#5=#:G425 NIL) (|k| NIL) (#6=#:G424 NIL) (|j| NIL) (#7=#:G423 NIL)
          (|i| NIL) (#8=#:G421 NIL) (#9=#:G422 NIL) (|offset| (|Integer|))
          (AI (M)))
         (SEQ
          (LETT AI
                (SPADCALL (SPADCALL A (QREFELT $ 11))
...
(DEFUN |TriangularMatrixOperations| (&REST #1=#:G426)
  (SPROG NIL
         (PROG (#2=#:G427)
           (RETURN
            (COND
