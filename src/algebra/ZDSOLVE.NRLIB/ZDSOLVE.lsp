...
(SDEFUN |ZDSOLVE;convert;NsmpNsmp;1|
        ...
        (SPROG
         ((|q2|
          ...
          (|iq2|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls2|)))
          (|v2| (|OrderedVariableList| |ls2|)) (#1=#:G411 NIL)
         ...
         ((|toSee|
          ...
          (|lf|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |ls2|))))
          (#5=#:G438 NIL) (|p| NIL) (#6=#:G437 NIL) (|irred?| (|Boolean|)))
         (SEQ (LETT |irred?| NIL)
                      ...
                      (|:| |pols|
                           #1=(|List|
                               (|NewSparseMultivariatePolynomial| R
                                                                  (|OrderedVariableList|
                                                                   |ls2|)))))))
          (#2=#:G485 NIL) (|urcRoot| NIL)
          (|urcRoots| (|List| (|RealClosure| (|Fraction| R))))
          (|urc| (|SparseUnivariatePolynomial| (|RealClosure| (|Fraction| R))))
          (|lv| (|List| (|Symbol|))) (#3=#:G474 NIL)
          (|qrc| (|Polynomial| (|RealClosure| (|Fraction| R)))) (#4=#:G483 NIL)
          (|r| NIL) (#5=#:G484 NIL) (|v| NIL) (|lq2| #1#)
          (|q2|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls2|)))
...
(SDEFUN |ZDSOLVE;realSolve;L3BL;12|
        ((|lp| |List| (|Polynomial| R)) (|info?| |Boolean|)
         ...
         ($ |List| (|List| (|RealClosure| (|Fraction| R)))))
        (SPROG
         ((#1=#:G507 NIL) (|prc| (|Polynomial| (|RealClosure| (|Fraction| R))))
          (#2=#:G518 NIL) (|rr| NIL) (#3=#:G519 NIL) (|symb| NIL)
          (#4=#:G517 NIL) (|realsol| NIL) (#5=#:G516 NIL) (|p| NIL)
          (|toSee|
           (|List|
            (|Record| (|:| |reals| (|List| (|RealClosure| (|Fraction| R))))
                      (|:| |vars| (|List| (|Symbol|)))
                      (|:| |pols|
                           #6=(|List|
                               (|NewSparseMultivariatePolynomial| R
                                                                  (|OrderedVariableList|
                                                                   |ls2|)))))))
          (#7=#:G515 NIL) (|urcRoot| NIL)
          (|urcRoots| (|List| (|RealClosure| (|Fraction| R))))
          (|urc| (|SparseUnivariatePolynomial| (|RealClosure| (|Fraction| R))))
          (|lv| (|List| (|Symbol|))) (#8=#:G496 NIL)
          (|qrc| (|Polynomial| (|RealClosure| (|Fraction| R)))) (#9=#:G513 NIL)
          (|r| NIL) (#10=#:G514 NIL) (|v| NIL) (|lq2| #6#)
          (|q2|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls2|)))
          (|toSave| (|List| (|List| (|RealClosure| (|Fraction| R)))))
          (|lr| (|List| (|RealClosure| (|Fraction| R))))
                     ...
                     (|:| |pols|
                          (|List|
                           (|NewSparseMultivariatePolynomial| R
                                                              (|OrderedVariableList|
                                                               |ls2|))))))
          (#11=#:G512 NIL) (|sts| NIL) (#12=#:G511 NIL)
          (|lsts|
           (|List|
            (|SquareFreeRegularTriangularSet| R
                                              (|IndexedExponents|
                                              ...
                                              (|NewSparseMultivariatePolynomial|
                                               ...
                                               (|OrderedVariableList|
                                                |ls2|)))))
          (#13=#:G510 NIL) (|ts| NIL) (|lts| (|List| (|RegularChain| R |ls|)))
          (|lq|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |ls|))))
          (#14=#:G509 NIL) (#15=#:G508 NIL))
         (SEQ
          (LETT |lq|
                (PROGN
                 (LETT #15# NIL)
                      ...
                      (|:| |pols|
                           #1=(|List|
                               (|NewSparseMultivariatePolynomial| R
                                                                  (|OrderedVariableList|
                                                                   |ls2|)))))))
          (#2=#:G543 NIL) (|urcRoot| NIL)
          (|urcRoots| (|List| (|RealClosure| (|Fraction| R))))
          (|urc| (|SparseUnivariatePolynomial| (|RealClosure| (|Fraction| R))))
          (|lv| (|List| (|Symbol|))) (#3=#:G531 NIL)
          (|qrc| (|Polynomial| (|RealClosure| (|Fraction| R)))) (#4=#:G541 NIL)
          (|r| NIL) (#5=#:G542 NIL) (|v| NIL) (|lq2| #1#)
          (|q2|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls2|)))
          (|toSave| (|List| (|List| (|RealClosure| (|Fraction| R)))))
          (|lr| (|List| (|RealClosure| (|Fraction| R))))
                      ...
                      (|:| |pols|
                           #1=(|List|
                               (|NewSparseMultivariatePolynomial| R
                                                                  (|OrderedVariableList|
                                                                   |ls2|)))))))
          (#2=#:G569 NIL) (|urcRoot| NIL)
          (|urcRoots| (|List| (|RealClosure| (|Fraction| R))))
          (|urc| (|SparseUnivariatePolynomial| (|RealClosure| (|Fraction| R))))
          (|lv| (|List| (|Symbol|))) (#3=#:G554 NIL)
          (|qrc| (|Polynomial| (|RealClosure| (|Fraction| R)))) (#4=#:G567 NIL)
          (|r| NIL) (#5=#:G568 NIL) (|v| NIL) (|lq2| #1#)
          (|q2|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls2|)))
          (|toSave| (|List| (|List| (|RealClosure| (|Fraction| R)))))
          (|lr| (|List| (|RealClosure| (|Fraction| R))))
           ...
           (|List|
            (|SquareFreeRegularTriangularSet| R
                                              ...
                                              (|NewSparseMultivariatePolynomial|
                                               ...
                                               (|OrderedVariableList|
                                                |ls2|)))))
          (#8=#:G564 NIL) (|ts| NIL) (|lts| (|List| (|RegularChain| R |ls|)))
          (|lq|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |ls|))))
          (#9=#:G563 NIL) (|p| NIL) (#10=#:G562 NIL))
         (SEQ
          (LETT |lq|
                (PROGN
                 (LETT #10# NIL)
        ...
        (SPROG
         ((|toSave|
           (|List|
            (|Record| (|:| |complexRoots| (|SparseUnivariatePolynomial| R))
                      (|:| |coordinates| (|List| (|Polynomial| R))))))
          (|lc| (|List| (|Polynomial| R))) (#1=#:G588 NIL) (|q2| NIL)
          (#2=#:G587 NIL) (|g| (|SparseUnivariatePolynomial| R))
          (#3=#:G574 NIL) (#4=#:G586 NIL) (|us| NIL)
          (|lus|
           (|List|
            (|SquareFreeRegularTriangularSet| R
                                              (|IndexedExponents|
        ...
        (SPROG
         ((|toSave|
           (|List|
            (|Record| (|:| |complexRoots| (|SparseUnivariatePolynomial| R))
                      (|:| |coordinates| (|List| (|Polynomial| R))))))
          (|lc| (|List| (|Polynomial| R))) (#1=#:G626 NIL) (|q2| NIL)
          (#2=#:G625 NIL) (|g| (|SparseUnivariatePolynomial| R))
          (#3=#:G606 NIL) (#4=#:G615 NIL)
          (|rems|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |ls2|))))
          (#5=#:G624 NIL) (#6=#:G623 NIL) (#7=#:G622 NIL) (|us| NIL)
          (|lus|
           (|List|
            (|SquareFreeRegularTriangularSet| R
                                              (|IndexedExponents|
           ...
           (|List|
            (|SquareFreeRegularTriangularSet| R
                                              ...
                                              (|NewSparseMultivariatePolynomial|
                                               ...
                                               (|OrderedVariableList|
                                                |ls2|)))))
          (#11=#:G618 NIL) (|ts| NIL) (|lts| (|List| (|RegularChain| R |ls|)))
          (|lq|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |ls|))))
          (#12=#:G617 NIL) (#13=#:G616 NIL))
         (SEQ
          (LETT |lq|
                (PROGN
                 (LETT #13# NIL)
...
(DEFUN |ZeroDimensionalSolvePackage| (&REST #1=#:G633)
  (SPROG NIL
         (PROG (#2=#:G634)
           (RETURN
            (COND
...
(DEFUN |ZeroDimensionalSolvePackage;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G411 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
