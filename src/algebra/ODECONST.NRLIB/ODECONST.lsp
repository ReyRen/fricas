...
(SDEFUN |ODECONST;basisSol|
        ((|p| |SparseUnivariatePolynomial| F) (|n| |Integer|) (|x| F)
         ($ |List| F))
        (SPROG
         ((|xn| (F)) (|l| (|List| F)) (#1=#:G409 NIL) (|f| NIL) (#2=#:G408 NIL)
          (#3=#:G407 NIL) (|i| NIL) (|ll| (|List| F)))
...
(SDEFUN |ODECONST;quadSol|
        ((|p| |SparseUnivariatePolynomial| F) (|x| F) ($ |List| F))
        (SPROG
         ((#1=#:G426 NIL) (|a| (F)) (#2=#:G425 NIL) (#3=#:G424 NIL) (|i| (F))
...
(DEFUN |ConstantLODE| (&REST #1=#:G427)
  (SPROG NIL
         (PROG (#2=#:G428)
           (RETURN
            (COND
