...
(SDEFUN |JBLF;coerce;$Of;2| ((|l| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (#1=#:G445 NIL) (|c| NIL) (#2=#:G446 NIL)
          (|jv| NIL))
         (SEQ
...
(SDEFUN |JBLF;retractIfCan;JbeU;12|
        ...
        (SPROG
         ((|resC| (|List| D)) (#1=#:G493 NIL) (|cd| #2=(|Union| D "failed"))
          (#3=#:G494 NIL) (|jv| NIL) (|resJ| (|List| JB)) (|pd| #2#))
         (SEQ
          (EXIT
...
(SDEFUN |JBLF;-;2$;18| ((|l| $) ($ $))
        (SPROG ((#1=#:G507 NIL) (|c| NIL) (#2=#:G506 NIL))
               (SEQ
                (CONS
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |JBLF;+;3$;19| ((|l1| $) (|l2| $) ($ $))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G524 NIL) (|c1| NIL)
          (#2=#:G525 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JBLF;*;I2$;20| ((|i| |Integer|) (|l| $) ($ $))
        (SPROG ((#1=#:G531 NIL) (|c| NIL) (#2=#:G530 NIL))
               (SEQ
...
(SDEFUN |JBLF;*;D2$;21| ((|ex| D) (|l| $) ($ $))
        (SPROG ((#1=#:G537 NIL) (|c| NIL) (#2=#:G536 NIL))
               (SEQ
                (COND ((SPADCALL |ex| (QREFELT $ 31)) (|spadConstant| $ 32))
...
(SDEFUN |JBLF;exquo;2$U;24| ((|l1| $) (|l2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|newC| (|List| D)) (#2=#:G566 NIL) (|e| (|Union| D #1#))
          (#3=#:G567 NIL) (|c| NIL) (|d| (D)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |JBLF;jetVariables;$L;26| ((|l| $) ($ |List| JB))
        (SPROG ((|res| (|List| JB)) (#1=#:G580 NIL) (|c| NIL))
               (SEQ
...
(SDEFUN |JBLF;differentiate;$S$;27| ((|l| $) (|s| |Symbol|) ($ $))
        (SPROG
         ((|resJ| (|List| JB)) (|resC| (|List| D)) (|dc| (D)) (#1=#:G586 NIL)
          (|c| NIL) (#2=#:G587 NIL) (|j| NIL))
...
(SDEFUN |JBLF;differentiate;$JB$;28| ((|l| $) (|jv| JB) ($ $))
        (SPROG
         ((|pos| (|Integer|)) (|resJ| (|List| JB)) (|resC| (|List| D))
          (|dc| (D)) (#1=#:G595 NIL) (|c| NIL) (#2=#:G596 NIL) (|j| NIL)
          (|jt| (|Symbol|)))
         (SEQ (LETT |jt| (SPADCALL |jv| (QREFELT $ 25)))
              (EXIT
               (COND
...
(SDEFUN |JBLF;jacobiMatrix;LSem;29|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G629 NIL) (|co| NIL) (#3=#:G630 NIL)
          (|jv| NIL) (#4=#:G628 NIL) (|cjv| NIL) (|ents| (|List| $))
          (#5=#:G627 NIL) (#6=#:G626 NIL) (#7=#:G625 NIL) (|eq| NIL) (|i| NIL)
          (|res| (|SparseEchelonMatrix| JB $)) (#8=#:G624 NIL) (#9=#:G623 NIL)
          (#10=#:G622 NIL) (|cinds| #1#) (#11=#:G621 NIL) (|inds| #1#)
          (#12=#:G620 NIL))
...
(SDEFUN |JBLF;jacobiMatrix;LLSem;30|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G656 NIL) (|co| NIL) (#3=#:G657 NIL)
          (|jv| NIL) (#4=#:G655 NIL) (|ijv| NIL) (|ivars| (|List| JB))
          (|ents| (|List| $)) (#5=#:G654 NIL) (#6=#:G653 NIL) (#7=#:G651 NIL)
          (|eq| NIL) (#8=#:G652 NIL) (|vars| NIL) (|i| NIL)
...
(SDEFUN |JBLF;freeOf?;$JBB;32| ((|l| $) (|jv| JB) ($ |Boolean|))
        (SPROG ((#1=#:G669 NIL) (|c| NIL) (#2=#:G668 NIL))
               (SEQ
                (COND
...
(SDEFUN |JBLF;solveFor;$JBU;33| ((|l| $) (|jv| JB) ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G683 NIL) (|c| NIL) (#2=#:G682 NIL) (|rc| (|Union| D "failed"))
...
(SDEFUN |JBLF;subst;$JB2$;34| ((|l| $) (|jv| JB) (|exp| $) ($ $))
        (SPROG
         ((|nl| ($)) (|c| (D)) (|pos| (|Integer|)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|nc| (D)) (#1=#:G692 NIL) (#2=#:G693 NIL)
...
(SDEFUN |JBLF;simplify;LSemR;35|
        ...
        (SPROG
         ((|dep| (|List| (|List| (|NonNegativeInteger|))))
          (|depj| (|List| (|NonNegativeInteger|))) (#1=#:G713 NIL)
          (|kb| (|Integer|)) (#2=#:G733 NIL) (|k| NIL) (|rowC| (|List| $))
          (|rowJ| #3=(|List| JB)) (|dCo| (|List| D)) (|dJV| #3#) (|dco| (D))
          (#4=#:G731 NIL) (|co| NIL) (#5=#:G732 NIL) (|jv| NIL) (#6=#:G730 NIL)
          (|cjv| NIL) (|ents| (|List| $)) (#7=#:G729 NIL) (#8=#:G728 NIL)
          (#9=#:G727 NIL) (#10=#:G726 NIL) (#11=#:G725 NIL) (|eq| NIL)
...
(DEFUN |JetBundleLinearFunction| (&REST #1=#:G744)
  (SPROG NIL
         (PROG (#2=#:G745)
           (RETURN
            (COND
