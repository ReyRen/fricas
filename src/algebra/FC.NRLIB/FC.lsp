...
(SDEFUN |FC;getfortarrayexp1|
        ((|name| |Symbol|) (|of| |OutputForm|) (|int_to_floats?| |Boolean|)
         ($ |List| (|String|)))
        (SPROG ((#1=#:G423 NIL) (|l| (|List| (|String|))))
               (SEQ
                (LETT |l|
...
(SDEFUN |FC;addCommas| ((|l| |List| (|Symbol|)) ($ |List| (|String|)))
        (SPROG ((|r| (|List| (|String|))) (#1=#:G437 NIL) (|e| NIL))
               (SEQ
                (COND ((NULL |l|) NIL)
                      ('T
                       (SEQ
...
(SDEFUN |FC;commaSep| ((|l| |List| (|String|)) ($ |List| (|String|)))
        (SPROG
         ((#1=#:G444 NIL) (#2=#:G443 #3=(|List| (|String|))) (#4=#:G445 #3#)
          (#5=#:G447 NIL) (|u| NIL))
         (SEQ
...
(SDEFUN |FC;getPrint| ((|l| |List| (|OutputForm|)) ($ |List| (|String|)))
        (SPROG ((|ll| (|List| (|String|))) (#1=#:G459 NIL) (|i| NIL))
...
(SDEFUN |FC;getBlock| ((|rec| |List| $) ($ |List| (|String|)))
        (SPROG ((|expr| (|List| (|String|))) (#1=#:G463 NIL) (|u| NIL))
...
(SDEFUN |FC;getElseIf| ((|f| $) ($ |List| (|String|)))
        (SPROG
         ((|expr| (|List| (|String|))) (|elseBranch| ($)) (#1=#:G491 NIL)
          (|rec|
...
(SDEFUN |FC;getComment| ((|rec| |List| (|String|)) ($ |List| (|String|)))
        (SPROG ((#1=#:G563 NIL) (|c| NIL) (#2=#:G562 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FC;getCode;$L;36| ((|f| $) ($ |List| (|String|)))
        (SPROG
         ((#1=#:G601 NIL) (#2=#:G602 NIL) (#3=#:G600 NIL) (#4=#:G599 NIL)
          (#5=#:G598 NIL) (#6=#:G597 NIL) (#7=#:G596 NIL) (#8=#:G595 NIL)
          (#9=#:G594 NIL) (#10=#:G593 NIL) (#11=#:G592 NIL) (#12=#:G591 NIL)
          (|rec|
