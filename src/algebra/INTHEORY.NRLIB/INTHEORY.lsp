...
(SDEFUN |INTHEORY;harmonic;IF;1| ((|n| |Integer|) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|h| #1=(|Fraction| (|Integer|))) (#2=#:G411 NIL) (|k| NIL)
          (|s| #3=(|Integer|))
          (|#G3| (|Record| (|:| |Hn| #3#) (|:| |Hv| #1#))))
         (SEQ
          (COND
...
(SDEFUN |INTHEORY;carmichaelLambda;2I;3| ((|n| |Integer|) ($ |Integer|))
        (SPROG ((#1=#:G424 NIL) (|pk| NIL) (#2=#:G423 NIL))
               (SEQ
                (COND
...
(SDEFUN |INTHEORY;euler;2I;4| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((|e| #1=(|Integer|)) (|t| #1#) (#2=#:G438 NIL) (|j| NIL)
          (#3=#:G437 NIL) (|i| NIL) (#4=#:G436 NIL) (#5=#:G426 NIL)
          (|l| (|Integer|)))
         (SEQ
...
(SDEFUN |INTHEORY;bernoulli;IF;5| ((|n| |Integer|) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|b| (|Fraction| (|Integer|))) (|t| (|Integer|)) (#1=#:G452 NIL)
          (|j| NIL) (#2=#:G451 NIL) (|i| NIL) (#3=#:G450 NIL) (#4=#:G440 NIL)
          (|l| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |INTHEORY;jacobi;3I;8| ((|a| |Integer|) (|b| |Integer|) ($ |Integer|))
        (SPROG
         ((|j| (|Integer|)) (|k| NIL) (#1=#:G479 NIL) (|#G40| (|Integer|))
          (|#G39| (|Integer|)))
...
(SDEFUN |INTHEORY;eulerPhi;2I;10| ((|n| |Integer|) ($ |Integer|))
        (SPROG ((|r| (|Fraction| (|Integer|))) (#1=#:G486 NIL) (|entry| NIL))
               (SEQ
                (COND ((EQL |n| 0) 0)
                      ('T
...
(SDEFUN |INTHEORY;divisors;IL;11| ((|n| |Integer|) ($ |List| (|Integer|)))
        (SPROG
         ((|oldList| #1=(|List| (|Integer|))) (|newList| #1#) (#2=#:G497 NIL)
          (|m| NIL) (|pow| (|Integer|)) (#3=#:G496 NIL) (|k| NIL)
          (#4=#:G495 NIL) (|f| NIL))
...
(SDEFUN |INTHEORY;numberOfDivisors;2I;12|
        ((|n| |Integer|) ($ . #1=(|Integer|)))
        (SPROG
         ((#2=#:G500 NIL) (#3=#:G499 #1#) (#4=#:G501 #1#) (#5=#:G503 NIL)
          (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
...
(SDEFUN |INTHEORY;sumOfDivisors;2I;13| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((|r| #1=(|Fraction| (|Integer|))) (#2=#:G506 NIL) (#3=#:G505 #1#)
          (#4=#:G507 #1#) (#5=#:G510 NIL) (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |INTHEORY;sumOfKthPowerDivisors;INniI;14|
        ...
        (SPROG
         ((|r| #1=(|Fraction| (|Integer|))) (#2=#:G513 NIL) (#3=#:G512 #1#)
          (#4=#:G514 #1#) (#5=#:G517 NIL) (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |INTHEORY;moebiusMu;2I;15| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((#1=#:G523 NIL) (#2=#:G524 NIL) (#3=#:G525 NIL) (|k| NIL)
          (|t| (|Factored| (|Integer|))))
         (SEQ
          (EXIT
           (COND ((EQL |n| 1) 1)
