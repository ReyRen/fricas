...
(SDEFUN |LMDICT;coerce;$Of;1| ((|s| $) ($ |OutputForm|))
        (SPROG ((#1=#:G403 NIL) (|x| NIL) (#2=#:G402 NIL))
               (SEQ
...
(SDEFUN |LMDICT;duplicates?;$B;18| ((|s| $) ($ |Boolean|))
        (SPROG ((|q| (|List| S)) (|p| (|List| S)) (#1=#:G440 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LMDICT;duplicates;$L;21|
        ...
        (SPROG
         ((|ld|
           (|List|
            (|Record| (|:| |entry| S) (|:| |count| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G459 NIL) (|x| NIL))
         (SEQ (LETT |ld| NIL)
              (SEQ (LETT |x| NIL)
                   (LETT #1#
                         (SPADCALL (SPADCALL |lmd| (QREFELT $ 12))
...
(DEFUN |ListMultiDictionary| (#1=#:G505)
  (SPROG NIL
         (PROG (#2=#:G506)
           (RETURN
            (COND
...
(DEFUN |ListMultiDictionary;| (|#1|)
  (SPROG
   ((#1=#:G504 NIL) (#2=#:G503 NIL) (|pv$| NIL) (#3=#:G500 NIL) (#4=#:G501 NIL)
    (#5=#:G502 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
