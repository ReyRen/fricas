        ...
        (SPROG
         ((|toReturn|
           (|List|
            (|Record| (|:| |complexRoots| (|SparseUnivariatePolynomial| R))
                      (|:| |coordinates| (|List| (|Polynomial| R))))))
          (|lc| (|List| (|Polynomial| R))) (#1=#:G450 NIL)
          (|q|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |lv|)))
          (#2=#:G449 NIL) (|g| (|SparseUnivariatePolynomial| R))
          (#3=#:G398 NIL) (#4=#:G448 NIL) (|us| NIL) (#5=#:G447 NIL)
          (|lus|
           (|List|
             ...
             (|:| |tower|
                  (|SquareFreeRegularTriangularSet| R
                                                    ...
                                                    (|NewSparseMultivariatePolynomial|
                                                     ...
                                                     (|OrderedVariableList|
                                                      |lv|)))))))
          (#10=#:G442 NIL) (#11=#:G441 NIL) (#12=#:G440 NIL) (|fq| NIL)
          (|lfq|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |lv|))))
               ...
               (COND ((NULL |lp|) (|error| "rur$RURPACK: #1 is empty"))
                     ...
                     ('T
                      (SEQ
                       ...
                       (LETT |toReturn| NIL)
                       (SEQ (LETT |ts| NIL) (LETT #6# |toSave|) G190
                            (COND
...
(DEFUN |RationalUnivariateRepresentationPackage| (&REST #1=#:G455)
  (SPROG NIL
         (PROG (#2=#:G456)
           (RETURN
            (COND
...
(DEFUN |RationalUnivariateRepresentationPackage;| (|#1| |#2|)
  (SPROG
   ((#1=#:G391 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
