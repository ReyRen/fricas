...
(SDEFUN |UTSODE;odeNre|
        ((|f| |Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|)))
         ...
         ($ |List| (|Stream| |Coef|)))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G471 NIL) (|c| NIL)
          (#2=#:G472 NIL) (|y| NIL) (#3=#:G470 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G492 NIL) (|csti| NIL) (#2=#:G493 NIL) (|lsfi| NIL)
          (#3=#:G491 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| |List| |Coef|) (|lsts| |List| (|Mapping| UTS (|List| UTS)))
         ($ |List| UTS))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G504 NIL) (|lst| NIL)
          (#2=#:G503 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G505)
  (SPROG NIL
         (PROG (#2=#:G506)
           (RETURN
            (COND
