...
(SDEFUN |PGE;li1n| ((|n| |Integer|) ($ |List| (|Integer|)))
        (SPROG ((#1=#:G403 NIL) (|i| NIL) (#2=#:G402 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |PGE;youngGroup;LPg;3|
        ...
        (SPROG
         ((|element| (|Integer|))
          (|gens| (|List| (|List| (|List| (|Integer|))))) (#1=#:G412 NIL)
          (|i| NIL) (#2=#:G411 NIL) (#3=#:G410 NIL) (|n| NIL))
...
(SDEFUN |PGE;mathieu11;LPg;6|
        ...
        (SPROG ((|a| (|List| (|List| (|Integer|)))))
               (SEQ (LETT |l| (SPADCALL |l| (QREFELT $ 27)))
                    (EXIT
                     (COND
...
(SDEFUN |PGE;abelianGroup;LPg;18|
        ...
        (SPROG
         ((|element| (|Integer|))
          (|gens| (|List| (|List| (|List| (|Integer|))))) (#1=#:G448 NIL)
          (|i| NIL) (#2=#:G447 NIL) (#3=#:G446 NIL) (|n| NIL))
         (SEQ (LETT |gens| NIL) (LETT |element| 1)
              (SEQ (LETT |n| NIL) (LETT #3# |l|) G190
                   (COND
                    ((OR (ATOM #3#) (PROGN (LETT |n| (CAR #3#)) NIL))
...
(SDEFUN |PGE;alternatingGroup;LPg;19|
        ...
        (SPROG
         ((|gens| (|List| (|List| (|List| #1=(|Integer|)))))
          (|tmp| (|List| #1#)) (#2=#:G457 NIL) (|i| NIL) (#3=#:G456 NIL))
         (SEQ (LETT |l| (SPADCALL |l| (QREFELT $ 27)))
              (EXIT
               (COND
                ((EQL (LENGTH |l|) 0)
...
(SDEFUN |PGE;dihedralGroup;LPg;25|
        ((|l| |List| (|Integer|)) ($ |PermutationGroup| (|Integer|)))
        (SPROG
         ((|tmp| (|List| (|List| (|Integer|)))) (#1=#:G471 NIL) (|i| NIL)
          (#2=#:G470 NIL))
         (SEQ (LETT |l| (SPADCALL |l| (QREFELT $ 27)))
              (EXIT
               (COND
