...
(SDEFUN |TRMANIP;simplifyLog1| ((|e| F) ($ F))
        (SPROG
         ((#1=#:G463 NIL) (#2=#:G462 (F)) (#3=#:G464 (F)) (#4=#:G475 NIL)
          (#5=#:G383 NIL) (|terms| (|List| F)) (|foundLog| (|Boolean|))
          (#6=#:G455 NIL) (#7=#:G454 (F)) (#8=#:G456 (F)) (#9=#:G474 NIL)
          (#10=#:G382 NIL) (|args| (|List| F)) (|i| (|NonNegativeInteger|))
          (|nterms| (|List| F)) (|exprs| (|List| F)) (#11=#:G473 NIL)
          (|term| NIL) (#12=#:G472 NIL) (#13=#:G471 NIL) (#14=#:G470 NIL)
          (|u| NIL) (#15=#:G469 NIL) (|kers| (|List| (|Kernel| F)))
          (|expt|
...
(SDEFUN |TRMANIP;termexp|
        ...
        (SPROG
         ((|coef| (|SparseMultivariatePolynomial| R (|Kernel| F)))
          (#1=#:G498 NIL) (|u| NIL) (#2=#:G497 NIL) (|exponent| (F))
          (|d| (|NonNegativeInteger|)) (#3=#:G496 NIL) (|k| NIL)
...
(SDEFUN |TRMANIP;simplifyExp;2F;48| ((|x| F) ($ F))
        (SPROG
         ((#1=#:G590 NIL) (|term| (F)) (#2=#:G594 NIL) (|k1| NIL)
          (#3=#:G591 NIL) (#4=#:G593 NIL) (|h| (|NonNegativeInteger|))
          (|args| (|List| F)) (|op| (|BasicOperator|)) (#5=#:G592 NIL)
...
(SDEFUN |TRMANIP;htrigs;2F;49| ((|f| F) ($ F))
        (SPROG
         ((|g1| (F)) (|b| (|Integer|)) (|g2| (F)) (|a| (F))
          ...
          (|num| #1#) (|arg| (|List| F)) (#2=#:G604 NIL) (|x| NIL)
          (#3=#:G603 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| F))
...
(SDEFUN |TRMANIP;exlog|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| F)) ($ F))
        (SPROG
         ((#1=#:G615 NIL) (#2=#:G614 (F)) (#3=#:G616 (F)) (#4=#:G618 NIL)
          (|r| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |TRMANIP;logexpand| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G624 NIL) (|x| (F)) (#2=#:G623 NIL) (|op| (|BasicOperator|)))
         (SEQ
          (COND
...
(SDEFUN |TRMANIP;kerexpand| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G645 NIL) (|x| (F)) (#2=#:G644 NIL) (#3=#:G643 NIL)
          (#4=#:G642 NIL) (|ctb| (F)) (|cta| (F)) (|tb| (F)) (|ta| (F))
          (|a| (F)) (|b| (F))
...
(DEFUN |TranscendentalManipulations| (&REST #1=#:G689)
  (SPROG NIL
         (PROG (#2=#:G690)
           (RETURN
            (COND
