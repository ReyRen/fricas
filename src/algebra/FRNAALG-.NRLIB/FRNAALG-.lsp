...
(SDEFUN |FRNAALG-;rank_polynomial|
        ...
        (SPROG
         ((|cijk| (R)) (|mxjk| (|Polynomial| R)) (#1=#:G416 NIL) (|k| NIL)
          (#2=#:G415 NIL) (|j| NIL) (|mo| (|Polynomial| R)) (#3=#:G414 NIL)
          (|i| NIL) (|mx| #4=(|Matrix| (|Polynomial| R))) (|x| #4#)
          (|symbolsForCoef| (|Vector| (|Symbol|))) (#5=#:G411 NIL)
          (#6=#:G413 NIL) (#7=#:G412 NIL) (|listOfNumbers| (|List| (|String|)))
          (#8=#:G410 NIL) (|q| NIL) (#9=#:G409 NIL)
...
(SDEFUN |FRNAALG-;leftUnitsInternal|
        (($ |Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
          (|:| |basis| (|List| (|Vector| R)))))
        (SPROG
         ((#1=#:G428 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#2=#:G427 NIL) (|i| NIL) (#3=#:G426 NIL) (|k| NIL)
...
(SDEFUN |FRNAALG-;rightUnitsInternal|
        (($ |Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
          (|:| |basis| (|List| (|Vector| R)))))
        (SPROG
         ((#1=#:G467 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#2=#:G466 NIL) (|i| NIL) (#3=#:G465 NIL) (|k| NIL)
        ...
        (SPROG
         ((#1=#:G500 NIL)
          (|res|
           (|Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
                     (|:| |basis| (|List| (|Vector| R)))))
          (#2=#:G507 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#3=#:G506 NIL) (|i| NIL) (#4=#:G505 NIL) (|k| NIL) (|u| (|Integer|))
          (|rhs| (|Vector| R)) (|cond| (|Matrix| R))
          (|gamma| (|Vector| (|Matrix| R))) (|b| (|Vector| S))
          (|n| (|PositiveInteger|)))
         (SEQ (LETT |n| (SPADCALL (QREFELT $ 11)))
