...
(SDEFUN |DFSFUN;airyAi;2Df;21| ((|x| |DoubleFloat|) ($ |DoubleFloat|))
        (SPROG
         ((|eta| (|DoubleFloat|)) (|athird| (|DoubleFloat|)) (#1=#:G415 NIL)
          (|ahalf| (|DoubleFloat|)))
         (SEQ
          (LETT |ahalf|
                (PROG2
...
(SDEFUN |DFSFUN;airyAi;2C;22|
        ...
        (SPROG
         ((|eta| (|Complex| (|DoubleFloat|)))
          (|athird| (|Complex| (|DoubleFloat|))) (#1=#:G420 NIL)
          (|ahalf| (|Complex| (|DoubleFloat|))))
         (SEQ
          (LETT |ahalf|
                (PROG2
...
(SDEFUN |DFSFUN;airyBi;2Df;23| ((|x| |DoubleFloat|) ($ |DoubleFloat|))
        (SPROG
         ((|eta| (|DoubleFloat|)) (|athird| (|DoubleFloat|)) (#1=#:G425 NIL)
          (|ahalf| (|DoubleFloat|)))
         (SEQ
          (LETT |ahalf|
                (PROG2
...
(SDEFUN |DFSFUN;airyBi;2C;24|
        ...
        (SPROG
         ((|eta| (|Complex| (|DoubleFloat|)))
          (|athird| (|Complex| (|DoubleFloat|))) (#1=#:G430 NIL)
          (|ahalf| (|Complex| (|DoubleFloat|))))
         (SEQ
          (LETT |ahalf|
                (PROG2
