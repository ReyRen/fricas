...
(SDEFUN |SORD;ordinalAdd;3$;15| ((|o1| $) (|o2| $) ($ $))
        (SPROG
         ((|p2| (|Rep|)) (#1=#:G418 NIL) (|t| NIL) (|p1| (|Rep|))
          (|lt| (|List| |Rep|)) (|e| ($)))
         (SEQ (LETT |p1| |o1|) (LETT |p2| |o2|)
              (LETT |e| (SPADCALL |p2| (QREFELT $ 42)))
              (EXIT
               (COND
                 ...
                 (SEQ (LETT |lt| NIL)
                      (SEQ G190
                           ...
                           (SEQ
                            ...
                            (EXIT (LETT |p1| (SPADCALL |p1| (QREFELT $ 45)))))
                    ...
                    (SEQ G190
                         (COND
                          ((NULL (NOT (SPADCALL |p| (QREFELT $ 31))))
                           (GO G191)))
                         (SEQ (EXIT (LETT |p| (SPADCALL |p| (QREFELT $ 45)))))
                         NIL (GO G190) G191 (EXIT NIL))
...
(SDEFUN |SORD;ordinalMul;3$;18| ((|o1| $) (|o2| $) ($ $))
        (SPROG ((|lo| ($)) (|hi| ($)) (|e| ($)))
               (SEQ (LETT |e| (SPADCALL |o1| (QREFELT $ 42)))
                    (LETT |hi|
                          (COND
               ...
               (SEQ
                (COND
                 ((SPADCALL |o| (QREFELT $ 31))
                  (SEQ (LETT |n| (SPADCALL |o| (QREFELT $ 32)))
                       (EXIT
                        (COND
                         ((EQL |n| 0)
               ...
               (SEQ
                (COND
                 ...
                 ((SPADCALL |o1| (|spadConstant| $ 10) (QREFELT $ 20))
                  (|spadConstant| $ 10))
                 (#1='T
                  (SEQ (LETT |e1| (SPADCALL |o1| (QREFELT $ 42)))
                       (EXIT
                        (COND
        ...
        (SPROG ((|n1| (|NonNegativeInteger|)) (|e| ($)))
               (SEQ
                (COND ((EQL |n| 0) (|spadConstant| $ 10)) ((EQL |n| 1) |o|)
                      (#1='T
                       (SEQ (LETT |e| (SPADCALL |o| (QREFELT $ 42)))
                            (EXIT
                             (COND
                              ((SPADCALL |e| (|spadConstant| $ 8)
                                         (QREFELT $ 20))
                               (SPADCALL
                                (EXPT (SPADCALL |o| (QREFELT $ 54)) |n|)
                                (QREFELT $ 27)))
                              (#1#
                               (SEQ (LETT |n1| (- |n| 1))
                                    (EXIT
         ...
         (SEQ (LETT |p| |o|)
              (EXIT
               (COND
                ...
                ('T
                 (SEQ (LETT |l| NIL)
                      (LETT |v| (SPADCALL "omega" (QREFELT $ 61)))
                      (SEQ G190
                           (COND
                            ((NULL
                              (SPADCALL |p| (|spadConstant| $ 7)
                                        (QREFELT $ 62)))
                             (GO G191)))
                           (SEQ (LETT |c| (SPADCALL |p| (QREFELT $ 63)))
                                (LETT |e| (SPADCALL |p| (QREFELT $ 42)))
                                (LETT |p| (SPADCALL |p| (QREFELT $ 45)))
                                (LETT |co| (SPADCALL |c| (QREFELT $ 59)))
                                (LETT |l1|
                                      (COND
                                       ((SPADCALL |e| (|spadConstant| $ 8)
                                                  (QREFELT $ 20))
