...
(SDEFUN |SRDCMPK;numberOfVariables;LLNni;2|
        ((|lp| |List| P) (|lts| |List| TS) ($ |NonNegativeInteger|))
        (SPROG ((|lv| (|List| V)) (#1=#:G433 NIL) (|ts| NIL))
               (SEQ
                (LETT |lv|
...
(SDEFUN |SRDCMPK;algebraicDecompose;PTSR;3|
        ...
        (SPROG
         ((#1=#:G454 NIL) (|lts| (|List| TS))
          (|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#2=#:G457 NIL) (|vs| NIL) (#3=#:G456 NIL) (|f| NIL)
          (|lsfp| (|List| P)) (|lus| (|List| TS)) (|h| (P)) (|us| (TS))
          (|g| (P)) (#4=#:G455 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v| (P)) (#5=#:G436 NIL) (|ts_v+| (TS)) (|ts_v-| (TS))
...
(SDEFUN |SRDCMPK;printInfo;LNniV;11|
        ...
        (SPROG
         ((|s| (|String|)) (|m| (|NonNegativeInteger|)) (#1=#:G522 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
...
(SDEFUN |SRDCMPK;decompose;LL5BL;12|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (|bound| (|NonNegativeInteger|)) (#1=#:G541 NIL) (|br| NIL)
          (#2=#:G540 NIL)
          (|branches|
           (|List|
...
(SDEFUN |SRDCMPK;upDateBranches;LLLRNniL;13|
        ...
        (SPROG
         ((|branches|
          ...
          (#2=#:G561 NIL) (|us| (TS)) (|branches1| (|List| #1#))
          (|newleq| (|List| P)) (#3=#:G560 NIL) (|branch| NIL)
...
(DEFUN |SquareFreeRegularSetDecompositionPackage| (&REST #1=#:G562)
  (SPROG NIL
         (PROG (#2=#:G563)
           (RETURN
            (COND
