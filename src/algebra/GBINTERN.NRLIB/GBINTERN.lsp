...
(SDEFUN |GBINTERN;makeCrit;RDpolNniR;4|
        ((|sp1| |Record| (|:| |totdeg| (|NonNegativeInteger|))
         ...
         ($ |Record| (|:| |lcmfij| |Expon|)
          ...
          (|:| |polj| |Dpol|)))
        (SPROG
         ((|tdeg| (|NonNegativeInteger|)) (|e2| (|Expon|)) (#1=#:G413 NIL)
...
(SDEFUN |GBINTERN;gbasisExtend;2L2IL;6|
        ...
        (SPROG
         ((#1=#:G470 NIL) (|x| NIL) (#2=#:G469 NIL) (|xx| (|Integer|))
          (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G468 NIL) (#5=#:G467 NIL) (#6=#:G460 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G466 NIL) (#8=#:G465 NIL) (#9=#:G464 NIL) (#10=#:G463 NIL)
          (|toth| (|NonNegativeInteger|)) (|Pol1| (|List| |Dpol|))
          (|sgb|
           (|List|
            (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                      (|:| |pol| |Dpol|))))
          (#11=#:G462 NIL) (#12=#:G461 NIL))
         (SEQ
          (LETT |sgb|
                (PROGN
                 (LETT #12# NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT $ 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT
                               (PROGN (LETT #6# |$NoValue|) (GO #13=#:G454)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
        ...
        ((|e| |Expon|)
         ...
         ($ |List|
          (|Record| (|:| |lcmfij| |Expon|)
                    (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                    (|:| |polj| |Dpol|))))
        (SPROG ((#1=#:G476 NIL) (|x| NIL) (#2=#:G475 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
        ...
        ((|h| |Dpol|)
         ...
         ($ |List|
          (|Record| (|:| |lcmfij| |Expon|)
                    (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                    (|:| |polj| |Dpol|))))
        (SPROG ((#1=#:G490 NIL) (|x| NIL) (#2=#:G489 NIL) (|d| (|Expon|)))
...
(SDEFUN |GBINTERN;updatF;DpolNni2L;10|
        ((|h| |Dpol|) (|deg| |NonNegativeInteger|)
         ...
         ($ |List|
          (|Record| (|:| |totdeg| (|NonNegativeInteger|)) (|:| |pol| |Dpol|))))
        (SPROG ((#1=#:G497 NIL) (|f| NIL) (#2=#:G496 NIL) (|d| (|Expon|)))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT $ 16)))
                    (EXIT
                     (SPADCALL
                      (PROGN
...
(SDEFUN |GBINTERN;sPol;RDpol;13|
        ((|p| |Record| (|:| |lcmfij| |Expon|)
         ...
         ($ |Dpol|))
        (SPROG
         ((#1=#:G523 NIL) (|cc| (|Record| (|:| |co1| |Dom|) (|:| |co2| |Dom|)))
...
(DEFUN |GroebnerInternalPackage| (&REST #1=#:G593)
  (SPROG NIL
         (PROG (#2=#:G594)
           (RETURN
            (COND
