...
(SDEFUN |CSTTOOLS;cycleElt;STU;1| ((|x| ST) ($ |Union| ST "failed"))
        (SPROG ((#1=#:G401 NIL) (#2=#:G402 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |CSTTOOLS;computeCycleLength;STNni;2|
        ...
        (SPROG ((#1=#:G407 NIL) (#2=#:G408 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |cycElt|)
                      (EXIT
...
(DEFUN |CyclicStreamTools| (&REST #1=#:G415)
  (SPROG NIL
         (PROG (#2=#:G416)
           (RETURN
            (COND
