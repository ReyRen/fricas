                 ...
                 (|:| |irr|
                      (|SparseUnivariatePolynomial|
                       (|SparseMultivariatePolynomial|
                        (|SparseUnivariatePolynomial| F) OV)))
                 (|:| |pow| (|NonNegativeInteger|)))))))
        (SPROG ((#1=#:G429 NIL) (|lff| NIL) (#2=#:G428 NIL))
               (SEQ
                (CONS (QCAR |lfg|)
                      (PROGN
                       (LETT #2# NIL)
          ...
          (|:| |factors|
               (|List|
                (|Record|
                 ...
                 (|:| |pow| (|NonNegativeInteger|)))))))
        (SPROG
         ((#1=#:G476 NIL) (|lcfacs| #2=(|SparseUnivariatePolynomial| F))
          (#3=#:G473 NIL) (#4=#:G472 #2#) (#5=#:G474 #2#) (#6=#:G491 NIL)
          (|f| NIL)
          (|factorlist|
           (|List|
            (|Record|
          ...
          (#10=#:G490 NIL) (|lfp| NIL) (#11=#:G489 NIL)
          (|lf|
           (|List|
            (|SparseUnivariatePolynomial|
             (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                             OV))))
          (|ldeg| (|List| #12=(|NonNegativeInteger|))) (#13=#:G465 NIL)
          (#14=#:G464 #12#) (#15=#:G466 #12#) (#16=#:G488 NIL) (|fc| NIL)
          (#17=#:G487 NIL) (|xx| NIL) (#18=#:G486 NIL)
          (|coefs|
           (|List|
            (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                            OV)))
          (|ffcont|
           (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                           OV))
          (|ffexp| #9#) (|ffactor| #8#) (#19=#:G485 NIL) (|fact| NIL)
          (|sqqfact| (|List| #7#)) (#20=#:G484 NIL) (|ff| NIL) (#21=#:G483 NIL)
          (|flead|
           (|Record| (|:| |contp| (|SparseUnivariatePolynomial| F))
                     (|:| |factors| (|List| #7#))))
          (|lcont|
          ...
          (|om| (|SparseUnivariatePolynomial| PG)) (#22=#:G481 NIL)
          (|lfg|
           (|Record| (|:| |contp| (|SparseUnivariatePolynomial| F))
                     (|:| |factors|
                          (|List|
          ...
          (#25=#:G432 NIL) (#26=#:G431 #24#) (#27=#:G433 #24#) (#28=#:G482 NIL)
          (|cf| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |MFINFACT;factor_sup|
        ...
        (SPROG
         ((|fr1| #1=(|Factored| (|SparseUnivariatePolynomial| PG)))
          (#2=#:G495 NIL) (#3=#:G494 #1#) (#4=#:G496 #1#) (#5=#:G500 NIL)
          (|p| NIL)
          (|fm|
           (|Record| (|:| |cont| F)
                     (|:| |factors|
...
(SDEFUN |MFINFACT;factor;SupF;4|
        ...
        (SPROG
         ((#1=#:G507 NIL)
          (#2=#:G506 #3=(|Factored| (|SparseUnivariatePolynomial| PG)))
          (#4=#:G508 #3#) (#5=#:G514 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| (|SparseUnivariatePolynomial| F))
                     (|:| |factors|
                          (|List|
          ...
          (|cm|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                            OV)))
          (|var| (OV)) (|dx| #6=(|NonNegativeInteger|)) (#7=#:G502 NIL)
          (#8=#:G501 #6#) (#9=#:G503 #6#) (#10=#:G513 NIL) (#11=#:G382 NIL)
         ...
         ((|factorlist|
          ...
          (|um|
           #3=(|SparseUnivariatePolynomial|
               (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                               OV)))
          (|lcum| (F)) (|ldeg| (|List| (|NonNegativeInteger|))) (#4=#:G562 NIL)
          (|lcterm| NIL)
          (|ffactor|
          ...
          (#7=#:G561 NIL) (#8=#:G530 NIL)
          (|lcont|
           (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                           OV))
          (#9=#:G560 NIL) (|lterm| NIL) (|ffexp| #10=(|NonNegativeInteger|))
          (#11=#:G559 NIL) (|fact| NIL)
          (|sqqfact|
           (|List| (|Record| (|:| |factor| #5#) (|:| |exponent| #10#))))
          (#12=#:G558 NIL) (|ff| NIL) (#13=#:G557 NIL)
          (|flead|
           (|Record| (|:| |contp| (|SparseUnivariatePolynomial| F))
                     (|:| |factors|
                          (|List|
                           (|Record|
                            (|:| |irr|
                                 (|SparseMultivariatePolynomial|
                                  (|SparseUnivariatePolynomial| F) OV))
                            (|:| |pow| (|NonNegativeInteger|)))))))
          (|sqfacs| (|Factored| PG)) (|om| (PG)) (#14=#:G518 NIL)
          (#15=#:G517 #16=(|Boolean|)) (#17=#:G519 #16#) (#18=#:G556 NIL)
...
(SDEFUN |MFINFACT;pM|
        ...
        (SPROG
         ((#1=#:G585 NIL) (|p| (|SparseUnivariatePolynomial| F))
          (#2=#:G575 NIL)
          (|q| (|Union| (|SparseUnivariatePolynomial| F) #3="failed"))
          (#4=#:G573 NIL) (|e| NIL) (#5=#:G584 NIL) (#6=#:G569 NIL)
          (#7=#:G586 NIL) (|i| NIL) (|x| (|SparseUnivariatePolynomial| F)))
         (SEQ
          (EXIT
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL |p| |lum| (QREFELT $ 124))
                           (PROGN
                            (LETT #5# (PROGN (LETT #1# |p|) (GO #8=#:G583)))
                            (GO #9=#:G570)))))))
                      #9# (EXIT #5#))
         ...
         ((|factfin|
          ...
          (|leadpol|
           (|List|
            (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                            OV)))
          (#7=#:G628 NIL) (#8=#:G627 NIL) (|polcase| (|Boolean|)))
         (SEQ
          (EXIT
...
(SDEFUN |MFINFACT;ran| ((|k1| |Integer|) ($ |SparseUnivariatePolynomial| F))
        (SPROG
         ((#1=#:G649 NIL) (#2=#:G648 #3=(|SparseUnivariatePolynomial| F))
          (#4=#:G650 #3#) (#5=#:G652 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MFINFACT;varChoose|
        ((|m| |SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
         ...
         ($ |Record|
          ...
          (|:| |newdeg| (|List| (|NonNegativeInteger|)))))
        (SPROG
         ((|x| (OV)) (|i| (|Integer|)) (|k| #1#) (#2=#:G655 NIL)
          (#3=#:G654 #1#) (#4=#:G656 #1#) (#5=#:G660 NIL) (#6=#:G383 NIL))
         (SEQ
          (LETT |k|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MFINFACT;norm|
        ((|lum| |List|
         ...
         ($ . #1=(|Integer|)))
        (SPROG
         ((#2=#:G662 NIL) (#3=#:G661 #1#) (#4=#:G663 #1#) (#5=#:G665 NIL)
          (|lup| NIL))
         (SEQ
          (PROGN
           (LETT #2# NIL)
        ...
        (SPROG
         ((|nfatt| (|NonNegativeInteger|))
          ...
          (|unifact|
           (|List|
            (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| F))))
          (#3=#:G748 NIL) (|uf| NIL) (#4=#:G747 NIL)
          (|leadtest| #5=(|Boolean|)) (#6=#:G746 NIL) (#7=#:G745 NIL)
          (#8=#:G730 NIL) (#9=#:G744 NIL) (#10=#:G743 NIL) (#11=#:G742 NIL)
          (#12=#:G741 NIL) (#13=#:G740 NIL) (|ff| NIL) (#14=#:G739 NIL)
          (#15=#:G738 NIL) (#16=#:G737 NIL) (|lffc1| #2#)
          ...
          (|dx| #18=(|NonNegativeInteger|)) (#19=#:G692 NIL) (#20=#:G691 #18#)
          (#21=#:G693 #18#) (#22=#:G736 NIL) (|uc| NIL)
          (|newm|
           (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| F)))
          ...
          (|Dnewm|
           (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| F)))
          (#23=#:G676 NIL) (#24=#:G670 NIL) (#25=#:G669 #26=(|Boolean|))
          (#27=#:G671 #26#) (#28=#:G735 NIL) (|epl| NIL) (|leadcomp1| #1#)
          (#29=#:G734 NIL) (|pol| NIL) (#30=#:G733 NIL)
          (|lval| (|List| (|SparseUnivariatePolynomial| F))) (#31=#:G732 NIL)
          (|i| NIL) (#32=#:G731 NIL)
          (|newunifact|
           (|List|
            (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| F))))
        ...
        (SPROG
         ((|flead|
          ...
          (|pol1|
           (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                           OV))
          (|i| (|NonNegativeInteger|)) (#2=#:G767 NIL) (|x| NIL))
         ...
         ($ |List|
          (|SparseUnivariatePolynomial|
           (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                           OV))))
        (SPROG
         ((#1=#:G777 NIL) (|lumf| NIL) (#2=#:G776 NIL)
          (|lum|
           (|Factored|
            (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| F))))
          (|um1|
...
(SDEFUN |MFINFACT;factor;PGF;20| ((|m| PG) ($ |Factored| PG))
        (SPROG
         ((#1=#:G788 NIL) (#2=#:G787 #3=(|Factored| PG)) (#4=#:G789 #3#)
          (#5=#:G796 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| (|SparseUnivariatePolynomial| F))
                     (|:| |factors|
          ...
          (|cm|
           (|SparseMultivariatePolynomial| (|SparseUnivariatePolynomial| F)
                                           OV))
          (|var| (OV)) (|dx| #6=(|NonNegativeInteger|)) (#7=#:G784 NIL)
          (#8=#:G783 #6#) (#9=#:G785 #6#) (#10=#:G795 NIL) (#11=#:G384 NIL)
          (|ld| (|List| #6#)) (#12=#:G794 NIL) (|x| NIL) (#13=#:G793 NIL)
          (|lv| (|List| OV)))
...
(DEFUN |MultFiniteFactorize| (&REST #1=#:G797)
  (SPROG NIL
         (PROG (#2=#:G798)
           (RETURN
            (COND
