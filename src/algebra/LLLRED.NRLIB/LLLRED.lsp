...
(SDEFUN |LLLRED;gram_step|
        ...
        (SPROG
         ((#1=#:G394 NIL) (|i| NIL) (#2=#:G393 NIL) (|v2| (|Vector| (|Float|)))
          (#3=#:G392 NIL) (|j| NIL) (#4=#:G391 NIL))
...
(SDEFUN |LLLRED;extendedLLL!;MNniM;2|
        ((L |Matrix| (|Integer|)) (N |NonNegativeInteger|)
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((|k| (|NonNegativeInteger|)) (|tmp| (|Float|)) (#1=#:G418 NIL)
          (|i| NIL) (#2=#:G417 NIL) (|bs2| #3=(|Vector| (|Float|))) (|bs1| #3#)
          (|v2i| #4=(|Float|)) (|v1i| #5=(|Float|)) (#6=#:G416 NIL)
          (|m| #7=(|Float|)) (|nv2| #7#) (|nv1| #5#) (|k1| (|Integer|))
          (|del1| #4#) (#8=#:G415 NIL) (#9=#:G414 NIL) (|q| (|Integer|))
          (|j| NIL) (|kmax| (|Integer|)) (|iters| (|Integer|)) (#10=#:G413 NIL)
...
(SDEFUN |LLLRED;extendedLLL;MR;3|
        ((L |Matrix| (|Integer|))
         ($ |Record| (|:| |lll| (|Matrix| (|Integer|)))
          (|:| |trf| (|Matrix| (|Integer|)))))
        (SPROG
         ((#1=#:G434 NIL) (|j| NIL) (#2=#:G433 NIL) (#3=#:G432 NIL) (|i| NIL)
          (|t| #4=(|Matrix| (|Integer|))) (|l| #4#)
          (|m| (|Matrix| (|Integer|))) (#5=#:G431 NIL) (#6=#:G430 NIL) (LE #4#)
...
(SDEFUN |LLLRED;find_relation;LNniL;5|
        ...
        (SPROG
         ((#1=#:G444 NIL) (|i| NIL) (#2=#:G443 NIL)
          (|res| (|Matrix| (|Integer|))) (#3=#:G441 NIL) (#4=#:G442 NIL)
