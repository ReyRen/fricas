...
(SDEFUN |MODHP;VSUPI_to_VPA;VIV;1|
        ...
        (SPROG
         ((#1=#:G417 NIL) (|i| NIL) (|vpa| (|Vector| (|U32Vector|)))
...
(SDEFUN |MODHP;VSUPPI_to_VPA;VLLIV;3|
        ((|vps| |Vector|
         ...
         ($ |Vector| (|U32Vector|)))
        (SPROG
         ((#1=#:G426 NIL) (|i| NIL) (|vpa| (|Vector| (|U32Vector|)))
          (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (QVSIZE |vps|))
              (LETT |vpa| (MAKEARR1 |m| (GETREFV_U32 0 0)))
              (SEQ (LETT |i| 1) (LETT #1# |m|) G190
...
(SDEFUN |MODHP;LLFI_to_LPA;L2IU;4|
        ...
        (SPROG
         ((|resl| (|List| (|U32Vector|))) (|nlc| (|Integer|))
          (|dms| (|SingleInteger|)) (#1=#:G440 NIL) (|dm| #2=(|Integer|))
          (|nm| #2#) (#3=#:G442 NIL) (|j| NIL) (#4=#:G443 NIL) (|el| NIL)
          (|pa| (|U32Vector|)) (|nn| (|Integer|)) (#5=#:G441 NIL) (|lfi| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |resl| NIL)
...
(SDEFUN |MODHP;LLFPI_to_LPA;LILLIU;5|
        ...
        (SPROG
         ((|resl| (|List| (|U32Vector|))) (|nlc| (|Integer|))
          (|dms| (|SingleInteger|)) (#1=#:G454 NIL) (|dm| #2=(|Integer|))
          (|nm| #2#) (#3=#:G456 NIL) (|j| NIL) (#4=#:G457 NIL) (|el| NIL)
          (|pa| (|U32Vector|)) (#5=#:G455 NIL) (|lfi| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |resl| NIL)
                (SEQ (LETT |lfi| NIL) (LETT #5# |llfi|) G190
...
(SDEFUN |MODHP;LPPFtoVPA|
        ...
        (SPROG
         ((#1=#:G474 NIL) (|vpp| (|Union| (|U32Vector|) "failed"))
          (#2=#:G475 NIL) (|i| NIL) (#3=#:G476 NIL) (|p| NIL)
...
(SDEFUN |MODHP;check_sol1a;VLM3IUv;9|
        ((|nres| |Vector| (|U32Vector|)) (|gv0| |List| (|U32Vector|))
         ...
         ($ |U32Vector|))
        (SPROG
         ((#1=#:G482 NIL) (|i| NIL) (|res| (|U32Vector|))
...
(SDEFUN |MODHP;HP_solve_I;LLSNniMMU;10|
        ...
        (SPROG
         ((#4=#:G574 NIL) (#5=#:G587 NIL) (|l| NIL) (#6=#:G586 NIL) (|i| NIL)
          ...
          (|pts| (|U32Vector|)) (#26=#:G571 NIL) (#27=#:G577 NIL) (|pts0| #19#)
          (|ve| (|Vector| (|Integer|))) (#28=#:G576 NIL) (|d| NIL)
          (#29=#:G575 NIL) (|degs_sum| (|NonNegativeInteger|))
          (|m| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |lp| NIL)
...
(SDEFUN |MODHP;get_variables2|
        ((|llpi| |List| (|List| (|Fraction| (|Polynomial| (|Integer|)))))
         ($ |List| (|Symbol|)))
        (SPROG
         ((|res| (|List| (|Symbol|))) (#1=#:G594 NIL) (|p| NIL) (#2=#:G593 NIL)
          (|lpi| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |MODHP;unpack_poly;LSevPa2ISup;12|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Polynomial| (|Integer|))))
          (#1=#:G606 NIL) (|i| (|Integer|)) (|term| (|Polynomial| (|Integer|)))
          (|term1| (|Polynomial| (|Integer|))) (#2=#:G600 NIL) (#3=#:G610 NIL)
          (|k| NIL) (#4=#:G611 NIL) (|var| NIL) (|j| (|Integer|))
          (#5=#:G596 NIL) (|jj| (|Integer|)) (#6=#:G609 NIL) (|i0| NIL)
...
(SDEFUN |MODHP;LPI_to_LPPI|
        ...
        (SPROG ((#1=#:G626 NIL) (|p| NIL) (#2=#:G625 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
        ...
        (SPROG
         ((#1=#:G656 NIL) (|j| NIL) (#2=#:G655 NIL) (|i| NIL)
          ...
          (|pres|
           (|Union| (|Matrix| (|SparseUnivariatePolynomial| (|Integer|)))
                    (|Boolean|)))
          (|nlist| (|List| (|List| (|Fraction| (|Integer|))))) (#4=#:G654 NIL)
          (|q| NIL) (#5=#:G653 NIL) (#6=#:G652 NIL) (|li| NIL) (#7=#:G651 NIL))
         (SEQ
          (EXIT
           (COND
            ((EQUAL |kind| '|qshiftHP|)
             (PROGN (LETT #3# (CONS 1 'T)) (GO #8=#:G649)))
            (#9='T
...
(SDEFUN |MODHP;HP_solve_P;LL2SNniMMU;19|
        ((|list| |List| (|List| (|Fraction| (|Polynomial| (|Integer|)))))
         ...
         ($ |Union|
          ...
          (|Boolean|)))
        (SPROG
         ((#2=#:G715 NIL) (#3=#:G724 NIL) (|l| NIL) (#4=#:G723 NIL) (|i| NIL)
          (|mress|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Polynomial| (|Integer|)))))
          (#5=#:G698 NIL) (|ii| (|Integer|)) (#6=#:G714 NIL) (|ok| (|Boolean|))
          (|sol_okp| #1#) (|hi| (|Integer|)) (|ohi| #7=(|Integer|))
          (|kk| (|Integer|)) (|lo| #7#) (#8=#:G722 NIL) (|j| NIL)
          (|resvi|
           (|Vector|
            (|SparseUnivariatePolynomial| (|Polynomial| (|Integer|)))))
          (#9=#:G721 NIL)
          ...
          (#13=#:G720 NIL) (|li| NIL) (#14=#:G719 NIL)
          (|vars| (|List| (|Symbol|))) (|pts| (|U32Vector|)) (#15=#:G713 NIL)
          (#16=#:G718 NIL) (|pts0| (|U32Vector|)) (|ve| (|Vector| (|Integer|)))
          (#17=#:G717 NIL) (|d| NIL) (#18=#:G716 NIL)
                     ...
                     (SEQ G190 NIL
                          (SEQ
                           ...
                           (EXIT
                            (COND
                             ((QEQCAR |pp| 1)
                              (PROGN (LETT #2# (CONS 1 NIL)) (GO #20=#:G712)))
                             ('T
...
(SDEFUN |MODHP;HP_solve_M;LLSINniMMU;20|
        ((|list| |List| (|List| (|Integer|))) (|degs| |List| (|Integer|))
         ...
         ($ |Union| (|Matrix| (|SparseUnivariatePolynomial| (|Integer|)))
          (|Boolean|)))
        (SPROG
         ((#3=#:G757 NIL) (#4=#:G767 NIL) (|l| NIL) (#5=#:G766 NIL) (|i| NIL)
          (|mress| (|Matrix| (|SparseUnivariatePolynomial| (|Integer|))))
          (#6=#:G750 NIL) (|ii| (|Integer|)) (|sol_okp| #2#)
          (|s| (|SparseUnivariatePolynomial| (|Integer|))) (#7=#:G765 NIL)
          (|bmij| (|U32Vector|)) (|mm| (|Integer|)) (#8=#:G764 NIL) (|j| NIL)
          (|resvi| (|Vector| (|SparseUnivariatePolynomial| (|Integer|))))
          (#9=#:G763 NIL)
          (|resv|
           (|Vector| (|Vector| (|SparseUnivariatePolynomial| (|Integer|)))))
          ...
          (|blr|
           (|Union|
            (|Record| (|:| |basis| #11#) (|:| |defects| #10#)
                      (|:| |cinds| (|Vector| (|Integer|))))
            "no_solution"))
          (|gv| #1#) (|gv0| (|List| (|U32Vector|))) (#12=#:G762 NIL) (|li| NIL)
          (#13=#:G761 NIL) (|pts| (|U32Vector|)) (#14=#:G756 NIL)
          (#15=#:G760 NIL) (|pts0| (|U32Vector|)) (|ve| (|Vector| (|Integer|)))
          (#16=#:G759 NIL) (|d| NIL) (#17=#:G758 NIL)
          (|m| (|NonNegativeInteger|)) (|lp| (|List| (|Integer|))))
         (SEQ
          (EXIT
           (SEQ (LETT |lp| NIL)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |blr| 1)
                   (PROGN (LETT #3# (CONS 1 NIL)) (GO #20=#:G755)))
                  (#18#
