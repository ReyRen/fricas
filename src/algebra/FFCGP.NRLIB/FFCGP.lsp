...
(SDEFUN |FFCGP;basis;PiV;8| ((|n| |PositiveInteger|) ($ |Vector| $))
        (SPROG
         ((#1=#:G423 NIL) (#2=#:G429 NIL) (|i| NIL) (#3=#:G428 NIL)
          (|m| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |FFCGP;retractIfCan;$U;17| ((|x| $) ($ |Union| GF "failed"))
        (SPROG ((#1=#:G468 NIL) (|u| (|Union| $ #2="failed")))
               (SEQ
                (COND
...
(SDEFUN |FFCGP;retract;$GF;18| ((|x| $) ($ GF))
        (SPROG ((#1=#:G480 NIL) (|a| (|Union| GF #2="failed")))
...
(SDEFUN |FFCGP;basis;V;19| (($ |Vector| $))
        (SPROG
         ((#1=#:G485 NIL) (#2=#:G488 NIL) (#3=#:G490 NIL) (|i| NIL)
          (#4=#:G489 NIL))
         (SEQ
          (PROGN
...
(SDEFUN |FFCGP;discreteLog;2$U;21|
        ...
        (SPROG
         ((|e1| (|Record| (|:| |coef1| $) (|:| |coef2| $))) (#1=#:G499 NIL)
          (|e|
...
(DEFUN |FiniteFieldCyclicGroupExtensionByPolynomial| (&REST #1=#:G557)
  (SPROG NIL
         (PROG (#2=#:G558)
           (RETURN
            (COND
...
(DEFUN |FiniteFieldCyclicGroupExtensionByPolynomial;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G556 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|FiniteFieldCyclicGroupExtensionByPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) '|Rep|
              ...
              (|PositiveInteger|) (9 . ^) (|Boolean|) (15 . >) '#:G382
              (21 . |One|)
