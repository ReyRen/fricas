...
(SDEFUN |XMLEL;outputStructured| ((|rp| $) ($ |List| (|String|)))
        (SPROG
         ((|res| (|List| #1=(|String|))) (#2=#:G402 NIL) (|el| NIL)
          (|atts| #1#) (#3=#:G401 NIL) (|s| NIL) (#4=#:G400 NIL))
         (SEQ
          (LETT |atts|
                (SPADCALL
                 (PROGN
...
(SDEFUN |XMLEL;outputUnstructured| ((|rp| $) ($ |List| (|String|)))
        (SPROG
         ((|res| (|List| #1=(|String|))) (|atts| #1#) (#2=#:G407 NIL) (|s| NIL)
          (#3=#:G406 NIL))
         (SEQ
          (LETT |atts|
                (SPADCALL
...
(SDEFUN |XMLEL;outputVRML;$TfV;7| ((|rp| $) (|f1| |TextFile|) ($ |Void|))
        (SPROG
         ((#1=#:G432 NIL) (|el| NIL) (#2=#:G431 NIL) (|att| NIL)
          (#3=#:G429 NIL) (#4=#:G430 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((OR (EQUAL (QVELT |rp| 0) "X3D") (EQUAL (QVELT |rp| 0) "Scene"))
              (SEQ
               ...
               (EXIT (PROGN (LETT #3# (|Void|)) (GO #5=#:G428))))))
