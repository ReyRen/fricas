...
(SDEFUN |DFINTTLS;computeInt;KF2OcBU;5|
        ...
        (SPROG
         ((#1=#:G424 NIL) (|ia| #2=(|Union| (|OrderedCompletion| F) "failed"))
          (|ib| #2#))
         (SEQ
                   ...
                   (SEQ
                    ...
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((QEQCAR |ib| 1)
                        (PROGN (LETT #1# (CONS 1 #4="failed")) (GO #5=#:G418)))
                       (#3#
                        (SEQ
                         (LETT |ia|
...
(SDEFUN |DFINTTLS;mkLogPos| ((|f| F) ($ F))
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          (|v| (|Union| F "positive")) (#1=#:G448 NIL) (|k| NIL))
...
(SDEFUN |DFINTTLS;checkForZero;Sup2OcBU;11|
        ((|q| |SparseUnivariatePolynomial| F) (|a| |OrderedCompletion| F)
         ...
         ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((|u| (|Union| (|Boolean|) "failed")) (#1=#:G487 NIL)
          (|i|
           (|Union|
            (|:| |fin|
...
(SDEFUN |DFINTTLS;maprat|
        ...
        (SPROG
         ((|ans| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (#1=#:G501 NIL) (|r| (|Union| (|Fraction| (|Integer|)) "failed"))
          (|c| (F)))
         (SEQ
          (EXIT
                ...
                (SEQ G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |r| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G500)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
          ...
          (|u|
           (|Union|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))
            #9="failed"))
          (#10=#:G550 NIL) (|t| NIL) (#11=#:G549 NIL)
          (|bounds|
           (|Record| (|:| |left| (|Fraction| (|Integer|)))
                     (|:| |right| (|Fraction| (|Integer|)))))
          (#12=#:G534 NIL) (#13=#:G533 #5#) (#14=#:G535 #5#) (#15=#:G548 NIL)
          (#16=#:G531 NIL) (#17=#:G530 #6#) (#18=#:G532 #6#) (#19=#:G547 NIL)
          (|r| #1#))
...
(SDEFUN |DFINTTLS;checkBudan|
        ((|p| |SparseUnivariatePolynomial| F) (|a| |OrderedCompletion| F)
         ...
         ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((|v| (|Integer|)) (|m| (|Integer|)) (#1=#:G571 NIL)
          (|vb| #2=(|Union| (|Integer|) "failed")) (|va| #2#)
          (|zb?| #3=(|Boolean|)) (|bb| (F)) (#4=#:G555 NIL)
          (|n| (|SingleInteger|)) (#5=#:G572 NIL) (|za?| #3#) (|aa| (F))
          (|r| (|Union| F "failed")))
         (SEQ (LETT |r| (SPADCALL |b| (QREFELT $ 35)))
              (EXIT
               (COND
                     ...
                     (EXIT
                      (COND
                       (|za?|
                        (COND
                         (|incl?|
                          (PROGN (LETT #5# (CONS 0 'T)) (GO #7=#:G568))))))))
                    (EXIT
                     (COND
                      ((SPADCALL (LETT |n| (SPADCALL |b| (QREFELT $ 99))) 0
                                 (QREFELT $ 100))
...
(SDEFUN |DFINTTLS;checkDeriv|
        ...
        (SPROG
         ((|u| (|Union| (|Boolean|) #1#)) (|s| (|Union| (|Boolean|) "failed"))
          (|r| (|Union| F "failed")))
         (SEQ (LETT |r| (SPADCALL |p| (QREFELT $ 118)))
              (EXIT
               (COND
...
(SDEFUN |DFINTTLS;posRoot|
        ((|p| |SparseUnivariatePolynomial| F) (|incl0?| |Boolean|)
         ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((|v| (|Union| (|Integer|) "failed")) (#1=#:G613 NIL)
          (|z0?| (|Boolean|)))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               (|z0?|
                (COND
                 (|incl0?| (PROGN (LETT #1# (CONS 0 'T)) (GO #2=#:G611))))))))
                 ...
                 ((|zero?_SI| (LETT |n| (SPADCALL |a| (QREFELT $ 99))))
                  (CONS 0
                        (SPADCALL |p| (SPADCALL |a| (QREFELT $ 101))
                                  (QREFELT $ 115))))
                 (#1='T
                  (SEQ (LETT |u| (SPADCALL |p| |n| (ELT $ 64) (QREFELT $ 124)))
                       (EXIT
                        (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                              (#1#
                               (CONS 0
...
(DEFUN |DefiniteIntegrationTools| (&REST #1=#:G637)
  (SPROG NIL
         (PROG (#2=#:G638)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 124
                                            '(0 6 0 8 0 7 0 9 2 11 0 7 10 12 1
                                              ...
                                              105 104 94 109 2 20 16 0 0 110 2
                                              17 0 0 0 111 2 17 0 0 0 112 3 105
                                              113 94 103 103 114 2 11 7 0 7 115
                                              1 7 16 0 116 1 20 16 0 117 1 11
                                              34 0 118 1 11 0 0 119 2 7 0 0 0
                                              120 2 11 7 0 10 121 3 123 62 11
                                              20 122 124 1 0 16 22 23 5 0 31 32
