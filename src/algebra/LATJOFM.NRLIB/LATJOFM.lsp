         ...
         ((|r|
          ...
          (|termRight|
           #1=(|List|
               (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                        (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (|termLeft| #1#) (#2=#:G460 NIL) (|innerb| NIL) (#3=#:G459 NIL)
          (|innera| NIL) (#4=#:G458 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((SPADCALL |a| (QREFELT $ 17))
              (PROGN (LETT #4# |b|) (GO #5=#:G457))))
            (COND
...
(SDEFUN |LATJOFM;equalElements|
        ((|a| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
         ...
         (|b| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
          (|:| |var| (|Record| (|:| |str| (|String|)))))
         ($ |Boolean|))
        (SPROG ((#1=#:G484 NIL) (#2=#:G480 NIL) (#3=#:G481 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
        ...
        (SPROG
         ((|r|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (|match| (|Boolean|)) (#1=#:G500 NIL) (|e2| NIL) (#2=#:G501 NIL)
          (|ne2| NIL) (#3=#:G498 NIL) (|e1| NIL) (#4=#:G499 NIL) (|ne1| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |LATJOFM;equalTerms|
        ((|a| |List|
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G517 NIL) (|found| (|Boolean|)) (#2=#:G519 NIL) (|b1| NIL)
          (#3=#:G518 NIL) (|a1| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |LATJOFM;subTerm|
        ((|a| |List|
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G535 NIL) (|found| (|Boolean|)) (#2=#:G537 NIL) (|b1| NIL)
          (#3=#:G536 NIL) (|a1| NIL))
         (SEQ
          (EXIT
           (SEQ
         ...
         ((|r|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                      (|:| |var| (|Record| (|:| |str| (|String|))))))))
          (|modified| #1=(|Boolean|)) (|isSubTerm| #1#) (#2=#:G551 NIL)
          (|inner| NIL) (|match| #1#) (#3=#:G549 NIL) (#4=#:G550 NIL)
          (|innern| NIL)
          (|newinnerList|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (#5=#:G547 NIL) (|outer| NIL) (#6=#:G548 NIL) (|outern| NIL))
...
(SDEFUN |LATJOFM;stringVarOrLit|
        ((|a| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
          (|:| |var| (|Record| (|:| |str| (|String|)))))
         ($ |String|))
        (SPROG ((#1=#:G565 NIL) (#2=#:G487 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |a| 1)
                    (PROGN (LETT #1# (QCAR (CDR |a|))) (GO #3=#:G564))))
                  (COND
                   ((QEQCAR |a| 0)
                    (SEQ
                     (COND
...
(SDEFUN |LATJOFM;toStringUnwrapped;$S;27| ((|n| $) ($ |String|))
        (SPROG
         ((|r| (|String|)) (#1=#:G578 NIL) (|inner| NIL) (#2=#:G579 NIL)
          (|innern| NIL) (|innerList| (|List| (|String|))) (#3=#:G576 NIL)
          (|outer| NIL) (#4=#:G577 NIL) (|outern| NIL)
...
(SDEFUN |LATJOFM;coerce;$Of;29| ((|n| $) ($ |OutputForm|))
        (SPROG
         ((|r| (|OutputForm|)) (#1=#:G595 NIL) (|inner| NIL) (#2=#:G596 NIL)
          (|innern| NIL) (|innerList| (|List| (|OutputForm|))) (#3=#:G593 NIL)
          (|outer| NIL) (#4=#:G594 NIL) (|outern| NIL)
...
(SDEFUN |LATJOFM;coerce;$Lmoj;30| ((|n| $) ($ |LatticeMeetOfJoins|))
        (SPROG
         ((|r| #1=(|LatticeMeetOfJoins|)) (|term| #1#)
          (|ele| (|LatticeMeetOfJoins|)) (#2=#:G607 NIL) (|inner| NIL)
          (#3=#:G608 NIL) (|innern| NIL) (#4=#:G605 NIL) (|outer| NIL)
          (#5=#:G606 NIL) (|outern| NIL))
...
(SDEFUN |LATJOFM;coerce;Lmoj$;31| ((|n1| |LatticeMeetOfJoins|) ($ $))
        (SPROG
         ((|r| ($)) (|term| ($)) (|ele| ($)) (#1=#:G619 NIL) (|inner| NIL)
          (#2=#:G620 NIL) (|innern| NIL) (#3=#:G617 NIL) (|outer| NIL)
          (#4=#:G618 NIL) (|outern| NIL)
          (|n|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
