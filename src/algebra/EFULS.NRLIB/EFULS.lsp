...
(SDEFUN |EFULS;atanIfCan;ULSU;25| ((|uls| ULS) ($ |Union| ULS "failed"))
        (SPROG
         ((|z| (|Union| ULS "failed")) (|cc| (|Coef|)) (#1=#:G560 NIL)
          (|rat| (|Union| (|Fraction| (|Integer|)) "failed")) (|lc| (|Coef|))
          (#2=#:G559 NIL) (|ord| (|Integer|)) (|coef| (|Coef|)))
         (SEQ
          (EXIT
           (SEQ
            (EXIT
...
(SDEFUN |EFULS;acotIfCan;ULSU;26| ((|uls| ULS) ($ |Union| ULS "failed"))
        (SPROG
         ((|z| (|Union| ULS "failed")) (|cc| (|Coef|)) (#1=#:G573 NIL)
          (|rat| (|Union| (|Fraction| (|Integer|)) "failed")) (|lc| (|Coef|))
          (#2=#:G572 NIL) (|ord| (|Integer|)) (|coef| (|Coef|)))
         (SEQ
          (EXIT
           (SEQ
            (EXIT
...
(SDEFUN |EFULS;atan;2ULS;56| ((|uls| ULS) ($ ULS))
        (SPROG
         ((|z| (|Union| ULS "failed")) (|cc| (|Coef|))
          (|rat| (|Union| (|Fraction| (|Integer|)) "failed")) (|lc| (|Coef|))
          (#1=#:G742 NIL) (|ord| (|Integer|)) (|coef| (|Coef|)))
         (SEQ
          (EXIT
           (SEQ (LETT |coef| (SPADCALL |uls| 0 (QREFELT $ 26)))
                (SEQ (LETT |ord| (SPADCALL |uls| 0 (QREFELT $ 86)))
...
(SDEFUN |EFULS;acot;2ULS;57| ((|uls| ULS) ($ ULS))
        (SPROG
         ((|z| (|Union| ULS "failed")) (|cc| (|Coef|))
          (|rat| (|Union| (|Fraction| (|Integer|)) "failed")) (|lc| (|Coef|))
          (#1=#:G754 NIL) (|ord| (|Integer|)) (|coef| (|Coef|)))
         (SEQ
          (EXIT
           (SEQ (LETT |coef| (SPADCALL |uls| 0 (QREFELT $ 26)))
                (SEQ (LETT |ord| (SPADCALL |uls| 0 (QREFELT $ 86)))
...
(DEFUN |ElementaryFunctionsUnivariateLaurentSeries| (&REST #1=#:G755)
  (SPROG NIL
         (PROG (#2=#:G756)
           (RETURN
            (COND
