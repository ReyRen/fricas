...
(SDEFUN |RMATCAT-;random;S;2| (($ S))
        (SPROG
         ((#1=#:G402 NIL) (|i| NIL) (#2=#:G401 NIL) (#3=#:G400 NIL) (|j| NIL)
          (#4=#:G399 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |RMATCAT-;lookup;SPi;3| ((|x| S) ($ |PositiveInteger|))
        (SPROG
         ((#1=#:G406 NIL) (|pow| (|Integer|)) (|res| (|Integer|))
          (#2=#:G410 NIL) (|c| NIL) (#3=#:G409 NIL) (|r| NIL)
         ...
         ((|res| (|List| (|List| R)))
          (|old|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (|row| (|List| R)) (|el| (R)) (#1=#:G412 NIL) (#2=#:G420 NIL)
          (|j| NIL) (#3=#:G419 NIL) (|s| (|NonNegativeInteger|)))
...
(SDEFUN |RMATCAT-;diagonal?;SB;8| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G430 NIL) (#2=#:G431 NIL) (#3=#:G433 NIL) (|j| NIL)
          (#4=#:G432 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |RMATCAT-;symmetric?;SB;9| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G440 NIL) (#2=#:G441 NIL) (#3=#:G443 NIL) (|j| NIL)
          (#4=#:G442 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |RMATCAT-;antisymmetric?;SB;10| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G450 NIL) (#2=#:G451 NIL) (#3=#:G453 NIL) (|j| NIL)
          (#4=#:G452 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|))
