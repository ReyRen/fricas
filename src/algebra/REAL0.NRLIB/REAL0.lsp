...
(SDEFUN |REAL0;makeSqfr| ((F |Pol|) ($ |Pol|))
        (SPROG
         ((#1=#:G400 NIL) (#2=#:G399 (|Pol|)) (#3=#:G401 (|Pol|))
          (#4=#:G404 NIL) (|s| NIL) (|sqfr| (|Factored| |Pol|)))
...
(SDEFUN |REAL0;realZeros;PolFL;6|
        ((F |Pol|) (|rn| |Fraction| (|Integer|))
         ($ |List|
          (|Record| (|:| |left| (|Fraction| (|Integer|)))
                    (|:| |right| (|Fraction| (|Integer|))))))
        (SPROG ((#1=#:G410 NIL) (|int| NIL) (#2=#:G409 NIL))
...
(SDEFUN |REAL0;realZeros;PolRFL;8|
        ((F |Pol|)
         ...
         ($ |List|
          (|Record| (|:| |left| (|Fraction| (|Integer|)))
                    (|:| |right| (|Fraction| (|Integer|))))))
        (SPROG ((#1=#:G423 NIL) (|int| NIL) (#2=#:G422 NIL))
               (SEQ (LETT F (|REAL0;makeSqfr| F $))
                    (EXIT
                     (PROGN
                      (LETT #2# NIL)
        ...
        (SPROG
         ((L
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G440 NIL) (|int| NIL) (#2=#:G439 NIL) (|b| (|Integer|)))
        ...
        (SPROG
         ((K
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G454 NIL) (|int| NIL) (#2=#:G453 NIL)
          (J
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#3=#:G452 NIL) (#4=#:G451 NIL) (G (|Pol|))
...
(SDEFUN |REAL0;transAdd1| ((F |Pol|) ($ |Pol|))
        (SPROG
         ((|ans| (|Pol|)) (#1=#:G479 NIL) (|i| NIL) (#2=#:G478 NIL) (|j| NIL)
          (#3=#:G477 NIL) (|v| (|Vector| (|Integer|)))
...
(SDEFUN |REAL0;invert| ((F |Pol|) ($ |Pol|))
        (SPROG ((G (|Pol|)) (#1=#:G486 NIL) (|n| (|NonNegativeInteger|)))
               (SEQ (LETT G (|spadConstant| $ 35))
...
(SDEFUN |REAL0;refine;PolRFR;20|
        ...
        (SPROG
         ((|xfl| (|Boolean|)) (|ad| #1=(|Integer|)) (|an| #2=(|Integer|))
          ...
          (|mid| (|Fraction| (|Integer|))) (|u| #3#) (#4=#:G507 NIL))
