...
(SDEFUN |MATLIN;rowAllZeroes?| ((|x| M) (|i| |Integer|) ($ |Boolean|))
        (SPROG ((#1=#:G407 NIL) (#2=#:G408 NIL) (#3=#:G409 NIL) (|j| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| |j| (QREFELT $ 13))
                             ...
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G406)))
                              (GO #5=#:G404))))))
...
(SDEFUN |MATLIN;colAllZeroes?| ((|x| M) (|j| |Integer|) ($ |Boolean|))
        (SPROG ((#1=#:G414 NIL) (#2=#:G415 NIL) (#3=#:G416 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| |j| (QREFELT $ 13))
                                       (|spadConstant| $ 14) (QREFELT $ 16))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G413)))
                              (GO #5=#:G411))))))
...
(SDEFUN |MATLIN;minorDet|
        ...
        (SPROG
         ((|j| (|Integer|)) (|rl| (|List| (|Integer|))) (|pos| (|Boolean|))
          (#2=#:G442 NIL) (|ans| (R)) (|md| (R)) (#3=#:G429 NIL)
...
(SDEFUN |MATLIN;minordet;MR;4| ((|x| M) ($ R))
        (SPROG
         ((#1=#:G457 NIL) (|i| NIL) (#2=#:G456 NIL) (#3=#:G455 NIL)
          (|maxC| (|Integer|)) (|minR| (|Integer|))
          (|v| (|PrimitiveArray| (|Union| R "uncomputed"))) (#4=#:G446 NIL)
...
(SDEFUN |MATLIN;fractionFreeGauss!;2M;8| ((|x| M) ($ M))
        (SPROG
         ((#1=#:G503 NIL) (|j| NIL) (|lasti| #2=(|Integer|)) (#3=#:G495 NIL)
          (#4=#:G497 NIL) (|i| #5=(|Integer|)) (|b| (R)) (#6=#:G478 NIL)
          (|val| (R)) (#7=#:G502 NIL) (|l| NIL) (|pv| (R)) (#8=#:G501 NIL)
          (#9=#:G500 NIL) (|k| NIL) (|c| (R)) (|ans| (R)) (#10=#:G496 NIL)
          (|rown| #2#) (#11=#:G499 NIL) (#12=#:G498 NIL) (|maxC| (|Integer|))
...
(SDEFUN |MATLIN;lastStep| ((|x| M) ($ M))
        (SPROG
         ((|iCol| #1=(|Integer|)) (#2=#:G508 NIL) (|ss| (R)) (#3=#:G505 NIL)
          (#4=#:G504 (R)) (#5=#:G506 (R)) (#6=#:G517 NIL) (|k| NIL)
          (#7=#:G516 NIL) (|j| NIL) (|i| NIL) (|iRow| #8=(|Integer|))
...
(SDEFUN |MATLIN;nullSpace;ML;18| ((|y| M) ($ |List| |Col|))
        (SPROG ((#1=#:G549 NIL) (|v| NIL) (#2=#:G548 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |v| NIL)
...
(SDEFUN |MATLIN;rank;MNni;21| ((|x| M) ($ |NonNegativeInteger|))
        (SPROG
         ((|rk| (|NonNegativeInteger|)) (#1=#:G556 NIL) (|i| (|Integer|))
...
(SDEFUN |MATLIN;rowEchelon;2M;25| ((|y| M) ($ M))
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G606 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G605 NIL) (|k| NIL) (|xij| (R)) (#4=#:G604 NIL) (|jj| NIL)
          (|un|
           (|Record| (|:| |unit| R) (|:| |canonical| R) (|:| |associate| R)))
          (|val2| (R)) (|val1| (R)) (#5=#:G603 NIL) (|a1| (R)) (#6=#:G579 NIL)
          (|b1| (R)) (|d| (R)) (|b| (R)) (|a| (R)) (|#G67| (R)) (|#G66| (R))
          (|#G65| (R))
          (|aa| (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (#7=#:G602 NIL) (|xnj| (R)) (|n| (|Integer|)) (|xkj| (R))
          (#8=#:G601 NIL) (#9=#:G599 NIL) (#10=#:G600 NIL) (|j| NIL)
                     ...
                     (SEQ
                      (COND
                       ((SPADCALL |i| |maxR| (QREFELT $ 46))
                        (PROGN (LETT #9# |$NoValue|) (GO #11=#:G596))))
                      (LETT |n| (- |minR| 1))
...
(DEFUN |MatrixLinearAlgebraFunctions| (&REST #1=#:G608)
  (SPROG NIL
         (PROG (#2=#:G609)
           (RETURN
            (COND
