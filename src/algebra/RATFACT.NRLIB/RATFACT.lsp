...
(SDEFUN |RATFACT;factor;RPF;1| ((|p| RP) ($ |Factored| RP))
        (SPROG
         ((#1=#:G399 NIL) (|u| NIL) (#2=#:G398 NIL)
          ...
          (|pden| (|Integer|)) (#3=#:G397 NIL) (|c| NIL) (#4=#:G396 NIL))
         (SEQ
          (COND
                     ...
                     (|:| |factors|
                          (|List|
                           (|Record|
                            ...
                            (|:| |pow| (|NonNegativeInteger|)))))))
          (|ipol| (|SparseUnivariatePolynomial| (|Integer|))) (|pol| (RP))
          (|pden| (|Integer|)) (#3=#:G415 NIL) (|c| NIL) (#4=#:G414 NIL))
         (SEQ
          (COND
           ((SPADCALL |p| (|spadConstant| $ 7) (QREFELT $ 11))
            (|spadConstant| $ 9))
...
(DEFUN |RationalFactorize| (#1=#:G418)
  (SPROG NIL
         (PROG (#2=#:G419)
           (RETURN
            (COND
