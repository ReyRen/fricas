...
(SDEFUN |FLAGG2;map;MAB;2| ((|f| |Mapping| R S) (|l| A) ($ B))
        (SPROG ((#1=#:G394 NIL) (|s| NIL) (#2=#:G393 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FLAGG2;map;MAB;4| ((|f| |Mapping| R S) (|l| A) ($ B))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G405 NIL) (|a| NIL) (|w| (B))
          (|l1| (|List| S)))
         (SEQ
          (COND ((SPADCALL |l| (QREFELT $ 11)) (SPADCALL (QREFELT $ 22)))
                ('T
...
(SDEFUN |FLAGG2;scan;MARB;5| ((|fn| |Mapping| R S R) (|l| A) (|ident| R) ($ B))
        (SPROG
         ((|i| (|Integer|)) (|vl| (R)) (#1=#:G411 NIL) (|a| NIL) (|w| (B))
          (|l1| (|List| S)))
         (SEQ
          (COND ((SPADCALL |l| (QREFELT $ 11)) (SPADCALL (QREFELT $ 22)))
                ('T
...
(SDEFUN |FLAGG2;map;MAB;6| ((|f| |Mapping| R S) (|l| A) ($ B))
        (SPROG ((#1=#:G415 NIL) (|s| NIL) (#2=#:G414 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FLAGG2;map;MAB;9| ((|f| |Mapping| R S) (|v| A) ($ B))
        (SPROG ((#1=#:G428 NIL) (|i| NIL) (#2=#:G427 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FLAGG2;map;MAB;11| ((|f| |Mapping| R S) (|v| A) ($ B))
        (SPROG
         ((#1=#:G438 NIL) (|i| NIL) (|w| (B)) (|i0| (|Integer|))
...
(SDEFUN |FLAGG2;scan;MARB;12|
        ((|fn| |Mapping| R S R) (|v| A) (|ident| R) ($ B))
        (SPROG
         ((|vl| (R)) (#1=#:G443 NIL) (|i| NIL) (|w| (B)) (|i0| (|Integer|))
          (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (SPADCALL |v| (QREFELT $ 34)))
              (EXIT
               (COND ((EQL |n| 0) (SPADCALL (QREFELT $ 22)))
...
(SDEFUN |FLAGG2;map;MAB;13| ((|f| |Mapping| R S) (|v| A) ($ B))
        (SPROG ((#1=#:G447 NIL) (|i| NIL) (#2=#:G446 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |FiniteLinearAggregateFunctions2| (&REST #1=#:G453)
  (SPROG NIL
         (PROG (#2=#:G454)
           (RETURN
            (COND
