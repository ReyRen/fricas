...
(SDEFUN |COMPUTIL;Ski2Lambda| ((|s| |SKICombinators| UT) ($ |Lambda| UT))
        (SPROG
         ((#1=#:G431 NIL) (|s112| #2=(|String|)) (|s12| #2#)
             ...
             ((SPADCALL |c1| (QREFELT $ 11))
              (SEQ
               (SPADCALL
                ...
                (QREFELT $ 17))
               (EXIT
                (PROGN (LETT #1# (|COMPUTIL;Ski2Lambda| |c2| $)) (GO #8#))))))
            (COND
             ...
             ((SPADCALL |c11| (QREFELT $ 22))
              (SEQ
               ...
               (SPADCALL
                ...
                (QREFELT $ 17))
               (EXIT
                (PROGN (LETT #1# (|COMPUTIL;Ski2Lambda| |c12| $)) (GO #8#))))))
            (COND
             ...
             ((SPADCALL |c111| (QREFELT $ 23))
              (SEQ
               ...
               (LETT |s12|
                     (SPADCALL (SPADCALL |c12| (QREFELT $ 24)) (QREFELT $ 25)))
               (LETT |s112|
                     (SPADCALL (SPADCALL |c112| (QREFELT $ 24))
                               (QREFELT $ 25)))
               (SPADCALL
                (SPADCALL
...
(SDEFUN |COMPUTIL;lambdaOverSki|
        ...
        (SPROG
         ((#1=#:G442 NIL) (|right| (|SKICombinators| UT))
...
(SDEFUN |COMPUTIL;coerce;LSkic;4| ((|lam| |Lambda| UT) ($ |SKICombinators| UT))
        (SPROG
         ((#1=#:G459 NIL) (|c32| #2=(|Lambda| UT)) (|c31| #3=(|Lambda| UT))
...
(SDEFUN |COMPUTIL;coerce;SkicIl;5| ((|s| |SKICombinators| UT) ($ |ILogic|))
        (SPROG
         ((#1=#:G478 NIL) (|bc| #2=(|ILogic|)) (|ac| #2#) (|ab| #2#)
          (|c| #3=(|ILogic|)) (|b| #3#) (|a| #3#)
