...
(SDEFUN |MATSTOR;copy!;3M;2| ((|c| |Matrix| R) (|a| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G418 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G417 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;plus!;4M;3|
        ...
        (SPROG
         ((#1=#:G429 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G428 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;minus!;3M;4|
        ...
        (SPROG
         ((#1=#:G438 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G437 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;minus!;4M;5|
        ((|c| |Matrix| R) (|a| |Matrix| R) (|b| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G449 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G448 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|bb| #4#)
          (|aa| #4#) (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;leftScalarTimes!;MR2M;6|
        ...
        (SPROG
         ((#1=#:G458 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G457 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;rightScalarTimes!;2MRM;7|
        ...
        (SPROG
         ((#1=#:G467 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G466 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;times!;4M;9|
        ((|c| |Matrix| R) (|a| |Matrix| R) (|b| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((|sum| (R)) (#1=#:G483 NIL) (|k| NIL)
          (|cRow| #2=(|PrimitiveArray| R)) (|aRow| #2#) (#3=#:G482 NIL)
          (|i| NIL) (#4=#:G481 NIL) (|j| NIL) (|n1| #5=(|Integer|)) (|m1| #5#)
          (|bCol| (|PrimitiveArray| R))
...
(SDEFUN |MATSTOR;power!;4MNniM;10|
        ...
        (SPROG
         ((#1=#:G499 NIL) (|flag| (|Boolean|)) (|nn| (|NonNegativeInteger|))
...
(DEFUN |StorageEfficientMatrixOperations| (#1=#:G503)
  (SPROG NIL
         (PROG (#2=#:G504)
           (RETURN
            (COND
