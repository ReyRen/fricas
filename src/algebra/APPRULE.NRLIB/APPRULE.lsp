...
(SDEFUN |APPRULE;applist|
        ((|lrule| |List| (|RewriteRule| |Base| R F)) (|arglist| |List| F)
         ($ |List| F))
        (SPROG ((#1=#:G393 NIL) (|arg| NIL) (#2=#:G392 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |APPRULE;splitRules|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          ...
          (|u| (|Union| (|Equation| F) "failed")) (#1=#:G403 NIL) (|r| NIL))
...
(SDEFUN |APPRULE;localApply|
        ((|lk| |List| (|Kernel| F)) (|lv| |List| F)
         ...
         (|n| |PositiveInteger|) ($ F))
        (SPROG
         ((#1=#:G419 NIL) (|k| NIL) (#2=#:G420 NIL) (|v| NIL) (#3=#:G418 NIL)
          (|i| NIL))
         (SEQ
...
(SDEFUN |APPRULE;rewrite|
        ((|f| F) (|res| |PatternMatchResult| |Base| F) (|l| |List| (|Symbol|))
         ($ F))
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F))) (#1=#:G426 NIL)
          (|rec| NIL))
...
(SDEFUN |APPRULE;isitwithpred|
        ...
        (SPROG
         ((#1=#:G431 NIL) (#2=#:G439 NIL) (|v| NIL) (#3=#:G428 NIL)
...
(SDEFUN |APPRULE;isit|
        ((|subject| F) (|pat| |Pattern| |Base|)
         ($ |PatternMatchResult| |Base| F))
        (SPROG ((#1=#:G444 NIL) (|l| (|List| (|Pattern| |Base|))) (|v| NIL))
               (SEQ
                (COND
...
(SDEFUN |APPRULE;app|
        ...
        (SPROG
         ((#1=#:G469 NIL) (#2=#:G466 NIL) (#3=#:G464 NIL) (|f| (F))
          (|ee| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|e|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #4="failed"))
          (#5=#:G457 NIL) (#6=#:G456 (F)) (#7=#:G458 (F)) (#8=#:G480 NIL)
          (#9=#:G383 NIL) (|l| (|Union| (|List| F) #4#)) (#10=#:G454 NIL)
          (#11=#:G453 (F)) (#12=#:G455 (F)) (#13=#:G479 NIL) (#14=#:G382 NIL)
          (|k| (|Union| (|Kernel| F) "failed")) (#15=#:G476 NIL)
          (#16=#:G477 NIL) (|u| (|PatternMatchResult| |Base| F))
          (#17=#:G478 NIL) (|r| NIL))
         (SEQ
          (EXIT
           (SEQ
