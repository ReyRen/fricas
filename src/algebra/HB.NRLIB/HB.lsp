...
(SDEFUN |HB;lfunc;3I;1| ((|d| |Integer|) (|n| |Integer|) ($ |Integer|))
        (SPROG
         ((|res| (|Integer|)) (#1=#:G409 NIL) (|sum| (|Integer|))
          (#2=#:G412 NIL) (|m| NIL))
         (SEQ
...
(SDEFUN |HB;basis;2NniV;3|
        ...
        (SPROG
         ((|numComms| #1=(|Integer|)) (|cW| (|Integer|))
          ...
          (#2=#:G430 NIL) (|rightIndex| NIL) (|done| (|Boolean|))
          (|wt| (|Integer|)) (|firstindex| (|Vector| (|Integer|)))
          (#3=#:G429 NIL) (|i| NIL) (|v| (|Vector| (|List| (|Integer|))))
          (#4=#:G416 NIL) (|siz| (|Integer|)) (#5=#:G428 NIL)
         ...
         (SEQ (LETT |gens| |n|) (LETT |maxweight| |c|) (LETT |siz| 0)
              ...
              (SPADCALL |firstindex| 1 1 (QREFELT $ 17))
