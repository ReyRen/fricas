...
(SDEFUN |DEFINTEF;checkForPole|
        ...
        (SPROG
         ((#1=#:G477 NIL) (|u| (|Union| (|Boolean|) "failed"))
...
(SDEFUN |DEFINTEF;checkFor0|
        ...
        (SPROG
         ((#2=#:G505 NIL) (|w| (|Union| (|Boolean|) #1#)) (|k| #3=(|Kernel| F))
          (|z|
           (|Union|
            (|Record| (|:| |var| #3#) (|:| |exponent| (|NonNegativeInteger|)))
            #4="failed"))
          (#5=#:G504 NIL) (#6=#:G506 NIL) (#7=#:G507 NIL) (|t| NIL)
          (|v|
...
(SDEFUN |DEFINTEF;checkSMP|
        ...
        (SPROG
         ((#2=#:G606 NIL) (|w| (|Union| (|Boolean|) #1#)) (|f2| (F))
          (#3=#:G607 NIL) (#4=#:G608 NIL) (#5=#:G605 NIL) (#6=#:G614 NIL)
          (|f| (F)) (|ak| (|List| F)) (|kk| #7=(|Kernel| F))
          (|z|
           (|Union|
            (|Record| (|:| |var| #7#) (|:| |exponent| (|NonNegativeInteger|)))
            #8="failed"))
          (|n| (R)) (#9=#:G617 NIL) (#10=#:G619 NIL) (|t| NIL)
          (|v|
           (|Union| (|List| (|SparseMultivariatePolynomial| R (|Kernel| F)))
                    #8#))
          (#11=#:G604 NIL) (#12=#:G618 NIL)
          (|u| (|Union| (|SparseUnivariatePolynomial| F) "failed")))
         (SEQ
          (EXIT
...
(SDEFUN |DEFINTEF;posit|
        ((|f| F) (|x| |Symbol|) (|k| |Kernel| F) (|a| |OrderedCompletion| F)
         (|b| |OrderedCompletion| F) ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((#1=#:G637 NIL) (|w| (|Union| (|Boolean|) "failed")) (#2=#:G638 NIL)
          (#3=#:G627 NIL) (|b2| #4=(|Boolean|))
                     ...
                     ((SPADCALL
                       (PROG2 (LETT #3# |z|)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0 (QREFELT $ 78))
                      (PROGN (LETT #2# (CONS 0 'T)) (GO #7=#:G635))))))))
            (LETT |z|
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((OR (QEQCAR |w| 1) (QCDR |w|))
                        (PROGN (LETT #1# (CONS 1 "failed")) (GO #8=#:G634))))))
                    (EXIT (CONS 0 NIL))))
                  #8# (EXIT #1#)))))))
            (EXIT (CONS 1 "failed"))))
          #7# (EXIT #2#)))) 
...
(SDEFUN |DEFINTEF;negat|
        ((|f| F) (|x| |Symbol|) (|k| |Kernel| F) (|a| |OrderedCompletion| F)
         (|b| |OrderedCompletion| F) ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((#1=#:G656 NIL) (|w| (|Union| (|Boolean|) "failed")) (#2=#:G657 NIL)
          (#3=#:G646 NIL) (|b2| #4=(|Boolean|))
          (|z| (|Union| (|Integer|) #5="failed")) (|r| (|Union| F "failed"))
          (|b1| #4#))
         (SEQ
          (EXIT
                     ...
                     ((<
                       (PROG2 (LETT #3# |z|)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0)
                      (PROGN (LETT #2# (CONS 0 'T)) (GO #7=#:G654))))))))
            (LETT |z|
                  (SEQ (LETT |r| (SPADCALL |b| (QREFELT $ 51)))
                       (EXIT
                        (COND
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((OR (QEQCAR |w| 1) (QCDR |w|))
                        (PROGN (LETT #1# (CONS 1 "failed")) (GO #8=#:G653))))))
                    (EXIT (CONS 0 NIL))))
                  #8# (EXIT #1#)))))))
            (EXIT (CONS 1 "failed"))))
          #7# (EXIT #2#)))) 
...
(SDEFUN |DEFINTEF;polyIfCan|
        ...
        (SPROG
         ((|q|
          ...
          (|ans| (|SparseUnivariatePolynomial| F)) (#1=#:G666 NIL) (|c| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |q| (SPADCALL |p| |x| (QREFELT $ 80)))
                (LETT |ans| (|spadConstant| $ 81))
                (SEQ G190
                     (COND
                      ((NULL
                        (SPADCALL |q| (|spadConstant| $ 83) (QREFELT $ 84)))
                       (GO G191)))
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |x|
                                   (SPADCALL
                                    (LETT |c|
                                          (SPADCALL
                                           (SPADCALL |q| (QREFELT $ 85))
                                           (QREFELT $ 86)))
                                    (QREFELT $ 88))
                                   (QREFELT $ 90))
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G665)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
                                          (SPADCALL |c|
                                                    ...
                                                    (QREFELT $ 93))
                                          (QREFELT $ 94)))
                          (EXIT (LETT |q| (SPADCALL |q| (QREFELT $ 95)))))))))
...
(SDEFUN |DEFINTEF;nopole|
        ((|f| F) (|x| |Symbol|) (|k| |Kernel| F) (|a| |OrderedCompletion| F)
         ...
         ($ |Union| (|:| |f1| (|OrderedCompletion| F))
          ...
          (|:| |pole| "potentialPole")))
        (SPROG
         ((|ans| (|List| (|OrderedCompletion| F))) (#2=#:G683 NIL)
          (|v| (|Union| (|OrderedCompletion| F) "failed")) (#3=#:G684 NIL)
          (|g| NIL) (|u| (|Union| F (|List| F))))
         (SEQ
          (EXIT
           (SEQ (LETT |u| (SPADCALL |f| |x| (QREFELT $ 98)))
                (EXIT
                 (COND
                  ((QEQCAR |u| 0)
                   (SEQ
                    (LETT |v|
                          (SPADCALL |k| (QCDR |u|) |a| |b| NIL
                                    (QREFELT $ 100)))
                    (EXIT
...
(DEFUN |ElementaryFunctionDefiniteIntegration| (&REST #1=#:G685)
  (SPROG NIL
         (PROG (#2=#:G686)
           (RETURN
            (COND
...
(MAKEPROP '|ElementaryFunctionDefiniteIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (8 . |coerce|)
              (|Union| (|:| |f1| 10) (|:| |f2| 101) (|:| |fail| '#1="failed")
                       (|:| |pole| '#2="potentialPole"))
              ...
              (|Record| (|:| |var| 30) (|:| |exponent| 91)) (|Union| 41 '#3#)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 102
                                            '(4 11 8 7 9 10 10 12 1 10 0 7 13 5
                                              ...
                                              77 2 72 15 0 0 78 2 39 79 0 30 80
                                              0 36 0 81 0 82 0 83 2 82 15 0 0
                                              84 1 82 39 0 85 1 7 0 32 86 1 7
                                              87 0 88 2 89 15 30 0 90 1 82 91 0
                                              92 2 36 0 7 91 93 2 36 0 0 0 94 1
                                              82 0 0 95 2 97 96 7 9 98 5 25 99
                                              30 7 10 10 15 100 2 101 0 0 0 102
                                              2 0 14 7 17 23 3 0 14 7 17 24 27
                                              5 0 14 7 9 10 10 15 16)))))
           '|lookupComplete|)) 
