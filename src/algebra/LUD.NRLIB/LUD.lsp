...
(SDEFUN |LUD;LUDecomp;MR;1|
        ((AA |Matrix| D)
         ($ |Record| (|:| LU (|Matrix| D)) (|:| |Perm| (|Vector| (|Integer|)))
          (|:| |Pivots| (|List| D))))
        (SPROG
         ((#1=#:G411 NIL) (|k| NIL) (|d| (D)) (|Pivs| (|List| D))
          (|i0| (|Integer|)) (|s| (D)) (#2=#:G410 NIL) (#3=#:G409 NIL)
          (|i| NIL) (#4=#:G408 NIL) (#5=#:G407 NIL) (#6=#:G406 NIL) (|j| NIL)
          (|PermV| (|Vector| (|Integer|))) (#7=#:G389 NIL) (|maxC| (|Integer|))
...
(SDEFUN |LUD;LUSolve;MV2V;2|
        ((LU |Matrix| D) (|Perm| |Vector| (|Integer|)) (XX |Vector| D)
         ($ |Vector| D))
        (SPROG
         ((|s| (D)) (#1=#:G425 NIL) (|j| NIL) (#2=#:G424 NIL) (|i| NIL)
          (|ii| (|Integer|)) (#3=#:G423 NIL) (|ip| (|Integer|)) (#4=#:G422 NIL)
...
(SDEFUN |LUD;LUInverse;MR;3|
        ...
        (SPROG
         ((|res| (|Matrix| D)) (|v| (|Vector| D)) (#1=#:G433 NIL) (|i| NIL)
