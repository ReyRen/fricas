...
(SDEFUN |SMATCAT-;diagonal;SRow;5| ((|x| S) ($ |Row|))
        (SPROG
         ((#1=#:G408 NIL) (|i| NIL) (#2=#:G409 NIL) (|j| NIL) (#3=#:G410 NIL)
          (|k| NIL) (|v| (|Vector| R)))
...
(SDEFUN |SMATCAT-;equation2R| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G423 NIL) (|j| NIL) (#2=#:G422 NIL) (|i| NIL)
          (|ans| (|Matrix| |Col|)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |SMATCAT-;reducedSystem;MM;9| ((|x| |Matrix| S) ($ |Matrix| R))
        (SPROG ((#1=#:G430 NIL) (|i| NIL) (#2=#:G429 NIL))
               (SEQ
                (COND
...
(SDEFUN |SMATCAT-;trace;SR;11| ((|x| S) ($ R))
        (SPROG ((|tr| (R)) (#1=#:G440 NIL) (|i| NIL) (#2=#:G441 NIL) (|j| NIL))
...
(SDEFUN |SMATCAT-;diagonalProduct;SR;12| ((|x| S) ($ R))
        (SPROG ((|pr| (R)) (#1=#:G445 NIL) (|i| NIL) (#2=#:G446 NIL) (|j| NIL))
               (SEQ
                (LETT |pr|
