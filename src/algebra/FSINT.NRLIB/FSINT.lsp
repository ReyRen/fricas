...
(SDEFUN |FSINT;find_int|
        ...
        (SPROG
         ((#1=#:G438 NIL) (|akl| #2=(|List| F)) (#3=#:G439 NIL) (|k| NIL)
...
(SDEFUN |FSINT;postSubst|
        ...
        (SPROG
         ((#1=#:G481 NIL) (|k| (|Kernel| F)) (#2=#:G480 NIL) (#3=#:G479 NIL)
          (#4=#:G478 NIL) (|ltemp| (|List| (|Kernel| F))) (#5=#:G477 NIL)
          (#6=#:G476 NIL) (|tf| (|List| (|Kernel| F))) (#7=#:G474 NIL)
          (#8=#:G475 NIL) (|v| NIL) (|vkv| (F)) (|vc| (F)) (|vkf| (F))
          (|vk| (|Kernel| F)) (|vkl| (|List| (|Kernel| F))) (#9=#:G473 NIL)
          (|kk| NIL) (#10=#:G472 NIL) (|uk| (|Kernel| F))
          (|u| (|Union| (|Kernel| F) "failed")) (#11=#:G470 NIL)
          (#12=#:G471 NIL))
         (SEQ
...
(SDEFUN |FSINT;inv_lst|
        ...
        (SPROG
         ((|rese| (|List| (|Expression| (|Complex| R))))
          ...
          (|k1| #1=(|Expression| (|Complex| R))) (|e1| #1#) (#2=#:G496 NIL)
          (|k| NIL) (#3=#:G497 NIL) (|e| NIL) (|im| (|Complex| R)))
...
(SDEFUN |FSINT;inv_alg_lst|
        ...
        (SPROG
         ((|rese| (|List| F)) (|resk| (|List| (|Kernel| F)))
          ...
          (|e1| (|Expression| (|Complex| R))) (#1=#:G510 NIL) (|k| NIL)
          (|im| (F)))
         (SEQ (LETT |resk| NIL) (LETT |rese| NIL)
              (LETT |im|
...
(SDEFUN |FSINT;integrate;FSU;15|
        ...
        (SPROG
         ((|rl| (|List| F)) (#1=#:G574 NIL) (|h| NIL) (#2=#:G573 NIL)
          ...
          (|rtg1|
           (|Record|
            (|:| |ker| (|List| (|Kernel| (|Expression| (|Complex| R)))))
            (|:| |val| (|List| (|Expression| (|Complex| R))))))
          (|tgg1| (|List| (|Expression| (|Complex| R)))) (#4=#:G572 NIL)
          (|k| NIL) (#5=#:G571 NIL)
          ...
          (|tg| (|List| (|Kernel| F))) (#7=#:G570 NIL) (#8=#:G569 NIL)
          ...
          (|pr|
           (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                     (|:| |radicand| F)))
          (|ak2| (|NonNegativeInteger|)) (#10=#:G537 NIL) (|ak1| (F))
          (|akl| (|List| F)) (#11=#:G568 NIL) (|tf2| #9#)
          (|rec|
          ...
          (#12=#:G566 NIL) (#13=#:G567 NIL) (|v| NIL) (|etf| (|List| F))
          (#14=#:G565 NIL) (#15=#:G564 NIL) (|ht| #6#) (|ltf| #3#) (|tf| #9#))
         (SEQ
          (COND
           ...
           ('T
            (SEQ
             ...
             (LETT |rec| (SPADCALL |f1| |x| (QREFELT $ 120)))
             ...
             (COND
              ((|FSINT;goComplex?| |rtg| |tg| |ltg| $)
               (SEQ (LETT |ralg| (|FSINT;inv_alg_lst| |tg0| $))
                    ...
                    (LETT |tgg0| (SPADCALL |gg0| (QREFELT $ 137)))
                    (LETT |tgg1|
                          (PROGN
                           (LETT #5# NIL)
                     ...
                     (LETT |i|
                           (SPADCALL |i|
                                     (SPADCALL
                                      ...
                                      (QREFELT $ 133))
                                     (QREFELT $ 147))))))
              (#16='T (LETT |i| (SPADCALL |g| |x| (QREFELT $ 149)))))
             (LETT |i|
                   (SPADCALL
                    (CONS #'|FSINT;integrate;FSU;15!7|
                          (VECTOR $ |ir_lst| |nr_lst|))
                    |i| (QREFELT $ 152)))
             (LETT |ltg0| (SPADCALL |ltg0| |ltf| (QREFELT $ 153)))
             (LETT |rl|
                   (PROGN
                    (LETT #2# NIL)
                    (SEQ (LETT |h| NIL)
...
(DEFUN |FunctionSpaceIntegration| (&REST #1=#:G575)
  (SPROG NIL
         (PROG (#2=#:G576)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 155
                                            '(2 14 0 12 13 15 1 18 17 0 19 1 21
                                              ...
                                              3 7 0 0 70 71 106 2 107 7 7 12
                                              108 1 59 28 7 109 1 7 0 12 110 2
                                              7 0 0 0 111 2 76 0 112 0 113 2 76
                                              28 112 0 114 2 55 7 7 12 115 2 7
                                              28 0 0 116 1 14 12 0 117 2 7 0 0
                                              0 118 2 55 119 7 12 120 2 17 7 0
                                              75 121 1 7 75 0 122 2 124 123 7
                                              13 125 1 7 126 0 127 1 129 128 0
                                              130 1 7 0 75 131 2 7 0 14 71 132
                                              1 7 24 0 133 1 7 134 0 135 2 134
                                              28 12 0 136 1 20 70 0 137 2 21 20
                                              20 101 138 3 20 0 0 70 71 139 2
                                              141 140 20 12 142 2 144 38 143
                                              140 145 2 146 38 38 18 147 2 148
                                              38 7 12 149 2 151 38 150 38 152 2
                                              76 0 0 0 153 2 0 154 7 12
                                              155)))))
           '|lookupComplete|)) 
