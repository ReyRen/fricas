...
(SDEFUN |SFQCMPK;squareFreeFactors| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|lsflp| (|List| P)) (|lsfp| (|List| P)) (#1=#:G451 NIL) (|p| NIL))
         (SEQ (LETT |lsflp| NIL)
...
(SDEFUN |SFQCMPK;moreAlgebraic?;2TSB;6| ((|ts| TS) (|us| TS) ($ |Boolean|))
        (SPROG ((#1=#:G479 NIL) (#2=#:G480 NIL) (#3=#:G481 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |SFQCMPK;internalSubQuasiComponent?;2TSU;13|
        ...
        (SPROG
         ((#1=#:G543 NIL) (|b| (|Boolean|)) (#2=#:G546 NIL) (|p| NIL)
          (|lsfp| (|List| P)) (#3=#:G541 NIL) (#4=#:G545 NIL) (#5=#:G542 NIL)
          (#6=#:G527 NIL) (#7=#:G544 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |SFQCMPK;internalSubQuasiComponent?;2TSU;14|
        ((|ts| TS) (|us| TS) ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((#1=#:G561 NIL) (#2=#:G563 NIL) (#3=#:G565 NIL) (|p| NIL)
          (#4=#:G562 NIL) (#5=#:G552 NIL) (#6=#:G564 NIL))
         (SEQ
          (EXIT
           (COND ((SPADCALL |us| |ts| (QREFELT $ 53)) (CONS 0 'T))
                 ((NULL (SPADCALL |ts| |us| (QREFELT $ 47))) (CONS 0 NIL))
...
(SDEFUN |SFQCMPK;subQuasiComponent?;TSLB;16|
        ...
        (SPROG ((#1=#:G577 NIL) (#2=#:G578 NIL) (#3=#:G579 NIL) (|us| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |ts| |us| (QREFELT $ 62))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G576)))
                              (GO #5=#:G574))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |SFQCMPK;removeAssociates| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G629 NIL) (|p| NIL) (#2=#:G628 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |SFQCMPK;branchIfCan;LTSL5BU;20|
        ((|leq| |List| P) (|ts| TS) (|lineq| |List| P) (|b1| |Boolean|)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|newleq| (|List| P)) (#1=#:G668 NIL) (|newp| (P)) (#2=#:G650 NIL)
          (|g| (P)) (#3=#:G672 NIL) (|q| NIL) (#4=#:G671 NIL) (|p| NIL)
          (#5=#:G665 NIL) (#6=#:G670 NIL) (#7=#:G666 NIL) (#8=#:G669 NIL)
          (|ps| (|GeneralPolynomialSet| R E V P)) (#9=#:G667 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
          ...
          (|newBranch|
           #6=(|Union|
               (|Record| (|:| |eq| (|List| P)) (|:| |tower| TS)
                         (|:| |ineq| (|List| P)))
               "failed"))
          (|lineq| #2#) (|leq| #1#) (|ubf2| #6#) (|ubf1| #6#) (#7=#:G709 NIL)
          (|branch| NIL) (#8=#:G708 NIL) (|f| NIL) (|lsfp| (|List| P))
          (#9=#:G707 NIL) (|p| NIL) (#10=#:G706 NIL) (#11=#:G705 NIL))
         (SEQ
          (LETT |lp|
                (SPADCALL (ELT $ 16)
                          (SPADCALL (ELT $ 68)
...
(DEFUN |SquareFreeQuasiComponentPackage| (&REST #1=#:G712)
  (SPROG NIL
         (PROG (#2=#:G713)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 103
                                            '(1 12 11 9 13 2 11 0 0 0 14 2 9 15
                                              ...
                                              69 2 10 15 9 0 70 2 0 71 10 10 72
                                              2 10 9 9 0 73 1 22 71 21 74 2 22
                                              20 21 15 75 2 78 0 77 0 79 2 78 0
                                              0 0 80 2 39 0 0 0 82 1 9 0 0 84 2
                                              11 0 85 0 86 1 9 15 0 87 2 11 15
                                              85 0 88 1 12 11 11 89 1 90 0 11
                                              91 2 90 92 9 0 93 2 8 15 0 0 94 2
                                              9 0 0 0 95 2 9 51 0 0 96 2 101 0
                                              100 0 102 2 0 15 10 10 38 2 0 15
                                              10 10 53 2 0 15 10 39 76 2 0 15
                                              10 10 62 2 0 15 11 11 59 2 0 15
                                              63 63 64 0 0 20 33 3 0 20 24 24
                                              24 29 1 0 39 39 83 1 0 78 78 81 4
                                              0 101 11 39 15 15 103 2 0 15 10
                                              10 47 2 0 71 10 10 72 2 0 15 11
                                              11 58 2 0 15 11 11 60 2 0 15 11
                                              11 61 8 0 98 11 10 11 15 15 15 15
                                              15 99 1 0 39 39 43)))))
           '|lookupComplete|)) 
