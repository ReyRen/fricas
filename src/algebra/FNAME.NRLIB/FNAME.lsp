...
(SDEFUN |FNAME;=;2$B;1| ((|f1| $) (|f2| $) ($ |Boolean|)) (EQUAL |f1| |f2|)) 
...
(SDEFUN |FNAME;directory;$S;6| ((|f| $) ($ |String|)) (|fnameDirectory| |f|)) 
...
(SDEFUN |FNAME;readable?;$B;10| ((|f| $) ($ |Boolean|)) (|fnameReadable?| |f|)) 

(PUT '|FNAME;writable?;$B;11| '|SPADreplace| '|fnameWritable?|) 

(SDEFUN |FNAME;writable?;$B;11| ((|f| $) ($ |Boolean|)) (|fnameWritable?| |f|)) 

(PUT '|FNAME;new;3S$;12| '|SPADreplace| '|fnameNew|) 

(SDEFUN |FNAME;new;3S$;12|
        ((|d| . #1=(|String|)) (|pref| . #1#) (|e| . #1#) ($ $))
        (|fnameNew| |d| |pref| |e|)) 
