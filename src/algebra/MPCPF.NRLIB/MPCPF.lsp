...
(SDEFUN |MPCPF;factor;PPRF;1| ((|p| PPR) ($ |Factored| PPR))
        (SPROG
         ((#1=#:G396 NIL) (#2=#:G395 #3=(|Factored| PPR)) (#4=#:G397 #3#)
          (#5=#:G403 NIL) (|ff| NIL) (|fcont| (PPR))
          (|ffact|
           (|List|
            (|Record| (|:| |irr| PPR) (|:| |pow| (|NonNegativeInteger|)))))
          (#6=#:G402 NIL) (|u| NIL) (#7=#:G401 NIL)
          (|flist| (|Factored| (|Polynomial| R))) (|g| (|Polynomial| R))
          (|vars| (|List| OV)) (#8=#:G384 NIL) (|c| (|Polynomial| R)))
         (SEQ
...
(DEFUN |MPolyCatPolyFactorizer| (&REST #1=#:G404)
  (SPROG NIL
         (PROG (#2=#:G405)
           (RETURN
            (COND
