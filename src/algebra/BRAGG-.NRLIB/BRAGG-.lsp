...
(SDEFUN |BRAGG-;isCycle?| ((|x| A) (|acc| |List| A) ($ |Boolean|))
        (SPROG ((#1=#:G471 NIL) (#2=#:G472 NIL) (#3=#:G473 NIL) (|y| NIL))
               (SEQ
                (EXIT
                 (COND ((SPADCALL |x| (QREFELT $ 15)) NIL)
...
(SDEFUN |BRAGG-;eqMember?| ((|y| A) (|l| |List| A) ($ |Boolean|))
        (SPROG ((#1=#:G478 NIL) (#2=#:G479 NIL) (#3=#:G480 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |x| |y| (QREFELT $ 48))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G477)))
                              (GO #5=#:G475))))))
