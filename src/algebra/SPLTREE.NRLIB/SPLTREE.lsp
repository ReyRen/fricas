...
(SDEFUN |SPLTREE;construct;VCL$;5|
        ...
        (SPROG ((#1=#:G447 NIL) (|s| NIL) (#2=#:G446 NIL))
               (SEQ
                (|SPLTREE;per|
...
(SDEFUN |SPLTREE;map;M2$;17|
        ...
        (SPROG ((#2=#:G485 NIL) (|c| NIL) (#3=#:G484 NIL) (|b| ($)))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;map!;M2$;18|
        ((|foo| |Mapping| #1=(|SplittingNode| V C) #1#) (|a| $) ($ $))
        (SPROG ((#2=#:G492 NIL) (|c| NIL) (#3=#:G491 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;nodes;$L;21| ((|a| $) ($ |List| $))
        (SPROG ((#1=#:G501 NIL) (|c| NIL) (#2=#:G500 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) NIL)
...
(SDEFUN |SPLTREE;members;$L;23| ((|a| $) ($ |List| (|SplittingNode| V C)))
        (SPROG ((#1=#:G513 NIL) (|c| NIL) (#2=#:G512 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) NIL)
                      ((SPADCALL |a| (QREFELT $ 41))
                       (LIST (SPADCALL |a| (QREFELT $ 25))))
...
(SDEFUN |SPLTREE;#;$Nni;24| ((|a| $) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G521 NIL) (|c| NIL) (#2=#:G520 NIL))
               (SEQ
...
(SDEFUN |SPLTREE;localCoerce|
        ...
        (SPROG
         ((|lo| (|List| (|OutputForm|))) (#1=#:G537 NIL) (|c| NIL)
          (#2=#:G536 NIL) (|ro| (|OutputForm|)) (|s| (|String|))
          (#3=#:G535 NIL) (|i| NIL))
...
(SDEFUN |SPLTREE;extractSplittingLeaf;$U;28|
        ((|a| $) ($ |Union| $ #1="failed"))
        (SPROG ((|la| (|List| $)) (#2=#:G551 NIL) (|esl| (|Union| $ #1#)))
               (SEQ
                (EXIT
                 (COND
...
(DEFUN |SplittingTree| (&REST #1=#:G615)
  (SPROG NIL
         (PROG (#2=#:G616)
           (RETURN
            (COND
...
(DEFUN |SplittingTree;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G612 NIL) (#2=#:G613 NIL) (#3=#:G614 NIL) ($ NIL)
