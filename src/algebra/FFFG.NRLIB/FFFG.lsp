...
(SDEFUN |FFFG;DiffC;NniL;6| ((|total| |NonNegativeInteger|) ($ |List| D))
        (SPROG ((#1=#:G406 NIL) (|i| NIL) (#2=#:G405 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FFFG;generalCoefficient;MVNniVD;7|
        ...
        (SPROG
         ((|res| (D)) (#1=#:G415 NIL) (|l| NIL)
          (|b| (|SparseUnivariatePolynomial| D)) (|a| (V)) (#2=#:G414 NIL)
          (|i| NIL))
...
(SDEFUN |FFFG;nextVector!|
        ...
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G452 NIL) (|sum| (|Integer|)) (#3=#:G440 NIL)
          (#4=#:G454 NIL) (|j| NIL) (#5=#:G453 NIL) (|i| NIL)
          ...
          (EXIT
           (SEQ (LETT |n| (SPADCALL |v| (QREFELT $ 48)))
                ...
                (EXIT
                 (COND
                  ((ZEROP |pos|)
                   (PROGN (LETT #2# (CONS 0 "failed")) (GO #6=#:G451)))
                  (#7='T
                   (SEQ
                    (COND
                     ((EQL |pos| 1)
...
(SDEFUN |FFFG;initialVector|
        ...
        (SPROG
         ((#1=#:G471 NIL) (#2=#:G469 NIL) (|entry| (|Integer|)) (#3=#:G477 NIL)
          (|i| NIL) (#4=#:G476 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |FFFG;interpolate;2LNniF;17|
        ...
        (SPROG
         ((M (|Matrix| (|SparseUnivariatePolynomial| D)))
          (|eta| (|List| (|NonNegativeInteger|))) (#1=#:G487 NIL)
          (|c|
           (|Mapping| D (|NonNegativeInteger|)
                      (|Vector| (|SparseUnivariatePolynomial| D))))
...
(SDEFUN |FFFG;recurrence|
        ((M |Matrix| (|SparseUnivariatePolynomial| D))
         ...
         ($ |Matrix| (|SparseUnivariatePolynomial| D)))
        (SPROG
         ((#1=#:G494 NIL) (|newMiPi| (|SparseUnivariatePolynomial| D))
          (|pl| (D)) (|Mil| (|SparseUnivariatePolynomial| D)) (|rl| (D))
          (#2=#:G503 NIL) (|l| NIL) (|MiPi| (|SparseUnivariatePolynomial| D))
          (#3=#:G502 NIL) (|i| NIL) (|polyf| (|SparseUnivariatePolynomial| D))
          (|rPi| (D)))
...
(SDEFUN |FFFG;fffg;LMVNniM;19|
        ...
        (SPROG
         ((|d| (D)) (M (|Matrix| (|SparseUnivariatePolynomial| D)))
          (#1=#:G508 NIL) (#2=#:G519 NIL) (|l| NIL)
          (|lambda| (|NonNegativeInteger|)) (|lambdaMax| (|Integer|))
          (|vdl| (|Integer|)) (#3=#:G518 NIL) (#4=#:G517 NIL) (|k| NIL)
          (|p| #5=(|Vector| D)) (|r| #5#)
...
(SDEFUN |FFFG;fffg;LMLM;20|
        ((C |List| D)
         ...
         ($ |Matrix| (|SparseUnivariatePolynomial| D)))
        (SPROG
         ((|vd| (|Vector| (|Integer|))) (#1=#:G528 NIL) (|ei| NIL)
          (#2=#:G527 NIL))
         (SEQ
          (LETT |vd|
                (SPADCALL
...
(DEFUN |FractionFreeFastGaussian| (&REST #1=#:G529)
  (SPROG NIL
         (PROG (#2=#:G530)
           (RETURN
            (COND
