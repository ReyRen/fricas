...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G402 NIL) (|u| (|Union| R "failed")) (#2=#:G403 NIL)
          (#3=#:G394 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
                ...
                (SEQ (LETT |i| 0)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G401)))
                        ('T
                         (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G426)
  (SPROG NIL
         (PROG (#2=#:G427)
           (RETURN
            (COND
