...
(SDEFUN |PRIMES;primes;2IL;1| ((|m| I) (|n| I) ($ |List| I))
        (SPROG
         ((|ll| (|List| I)) (#1=#:G419 NIL) (|k| NIL) (#2=#:G418 NIL)
          (|m0| (I)))
         (SEQ
          (COND
          ...
          (LETT |ll|
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| (SPADCALL |m| (QREFELT $ 39)))
                      (LETT #1# (SPADCALL |n| (QREFELT $ 39))) G190
                      (COND ((> |k| #1#) (GO G191)))
                      (SEQ
                       (EXIT
                        (COND
...
(SDEFUN |PRIMES;rabinProvesCompositeSmall|
        ((|p| I) (|n| I) (|nm1| I) (|q| I) (|k| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G426 NIL) (#2=#:G425 NIL) (|t| (I)) (|oldt| (I))
          (#3=#:G427 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |t| (SPADCALL |p| |q| |n| (QREFELT $ 44)))
                (COND
                     ...
                     (SEQ
                      (EXIT
                       (SEQ (LETT |j| 1) (LETT #3# (- |k| 1)) G190
                            ...
                            (SEQ (LETT |oldt| |t|)
                                 (LETT |t|
                                       (SPADCALL |t| |t| |n| (QREFELT $ 46)))
                                 (EXIT
                                  (COND
                                   ((SPADCALL |t| (|spadConstant| $ 11)
                                              (QREFELT $ 45))
                                    (PROGN (LETT #1# 'T) (GO #4=#:G424)))
...
(SDEFUN |PRIMES;rabinProvesComposite|
        ((|p| I) (|n| I) (|nm1| I) (|q| I) (|k| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G435 NIL) (#2=#:G434 NIL) (|t| (I)) (|oldt| (I))
          (#3=#:G436 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |t| (SPADCALL |p| |q| |n| (QREFELT $ 44)))
...
(SDEFUN |PRIMES;prime?;IB;4| ((|n| I) ($ |Boolean|))
        (SPROG
         ((#1=#:G468 NIL) (#2=#:G471 NIL) (|probablySafe| (I))
          (|currPrime| (I)) (#3=#:G470 NIL) (|n9| (I)) (#4=#:G469 NIL)
          (#5=#:G472 NIL) (|i| NIL) (|mn| (|Integer|)) (|q| (I)) (|k| NIL)
          (|nm1| (I)))
         (SEQ
          (EXIT
           (SEQ
                      ...
                      (SEQ
                       (LETT |nm1|
                             (SPADCALL |n| (|spadConstant| $ 11)
                                       (QREFELT $ 55)))
                       (LETT |q|
                             (SPADCALL |nm1| (QREFELT $ 17) (QREFELT $ 56)))
                       (SEQ (LETT |k| 1) G190
                            (COND
                ...
                (SEQ
                 ...
                 (SEQ G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT |n|
                              (SPADCALL |n| (QREFELT $ 17) (QREFELT $ 38)))))
                      NIL (GO G190) G191 (EXIT NIL))
                 (EXIT |n|)))))) 
...
(DEFUN |IntegerPrimesPackage| (#1=#:G484)
  (SPROG NIL
         (PROG (#2=#:G485)
           (RETURN
            (COND
...
(DEFUN |IntegerPrimesPackage;| (|#1|)
  (SPROG
   ((#1=#:G412 NIL) (#2=#:G411 NIL) (#3=#:G413 NIL) (#4=#:G483 NIL)
    (#5=#:G382 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (SEQ
    (PROGN
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 66
                                            '(1 6 0 7 8 2 6 0 0 0 10 0 6 0 11 2
                                              6 0 0 14 15 2 14 0 0 14 22 0 27 0
                                              28 2 31 0 30 30 32 0 6 0 34 2 6
                                              35 0 0 36 1 6 35 0 37 2 6 0 0 0
                                              38 1 6 7 0 39 2 6 35 0 0 41 3 6 0
                                              0 0 0 44 2 6 35 0 0 45 3 6 0 0 0
                                              0 46 2 31 30 0 7 47 3 31 30 0 7
                                              30 48 2 27 0 0 6 49 1 27 30 0 50
                                              2 30 35 0 0 51 1 6 0 0 52 2 42 35
                                              6 0 53 2 6 0 0 0 54 2 6 0 0 0 55
                                              2 6 0 0 0 56 1 6 35 0 57 1 42 7 0
                                              58 2 42 6 0 7 59 2 6 35 0 0 60 2
                                              6 0 14 0 61 1 62 35 6 63 2 6 0 0
                                              0 64 2 0 42 6 6 43 1 0 35 6 40 1
                                              0 6 6 66 1 0 6 6 65)))))
           '|lookupComplete|)) 
