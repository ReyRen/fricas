...
(SDEFUN |FGLMICPK;zeroDim?|
        ...
        (SPROG
         ((|lv| (|List| (|OrderedVariableList| |ls|)))
          (|x| (|OrderedVariableList| |ls|)) (#1=#:G389 NIL)
          (|m| (|HomogeneousDistributedMultivariatePolynomial| |ls| R))
          (#2=#:G401 NIL) (|q2| NIL) (#3=#:G400 NIL) (|s| NIL) (#4=#:G399 NIL))
...
(SDEFUN |FGLMICPK;fglmIfCan;LU;3|
        ...
        (SPROG
         ((#1=#:G421 NIL) (|q3| NIL) (#2=#:G420 NIL)
          (|lq3| (|List| (|DistributedMultivariatePolynomial| |ls| R)))
          (|lq2|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |ls| R)))
          (#3=#:G419 NIL) (|q1| NIL) (#4=#:G418 NIL))
         (SEQ
          (LETT |lq2|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |FGLMICPK;groebner;2L;4|
        ...
        (SPROG
         ((#1=#:G437 NIL) (|q3| NIL) (#2=#:G436 NIL)
          (|lq3| (|List| (|DistributedMultivariatePolynomial| |ls| R)))
          (#3=#:G435 NIL) (#4=#:G434 NIL) (#5=#:G433 NIL) (|q1| NIL)
          (#6=#:G432 NIL)
          (|lq2|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |ls| R)))
          (#7=#:G431 NIL) (#8=#:G430 NIL))
         (SEQ
          (LETT |lq2|
                (PROGN
                 (LETT #8# NIL)
...
(DEFUN |FGLMIfCanPackage| (&REST #1=#:G438)
  (SPROG NIL
         (PROG (#2=#:G439)
           (RETURN
            (COND
