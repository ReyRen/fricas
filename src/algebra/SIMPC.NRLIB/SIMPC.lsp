...
(SDEFUN |SIMPC;simplicialComplex;LNniL$;1|
        ...
        (SPROG ((|res| (|List| (|OrientedFacet|))) (#1=#:G411 NIL) (|f| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |SIMPC;simplicialComplex;LL$;2|
        ...
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G418 NIL) (|fac| NIL) (|facs| (|List| (|OrientedFacet|)))
          (#2=#:G417 NIL) (|f| NIL))
         (SEQ (LETT |facs| NIL)
...
(SDEFUN |SIMPC;simplicialComplexIfCan;DcBU;5|
        ...
        (SPROG
         ((|res| (|List| (|OrientedFacet|))) (#1=#:G453 NIL) (|r| NIL)
          (|orf| (|OrientedFacet|)) (#2=#:G447 NIL)
          ...
          (#3=#:G434 NIL) (#4=#:G452 NIL) (|i| NIL) (#5=#:G451 NIL)
          (|facet| NIL) (|thisPoint| #6=(|NonNegativeInteger|)) (#7=#:G450 NIL)
          (|NumPoints| #6#) (|lastMap| (|List| (|List| (|OrientedFacet|))))
          (#8=#:G448 NIL) (|map| NIL) (#9=#:G449 NIL) (|grade| NIL)
...
(SDEFUN |SIMPC;addSimplex;$Of$;6| ((|a| $) (|f| |OrientedFacet|) ($ $))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|max| (|NonNegativeInteger|))
          (#1=#:G466 NIL) (|orf2| NIL) (|res2| (|List| (|OrientedFacet|)))
          (#2=#:G465 NIL) (|orf| NIL) (|res| (|List| (|OrientedFacet|)))
          (|found| (|Boolean|)) (|m| (|Integer|)) (#3=#:G464 NIL))
...
(SDEFUN |SIMPC;maxIndex;$Nni;7| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G471 NIL) (|fac| NIL) (|facs| (|List| (|OrientedFacet|))))
...
(SDEFUN |SIMPC;minIndex;$Nni;8| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G479 NIL) (|fac| NIL) (#2=#:G478 NIL)
          (|facs| (|List| (|OrientedFacet|))))
         (SEQ
          (EXIT
           (SEQ (LETT |res| 10000) (LETT |facs| (QVELT |s| 2))
                (COND
                 ((EQL (LENGTH |facs|) 0) (PROGN (LETT #2# 0) (GO #3=#:G477))))
                (SEQ (LETT |fac| NIL) (LETT #1# |facs|) G190
                     (COND
                      ((OR (ATOM #1#) (PROGN (LETT |fac| (CAR #1#)) NIL))
                       (GO G191)))
...
(SDEFUN |SIMPC;grade;$L;9| ((|s| $) ($ |List| (|List| (|OrientedFacet|))))
        (SPROG
         ((|gr| (|Integer|)) (#1=#:G490 NIL) (|face| NIL)
          (|res| (|List| (|List| (|OrientedFacet|)))) (#2=#:G489 NIL) (|a| NIL)
          (#3=#:G487 NIL) (|maxGrade| (|NonNegativeInteger|)) (#4=#:G488 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |simp| (QVELT |s| 2)) (LETT |maxGrade| 0)
                ...
                (LETT |res| NIL)
                (COND
                 ((< |maxGrade| 1) (PROGN (LETT #3# |res|) (GO #5=#:G486))))
...
(SDEFUN |SIMPC;orderedPermutation|
        ...
        (SPROG
         ((|reslt| (|List| (|List| (|Integer|)))) (|r1| (|List| (|Integer|)))
          (#1=#:G506 NIL) (#2=#:G498 NIL) (|x| NIL)
          (|rst| (|List| (|Integer|))) (|fst| (|Integer|)) (#3=#:G504 NIL)
          (#4=#:G505 NIL) (|y| NIL))
         (SEQ
          (EXIT
           (SEQ (COND ((< |len| 1) (PROGN (LETT #3# NIL) (GO #5=#:G503))))
                (COND
...
(SDEFUN |SIMPC;isNewFace?|
        ...
        (SPROG ((#1=#:G511 NIL) (#2=#:G512 NIL) (|a| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |SIMPC;addImpliedFaces;$L;14|
        ...
        (SPROG
         ((|newFaces| (|List| (|OrientedFacet|)))
          (|len| (|NonNegativeInteger|)) (#1=#:G527 NIL) (|face| NIL)
          (|res| (|List| (|List| (|OrientedFacet|))))
          (|all_faces| (|List| (|OrientedFacet|))) (#2=#:G526 NIL) (|gr| NIL)
          (#3=#:G525 NIL) (|maxGrade| (|NonNegativeInteger|))
                 ...
                 ((< |maxGrade| 1)
                  (SEQ
                   (SPADCALL
                    ...
                    (QREFELT $ 34))
                   (EXIT (PROGN (LETT #3# |res|) (GO #4=#:G524))))))
...
(SDEFUN |SIMPC;boundary;2$;15| ((|s| $) ($ $))
        (SPROG
         ((|res| ($)) (#1=#:G534 NIL) (|y| NIL)
          (|x| (|List| (|OrientedFacet|))) (#2=#:G533 NIL) (|facet| NIL))
...
(SDEFUN |SIMPC;star;$Of$;16| ((|s| $) (|simplex| |OrientedFacet|) ($ $))
        (SPROG
         ((|res| (|List| (|OrientedFacet|))) (#1=#:G539 NIL) (|simp| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |SIMPC;makeDisjoint;3$;20| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G558 NIL) (|maxb| #2=(|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |mina| (SPADCALL |a| (QREFELT $ 62)))
                ...
                (COND
                 ((< |maxa| |minb|) (PROGN (LETT #1# |b|) (GO #4=#:G557))))
...
(SDEFUN |SIMPC;simplicialJoin;2$B$;21|
        ...
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|verts| (|List| VS))
          ...
          (#1=#:G568 NIL) (|y| NIL) (#2=#:G567 NIL) (|x| NIL) (|b2| ($))
          (#3=#:G566 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND ((NULL (QVELT |a| 2)) (PROGN (LETT #3# |b|) (GO #4=#:G565))))
...
(SDEFUN |SIMPC;oneSkeleton;$Dg;25|
        ...
        (SPROG
         ((|edges|
          ...
          (|n| (|NonNegativeInteger|)) (#3=#:G601 NIL) (|x| NIL)
          (GS
...
(SDEFUN |SIMPC;product;3$;32| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|))
          ...
          (#1=#:G625 NIL) (|l| (|NonNegativeInteger|)) (#2=#:G640 NIL)
          (|y| NIL) (|mul| (|Integer|))
          (|inds|
           (|List|
            (|Record| (|:| |left| (|NonNegativeInteger|))
                      (|:| |right| (|NonNegativeInteger|)))))
          (#3=#:G639 NIL) (|x| NIL) (|dimb| #4=(|NonNegativeInteger|))
          (|bz| (|NonNegativeInteger|)) (|dima| #4#)
          (|az| (|NonNegativeInteger|)) (#5=#:G638 NIL) (|z| NIL)
          (|res2| (|List| (|ProductFacet|))) (#6=#:G637 NIL) (|e| NIL)
          (|res| (|List| (|ProductFacet|))) (#7=#:G636 NIL) (|simpb| NIL)
          (#8=#:G635 NIL) (|simpa| NIL) (|vs| (|List| VS)) (|pp| (VS))
          (#9=#:G634 NIL) (|pb| NIL) (#10=#:G633 NIL) (|pa| NIL)
...
(SDEFUN |SIMPC;equalSimplex|
        ...
        (SPROG
         ((|offset| (|Integer|)) (#1=#:G648 NIL) (#2=#:G649 NIL) (|n| NIL)
...
(SDEFUN |SIMPC;=;2$B;34| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G661 NIL) (#2=#:G665 NIL) (|f| NIL)
          (|x| (|NonNegativeInteger|)) (#3=#:G664 NIL) (|a1| NIL)
          (|flags| (|List| (|Boolean|))) (#4=#:G663 NIL) (#5=#:G662 NIL)
...
(SDEFUN |SIMPC;coerce;$Of;35| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (#1=#:G671 NIL) (|a| NIL) (#2=#:G670 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |res|
...
(DEFUN |FiniteSimplicialComplex| (#1=#:G673)
  (SPROG NIL
         (PROG (#2=#:G674)
           (RETURN
            (COND
