...
(SDEFUN |FAXF-;represents;VS;1| ((|v| |Vector| F) ($ S))
        (SPROG ((|a| (S)) (#1=#:G399 NIL) (|i| NIL) (|b| (|Vector| S)))
...
(SDEFUN |FAXF-;coordinates;VM;6| ((|v| |Vector| S) ($ |Matrix| F))
        (SPROG ((#1=#:G409 NIL) (|i| NIL) (|j| NIL) (|m| (|Matrix| F)))
               (SEQ
                (LETT |m|
...
(SDEFUN |FAXF-;trace;SF;10| ((|a| S) ($ F))
        (SPROG ((|abs| (F)) (#1=#:G417 NIL) (|i| NIL) (|b| (|Vector| S)))
...
(SDEFUN |FAXF-;norm;SF;11| ((|a| S) ($ F))
        (SPROG
         ((#1=#:G421 NIL) (|i| NIL) (|m| (|Matrix| F)) (|b| (|Vector| S)))
         (SEQ (LETT |b| (SPADCALL (QREFELT $ 10)))
              (LETT |m|
...
(SDEFUN |FAXF-;linearAssociatedExp;SSupS;12|
        ...
        (SPROG ((|y| (S)) (|erg| (S)) (#1=#:G426 NIL) (|i| NIL))
...
(SDEFUN |FAXF-;linearAssociatedLog;2SU;13|
        ...
        (SPROG
         ((|p| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G436 NIL)
          (#3=#:G435 #1#) (#4=#:G437 #1#) (#5=#:G446 NIL) (|i| NIL)
          (|rown| (|Integer|)) (#6=#:G445 NIL) (|v| (|Vector| F))
          (|m1| (|Matrix| F)) (|l| (|List| (|List| F))) (|a| (S))
          (#7=#:G444 NIL) (|extdeg| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |FAXF-;linearAssociatedOrder;SSup;15|
        ((|x| S) ($ |SparseUnivariatePolynomial| F))
        (SPROG
         ((#1=#:G454 NIL) (#2=#:G453 #3=(|SparseUnivariatePolynomial| F))
          (#4=#:G455 #3#) (#5=#:G459 NIL) (|i| NIL) (|v| (|Vector| F))
          (|l| (|List| (|List| F))) (|a| (S)) (#6=#:G458 NIL))
         (SEQ
          (COND
           ((SPADCALL |x| (|spadConstant| $ 8) (QREFELT $ 51))
            (|spadConstant| $ 52))
...
(SDEFUN |FAXF-;trace;SPiS;19| ((|e| S) (|s| |PositiveInteger|) ($ S))
        (SPROG
         ((|a| (S)) (#1=#:G483 NIL) (|i| NIL) (|q| (|NonNegativeInteger|))
          (|qr|
           (|Record| (|:| |quotient| (|NonNegativeInteger|))
                     (|:| |remainder| (|NonNegativeInteger|)))))
         (SEQ (LETT |qr| (DIVIDE2 (SPADCALL (QREFELT $ 12)) |s|))
...
(SDEFUN |FAXF-;createNormalElement;S;21| (($ S))
        (SPROG
         ((#1=#:G492 NIL) (#2=#:G493 NIL) (|res| (S)) (#3=#:G486 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |FAXF-;normal?;SB;22| ((|x| S) ($ |Boolean|))
        (SPROG
         ((|f| #1=(|SparseUnivariatePolynomial| S)) (#2=#:G495 NIL)
          (#3=#:G494 #1#) (#4=#:G496 #1#) (#5=#:G499 NIL) (|i| NIL)
