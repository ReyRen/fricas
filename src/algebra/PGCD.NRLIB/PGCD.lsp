...
(SDEFUN |PGCD;chooseVal|
        ((|p1| |SparseUnivariatePolynomial| P)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|dd| (|NonNegativeInteger|)) (#1=#:G455 NIL) (#2=#:G446 NIL)
...
(SDEFUN |PGCD;good|
        ((|f| |SparseUnivariatePolynomial| P) (|lvr| |List| OV)
         ...
         ($ |Record| (|:| |upol| (|SparseUnivariatePolynomial| R))
          (|:| |inval| (|List| (|List| R)))))
        (SPROG
         ((#1=#:G465 NIL) (|uf| (|SparseUnivariatePolynomial| R))
          (|lval| (|List| R)) (#2=#:G467 NIL) (|i| NIL) (#3=#:G466 NIL)
          (|range| (|Integer|)) (|nvr| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |PGCD;imposelc|
        ...
        (SPROG
         ((|result| (|List| (|SparseUnivariatePolynomial| R))) (#1=#:G478 NIL)
          (|p1u| (|Union| (|SparseUnivariatePolynomial| R) "failed"))
          (|p1| (|SparseUnivariatePolynomial| R)) (#2=#:G479 NIL) (|pol| NIL)
          (#3=#:G480 NIL) (|leadpol| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |result| NIL)
                (SEQ (LETT |leadpol| NIL) (LETT #3# |leadc|) (LETT |pol| NIL)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |p1u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G477)))
...
(SDEFUN |PGCD;notCoprime|
        ...
        (SPROG
         ((|lval| (|List| R)) (|ul| #1=(|SparseUnivariatePolynomial| R))
          ...
          (|p2l| (|SparseUnivariatePolynomial| P)) (#4=#:G482 NIL) (|dl| #3#)
          (#5=#:G494 NIL)
              ...
              (SEQ G190 NIL
                   (SEQ
                    ...
                    (EXIT
                     (COND
                      ((NULL (QEQCAR |p2u| 1))
                       (PROGN (LETT #5# |$NoValue|) (GO #8=#:G486))))))
                   NIL (GO G190) G191 (EXIT NIL)))
             #8# (EXIT #5#))
...
(SDEFUN |PGCD;not_coprime2|
        ...
        (SPROG
         ((#2=#:G501 NIL) (#3=#:G513 NIL) (|uf| NIL) (#4=#:G512 NIL)
          (|gd1| #1#) (#5=#:G511 NIL)
                      ...
                      (SEQ
                       ...
                       (COND
                        ((EQL (SPADCALL |d| (QREFELT $ 32)) 0)
                         (PROGN (LETT #5# (CONS 0 |gd1|)) (GO #6=#:G510))))
                       (LETT |lquo|
                             (PROG2
...
(SDEFUN |PGCD;best_to_front| ((|l| |List| P) ($ |List| P))
        (SPROG ((|ress| (|List| P)) (|best| (P)) (#1=#:G551 NIL) (|p| NIL))
...
(SDEFUN |PGCD;gcdTermList| ((|p1| P) (|p2| P) ($ P))
        (SPROG
         ((|q| (P)) (#1=#:G558 NIL) (|term| NIL) (#2=#:G559 NIL)
          (|termList| (|List| P)) (#3=#:G553 NIL))
         (SEQ
          (LETT |termList|
                (|PGCD;best_to_front|
                 (CONS |p1|
...
(SDEFUN |PGCD;gcd;3Sup;13|
        ((|p1| |SparseUnivariatePolynomial| P)
         ...
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#1=#:G497 NIL) (|c2| #2=(|SparseUnivariatePolynomial| P)) (|c1| #2#)
                    ...
                    (COND
                     ((SPADCALL
                       (SPADCALL (SPADCALL |uf| |d| (QREFELT $ 34))
                                 (QREFELT $ 32))
                       0 (QREFELT $ 33))
                      (PROGN (LETT #4# (CONS 2 #3#)) (GO #7=#:G573))))))))
            (LETT |lgcd|
                  (SPADCALL (SPADCALL |p1| (QREFELT $ 50))
...
(SDEFUN |PGCD;lift|
        ...
        (SPROG
         ((|p1| #1=(|SparseUnivariatePolynomial| P))
          ...
          (|lgcd1| (R)) (|lcd| (R)) (#3=#:G592 NIL) (|n0| NIL) (#4=#:G593 NIL)
          (|n1| NIL) (#5=#:G591 NIL) (|leadpol| (|Boolean|))
...
(SDEFUN |PGCD;gcd;3P;17| ((|p1| P) (|p2| P) ($ P))
        (SPROG ((|mv2| (OV)) (#1=#:G600 NIL) (|mv1| (OV)))
               (SEQ
                (COND
...
(SDEFUN |PGCD;gcd;LP;18| ((|listp| |List| P) ($ P))
        (SPROG
         ((#1=#:G611 NIL) (|f| (P)) (#2=#:G612 NIL) (|g| NIL)
          (|lf| (|List| P)))
         (SEQ
          (EXIT
...
(SDEFUN |PGCD;gcd;LSup;19|
        ((|listp| |List| (|SparseUnivariatePolynomial| P))
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#1=#:G622 NIL) (|f| (|SparseUnivariatePolynomial| P))
          (#2=#:G623 NIL) (|g| NIL)
...
(SDEFUN |PGCD;gcdPrimitive;3P;20| ((|p1| P) (|p2| P) ($ P))
        (SPROG
         ((|up2| #1=(|SparseUnivariatePolynomial| P)) (|up1| #1#)
          (#2=#:G631 NIL) (|mp| (P)) (|md| (|NonNegativeInteger|)) (|mv2| (OV))
          (#3=#:G628 NIL) (|mv1| (OV)))
         (SEQ (LETT |p1| (SPADCALL |p1| (QREFELT $ 103)))
              (LETT |p2| (SPADCALL |p2| (QREFELT $ 103)))
              (EXIT
...
(SDEFUN |PGCD;gcdPrimitive;LP;21| ((|listp| |List| P) ($ P))
        (SPROG
         ((#1=#:G646 NIL) (|f| (P)) (#2=#:G647 NIL) (|g| NIL)
          (|lf| (|List| P)))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |PolynomialGcdPackage| (&REST #1=#:G648)
  (SPROG NIL
         (PROG (#2=#:G649)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 122
                                            '(2 10 0 0 10 11 1 13 12 12 14 1 8
                                              0 12 15 2 18 17 0 0 19 1 18 20 0
                                              21 2 12 0 10 0 22 1 23 8 12 24 2
                                              27 25 26 0 28 3 23 29 18 30 26 31
                                              1 29 20 0 32 2 20 25 0 0 33 2 29
                                              0 0 0 34 0 6 0 35 0 8 0 36 0 29 0
                                              37 0 18 0 38 2 29 17 0 0 39 0 8 0
                                              40 0 9 0 41 1 29 0 0 42 3 9 0 0
                                              30 26 43 1 9 29 0 44 2 29 0 0 0
                                              45 1 29 8 0 46 2 29 17 0 8 47 1
                                              18 0 0 48 1 18 9 0 50 1 29 0 51
                                              52 2 18 0 0 0 55 2 20 25 0 0 56 2
                                              18 25 0 0 57 1 18 0 0 58 2 7 25 0
                                              0 59 1 23 30 18 60 2 30 0 0 0 61
                                              2 30 0 62 0 63 1 23 29 18 64 1 23
                                              18 29 65 0 18 0 66 2 20 0 0 0 68
                                              2 23 69 18 30 70 3 69 0 71 0 0 72
                                              1 18 20 0 73 1 18 53 0 74 2 18 0
                                              9 20 75 1 9 25 0 76 1 9 77 0 78 2
                                              9 20 0 7 79 2 9 80 0 7 81 2 9 25
                                              0 0 83 1 18 9 0 84 1 18 0 9 85 1
                                              18 0 0 86 2 87 29 0 12 88 2 9 25
                                              0 0 89 2 18 0 9 0 90 2 9 69 0 30
                                              91 1 9 6 0 92 2 6 25 0 0 93 1 9 8
                                              0 94 2 29 0 8 0 95 7 97 96 18 30
                                              87 26 53 69 8 98 2 99 18 0 12 100
                                              2 29 25 0 0 101 2 18 17 0 9 102 1
                                              9 0 0 103 0 9 0 104 2 8 0 0 0 105
                                              1 9 0 8 106 2 7 25 0 0 107 2 9 0
                                              80 7 108 2 7 25 0 0 109 2 20 25 0
                                              0 110 2 99 0 111 0 112 2 9 20 0 7
                                              114 1 9 0 7 115 2 9 0 0 20 116 2
                                              9 17 0 0 117 2 9 0 0 0 118 2 53 0
                                              120 0 121 2 0 9 9 9 119 1 0 9 53
                                              122 2 0 18 18 18 67 2 0 9 9 9 82
                                              2 0 18 18 18 49 1 0 9 53 54 1 0
                                              18 99 113)))))
           '|lookupComplete|)) 
