...
(SDEFUN |IBATOOL;diagonalProduct;MR;1| ((|m| |Matrix| R) ($ R))
        (SPROG
         ((|ans| (R)) (#1=#:G395 NIL) (|i| NIL) (#2=#:G396 NIL) (|j| NIL))
...
(SDEFUN |IBATOOL;matrixGcd;MRNniR;2|
        ...
        (SPROG
         ((#1=#:G403 NIL) (|d| (R)) (|mij| (R)) (#2=#:G405 NIL) (|j| NIL)
          (#3=#:G404 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |d| |sing|)
...
(SDEFUN |IBATOOL;divideIfCan!;2MRIR;3|
        ((|matrix| |Matrix| R) (|matrixOut| |Matrix| R) (|prime| R)
         (|n| |Integer|) ($ R))
        (SPROG
         ((#1=#:G414 NIL) (|a| (|Union| R "failed")) (#2=#:G416 NIL) (|j| NIL)
          (#3=#:G415 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |IBATOOL;idealiserMatrix;3M;5|
        ...
        (SPROG
         ((#1=#:G429 NIL) (|k| NIL) (#2=#:G428 NIL) (|j| NIL)
          (|m| (|Matrix| R)) (|r| (|Matrix| R)) (#3=#:G427 NIL) (|i| NIL)
...
(SDEFUN |IBATOOL;idealiser;2MRM;7|
        ((|ideal| |Matrix| R) (|idealinv| |Matrix| R) (|denom| R)
         ($ |Matrix| R))
        (SPROG ((|bigm| (|Matrix| R)) (#1=#:G433 NIL))
               (SEQ
                (LETT |bigm|
                      (PROG2
                          (LETT #1#
...
(DEFUN |IntegralBasisTools| (&REST #1=#:G450)
  (SPROG NIL
         (PROG (#2=#:G451)
           (RETURN
            (COND
