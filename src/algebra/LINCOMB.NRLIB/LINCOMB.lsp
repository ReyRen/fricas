...
(SDEFUN |LINCOMB;dehomogenize;LR;1|
        ...
        (SPROG
         ((|res3|
          ...
          (|bv| #1=(|Vector| F)) (|rp| (F)) (|c| (F)) (#2=#:G405 NIL)
          (|be| NIL) (|ppv| #1#) (|ppa| (F)) (|c1inv| (F))
          (|found| (|Boolean|))
          (|be1| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
          (|res2|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#3=#:G404 NIL) (|nn| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |LINCOMB;lin_comb;VLF;2| ((|v| |Vector| F) (|lf| |List| F) ($ F))
        (SPROG
         ((|res| (F)) (#1=#:G409 NIL) (|i| NIL) (#2=#:G410 NIL) (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLF;3|
        ...
        (SPROG
         ((|res| (F)) (#1=#:G414 NIL) (|i| NIL) (#2=#:G415 NIL) (|f| NIL))
         (SEQ (LETT |res| (|spadConstant| $ 16))
              (SEQ (LETT |f| NIL) (LETT #2# |lf|) (LETT |i| 1)
                   (LETT #1# (QVSIZE |v|)) G190
                   (COND
...
(SDEFUN |LINCOMB;lin_comb!;2VLV;4|
        ((|u| |Vector| F) (|v| |Vector| F) (|lw| |List| (|Vector| F))
         ($ |Vector| F))
        (SPROG
         ((#1=#:G423 NIL) (|j| NIL) (|c| (F)) (#2=#:G421 NIL) (|i| NIL)
          (#3=#:G422 NIL) (|w| NIL) (|n| (|NonNegativeInteger|))
          (|res| (|Vector| F)))
...
(SDEFUN |LINCOMB;lin_comb;VLF;6|
        ...
        (SPROG
         ((|res| (|Fraction| UP)) (#1=#:G429 NIL) (|i| NIL) (#2=#:G430 NIL)
          (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLF;7|
        ((|v| |Vector| (|Fraction| (|Integer|))) (|lg| |List| (|Fraction| UP))
         ($ |Fraction| UP))
        (SPROG
         ((|res| (|Fraction| UP)) (#1=#:G434 NIL) (|i| NIL) (#2=#:G435 NIL)
          (|g| NIL))
         (SEQ (LETT |res| (|spadConstant| $ 45))
...
(SDEFUN |LINCOMB;lin_comb;VLLp;8|
        ...
        (SPROG
         ((|res| (|LaurentPolynomial| F UP)) (#1=#:G439 NIL) (|i| NIL)
          (#2=#:G440 NIL) (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLUP;9| ((|v| |Vector| F) (|lf| |List| UP) ($ UP))
        (SPROG
         ((|res| (UP)) (#1=#:G444 NIL) (|i| NIL) (#2=#:G445 NIL) (|f| NIL))
...
(DEFUN |LinearCombinationUtilities| (&REST #1=#:G446)
  (SPROG NIL
         (PROG (#2=#:G447)
           (RETURN
            (COND
