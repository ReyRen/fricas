...
(SDEFUN |FELFUN;landen2;FLFL;4|
        ((|m| |Float|) (|res| |List| (|Float|)) (|eps| |Float|)
         ($ |List| (|Float|)))
        (SPROG
         ((|kn| (|Float|)) (|kp| (|Float|)) (#1=#:G442 NIL) (|am| (|Float|)))
         (SEQ
          (SEQ
           (EXIT
            (SEQ G190 NIL
                       ...
                       (COND
                        ((SPADCALL |am| |eps| (QREFELT $ 17))
                         (SEQ
                          ...
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G439)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;kprod;LF;6| ((|ll| |List| (|Float|)) ($ |Float|))
        (SPROG ((#1=#:G452 NIL) (|k| NIL) (#2=#:G451 NIL))
               (SEQ
                (SPADCALL (ELT $ 34)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FELFUN;sn2;FLF;7| ((|z| |Float|) (|ll| |List| (|Float|)) ($ |Float|))
        (SPROG ((|res| (|Float|)) (#1=#:G456 NIL) (|k| NIL))
                         ...
                         (SEQ
                          (LETT |kn|
                                (SPADCALL (SPADCALL 1 4 (QREFELT $ 29)) |m|
                                          (QREFELT $ 49)))
                          (LETT |res| (CONS |kn| |res|))
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G464)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;kprod;LC;11|
        ...
        (SPROG ((#1=#:G477 NIL) (|k| NIL) (#2=#:G476 NIL))
               (SEQ
                (SPADCALL (ELT $ 52)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FELFUN;sn2;CLC;12|
        ((|z| |Complex| (|Float|)) (|ll| |List| (|Complex| (|Float|)))
         ($ |Complex| (|Float|)))
        (SPROG ((|res| (|Complex| (|Float|))) (#1=#:G481 NIL) (|k| NIL))
...
(SDEFUN |FELFUN;zeta2|
        ...
        (SPROG
         ((|snz| (|Float|)) (|res| (|Float|)) (|r| (|Float|))
          ...
          (|p| #2#) (|k1inv| #1#) (|k1| (|Float|)) (#3=#:G568 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;theta0|
        ...
        (SPROG
         ((|t3| #2=(|Complex| (|Float|))) (|t2| (|Complex| (|Float|)))
          (|pp| #3=(|Complex| (|Float|))) (|nt3| #2#) (#4=#:G585 NIL) (|i| NIL)
          (#5=#:G586 NIL) (|iq2| #6=(|Complex| (|Float|)))
          (|liq2| (|List| (|Complex| (|Float|)))) (#7=#:G584 NIL)
                     ...
                     ('T
                      (SEQ
                       ...
                       (SEQ (LETT |i| 1) (LETT #7# |k|) G190
                            ...
                            (EXIT NIL))
                       (SEQ (LETT |iq2| NIL) (LETT #5# |liq2|) (LETT |i| 1)
                            (LETT #4# |k|) G190
                            (COND
...
(SDEFUN |FELFUN;reduce_periods|
        ((|w1| . #1=(|Complex| (|Float|))) (|w2| . #2=(|Complex| (|Float|)))
         ($ |List| (|Complex| (|Float|))))
        (SPROG
         ((|aw1| #3=(|Float|)) (#4=#:G597 NIL) (|rit| (|Float|))
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL |rit| (|spadConstant| $ 65) (QREFELT $ 95))
                          (PROGN (LETT #4# (LIST |w1| |w2|)) (GO #5=#:G596)))
                         ('T
                          (SEQ
                           (LETT |w1|
                                 (SPADCALL |w1|
...
(SDEFUN |FELFUN;ellipticF;3F;37| ((|z| |Float|) (|m| |Float|) ($ |Float|))
        (SPROG
         ((|res| (|Float|)) (|delta| (|Float|)) (#1=#:G615 NIL) (|k| NIL)
          (|ll| (|List| (|Float|))) (|eps| (|Float|))
...
(SDEFUN |FELFUN;ellipticF_aux|
        ((|z| |Complex| (|Float|)) (|m| |Complex| (|Float|))
         ($ |Complex| (|Float|)))
        (SPROG
         ((|delta| (|Complex| (|Float|))) (#1=#:G628 NIL) (|k| NIL)
          (|sf| (|Float|)) (|nz| (|Float|))
...
(SDEFUN |FELFUN;ellipticE;2F;41| ((|m| |Float|) ($ |Float|))
        (SPROG
         ((|e_val| #1=(|Float|)) (|p| (|Float|)) (|k1inv| (|Float|))
          (|f_val| #1#) (|k1| (|Float|)) (#2=#:G635 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;ellipticE;2C;42|
        ...
        (SPROG
         ((|e_val| #1=(|Complex| (|Float|))) (|p| (|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#2=#:G642 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;ellipticE;3F;43| ((|z| |Float|) (|m| |Float|) ($ |Float|))
        (SPROG
         ((|e_val| #1=(|Float|)) (|r| #2=(|Float|)) (|k_z2| #3=(|Float|))
          ...
          (|k1| (|Float|)) (#4=#:G656 NIL) (|k| NIL) (#5=#:G657 NIL)
          (|lz| (|List| (|Float|))) (|delta| #6=(|Float|)) (#7=#:G655 NIL)
          (|llr| (|List| (|Float|))) (|ll| (|List| (|Float|)))
...
(SDEFUN |FELFUN;ellipticE_aux|
        ...
        (SPROG
         ((|e_val| #2=(|Complex| (|Float|))) (|r| #3=(|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#5=#:G670 NIL) (|k| NIL)
          (#6=#:G671 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#7=#:G669 NIL)
                 ...
                 (COND
                  ...
                  (#8#
                   (SEQ (LETT |prec| (+ |obits| 20))
                        ...
                        (SEQ (LETT |z| NIL) (LETT #6# |lz|) (LETT |k| NIL)
                             (LETT #5# |ll|) G190
                             (COND
...
(SDEFUN |FELFUN;ellipticPi_r|
        ...
        (SPROG
         ((|pi_val| (|Float|)) (|p_inv| (|Float|)) (|f_val| (|Float|))
          (|k1| (|Float|)) (#3=#:G701 NIL) (|k| NIL) (#4=#:G702 NIL)
          (#5=#:G703 NIL) (|p| #6=(|Float|)) (#7=#:G704 NIL) (|nk| #2#)
          (|lnk| (|List| (|Float|))) (|cc| #8=(|Float|))
          (|lp| (|List| (|Float|))) (#9=#:G700 NIL) (|lz| (|List| (|Float|)))
          (|delta| (|Float|)) (#10=#:G699 NIL) (|z0| #1#)
          (|llr| (|List| (|Float|))) (|ll| (|List| (|Float|)))
          (|eps| (|Float|)) (|prec| (|PositiveInteger|)) (|nn1| #11=(|Float|))
          (|nn| (|Float|)) (|res1| #8#) (|n1| #6#) (|lzz| #8#) (|z2| #11#)
          (|m1| #6#))
         (SEQ
          (COND
           ((SPADCALL |m| (|spadConstant| $ 20) (QREFELT $ 74))
                  ...
                  (COND
                   ...
                   (#12#
                    (SEQ
                     ...
                     (SEQ (LETT |nk| NIL) (LETT #7# |lnk|) (LETT |p| NIL)
                          (LETT #5# |lp|) (LETT |z| NIL) (LETT #4# |lz|)
...
(SDEFUN |FELFUN;ellipticPi_aux|
        ...
        (SPROG
         ((|pi_val| (|Complex| (|Float|))) (|p_inv| #3=(|Complex| (|Float|)))
          ...
          (#4=#:G726 NIL) (|k| NIL) (#5=#:G727 NIL) (#6=#:G728 NIL)
          (|p| #7=(|Complex| (|Float|))) (#8=#:G729 NIL) (|nk| #2#)
          (|lnk| (|List| (|Complex| (|Float|))))
          (|cc| #9=(|Complex| (|Float|))) (|lp| (|List| (|Complex| (|Float|))))
          (#10=#:G725 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#11=#:G724 NIL) (|z0| #1#)
          (|llr| (|List| (|Complex| (|Float|))))
          (|ll| (|List| (|Complex| (|Float|)))) (|eps| (|Float|))
          (|prec| (|PositiveInteger|)) (|res0| #3#) (|h1| #7#)
          (|h| #12=(|Complex| (|Float|))) (|t| #9#) (|ss| #12#) (|z12| #12#)
          (|z2| #12#) (|sf| (|Float|)) (|nz| (|Float|)) (|nn1| #12#) (|nn| #9#)
          (|res1| #9#) (|n1| #7#) (|lzz| #9#) (|ctwo| (|Complex| (|Float|))))
         (SEQ
          (LETT |ctwo|
           ...
           (COND
            ...
            (#13#
             (SEQ (LETT |nz| (SPADCALL |z| (QREFELT $ 115)))
                  ...
                  (SEQ (LETT |nk| NIL) (LETT #8# |lnk|) (LETT |p| NIL)
                       (LETT #6# |lp|) (LETT |z| NIL) (LETT #5# |lz|)
                       (LETT |k| NIL) (LETT #4# |ll|) G190
                       (COND
