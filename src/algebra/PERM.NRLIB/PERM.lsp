...
(SDEFUN |PERM;rotateCycle| ((|cyc| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G414 NIL) (#2=#:G413 NIL) (|minpos| (|Integer|)) (|min| (S))
          (#3=#:G417 NIL) (|i| NIL))
...
(SDEFUN |PERM;coerceCycle| ((|lls| |List| (|List| S)) ($ $))
        (SPROG ((|perm| ($)) (#1=#:G421 NIL) (|lists| NIL))
...
(SDEFUN |PERM;smallerCycle?|
        ...
        (SPROG
         ((#1=#:G427 NIL) (#2=#:G428 NIL) (#3=#:G429 NIL) (|i| NIL)
          (#4=#:G430 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PERM;permord|
        ((|pa| |Record| (|:| |cycl| (|List| (|List| S))) (|:| |permut| $))
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G437 NIL) (#2=#:G438 NIL) (#3=#:G439 NIL) (|i| NIL)
          (#4=#:G440 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |PERM;coercePreimagesImages;L$;10|
        ...
        (SPROG
         ((|image| (|List| S)) (|preImage| (|List| S)) (#1=#:G470 NIL)
          (|i| NIL) (#2=#:G471 NIL) (|pi| NIL))
...
(SDEFUN |PERM;=;2$B;13| ((|p| $) (|q| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G482 NIL) (#2=#:G483 NIL) (|pos| (|Integer|)) (#3=#:G484 NIL)
             ...
             (SEQ
              (SEQ (LETT |i| 1) (LETT #3# (SPADCALL |preimp| (QREFELT $ 14)))
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (COND
                      ((EQL |pos| 0) (PROGN (LETT #2# NIL) (GO #5=#:G481)))
                      ('T
                       (SEQ
                        (EXIT
                         (COND
...
(SDEFUN |PERM;cyclePartition;$P;15| ((|p| $) ($ |Partition|))
        (SPROG ((#1=#:G492 NIL) (|c| NIL) (#2=#:G491 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |PERM;<;2$B;20| ((|pa| $) (|pb| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G504 NIL) (#2=#:G505 NIL) (#3=#:G506 NIL) (|i| NIL)
          (#4=#:G507 NIL) (|j| NIL) (|pbcyc| #5=(|List| (|List| S)))
          (|pacyc| #5#))
         (SEQ
          (EXIT
...
(SDEFUN |PERM;sort;2L;23| ((|inList| |List| $) ($ |List| $))
        (SPROG
         ((|outList| (|List| $)) (#1=#:G520 NIL) (|rec| NIL)
          (|ownList|
           (|List|
            (|Record| (|:| |cycl| (|List| (|List| S))) (|:| |permut| $))))
          (#2=#:G519 NIL) (|sigma| NIL))
         (SEQ
          (COND
...
(SDEFUN |PERM;coerce;$Of;24| ((|p| $) ($ |OutputForm|))
        (SPROG
         ((|outfmL| (|List| (|OutputForm|)))
          (|outcycL| (|List| (|OutputForm|))) (#1=#:G528 NIL) (|elt| NIL)
          (#2=#:G527 NIL) (|cycle| NIL) (|cycles| (|List| (|List| S))))
...
(SDEFUN |PERM;coerceListOfPairs;L$;27| ((|loP| |List| (|List| S)) ($ $))
        (SPROG
         ((|im| (|List| S)) (|preim| (|List| S)) (#1=#:G541 NIL) (|pair| NIL))
...
(SDEFUN |PERM;*;3$;28| ((|q| $) (|p| $) ($ $))
        (SPROG
         ((|imOfq| #1=(|List| S)) (|preimOfq| #1#) (|imOfqp| (|List| S))
          (|preimOfqp| (|List| S)) (|el| (S)) (|j| (|Integer|)) (#2=#:G552 NIL)
...
(SDEFUN |PERM;coerceImages;L$;34| ((|image| |List| S) ($ $))
        (SPROG
         ((|preImage| (|List| S)) (#1=#:G563 NIL) (|i| NIL) (#2=#:G562 NIL))
         (SEQ
          (LETT |preImage|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |PERM;coerceImages;L$;35| ((|image| |List| S) ($ $))
        (SPROG
         ((|preImage| (|List| S)) (#1=#:G565 NIL) (#2=#:G570 NIL) (|i| NIL)
          (#3=#:G569 NIL))
         (SEQ
          (LETT |preImage|
                (PROGN
...
(SDEFUN |PERM;cyclePartition;$P;37| ((|p| $) ($ |Partition|))
        (SPROG ((|pt| (|Partition|)) (#1=#:G576 NIL) (|c| NIL) (#2=#:G575 NIL))
               (SEQ
                (LETT |pt|
                      (SPADCALL
                       (PROGN
...
(DEFUN |Permutation;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G580 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
