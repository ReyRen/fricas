...
(SDEFUN |MAGCDT4;pack_modulus;LLIU;2|
        ((|lm| |List| (|FakePolynomial|)) (|lvz| |List| (|Symbol|))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|lm2| (|List| (|Polynomial| (|Integer|)))) (#1=#:G397 NIL) (|m| NIL)
          (#2=#:G396 NIL))
         (SEQ
          (LETT |lm2|
                (PROGN
...
(MAKEPROP '|ModularAlgebraicGcdTools4| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|ModularAlgebraicGcdTools3|)
              ...
              (22 . |monomial|) (28 . |coerce|) (33 . +) (|Union| 22 '#1#)
              (39 . |canonicalIfCan|) (45 . |Zero|) (49 . |Zero|)
              (53 . |coefficient|) (|Union| 9 '"failed") (|Mapping| 31 6)
              (59 . |map|) (|Symbol|) |MAGCDT4;MPtoMPT;FpSLRU;4| (|Void|)
              (|U32Vector|) (|SortedExponentVector|))
           '#(|zero?| 65 |repack1| 70 |pseudoRem| 78 |pack_modulus| 85
              |pack_exps| 92 |degree| 99 |canonicalIfCan| 104 |MPtoMPT| 110)
           'NIL
           (CONS (|makeByteWordVec2| 1 '(0))
                 (CONS '#(NIL)
                       (CONS '#((|ModularAlgebraicGcdOperations| 7 22 13))
                             (|makeByteWordVec2| 38
                                                 '(1 7 6 0 8 0 9 0 10 2 9 11 0
                                                   0 12 3 5 14 15 16 17 18 2 22
                                                   0 9 21 23 1 22 0 9 24 2 22 0
                                                   0 0 25 2 5 26 22 13 27 0 9 0
                                                   28 0 22 0 29 2 22 9 0 21 30
                                                   2 7 26 32 0 33 1 0 11 22 1 4
                                                   0 36 22 37 17 13 1 3 0 22 22
                                                   22 13 1 3 0 14 19 16 17 20 3
                                                   0 38 17 17 13 1 1 0 17 22 1
                                                   2 0 26 22 13 1 4 0 26 7 34
                                                   16 13 35)))))
           '|lookupComplete|)) 
