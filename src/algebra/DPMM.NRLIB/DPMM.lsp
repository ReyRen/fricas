...
(SDEFUN |DPMM;*;M2$;2| ((|m| M) (|x| $) ($ $))
        (SPROG
         ((#1=#:G388 NIL) (#2=#:G387 (S)) (#3=#:G389 (S)) (#4=#:G395 NIL)
          (|j| NIL) (#5=#:G392 NIL) (#6=#:G394 NIL) (|i| NIL) (#7=#:G393 NIL))
         (SEQ
          (PROGN
...
(DEFUN |DirectProductMatrixModule| (&REST #1=#:G421)
  (SPROG NIL
         (PROG (#2=#:G422)
           (RETURN
            (COND
...
(DEFUN |DirectProductMatrixModule;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|pv$| NIL) (#1=#:G413 NIL) (#2=#:G414 NIL) (#3=#:G415 NIL) (#4=#:G416 NIL)
    (#5=#:G417 NIL) (#6=#:G418 NIL) (#7=#:G419 NIL) (#8=#:G420 NIL) ($ NIL)
           ...
           (CONS
            (|makeByteWordVec2| 47
                                '(0 7 10 10 7 7 10 15 16 17 19 1 10 19 9 2 7 8
                                  ...
                                  5 11 13 29 18 47 0 0 14 29 0 0 0 43 7 20 0 0
                                  0 0 0 0 43 4 6 7 13 20 44 45))
            (CONS
