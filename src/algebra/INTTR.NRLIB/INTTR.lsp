          ...
          (|logs|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                      ...
                      (|:| |logand|
                           (|SparseUnivariatePolynomial| (|Fraction| UP))))))
          (#2=#:G434 NIL) (|term| NIL) (#3=#:G433 NIL)
          (|rec|
...
(SDEFUN |INTTR;monomialIntPoly;UPMR;9|
        ...
        (SPROG
         ((|ans| (UP)) (|term| (UP)) (#1=#:G440 NIL) (|n| (|Integer|))
          (|l| (F)) (|d| (|Integer|)) (|dt| (UP)))
         (SEQ
          (LETT |d|
                (SPADCALL
        ...
        (SPROG
         ((|u2|
           (|Union|
            ...
            (|Record| (|:| |elem| (|LaurentPolynomial| F UP))
                      (|:| |notelem| (|LaurentPolynomial| F UP)))))
          (|special| (|LaurentPolynomial| F UP)) (#1=#:G489 NIL)
          (|i1| (|IntegrationResult| (|Fraction| UP)))
          (|rec|
           (|Record| (|:| |ir| (|IntegrationResult| (|Fraction| UP)))
                     (|:| |specpart| (|Fraction| UP)) (|:| |polypart| UP))))
...
(SDEFUN |INTTR;lambintegrate;FFMMMMR;15|
        ...
        (SPROG
         ((|ri2|
           (|Record| (|:| |answer| (|IntegrationResult| (|Fraction| UP)))
                     (|:| |a0| (|IntegrationResult| F))))
          (|sp| (|LaurentPolynomial| F UP)) (#1=#:G512 NIL) (|n| (|Integer|))
...
(SDEFUN |INTTR;lamintegratepoly|
        ((|p| |LaurentPolynomial| F UP) (|dx| F) (|n| |Integer|)
         ...
         ($ |Record| (|:| |answer| (|IntegrationResult| (|Fraction| UP)))
          (|:| |a0| (|IntegrationResult| F))))
        (SPROG
         ((#2=#:G546 NIL) (|answr| (|LaurentPolynomial| F UP)) (|clg0| (F))
          (|db1| (F)) (|b1| (F)) (#3=#:G547 NIL) (|i0| (|IntegrationResult| F))
...
(SDEFUN |INTTR;primintegratepoly|
        ((|p| UP)
         ...
         ($ |Union| (|Record| (|:| |answer| UP) (|:| |a0| F))
          (|Record| (|:| |elem| UP) (|:| |notelem| UP))))
        (SPROG
         ((|ans1| #1#) (|rp| (F)) (|ans| (UP)) (#2=#:G557 NIL) (#3=#:G564 NIL)
...
(DEFUN |TranscendentalIntegration| (&REST #1=#:G565)
  (SPROG NIL
         (PROG (#2=#:G566)
           (RETURN
            (COND
...
(MAKEPROP '|TranscendentalIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|Union| 110 '#1="failed") (|Mapping| 111 6)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 141
                                            '(0 8 0 9 2 8 0 0 11 12 2 8 0 0 0
                                              ...
                                              0 86 2 87 29 0 0 88 2 6 0 87 0 89
                                              2 6 0 0 0 90 2 7 0 0 0 91 0 94 0
                                              95 2 94 29 0 0 96 1 94 87 0 97 1
                                              94 6 0 98 2 94 0 6 87 99 2 94 0 0
                                              0 100 2 6 0 0 0 101 1 94 0 0 102
                                              1 94 29 0 103 2 40 0 8 8 104 1 40
                                              29 0 105 1 7 6 0 106 1 94 0 7 114
                                              2 94 115 0 0 116 1 94 8 0 117 2 6
                                              29 0 0 121 2 20 0 8 34 122 0 123
                                              0 124 1 7 125 0 126 1 125 127 0
                                              128 2 87 29 0 0 133 1 6 0 87 134
                                              1 123 29 0 135 2 6 0 0 0 136 2 6
                                              0 0 0 137 2 94 0 0 0 138 1 94 125
                                              0 139 2 34 29 0 0 140 2 6 0 34 0
                                              141 4 0 107 8 11 109 112 113 2 0
                                              84 8 11 85 2 0 92 7 11 93 6 0 129
                                              8 6 130 11 112 131 132 4 0 107 8
                                              11 109 119 120)))))
           '|lookupComplete|)) 
