...
(SDEFUN |PATTERN;LPAT2O|
        ((|f| |Mapping| (|OutputForm|) (|OutputForm|) (|OutputForm|))
         (|l| |List| $) ($ |OutputForm|))
        (SPROG ((#1=#:G507 NIL) (|x| NIL) (#2=#:G506 NIL))
               (SEQ
                (SPADCALL |f|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |PATTERN;incmax| ((|l| |List| $) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G534 NIL) (|p| NIL) (#2=#:G533 NIL))
               (SEQ
                (+ 1
                   (SPADCALL (ELT $ 73)
                             (PROGN
...
(SDEFUN |PATTERN;SYM2O|
        ((|p| |Record| (|:| |tag| (|SingleInteger|)) (|:| |val| (|Symbol|))
         ...
         ($ |OutputForm|))
        (SPROG
         ((#1=#:G640 NIL) (|i| NIL) (#2=#:G639 NIL) (|sy| (|OutputForm|)))
...
(SDEFUN |PATTERN;variables;$L;53| ((|p| $) ($ |List| $))
        (SPROG
         ((#1=#:G648 NIL) (#2=#:G438 NIL) (|r| NIL) (#3=#:G647 NIL)
          (#4=#:G440 NIL) (#5=#:G439 NIL)
          (|q|
           (|Union| (|:| |ret| R)
                    (|:| |ker|
                         (|Record| (|:| |tag| (|SingleInteger|))
         ...
         ((#1=#:G438 NIL)
          (|u|
           (|Union| (|Mapping| (|OutputForm|) (|List| (|OutputForm|)))
                    "failed"))
          (|l| (|List| (|OutputForm|))) (#2=#:G667 NIL) (|x| NIL)
          (#3=#:G666 NIL) (#4=#:G440 NIL) (#5=#:G439 NIL) (#6=#:G441 NIL))
         (SEQ
         ...
         ($ |Union| (|:| |ret| R)
          ...
          (|:| |sym|
               (|Record| (|:| |tag| (|SingleInteger|)) (|:| |val| (|Symbol|))
                         ...
                         (|:| |bad| (|List| (|Any|)))))))
        (SPROG
         ((#1=#:G439 NIL) (#2=#:G440 NIL) (#3=#:G674 NIL) (#4=#:G438 NIL)
          (|x| NIL) (#5=#:G673 NIL) (#6=#:G441 NIL))
         (SEQ
...
(SDEFUN |PATTERN;pateq?|
        ((|p1| |Union| (|:| |ret| R)
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G439 NIL) (#2=#:G438 NIL) (#3=#:G441 NIL) (#4=#:G440 NIL))
         (COND
          ((QEQCAR |p1| 0)
           (COND
