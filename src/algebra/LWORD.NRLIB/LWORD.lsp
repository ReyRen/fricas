...
(SDEFUN |LWORD;lyndon?;FmB;1| ((|w| |FreeMonoid| |VarSet|) ($ |Boolean|))
        (SPROG ((|f| (|FreeMonoid| |VarSet|)) (#1=#:G400 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LWORD;factor;FmL;6| ((|w| |FreeMonoid| |VarSet|) ($ |List| $))
        (SPROG ((|l| (|List| $)) (#1=#:G425 NIL) (|u| NIL) (#2=#:G424 NIL))
               (SEQ
                (COND ((SPADCALL |w| (|spadConstant| $ 9) (QREFELT $ 11)) NIL)
                      ('T
                       (SEQ
...
(SDEFUN |LWORD;LyndonWordsList1;LPiOda;10|
        ...
        (SPROG
         ((#1=#:G449 NIL) (|lbase1| (|List| $)) (#2=#:G457 NIL) (|b| NIL)
          (#3=#:G456 NIL) (|a| NIL) (#4=#:G455 NIL) (|i| NIL) (#5=#:G454 NIL)
          (#6=#:G453 NIL) (#7=#:G452 NIL) (|ll| NIL) (#8=#:G451 NIL) (|w| NIL)
          (#9=#:G450 NIL) (|base| (|OneDimensionalArray| (|List| $)))
          (#10=#:G431 NIL))
         (SEQ
          (EXIT
           (COND ((NULL |vl|) (|error| "empty list"))
                 ('T
                  (SEQ
                   ...
                   (EXIT (PROGN (LETT #1# |base|) (GO #11=#:G448)))))))
          #11# (EXIT #1#)))) 

(SDEFUN |LWORD;LyndonWordsList;LPiL;11|
        ((|vl| |List| |VarSet|) (|n| |PositiveInteger|) ($ |List| $))
        (SPROG
         ((#1=#:G459 NIL) (#2=#:G458 #3=(|List| $)) (#4=#:G460 #3#)
          (#5=#:G463 NIL) (|i| NIL) (|v| (|OneDimensionalArray| (|List| $))))
