...
(SDEFUN |SBOUND;sunion;3$;6| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((|ymax| (PT)) (#1=#:G403 NIL) (|ymin| (PT)) (|xmax| (PT))
          (|xmin| (PT)) (#2=#:G435 NIL) (|res| ($)) (#3=#:G437 NIL) (|ptr| NIL)
          (|p| (|List| $)) (#4=#:G404 NIL) (#5=#:G436 NIL))
         (SEQ
          (EXIT
           (SEQ (COND ((QEQCAR |x| 0) (PROGN (LETT #2# |y|) (GO #6=#:G434))))
...
(SDEFUN |SBOUND;extendToPoint;$PT$;7| ((|n| $) (|p| PT) ($ $))
        (SPROG
         ((|xmax| (PT)) (|xmin| (PT)) (#1=#:G449 NIL) (|res| ($))
          (#2=#:G450 NIL) (|ptr| NIL) (|pa| (|List| $)) (#3=#:G404 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |SBOUND;containsPoint?;$PTB;8| ((|n| $) (|p| PT) ($ |Boolean|))
        (SPROG
         ((#1=#:G403 NIL) (#2=#:G460 NIL) (|rDist| #3=(|DoubleFloat|))
          (|pDist| #3#) (|pRel| (PT)) (#4=#:G461 NIL) (|sub| NIL)
          (|pa| (|List| $)) (#5=#:G404 NIL))
         (SEQ
          (EXIT
           (SEQ (COND ((QEQCAR |n| 0) (PROGN (LETT #2# NIL) (GO #6=#:G459))))
                (COND
                 ((QEQCAR |n| 2)
                  (SEQ
                   (LETT |pa|
...
(SDEFUN |SBOUND;lineIntersect;$2PT;9| ((|n| $) (|p| PT) ($ PT))
        (SPROG
         ((|y| #1=(|DoubleFloat|)) (|x| #1#) (|yp| #2=(|DoubleFloat|))
          ...
          (#4=#:G403 NIL) (|pRel| (PT)) (|cent| (PT)) (#5=#:G474 NIL)
          (|divisor| (|DoubleFloat|)) (|ab| (|DoubleFloat|)) (|centre| (PT)))
         (SEQ
          (EXIT
           (SEQ (COND ((QEQCAR |n| 0) (PROGN (LETT #5# |p|) (GO #6=#:G473))))
                (COND
                 ((QEQCAR |n| 2)
...
(SDEFUN |SBOUND;coerce;$Of;17| ((|n| $) ($ |OutputForm|))
        (SPROG
         ((|sub| (|OutputForm|)) (#1=#:G519 NIL) (#2=#:G404 NIL) (|x| NIL)
          (#3=#:G518 NIL) (#4=#:G517 NIL) (#5=#:G403 NIL) (|s| (|OutputForm|))
          (|ty| (|OutputForm|)))
         (SEQ
          (EXIT
           (SEQ (LETT |ty| (SPADCALL '|none | (QREFELT $ 55)))
                ...
                (LETT |s|
                      (SPADCALL (SPADCALL '|bound | (QREFELT $ 55)) |ty|
                                (QREFELT $ 57)))
                (COND ((QEQCAR |n| 0) (PROGN (LETT #4# |s|) (GO #6=#:G516))))
                (COND
                 ((QEQCAR |n| 1)
                  (PROGN
                   (LETT #4#
