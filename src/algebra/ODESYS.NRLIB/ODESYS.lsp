...
(SDEFUN |ODESYS;solve;MLMR;1|
        ((|mm| |Matrix| F) (|lv| |List| (|Vector| F))
         ...
         ($ |Record|
          ...
          (|:| |basis| (|List| (|Vector| F)))))
        (SPROG
         ((#1=#:G436 NIL) (|bvec| NIL) (#2=#:G435 NIL) (#3=#:G433 NIL)
          (|np| NIL) (#4=#:G434 NIL) (|bv| NIL) (#5=#:G432 NIL)
          (|base_vecs| (|List| (|Vector| F))) (|cb| (|List| (|Vector| F)))
          (|pl| (|List| (|Vector| F))) (|k| #6=(|NonNegativeInteger|))
          (#7=#:G431 NIL) (|l| NIL) (|g1| #8=(|Vector| F)) (#9=#:G428 NIL)
          (|be| NIL) (#10=#:G429 NIL) (#11=#:G430 NIL) (|npl| (|List| #8#))
          (#12=#:G427 NIL) (#13=#:G426 NIL) (#14=#:G425 NIL)
          (|base_vec| (|Vector| F)) (#15=#:G424 NIL) (|s| NIL)
          (|nn| (|NonNegativeInteger|)) (|ncb| (|List| #8#)) (#16=#:G423 NIL)
          (#17=#:G422 NIL)
          (|np1|
           #18=(|List|
                (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|u| (|Record| (|:| |particular| #18#) (|:| |basis| (|List| F))))
          (|crh| (|List| F)) (#19=#:G421 NIL) (#20=#:G420 NIL) (#21=#:G419 NIL)
          (|e| NIL) (#22=#:G417 NIL) (|i| #6#) (#23=#:G418 NIL)
          (#24=#:G416 NIL) (|v| NIL) (#25=#:G415 NIL) (#26=#:G414 NIL)
          (#27=#:G413 NIL) (|n| (|NonNegativeInteger|)) (|mA| #28=(|Matrix| F))
...
(SDEFUN |ODESYS;solve;MVMU;3|
        ((|mm| |Matrix| F) (|v| |Vector| F)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|bm| (|Matrix| F)) (#1=#:G470 NIL) (|bv| NIL) (#2=#:G469 NIL)
          (|s1| (|Vector| F)) (|c1inv| (F))
          (|part1|
         ...
         ((|k| (|NonNegativeInteger|))
          (|ler|
           (|List|
            (|Record| (|:| C (|Matrix| F)) (|:| |lg| (|List| (|Vector| F)))
                      (|:| |eq| LO) (|:| |lrh| (|List| F)))))
          (|lh| (|List| F)) (|h0| (F)) (#1=#:G492 NIL) (|j| NIL)
          (#2=#:G491 NIL) (|sum| (|Vector| F)) (#3=#:G490 NIL) (|g| NIL)
          (|op| (LO)) (#4=#:G489 NIL) (|n| (|NonNegativeInteger|))
          (#5=#:G488 NIL) (|er| NIL)
          (|l|
           (|List|
            (|Record| (|:| C (|Matrix| F)) (|:| |lg| (|List| (|Vector| F))))))
          (#6=#:G487 NIL) (|v| NIL) (#7=#:G486 NIL)
          (|rat|
         ...
         ((|rec|
           (|Union|
            (|Record|
             ...
             (|:| |basis| (|List| (|Vector| F))))
            "failed"))
          (#1=#:G521 NIL) (|u| (|Union| (|Matrix| F) "failed")) (#2=#:G522 NIL)
          (#3=#:G524 NIL) (|i| NIL) (#4=#:G523 NIL)
...
(SDEFUN |ODESYS;M2F| ((|m| |Matrix| LO) ($ |Union| (|Matrix| F) "failed"))
        (SPROG
         ((#1=#:G536 NIL) (|u| (|Union| F "failed")) (#2=#:G538 NIL) (|j| NIL)
          (#3=#:G537 NIL) (|i| NIL) (|mf| (|Matrix| F)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |mf|
...
(DEFUN |SystemODESolver| (&REST #1=#:G552)
  (SPROG NIL
         (PROG (#2=#:G553)
           (RETURN
            (COND
