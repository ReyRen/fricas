...
(SDEFUN |CHARPOL3;char_pol_via_interpolation0|
        ...
        (SPROG
         ((#1=#:G390 NIL) (|j| NIL) (#2=#:G391 NIL) (|di| NIL)
          ...
          (|d1| (R)) (#3=#:G389 NIL) (|i| NIL) (|v| (|SingletonAsOrderedSet|))
...
(SDEFUN |CHARPOL3;char_pol_via_interpolation;MSup;2|
        ...
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| (|Fraction| R)))
          (|ld| (|List| R)) (#1=#:G397 NIL) (|i| NIL) (#2=#:G396 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |CHARPOL3;to_common_denominator|
        ...
        (SPROG
         ((|g1| (R)) (#1=#:G401 NIL) (|a| (|Fraction| R)) (#2=#:G411 NIL)
          (|j| NIL) (|lg| (|List| R)) (|g| (R)) (|lr| (|List| R))
          (#3=#:G410 NIL) (#4=#:G409 NIL) (|i| NIL) (B (|Matrix| R))
...
(DEFUN |CharacteristicPolynomial3| (#1=#:G421)
  (SPROG NIL
         (PROG (#2=#:G422)
           (RETURN
            (COND
