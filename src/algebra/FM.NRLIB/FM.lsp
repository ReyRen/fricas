...
(SDEFUN |FM;*;R2$;3| ((|r| R) (|x| $) ($ $))
        (SPROG ((#1=#:G405 NIL) (|u| NIL) (#2=#:G404 NIL))
               (SEQ
...
(SDEFUN |FM;*;R2$;4| ((|r| R) (|x| $) ($ $))
        (SPROG ((|a| (R)) (#1=#:G410 NIL) (|u| NIL) (#2=#:G409 NIL))
               (SEQ
                (COND ((SPADCALL |r| (QREFELT $ 13)) (|spadConstant| $ 14))
                      ((SPADCALL |r| (QREFELT $ 11) (QREFELT $ 15)) |x|)
                      ('T
...
(SDEFUN |FM;*;$R$;5| ((|x| $) (|r| R) ($ $))
        (SPROG ((#1=#:G415 NIL) (|u| NIL) (#2=#:G414 NIL))
               (SEQ
                (COND ((SPADCALL |r| (QREFELT $ 13)) (|spadConstant| $ 14))
                      ((SPADCALL |r| (QREFELT $ 11) (QREFELT $ 15)) |x|)
                      ('T
...
(SDEFUN |FM;*;$R$;6| ((|x| $) (|r| R) ($ $))
        (SPROG ((|a| (R)) (#1=#:G420 NIL) (|u| NIL) (#2=#:G419 NIL))
               (SEQ
                (COND ((SPADCALL |r| (QREFELT $ 13)) (|spadConstant| $ 14))
                      ((SPADCALL |r| (QREFELT $ 11) (QREFELT $ 15)) |x|)
                      ('T
...
(SDEFUN |FM;coerce;$Of;9| ((|x| $) ($ |OutputForm|))
        (SPROG ((|le| (|List| (|OutputForm|))) (#1=#:G434 NIL) (|rec| NIL))
               (SEQ
                (COND
...
(SDEFUN |FM;coerce;$Of;10| ((|x| $) ($ |OutputForm|))
        (SPROG ((#1=#:G449 NIL) (|rec| NIL) (#2=#:G448 NIL))
               (SEQ
                (SPADCALL (ELT $ 26)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FM;support;$L;11| ((|x| $) ($ |List| S))
        (SPROG ((#1=#:G453 NIL) (|t| NIL) (#2=#:G452 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FM;coefficients;$L;12| ((|x| $) ($ |List| R))
        (SPROG ((#1=#:G457 NIL) (|t| NIL) (#2=#:G456 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |x|) G190
...
(SDEFUN |FM;monomials;$L;14| ((|x| $) ($ |List| $))
        (SPROG ((#1=#:G462 NIL) (|t| NIL) (#2=#:G461 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |x|) G190
...
(SDEFUN |FM;coefficient;$SR;19| ((|x| $) (|s| S) ($ R))
        (SPROG ((#1=#:G486 NIL) (#2=#:G487 NIL) (|t| NIL) (|xr| (|Rep|)))
               (SEQ
                (EXIT
                 (SEQ (LETT |xr| |x|)
...
(DEFUN |FreeModule;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G498 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
