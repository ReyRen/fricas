...
(SDEFUN |INTTOOLS;varselect;LSL;2|
        ...
        (SPROG ((#1=#:G403 NIL) (|k| NIL) (#2=#:G402 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INTTOOLS;kmax;LK;5| ((|l| |List| (|Kernel| F)) ($ |Kernel| F))
        (SPROG ((|ans| (|Kernel| F)) (#1=#:G416 NIL) (|k| NIL))
...
(SDEFUN |INTTOOLS;mkPrim;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG
         ((#1=#:G458 NIL) (|k| NIL) (#2=#:G457 NIL)
          (|lg| (|List| (|Kernel| F))) (#3=#:G456 NIL) (#4=#:G455 NIL))
         (SEQ
          (LETT |lg|
                (PROGN
                 (LETT #4# NIL)
...
(DEFUN |IntegrationTools| (&REST #1=#:G487)
  (SPROG NIL
         (PROG (#2=#:G488)
           (RETURN
            (COND
...
(MAKEPROP '|IntegrationTools| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (|Union| 86 '#1#) (254 . |isExpt|) (259 . |One|) '#:G398
