...
(SDEFUN |FFCAT-;nonSingularModel;SL;13|
        ...
        (SPROG
         ((#1=#:G454 NIL) (|v| NIL) (#2=#:G455 NIL) (|i| NIL) (#3=#:G453 NIL)
          (|y| (|Symbol|)) (|x| (|Symbol|)) (|vars| (|List| (|Symbol|)))
          (#4=#:G452 NIL) (|n| (|Integer|)) (#5=#:G451 NIL)
...
(SDEFUN |FFCAT-;rationalPoints;L;15| (($ |List| (|List| F)))
        (SPROG
         ((|pt| (|List| F)) (#1=#:G461 NIL) (#2=#:G459 NIL) (#3=#:G470 NIL)
          (|y| NIL) (#4=#:G469 NIL) (#5=#:G468 NIL) (|x| NIL) (#6=#:G467 NIL)
          (|p| (UPUP)))
...
(SDEFUN |FFCAT-;intvalue| ((|v| |Vector| UP) (|x| F) (|y| F) ($ F))
        (SPROG
         ((#1=#:G482 NIL) (|d| (F)) (|n| (F)) (#2=#:G476 NIL) (#3=#:G475 (F))
          (#4=#:G477 (F)) (#5=#:G479 NIL) (#6=#:G488 NIL) (|i| NIL)
          (|rec| (|Record| (|:| |num| (|Vector| UP)) (|:| |den| UP)))
          (#7=#:G472 NIL) (#8=#:G471 (S)) (#9=#:G473 (S)) (#10=#:G487 NIL)
...
(SDEFUN |FFCAT-;primitivePart;2S;18| ((|f| S) ($ S))
        (SPROG
         ((#1=#:G504 NIL) (#2=#:G506 NIL) (|i| NIL) (#3=#:G505 NIL) (|d| (UP))
          (#4=#:G503 NIL) (#5=#:G502 NIL)
...
(SDEFUN |FFCAT-;reduceBasisAtInfinity;2V;19| ((|b| |Vector| S) ($ |Vector| S))
        (SPROG
         ((|f| (S)) (|j| NIL) (#1=#:G513 NIL) (#2=#:G512 NIL) (|i| NIL)
          (#3=#:G511 NIL) (|x| (|Fraction| UP)))
         (SEQ
          (LETT |x|
...
(SDEFUN |FFCAT-;complementaryBasis;2V;20| ((|b| |Vector| S) ($ |Vector| S))
        (SPROG
         ((#1=#:G520 NIL) (#2=#:G522 NIL) (|i| NIL) (#3=#:G521 NIL)
          (|m| (|Matrix| (|Fraction| UP))) (#4=#:G515 NIL))
         (SEQ
          (LETT |m|
                (PROG2
                    (LETT #4#
...
(SDEFUN |FFCAT-;represents;VUPS;23| ((|v| |Vector| UP) (|d| UP) ($ S))
        (SPROG ((#1=#:G530 NIL) (#2=#:G532 NIL) (|i| NIL) (#3=#:G531 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #3#
...
(SDEFUN |FFCAT-;genus;Nni;24| (($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G536 NIL) (|dd| (|Integer|)) (#2=#:G534 NIL) (|d| (|Integer|))
          (|ds| (|Fraction| UP)))
...
(SDEFUN |FFCAT-;kmin|
        ...
        (SPROG
         ((|i0| (|Integer|)) (|k| (|Integer|)) (|nostart| (|Boolean|))
          (|nk| (|Integer|)) (#1=#:G558 NIL) (|i| NIL) (|ii| (|Integer|)))
         (SEQ (LETT |nostart| 'T) (LETT |k| 0)
              (LETT |ii|
                    (- (PROGN |m| 1)
                       (LETT |i0| (SPADCALL |v| (QREFELT $ 173)))))
              (SEQ (LETT |i| (SPADCALL |v| (QREFELT $ 173)))
...
(SDEFUN |FFCAT-;normalizeAtInfinity;2V;29| ((|w| |Vector| S) ($ |Vector| S))
        (SPROG
         ((#1=#:G565 NIL) (#2=#:G564 (S)) (#3=#:G566 (S)) (#4=#:G578 NIL)
          (|i| NIL)
          (|pr| (|Record| (|:| |pos| (|Integer|)) (|:| |km| (|Integer|))))
          (|sol| (|Vector| (|Fraction| F))) (#5=#:G572 NIL)
          (|solList| (|List| (|Vector| (|Fraction| F)))) (#6=#:G577 NIL)
          (|j| NIL) (#7=#:G576 NIL) (|r| (|Vector| (|Fraction| UP)))
          (#8=#:G573 NIL) (#9=#:G575 NIL) (#10=#:G574 NIL)
          (|m| (|Matrix| (|Fraction| UP))) (|ii| (|Integer|))
          (|mhat| (|Matrix| (|Fraction| UP)))
          (|infm| (|Matrix| (|Fraction| UP))) (|ans| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| (SPADCALL |w| (QREFELT $ 175)))
...
(SDEFUN |FFCAT-;integral?;SUPB;30| ((|f| S) (|p| UP) ($ |Boolean|))
        (SPROG ((|r| (|Union| F "failed")))
               (SEQ (LETT |r| (SPADCALL |p| (QREFELT $ 187)))
                    (EXIT
                     (COND
                      ((QEQCAR |r| 0)
                       (SPADCALL |f| (QCDR |r|) (QREFELT $ 188)))
                      ('T
                       (QEQCAR
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 193
                                            '(1 10 7 0 11 1 8 0 7 12 1 10 7 0
                                              ...
                                              31 0 148 2 31 22 149 0 150 2 95
                                              17 152 0 153 0 6 83 156 0 6 83
                                              157 2 83 0 0 0 158 1 83 14 0 159
                                              2 14 0 0 94 160 2 14 0 0 0 161 2
                                              94 53 0 0 162 0 6 108 163 1 31 94
                                              0 165 0 14 0 166 2 14 22 0 0 167
                                              0 10 0 168 2 94 22 0 0 169 1 8 7
                                              0 170 2 10 0 7 7 171 1 172 94 0
                                              173 2 10 22 0 0 174 1 95 0 0 175
                                              2 83 0 17 17 176 1 83 94 0 177 2
                                              180 178 179 83 181 1 178 0 0 182
                                              1 178 183 0 184 1 8 186 0 187 2 6
                                              22 0 7 188 2 14 0 0 62 190 2 6 0
                                              0 191 192 1 0 20 0 35 2 0 0 125 8
                                              155 1 0 81 81 139 0 0 111 113 2 0
                                              22 7 7 70 1 0 0 0 132 0 0 17 154
                                              1 0 81 81 185 1 0 101 88 106 1 0
                                              22 0 151 2 0 22 0 7 28 2 0 22 0 8
                                              189 1 0 22 0 24 0 0 45 47 0 0 17
                                              164 3 0 7 0 7 7 124 0 0 45 65 2 0
                                              0 0 62 193 1 0 81 81 144 2 0 61 0
                                              62 63 0 0 22 30)))))
           '|lookupComplete|)) 
