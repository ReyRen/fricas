...
(SDEFUN |LIMITPS;is_exp_log| ((|fcn| FE) (|x| |Symbol|) ($ |Boolean|))
        (SPROG ((#1=#:G562 NIL) (|nm| (|Symbol|)) (#2=#:G563 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL)
...
(SDEFUN |LIMITPS;firstNonLogPtr|
        ...
        (SPROG
         ((|list| (|List| (|Kernel| FE))) (#1=#:G575 NIL)
          (|ker| (|Kernel| FE)))
         (SEQ
          (EXIT
...
(SDEFUN |LIMITPS;specialLimit|
        ...
        (SPROG
         ((#2=#:G632 NIL) (|den| (FE)) (|num| (FE)) (|finVal| (FE))
          (|valu| (|Union| FE "failed")) (|val| (|OrderedCompletion| FE))
          (|fval| (|Union| (|OrderedCompletion| FE) #1#)) (#3=#:G635 NIL)
          (|k| NIL) (|xkers| (|List| (|Kernel| FE))) (#4=#:G634 NIL)
          (#5=#:G633 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |LIMITPS;specialLimitNormalize|
        ...
        (SPROG
         ((|lim| (|Union| FE "failed")) (|limm| (|OrderedCompletion| FE))
          ...
          (#3=#:G659 NIL) (|k| NIL) (#4=#:G658 NIL) (|xkers| (|List| #2#))
          (#5=#:G657 NIL) (#6=#:G656 NIL) (|nfcn| (FE)))
...
(SDEFUN |LIMITPS;specialLimit1|
        ...
        (SPROG
         ((|limVal|
          ...
          (|xkers| (|List| (|Kernel| FE))) (#2=#:G675 NIL) (|k| NIL)
          (#3=#:G674 NIL))
         (SEQ
          (LETT |xkers|
                (PROGN
...
(SDEFUN |LIMITPS;anyRootsOrAtrigs?| ((|fcn| FE) ($ |Boolean|))
        (SPROG ((#1=#:G811 NIL) (#2=#:G812 NIL) (#3=#:G813 NIL) (|kernel| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |kernel| NIL)
...
(SDEFUN |LIMITPS;complLimit|
        ((|fcn| FE) (|x| |Symbol|)
         ($ |Union| (|OnePointCompletion| FE) "failed"))
        (SPROG
         ((|answer| (FE)) (|lim| (FE)) (#1=#:G841 NIL) (|uls| (|Uls|))
          (|lseries|
           (|Union| (|:| |%series| |Uls|)
                    (|:| |%problem|
                         (|Record| (|:| |func| (|String|))
                     ...
                     ((|LIMITPS;anyRootsOrAtrigs?| |fcn| $)
                      (SEQ
                       ...
                       (EXIT
                        (COND
                         ((QEQCAR |pseries| 1)
                          (PROGN (LETT #1# (CONS 1 "failed")) (GO #27=#:G840)))
                         (#28='T
                          (SEQ
                           (COND
                          ...
                          (COND ((EQL |si| 0) (|error| "poleLimit: coef = 0"))
                                (#2='T
                                 (SEQ
                                  (LETT |rtLim|
                                        (COND
                                         ((SPADCALL |si| 0 (QREFELT $ 99))
                                          (SPADCALL (QREFELT $ 70)))
                                         (#2# (SPADCALL (QREFELT $ 59)))))
                                  (EXIT
                                   (COND
                                    ((SPADCALL
                                      (SPADCALL |order| (QREFELT $ 100))
                                      (QREFELT $ 101))
                                     (CONS 0 |rtLim|))
                                    ((SPADCALL
                                      (SPADCALL |order| (QREFELT $ 102))
                                      (QREFELT $ 101))
                                     (CONS 1
                                           (CONS (CONS 1 "failed")
                                                 (CONS 0 |rtLim|))))
...
(SDEFUN |LIMITPS;realLimit|
        ((|fcn| FE) (|x| |Symbol|)
         ($ |Union| (|OrderedCompletion| FE)
          ...
          "failed"))
        (SPROG
         ((|answer| (FE)) (|lim| (|Union| FE "failed")) (#2=#:G915 NIL)
...
(SDEFUN |LIMITPS;limitPlus|
        ...
        (SPROG
         ((|xLim| (|Union| (|OrderedCompletion| FE) #1#)) (|answer| (FE))
          (|lim| (|Union| FE "failed")) (#2=#:G955 NIL) (|cl| (FE))
                   ...
                   (COND
                    ...
                    (#6#
                     (SEQ
                      (EXIT
                       (SEQ (LETT |x| (QCDR |xx|))
                            (LETT |a| (SPADCALL |eq| (QREFELT $ 109)))
...
(SDEFUN |LIMITPS;complexLimit;FEEU;38|
        ((|fcn| FE) (|eq| |Equation| (|OnePointCompletion| FE))
         ($ |Union| (|OnePointCompletion| FE) "failed"))
        (SPROG
         ((#1=#:G1012 NIL) (|res2| #2=(|Union| FE "failed"))
         ...
         (SEQ
          (LETT |f| (SPADCALL (SPADCALL |eq| (QREFELT $ 118)) (QREFELT $ 75)))
          (EXIT
           (COND
            ((QEQCAR |f| 1)
             (|error| "limit:left hand side must be a variable"))
                   ...
                   (COND
                    ...
                    (#3#
                     (SEQ
                      (EXIT
                       (SEQ (LETT |x| (QCDR |xx|))
                            (LETT |a| (SPADCALL |eq| (QREFELT $ 119)))
...
(DEFUN |PowerSeriesLimitPackage| (&REST #1=#:G1013)
  (SPROG NIL
         (PROG (#2=#:G1014)
           (RETURN
            (COND
...
(MAKEPROP '|PowerSeriesLimitPackage| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|ToolsForSign| 6) (274 . |direction|) (|Union| 112 '"failed")
              ...
              (307 . |sign|) (312 . >) (318 . |numer|) (323 . |even?|)
              (328 . |denom|) (333 . -) (338 . |zero?|) (343 . =)
              (349 . |coerce|) (|Equation| 31) (354 . |lhs|) (359 . |rhs|)
              (|Record| (|:| |leftHandLimit| 86) (|:| |rightHandLimit| 86))
              (|Union| 112 110 '"failed") (|OrderedCompletion| 87)
              (364 . |mrv_limit|)
              (|Record| (|:| |leftHandLimit| 90) (|:| |rightHandLimit| 90))
              (|Union| 31 114 '#2="failed") (371 . |limit|) (|Equation| 74)
              (377 . |lhs|) (382 . |rhs|) (|Union| 74 '#3="failed")
              |LIMITPS;complexLimit;FEEU;38|)
           '#(|limit| 387 |complexLimit| 400) 'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 121
                                            '(0 7 0 8 1 7 10 0 11 1 13 12 0 14
                                              ...
                                              7 95 1 97 96 7 98 2 37 20 0 0 99
                                              1 93 37 0 100 1 37 20 0 101 1 93
                                              37 0 102 1 31 0 0 103 1 7 20 0
                                              104 2 31 20 0 0 105 1 93 0 37 106
                                              1 107 31 0 108 1 107 31 0 109 3
                                              88 111 87 15 112 113 2 0 115 7
                                              107 116 1 117 74 0 118 1 117 74 0
                                              119 2 0 115 7 107 116 3 0 90 7 51
                                              83 91 2 0 120 7 117 121)))))
           '|lookupComplete|)) 
