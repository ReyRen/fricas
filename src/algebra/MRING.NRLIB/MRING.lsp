...
(SDEFUN |MRING;index;Pi$;8| ((|i0| |PositiveInteger|) ($ $))
        (SPROG
         ((|i| (|Integer|)) (|ans| ($)) (|m| (M)) (#1=#:G444 NIL) (|cf| (R))
          (#2=#:G442 NIL) (|h| (|Integer|)) (|j| NIL) (|n| (|Integer|))
          (|p| (|Integer|)))
...
(SDEFUN |MRING;lookup;$Pi;9| ((|z| $) ($ |PositiveInteger|))
        (SPROG
         ((|res| (|Integer|)) (|co| (|Integer|))
          (|ex| #1=(|NonNegativeInteger|)) (|l| #1#) (#2=#:G457 NIL) (|te| NIL)
          (|n| (|Integer|)) (|p| (|Integer|))
...
(SDEFUN |MRING;monomials;$L;13| ((|a| $) ($ |List| $))
        (SPROG ((#1=#:G467 NIL) (|t| NIL) (#2=#:G466 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MRING;coefficients;$L;14| ((|a| $) ($ |List| R))
        (SPROG ((#1=#:G472 NIL) (|t| NIL) (#2=#:G471 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;-;2$;18| ((|a| $) ($ $))
        (SPROG ((#1=#:G483 NIL) (|t| NIL) (#2=#:G482 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;*;R2$;19| ((|r| R) (|a| $) ($ $))
        (SPROG ((#1=#:G488 NIL) (|t| NIL) (#2=#:G487 NIL))
               (SEQ
                (COND
                 ((SPADCALL |r| (|spadConstant| $ 16) (QREFELT $ 18))
                  (|spadConstant| $ 15))
...
(SDEFUN |MRING;*;R2$;20| ((|r| R) (|a| $) ($ $))
        (SPROG ((|rt| (R)) (#1=#:G493 NIL) (|t| NIL) (#2=#:G492 NIL))
               (SEQ
                (COND
                 ((SPADCALL |r| (|spadConstant| $ 16) (QREFELT $ 18))
                  (|spadConstant| $ 15))
...
(SDEFUN |MRING;*;I2$;21| ((|n| |Integer|) (|a| $) ($ $))
        (SPROG ((#1=#:G498 NIL) (|t| NIL) (#2=#:G497 NIL))
               (SEQ
                (COND ((EQL |n| 0) (|spadConstant| $ 15))
                      ('T
                       (PROGN
...
(SDEFUN |MRING;*;I2$;22| ((|n| |Integer|) (|a| $) ($ $))
        (SPROG ((|nt| (R)) (#1=#:G503 NIL) (|t| NIL) (#2=#:G502 NIL))
               (SEQ
                (COND ((EQL |n| 0) (|spadConstant| $ 15))
                      ('T
                       (PROGN
...
(SDEFUN |MRING;map;M2$;23| ((|f| |Mapping| R R) (|a| $) ($ $))
        (SPROG ((|ft| (R)) (#1=#:G509 NIL) (|t| NIL) (#2=#:G508 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;coerce;$Of;30| ((|a| $) ($ |OutputForm|))
        (SPROG ((#1=#:G564 NIL) (|t| NIL) (#2=#:G563 NIL))
               (SEQ
...
(SDEFUN |MRING;support;$L;37| ((|a| $) ($ |List| M))
        (SPROG ((#1=#:G585 NIL) (|t| NIL) (#2=#:G584 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MRING;construct;L$;40|
        ((|x| |List| (|Record| (|:| |k| M) (|:| |c| R))) ($ $))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| M) (|:| |c| R)))) (#1=#:G603 NIL)
...
(SDEFUN |MRING;=;2$B;42| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G618 NIL) (#2=#:G619 NIL) (#3=#:G620 NIL) (|ta| NIL)
          (#4=#:G621 NIL) (|tb| NIL))
         (SEQ
          (EXIT
           (COND
                      ...
                      (EXIT
                       (COND
                        ((OR (SPADCALL (QCDR |ta|) (QCDR |tb|) (QREFELT $ 54))
                         ...
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# NIL) (GO #5=#:G617)))
                          (GO #6=#:G614))))))
...
(SDEFUN |MRING;coefficient;$MR;44| ((|a| $) (|m| M) ($ R))
        (SPROG ((#1=#:G641 NIL) (#2=#:G642 NIL) (|t| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |MRING;*;3$;45| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G645 NIL) (#2=#:G644 ($)) (#3=#:G646 ($)) (#4=#:G651 NIL)
          (|tb| NIL) (#5=#:G650 NIL) (#6=#:G649 NIL) (|ta| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MRING;*;3$;46| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G654 NIL) (#2=#:G653 ($)) (#3=#:G655 ($)) (|r| (R))
          (#4=#:G661 NIL) (|tb| NIL) (#5=#:G660 NIL) (#6=#:G659 NIL)
          (|ta| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MRING;*;3$;49| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G680 NIL) (#2=#:G679 ($)) (#3=#:G681 ($)) (#4=#:G692 NIL)
          (|tb| NIL) (#5=#:G691 NIL) (#6=#:G690 NIL) (|ta| NIL))
         (SEQ
...
(SDEFUN |MRING;*;3$;50| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G695 NIL) (#2=#:G694 ($)) (#3=#:G696 ($)) (|r| (R))
          (#4=#:G712 NIL) (|tb| NIL) (#5=#:G711 NIL) (#6=#:G710 NIL)
          (|ta| NIL))
         (SEQ
          (COND ((SPADCALL |a| (QREFELT $ 34)) |a|)
                ((SPADCALL |b| (QREFELT $ 34)) |b|)
...
(SDEFUN |MRING;coefficient;$MR;52| ((|a| $) (|m| M) ($ R))
        (SPROG ((#1=#:G722 NIL) (#2=#:G723 NIL) (#3=#:G724 NIL) (|t| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |MRING;+;3$;54| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G742 NIL) (|m| NIL) (#2=#:G741 NIL) (#3=#:G740 NIL) (|t| NIL)
          (#4=#:G739 NIL) (|Tabl| (|AssociationList| M R)))
...
(SDEFUN |MRING;*;3$;55| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G752 NIL) (|m| NIL) (#2=#:G751 NIL) (#3=#:G750 NIL) (|tb| NIL)
          (#4=#:G749 NIL) (|ta| NIL) (|Tabl| (|AssociationList| M R)))
         (SEQ (LETT |Tabl| (SPADCALL (QREFELT $ 112)))
...
(DEFUN |MonoidRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G753 NIL) (#2=#:G754 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
