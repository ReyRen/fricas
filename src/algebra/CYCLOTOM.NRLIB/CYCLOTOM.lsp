...
(SDEFUN |CYCLOTOM;cyclotomic;ISup;1|
        ...
        (SPROG
         ((|l| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G389 NIL)
          (#2=#:G388 NIL) (#3=#:G386 NIL) (#4=#:G394 NIL) (|u| NIL)
          (|g|
           (|List|
...
(SDEFUN |CYCLOTOM;cyclotomicDecomposition;IL;2|
        ...
        (SPROG
         ((|l| (|List| (|SparseUnivariatePolynomial| (|Integer|))))
          ...
          (#1=#:G400 NIL) (#2=#:G413 NIL) (|z| NIL) (#3=#:G412 NIL)
          (#4=#:G411 NIL) (|rr| NIL) (#5=#:G398 NIL) (#6=#:G410 NIL)
          (#7=#:G409 NIL) (#8=#:G408 NIL) (|u| NIL)
          (|g|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|Integer|))
