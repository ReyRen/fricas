...
(SDEFUN |MULDEP;logDependenceQ;LFU;2|
        ((|lq| |List| (|Fraction| (|Integer|))) (|q| |Fraction| (|Integer|))
         ($ |Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
        (SPROG
         ((|qv| #1=(|Vector| (|Fraction| (|Integer|)))) (#2=#:G406 NIL)
          (|i| NIL) (#3=#:G405 NIL) (|m| (|Matrix| (|Fraction| (|Integer|))))
          (#4=#:G404 NIL) (|j| NIL) (#5=#:G403 NIL) (#6=#:G402 NIL)
          (#7=#:G401 NIL) (|tm| #8=(|Matrix| (|Integer|)))
          (|li| (|List| (|NonNegativeInteger|))) (#9=#:G400 NIL)
          (#10=#:G399 NIL) (|k0| (|NonNegativeInteger|))
