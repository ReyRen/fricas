...
(SDEFUN |LNAGG-;indices;AL;1| ((|a| A) ($ |List| (|Integer|)))
        (SPROG ((#1=#:G395 NIL) (|i| NIL) (#2=#:G394 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LNAGG-;leftTrim;ASA;9| ((|u| A) (|x| S) ($ A))
        (SPROG ((#1=#:G407 NIL) (|i| NIL) (|n| (|Integer|)))
...
(SDEFUN |LNAGG-;rightTrim;ASA;10| ((|u| A) (|x| S) ($ A))
        (SPROG ((#1=#:G411 NIL) (|j| NIL) (|mn| (|Integer|)))
...
(SDEFUN |LNAGG-;trim;ASA;11| ((|u| A) (|x| S) ($ A))
        (SPROG
         ((#1=#:G417 NIL) (|j| NIL) (#2=#:G416 NIL) (|i| NIL)
                       ...
                       (CONS
                        '#((|Join|
                            (|mkCategory|
                             ...
                             (LIST) NIL NIL)))
                        (|makeByteWordVec2| 55
                                            '(1 6 8 0 9 1 6 8 0 10 2 8 13 0 0
                                              14 2 6 0 16 7 17 2 6 0 0 0 18 3 6
                                              0 0 0 8 21 2 23 0 8 8 24 2 23 0 8
                                              0 25 2 6 0 0 23 26 1 6 16 0 28 1
                                              0 8 0 29 3 6 8 7 0 8 30 2 0 8 7 0
                                              31 2 6 7 0 8 32 2 7 13 0 0 33 2 0
                                              0 0 7 34 2 0 0 0 7 35 2 0 0 0 7
                                              36 2 6 7 0 8 37 2 7 38 38 0 39 2
                                              0 38 38 0 40 2 7 13 0 0 41 2 6 13
                                              42 0 43 1 0 13 0 44 2 7 13 0 0 45
                                              3 6 0 42 0 0 46 2 0 0 0 0 47 2 6
                                              0 42 0 48 1 0 0 0 49 1 6 0 0 50 1
                                              6 0 0 51 1 0 0 0 52 2 6 0 42 0 53
                                              2 0 0 42 0 54 1 0 0 0 55 2 0 0 0
                                              7 36 1 0 13 0 44 1 0 0 0 55 1 0 0
                                              0 49 2 0 0 42 0 54 2 0 0 0 7 35 1
                                              0 0 0 52 2 0 8 7 0 31 2 0 0 0 0
                                              47 1 0 8 0 29 2 0 0 0 7 34 3 0 0
                                              7 0 8 22 1 0 11 0 12 2 0 13 8 0
                                              15 2 0 38 38 0 40 2 0 0 0 16 27 2
                                              0 0 0 7 19 2 0 0 7 0 20)))))
           '|lookupComplete|)) 
