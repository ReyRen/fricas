...
(SDEFUN |MATCAT-;diagonal?;SB;2| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G426 NIL) (#2=#:G427 NIL) (#3=#:G429 NIL) (|j| NIL)
          (#4=#:G428 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |MATCAT-;symmetric?;SB;3| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G436 NIL) (#2=#:G437 NIL) (#3=#:G439 NIL) (|j| NIL)
          (#4=#:G438 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|))
          (|nRows| (|Integer|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |MATCAT-;antisymmetric?;SB;4| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G446 NIL) (#2=#:G447 NIL) (#3=#:G449 NIL) (|j| NIL)
          (#4=#:G448 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|))
          (|nRows| (|Integer|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |MATCAT-;zero?;SB;5| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G455 NIL) (#2=#:G457 NIL) (|j| NIL) (#3=#:G456 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |i| (SPADCALL |x| (QREFELT $ 17)))
...
(SDEFUN |MATCAT-;matrix;LS;7| ((|l| |List| (|List| R)) ($ S))
        (SPROG
         ((#1=#:G469 NIL) (|j| NIL) (#2=#:G470 NIL) (|r| NIL) (#3=#:G467 NIL)
          (|i| NIL) (#4=#:G468 NIL) (|ll| NIL) (|ans| (S))
          (|rows| (|NonNegativeInteger|)) (#5=#:G466 NIL)
...
(SDEFUN |MATCAT-;matrix;2NniMS;8|
        ...
        (SPROG
         ((#1=#:G477 NIL) (|j| NIL) (#2=#:G476 NIL) (|i| NIL) (|mat| (S)))
         (SEQ
...
(SDEFUN |MATCAT-;scalarMatrix;NniRS;9|
        ...
        (SPROG
         ((#1=#:G481 NIL) (|i| NIL) (#2=#:G482 NIL) (|j| NIL) (|ans| (S)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;10| ((|l| |List| R) ($ S))
        (SPROG
         ((#1=#:G486 NIL) (|i| NIL) (#2=#:G487 NIL) (|j| NIL) (#3=#:G488 NIL)
...
(SDEFUN |MATCAT-;get_dims|
        ...
        (SPROG ((#1=#:G495 NIL) (|a| NIL) (#2=#:G494 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MATCAT-;kronecker_prod1;SILL2NniUV;12|
        ...
        (SPROG
         ((|c_off1| (|NonNegativeInteger|)) (|mm| (R)) (|aij| (R))
          (#1=#:G533 NIL) (|j| NIL) (#2=#:G532 NIL) (|i| NIL)
          (|c_step| #3=(|NonNegativeInteger|)) (#4=#:G531 NIL) (|rc| NIL)
          (#5=#:G530 NIL) (|r_step| #3#) (#6=#:G529 NIL) (#7=#:G528 NIL)
          (|c_ind| (|NonNegativeInteger|)) (#8=#:G527 NIL) (#9=#:G526 NIL)
...
(SDEFUN |MATCAT-;kroneckerProduct;LS;13| ((|l| |List| S) ($ S))
        (SPROG
         ((#1=#:G564 NIL) (|a| NIL) (|res| (S))
          (|nc| #2=(|NonNegativeInteger|)) (#3=#:G563 NIL) (|rc| NIL)
          (#4=#:G562 NIL) (|nr| #2#) (#5=#:G561 NIL) (#6=#:G560 NIL)
...
(SDEFUN |MATCAT-;kroneckerSum;LS;15| ((|l| |List| S) ($ S))
        (SPROG
         ((|n0| (|Integer|)) (|off0| (|NonNegativeInteger|))
          ...
          (#2=#:G604 NIL) (|j| NIL) (#3=#:G603 NIL) (#4=#:G602 NIL) (|i| NIL)
          (#5=#:G601 NIL) (|m| NIL) (|step0| (|NonNegativeInteger|))
          (|n2| (|NonNegativeInteger|)) (|dl| (|List| (|NonNegativeInteger|)))
          (|nr| (|NonNegativeInteger|)) (#6=#:G600 NIL) (|a| NIL) (|res| (S))
          (|nrs| (|NonNegativeInteger|)) (#7=#:G599 NIL) (#8=#:G598 NIL)
          (|nc| (|NonNegativeInteger|)) (#9=#:G597 NIL)
          (|k| (|NonNegativeInteger|)))
         (SEQ (LETT |k| (LENGTH |l|))
              (EXIT
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;17| ((|list| |List| S) ($ S))
        (SPROG
         ((|loC| (|Integer|)) (|loR| (|Integer|)) (#1=#:G618 NIL) (|j| NIL)
          (#2=#:G619 NIL) (|l| NIL) (#3=#:G616 NIL) (|i| NIL) (#4=#:G617 NIL)
          (|k| NIL) (|hiC| #5=(|Integer|)) (|hiR| #5#) (#6=#:G615 NIL)
...
(SDEFUN |MATCAT-;kronecker_prod1;SILL2NniUV;18|
        ...
        (SPROG
         ((|c_off1| (|NonNegativeInteger|)) (|mm| (R)) (|aij| (R))
          (#1=#:G657 NIL) (|j| NIL) (#2=#:G656 NIL) (|i| NIL)
          (|c_step| #3=(|NonNegativeInteger|)) (#4=#:G655 NIL) (|rc| NIL)
          (#5=#:G654 NIL) (|r_step| #3#) (#6=#:G653 NIL) (#7=#:G652 NIL)
          (|c_ind| (|NonNegativeInteger|)) (#8=#:G651 NIL) (#9=#:G650 NIL)
          (|m| (R)) (|a| (S)) (|nc| #10=(|NonNegativeInteger|)) (|nr| #10#)
          (|dp| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |dp| (|SPADfirst| |dl|))
              (LETT |nr| (SPADCALL |dp| 1 (QREFELT $ 46)))
...
(SDEFUN |MATCAT-;kroneckerProduct;LS;19| ((|l| |List| S) ($ S))
        (SPROG
         ((#1=#:G688 NIL) (|a| NIL) (|res| (S))
          (|nc| #2=(|NonNegativeInteger|)) (#3=#:G687 NIL) (|rc| NIL)
          (#4=#:G686 NIL) (|nr| #2#) (#5=#:G685 NIL) (#6=#:G684 NIL)
          (|dl| (|List| (|List| (|NonNegativeInteger|))))
          (|k| (|NonNegativeInteger|)))
         (SEQ (LETT |k| (LENGTH |l|))
              (EXIT
...
(SDEFUN |MATCAT-;kroneckerSum;LS;21| ((|l| |List| S) ($ S))
        (SPROG
         ((|n0| (|Integer|)) (|off0| (|NonNegativeInteger|))
          (|off_r| #1=(|NonNegativeInteger|)) (|ind_c| #1#) (|vv| (R))
          (#2=#:G728 NIL) (|j| NIL) (#3=#:G727 NIL) (#4=#:G726 NIL) (|i| NIL)
          (#5=#:G725 NIL) (|m| NIL) (|step0| (|NonNegativeInteger|))
          (|n2| (|NonNegativeInteger|)) (|dl| (|List| (|NonNegativeInteger|)))
          (|nr| (|NonNegativeInteger|)) (#6=#:G724 NIL) (|a| NIL) (|res| (S))
          (|nrs| (|NonNegativeInteger|)) (#7=#:G723 NIL) (#8=#:G722 NIL)
          (|nc| (|NonNegativeInteger|)) (#9=#:G721 NIL)
          (|k| (|NonNegativeInteger|)))
         (SEQ (LETT |k| (LENGTH |l|))
              (EXIT
               (COND ((EQL |k| 0) (SPADCALL 1 1 (QREFELT $ 39)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;23| ((|list| |List| S) ($ S))
        (SPROG
         ((|loC| (|Integer|)) (|loR| (|Integer|)) (#1=#:G742 NIL) (|j| NIL)
          (#2=#:G743 NIL) (|l| NIL) (#3=#:G740 NIL) (|i| NIL) (#4=#:G741 NIL)
          (|k| NIL) (|hiC| #5=(|Integer|)) (|hiR| #5#) (#6=#:G739 NIL)
          (|mat| NIL) (|ans| (S)) (|cols| #7=(|NonNegativeInteger|))
          (|rows| #7#) (#8=#:G738 NIL))
         (SEQ (LETT |rows| 0) (LETT |cols| 0)
              (SEQ (LETT |mat| NIL) (LETT #8# |list|) G190
...
(SDEFUN |MATCAT-;coerce;ColS;24| ((|v| |Col|) ($ S))
        (SPROG
         ((#1=#:G747 NIL) (|i| NIL) (#2=#:G748 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;transpose;RowS;25| ((|v| |Row|) ($ S))
        (SPROG
         ((#1=#:G752 NIL) (|j| NIL) (#2=#:G753 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;+;3S;26| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G763 NIL) (|j| NIL) (#2=#:G762 NIL) (|i| NIL) (|ans| (S))
...
(SDEFUN |MATCAT-;-;3S;27| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G773 NIL) (|j| NIL) (#2=#:G772 NIL) (|i| NIL) (|ans| (S))
          (|c| (|NonNegativeInteger|)) (|r| (|NonNegativeInteger|)))
         (SEQ
          (COND
           ((OR
...
(SDEFUN |MATCAT-;*;3S;32| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((|entry| (R)) (|sum| (R)) (#1=#:G791 NIL) (|k| NIL) (#2=#:G792 NIL)
          (|l| NIL) (#3=#:G790 NIL) (|j| NIL) (#4=#:G789 NIL) (|i| NIL)
          (|ans| (S)))
         (SEQ
          (COND
...
(SDEFUN |MATCAT-;*;S2Col;35| ((|x| S) (|v| |Col|) ($ |Col|))
        (SPROG
         ((|sum| (R)) (#1=#:G807 NIL) (|j| NIL) (#2=#:G808 NIL) (|l| NIL)
          (#3=#:G805 NIL) (|i| NIL) (#4=#:G806 NIL) (|k| NIL) (|w| (|Col|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 12))
...
(SDEFUN |MATCAT-;*;RowSRow;36| ((|v| |Row|) (|x| S) ($ |Row|))
        (SPROG
         ((|sum| (R)) (#1=#:G817 NIL) (|i| NIL) (#2=#:G818 NIL) (|l| NIL)
          (#3=#:G815 NIL) (|j| NIL) (#4=#:G816 NIL) (|k| NIL) (|w| (|Row|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 11))
...
(SDEFUN |MATCAT-;columnSpace;SL;37| ((M S) ($ |List| |Col|))
        (SPROG
         ((|indRow| (|Integer|)) (|basis| (|List| |Col|)) (#1=#:G824 NIL)
...
(SDEFUN |MATCAT-;B0| ((|n| |PositiveInteger|) ($ S))
        (SPROG
         ((#1=#:G837 NIL) (|j| NIL) (#2=#:G836 NIL) (#3=#:G835 NIL) (|i| NIL)
          (#4=#:G834 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |MATCAT-;PfChar| ((A S) ($ . #1=(|SparseUnivariatePolynomial| R)))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#2=#:G851 NIL) (|e| NIL)
          (#3=#:G852 NIL) (|k| NIL) (|c| (R)) (#4=#:G849 NIL) (|i| NIL)
          (#5=#:G850 NIL) (|j| NIL) (|g| (|List| R)) (C (S)) (#6=#:G848 NIL)
          (B (S)) (#7=#:G838 NIL) (|d| (|NonNegativeInteger|)) (|p| #1#)
...
(SDEFUN |MATCAT-;exquo;SRU;41| ((|x| S) (|a| R) ($ |Union| S "failed"))
        (SPROG
         ((|entry| (R)) (#1=#:G868 NIL) (|r| (|Union| R "failed"))
          (#2=#:G870 NIL) (|j| NIL) (#3=#:G869 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |ans|
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 127
                                            '(1 6 10 0 11 1 6 10 0 12 1 6 13 0
                                              ...
                                              0 101 2 16 13 0 0 102 3 6 7 0 16
                                              16 103 2 6 9 0 16 104 1 0 105 0
                                              106 1 6 0 35 107 2 108 0 7 10 109
                                              1 108 0 7 110 2 108 0 0 0 111 5 6
                                              0 0 16 16 16 16 112 1 108 10 0
                                              113 0 108 0 114 2 108 7 0 10 115
                                              2 41 0 0 10 116 1 6 13 0 117 2
                                              108 7 0 7 118 1 0 7 0 119 2 7 120
                                              0 0 121 2 0 120 0 7 122 2 7 0 0 0
                                              123 2 0 0 0 7 124 1 16 13 0 125 1
                                              6 120 0 126 2 0 0 0 16 127 1 0 13
                                              ...
                                              120 0 7 122 1 0 0 53 66 1 0 0 41
                                              42 1 0 13 0 24 1 0 105 0 106 1 0
                                              0 9 71 1 0 13 0 28 2 0 0 0 16 127
                                              2 0 0 0 10 92 1 0 7 0 119 2 0 0 0
                                              7 124 1 0 0 0 82 2 0 0 0 0 79 2 0
