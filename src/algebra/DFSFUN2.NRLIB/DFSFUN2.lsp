...
(MAKEPROP '|DoubleFloatSpecialFunctions2| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|PositiveInteger|) (|Float|)
              (0 . |bits|) (4 . |bits|) (|DoubleFloat|) (9 . |convert|)
              (|FloatLiouvilianFunctions|) (14 . |erf|) (19 . |convert|)
              |DFSFUN2;erf;2Df;1| (24 . |erfi|) |DFSFUN2;erfi;2Df;2|
              (29 . |fresnelC|) |DFSFUN2;fresnelC;2Df;3| (34 . |fresnelS|)
              |DFSFUN2;fresnelS;2Df;4| (39 . |Ei|) |DFSFUN2;Ei;2Df;5|
              (44 . |li|) |DFSFUN2;li;2Df;6| (49 . |Ci|) |DFSFUN2;Ci;2Df;7|
              (54 . |Si|) |DFSFUN2;Si;2Df;8| (59 . |Chi|) |DFSFUN2;Chi;2Df;9|
              (64 . |Shi|) |DFSFUN2;Shi;2Df;10|)
