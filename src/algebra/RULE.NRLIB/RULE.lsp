...
(SDEFUN |RULE;mkRule|
        ((|pt| |Pattern| |Base|) (|p| F) (|s| F) (|l| |List| (|Symbol|)) ($ $))
        (VECTOR |pt| |p| |s| |l|)) 
...
(SDEFUN |RULE;suchThat;$LM$;9|
        ((|x| $) (|l| |List| (|Symbol|)) (|f| |Mapping| (|Boolean|) (|List| F))
         ($ $))
        (|RULE;mkRule|
...
(SDEFUN |RULE;F2Symbol| ((|f| F) ($ F))
        (SPROG
         ((#1=#:G409 NIL) (#2=#:G416 NIL) (|k| NIL) (#3=#:G415 NIL)
          (|l| (|List| (|Kernel| F))))
         (SEQ
          (LETT |l|
...
(SDEFUN |RULE;rule;2FL$;14| ((|p| F) (|s| F) (|l| |List| (|Symbol|)) ($ $))
        (SPROG
...
(SDEFUN |RULE;appear?|
        ...
        (SPROG ((#1=#:G441 NIL) (#2=#:G442 NIL) (#3=#:G443 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                            ...
                            ((SPADCALL |p| |x| (QREFELT $ 66))
                             (COND
                              ((SPADCALL |x| (SPADCALL |p| (QREFELT $ 67))
                                         (QREFELT $ 69))
                               (PROGN
                                (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G440)))
                                (GO #5=#:G438))))))))
...
(SDEFUN |RULE;bad?|
        ...
        (SPROG ((#1=#:G452 NIL) (#2=#:G453 NIL) (#3=#:G454 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (COND
                  ((QEQCAR |u| 0)
...
(MAKEPROP '|RewriteRule| '|infovec|
          (LIST
           ...
           (CONS (|makeByteWordVec2| 1 '(0 0 0 0 0))
                 (CONS '#(|SetCategory&| |BasicType&| |RetractableTo&| NIL NIL)
                       (CONS
                        '#((|SetCategory|) (|BasicType|)
                           (|RetractableTo| (|Equation| 8)) (|Eltable| 8 8)
                           (|CoercibleTo| 78))
                        (|makeByteWordVec2| 85
                                            '(1 16 8 0 17 1 16 8 0 18 2 23 8 22
                                              8 24 3 27 10 10 14 26 28 2 8 30 0
                                              0 31 2 14 30 0 0 32 3 23 8 22 8
                                              34 35 1 38 37 0 39 1 8 40 0 41 2
                                              43 0 42 0 44 1 8 0 45 46 3 8 0 0
                                              40 47 48 1 10 30 0 49 1 8 50 0 51
                                              1 8 0 52 53 2 16 0 8 8 54 1 8 10
                                              0 57 2 10 0 0 0 58 2 10 0 0 0 59
                                              2 8 0 0 0 60 2 8 0 0 0 61 1 8 62
                                              0 63 1 64 8 8 65 2 10 30 0 0 66 1
                                              10 47 0 67 2 68 30 10 0 69 1 10
                                              30 0 70 1 10 71 0 72 0 45 0 73 0
                                              8 0 74 1 10 71 0 75 0 7 0 76 0 8
                                              0 77 1 45 78 0 79 1 8 78 0 80 3
                                              78 0 0 0 0 81 2 0 30 0 0 1 3 0 0
                                              0 14 26 29 3 0 0 8 8 14 19 2 0 0
                                              8 8 21 1 0 8 0 13 1 0 55 0 56 1 0
                                              16 0 1 1 0 14 0 15 1 0 10 0 11 1
                                              0 8 0 12 1 0 83 0 1 2 0 85 85 0 1
                                              1 0 84 0 1 3 0 8 0 8 34 36 2 0 8
                                              0 8 25 1 0 0 16 20 1 0 78 0 82 2
                                              0 30 0 0 33)))))
           '|lookupComplete|)) 
