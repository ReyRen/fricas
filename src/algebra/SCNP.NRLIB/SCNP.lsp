...
(SDEFUN |SCNP;isPointLeaf?;$B;4| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G421 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 0) (PROGN (LETT #1# 'T) (GO #2=#:G420))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 
...
(SDEFUN |SCNP;isNodeLeaf?;$B;5| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G424 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 1) (PROGN (LETT #1# 'T) (GO #2=#:G423))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 
...
(SDEFUN |SCNP;isNodeBranch?;$B;6| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G427 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 2) (PROGN (LETT #1# 'T) (GO #2=#:G426))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 

(SDEFUN |SCNP;getNames;$L;7| ((|n| $) ($ |List| (|String|)))
        (SPROG ((#1=#:G405 NIL) (#2=#:G431 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |n| 0)
                    (PROGN (LETT #2# (QCDR (CDR |n|))) (GO #3=#:G430))))
                  (EXIT
                   (QCDR
                    (PROG2 (LETT #1# |n|)
                        (QCDR #1#)
...
(SDEFUN |SCNP;findPoint;$SPT;8| ((|n| $) (|ptName| |String|) ($ PT))
        (SPROG
         ((#1=#:G440 NIL) (#2=#:G403 NIL) (|s| (|String|)) (#3=#:G441 NIL)
          (|sNum| NIL) (|fst| ($)) (|c| (|List| $)) (#4=#:G405 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |SCNP;addNode!;$SS$;10|
        ...
        (SPROG
         ((#1=#:G404 NIL) (#2=#:G452 NIL) (#3=#:G405 NIL) (|fst| ($))
          (|c| (|List| $)) (|scnd| ($)))
         (SEQ
          (EXIT
           (SEQ
                 ...
                 (SEQ
                  ...
                  (PROGN
                   (RPLACD
                    ...
                    (LIST "useNames"))
                   (QCDR #5#))
                  (EXIT (PROGN (LETT #2# |scnd|) (GO #6=#:G451))))))
               (LETT |fst| (SPADCALL |c| (QREFELT $ 24)))
               (COND
                ((SPADCALL |fst| (QREFELT $ 17))
                 (PROGN
...
(SDEFUN |SCNP;findNode;$SS;11| ((|n| $) (|ptName| |String|) ($ |Scene| PT))
        (SPROG
         ((#1=#:G459 NIL) (#2=#:G404 NIL) (#3=#:G460 NIL) (|name| NIL)
          (#4=#:G461 NIL) (|namei| NIL) (|fst| ($)) (|c| (|List| $))
          (#5=#:G405 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SCNP;toString;$S;12| ((|n| $) ($ |String|))
        (SPROG
         ((|s| (|String|)) (#1=#:G481 NIL) (|l1| NIL) (#2=#:G482 NIL)
          (|ptr| NIL) (#3=#:G479 NIL) (|lst| NIL) (#4=#:G480 NIL)
          (#5=#:G476 NIL) (|lenPT| (|NonNegativeInteger|))
          (|lenNM| (|NonNegativeInteger|)) (#6=#:G477 NIL) (#7=#:G478 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |s| "")
                (COND
...
(SDEFUN |SCNP;coerce;$Of;16| ((|n| $) ($ |OutputForm|))
        (SPROG
         ((|s| (|OutputForm|)) (#1=#:G516 NIL) (|l1| NIL) (#2=#:G517 NIL)
          (|ptr| NIL) (#3=#:G514 NIL) (|lst| NIL) (#4=#:G515 NIL)
          (#5=#:G511 NIL) (|lenPT| (|NonNegativeInteger|))
          (|lenNM| (|NonNegativeInteger|)) (#6=#:G512 NIL) (#7=#:G513 NIL))
         (SEQ
          (EXIT
