...
(SDEFUN |EUCDOM-;expressIdealMember;LSU;10|
        ...
        (SPROG
         ((#1=#:G493 NIL) (|v| NIL) (#2=#:G492 NIL) (|q| (|Union| S "failed"))
          (|pid| (|Record| (|:| |coef| (|List| S)) (|:| |generator| S)))
          (#3=#:G491 NIL) (#4=#:G490 NIL))
         (SEQ
          (COND
...
(SDEFUN |EUCDOM-;multiEuclidean;LSU;11|
        ...
        (SPROG
         ((|v2| #2=(|Union| (|List| S) #1#)) (|v1| #2#)
          ...
          (#3=#:G501 NIL) (#4=#:G500 (S)) (#5=#:G502 (S)) (#6=#:G513 NIL)
          (#7=#:G383 NIL) (#8=#:G498 NIL) (#9=#:G497 (S)) (#10=#:G499 (S))
          (#11=#:G512 NIL) (#12=#:G382 NIL) (|l2| (|List| S)) (|l1| (|List| S))
