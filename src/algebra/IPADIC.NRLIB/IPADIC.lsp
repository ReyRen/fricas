...
(SDEFUN |IPADIC;=;2$B;15| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG
         ((|st| (|Stream| (|Integer|))) (#1=#:G459 NIL) (#2=#:G460 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
                ...
                (COND
                 ...
                 ((ZEROP (SPADCALL |yy| (QREFELT $ 31)))
                  (COND
                   ...
                   (#1='T (CONS 1 "failed"))))
                 (#1#
                  (SEQ (LETT |rec| (SPADCALL |yy| (QREFELT $ 60)))
                       (EXIT
...
(SDEFUN |IPADIC;divide;2$R;36|
        ...
        (SPROG ((|z| (|Union| $ "failed")))
               (SEQ (LETT |z| (SPADCALL |x| |y| (QREFELT $ 62)))
                    (EXIT
...
(SDEFUN |IPADIC;iRoot!0| (($$ NIL))
        (PROG (|f| |alpha| $ |pPow| |invFpx0| |p|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G608 NIL) (|num| NIL) (|digit| NIL))
                   (SEQ
                    (LETT |num|
                          (SPADCALL
                           (PROG2
...
(SDEFUN |IPADIC;coerce;$Of;43| ((|x| $) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|st| ($)) (|st1| ($)) (|n| NIL)
          (#1=#:G643 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(DEFUN |InnerPAdicInteger| (&REST #1=#:G655)
  (SPROG NIL
         (PROG (#2=#:G656)
           (RETURN
            (COND
