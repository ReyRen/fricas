...
(SDEFUN |XPBWPOLY;prod1|
        ...
        (SPROG
         ((#1=#:G405 NIL) (#2=#:G404 ($)) (#3=#:G406 ($)) (#4=#:G408 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |XPBWPOLY;prod2|
        ...
        (SPROG
         ((#1=#:G410 NIL) (#2=#:G409 ($)) (#3=#:G411 ($)) (#4=#:G413 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |XPBWPOLY;prod11|
        ...
        (SPROG
         ((#1=#:G415 NIL) (#2=#:G414 ($)) (#3=#:G416 ($)) (#4=#:G419 NIL)
          (|t| NIL) (|limit| (|Integer|)))
...
(SDEFUN |XPBWPOLY;prod22|
        ((|p| $) (|b| |PoincareBirkhoffWittLyndonBasis| |VarSet|)
         (|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((#1=#:G421 NIL) (#2=#:G420 ($)) (#3=#:G422 ($)) (#4=#:G425 NIL)
          (|t| NIL) (|limit| (|Integer|)))
         (SEQ (LETT |limit| (- |n| (SPADCALL |b| (QREFELT $ 23))))
              (EXIT
               (PROGN
...
(SDEFUN |XPBWPOLY;Dexpand|
        ...
        (SPROG
         ((#1=#:G428 NIL) (#2=#:G427 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G429 #3#) (#5=#:G431 NIL) (|l| NIL))
         (SEQ
          (COND
           ...
           (#6='T
            (PROGN
             (LETT #1# NIL)
             (SEQ (LETT |l| NIL) (LETT #5# (SPADCALL |b| (QREFELT $ 29))) G190
                  (COND
                    ...
                    (PROGN
                     (LETT #4#
                           (SPADCALL (SPADCALL |l| (QREFELT $ 35))
                                     (QREFELT $ 36)))
                     (COND (#1# (LETT #2# (SPADCALL #2# #4# (QREFELT $ 37))))
...
(SDEFUN |XPBWPOLY;Rexpand|
        ...
        (SPROG
         ((#1=#:G433 NIL) (#2=#:G432 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G434 #3#) (#5=#:G436 NIL) (|l| NIL))
         (SEQ
          (COND
           ((SPADCALL |b| (|spadConstant| $ 15) (QREFELT $ 16))
            (|spadConstant| $ 39))
                   ...
                   (EXIT
                    (PROGN
                     (LETT #4#
                           (SPADCALL (SPADCALL |l| (QREFELT $ 35))
                                     (QREFELT $ 40)))
                     (COND (#1# (LETT #2# (SPADCALL #2# #4# (QREFELT $ 41))))
                           ('T (PROGN (LETT #2# #4#) (LETT #1# 'T)))))))
                  (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
                  ...
                  (SEQ
                   (LETT |lp|
                         (SPADCALL (SPADCALL |b| (QREFELT $ 31))
                                   (QREFELT $ 35)))
                   (LETT |lp| (SPADCALL |lp| (QREFELT $ 42)))
                   (EXIT
                    (SPADCALL
...
(SDEFUN |XPBWPOLY;process|
        ...
        (SPROG
         ((|r2| ($)) (#1=#:G452 NIL) (#2=#:G451 ($)) (#3=#:G453 ($))
          (#4=#:G461 NIL) (|t| NIL) (|r1| ($)) (#5=#:G449 NIL) (#6=#:G448 ($))
          (#7=#:G450 ($)) (#8=#:G460 NIL) (#9=#:G446 NIL) (#10=#:G445 ($))
          (#11=#:G447 ($)) (#12=#:G459 NIL) (|fd| (|LyndonWord| |VarSet|))
          (|rd| (|List| (|LyndonWord| |VarSet|))) (#13=#:G442 NIL)
          (#14=#:G441 ($)) (#15=#:G443 ($)) (#16=#:G458 NIL)
                ...
                (SEQ
                 (LETT |r1|
                       (PROGN
                        (LETT #13# NIL)
                        (SEQ (LETT |t| NIL)
                             (LETT #16# (SPADCALL |p| (QREFELT $ 51))) G190
                             (COND
                              ((OR (ATOM #16#)
                ...
                (SEQ (LETT |rd| (CDR |droite|))
                     ...
                     (LETT |r1|
                           (PROGN
                            (LETT #9# NIL)
                            (SEQ (LETT |t| NIL)
                                 (LETT #12# (SPADCALL |p| (QREFELT $ 51))) G190
                                 (COND
                                  ((OR (ATOM #12#)
...
(SDEFUN |XPBWPOLY;coerce;$Of;13| ((|p| $) ($ |OutputForm|))
        (SPROG ((|le| (|List| (|OutputForm|))) (#1=#:G470 NIL) (|rec| NIL))
               (SEQ
                (COND
...
(SDEFUN |XPBWPOLY;coerce;Lp$;15| ((|p| |LiePolynomial| |VarSet| R) ($ $))
        (SPROG ((#1=#:G476 NIL) (|t| NIL) (#2=#:G475 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# (SPADCALL |p| (QREFELT $ 51)))
                      G190
                      (COND
...
(SDEFUN |XPBWPOLY;coerce;$Xdp;16|
        ...
        (SPROG
         ((#1=#:G478 NIL) (#2=#:G477 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G479 #3#) (#5=#:G481 NIL) (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
                  ...
                  (PROGN
                   (LETT #4#
                         (SPADCALL (QCDR |t|) (|XPBWPOLY;Dexpand| (QCAR |t|) $)
                                   (QREFELT $ 63)))
                   (COND (#1# (LETT #2# (SPADCALL #2# #4# (QREFELT $ 64))))
                         ('T (PROGN (LETT #2# #4#) (LETT #1# 'T)))))))
                (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
...
(SDEFUN |XPBWPOLY;coerce;$Xrp;17|
        ...
        (SPROG
         ((#1=#:G483 NIL) (#2=#:G482 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G484 #3#) (#5=#:G486 NIL) (|t| NIL))
         (SEQ
          (COND
                    ...
                    (PROGN
                     (LETT #4#
                           (SPADCALL (QCDR |t|)
                                     ...
                                     (QREFELT $ 69)))
                     (COND (#1# (LETT #2# (SPADCALL #2# #4# (QREFELT $ 70))))
                           ('T (PROGN (LETT #2# #4#) (LETT #1# 'T)))))))
                  (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
...
(SDEFUN |XPBWPOLY;*;3$;22| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G496 NIL) (#2=#:G495 ($)) (#3=#:G497 ($)) (#4=#:G500 NIL)
          (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |XPBWPOLY;varList;$L;23| ((|p| $) ($ |List| |VarSet|))
        (SPROG
         ((|lv| #1=(|List| |VarSet|)) (#2=#:G502 NIL) (#3=#:G501 #1#)
          (#4=#:G503 #1#) (#5=#:G506 NIL) (|b| NIL))
         (SEQ
          (LETT |lv|
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |b| NIL) (LETT #5# |p|) G190
                      ...
                      (SEQ
                       (EXIT
                        (PROGN
                         (LETT #4# (SPADCALL (QCAR |b|) (QREFELT $ 84)))
                         (COND
...
(SDEFUN |XPBWPOLY;product;2$Nni$;26|
        ...
        (SPROG
         ((#1=#:G511 NIL) (#2=#:G510 ($)) (#3=#:G512 ($)) (#4=#:G514 NIL)
          (|t| NIL))
         (SEQ
          (COND
        ...
        (SPROG
         ...
         (SEQ
          (COND
           ...
           ('T
            (SEQ (LETT |s| (|spadConstant| $ 26))
                 (LETT |r| (|spadConstant| $ 26))
                 (SEQ (LETT |i| 1) (LETT #1# |n|) G190
                      (COND ((|greater_SI| |i| #1#) (GO G191)))
                      (SEQ (LETT |k1| (SPADCALL 1 |i| (QREFELT $ 94)))
                           (LETT |k2|
          ...
          (COND
           ...
           ('T
            (SEQ
             ...
             (LETT |s| (SPADCALL (|spadConstant| $ 26) (QREFELT $ 98)))
             ...
             (SEQ (LETT |i| 1) (LETT #1# |n|) G190
                  ...
                  (SEQ (LETT |k1| (SPADCALL 1 |i| (QREFELT $ 94)))
                       (LETT |k2|
                             (SPADCALL |k1| (|spadConstant| $ 9)
                                       (QREFELT $ 95)))
                       (LETT |s| (SPADCALL |p1| |s| |n| (QREFELT $ 92)))
                       (EXIT
                        (LETT |r|
...
(SDEFUN |XPBWPOLY;LiePolyIfCan;$U;29|
        ...
        (SPROG
         ((|lt|
          ...
          (#1=#:G543 NIL) (|t| NIL) (#2=#:G542 NIL) (#3=#:G531 NIL)
          (#4=#:G530 #5=(|Boolean|)) (#6=#:G532 #5#) (#7=#:G541 NIL))
         (SEQ
          (COND
           ((SPADCALL |p| (|spadConstant| $ 21) (QREFELT $ 67))
           ...
           ((PROGN
             ...
             (SEQ (LETT |t| NIL) (LETT #7# |p|) G190
                  ...
                  (SEQ
                   (EXIT
                    (PROGN
                     (LETT #6# (SPADCALL (QCAR |t|) (QREFELT $ 101)))
...
(SDEFUN |XPBWPOLY;mirror;2$;30| ((|p| $) ($ $))
        (SPROG
         ((#1=#:G545 NIL) (#2=#:G544 ($)) (#3=#:G546 ($)) (#4=#:G548 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |XPBWPolynomial| (&REST #1=#:G563)
  (SPROG NIL
         (PROG (#2=#:G564)
           (RETURN
            (COND
...
(DEFUN |XPBWPolynomial;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G562 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
    ...
    (COND
     ((|testBitVector| |pv$| 8)
      (PROGN
       (QSETREFV $ 96 (CONS (|dispatchFunction| |XPBWPOLY;exp;$Nni$;27|) $))
       (QSETREFV $ 99 (CONS (|dispatchFunction| |XPBWPOLY;log;$Nni$;28|) $)))))
    $))) 
...
(MAKEPROP '|XPBWPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|FreeModule| 7 13) (|local| |#1|)
              ...
              |XPBWPOLY;LiePolyIfCan;$U;29| |XPBWPOLY;mirror;2$;30| (|List| 74)
              (|Mapping| 7 13) (|Union| 13 '#1="failed") (|List| 13) (|List| 7)
              (|List| $) (|FreeMonoid| 6) (|Mapping| 7 7)
              (|Record| (|:| |k| 112) (|:| |c| 7)) (|Union| 112 '#1#)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 105
                                  '(0 7 0 9 2 7 10 0 0 11 1 13 12 0 14 0 13 0
                                    ...
                                    102 1 0 83 0 87 2 0 0 0 22 91 1 6 0 0 90 1
                                    0 10 0 79 1 0 0 0 82 3 0 0 0 0 22 92 2 0 0
                                    7 13 27 1 0 0 0 105 2 8 0 0 22 99 1 6 13 0
                                    72 2 8 0 0 22 96 1 0 22 0 88 1 0 10 0 73 1
