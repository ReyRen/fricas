...
(SDEFUN |PARTPERM;partitions;2IS;3|
        ...
        (SPROG
         ((|aaa| (|List| (|Stream| (|List| (|Integer|))))) (#1=#:G405 NIL)
          (|i| NIL) (#2=#:G404 NIL))
         (SEQ
          (LETT |aaa|
                (PROGN
               ...
               (SEQ
                (COND
                 ...
                 ((OR (OR (ZEROP M) (SPADCALL N 0 (QREFELT $ 24))) (< |n| 0))
                  (SPADCALL (QREFELT $ 7)))
                 ('T
                  (SEQ (COND ((SPADCALL N (QREFELT $ 25)) (LETT N (- N 1))))
                       (LETT |c|
                             (SPADCALL
...
(SDEFUN |PARTPERM;nogreq|
        ...
        (SPROG
         ((#1=#:G421 NIL) (#2=#:G420 #3=(|Integer|)) (#4=#:G422 #3#)
          (#5=#:G424 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |PARTPERM;rpt| ((|n| |Integer|) (|m| |Integer|) ($ |List| (|Integer|)))
        (SPROG ((#1=#:G453 NIL) (|i| NIL) (#2=#:G452 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |PARTPERM;permutations;IS;17|
        ((|n| |Integer|) ($ |Stream| (|List| (|Integer|))))
        (SPROG ((#1=#:G467 NIL) (|i| NIL) (#2=#:G466 NIL))
               (SEQ
