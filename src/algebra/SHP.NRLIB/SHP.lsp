...
(SDEFUN |SHP;polsth1|
        ...
        (SPROG
         ((|List2| (|List| UP)) (|Pr6| (UP)) (#1=#:G491 NIL) (#2=#:G496 NIL)
          (|j| NIL) (|List1| (|List| UP)) (|Listf| (|List| UP)) (#3=#:G482 NIL)
          (|Pr5| (UP)) (#4=#:G481 NIL) (#5=#:G479 NIL) (|Pr4| (UP))
          (#6=#:G432 NIL) (|Pr3| (UP)) (#7=#:G418 NIL)
          (|r| (|NonNegativeInteger|)) (|c2| (R)) (|Pr2| (UP)) (#8=#:G403 NIL)
          (|Pr1| (UP)) (|sc1| (R)))
         (SEQ
...
(SDEFUN |SHP;polsth2|
        ((|p1| UP) (|p| |NonNegativeInteger|) (|p2| UP)
         (|q| |NonNegativeInteger|) (|c1| R) ($ |List| UP))
        (SPROG
         ((|List2| (|List| UP)) (|Pr5| (UP)) (#1=#:G505 NIL) (|Pr4| (UP))
          (#2=#:G503 NIL) (#3=#:G511 NIL) (|j| NIL)
...
(SDEFUN |SHP;polsth3|
        ((|p1| UP) (|p| |NonNegativeInteger|) (|p2| UP)
         (|q| |NonNegativeInteger|) (|c1| R) ($ |List| UP))
        (SPROG
         ((|List2| (|List| UP)) (|Pr3| (UP)) (#1=#:G523 NIL) (|Pr2| (UP))
          (#2=#:G521 NIL) (#3=#:G529 NIL) (#4=#:G514 NIL) (|j| NIL)
...
(SDEFUN |SHP;SturmHabichtCoefficients;2UPL;6|
        ((|p1| UP) (|p2| UP) ($ |List| R))
        (SPROG
         ((#1=#:G532 NIL) (#2=#:G537 NIL) (|p| NIL) (#3=#:G538 NIL) (|j| NIL)
          (#4=#:G536 NIL) (|qp| (|NonNegativeInteger|)) (|List1| (|List| UP)))
...
(SDEFUN |SHP;epsil|
        ...
        (SPROG
         ((|ct4| (|Integer|)) (|ct3| (|NonNegativeInteger|)) (#1=#:G549 NIL)
          (|ct2| #2=(|Integer|)) (|ct1| #2#))
         (SEQ
...
(SDEFUN |SHP;wfunctaux| ((|Lsig| . #1=(|List| R)) ($ |Integer|))
        (SPROG
         ((|ind4| (|Integer|)) (|ind3| (|Integer|)) (|ind2| (|Integer|))
          (|List1| #1#) (#2=#:G567 NIL) (|j| NIL)
          (|cont2| (|NonNegativeInteger|)) (|List2| (|List| R)) (#3=#:G566 NIL)
...
(SDEFUN |SHP;SturmHabicht;2UPI;15| ((|p1| UP) (|p2| UP) ($ |Integer|))
        (SPROG
         ((#1=#:G575 NIL) (|p| NIL) (#2=#:G574 NIL) (|List1| (|List| UP)))
         (SEQ
          (COND
...
(SDEFUN |SHP;SturmHabichtMultiple;2UPI;17| ((|p1| UP) (|p2| UP) ($ |Integer|))
        (SPROG
         ((#1=#:G600 NIL) (|f| NIL) (#2=#:G599 NIL)
          (|sqfr|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| UP)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (SH (|List| UP)) (|ans| (|Integer|)) (#3=#:G577 NIL) (#4=#:G597 NIL)
          (|p| NIL) (#5=#:G598 NIL) (|j| NIL) (#6=#:G596 NIL)
...
(DEFUN |SturmHabichtPackage| (&REST #1=#:G602)
  (SPROG NIL
         (PROG (#2=#:G603)
           (RETURN
            (COND
