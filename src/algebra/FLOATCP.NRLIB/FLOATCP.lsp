...
(SDEFUN |FLOATCP;complexRoots;LLParL;2|
        ...
        (SPROG
         ((|lden| (|List| #1=(|Polynomial| (|Complex| (|Integer|)))))
          (|dp| #1#) (#2=#:G393 NIL) (|p| NIL) (#3=#:G392 NIL)
          (|lnum| (|List| (|Polynomial| (|Complex| (|Integer|)))))
          (#4=#:G391 NIL) (#5=#:G390 NIL))
         (SEQ
          (LETT |lnum|
                (PROGN
                 (LETT #5# NIL)
...
(SDEFUN |FLOATCP;complexSolve;LParL;3|
        ...
        (SPROG
         ((#1=#:G416 NIL) (|x| NIL) (#2=#:G417 NIL) (|r| NIL) (#3=#:G415 NIL)
          (#4=#:G414 NIL) (|nres| NIL) (#5=#:G413 NIL)
          (|lv| #6=(|List| (|Symbol|))) (#7=#:G400 NIL) (#8=#:G399 #6#)
          (#9=#:G401 #6#) (#10=#:G412 NIL)
          (|dp| #11=(|Polynomial| (|Complex| (|Integer|)))) (#12=#:G397 NIL)
          (#13=#:G396 #6#) (#14=#:G398 #6#) (#15=#:G411 NIL) (|np| NIL)
          (|lden| (|List| #11#)) (#16=#:G410 NIL) (|p| NIL) (#17=#:G409 NIL)
          (|lnum| (|List| (|Polynomial| (|Complex| (|Integer|)))))
         ...
         (SEQ
          ...
          (LETT |lv|
                (PROGN
                 (LETT #12# NIL)
                 (SEQ (LETT |np| NIL) (LETT #15# |lnum|) G190
                      (COND
                       ((OR (ATOM #15#) (PROGN (LETT |np| (CAR #15#)) NIL))
                        (GO G191)))
                      (SEQ
                       (EXIT
                        (PROGN
                         (LETT #14# (SPADCALL |np| (QREFELT $ 27)))
                         (COND
                          (#12#
                           (LETT #13# (SPADCALL #13# #14# (QREFELT $ 28))))
                          ('T (PROGN (LETT #13# #14#) (LETT #12# 'T)))))))
                      (LETT #15# (CDR #15#)) (GO G190) G191 (EXIT NIL))
                 (COND (#12# #13#) (#20='T (|IdentityError| '|setUnion|)))))
          (COND
           ((SPADCALL |lden| NIL (QREFELT $ 29))
            (LETT |lv|
                  (SPADCALL |lv|
                            (PROGN
                             (LETT #7# NIL)
                             (SEQ (LETT |dp| NIL) (LETT #10# |lden|) G190
                                  (COND
                                   ((OR (ATOM #10#)
...
(SDEFUN |FLOATCP;complexSolve;LParL;4|
        ((|le| |List|
         ...
         ($ |List| (|List| (|Equation| (|Polynomial| (|Complex| |Par|))))))
        (SPROG
         ((#1=#:G443 NIL) (|x| NIL) (#2=#:G444 NIL) (|r| NIL) (#3=#:G442 NIL)
          (#4=#:G441 NIL) (|nres| NIL) (#5=#:G440 NIL)
          (|lv| #6=(|List| (|Symbol|))) (#7=#:G425 NIL) (#8=#:G424 #6#)
          (#9=#:G426 #6#) (#10=#:G439 NIL)
          (|dp| #11=(|Polynomial| (|Complex| (|Integer|)))) (#12=#:G422 NIL)
          (#13=#:G421 #6#) (#14=#:G423 #6#) (#15=#:G438 NIL) (|np| NIL)
          (|lden| (|List| #11#)) (#16=#:G437 NIL) (|p| NIL) (#17=#:G436 NIL)
          (|lnum| (|List| (|Polynomial| (|Complex| (|Integer|)))))
          (#18=#:G435 NIL) (#19=#:G434 NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| (|Complex| (|Integer|))))))
          (#20=#:G433 NIL) (|ep| NIL) (#21=#:G432 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
                 (LETT #21# NIL)
                       ...
                       (EXIT
                        (PROGN
                         ...
                         (COND
                          ...
                          ('T (PROGN (LETT #13# #14#) (LETT #12# 'T)))))))
                      (LETT #15# (CDR #15#)) (GO G190) G191 (EXIT NIL))
                 (COND (#12# #13#) (#22='T (|IdentityError| '|setUnion|)))))
          (COND
           ((SPADCALL |lden| NIL (QREFELT $ 29))
            (LETT |lv|
                  (SPADCALL |lv|
...
(DEFUN |FloatingComplexPackage| (#1=#:G455)
  (SPROG NIL
         (PROG (#2=#:G456)
           (RETURN
            (COND
