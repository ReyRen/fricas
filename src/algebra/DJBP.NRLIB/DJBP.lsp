...
(SDEFUN |DJBP;lookup| ((|jv| JB) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G417 NIL) (#2=#:G418 NIL) (|i| NIL) (#3=#:G419 NIL)
          (|ljv| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |DJBP;mainVariable;$U;8| ((|p| $) ($ |Union| JB "failed"))
        (SPROG
         ((#1=#:G441 NIL) (#2=#:G442 NIL) (|i| NIL) (#3=#:G443 NIL) (|jv| NIL)
          (|tdeg| (E)))
         (SEQ
          (EXIT
...
(SDEFUN |DJBP;variables;$L;9| ((|p| $) ($ |List| JB))
        (SPROG
         ((#1=#:G456 NIL) (|jv| NIL) (#2=#:G457 NIL) (|i| NIL) (#3=#:G455 NIL)
          (#4=#:G454 NIL) (|tdeg| (E))
...
(SDEFUN |DJBP;coerce;$Of;10| ((|p| $) ($ |OutputForm|))
        (SPROG
         ((|lt| #1=(|List| (|OutputForm|))) (|l| #1#) (#2=#:G474 NIL) (|i| NIL)
          (#3=#:G473 NIL) (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |DJBP;univariate;$JBSup;16|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G513 NIL)
          (#2=#:G515 NIL) (|i| NIL) (#3=#:G514 NIL)
...
(SDEFUN |DJBP;totalDegree;$Nni;20| ((|p| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G531 NIL) (#2=#:G530 #3=(|NonNegativeInteger|)) (#4=#:G532 #3#)
          (#5=#:G537 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |DJBP;degree;$LL;22|
        ...
        (SPROG ((#1=#:G542 NIL) (|jv| NIL) (#2=#:G541 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |DJBP;minimumDegree;$LL;24|
        ((|p| $) (|ljv| |List| JB) ($ |List| (|NonNegativeInteger|)))
        (SPROG ((#1=#:G547 NIL) (|jv| NIL) (#2=#:G546 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |jv| NIL) (LETT #1# |ljv|) G190
...
(SDEFUN |DJBP;eval;$LL$;29|
        ((|p| $) (|Ljvar| |List| JB) (|Lpval| |List| $) ($ $))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G567 NIL) (|mvar| NIL) (#2=#:G566 NIL)
          (|nljvar| (|List| JB)))
         (SEQ
          (LETT |nljvar|
...
(SDEFUN |DJBP;content;$R;32| ((|p| $) ($ R))
        (SPROG
         ((#1=#:G571 NIL) (#2=#:G570 (R)) (#3=#:G572 (R)) (#4=#:G575 NIL)
          (|t| NIL))
         (SEQ
...
(DEFUN |DistributedJetBundlePolynomial| (&REST #1=#:G635)
  (SPROG NIL
         (PROG (#2=#:G636)
           (RETURN
            (COND
...
(DEFUN |DistributedJetBundlePolynomial;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G634 NIL) (|jv| NIL) (#2=#:G633 NIL) (#3=#:G632 NIL) (|pv$| NIL)
    (#4=#:G624 NIL) (#5=#:G625 NIL) (#6=#:G626 NIL) (#7=#:G627 NIL)
    (#8=#:G628 NIL) (#9=#:G629 NIL) (#10=#:G630 NIL) (#11=#:G631 NIL) ($ NIL)
...
(MAKEPROP '|DistributedJetBundlePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 6 9) (|local| |#1|)
              ...
              (|Union| 166 '#1="failed") (|Matrix| $) (|InputForm|)
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 9 7)
                 ...
                 (|RetractableTo| 36) (|canonicalUnitNormal|) (|TwoSidedRecip|)
