...
(SDEFUN |IBACHIN;applyFrobToMatrix|
        ...
        (SPROG
         ((#1=#:G391 NIL) (|j| NIL) (#2=#:G390 NIL) (|i| NIL)
         ...
         ((|outList|
           (|List|
            (|Record| (|:| |basis| (|Matrix| R)) (|:| |basisDen| R)
                      (|:| |basisInv| (|Matrix| R)))))
          (|newBasis| #1#) (|bDen| (R)) (|bInv| #3#) (|b| #2#) (#4=#:G401 NIL)
          (|i| NIL))
...
(SDEFUN |IBACHIN;factorList;K3NniL;3|
        ...
        (SPROG
         ((|outList| (|List| (|SparseUnivariatePolynomial| K)))
          (|coef| #1=(|SparseUnivariatePolynomial| K)) (#2=#:G406 NIL)
          (|i| NIL) (|xx| #1#))
...
(SDEFUN |IBACHIN;basisInfoToPolys|
        ...
        (SPROG
         ((|outList| (|List| UP)) (|pp| (UP)) (#1=#:G413 NIL) (|j| NIL)
          (#2=#:G412 NIL) (|i| NIL) (|n1| (|Integer|)) (|n| (|Integer|)))
...
(SDEFUN |IBACHIN;basesToPolyLists|
        ((|basisList| |List|
          (|Record| (|:| |basis| (|Matrix| R)) (|:| |basisDen| R)
                    (|:| |basisInv| (|Matrix| R))))
         (|lcm| R) ($ |List| (|List| UP)))
        (SPROG ((#1=#:G418 NIL) (|b| NIL) (#2=#:G417 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |IBACHIN;approximateExtendedEuclidean|
        ...
        (SPROG
         ((|t| #1=(|SparseUnivariatePolynomial| R)) (|s| #1#) (|pPower| (R))
          ...
          (|rhs| (|SparseUnivariatePolynomial| R)) (#3=#:G423 NIL)
          (|num| (|SparseUnivariatePolynomial| R)) (#4=#:G442 NIL) (|i| NIL)
...
(SDEFUN |IBACHIN;mapChineseToList|
        ((|list| |List| UP) (|polyList| |List| UP) (|i| |Integer|) (|den| R)
         ($ |List| UP))
        (SPROG
         ((#1=#:G456 NIL) (|pp| NIL) (#2=#:G455 NIL) (|invPoly| (UP))
          (|n| #3=(|NonNegativeInteger|)) (|prime| (R))
          (|factoredDen|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| R) (|:| |exponent| #3#))))
          (|q| (UP)) (|j| NIL) (|p| (UP)) (#4=#:G454 NIL))
...
(SDEFUN |IBACHIN;polyListToMatrix|
        ...
        (SPROG
         ((|poly| (UP)) (#1=#:G463 NIL) (|i| NIL) (#2=#:G464 NIL)
          (|mat| (|Matrix| R)))
...
(SDEFUN |IBACHIN;chineseRemainder;LLNniR;9|
        ...
        (SPROG
         ((|matInv| (|Matrix| R)) (|mat| (|Matrix| R))
          ...
          (|polyList| (|List| UP)) (|i| NIL) (#1=#:G477 NIL) (|pList| NIL)
          (|factorBasisPolyLists| (|List| (|List| UP))) (|denLCM| (R))
          (#2=#:G476 NIL) (|base| NIL) (#3=#:G475 NIL))
         (SEQ
          (LETT |denLCM|
                (SPADCALL (ELT $ 66)
                          (PROGN
...
(DEFUN |ChineseRemainderToolsForIntegralBases| (&REST #1=#:G478)
  (SPROG NIL
         (PROG (#2=#:G479)
           (RETURN
            (COND
