...
(SDEFUN |RINTERP;interpolate;2L2NniF;1|
        ...
        (SPROG
         ((|reslist| (|List| (|List| (|Polynomial| F)))) (#1=#:G417 NIL)
          (|i| NIL) (#2=#:G416 NIL) (#3=#:G415 NIL) (#4=#:G414 NIL)
          (|res| (|List| (|Vector| F))) (|collist| (|List| (|List| F)))
          (#5=#:G413 NIL) (#6=#:G412 NIL) (#7=#:G411 NIL) (|j| NIL)
          (#8=#:G410 NIL) (#9=#:G409 NIL) (#10=#:G408 NIL)
          (|tempvec| (|List| F)) (#11=#:G407 NIL) (#12=#:G406 NIL)
          (#13=#:G405 NIL) (#14=#:G404 NIL) (#15=#:G403 NIL) (#16=#:G402 NIL))
         (SEQ
          (COND
...
(DEFUN |RationalInterpolation| (&REST #1=#:G418)
  (SPROG NIL
         (PROG (#2=#:G419)
           (RETURN
            (COND
