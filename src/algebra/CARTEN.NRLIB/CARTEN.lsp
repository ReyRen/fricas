        ...
        (SPROG
         ((|qr|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#1=#:G414 NIL) (|i| NIL) (|rnk| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |CARTEN;index2int| ((|indv| |Vector| (|Integer|)) ($ |Integer|))
        (SPROG ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G420 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
...
(SDEFUN |CARTEN;mkPerm|
        ((|n| |NonNegativeInteger|) (|l| |List| (|Integer|))
         ($ |Vector| (|Integer|)))
        (SPROG
         ((#1=#:G434 NIL) (#2=#:G437 NIL) (|e| NIL) (#3=#:G435 NIL) (|i| NIL)
          (#4=#:G436 NIL) (|seen| (|Vector| (|Boolean|)))
          (|p| (|Vector| (|Integer|))))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;permsign!| ((|v| |Vector| (|Integer|)) ($ |Integer|))
        (SPROG
         ((#1=#:G456 NIL) (#2=#:G460 NIL) (|i| NIL) (|totTrans| (|Integer|))
          (|e| (|Integer|)) (|nTrans| (|Integer|)) (#3=#:G458 NIL)
          (#4=#:G459 NIL) (|j| NIL) (|n| (|Integer|)) (#5=#:G457 NIL)
          (|psum| (|Integer|)) (#6=#:G443 NIL) (|maxix| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |CARTEN;ravel;$L;8| ((|x| $) ($ |List| R))
        (SPROG ((#1=#:G464 NIL) (|i| NIL) (#2=#:G463 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0)
...
(SDEFUN |CARTEN;unravel;L$;9| ((|l| |List| R) ($ $))
        (SPROG
         ((#1=#:G468 NIL) (|i| NIL) (#2=#:G469 NIL) (|r| NIL) (|z| ($))
...
(SDEFUN |CARTEN;kroneckerDelta;$;10| (($ $))
        (SPROG ((#1=#:G473 NIL) (|i| NIL) (#2=#:G474 NIL) (|zi| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
...
(SDEFUN |CARTEN;leviCivitaSymbol;$;11| (($ $))
        (SPROG
         ((#1=#:G478 NIL) (|i| NIL) (|indv| (|Vector| (|Integer|))) (|z| ($))
          (|nz| (|NonNegativeInteger|)))
...
(SDEFUN |CARTEN;elt;$LR;19| ((|x| $) (|i| |List| (|Integer|)) ($ R))
        (SPROG
         ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G498 NIL) (|ii| NIL))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;coerce;L$;20| ((|lr| |List| R) ($ $))
        (SPROG ((#1=#:G503 NIL) (|r| NIL) (#2=#:G504 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
...
(SDEFUN |CARTEN;coerce;L$;21| ((|lx| |List| $) ($ $))
        (SPROG
         ((#1=#:G516 NIL) (|i| NIL) (#2=#:G514 NIL) (|x| NIL) (#3=#:G515 NIL)
          (|offz| NIL) (|z| ($)) (|nx| (|NonNegativeInteger|)) (#4=#:G512 NIL)
          (#5=#:G513 NIL) (|rx| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;mkOutf|
        ((|x| $) (|i0| |Integer|) (|rnk| |NonNegativeInteger|)
         ($ |OutputForm|))
        (SPROG
         ((#1=#:G537 NIL) (|j| NIL) (#2=#:G536 NIL) (#3=#:G535 NIL) (|i| NIL)
          (#4=#:G534 NIL) (|nskip| (|NonNegativeInteger|))
          (|rnk1| (|NonNegativeInteger|)) (#5=#:G533 NIL) (#6=#:G532 NIL))
         (SEQ
          (COND
           ((ODDP |rnk|)
            (SEQ (LETT |rnk1| (- |rnk| 1))
...
(SDEFUN |CARTEN;coerce;Dp$;28| ((|v| |DirectProduct| |dim| R) ($ $))
        (SPROG ((#1=#:G545 NIL) (|i| NIL) (#2=#:G546 NIL) (|j| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
                      (SPADCALL (QREFELT $ 7) (|spadConstant| $ 36)
                                (QREFELT $ 37)))
...
(SDEFUN |CARTEN;coerce;Sm$;29| ((|m| |SquareMatrix| |dim| R) ($ $))
        (SPROG
         ((|offz| (|NonNegativeInteger|)) (#1=#:G553 NIL) (|j| NIL)
          (#2=#:G552 NIL) (|i| NIL) (|z| ($)))
         (SEQ
          (LETT |z|
...
(SDEFUN |CARTEN;=;2$B;30| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG ((#1=#:G559 NIL) (#2=#:G560 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| (QREFELT $ 33))
                                       ...
                                       (QREFELT $ 78))
                             (PROGN (LETT #1# NIL) (GO #3=#:G558))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                    (EXIT 'T)))))
                #3# (EXIT #1#)))) 

(SDEFUN |CARTEN;+;3$;31| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G565 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
                 ((SPADCALL (SPADCALL |x| (QREFELT $ 32))
                            (SPADCALL |y| (QREFELT $ 32)) (QREFELT $ 26))
...
(SDEFUN |CARTEN;product;3$;38| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G597 NIL) (|j| NIL) (#2=#:G595 NIL) (|i| NIL) (#3=#:G596 NIL)
...
(SDEFUN |CARTEN;contract;$2I$;40|
        ...
        (SPROG
         ((#3=#:G616 NIL) (|k| NIL) (#4=#:G617 NIL) (|xk| NIL) (#5=#:G613 NIL)
          (|l| NIL) (#6=#:G614 NIL) (|xl| NIL) (#7=#:G615 NIL) (|zl| NIL)
          (#8=#:G610 NIL) (|m| NIL) (#9=#:G611 NIL) (|xm| NIL) (#10=#:G612 NIL)
          (|zm| NIL) (#11=#:G607 NIL) (|h| NIL) (#12=#:G608 NIL) (|xh| NIL)
          (#13=#:G609 NIL) (|zh| NIL) (|z| ($))
...
(SDEFUN |CARTEN;contract;$I$I$;41|
        ...
        (SPROG
         ((#1=#:G638 NIL) (|k| NIL) (#2=#:G639 NIL) (|xk| NIL) (#3=#:G640 NIL)
          (|yk| NIL) (#4=#:G635 NIL) (|dyl| NIL) (#5=#:G636 NIL) (|yl| NIL)
          (#6=#:G637 NIL) (|zly| NIL) (#7=#:G632 NIL) (|dyh| NIL)
          (#8=#:G633 NIL) (|yh| NIL) (#9=#:G634 NIL) (|zhy| NIL)
          (#10=#:G629 NIL) (|dxl| NIL) (#11=#:G630 NIL) (|xl| NIL)
          (#12=#:G631 NIL) (|zlx| NIL) (#13=#:G626 NIL) (|dxh| NIL)
          (#14=#:G627 NIL) (|xh| NIL) (#15=#:G628 NIL) (|zhx| NIL) (|z| ($))
...
(SDEFUN |CARTEN;transpose;$2I$;43|
        ((|x| $) (|i| . #1=(|Integer|)) (|j| . #2=(|Integer|)) ($ $))
        (SPROG
         ((#3=#:G658 NIL) (|q| NIL) (#4=#:G659 NIL) (|zq| NIL) (#5=#:G660 NIL)
          (|xq| NIL) (#6=#:G655 NIL) (|p| NIL) (#7=#:G656 NIL) (|zp| NIL)
          (#8=#:G657 NIL) (|xp| NIL) (#9=#:G653 NIL) (|l| NIL) (#10=#:G654 NIL)
          (|zl| NIL) (#11=#:G651 NIL) (|m| NIL) (#12=#:G652 NIL) (|zm| NIL)
          (#13=#:G649 NIL) (|h| NIL) (#14=#:G650 NIL) (|zh| NIL) (|z| ($))
...
(DEFUN |CartesianTensor| (&REST #1=#:G666)
  (SPROG NIL
         (PROG (#2=#:G667)
           (RETURN
            (COND
