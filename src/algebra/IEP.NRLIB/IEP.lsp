...
(SDEFUN |IEP;eigenvalues;MML;10|
        ((A |Matrix| F)
         ...
         ($ |List| (|Union| F (|SparseUnivariatePolynomial| F))))
        (SPROG
         ((#1=#:G438 NIL) (|ls| NIL) (#2=#:G437 NIL) (#3=#:G436 NIL) (|lr| NIL)
          (#4=#:G435 NIL) (|lsym| (|List| (|SparseUnivariatePolynomial| F)))
          (|lrat| (|List| F)) (|rv| (F))
          (|f1| (|SparseUnivariatePolynomial| F)) (#5=#:G434 NIL) (|fr| NIL)
...
(SDEFUN |IEP;intRatEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G454 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G453 NIL)
          (|v| NIL) (#3=#:G452 NIL) (|j| NIL) (#4=#:G451 NIL) (B (|Matrix| F))
...
(SDEFUN |IEP;intAlgEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G480 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G479 NIL)
          (|vec| NIL) (#3=#:G478 NIL) (|j| NIL) (#4=#:G477 NIL) (B (AM))
...
(SDEFUN |IEP;eigenvectors;MML;17|
        ...
        (SPROG
         ((|algSol|
          ...
          (|vec| (F)) (|pol| #2#) (#3=#:G510 NIL) (|fact| NIL)
          (|lff|
           (|List|
...
(DEFUN |InnerEigenPackage| (#1=#:G511)
  (SPROG NIL
         (PROG (#2=#:G512)
           (RETURN
            (COND
