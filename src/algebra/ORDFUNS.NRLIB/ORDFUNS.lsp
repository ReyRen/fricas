...
(SDEFUN |ORDFUNS;pureLex;2VB;1|
        ...
        (SPROG ((#1=#:G393 NIL) (#2=#:G394 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |ORDFUNS;totalLex;2VB;2|
        ((|v1| |Vector| S) (|v2| |Vector| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G403 NIL) (#2=#:G405 NIL) (|i| NIL) (|n2| (S)) (|n1| (S))
          (#3=#:G404 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |ORDFUNS;reverseLex;2VB;3|
        ((|v1| |Vector| S) (|v2| |Vector| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G414 NIL) (|i| NIL) (|n2| (S)) (|n1| (S)) (#2=#:G415 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |n1| (|spadConstant| $ 13))
                (LETT |n2| (|spadConstant| $ 13))
...
(DEFUN |OrderingFunctions| (&REST #1=#:G416)
  (SPROG NIL
         (PROG (#2=#:G417)
           (RETURN
            (COND
