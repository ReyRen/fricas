...
(SDEFUN |WFFINTBS;iLocalIntegralBasis|
        ...
        (SPROG
         ((#1=#:G425 NIL) (#2=#:G426 NIL) (|oldIndex| (R)) (|indexChange| (R))
          (|rbinv| #3=(|Matrix| R)) (|rbden| (R)) (|rb| #3#) (|index| (R))
          (|idinv| (|Matrix| R)) (|id| (|Matrix| R)) (#4=#:G435 NIL) (|j| NIL)
          (#5=#:G434 NIL) (|vec| NIL) (|i| NIL) (#6=#:G433 NIL) (#7=#:G432 NIL)
          (|ns| (|List| (|Vector| |sae|))) (|frobPow| (|Matrix| |sae|))
          (#8=#:G431 NIL) (#9=#:G430 NIL) (#10=#:G429 NIL) (|r| NIL)
          (|tmpMat| (|Matrix| |sae|)) (|frob| (|Matrix| |sae|))
          (|pPows| (|Matrix| |sae|)) (|coMat| (|Matrix| R))
          (|coMat0| (|Union| (|Matrix| R) "failed")) (|denPow| (R))
          (#11=#:G402 NIL) (|coor0| (|Matrix| R)) (|bi| (F)) (#12=#:G428 NIL)
          (#13=#:G427 NIL) (|lp| (|NonNegativeInteger|))
         ...
         ((|runningRbinv| #1=(|Matrix| R)) (|runningRb| #1#)
          ...
          (|lb|
           (|Record| (|:| |basis| #3#) (|:| |basisDen| R) (|:| |basisInv| #2#)
                     (|:| |discr| R)))
          (#4=#:G446 NIL) (|prime| NIL) (|matrixOut| #5=(|Matrix| R))
...
(DEFUN |WildFunctionFieldIntegralBasis| (&REST #1=#:G456)
  (SPROG NIL
         (PROG (#2=#:G457)
           (RETURN
            (COND
