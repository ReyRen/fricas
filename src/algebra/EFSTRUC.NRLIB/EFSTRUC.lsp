...
(SDEFUN |EFSTRUC;toY| ((|ker| |List| (|Kernel| F)) ($ |List| F))
        (SPROG ((|func| (F)) (#1=#:G506 NIL) (|k| NIL) (#2=#:G505 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |EFSTRUC;toZ| ((|ker| |List| (|Kernel| F)) ($ |List| F))
        (SPROG ((|func| (F)) (#1=#:G510 NIL) (|k| NIL) (#2=#:G509 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# |ker|) G190
...
(SDEFUN |EFSTRUC;toU| ((|ker| |List| (|Kernel| F)) ($ |List| F))
        (SPROG ((|func| (F)) (#1=#:G514 NIL) (|k| NIL) (#2=#:G513 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# |ker|) G190
...
(SDEFUN |EFSTRUC;toV| ((|ker| |List| (|Kernel| F)) ($ |List| F))
        (SPROG ((|func| (F)) (#1=#:G518 NIL) (|k| NIL) (#2=#:G517 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# |ker|) G190
...
(SDEFUN |EFSTRUC;tanSum| ((|c| F) (|l| |List| F) ($ F))
        (SPROG ((#1=#:G535 NIL) (|r| (|Union| (|Integer|) "failed")) (|k| (F)))
               (SEQ
                (EXIT
...
(SDEFUN |EFSTRUC;findQRelation|
        ...
        (SPROG
         ((|u| (|Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
          (#2=#:G560 NIL) (|j| NIL) (#3=#:G561 NIL) (|k| NIL) (#4=#:G558 NIL)
          (|i| NIL) (#5=#:G559 NIL) (|var| NIL) (|mat| (|Matrix| F))
          (|isconstant| (|Boolean|)) (#6=#:G556 NIL) (#7=#:G557 NIL)
          (|v| (|Vector| F)) (|lvv| #1#) (|m| (|NonNegativeInteger|))
          (#8=#:G554 NIL) (#9=#:G555 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |EFSTRUC;findLinearRelation1|
        ...
        (SPROG
         ((|u| (|Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
          (#1=#:G570 NIL) (|j| NIL) (#2=#:G571 NIL) (|k| NIL)
...
(SDEFUN |EFSTRUC;transkers| ((|x| |List| (|Kernel| F)) ($ |List| (|Kernel| F)))
        (SPROG ((#1=#:G576 NIL) (|k| NIL) (#2=#:G575 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |EFSTRUC;toQ|
        ...
        (SPROG ((#1=#:G588 NIL) (|k| NIL) (#2=#:G587 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |EFSTRUC;findLinearRelation2|
        ((|lk| |List| (|Kernel| F)) (|lz| |List| F) (|ker| |Kernel| F)
         ($ |Union| (|:| |vec| (|Vector| (|Fraction| (|Integer|))))
          (|:| |func| F) (|:| |fail| (|Boolean|))))
        (SPROG
         ((|nz| (F)) (|ly| (|List| F)) (#1=#:G630 NIL) (|x| NIL)
          (#2=#:G629 NIL) (#3=#:G628 NIL) (#4=#:G627 NIL)
          (|lpars1f| (|List| F)) (#5=#:G626 NIL) (|s| NIL) (#6=#:G625 NIL)
          (|lpars1| (|List| (|Symbol|))) (#7=#:G624 NIL) (|k| NIL)
          (#8=#:G623 NIL) (|lpars0| #9=(|List| (|Kernel| F))) (#10=#:G620 NIL)
          ...
          (#11=#:G621 NIL) (|z1| NIL) (#12=#:G622 NIL) (|i| NIL)
...
(SDEFUN |EFSTRUC;findRelation|
        ((|lv| |List| (|Symbol|)) (|lpar| |List| (|Symbol|))
         ...
         ($ |Union| (|:| |vec| (|Vector| (|Fraction| (|Integer|))))
          (|:| |func| F) (|:| |fail| (|Boolean|))))
        (SPROG ((#1=#:G650 NIL) (|x| NIL) (#2=#:G649 NIL))
               (SEQ
                (COND
...
(SDEFUN |EFSTRUC;do_int| ((|op| |BasicOperator|) (|args| |List| F) ($ F))
        (SPROG
         ((|dvs| (|List| F)) (#1=#:G711 NIL) (|v| NIL) (#2=#:G710 NIL)
          (|vfs| (|List| F)) (#3=#:G709 NIL) (#4=#:G708 NIL)
...
(SDEFUN |EFSTRUC;k_to_liou| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G726 NIL) (#2=#:G725 NIL) (|i| (|Integer|))
          (|iu| (|Union| (|Integer|) "failed")) (|nm| (|Symbol|))
          (|args| (|List| F)) (#3=#:G728 NIL) (|a| NIL) (#4=#:G727 NIL)
          (|op| (|BasicOperator|)))
...
(SDEFUN |EFSTRUC;do_int1|
        ...
        (SPROG
         ((|dvs| (|List| F)) (#2=#:G736 NIL) (|v| NIL) (#3=#:G735 NIL)
          (|vfs| (|List| F)) (#4=#:G734 NIL) (#5=#:G733 NIL)
          (|vars| (|List| #1#)) (|kf1| (F)))
         (SEQ (LETT |kf1| (SPADCALL |op| |args| (QREFELT $ 138)))
              (LETT |vars| (LIST |x|))
              (LETT |vfs|
...
(SDEFUN |EFSTRUC;k_to_liou1| ((|k| |Kernel| F) (|x| |Symbol|) ($ F))
        (SPROG
         ((#1=#:G760 NIL) (#2=#:G759 NIL) (|i| (|Integer|))
          (|iu| (|Union| (|Integer|) "failed")) (|nm| (|Symbol|))
          (|args| (|List| F)) (#3=#:G762 NIL) (|a| NIL) (#4=#:G761 NIL)
          (|op| (|BasicOperator|)))
         (SEQ (LETT |op| (SPADCALL |k| (QREFELT $ 74)))
              (LETT |args|
                    (PROGN
...
(SDEFUN |EFSTRUC;k2Elem| ((|k| |Kernel| F) (|l| |List| (|Symbol|)) ($ F))
        (SPROG
         ((|args| (|List| F)) (#1=#:G767 NIL) (|a| NIL) (#2=#:G766 NIL)
          (|op| (|BasicOperator|)))
         (SEQ (LETT |op| (SPADCALL |k| (QREFELT $ 74)))
              (LETT |args|
                    (PROGN
...
(SDEFUN |EFSTRUC;rooteval|
        ((|lf| |List| F) (|lk| |List| (|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#1=#:G786 NIL) (|f| NIL) (#2=#:G785 NIL)
          (|lv| (|List| F)) (#3=#:G784 NIL) (|r| NIL) (#4=#:G783 NIL)
          (|l| (|List| (|Kernel| F))) (#5=#:G782 NIL) (#6=#:G781 NIL)
          (|nv| (F)) (|m| (|Integer|)) (|x| (F)))
         (SEQ
          (LETT |nv|
                (SPADCALL
...
(SDEFUN |EFSTRUC;ataneval|
        ((|lf| |List| F) (|lk| |List| (|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#1=#:G802 NIL) (|f| NIL) (#2=#:G801 NIL)
          (|g| (F)) (|h| (F)) (|d| (F)) (#3=#:G790 NIL) (#4=#:G789 (F))
          (#5=#:G791 (F)) (#6=#:G799 NIL) (|i| NIL) (#7=#:G800 NIL) (|x| NIL)
          (|s| (F)) (#8=#:G797 NIL) (#9=#:G798 NIL) (#10=#:G796 NIL) (|w| (F)))
...
(SDEFUN |EFSTRUC;gdCoef?|
        ((|c| |Fraction| (|Integer|)) (|v| |Vector| (|Fraction| (|Integer|)))
         ($ |Boolean|))
        (SPROG ((#1=#:G810 NIL) (#2=#:G811 NIL) (#3=#:G812 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((QEQCAR
                              ...
                              1)
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G809)))
                              (GO #5=#:G807))))))
...
(SDEFUN |EFSTRUC;goodCoef|
        ((|v| |Vector| (|Fraction| (|Integer|))) (|l| |List| (|Kernel| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G843 NIL) (#2=#:G844 NIL)
          (|r| (|Union| (|Fraction| (|Integer|)) "failed")) (#3=#:G848 NIL)
          (|i| NIL) (#4=#:G849 NIL) (|k| NIL) (|h| (|NonNegativeInteger|))
          (|j| (|Integer|)) (|h1| (|NonNegativeInteger|)) (#5=#:G846 NIL)
          (#6=#:G847 NIL) (|ll| (|List| (|Kernel| F))) (#7=#:G845 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |EFSTRUC;taneval|
        ((|lf| |List| F) (|lk| |List| #1=(|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#2=#:G875 NIL) (|f| NIL) (#3=#:G874 NIL)
          (|g| (F)) (#4=#:G872 NIL) (|a| NIL) (#5=#:G873 NIL) (|x| NIL)
          (#6=#:G871 NIL) (|l| (|List| #1#)) (#7=#:G870 NIL) (|kk| NIL)
          (#8=#:G869 NIL) (|lv| (|List| (|Fraction| (|Integer|))))
          (#9=#:G868 NIL) (|i| NIL) (#10=#:G867 NIL) (|v0| (|Integer|))
          (|rec|
           (|Union|
            (|Record| (|:| |index| (|Integer|)) (|:| |ker| (|Kernel| F)))
            "failed"))
          (|c| (F)) (#11=#:G852 NIL) (#12=#:G851 (F)) (#13=#:G853 (F))
          (#14=#:G865 NIL) (#15=#:G866 NIL) (|fns| (|List| F)) (|u| (F)))
...
(SDEFUN |EFSTRUC;tannosimp|
        ((|lf| |List| F) (|lk| |List| #1=(|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#2=#:G918 NIL) (|f| NIL) (#3=#:G917 NIL)
          (|h| (F)) (#4=#:G915 NIL) (|i| NIL) (#5=#:G916 NIL) (|x| NIL)
          (#6=#:G914 NIL) (#7=#:G913 NIL) (#8=#:G912 NIL) (|lk1| (|List| #1#))
          (|newtan| (|List| F)) (#9=#:G910 NIL) (#10=#:G911 NIL) (|t| NIL)
          (#11=#:G909 NIL) (|li| (|List| (|NonNegativeInteger|)))
          (#12=#:G908 NIL) (#13=#:G907 NIL) (#14=#:G906 NIL) (#15=#:G905 NIL)
          (|newt| (|List| F)) (#16=#:G903 NIL) (|u| NIL) (#17=#:G904 NIL)
          (#18=#:G902 NIL) (|dd| (F)) (|d| #19=(|Integer|))
          (|cd| (|Record| (|:| |num| (|Vector| (|Integer|))) (|:| |den| #19#)))
          (#20=#:G900 NIL) (#21=#:G901 NIL) (#22=#:G899 NIL) (#23=#:G898 NIL)
          (#24=#:G897 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (QVSIZE |v|))
              (LETT |lk|
                    (PROGN
                     (LETT #24# NIL)
...
(SDEFUN |EFSTRUC;expnosimp|
        ((|lf| |List| F) (|lk| |List| (|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#1=#:G937 NIL) (|f| NIL) (#2=#:G936 NIL)
          (|lexp| (|List| F)) (|lke| (|List| (|Kernel| F))) (|h| (F))
          (|nui| (F)) (|di| (|Integer|)) (|vi| (|Fraction| (|Integer|)))
          (#3=#:G933 NIL) (|i| NIL) (#4=#:G934 NIL) (|k1| NIL) (#5=#:G935 NIL)
          (|y| NIL) (|vnum| #6=(|Vector| (|Integer|))) (|d| #7=(|Integer|))
          (|cd| (|Record| (|:| |num| #6#) (|:| |den| #7#))) (#8=#:G932 NIL)
          (|x| NIL) (#9=#:G931 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (QVSIZE |v|))
              (LETT |lk|
                    (PROGN
                     (LETT #9# NIL)
...
(SDEFUN |EFSTRUC;logeval|
        ((|lf| |List| F) (|lk| |List| (|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#1=#:G962 NIL) (|f| NIL) (#2=#:G961 NIL)
          (|g| (F)) (#3=#:G950 NIL) (#4=#:G949 (F)) (#5=#:G951 (F))
          (#6=#:G959 NIL) (|i| NIL) (#7=#:G960 NIL) (|x| NIL) (|c| (F))
          (#8=#:G941 NIL) (#9=#:G940 (F)) (#10=#:G942 (F)) (#11=#:G957 NIL)
          (#12=#:G958 NIL) (|dd| (|Integer|)) (#13=#:G956 NIL) (#14=#:G955 NIL)
          (|z| (F)))
         ...
         ((#1=#:G975 NIL)
          (|rn|
           (|Record| (|:| |funcs| (|List| F))
                     (|:| |kers| (|List| (|Kernel| F)))
                     (|:| |vals| (|List| F))))
          (|nlf| (|List| F)) (#2=#:G979 NIL) (|f| NIL) (#3=#:G978 NIL)
          (#4=#:G974 NIL)
          (|rec|
           (|Record| (|:| |funcs| (|List| F))
                     (|:| |kers| (|List| (|Kernel| F)))
          ...
          (|c|
           (|Union| (|:| |vec| (|Vector| (|Fraction| (|Integer|))))
                    (|:| |func| F) (|:| |fail| (|Boolean|))))
          (|klist| (|List| (|Kernel| F))) (#5=#:G976 NIL) (|i| NIL)
          (#6=#:G977 NIL) (|kk| NIL) (|n| (|NonNegativeInteger|))
...
(SDEFUN |EFSTRUC;validExponential;LFSU;47|
        ((|twr| |List| (|Kernel| F)) (|eta| F) (|x| |Symbol|)
         ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G1034 NIL) (#2=#:G1033 (F)) (#3=#:G1035 (F)) (#4=#:G1046 NIL)
          (|i| NIL) (#5=#:G1047 NIL) (|yy| NIL) (|g| (F)) (#6=#:G1007 NIL)
          (#7=#:G1006 (F)) (#8=#:G1008 (F)) (#9=#:G1044 NIL) (#10=#:G1045 NIL)
          (|v| (|Vector| (|Fraction| (|Integer|))))
          (|c| (|Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
          (#11=#:G1043 NIL) (|fns| (|List| F)) (#12=#:G1042 NIL))
         (SEQ
          (LETT |c|
                (SPADCALL
                 (SPADCALL
         ...
         ((|nv| (F)) (|nk| (F)) (|nr| (F)) (|nf| (F))
          (|pr|
           (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                     (|:| |radicand| F)))
          (|n| (|NonNegativeInteger|)) (#1=#:G1048 NIL))
         (SEQ
          (LETT |n|
                (PROG1
                    (LETT #1#
...
(SDEFUN |EFSTRUC;rootDep|
        ((|ker| |List| (|Kernel| F)) (|k| |Kernel| F)
         ($ |Union| (|:| |vec| (|Vector| (|Fraction| (|Integer|))))
          (|:| |func| F) (|:| |fail| (|Boolean|))))
        (SPROG
         ((#1=#:G1084 NIL) (#2=#:G1083 #3=(|Integer|)) (#4=#:G1085 #3#)
          (#5=#:G1088 NIL) (|r| NIL))
         (SEQ
          (COND
           ((NULL
...
(SDEFUN |EFSTRUC;expeval|
        ((|lf| |List| F) (|lk| |List| #1=(|Kernel| F)) (|k| |Kernel| F)
         ...
         ($ |Record| (|:| |funcs| (|List| F))
          (|:| |kers| (|List| (|Kernel| F))) (|:| |vals| (|List| F))))
        (SPROG
         ((|nlf| (|List| F)) (#2=#:G1115 NIL) (|f| NIL) (#3=#:G1114 NIL)
          (|h| (F)) (#4=#:G1100 NIL) (#5=#:G1099 (F)) (#6=#:G1101 (F))
          (#7=#:G1112 NIL) (|a| NIL) (#8=#:G1113 NIL) (|z| NIL)
          (|l| (|List| #1#)) (#9=#:G1111 NIL) (|kk| NIL) (#10=#:G1110 NIL)
          (|lv| (|List| (|Fraction| (|Integer|)))) (#11=#:G1109 NIL) (|i| NIL)
          (#12=#:G1108 NIL) (|v0| (|Integer|))
          (|rec|
           (|Union|
            (|Record| (|:| |index| (|Integer|)) (|:| |ker| (|Kernel| F)))
            "failed"))
          (|g| (F)) (#13=#:G1091 NIL) (#14=#:G1090 (F)) (#15=#:G1092 (F))
          (#16=#:G1106 NIL) (#17=#:G1107 NIL) (|fns| (|List| F)) (|y| (F)))
...
(SDEFUN |EFSTRUC;normalize;LLL;55|
        ...
        (SPROG ((|lf2| (|List| F)) (#1=#:G1124 NIL) (|f| NIL) (#2=#:G1123 NIL))
               (SEQ
                (LETT |lf2|
                      (PROGN
                       (LETT #2# NIL)
...
(SDEFUN |EFSTRUC;factdeprel|
        ((|l| |List| (|Kernel| F)) (|k| |Kernel| F)
         ($ |Union| (|:| |vec| (|Vector| (|Fraction| (|Integer|))))
          (|:| |func| F) (|:| |fail| (|Boolean|))))
        (SPROG
         ((#1=#:G1163 NIL) (#2=#:G1165 NIL) (#3=#:G1157 NIL) (#4=#:G1156 (F))
          (#5=#:G1158 (F)) (#6=#:G1167 NIL) (|i| NIL)
          (|r| (|Union| (|Integer|) "failed")) (|m| (F)) (#7=#:G1166 NIL)
          (|x| NIL) (#8=#:G1164 NIL) (|n| (F)))
         (SEQ
          (EXIT
           (SEQ
            (EXIT
...
(SDEFUN |EFSTRUC;normalize;LLL;57|
        ((|lf| |List| F) (|lx| |List| (|Symbol|)) ($ |List| F))
        (SPROG ((|lf2| (|List| F)) (#1=#:G1173 NIL) (|f| NIL) (#2=#:G1172 NIL))
               (SEQ
                (LETT |lf2|
                      (PROGN
                       (LETT #2# NIL)
...
(DEFUN |ElementaryFunctionStructurePackage| (&REST #1=#:G1174)
  (SPROG NIL
         (PROG (#2=#:G1175)
           (RETURN
            (COND
