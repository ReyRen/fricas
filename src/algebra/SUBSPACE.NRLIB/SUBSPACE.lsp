...
(SDEFUN |SUBSPACE;deepCopy;2$;11| ((|space| $) ($ $))
        (SPROG ((|cc| ($)) (#1=#:G444 NIL) (|c| NIL) (|node| ($)))
...
(SDEFUN |SUBSPACE;merge;L$;13| ((|listOfSpaces| |List| $) ($ $))
        (SPROG
         ((#1=#:G454 NIL) (|c| NIL) (#2=#:G453 NIL) (#3=#:G452 NIL) (|s| NIL)
          (|space| ($)))
         (SEQ
          (COND
...
(SDEFUN |SUBSPACE;separate;$L;14| ((|space| $) ($ |List| $))
        (SPROG ((|spaceList| (|List| $)) (|spc| ($)) (#1=#:G459 NIL) (|s| NIL))
...
(SDEFUN |SUBSPACE;addPoint;$LP$;15|
        ((|space| $) (|path| |List| (|NonNegativeInteger|)) (|point| |Point| R)
         ($ $))
        (SPROG
         ((|node| ($)) (#1=#:G471 NIL) (|more| NIL)
          (|depth| (|NonNegativeInteger|)) (#2=#:G470 NIL) (|i| NIL)
...
(SDEFUN |SUBSPACE;addPoint2;$P$;16| ((|space| $) (|point| |Point| R) ($ $))
        (SPROG
         ((|node| ($)) (#1=#:G480 NIL) (|more| NIL) (|first| ($))
...
(SDEFUN |SUBSPACE;addPointLast;2$PNni$;17|
        ...
        (SPROG
         ((#1=#:G489 NIL) (|more| NIL) (|which| (|NonNegativeInteger|))
          (|lastPt| (|List| (|Point| R))))
         (SEQ
          (COND
           ((NULL (NULL (LETT |lastPt| (QVELT |space| 7))))
...
(SDEFUN |SUBSPACE;addPoint;$LNni$;18|
        ...
        (SPROG
         ((|node| ($)) (#1=#:G497 NIL) (|more| NIL)
          (|depth| (|NonNegativeInteger|)) (#2=#:G496 NIL) (|i| NIL))
...
(SDEFUN |SUBSPACE;=;2$B;33| ((|s1| $) (|s2| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G554 NIL) (#2=#:G553 #3=(|Boolean|)) (#4=#:G555 #3#)
          (#5=#:G560 NIL) (|c1| NIL) (#6=#:G561 NIL) (|c2| NIL))
         (SEQ
          (COND
