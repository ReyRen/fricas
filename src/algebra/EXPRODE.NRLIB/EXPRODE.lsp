...
(SDEFUN |EXPRODE;k2exquo| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G396 NIL) (|f| NIL) (#2=#:G395 NIL) (|op| (|BasicOperator|)))
         (SEQ
          (COND
...
(SDEFUN |EXPRODE;findCompat| ((|yx| F) (|l| |List| (|Equation| F)) ($ F))
        (SPROG ((#1=#:G411 NIL) (#2=#:G412 NIL) (#3=#:G413 NIL) (|eq| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |EXPRODE;findEq|
        ...
        (SPROG ((#1=#:G418 NIL) (#2=#:G419 NIL) (#3=#:G420 NIL) (|eq| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |k|
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |k| (SPADCALL |eq| (QREFELT $ 61))
                                       (QREFELT $ 63))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# |eq|) (GO #4=#:G417)))
                              (GO #5=#:G415))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT (|error| "Improper differential equation"))))
...
(SDEFUN |EXPRODE;checkSystem|
        ...
        (SPROG ((#1=#:G432 NIL) (#2=#:G433 NIL) (#3=#:G434 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;13|
        ...
        (SPROG ((#1=#:G438 NIL) (|deq| NIL) (#2=#:G437 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;14|
        ...
        (SPROG ((#1=#:G443 NIL) (|deq| NIL) (#2=#:G442 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;15|
        ...
        (SPROG ((#1=#:G447 NIL) (|y| NIL) (#2=#:G446 NIL))
               (SEQ
                (SPADCALL |l| |ly| |eqx|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;22|
        ((|sys| |List| F) (|ly| |List| (|BasicOperator|)) (|eqx| |Equation| F)
         (|l0| |List| F) ($ |Any|))
        (SPROG
         ((#1=#:G485 NIL) (|f| NIL) (#2=#:G484 NIL) (|center| (F))
          (|l| (|List| F)) (#3=#:G483 NIL) (|eq| NIL) (#4=#:G482 NIL)
          (#5=#:G481 NIL) (|k| NIL) (#6=#:G480 NIL) (|lelt| (|List| F))
          (|m| (F)) (#7=#:G479 NIL) (#8=#:G478 NIL)
          (|yx| (|List| (|Kernel| F))) (#9=#:G477 NIL) (|y| NIL)
          (#10=#:G476 NIL) (|fsy| (F)) (|sy| (|Symbol|)) (|x| (|Symbol|))
          (#11=#:G465 NIL) (|kx| (|Kernel| F)))
         (SEQ
          (LETT |x|
                (PROG2
                    (LETT #11#
...
(DEFUN |ExpressionSpaceODESolver| (&REST #1=#:G486)
  (SPROG NIL
         (PROG (#2=#:G487)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 90
                                            '(1 9 0 8 10 2 7 0 9 0 15 1 7 16 0
                                              ...
                                              45 0 46 2 45 20 0 0 47 1 43 42 0
                                              48 1 42 20 0 49 0 6 0 50 2 42 7 0
                                              45 51 2 7 0 0 0 52 1 7 0 0 53 1
                                              54 7 0 55 1 54 7 0 56 2 7 20 0 0
                                              57 1 7 0 16 58 2 7 0 0 8 59 1 7
                                              60 0 61 2 62 20 18 0 63 3 7 0 0
                                              60 24 64 1 62 65 0 66 1 7 0 65 67
                                              2 7 0 0 0 68 2 18 20 0 8 69 0 7 0
                                              70 2 7 0 0 0 71 1 18 85 0 86 1 9
                                              8 0 87 1 7 0 8 88 0 8 0 89 1 22
                                              65 0 90 4 0 72 54 9 54 22 84 4 0
                                              72 54 9 54 54 80 4 0 72 74 73 54
                                              74 76 4 0 72 22 73 54 22 77 4 0
                                              72 74 73 54 22 78 4 0 72 54 9 54
                                              7 82 4 0 72 22 73 54 74 75 4 0 72
                                              7 9 54 7 81 4 0 72 7 9 54 22 83 4
                                              0 72 7 9 54 54 79)))))
           '|lookupComplete|)) 
