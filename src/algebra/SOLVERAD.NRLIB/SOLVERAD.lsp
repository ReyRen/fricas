...
(SDEFUN |SOLVERAD;findGenZeros|
        ...
        (SPROG
         ((|res| (|List| (|List| (|Expression| R)))) (#1=#:G406 NIL) (|vv| NIL)
          (#2=#:G407 NIL) (|p| NIL) (#3=#:G405 NIL) (#4=#:G404 NIL) (|r| NIL)
          (#5=#:G403 NIL) (|v| (|Symbol|)) (|pp| (|Polynomial| R)))
...
(SDEFUN |SOLVERAD;findZeros|
        ...
        (SPROG
         ((|res| (|List| (|List| (|Expression| R))))
          ...
          (#1=#:G418 NIL) (|par| NIL)
          (|parRes| (|List| (|List| (|Expression| R)))) (#2=#:G416 NIL)
          (|p| NIL) (#3=#:G417 NIL) (|v| NIL) (#4=#:G415 NIL))
         (SEQ
          (LETT |parRes|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |SOLVERAD;radicalSolve;FSL;10|
        ...
        (SPROG ((#1=#:G422 NIL) (|r| NIL) (#2=#:G421 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |r| NIL)
...
(SDEFUN |SOLVERAD;radicalRoots;LLL;14|
        ((|lp| |List| (|Fraction| (|Polynomial| R))) (|lv| |List| (|Symbol|))
         ($ |List| (|List| (|Expression| R))))
        (SPROG
         ((#1=#:G438 NIL) (#2=#:G437 #3=(|List| (|List| (|Expression| R))))
          (#4=#:G439 #3#) (#5=#:G448 NIL) (|res| NIL)
          (|rpRes| (|List| #6=(|List| (|Polynomial| R)))) (#7=#:G447 NIL)
          (|result| (|List| (|List| (|Expression| R)))) (#8=#:G432 NIL)
          (#9=#:G431 #10=(|List| (|List| (|Expression| R)))) (#11=#:G433 #10#)
          (#12=#:G446 NIL) (|listGen| (|List| #6#)) (#13=#:G445 NIL)
          (#14=#:G444 NIL) (#15=#:G443 NIL) (#16=#:G442 NIL)
          (|rlv| (|List| (|Symbol|)))
          (|parRes| (|List| (|List| (|Polynomial| R)))))
         (SEQ (LETT |parRes| (SPADCALL |lp| |lv| (QREFELT $ 81)))
              (LETT |rlv| (REVERSE |lv|))
              (LETT |rpRes|
                    (PROGN
                     (LETT #16# NIL)
...
(SDEFUN |SOLVERAD;radicalSolve;LLL;15|
        ...
        (SPROG ((#1=#:G452 NIL) (|lres| NIL) (#2=#:G451 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |lres| NIL)
                      (LETT #1# (SPADCALL |lp| |lv| (QREFELT $ 87))) G190
                      (COND
...
(SDEFUN |SOLVERAD;radicalSolve;LL;16|
        ((|lp| |List| (|Fraction| (|Polynomial| R)))
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G461 NIL) (|lres| NIL) (#2=#:G460 NIL)
          (|lv| #3=(|List| (|Symbol|))) (#4=#:G454 NIL) (#5=#:G453 #3#)
          (#6=#:G455 #3#) (#7=#:G459 NIL) (|p| NIL))
         (SEQ
          (LETT |lv|
                (PROGN
                 (LETT #4# NIL)
                        ...
                        (PROGN
                         (LETT #6#
                               (SPADCALL
                                ...
                                (QREFELT $ 90)))
                         (COND
                          (#4# (LETT #5# (SPADCALL #5# #6# (QREFELT $ 90))))
...
(SDEFUN |SOLVERAD;radicalSolve;LLL;17|
        ((|le| |List| (|Equation| (|Fraction| (|Polynomial| R))))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G469 NIL) (|lres| NIL) (#2=#:G468 NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| R)))) (#3=#:G467 NIL)
          (|p| NIL) (#4=#:G466 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
...
(SDEFUN |SOLVERAD;radicalSolve;LL;18|
        ((|le| |List| (|Equation| (|Fraction| (|Polynomial| R))))
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G481 NIL) (|lres| NIL) (#2=#:G480 NIL)
          (|lv| #3=(|List| (|Symbol|))) (#4=#:G472 NIL) (#5=#:G471 #3#)
          (#6=#:G473 #3#) (#7=#:G479 NIL) (|p| NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| R)))) (#8=#:G478 NIL)
          (#9=#:G477 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
...
(SDEFUN |SOLVERAD;isGeneric?|
        ((|rlp| |List| (|Polynomial| R)) (|rlv| |List| (|Symbol|))
         ($ |Boolean|))
        (SPROG
         ((#1=#:G486 NIL) (#2=#:G485 #3=(|Boolean|)) (#4=#:G487 #3#)
          (#5=#:G489 NIL) (|f| NIL) (#6=#:G490 NIL) (|x| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |x| NIL) (LETT #6# (CDR |rlv|)) (LETT |f| NIL)
                ...
                (SEQ
                 (EXIT
                  (PROGN
                   (LETT #4# (EQL (SPADCALL |f| |x| (QREFELT $ 99)) 1))
...
(SDEFUN |SOLVERAD;select|
        ...
        (SPROG
         ((#2=#:G492 NIL) (#3=#:G491 #1#) (#4=#:G493 #1#) (#5=#:G498 NIL)
          (|lsel| NIL) (#6=#:G497 NIL) (#7=#:G496 NIL) (|f| NIL))
         (SEQ
          (COND
...
(SDEFUN |SOLVERAD;makeEq|
        ((|nres| |List| (|Expression| R)) (|lv| |List| (|Symbol|))
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG
         ((#1=#:G502 NIL) (|x| NIL) (#2=#:G503 NIL) (|r| NIL) (#3=#:G501 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |SOLVERAD;solveInner|
        ...
        (SPROG
         ((|re| (|List| (|Equation| (|Expression| R))))
          (|solutions| (|List| (|Expression| R))) (#1=#:G518 NIL) (|i| NIL)
          (T0 (|List| (|Expression| R))) (|s| (|Expression| R)) (#2=#:G517 NIL)
          (|l| (|List| (|Expression| R)))
         ...
         (SEQ (SETELT $ 7 NIL) (SETELT $ 8 |contractFlag|)
              ...
              (SEQ (LETT |f| NIL) (LETT #4# |lfactors|) G190
                   ...
                   (SEQ (LETT |ff| (QVELT |f| 1))
                        ...
                        (LETT |t| (SPADCALL |u| (QREFELT $ 112)))
                        (LETT |u| (QCAR |t|))
                        (LETT |n| (SPADCALL |u| (QREFELT $ 113)))
                        (LETT |l|
...
(DEFUN |RadicalSolvePackage| (#1=#:G519)
  (SPROG NIL
         (PROG (#2=#:G520)
           (RETURN
            (COND
