...
(SDEFUN |INNMFACT;convertPUP|
        ...
        (SPROG ((#1=#:G418 NIL) (|lff| NIL) (#2=#:G417 NIL))
               (SEQ
                (CONS (QCAR |lfg|)
                      (PROGN
                       (LETT #2# NIL)
          ...
          (|:| |factors|
               (|List|
                (|Record| (|:| |irr| (|SparseUnivariatePolynomial| P))
                          (|:| |pow| (|NonNegativeInteger|)))))))
        (SPROG
         ((#2=#:G459 NIL) (|uum1| (R)) (|lcfacs| (R)) (#3=#:G456 NIL)
          (#4=#:G455 (R)) (#5=#:G457 (R)) (#6=#:G477 NIL) (|f| NIL)
          (|factorlist|
           (|List|
            (|Record| (|:| |irr| (|SparseUnivariatePolynomial| P))
                      (|:| |pow| (|NonNegativeInteger|)))))
          (|auxfl|
           (|List|
            #7=(|Record| (|:| |irr| (|SparseUnivariatePolynomial| P))
                         (|:| |pow| (|NonNegativeInteger|)))))
          (#8=#:G476 NIL) (|lfp| NIL) (#9=#:G475 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|ldeg| (|List| #10=(|NonNegativeInteger|))) (#11=#:G445 NIL)
          (#12=#:G444 #10#) (#13=#:G446 #10#) (#14=#:G474 NIL) (|fc| NIL)
          (#15=#:G473 NIL) (|xx| NIL) (#16=#:G472 NIL) (|coefs| (|List| P))
          (#17=#:G471 NIL) (|lff| NIL) (#18=#:G470 NIL) (|lcont| (P))
          (|lfg|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
                          (|List|
          ...
          (|ffactor| #20=(|SparseUnivariatePolynomial| P)) (#21=#:G469 NIL)
          (|fact| NIL)
          (|sqqfact|
           (|List|
          ...
          (#22=#:G465 NIL) (#23=#:G431 NIL)
          (|f1| (|SparseUnivariatePolynomial| P))
          (|mdeg| (|NonNegativeInteger|)) (#24=#:G468 NIL) (|ff| NIL)
          (#25=#:G467 NIL) (|lfact| #1#)
          (|umv| (|SparseUnivariatePolynomial| R)) (|lvar| #26=(|List| OV))
          (#27=#:G422 NIL) (#28=#:G421 #26#) (#29=#:G423 #26#) (#30=#:G466 NIL)
          (|cf| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INNMFACT;factor;SupMF;3|
        ...
        (SPROG
         ((#1=#:G481 NIL)
          (#2=#:G480 #3=(|Factored| (|SparseUnivariatePolynomial| P)))
          (#4=#:G482 #3#) (#5=#:G486 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
                          (|List|
...
(SDEFUN |INNMFACT;varChoose|
        ...
        (SPROG
         ((|x| (OV)) (|i| (|Integer|)) (|k| #1#) (#2=#:G489 NIL)
          (#3=#:G488 #1#) (#4=#:G490 #1#) (#5=#:G494 NIL) (|d| NIL))
         (SEQ
          (LETT |k|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INNMFACT;localNorm|
        ...
        (SPROG
         ((#2=#:G499 NIL) (#3=#:G498 #1#) (#4=#:G500 #1#) (#5=#:G502 NIL)
          (#6=#:G501 #1#) (#7=#:G503 #1#) (|cc| (R)) (#8=#:G507 NIL) (|i| NIL)
          (#9=#:G506 NIL) (|ff| NIL) (#10=#:G496 NIL) (#11=#:G495 #1#)
          (#12=#:G497 #1#) (#13=#:G505 NIL))
         (SEQ
          (COND
...
(SDEFUN |INNMFACT;intChoose|
        ...
        (SPROG
         ((|nfatt| (|NonNegativeInteger|)) (|int| #2=(|List| R))
          (|leadcomp| #2#) (|lffc| (R))
          (|unifact| (|List| (|SparseUnivariatePolynomial| R))) (#3=#:G569 NIL)
          (|uf| NIL) (#4=#:G568 NIL) (|leadtest| (|Boolean|)) (#5=#:G567 NIL)
          (#6=#:G566 NIL) (#7=#:G551 NIL) (#8=#:G565 NIL) (#9=#:G564 NIL)
          (#10=#:G563 NIL) (#11=#:G562 NIL) (#12=#:G561 NIL) (|ff| NIL)
          (#13=#:G560 NIL) (#14=#:G559 NIL) (#15=#:G558 NIL)
          ...
          (|newm| (|SparseUnivariatePolynomial| R)) (#16=#:G523 NIL)
          (#17=#:G517 NIL) (#18=#:G516 #19=(|Boolean|)) (#20=#:G518 #19#)
          (#21=#:G557 NIL) (|epl| NIL) (|leadcomp1| #2#) (#22=#:G556 NIL)
          (|pol| NIL) (#23=#:G555 NIL) (|lval| (|List| R)) (#24=#:G554 NIL)
          (|i| NIL) (#25=#:G553 NIL) (#26=#:G552 NIL)
        ...
        (SPROG
         ((|flead|
          ...
          (|factorlist|
           (|List|
            (|Record| (|:| |irr| P) (|:| |pow| (|NonNegativeInteger|)))))
          (|pol1| (P)) (|i| (|NonNegativeInteger|)) (#2=#:G583 NIL) (|x| NIL))
...
(SDEFUN |INNMFACT;intfact|
        ...
        (SPROG
         ((|factfin| (|List| (|SparseUnivariatePolynomial| P))) (#1=#:G736 NIL)
          (|ff| NIL) (#2=#:G735 NIL)
          (|ffin| (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|umd| (|SparseUnivariatePolynomial| P)) (#3=#:G717 NIL)
          (|unifact| (|List| (|SparseUnivariatePolynomial| R))) (#4=#:G734 NIL)
          (|unif| NIL) (#5=#:G733 NIL) (|dd| (R)) (|lpol| (|List| P))
          (|dist|
          ...
          (|check|
           (|Union|
            (|Record| (|:| |inval| (|List| (|List| R)))
                      ...
                      (|:| |lu| R) (|:| |complead| (|List| R)))
            #8="failed"))
          (|leadpol| (|List| P)) (#9=#:G732 NIL) (#10=#:G731 NIL)
          (|polcase| (|Boolean|)))
         (SEQ
          (EXIT
...
(SDEFUN |INNMFACT;monicize|
        ...
        (SPROG
         ((|ans| (|SparseUnivariatePolynomial| P)) (|prod| (P)) (#1=#:G751 NIL)
          (|n| #2=(|NonNegativeInteger|)) (|lc| (P)) (|i| #2#) (#3=#:G749 NIL))
         ...
         ($ |Record| (|:| |contp| R)
          (|:| |factors|
               (|List|
                (|Record| (|:| |irr| P) (|:| |pow| (|NonNegativeInteger|)))))))
        (SPROG
         ((#1=#:G812 NIL) (|lcfacs| (R)) (#2=#:G809 NIL) (#3=#:G808 (R))
          (#4=#:G810 (R)) (#5=#:G824 NIL) (|f| NIL)
          (|factorlist|
           (|List|
            (|Record| (|:| |irr| P) (|:| |pow| (|NonNegativeInteger|)))))
          (|auxfl|
          ...
          (#7=#:G823 NIL) (|lfp| NIL) (#8=#:G822 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|um| (|SparseUnivariatePolynomial| P))
          (|ldeg| (|List| (|NonNegativeInteger|))) (#9=#:G821 NIL)
          (|lcterm| NIL) (|ffactor| (P)) (#10=#:G791 NIL) (|pc| (P))
          (|lvar| (|List| OV)) (|x| (OV))
          (|varch|
           (|Record| (|:| |npol| (|SparseUnivariatePolynomial| P))
                     (|:| |nvar| (|List| OV))
                     (|:| |newdeg| (|List| (|NonNegativeInteger|)))))
          (#11=#:G820 NIL) (#12=#:G779 NIL) (|lcont| (P))
          (|ffexp| #13=(|NonNegativeInteger|)) (#14=#:G819 NIL) (|fact| NIL)
          (|sqqfact|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P) (|:| |exponent| #13#))))
          (|flead| (|Record| (|:| |contp| R) (|:| |factors| (|List| #6#))))
          (|sqfacs| (|Factored| P)) (#15=#:G768 NIL)
          (#16=#:G767 #17=(|Boolean|)) (#18=#:G769 #17#) (#19=#:G818 NIL)
...
(SDEFUN |INNMFACT;factor;PMF;15|
        ((|m| P)
         ...
         ($ |Factored| P))
        (SPROG
         ((#1=#:G828 NIL) (#2=#:G827 #3=(|Factored| P)) (#4=#:G829 #3#)
          (#5=#:G832 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
...
(DEFUN |InnerMultFact| (&REST #1=#:G833)
  (SPROG NIL
         (PROG (#2=#:G834)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 166
                                            '(2 10 0 0 10 11 1 13 12 12 14 1 8
