...
(SDEFUN |IR;neselect|
        ((|l| |List| (|Record| (|:| |integrand| F) (|:| |intvar| F))) (|x| F)
         ($ F))
        (SPROG
         ((#1=#:G427 NIL) (#2=#:G426 (F)) (#3=#:G428 (F)) (#4=#:G430 NIL)
          (|ne| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |IR;nesimp|
        ...
        (SPROG
         ((|u| (F)) (#1=#:G447 NIL) (#2=#:G449 NIL) (|ne| NIL) (#3=#:G448 NIL)
          (|x| NIL) (#4=#:G446 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |IR;retractIfCan;$U;18| ((|u| $) ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G456 NIL) (#2=#:G455 (F)) (#3=#:G457 (F)) (#4=#:G463 NIL)
          (|ne| NIL))
         (SEQ
          (COND
...
(SDEFUN |IR;differentiate;$MF;24| ((|u| $) (|derivation| |Mapping| F F) ($ F))
        (SPROG
         ((#1=#:G497 NIL) (#2=#:G496 (F)) (#3=#:G498 (F)) (#4=#:G502 NIL)
          (|ne| NIL) (#5=#:G492 NIL) (#6=#:G491 (F)) (#7=#:G493 (F))
          (#8=#:G501 NIL) (|log| NIL))
         (SEQ
          (SPADCALL
...
(SDEFUN |IR;pLogDeriv|
        ...
        (SPROG
         ((|ans| (F)) (|algans| #1=(|SparseUnivariatePolynomial| F))
          ...
          (#3=#:G516 NIL) (|numlog| (|SparseUnivariatePolynomial| F)) (|c| (F))
...
(SDEFUN |IR;coerce;$Of;27| ((|u| $) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (#1=#:G545 NIL) (|f| NIL)
          (#2=#:G544 NIL) (#3=#:G543 NIL) (#4=#:G542 NIL)
          (|r| (|Union| F "failed")))
...
(DEFUN |IntegrationResult| (#1=#:G552)
  (SPROG NIL
         (PROG (#2=#:G553)
           (RETURN
            (COND
...
(DEFUN |IntegrationResult;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G551 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
