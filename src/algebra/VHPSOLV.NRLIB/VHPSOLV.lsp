...
(SDEFUN |VHPSOLV;hp_solve;LLNniM;2|
        ((|lv| |List|
         ...
         ($ |Matrix|
          (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
        (SPROG
         ((#1=#:G416 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G415 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G414 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G413 NIL)
          (#6=#:G412 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G411 NIL)
          (|ei| NIL) (#8=#:G410 NIL)
          (|lpp|
