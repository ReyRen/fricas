...
(SDEFUN |INTALG2;list_hermite|
        ((|lf| |List| R)
         ...
         ($ |List|
          (|Record| (|:| |answer| R) (|:| |logpart| R) (|:| |polypart| R))))
        (SPROG ((#1=#:G414 NIL) (|f| NIL) (#2=#:G413 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INTALG2;lin_comb2| ((|v| |Vector| F) (|lr| |List| R) ($ R))
        (SPROG
         ((|res| (R)) (#1=#:G418 NIL) (|i| NIL) (#2=#:G419 NIL) (|r| NIL))
         ...
         ((|b| #1=(|SparseUnivariatePolynomial| F))
          ...
          (|eeu|
           (|Union| (|Record| (|:| |coef1| #2#) (|:| |coef2| #1#))
                    #4="failed"))
          (|d1| (|SparseUnivariatePolynomial| F)) (#5=#:G422 NIL)
         ...
         ((|lres| (|List| (|Fraction| (|SparseUnivariatePolynomial| F))))
          ...
          (|#G27|
           (|Record|
            (|:| |polypart| (|Fraction| (|SparseUnivariatePolynomial| F)))
            (|:| |logpart| (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (#1=#:G437 NIL) (|p1| NIL) (#2=#:G438 NIL) (|lg1| NIL))
...
(SDEFUN |INTALG2;diagextint|
        ...
        (SPROG
         ((#5=#:G482 NIL) (|ai| NIL) (#6=#:G483 NIL) (|bv| NIL) (#7=#:G481 NIL)
          (|ca| (|List| R)) (|cb| (|List| #2#)) (|nca1| (|List| R))
          (#8=#:G480 NIL) (|be| NIL) (#9=#:G479 NIL) (|wi| (R))
          (|ncb1| (|List| #10=(|Vector| F))) (#11=#:G478 NIL) (#12=#:G477 NIL)
          (|res2| #3#)
          (|lup2| (|List| #13=(|Fraction| (|SparseUnivariatePolynomial| F))))
          (#14=#:G476 NIL) (#15=#:G475 NIL) (|nca0| (|List| R))
          (#16=#:G474 NIL) (#17=#:G473 NIL) (|ncb0| (|List| #10#))
          (#18=#:G472 NIL) (#19=#:G471 NIL) (|res1| #4#) (|rs2| (|Matrix| F))
          (|rs1| (|Matrix| (|SparseUnivariatePolynomial| F)))
          (|llog2| (|List| #13#)) (#20=#:G470 NIL) (#21=#:G469 NIL)
          ...
          (#23=#:G468 NIL) (|gv| NIL) (#24=#:G467 NIL) (|lup0| (|List| #22#))
          (#25=#:G466 NIL) (|pv| NIL) (#26=#:G465 NIL)
          (|dmi| (|Fraction| (|SparseUnivariatePolynomial| F)))
          (#27=#:G464 NIL) (|i| NIL) (#28=#:G463 NIL) (|be0| NIL)
          (#29=#:G462 NIL) (#30=#:G461 NIL) (#31=#:G460 NIL) (|res0| #1#)
          (|lrf| (|List| (|Fraction| (|SparseUnivariatePolynomial| F))))
          (#32=#:G458 NIL) (#33=#:G459 NIL) (#34=#:G457 NIL))
         (SEQ
          (LETT |lrf|
                (PROGN
                 (LETT #34# NIL)
...
(SDEFUN |INTALG2;algprimextint|
        ((|der| |Mapping| (|SparseUnivariatePolynomial| F)
         ...
         ($ |List| (|Record| (|:| |ratpart| R) (|:| |coeffs| (|Vector| F)))))
        (SPROG
         ((|ca0| (|List| R)) (#1=#:G508 NIL) (|h| NIL) (#2=#:G507 NIL)
...
(SDEFUN |INTALG2;algexpextint|
        ((|der| |Mapping| (|SparseUnivariatePolynomial| F)
         ...
         ($ |List| (|Record| (|:| |ratpart| R) (|:| |coeffs| (|Vector| F)))))
        (SPROG
         ((|ca0| (|List| R)) (#1=#:G528 NIL) (|h| NIL) (#2=#:G527 NIL)
          (|dden| #3=(|SparseUnivariatePolynomial| F))
          (|dm|
           (|Record| (|:| |num| (|Matrix| (|SparseUnivariatePolynomial| F)))
                     (|:| |den| #3#)))
          ...
          (|lpv|
           (|List| (|Vector| (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (#4=#:G526 NIL) (|n| (|NonNegativeInteger|)) (|w| (|Vector| R))
          (|lh|
           (|List|
            (|Record| (|:| |answer| R) (|:| |logpart| R) (|:| |polypart| R))))
          (|hermite1|
...
(SDEFUN |INTALG2;algextint_base;MMLL;11|
        ((|der| |Mapping| (|SparseUnivariatePolynomial| F)
         ...
         ($ |List| (|Record| (|:| |ratpart| R) (|:| |coeffs| (|Vector| F)))))
        (SPROG
         ((#2=#:G545 NIL) (|bv| NIL) (#3=#:G544 NIL) (|ca0| (|List| R))
          (#4=#:G543 NIL) (|h| NIL) (#5=#:G542 NIL) (|res1| #1#)
          (|rs3| (|Matrix| F))
          (|rs2| (|Matrix| (|SparseUnivariatePolynomial| F)))
          (|rs1| (|Matrix| (|Fraction| (|SparseUnivariatePolynomial| F))))
          (|lg1| (|List| R)) (#6=#:G541 NIL) (#7=#:G540 NIL)
          (|lh|
           (|List|
            (|Record| (|:| |answer| R) (|:| |logpart| R) (|:| |polypart| R))))
          (|hermite1|
...
(DEFUN |AlgebraicIntegrate2| (&REST #1=#:G572)
  (SPROG NIL
         (PROG (#2=#:G573)
           (RETURN
            (COND
