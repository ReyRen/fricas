...
(SDEFUN |FINAALG-;leftCharacteristicPolynomial;SSup;1|
        ...
        (SPROG
         ((#1=#:G415 NIL) (|j| NIL) (#2=#:G414 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;rightCharacteristicPolynomial;SSup;2|
        ((|a| S) ($ |SparseUnivariatePolynomial| R))
        (SPROG
         ((#1=#:G421 NIL) (|j| NIL) (#2=#:G420 NIL) (|i| NIL)
          (|mb| (|Matrix| (|SparseUnivariatePolynomial| R)))
          (|ma| (|Matrix| R)) (|n| (|PositiveInteger|)))
         (SEQ (LETT |n| (SPADCALL (QREFELT $ 9)))
              (LETT |ma|
...
(SDEFUN |FINAALG-;leftTrace;SR;3| ((|a| S) ($ R))
        (SPROG ((|t| (R)) (#1=#:G425 NIL) (|i| NIL) (|ma| (|Matrix| R)))
...
(SDEFUN |FINAALG-;rightTrace;SR;4| ((|a| S) ($ R))
        (SPROG ((|t| (R)) (#1=#:G429 NIL) (|i| NIL) (|ma| (|Matrix| R)))
               (SEQ (LETT |t| (|spadConstant| $ 28))
                    (LETT |ma|
                          (SPADCALL |a| (SPADCALL (QREFELT $ 11))
                                    (QREFELT $ 26)))
...
(SDEFUN |FINAALG-;antiAssociative?;B;7| (($ |Boolean|))
        (SPROG
         ((#1=#:G439 NIL) (#2=#:G440 NIL) (#3=#:G443 NIL) (|k| NIL)
          (#4=#:G442 NIL) (|j| NIL) (#5=#:G441 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;jordanAdmissible?;B;8| (($ |Boolean|))
        (SPROG
         ((#1=#:G457 NIL) (#2=#:G458 NIL) (#3=#:G462 NIL) (|l| NIL)
          (#4=#:G461 NIL) (|k| NIL) (#5=#:G460 NIL) (|j| NIL) (#6=#:G459 NIL)
...
(SDEFUN |FINAALG-;lieAdmissible?;B;9| (($ |Boolean|))
        (SPROG
         ((#1=#:G470 NIL) (#2=#:G471 NIL) (#3=#:G474 NIL) (|k| NIL)
          (#4=#:G473 NIL) (|j| NIL) (#5=#:G472 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;structuralConstants;VV;10|
        ...
        (SPROG
         ((#1=#:G488 NIL) (|k| NIL) (|covec| (|Vector| R)) (#2=#:G487 NIL)
          (|j| NIL) (#3=#:G486 NIL) (|i| NIL) (|sC| (|Vector| (|Matrix| R)))
          (#4=#:G483 NIL) (#5=#:G485 NIL) (#6=#:G484 NIL)
          (|m| (|NonNegativeInteger|)) (#7=#:G475 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |FINAALG-;leftRecip;SU;11| ((|x| S) ($ |Union| S "failed"))
        (SPROG
         ((#1=#:G505 NIL) (#2=#:G507 NIL) (|power| NIL) (#3=#:G508 NIL)
          (|i| NIL) (#4=#:G506 NIL) (|invCR| (R)) (|invC| (|Union| R "failed"))
...
(SDEFUN |FINAALG-;rightRecip;SU;12| ((|x| S) ($ |Union| S "failed"))
        (SPROG
         ((#1=#:G525 NIL) (#2=#:G527 NIL) (|power| NIL) (#3=#:G528 NIL)
          (|i| NIL) (#4=#:G526 NIL) (|invCR| (R)) (|invC| (|Union| R "failed"))
          (|vectorOfCoef| (|Vector| R)) (|cond| (|Matrix| R))
          (|listOfPowers| (|List| S)) (|xx| (S)) (|k| (|PositiveInteger|))
...
(SDEFUN |FINAALG-;leftMinimalPolynomial;SSup;14|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#1=#:G542 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;rightMinimalPolynomial;SSup;15|
        ((|x| S) ($ |SparseUnivariatePolynomial| R))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#1=#:G549 NIL) (|i| NIL)
          (|vectorOfCoef| (|Vector| R)) (|cond| (|Matrix| R)) (|xx| (S))
          (|k| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (COND
...
(SDEFUN |FINAALG-;associatorDependence;L;16| (($ |List| (|Vector| R)))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G561 NIL) (|r| NIL) (|a213| #2=(|Vector| R))
          (|a321| #2#) (|a132| #2#) (|a312| #2#) (|a231| #2#) (|a123| #2#)
          (#3=#:G560 NIL) (|k| NIL) (#4=#:G559 NIL) (|j| NIL) (#5=#:G558 NIL)
...
(SDEFUN |FINAALG-;jacobiIdentity?;B;17| (($ |Boolean|))
        (SPROG
         ((#1=#:G569 NIL) (#2=#:G570 NIL) (#3=#:G573 NIL) (|k| NIL)
          (#4=#:G572 NIL) (|j| NIL) (#5=#:G571 NIL) (|i| NIL)
          (|b| (|Vector| S)) (|n| (|PositiveInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (SPADCALL (QREFELT $ 9)))
...
(SDEFUN |FINAALG-;jordanAlgebra?;B;19| (($ |Boolean|))
        (SPROG
         ((#1=#:G592 NIL) (#2=#:G593 NIL) (#3=#:G597 NIL) (|l| NIL)
          (#4=#:G596 NIL) (|k| NIL) (#5=#:G595 NIL) (|j| NIL) (#6=#:G594 NIL)
          (|i| NIL) (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;antiCommutative?;B;21| (($ |Boolean|))
        (SPROG
         ((#1=#:G613 NIL) (#2=#:G614 NIL) (#3=#:G616 NIL) (|j| NIL)
          (#4=#:G615 NIL) (|i| NIL) (|n| (|PositiveInteger|))
          (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;commutative?;B;22| (($ |Boolean|))
        (SPROG
         ((#1=#:G623 NIL) (#2=#:G624 NIL) (#3=#:G626 NIL) (|j| NIL)
          (#4=#:G625 NIL) (|i| NIL) (|n| (|PositiveInteger|))
          (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;associative?;B;23| (($ |Boolean|))
        (SPROG
         ((#1=#:G634 NIL) (#2=#:G635 NIL) (#3=#:G638 NIL) (|k| NIL)
          (#4=#:G637 NIL) (|j| NIL) (#5=#:G636 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;leftAlternative?;B;24| (($ |Boolean|))
        (SPROG
         ((#1=#:G646 NIL) (#2=#:G647 NIL) (#3=#:G650 NIL) (|k| NIL)
          (#4=#:G649 NIL) (|j| NIL) (#5=#:G648 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;rightAlternative?;B;25| (($ |Boolean|))
        (SPROG
         ((#1=#:G658 NIL) (#2=#:G659 NIL) (#3=#:G662 NIL) (|k| NIL)
          (#4=#:G661 NIL) (|j| NIL) (#5=#:G660 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;flexible?;B;26| (($ |Boolean|))
        (SPROG
         ((#1=#:G670 NIL) (#2=#:G671 NIL) (#3=#:G674 NIL) (|k| NIL)
          (#4=#:G673 NIL) (|j| NIL) (#5=#:G672 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;alternative?;B;27| (($ |Boolean|))
        (SPROG
         ((#1=#:G684 NIL) (#2=#:G685 NIL) (#3=#:G688 NIL) (|k| NIL)
          (#4=#:G687 NIL) (|j| NIL) (#5=#:G686 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;coordinates;2VM;30|
        ...
        (SPROG ((#1=#:G694 NIL) (|i| NIL) (|j| NIL) (|m| (|Matrix| R)))
               (SEQ
                (LETT |m|
...
(SDEFUN |FINAALG-;represents;VVS;31| ((|v| |Vector| R) (|b| |Vector| S) ($ S))
        (SPROG
         ((#1=#:G700 NIL) (#2=#:G702 NIL) (|i| NIL) (#3=#:G701 NIL)
          (|m| (|Integer|)))
...
(SDEFUN |FINAALG-;leftTraceMatrix;VM;32| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G709 NIL) (|j| NIL) (#2=#:G708 NIL) (#3=#:G707 NIL) (|i| NIL)
          (#4=#:G706 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |FINAALG-;rightTraceMatrix;VM;33| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G716 NIL) (|j| NIL) (#2=#:G715 NIL) (#3=#:G714 NIL) (|i| NIL)
          (#4=#:G713 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |FINAALG-;leftRegularRepresentation;SVM;34|
        ...
        (SPROG ((#1=#:G722 NIL) (|i| NIL) (#2=#:G721 NIL) (|m| (|Integer|)))
...
(SDEFUN |FINAALG-;rightRegularRepresentation;SVM;35|
        ((|x| S) (|b| |Vector| S) ($ |Matrix| R))
        (SPROG ((#1=#:G728 NIL) (|i| NIL) (#2=#:G727 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (- (SPADCALL |b| (QREFELT $ 105)) 1))
                    (EXIT
                     (SPADCALL
                      (SPADCALL
