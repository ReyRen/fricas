...
(SDEFUN |NGROEB;makeCrit|
        ((|sp1| |Record| (|:| |totdeg| (|NonNegativeInteger|))
         ...
         ($ |Record| (|:| |lcmfij| |Expon|)
          ...
          (|:| |polj| |Dpol|)))
        (SPROG
         ((|tdeg| (|NonNegativeInteger|)) (|e2| (|Expon|)) (#1=#:G409 NIL)
...
(SDEFUN |NGROEB;gbasis| ((|Pol| |List| |Dpol|) ($ |List| |Dpol|))
        (SPROG
         ((#1=#:G449 NIL) (|x| NIL) (#2=#:G448 NIL) (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G447 NIL) (#5=#:G446 NIL) (#6=#:G441 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G445 NIL) (#8=#:G444 NIL) (#9=#:G443 NIL) (#10=#:G442 NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT $ 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT
                               (PROGN (LETT #6# |$NoValue|) (GO #11=#:G437)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
...
(DEFUN |NGroebnerPackage| (&REST #1=#:G500)
  (SPROG NIL
         (PROG (#2=#:G501)
           (RETURN
            (COND
