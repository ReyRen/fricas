...
(SDEFUN |FS2EXPXP;k2Elem| ((|k| |Kernel| FE) ($ FE))
        (SPROG
         ((|cosz| (FE)) (|sinz| (FE)) (|iez| (FE)) (|ez| (FE)) (|z| (FE))
          (|args| (|List| FE)) (#1=#:G477 NIL) (|a| NIL) (#2=#:G476 NIL))
         (SEQ
          (COND
           ((NULL
             (LETT |args|
...
(SDEFUN |FS2EXPXP;iExprToXXP|
        ...
        (SPROG
         ((|ker| (|Union| (|Kernel| FE) #1="failed"))
          ...
          (|sum| (|Union| (|List| FE) #2#)) (#3=#:G497 NIL)
        ...
        ((|fcn| FE) (|n| |Integer|) (|posCheck?| |Boolean|)
         ($ |Union|
          ...
          (|:| |%problem|
               (|Record| (|:| |func| (|String|)) (|:| |prob| (|String|))))))
        (SPROG
         ((|nn| (|NonNegativeInteger|)) (#2=#:G546 NIL)
          (|rec|
           (|Union|
                       ...
                       (EXIT
                        (COND
                         ...
                         ((|FS2EXPXP;negativePowerOK?|
                           (SPADCALL |num| (QREFELT $ 89)) $)
                          (SEQ (LETT |rec| (SPADCALL |num| (QREFELT $ 91)))
                               (EXIT
                                (COND
                                 ((QEQCAR |rec| 1)
                         ...
                         (COND
                          ((SPADCALL |n| (QREFELT $ 96))
                           (COND
                            (|posCheck?|
                             (SEQ
                              (LETT |signum| (SPADCALL |coef| (QREFELT $ 99)))
                              (EXIT
                               (COND
                                ((QEQCAR |signum| 0)
                                 (COND
                                   ...
                                   (PROGN
                                    (LETT #1#
                                          (PROGN
                                           ...
                                           (GO #4=#:G569)))
                                    (GO #5=#:G568))))))))))))
                         (LETT |ans| (SPADCALL |ups| |n| (QREFELT $ 102)))
                         (EXIT
                          (COND
                           ((QEQCAR |ans| 1)
...
(SDEFUN |FS2EXPXP;nthRootXXPIfCan|
        ...
        (SPROG
         ((|newDen|
          ...
          (|coef| (|UnivariatePuiseuxSeries| FE |x| |cen|)) (#2=#:G577 NIL)
          (#3=#:G585 NIL) (#4=#:G578 NIL)
          (|root|
           (|Union| (|:| |%series| (|UnivariatePuiseuxSeries| FE |x| |cen|))
                    (|:| |%problem|
                         (|Record| (|:| |func| (|String|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |num| (SPADCALL |xxp| (QREFELT $ 85)))
                (LETT |den| (SPADCALL |xxp| (QREFELT $ 92)))
                (COND
           ...
           (COND ((QEQCAR |logBase| 1) |logBase|)
                 (#1='T
                  (SEQ
                   (LETT |expon|
                         (|FS2EXPXP;iExprToXXP|
                          (SPADCALL |args| (QREFELT $ 111)) |posCheck?| $))
                   (EXIT
                           ...
                           (SEQ
                            (LETT |xxp|
                                  (SPADCALL (CDR |expon|) (CDR |logBase|)
                                            (QREFELT $ 69)))
                            (LETT |f| (SPADCALL |xxp| (QREFELT $ 112)))
                            (EXIT
                             (COND
                              ((QEQCAR |f| 1)
        ...
        ((|ker| |Kernel| FE) (|posCheck?| |Boolean|)
         ($ |Union| (|:| |%expansion| (|ExponentialExpansion| R FE |x| |cen|))
          (|:| |%problem|
               (|Record| (|:| |func| (|String|)) (|:| |prob| (|String|))))))
        (SPROG
         ((#1=#:G611 NIL) (|n| (|Integer|)) (|arg| (FE)) (|args| (|List| FE))
          (|sym| (|Union| (|Symbol|) "failed")))
         (SEQ (LETT |sym| (SPADCALL |ker| (QREFELT $ 114)))
              (EXIT
               (COND
                ((QEQCAR |sym| 0)
                 (COND
                ...
                ((SPADCALL |ker| '|nthRoot| (QREFELT $ 38))
                 (SEQ
                  (LETT |n|
                        (SPADCALL (SPADCALL |args| (QREFELT $ 111))
                                  (QREFELT $ 118)))
                  (EXIT
          ...
          (LETT |singPart|
                (SPADCALL (SPADCALL |f| (|spadConstant| $ 117) (QREFELT $ 130))
                          (SPADCALL
                           ...
                           (QREFELT $ 131))
                          (QREFELT $ 128)))
          (LETT |taylorPart| (SPADCALL |f| |singPart| (QREFELT $ 128)))
          (LETT |expon| (SPADCALL |singPart| (QREFELT $ 132)))
          ...
          (EXIT
           (COND ((QEQCAR |coef| 1) (CONS 1 (CDR |coef|)))
                 ('T
                  (CONS 0
                        (SPADCALL
                         (SPADCALL (CDR |coef|) |expon| (QREFELT $ 109))
                         (QREFELT $ 95))))))))) 
...
(SDEFUN |FS2EXPXP;genLog|
        ...
        (SPROG
         ((|logTerm| (FE)) (|term1| (FE)) (|pow| (FE)) (|mon| (FE))
          ...
          (|lt| (|UnivariatePuiseuxSeries| FE |x| |cen|)) (#1=#:G666 NIL)
          (#2=#:G667 NIL) (|signum| (|Union| (|Integer|) "failed"))
           ...
           (SEQ
            (EXIT
             (SEQ (LETT |deg| (SPADCALL |ups| (QREFELT $ 75)))
                  ...
                  (COND
                   (|posCheck?|
                    (SEQ (LETT |signum| (SPADCALL |coef| (QREFELT $ 99)))
                         (EXIT
                          (COND
                           ((QEQCAR |signum| 0)
                            (COND
                              ...
                              (PROGN
                               (LETT #1#
                                     (PROGN
                                      ...
                                      (GO #3=#:G665)))
                               (GO #4=#:G664))))))))))
                  (LETT |lt| (SPADCALL |coef| |deg| (QREFELT $ 116)))
                  (LETT |negRat?|
                  ...
                  (LETT |logTerm|
                        (SEQ
                         (LETT |mon|
                               (SPADCALL
                                (SPADCALL (QREFELT $ 8) (QREFELT $ 133))
                  ...
                  (EXIT
                   (CONS 0
                         (SPADCALL
                          (SPADCALL |logTerm| (|spadConstant| $ 117)
                                    (QREFELT $ 116))
...
(SDEFUN |FS2EXPXP;logToXXP|
        ...
        (SPROG
         ((|denLog| #2=(|UnivariatePuiseuxSeries| FE |x| |cen|)) (|numLog| #2#)
          ...
          (#3=#:G673 NIL) (#4=#:G680 NIL) (#5=#:G674 NIL)
          (|res|
           (|Union| (|:| |%series| (|UnivariatePuiseuxSeries| FE |x| |cen|))
                    (|:| |%problem|
                         (|Record| (|:| |func| (|String|))
                 ...
                 (COND ((QEQCAR |result| 1) |result|)
                       (#7='T
                        (SEQ
                         ...
                         (LETT |den| (SPADCALL |xxp| (QREFELT $ 92)))
                         (COND
                          ((SPADCALL (SPADCALL |num| (QREFELT $ 103))
                                     (QREFELT $ 104))
                           (COND
                            ((NULL
                              (SPADCALL (SPADCALL |den| (QREFELT $ 103))
                         ...
                         (EXIT
                          (CONS 0
                                (SPADCALL
                                 (SPADCALL |numLog| |denLog| (QREFELT $ 128))
                                 (QREFELT $ 62))))))))))
          #10# (EXIT #4#)))) 
        ...
        ((|fcn| |Mapping|
         ...
         ($ |Union|
          ...
          (|:| |%problem|
               (|Record| (|:| |func| (|String|)) (|:| |prob| (|String|))))))
        (SPROG
         ((#2=#:G685 NIL) (|xOpList| (|List| (|BasicOperator|))) (|lc| (FE))
          (|deg| (|Fraction| (|Integer|)))
...
(SDEFUN |FS2EXPXP;opsInvolvingX| ((|fcn| FE) ($ |List| (|BasicOperator|)))
        (SPROG
         ((|opList| (|List| #1=(|BasicOperator|))) (|op| #1#) (#2=#:G712 NIL)
          (|k| NIL) (#3=#:G711 NIL))
         (SEQ
          (LETT |opList|
                (PROGN
                 (LETT #3# NIL)
                 (SEQ (LETT |k| NIL)
                      (LETT #2# (SPADCALL |fcn| (QREFELT $ 145))) G190
                      (COND
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |op| |name| (QREFELT $ 81))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G716)))
                              (GO #5=#:G714))))))
...
(SDEFUN |FS2EXPXP;productOfNonZeroes?| ((|fcn| FE) ($ |Boolean|))
        (SPROG
         ((#1=#:G735 NIL) (#2=#:G736 NIL) (#3=#:G737 NIL) (|term| NIL)
...
(SDEFUN |FS2EXPXP;tranToXXP|
        ...
        (COND
         ((SPADCALL |ker| '|sin| (QREFELT $ 38))
          (|FS2EXPXP;applyBddIfCan| (SPADCALL |ker| (QREFELT $ 31)) (ELT $ 152)
           |arg| "sin" |posCheck?| $))
         ((SPADCALL |ker| '|cos| (QREFELT $ 38))
          (|FS2EXPXP;applyBddIfCan| (SPADCALL |ker| (QREFELT $ 31)) (ELT $ 153)
           |arg| "cos" |posCheck?| $))
...
(SDEFUN |FS2EXPXP;atancotToXXP|
        ...
        (SPROG
         ((|cc| (FE)) (|n| (|Integer|)) (|posNegPi2| (FE))
          (|signum| (|Union| (|Integer|) "failed")) (|lc| (FE)) (#1=#:G793 NIL)
          (|rn| (|Union| (|Fraction| (|Integer|)) "failed")) (#2=#:G792 NIL)
          (|yCoef| (FE)) (|y| (|UnivariatePuiseuxSeries| FE |x| |cen|))
          (|ord| (|Fraction| (|Integer|))) (|coef| (FE))
          (|ups| #3=(|UnivariatePuiseuxSeries| FE |x| |cen|)) (#4=#:G773 NIL)
          (|trouble|
                                       ...
                                       ((EQL |plusMinus| 1)
                                        (SPADCALL
                                         (SPADCALL (SPADCALL (QREFELT $ 167))
                                                   ...
                                                   (QREFELT $ 20))
                                         (QREFELT $ 162)))
                                       (#6# (SPADCALL (QREFELT $ 167)))))
                                     ((EQL |plusMinus| 1)
                                      (SPADCALL (SPADCALL (QREFELT $ 167))
                                                (SPADCALL 2 (QREFELT $ 40))
                                                (QREFELT $ 20)))
                                     (#6# (|spadConstant| $ 77))))))))))
                             (#6# (SPADCALL |coef| (QREFELT $ 168)))))
                      (EXIT
                       (CONS 0
                             (SPADCALL
...
(DEFUN |FunctionSpaceToExponentialExpansion| (&REST #1=#:G794)
  (SPROG NIL
         (PROG (#2=#:G795)
           (RETURN
            (COND
...
(DEFUN |FunctionSpaceToExponentialExpansion;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ...
   (PROGN
    ...
    (QSETREFV $ 140 (LIST #1="sin" #2="cos" #3="atan" #4="acot" "exp" "asinh"))
    (QSETREFV $ 141 (LIST #1# #2# #3# #4#))
    (COND
     ((|HasSignature| |#2|
                      (LIST '|abs|
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 168
                                            '(0 7 0 10 2 12 0 11 11 13 1 7 15 0
                                              ...
                                              0 37 81 2 11 36 0 0 82 2 61 0 0
                                              11 83 1 61 84 0 85 1 84 86 0 87 2
                                              86 36 0 0 88 1 84 60 0 89 1 84 90
                                              0 91 1 61 84 0 92 2 84 0 0 86 93
                                              2 84 0 0 0 94 1 61 0 84 95 1 11
                                              36 0 96 1 98 97 7 99 2 101 100 60
                                              86 102 1 84 0 0 103 1 84 36 0 104
                                              1 7 0 12 105 1 84 106 0 107 2 106
                                              0 7 0 108 2 84 0 60 106 109 2 61
                                              0 84 84 110 1 27 7 0 111 1 61 100
                                              0 112 1 28 113 0 114 0 12 0 115 2
                                              60 0 7 12 116 0 12 0 117 1 7 11 0
                                              118 1 28 37 0 119 1 37 120 0 121
                                              2 12 36 0 0 122 2 12 36 0 0 123 1
                                              101 60 60 124 2 125 7 7 37 126 3
                                              58 56 7 36 57 127 2 60 0 0 0 128
                                              2 60 0 0 0 129 2 60 0 0 12 130 1
                                              60 0 7 131 1 106 0 60 132 1 7 0
                                              37 133 2 7 0 0 0 134 2 7 0 0 0
                                              135 2 60 0 0 0 136 1 101 60 60
                                              137 2 60 0 0 0 138 1 106 60 0 139
                                              2 142 36 120 0 143 1 7 144 0 145
                                              1 47 36 0 146 1 7 147 0 148 2 147
                                              36 37 0 149 1 150 0 0 151 1 101
                                              100 60 152 1 101 100 60 153 1 101
                                              100 60 154 1 101 100 60 155 1 101
                                              100 60 156 1 101 100 60 157 1 101
                                              100 60 158 1 7 0 0 159 1 0 7 7
                                              160 2 12 36 0 0 161 1 7 0 0 162 1
                                              60 0 0 163 0 60 0 164 1 12 0 0
                                              165 1 60 0 0 166 0 7 0 167 1 7 0
                                              0 168 1 0 7 7 160 2 0 52 7 36
                                              53)))))
           '|lookupComplete|)) 
