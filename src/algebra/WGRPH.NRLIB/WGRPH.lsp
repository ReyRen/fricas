         ...
         ((|fobs|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|))
                         (|:| |weight| W))))
          (|fo| #1#) (#2=#:G453 NIL) (|f| NIL) (#3=#:G454 NIL) (|fn| NIL)
          (|arrs|
           (|List|
         ...
         ((|edges|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (#1=#:G468 NIL) (|ar| NIL) (#2=#:G469 NIL) (|arn| NIL)
          (|nodes|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#3=#:G466 NIL) (|ob| NIL) (#4=#:G467 NIL) (|obn| NIL))
         (SEQ (LETT |nodes| NIL)
         ...
         ((|ars|
           (|List|
            #1=(|Record| (|:| |fromOb| (|NonNegativeInteger|))
                         (|:| |toOb| (|NonNegativeInteger|)))))
          (|z| #1#) (#2=#:G478 NIL) (|y| NIL) (#3=#:G479 NIL) (|yn| NIL)
          (#4=#:G476 NIL) (|x| NIL) (#5=#:G477 NIL) (|xn| NIL)
         ...
         ((|ar|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G493 NIL) (|j| NIL) (#3=#:G492 NIL) (|i| NIL)
          (|obs|
           (|List|
            #4=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|))
                         (|:| |weight| W))))
          (|o| #4#) (|ob| (S)) (#5=#:G491 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
          ...
          (|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G572 NIL) (|obm| NIL)
          (|obs|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|))
                         (|:| |weight| W))))
          (|o| #3#) (|ob| (S)) (#4=#:G571 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
          ...
          (|lb|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (#2=#:G580 NIL) (|ba| NIL)
          (|bStart| (|NonNegativeInteger|))
          (|lo|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)) (|:| |weight| W)))))
         (SEQ (LETT |lo| (SPADCALL (QCAR |a|) (QCAR |b|) (QREFELT $ 65)))
              ...
              (SEQ (LETT |ba| NIL) (LETT #2# (QCDR |b|)) G190
                   ...
                   (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
              (LETT |la| (SPADCALL (QCDR |a|) |lb| (QREFELT $ 66)))
              (EXIT (CONS |lo| |la|))))) 
...
(SDEFUN |WGRPH;merge;3$;22| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|la|
          ...
          (#3=#:G601 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G589 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)) (|:| |weight| W))))
          (|i| (|Integer|)) (#6=#:G600 NIL) (|bob| NIL) (#7=#:G599 NIL)
          (|x| NIL) (#8=#:G598 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
          ...
          (SEQ (LETT |bob| NIL) (LETT #6# (QCAR |b|)) G190
               ...
               (SEQ (LETT |i| (SPADCALL |bob| (QCAR |a|) (QREFELT $ 68)))
                    (EXIT
                     (COND
                      ((< |i| 1)
                       (SEQ
...
(SDEFUN |WGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #3=(|NonNegativeInteger|)) (|bi| (S)) (#4=#:G612 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #3#) (|ai| (S)) (#5=#:G611 NIL)
          (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G635 NIL) (|bv| NIL)
          (#3=#:G634 NIL) (|bu| NIL) (#4=#:G633 NIL) (|av| NIL) (#5=#:G632 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G660 NIL) (|bv| NIL)
          (#3=#:G659 NIL) (|bu| NIL) (#4=#:G658 NIL) (|av| NIL) (#5=#:G657 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
...
(SDEFUN |WGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|x| #3#) (|byi| #2#) (|bxi| #1#) (|bi| (S)) (#4=#:G669 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#5=#:G668 NIL)
          (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G690 NIL) (|bv| NIL)
          (#3=#:G689 NIL) (|bu| NIL) (#4=#:G688 NIL) (|av| NIL) (#5=#:G687 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G716 NIL) (|bv| NIL)
          (#3=#:G715 NIL) (|bu| NIL) (#4=#:G714 NIL) (|av| NIL) (#5=#:G713 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G733 NIL) (|oldArrow| NIL) (#4=#:G721 NIL)
          (#5=#:G720 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G732 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)) (|:| |weight| W))))
          (#7=#:G731 NIL) (|o| NIL) (#8=#:G730 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|)) (|:| |weight| W)
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G750 NIL) (|oldArrow| NIL) (#4=#:G738 NIL)
          (#5=#:G737 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G749 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)) (|:| |weight| W))))
          (#7=#:G748 NIL) (|o| NIL) (#8=#:G747 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |WGRPH;routeNodeRecursive|
        ...
        (SPROG
         ((#2=#:G763 NIL) (|shortest| (|List| (|NonNegativeInteger|)))
          (|d| #1#) (#3=#:G764 NIL) (|arr| NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |WGRPH;distanceWeighted;$2NniU;36|
        ((|s| $) (|a| |NonNegativeInteger|) (|b| |NonNegativeInteger|)
         ($ |Union| W "disjoint"))
        (SPROG ((#1=#:G794 NIL) (|r| (|List| (|NonNegativeInteger|))))
               (SEQ
                (EXIT
                 (SEQ (LETT |r| (|WGRPH;routeNodeRecursive| |s| |a| |b| NIL $))
                      (COND
                       ((EQL (SPADCALL |r| (QREFELT $ 44)) 0)
                        (PROGN (LETT #1# (CONS 1 "disjoint")) (GO #2=#:G793))))
...
(SDEFUN |WGRPH;getWeightBetween|
        ...
        (SPROG
         ((|res| (W)) (|isDisjoint| (|Boolean|)) (#1=#:G806 NIL) (|arr| NIL)
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|)) (|:| |weight| W)
                      (|:| |fromOb| (|NonNegativeInteger|))
                    ...
                    (COND
                     ((NULL |fst|)
                      (SEQ
                       ...
                       (EXIT
                        (LETT |res| (SPADCALL |res| |w| (QREFELT $ 104)))))))
         ...
         (SEQ (LETT |res| (|spadConstant| $ 9))
              (SEQ (LETT |i| NIL) (LETT #1# |r|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |i| (CAR #1#)) NIL))
                     (GO G191)))
                   (SEQ (LETT |a| (SPADCALL (QCDR |s|) |i| (QREFELT $ 105)))
                        (EXIT
                         (LETT |res|
...
(SDEFUN |WGRPH;weightedDistanceMatrix;$Tda;40|
        ...
        (SPROG
         ((#2=#:G832 NIL) (|v| NIL) (#3=#:G831 NIL) (|u| NIL)
...
(DEFUN |WeightedGraph| (&REST #1=#:G834)
  (SPROG NIL
         (PROG (#2=#:G835)
           (RETURN
            (COND
...
(MAKEPROP '|WeightedGraph| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) '|Rep|
              ...
              (|List| (|Loop|)) (|Tree| 39) (|List| 114) (|DirectedGraph| $)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 119
                                            '(0 7 0 9 2 16 0 0 15 18 2 13 0 0
                                              ...
                                              1 2 0 114 0 25 1 2 0 114 0 25 1 1
                                              0 115 0 1 1 0 115 0 1 3 0 41 0 25
                                              25 98 2 0 7 0 41 96 3 0 41 0 25
                                              25 101 2 0 7 0 41 100 2 0 25 0 25
                                              1 2 0 41 0 25 1 2 0 41 0 25 1 2 0
                                              41 0 25 1 2 0 41 0 25 1 1 0 25 0
                                              1 2 0 25 0 41 1 2 0 0 0 0 70 2 0
                                              ...
                                              25 0 25 1 2 0 118 118 0 1 1 0 117
                                              ...
                                              25 25 1 1 0 0 33 108 1 0 119 0 1
                                              ...
                                              0 0 0 51 25 25 7 52 2 0 0 0 6 49
                                              2 0 0 0 20 50 4 0 0 0 51 6 6 1 4
                                              0 0 0 51 25 25 54 5 0 0 0 51 25
                                              25 41 1 2 0 0 0 22 53 2 0 47 0 0
                                              1 2 0 0 0 0 67 2 0 82 0 0 84)))))
           '|lookupComplete|)) 
