...
(SDEFUN |FLOATRP;makeEq|
        ...
        (SPROG
         ((#1=#:G387 NIL) (|x| NIL) (#2=#:G388 NIL) (|r| NIL) (#3=#:G386 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |FLOATRP;realRoots;LLParL;3|
        ...
        (SPROG
         ((|lden| (|List| #1=(|Polynomial| (|Integer|)))) (|dp| #1#)
          (#2=#:G397 NIL) (|p| NIL) (#3=#:G396 NIL)
          (|lnum| (|List| (|Polynomial| (|Integer|)))) (#4=#:G395 NIL)
          (#5=#:G394 NIL))
         (SEQ
          (LETT |lnum|
                (PROGN
...
(SDEFUN |FLOATRP;solve;LParL;4|
        ...
        (SPROG
         ((#1=#:G417 NIL) (|numres| NIL) (#2=#:G416 NIL)
          (|lv| #3=(|List| (|Symbol|))) (#4=#:G404 NIL) (#5=#:G403 #3#)
          (#6=#:G405 #3#) (#7=#:G415 NIL) (|dp| #8=(|Polynomial| (|Integer|)))
          (#9=#:G401 NIL) (#10=#:G400 #3#) (#11=#:G402 #3#) (#12=#:G414 NIL)
          (|np| NIL) (|lden| (|List| #8#)) (#13=#:G413 NIL) (|p| NIL)
          (#14=#:G412 NIL) (|lnum| (|List| (|Polynomial| (|Integer|))))
          (#15=#:G411 NIL) (#16=#:G410 NIL))
         (SEQ
          (LETT |lnum|
                (PROGN
                 (LETT #16# NIL)
...
(SDEFUN |FLOATRP;solve;LParL;5|
        ...
        (SPROG
         ((#1=#:G440 NIL) (|numres| NIL) (#2=#:G439 NIL)
          (|lv| #3=(|List| (|Symbol|))) (#4=#:G425 NIL) (#5=#:G424 #3#)
          (#6=#:G426 #3#) (#7=#:G438 NIL) (|dp| #8=(|Polynomial| (|Integer|)))
          (#9=#:G422 NIL) (#10=#:G421 #3#) (#11=#:G423 #3#) (#12=#:G437 NIL)
          (|np| NIL) (|lden| (|List| #8#)) (#13=#:G436 NIL) (|p| NIL)
          (#14=#:G435 NIL) (|lnum| (|List| (|Polynomial| (|Integer|))))
          (#15=#:G434 NIL) (#16=#:G433 NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| (|Integer|)))))
          (#17=#:G432 NIL) (|ep| NIL) (#18=#:G431 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
                 (LETT #18# NIL)
...
(DEFUN |FloatingRealPackage| (#1=#:G451)
  (SPROG NIL
         (PROG (#2=#:G452)
           (RETURN
            (COND
