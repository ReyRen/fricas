...
(SDEFUN |SMP;numberOfMonomials;$Nni;6| ((|p| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G488 NIL) (#2=#:G487 #3=(|NonNegativeInteger|)) (#4=#:G489 #3#)
          (#5=#:G491 NIL) (|q| NIL))
         (SEQ
          (COND
           ((QEQCAR |p| 0)
...
(SDEFUN |SMP;multivariate;SupVarSet$;17|
        ((|u| |SparseUnivariatePolynomial| $) (|mvar| |VarSet|) ($ $))
        (SPROG
         ((#1=#:G531 NIL) (|uu| (|SparseUnivariatePolynomial| $)) (|cc| ($)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;48|
        ...
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G691 NIL)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;55|
        ((|a| . #1=(|SparseUnivariatePolynomial| $)) (|b| . #1#)
         ($ |SparseUnivariatePolynomial| $))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G723 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;58|
        ((|a| . #1=(|SparseUnivariatePolynomial| $)) (|b| . #1#)
         ($ |SparseUnivariatePolynomial| $))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G751 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;coefficients;$L;60| ((|p| $) ($ |List| R))
        (SPROG
         ((#1=#:G768 NIL) (#2=#:G767 #3=(|List| R)) (#4=#:G769 #3#)
          (#5=#:G771 NIL) (|p1| NIL))
         (SEQ
...
(SDEFUN |SMP;eval;$LL$;69|
        ((|p| $) (|Lvar| |List| |VarSet|) (|Lpval| |List| $) ($ $))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G828 NIL) (|mvar| NIL) (#2=#:G827 NIL)
          (|nlvar| (|List| |VarSet|)))
         (SEQ
          (COND
           ((OR (NULL (CDR |Lvar|))
...
(SDEFUN |SMP;eval;$LL$;70|
        ...
        (SPROG ((#1=#:G832 NIL) (|val| NIL) (#2=#:G831 NIL))
               (SEQ
                (SPADCALL |p| |Lvar|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SMP;degree;$LL;72|
        ...
        (SPROG ((#1=#:G842 NIL) (|mvar| NIL) (#2=#:G841 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SMP;minimumDegree;$LL;76|
        ((|p| $) (|Lvar| |List| |VarSet|) ($ |List| (|NonNegativeInteger|)))
        (SPROG ((#1=#:G861 NIL) (|mvar| NIL) (#2=#:G860 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |mvar| NIL) (LETT #1# |Lvar|) G190
...
(SDEFUN |SMP;monomials1|
        ...
        (SPROG
         ((|degs1| #2#) (|vars1| #1#) (|mon| ($))
          ...
          (#5=#:G894 NIL) (|var| NIL) (#6=#:G895 NIL) (|deg| NIL) (|k1| #4#)
          (|p1| ($)) (#7=#:G893 NIL) (|t| NIL) (|v1| (|VarSet|))
          (|tl| (|List| #3#)))
...
(DEFUN |SparseMultivariatePolynomial| (&REST #1=#:G930)
  (SPROG NIL
         (PROG (#2=#:G931)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G929 NIL) (|pv$| NIL) (#2=#:G921 NIL) (#3=#:G922 NIL) (#4=#:G923 NIL)
    (#5=#:G924 NIL) (#6=#:G925 NIL) (#7=#:G926 NIL) (#8=#:G927 NIL)
    (#9=#:G928 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SparseMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'D '|VPoly|
              ...
              (671 . >) (677 . |cons|) (683 . |reverse!|) |SMP;monomials;$L;82|
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|ConvertibleTo| 209) (|InnerEvalable| $$ $$)
                 (|RetractableTo| 7))
              (|makeByteWordVec2| 235
                                  '(0 6 0 11 0 6 0 13 0 0 0 14 1 6 16 0 17 0 8
                                    ...
                                    110 2 0 0 0 106 111 0 48 0 12 0 46 0 14 2 4
