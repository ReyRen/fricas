...
(SDEFUN |FRAC;gcdPolynomial;3Sup;34|
        ...
        (SPROG
         ((|lc| (S)) (|g| (|SparseUnivariatePolynomial| S))
          ...
          (#3=#:G1068 NIL) (#4=#:G1067 (S)) (#5=#:G1069 (S)) (#6=#:G1078 NIL)
          (|u| NIL) (|ppD| #2#) (|denpp| (S)) (#7=#:G1064 NIL) (#8=#:G1063 (S))
          (#9=#:G1065 (S)) (#10=#:G1077 NIL))
         (SEQ
...
(SDEFUN |FRAC;clear| ((|l| |List| $) ($ |List| S))
        (SPROG
         ((#1=#:G1111 NIL) (#2=#:G1118 NIL) (|x| NIL) (#3=#:G1117 NIL)
          (|d| (S)) (#4=#:G1108 NIL) (#5=#:G1107 (S)) (#6=#:G1109 (S))
          (#7=#:G1116 NIL))
         (SEQ
          (LETT |d|
                (PROGN
...
(SDEFUN |FRAC;conditionP;MU;39|
        ...
        (SPROG
         ((#2=#:G1136 NIL) (#3=#:G1138 NIL) (|i| NIL) (#4=#:G1137 NIL)
          (|ansDD| (|Vector| S)) (|ansD| (|Union| (|Vector| S) #1#))
          (|matD| (|Matrix| S)) (#5=#:G1135 NIL) (|l| NIL) (#6=#:G1134 NIL))
         (SEQ
          (LETT |matD|
                (SPADCALL
                 (PROGN
...
(SDEFUN |FRAC;factorPolynomial;SupF;40|
        ...
        (SPROG
         ((|lfact|
          ...
          (|den1| ($)) (|lc| ($)) (#2=#:G1161 NIL) (|w| NIL) (#3=#:G1160 NIL)
          (|ff| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|ppD| (|SparseUnivariatePolynomial| S)) (|denpp| (S))
          (#4=#:G1140 NIL) (#5=#:G1139 (S)) (#6=#:G1141 (S)) (#7=#:G1159 NIL)
          (|u| NIL))
         (SEQ
         ...
         ((|lfact|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|SparseUnivariatePolynomial| $))
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|den1| ($)) (|lc| ($)) (#2=#:G1186 NIL) (|w| NIL) (#3=#:G1185 NIL)
          (|ff| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|ppD| (|SparseUnivariatePolynomial| S)) (|denpp| (S))
          (#4=#:G1166 NIL) (#5=#:G1165 (S)) (#6=#:G1167 (S)) (#7=#:G1184 NIL)
          (|u| NIL) (|lcpp| ($)))
         (SEQ
          (COND ((SPADCALL |pp| (QREFELT $ 80)) (|spadConstant| $ 118))
...
(DEFUN |Fraction;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1206 NIL) (#2=#:G1207 NIL) (#3=#:G1208 NIL)
    (#4=#:G1210 NIL) (#5=#:G1209 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
