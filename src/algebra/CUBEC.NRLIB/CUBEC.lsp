...
(SDEFUN |CUBEC;cubicalComplex;LL$;2|
        ...
        (SPROG ((|res| (|List| (|CubicalFacet|))) (#1=#:G398 NIL) (|f| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |CUBEC;cubicalComplex;LL$;3|
        ...
        (SPROG ((|res| (|List| (|CubicalFacet|))) (#1=#:G402 NIL) (|f| NIL))
               (SEQ (LETT |res| NIL)
                    (SEQ (LETT |f| NIL) (LETT #1# |fs|) G190
                         (COND
                          ((OR (ATOM #1#) (PROGN (LETT |f| (CAR #1#)) NIL))
...
(SDEFUN |CUBEC;maxIndex;$Nni;5| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (|i| (|List| (|Segment| (|Integer|)))) (#1=#:G409 NIL) (|fac| NIL)
...
(SDEFUN |CUBEC;boundary;2$;7| ((|s| $) ($ $))
        (SPROG
         ((|res| ($)) (#1=#:G424 NIL) (|y| NIL) (|x| (|List| (|CubicalFacet|)))
          (#2=#:G423 NIL) (|facet| NIL))
...
(SDEFUN |CUBEC;grade;$L;8| ((|s| $) ($ |List| (|List| (|CubicalFacet|))))
        (SPROG
         ((|gr| (|Integer|)) (#1=#:G435 NIL) (|face| NIL)
          (|res| (|List| (|List| (|CubicalFacet|)))) (#2=#:G434 NIL) (|a| NIL)
          (#3=#:G432 NIL) (|maxGrade| (|NonNegativeInteger|)) (#4=#:G433 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |simp| (QCDR |s|)) (LETT |maxGrade| 0)
                ...
                (LETT |res| NIL)
                (COND
                 ((< |maxGrade| 0) (PROGN (LETT #3# |res|) (GO #5=#:G431))))
...
(SDEFUN |CUBEC;isNewFace?|
        ...
        (SPROG ((#1=#:G440 NIL) (#2=#:G441 NIL) (|a| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |CUBEC;listUnion|
        ((|a| |List| (|CubicalFacet|)) (|b| |List| (|CubicalFacet|))
         ($ |List| (|CubicalFacet|)))
        (SPROG
         ((|res| (|List| (|CubicalFacet|))) (#1=#:G448 NIL) (|b1| NIL)
          (#2=#:G447 NIL) (|a1| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |CUBEC;addImpliedFaces;$L;11|
        ...
        (SPROG
         ((|newFaces| (|List| (|CubicalFacet|))) (|len| (|NonNegativeInteger|))
          (#1=#:G465 NIL) (|face| NIL) (#2=#:G464 NIL) (#3=#:G463 NIL)
          (#4=#:G461 NIL) (|gr| NIL) (#5=#:G462 NIL) (|grn| NIL)
          (|res| (|List| (|List| (|CubicalFacet|)))) (#6=#:G460 NIL) (|a| NIL)
          (#7=#:G459 NIL) (|maxGrade| (|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |inputList| (REVERSE (SPADCALL |s| (QREFELT $ 43))))
                ...
                (COND
                 ((< |maxGrade| 1) (PROGN (LETT #7# |res|) (GO #8=#:G458))))
...
(SDEFUN |CUBEC;product;3$;12| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|res| (|List| (|CubicalFacet|))) (|p| (|CubicalFacet|))
          (#1=#:G477 NIL) (|cubeb| NIL) (#2=#:G476 NIL) (|cubea| NIL)
          (|vs| (|List| VS)) (|pp| (VS)) (#3=#:G475 NIL) (|pb| NIL)
          (#4=#:G474 NIL) (|pa| NIL) (|cubesb| #5=(|List| (|CubicalFacet|)))
          (|cubesa| #5#))
...
(SDEFUN |CUBEC;=;2$B;17| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G496 NIL) (#2=#:G500 NIL) (|f| NIL)
          (|x| (|NonNegativeInteger|)) (#3=#:G499 NIL) (|a1| NIL)
          (|flags| (|List| (|Boolean|))) (#4=#:G498 NIL) (#5=#:G497 NIL)
...
(SDEFUN |CUBEC;coerce;$Of;18| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (#1=#:G506 NIL) (|a| NIL) (#2=#:G505 NIL))
         (SEQ
          (EXIT
...
(DEFUN |FiniteCubicalComplex| (#1=#:G508)
  (SPROG NIL
         (PROG (#2=#:G509)
           (RETURN
            (COND
