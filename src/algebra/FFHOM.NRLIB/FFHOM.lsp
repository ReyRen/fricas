            ...
            (SEQ (LETT |equal| 0)
                 (SEQ (LETT |i| (SPADCALL |f| (QREFELT $ 33))) G190
                      ...
                      (SEQ
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL |f1| |g1| (QREFELT $ 42)) (LETT |equal| 1))
                         ((< |f1| |g1|) (LETT |equal| -1)))))
...
(SDEFUN |FFHOM;initialize| (($ |Void|))
        (SPROG
         ((|matbs| #1=(|Matrix| GF)) (#2=#:G416 NIL) (|matsb| #1#)
          (#3=#:G442 NIL) (|i| NIL) (|mat| #1#)
          (|arr| (|PrimitiveArray| (|SparseUnivariatePolynomial| GF)))
          (#4=#:G441 NIL) (#5=#:G440 NIL) (|rowind| (|Integer|))
          ...
          (COND
           ((SPADCALL (QREFELT $ 30) (QREFELT $ 32) (QREFELT $ 43))
            (SEQ
             ...
             (LETT |arr| (SPADCALL (QREFELT $ 30) (QREFELT $ 46)))
              ...
              (COND
               ((SPADCALL (QREFELT $ 24) (CONS 2 "normal") (QREFELT $ 51))
                (SEQ (SETELT $ 20 (SPADCALL |mat| (QREFELT $ 52)))
                     (SETELT $ 21
                             (SPADCALL
                              (PROG2 (LETT #2# (SPADCALL |mat| (QREFELT $ 54)))
                                  (QCDR #2#)
            ...
            (SEQ (LETT |dPbig| (QREFELT $ 32)) (LETT |rTbig| (QREFELT $ 26))
                 ...
                 (COND
                  ((SPADCALL |rTbig| (CONS 2 "normal") (QREFELT $ 51))
                   (SEQ (LETT |arr| (SPADCALL |dPbig| (QREFELT $ 46)))
                        (LETT |mat|
                        ...
                        (EXIT
                         (LETT |matbs|
                               (SPADCALL |matbs| |mat| (QREFELT $ 66)))))))
                 (COND
                  ((SPADCALL |rTsmall| (CONS 2 "normal") (QREFELT $ 51))
                   (SEQ (LETT |arr| (SPADCALL |dPsmall| (QREFELT $ 46)))
                        (LETT |mat|
...
(DEFUN |FiniteFieldHomomorphisms| (&REST #1=#:G461)
  (SPROG NIL
         (PROG (#2=#:G462)
           (RETURN
            (COND
...
(MAKEPROP '|FiniteFieldHomomorphisms| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|NonNegativeInteger|) (8 . ~=) '#:G382 (|Matrix| 7)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 95
                                            '(0 6 9 10 0 8 9 12 2 15 14 0 0 16
                                              ...
                                              33 2 15 14 0 0 34 0 6 0 35 0 7 0
                                              36 0 6 0 37 0 7 0 38 2 28 7 0 15
                                              39 1 7 14 0 40 1 7 9 0 41 2 9 14
                                              0 0 42 2 28 14 0 0 43 1 45 44 28
                                              46 2 28 47 0 15 48 3 18 0 0 49 47
                                              50 2 22 14 0 0 51 1 18 0 0 52 1
                                              18 53 0 54 0 55 0 56 2 18 47 0 49
                                              57 1 18 0 47 58 2 18 0 0 0 59 1
                                              18 15 0 60 2 49 14 0 0 61 3 62 49
                                              0 49 49 63 2 62 49 0 49 64 2 18
                                              47 0 49 65 2 18 0 0 0 66 1 6 14 0
                                              67 1 6 7 0 68 1 8 0 7 69 2 6 14 0
                                              0 71 0 8 0 72 0 8 0 73 2 8 0 0 49
                                              74 1 6 15 0 75 1 6 47 0 76 2 18
                                              47 0 47 77 1 8 0 47 78 1 6 79 0
                                              80 1 6 9 0 81 2 49 0 0 0 82 2 49
                                              14 0 0 83 1 8 14 0 84 1 8 7 0 85
                                              1 6 0 7 86 2 8 14 0 0 88 0 6 0 89
                                              2 6 0 0 49 90 1 8 15 0 91 1 8 47
                                              0 92 1 6 0 47 93 1 8 79 0 94 1 8
                                              9 0 95 1 0 6 8 87 1 0 8 6 70)))))
           '|lookupComplete|)) 
