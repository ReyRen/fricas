...
(SDEFUN |JBUNDLE;CheckZeroIndex|
        ...
        (SPROG ((#1=#:G408 NIL) (#2=#:G409 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |JBUNDLE;U;Pi$;8| ((|up| |PositiveInteger|) ($ $))
        (SPROG ((#1=#:G414 NIL) (|i| NIL) (#2=#:G413 NIL))
               (SEQ
                (COND
...
(SDEFUN |JBUNDLE;coerce;S$;10| ((|s| |Symbol|) ($ $))
        (SPROG ((#1=#:G422 NIL) (#2=#:G419 NIL) (|pos| (|Integer|)))
...
(SDEFUN |JBUNDLE;D;SL$;11| ((|u| |Symbol|) (|der| |List| (|Symbol|)) ($ $))
        (SPROG
         ((#1=#:G430 NIL) (|lower| (|List| (|PositiveInteger|)))
          (#2=#:G426 NIL) (|pos| #3=(|Integer|)) (#4=#:G434 NIL) (|d| NIL)
          (|up| #3#))
...
(SDEFUN |JBUNDLE;name;$S;15| ((|jv| $) ($ |Symbol|))
        (SPROG
         ((|lower| (|List| (|OutputForm|))) (#1=#:G446 NIL) (|j| NIL)
...
(SDEFUN |JBUNDLE;coerce;$E;17| ((|jv| $) ($ |Expression| (|Integer|)))
        (SPROG
         ((|arg| (|List| (|Expression| (|Integer|)))) (#1=#:G454 NIL) (|i| NIL)
          (#2=#:G453 NIL) (|jop| (|BasicOperator|)) (|tmp| (|None|))
          (|opname| (|Symbol|)))
         (SEQ
          (COND
