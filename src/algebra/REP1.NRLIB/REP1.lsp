...
(SDEFUN |REP1;calcCoef|
        ...
        (SPROG ((|prod| (|Integer|)) (#1=#:G387 NIL) (|i| NIL))
               (SEQ (LETT |prod| 1)
                    (SEQ (LETT |i| 1)
...
(SDEFUN |REP1;invContent|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#2=#:G403 NIL) (|k| NIL)
          (|j| (|Integer|)) (#3=#:G402 NIL) (|og| NIL)
          (|f| (|Vector| (|Integer|))) (|n| (|NonNegativeInteger|))
          (#4=#:G394 NIL) (#5=#:G392 NIL) (#6=#:G391 #1#) (#7=#:G393 #1#)
          (#8=#:G401 NIL) (#9=#:G382 NIL))
         (SEQ
          (LETT |n|
                (PROG1
                    (LETT #4#
...
(SDEFUN |REP1;antisymmetricTensors;MPiM;3|
        ...
        (SPROG
         ((#1=#:G429 NIL) (|t| NIL) (#2=#:G430 NIL) (|tt| NIL) (#3=#:G427 NIL)
          (|r| NIL) (#4=#:G428 NIL) (|rr| NIL) (|c| #5=(|Matrix| R))
          (#6=#:G425 NIL) (|j| NIL) (#7=#:G426 NIL) (|lt| NIL) (#8=#:G423 NIL)
          (|i| NIL) (#9=#:G424 NIL) (|lr| NIL) (|b| #5#) (#10=#:G409 NIL)
          (#11=#:G408 NIL) (|ilc| (|List| (|List| (|Integer|))))
          (#12=#:G422 NIL) (#13=#:G421 NIL)
          (|ilr| (|List| (|List| (|Integer|)))) (#14=#:G420 NIL)
          (#15=#:G419 NIL) (|mc| #16=(|Integer|)) (|mr| #16#)
         ...
         (SEQ (LETT |nr| (ANROWS |a|)) (LETT |nc| (ANCOLS |a|))
              (EXIT
               (COND ((EQL |k| 1) |a|)
                     ...
                     ('T
                      (SEQ (LETT |mr| (SPADCALL |nr| |k| (QREFELT $ 23)))
                           (LETT |mc| (SPADCALL |nc| |k| (QREFELT $ 23)))
                           (LETT |ilr|
                                 (PROGN
                                  (LETT #15# NIL)
...
(SDEFUN |REP1;antisymmetricTensors;LPiL;4|
        ((|la| |List| (|Matrix| R)) (|k| |PositiveInteger|)
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G434 NIL) (|ma| NIL) (#2=#:G433 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |ma| NIL) (LETT #1# |la|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL |ma| |k| (QREFELT $ 32)) #2#))))
...
(SDEFUN |REP1;symmetricTensors;MPiM;5|
        ...
        (SPROG
         ((|colemanMatrix| (|Matrix| (|Integer|))) (|help| (R)) (#1=#:G438 NIL)
          (#2=#:G437 NIL) (#3=#:G451 NIL) (|k| NIL)
          (|gamma| (|List| (|Integer|))) (|g| #4=(|Vector| (|Integer|)))
          (|beta| #5=(|List| (|Integer|))) (#6=#:G450 NIL) (|j| NIL) (|f| #4#)
          (|alpha| #5#) (#7=#:G449 NIL) (|i| NIL)
          (|nullMatrix| (|Matrix| (|Integer|))) (|c| (|Matrix| R))
          (|dimc| (|NonNegativeInteger|)) (#8=#:G436 NIL)
          (|dimr| (|NonNegativeInteger|)) (#9=#:G435 NIL)
...
(SDEFUN |REP1;symmetricTensors;LPiL;6|
        ((|la| |List| (|Matrix| R)) (|k| |PositiveInteger|)
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G455 NIL) (|ma| NIL) (#2=#:G454 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |ma| NIL) (LETT #1# |la|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL |ma| |k| (QREFELT $ 43)) #2#))))
                      (LETT #1# (CDR #1#)) (GO G190) G191
                      (EXIT (NREVERSE #2#))))))) 
...
(SDEFUN |REP1;tensorProduct;3L;8|
        ((|la| |List| (|Matrix| R)) (|lb| |List| (|Matrix| R))
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G460 NIL) (|i| NIL) (#2=#:G459 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 1) (LETT #1# (SPADCALL |la| (QREFELT $ 47)))
...
(SDEFUN |REP1;permutationRepresentation;PIM;11|
        ((|p| |Permutation| (|Integer|)) (|n| |Integer|)
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G470 NIL) (|i| NIL) (|a| (|Matrix| (|Integer|)))
          (#2=#:G466 NIL) (#3=#:G465 NIL))
         (SEQ
          (LETT |a|
                (SPADCALL
                 (PROG1 (LETT #3# |n|)
...
(SDEFUN |REP1;permutationRepresentation;LM;12|
        ...
        (SPROG
         ((#1=#:G478 NIL) (|i| NIL) (|a| (|Matrix| (|Integer|)))
          (#2=#:G474 NIL) (#3=#:G473 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (LENGTH |p|))
              (LETT |a|
                    (SPADCALL
                     (PROG1 (LETT #3# |n|)
...
(SDEFUN |REP1;permutationRepresentation;LIL;13|
        ((|listperm| |List| (|Permutation| (|Integer|))) (|n| |Integer|)
         ($ |List| (|Matrix| (|Integer|))))
        (SPROG ((#1=#:G482 NIL) (|perm| NIL) (#2=#:G481 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |perm| NIL) (LETT #1# |listperm|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL |perm| |n| (QREFELT $ 56))
                                    #2#))))
                      (LETT #1# (CDR #1#)) (GO G190) G191
                      (EXIT (NREVERSE #2#))))))) 
...
(SDEFUN |REP1;permutationRepresentation;LL;14|
        ((|listperm| |List| (|List| (|Integer|)))
         ($ |List| (|Matrix| (|Integer|))))
        (SPROG ((#1=#:G486 NIL) (|perm| NIL) (#2=#:G485 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |perm| NIL) (LETT #1# |listperm|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL |perm| (QREFELT $ 57)) #2#))))
                      (LETT #1# (CDR #1#)) (GO G190) G191
                      (EXIT (NREVERSE #2#))))))) 
...
(SDEFUN |REP1;createGenericMatrix;NniM;15|
        ...
        (SPROG
         ((|sy| (|Symbol|)) (|le| (|List| (|OutputForm|)))
          (|jof| #1=(|OutputForm|)) (|iof| #1#) (#2=#:G493 NIL) (|j| NIL)
          (#3=#:G492 NIL) (|i| NIL) (|res| (|Matrix| (|Polynomial| R))))
         (SEQ (LETT |res| (MAKE_MATRIX1 |m| |m| (|spadConstant| $ 64)))
                   ...
                   (SEQ
                    (EXIT
                     (SEQ (LETT |j| 1) (LETT #2# |m|) G190
                          ...
                          (SEQ (LETT |iof| (SPADCALL |i| (QREFELT $ 66)))
                               (LETT |jof| (SPADCALL |j| (QREFELT $ 66)))
                               (LETT |le|
                                     (CONS |iof|
                                           (SPADCALL |jof| (QREFELT $ 68))))
...
(DEFUN |RepresentationPackage1| (#1=#:G494)
  (SPROG NIL
         (PROG (#2=#:G495)
           (RETURN
            (COND
