...
(SDEFUN |SKSMP;coerce;$Of;10| ((|x| $) ($ |OutputForm|))
        (SPROG ((|xu| (|Upol|)) (|v| (|Var|)) (#1=#:G442 NIL))
               (SEQ
                (COND
                 ((SPADCALL |x| (QREFELT $ 34))
...
(DEFUN |SparseMultivariateSkewPolynomial| (&REST #1=#:G462)
  (SPROG NIL
         (PROG (#2=#:G463)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariateSkewPolynomial;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|pv$| NIL) (#1=#:G460 NIL) (#2=#:G461 NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL)
