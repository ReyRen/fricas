...
(SDEFUN |CLINDEP;kmap|
        ...
        (SPROG
         ((#1=#:G415 NIL) (|a| NIL) (#2=#:G414 NIL)
          ...
          (|op| (|BasicOperator|)) (#5=#:G409 NIL) (|is_const| (|Boolean|))
          (#6=#:G413 NIL) (|d| NIL) (|kf| (F)) (#7=#:G410 NIL) (#8=#:G411 NIL)
          (|dmvar| NIL) (#9=#:G412 NIL) (|dmval| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |CLINDEP;constant_subspace;LLR;15|
        ((|b| |List| (|Vector| F)) (|ld| |List| (|Mapping| F F))
         ($ |Record| (|:| |transform| (|Matrix| F))
          (|:| |basis| (|List| (|Vector| F)))))
        (SPROG
         ((#1=#:G486 NIL) (|bv| NIL) (#2=#:G485 NIL) (|m2| #3=(|Matrix| F))
          (#4=#:G484 NIL) (|i| NIL) (#5=#:G483 NIL) (#6=#:G482 NIL)
          (#7=#:G481 NIL) (|l3| (|List| (|Vector| F))) (#8=#:G480 NIL)
          (#9=#:G479 NIL) (|s1| (|List| (|Vector| F))) (|m| (|Matrix| F))
          (|lr| (|List| (|Vector| F))) (|ll| (|List| (|List| F)))
          (|ll1| (|List| F)) (#10=#:G478 NIL) (|d1| NIL)
          (|lpiv1| (|List| (|Integer|))) (|kk| (|Integer|)) (#11=#:G477 NIL)
          (|j| NIL) (#12=#:G476 NIL) (|lpiv| (|List| (|Integer|)))
          (|lri| (|List| (|Integer|))) (|k| #13=(|Integer|)) (|k1| #13#)
          (#14=#:G475 NIL) (|m1| (|Matrix| F)) (|m0| (|Matrix| F)) (|m0b| #3#)
          (#15=#:G474 NIL) (#16=#:G473 NIL) (|nr| (|NonNegativeInteger|))
...
(DEFUN |ConstantLinearDependence| (&REST #1=#:G487)
  (SPROG NIL
         (PROG (#2=#:G488)
           (RETURN
            (COND
