...
(SDEFUN |PADICRC;=;2$B;11| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG ((#1=#:G598 NIL) (#2=#:G537 NIL) (|n| (|Integer|)))
               (SEQ
                (COND ((EQ |x| |y|) 'T)
                      (#3='T
                       (SEQ
...
(SDEFUN |PADICRC;+;3$;12| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G616 NIL) (#2=#:G612 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|PADICRC;getExpon| |x| $)
                         (|PADICRC;getExpon| |y| $)))
...
(SDEFUN |PADICRC;-;3$;14| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G634 NIL) (#2=#:G630 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|PADICRC;getExpon| |x| $)
                         (|PADICRC;getExpon| |y| $)))
...
(SDEFUN |PADICRC;recip;$U;18| ((|x| $) ($ |Union| $ #1="failed"))
        (SPROG ((|inv| (|Union| PADIC #1#)) (|xx| (PADIC)))
               (SEQ (LETT |x| (SPADCALL 1000 |x| (QREFELT $ 33)))
                    (EXIT
                     (COND
                      ((ZEROP
                        (SPADCALL (LETT |xx| (|PADICRC;getZp| |x| $))
                       ...
                       (CONS 1 "failed"))
                      (#2='T
                       (SEQ (LETT |inv| (SPADCALL |xx| (QREFELT $ 53)))
                            (EXIT
...
(SDEFUN |PADICRC;inv;2$;19| ((|x| $) ($ $))
        (SPROG ((|inv| (|Union| $ "failed")))
               (SEQ (LETT |inv| (SPADCALL |x| (QREFELT $ 54)))
                    (EXIT
          ...
          (RETURN
           (PROGN
            (SPROG ((|invx| NIL) (|x0| NIL))
                   (SEQ (LETT |invx| (SPADCALL |x| (QREFELT $ 50)))
                        (LETT |x0|
...
(SDEFUN |PADICRC;continuedFraction;$Cf;25|
        ...
        (SPROG ((|x0| (|Fraction| (|Integer|))))
               (SEQ (LETT |x0| (SPADCALL |x| 1 (QREFELT $ 61)))
                    (EXIT
                     (SPADCALL |x0|
                               (|PADICRC;cfStream|
...
(SDEFUN |PADICRC;coerce;$Of;28| ((|x| $) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu| (|Stream| (|Integer|)))
          (|uu1| (|Stream| (|Integer|))) (|n| NIL) (#1=#:G698 NIL)
          (|count| (|NonNegativeInteger|)) (|zp| (PADIC)) (|m| (|Integer|)))
         (SEQ (LETT |x| (SPADCALL |$streamCount| |x| (QREFELT $ 33)))
                             ...
                             ((SPADCALL (SPADCALL |uu| (QREFELT $ 73)) 0
                              ...
                              (LETT |l|
                                    (CONS
                                     ...
                                     |l|))))
                            (EXIT (LETT |uu| (SPADCALL |uu| (QREFELT $ 75)))))
...
(DEFUN |PAdicRationalConstructor| (&REST #1=#:G733)
  (SPROG NIL
         (PROG (#2=#:G734)
           (RETURN
            (COND
...
(DEFUN |PAdicRationalConstructor;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G732 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
