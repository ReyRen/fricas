...
(SDEFUN |IRURPK;checkRur;TSLB;1| ((|ts| TS) (|lts| |List| TS) ($ |Boolean|))
        (SPROG
         ((#1=#:G419 NIL) (#2=#:G420 NIL) (|rems| (|List| P)) (#3=#:G423 NIL)
          (|p| NIL) (#4=#:G422 NIL) (|dlts| (|NonNegativeInteger|))
          (#5=#:G421 NIL) (|us| NIL) (|lp| (|List| P))
          (|dts| (|NonNegativeInteger|)) (|z| (V)) (|f0| (P)) (#6=#:G408 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |f0|
...
(SDEFUN |IRURPK;prepareRur|
        ...
        (SPROG
         ((|toSave|
           (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|newf0| (P)) (#1=#:G440 NIL) (|ff1| NIL) (|newf1| (P)) (|x1| (V))
...
(SDEFUN |IRURPK;makeMonic|
        ...
        (SPROG ((|newts| (TS)) (|p| (P)) (#1=#:G448 NIL) (|lp| (|List| P)))
               (SEQ (LETT |lp| (SPADCALL |ts| (QREFELT $ 18)))
                    (LETT |lp| (SPADCALL (ELT $ 35) |lp| (QREFELT $ 37)))
         ...
         ((|toSee|
           (|List|
            (|Record| (|:| |pol| P) (|:| |gap| #1=(|Integer|))
                      (|:| |tower| TS))))
          (|toSave| (|List| TS)) (#2=#:G476 NIL) (|fr| NIL) (|r| (P)) (|h| (P))
...
(SDEFUN |IRURPK;rur;TSBL;7| ((|ts| TS) (|univ?| |Boolean|) ($ |List| TS))
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (#1=#:G491 NIL) (|lts| (|List| TS)) (|p| (P)) (|xi| (V))
...
(DEFUN |InternalRationalUnivariateRepresentationPackage| (&REST #1=#:G492)
  (SPROG NIL
         (PROG (#2=#:G493)
           (RETURN
            (COND
