...
(SDEFUN |FFIELDC-;createPrimitiveElement;S;8| (($ S))
        (SPROG
         ((|found| (|Boolean|)) (|e| (S)) (#1=#:G427 NIL) (|i| NIL)
...
(SDEFUN |FFIELDC-;primitive?;SB;9| ((|a| S) ($ |Boolean|))
        (SPROG
         ((|equalone| (|Boolean|)) (#1=#:G437 NIL) (|exp| NIL)
          (|q| (|Integer|))
          (|explist|
           (|List|
...
(SDEFUN |FFIELDC-;order;SPi;10| ((|e| S) ($ |PositiveInteger|))
        (SPROG
         ((|ord| (|Integer|)) (|goon| (|Boolean|)) (|a| (|Integer|))
          (#1=#:G446 NIL) (|j| NIL) (|primeDivisor| #2=(|Integer|))
          (#3=#:G445 NIL) (|rec| NIL)
          (|lof|
           (|List|
            (|Record| (|:| |factor| #2#)
...
(SDEFUN |FFIELDC-;discreteLog;SNni;11| ((|b| S) ($ |NonNegativeInteger|))
        (SPROG
         ((|a| (S)) (|disclog| (|Integer|)) (|mult| (|Integer|)) (|c| (S))
          ...
          (|rho| (|Union| (|NonNegativeInteger|) "failed")) (#1=#:G465 NIL)
          (|i| NIL) (|end| (|Integer|)) (|n| (|NonNegativeInteger|))
          (|exptable| (|Table| (|PositiveInteger|) (|NonNegativeInteger|)))
          (|exp| #2=(|Integer|)) (#3=#:G464 NIL) (|t| NIL)
          (|fac| #4=(|Integer|)) (#5=#:G463 NIL) (|f| NIL) (|groupord| #2#)
          (|gen| (S))
          (|faclist|
           (|List|
            (|Record| (|:| |factor| #4#)
...
(SDEFUN |FFIELDC-;discreteLog;2SU;12|
        ...
        (SPROG
         ((|a| (S)) (|mult| (|Integer|)) (|disclog| (|Integer|))
          (|rho| (|Integer|)) (#1=#:G486 NIL)
          (|rhoHelp| (|Union| (|NonNegativeInteger|) "failed"))
          (|exp| (|Integer|)) (#2=#:G488 NIL) (|t| NIL) (|primroot| (S))
          (|fac| #3=(|Integer|)) (#4=#:G487 NIL) (|f| NIL)
          (|faclist|
           (|List|
...
(SDEFUN |FFIELDC-;factorSquareFreePolynomial;SupF;15|
        ...
        (SPROG
         ((#1=#:G502 NIL)
          (#2=#:G501 #3=(|Factored| (|SparseUnivariatePolynomial| S)))
          (#4=#:G503 #3#) (#5=#:G506 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |cont| S)
                     (|:| |factors|
                          (|List|
