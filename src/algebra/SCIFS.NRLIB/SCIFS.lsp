...
(SDEFUN |SCIFS;smesh;LB$;4|
        ...
        (SPROG
         ((|j| #1=(|NonNegativeInteger|))
          ...
          (|pt2| (|List| PT)) (#2=#:G404 NIL) (|p| NIL) (#3=#:G403 NIL)
...
(SDEFUN |SCIFS;singleFace;L$;5| ((|ptin| |List| PT) ($ $))
        (SPROG
         ((|in2| (|List| (|List| (|NonNegativeInteger|)))) (#1=#:G409 NIL)
          (|i| NIL) (#2=#:G408 NIL) (|pt2| (|List| PT)))
         (SEQ (LETT |pt2| |ptin|)
              (LETT |in2|
                    (LIST
                     (PROGN
...
(SDEFUN |SCIFS;subdivide;2$;6| ((|me| $) ($ $))
        (SPROG
         ((|indexSize| (|NonNegativeInteger|))
          ...
          (|newFace| (|List| (|NonNegativeInteger|))) (#1=#:G426 NIL) (|j| NIL)
          (#2=#:G425 NIL) (#3=#:G424 NIL) (|ptIx| NIL) (|pt2| (|List| PT))
          (|newPt| (PT)) (#4=#:G423 NIL) (#5=#:G422 NIL) (|faceIx| NIL)
          (#6=#:G421 NIL) (|i| NIL) (#7=#:G420 NIL))
...
(SDEFUN |SCIFS;sierpinskiDivide;$Nni$;7|
        ...
        (SPROG
         ((#1=#:G438 NIL) (#2=#:G441 NIL) (|indexSize| (|NonNegativeInteger|))
          (|in2| (|List| (|List| (|NonNegativeInteger|))))
          (|index2| (|NonNegativeInteger|)) (|index1| (|NonNegativeInteger|))
          (|newFace| (|List| #3=(|NonNegativeInteger|))) (|ix4| #3#)
          (|ix3| #3#) (#4=#:G446 NIL) (|offset| NIL) (#5=#:G431 NIL)
          (|pt2| (|List| PT)) (|newPt| (PT)) (|ix2| #3#)
          (|ix1| (|NonNegativeInteger|)) (#6=#:G445 NIL) (#7=#:G444 NIL)
          (|faceIx| NIL) (#8=#:G443 NIL) (|i| NIL) (#9=#:G442 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |indexSize| (LENGTH (QCDR |me|)))
                (LETT |pt2|
                ...
                (COND
                 ((< |level| 1)
                  (PROGN (LETT #2# (CONS |in2| |pt2|)) (GO #10=#:G440))))
                (EXIT
...
(SDEFUN |SCIFS;listBranches|
        ((|functions| |List|
          (|Record| (|:| |source| (|Mapping| PT (|DoubleFloat|)))
                    ...
                    (|:| |points| (|List| PT))))
         ($ |List| (|List| PT)))
        (SPROG ((|outList| (|List| (|List| PT))) (#1=#:G451 NIL) (|curve| NIL))
...
(SDEFUN |SCIFS;curveTriads|
        ...
        (SPROG
         ((|endtriad|
          ...
          (|midtriads|
           (|List| (|Record| (|:| |tang| PT) (|:| |norm| PT) (|:| |bin| PT))))
          (#2=#:G469 NIL) (|pl| NIL) (#3=#:G470 NIL) (|po| NIL) (#4=#:G471 NIL)
          (|pr| NIL) (#5=#:G468 NIL) (|triad| #1#) (|b| (PT))
...
(SDEFUN |SCIFS;cosSinInfo|
        ...
        (SPROG
         ((|ans| (|List| (|List| (|DoubleFloat|)))) (|angle| (|DoubleFloat|))
          (#1=#:G476 NIL) (|i| NIL) (|theta| (|DoubleFloat|)))
         (SEQ (LETT |ans| NIL)
              (LETT |theta|
                    (|div_DF_I|
...
(SDEFUN |SCIFS;curveLoops;LDfIL;14|
        ((|pts1| |List| PT) (|r| |DoubleFloat|) (|nn| |Integer|)
         ($ |List| (|List| PT)))
        (SPROG
         ((|loops| (|List| (|List| PT))) (|b| (PT)) (|n| (PT)) (#1=#:G486 NIL)
          (|pt| NIL) (#2=#:G487 NIL) (|triad| NIL)
...
(SDEFUN |SCIFS;stube;LDfI$;15|
        ...
        (SPROG
         ((|loops| (|List| (|List| PT))) (#1=#:G495 NIL) (|bran| NIL)
          (|brans| (|List| (|List| PT))))
         (SEQ
...
(SDEFUN |SCIFS;coerce;$Of;16| ((|me| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|List| (|OutputForm|))) (|r| (|OutputForm|)) (#1=#:G506 NIL)
          (|pIx| NIL) (#2=#:G505 NIL) (|faceIx| NIL) (#3=#:G504 NIL) (|p| NIL))
