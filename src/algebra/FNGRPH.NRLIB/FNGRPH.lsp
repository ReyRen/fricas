        ...
        (SPROG
         ((|fobs|
          ...
          (|f|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#1=#:G422 NIL) (|fn| NIL) (|too| (|NonNegativeInteger|))
          (|fromo| (|NonNegativeInteger|)) (#2=#:G421 NIL) (|a| NIL)
          (|arrs| (|List| (|NonNegativeInteger|))) (#3=#:G420 NIL) (|x| NIL)
          (#4=#:G419 NIL))
         (SEQ
          (LETT |arrs|
                (PROGN
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G434 NIL) (|j| NIL)
          (#2=#:G432 NIL) (|vert| NIL) (#3=#:G433 NIL) (|i| NIL)
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G467 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G474 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
              (SEQ (LETT |obn| 1) (LETT #1# (LENGTH |objs|)) G190
                   (COND ((|greater_SI| |obn| #1#) (GO G191)))
                   (SEQ (LETT |ob| (SPADCALL |objs| |obn| (QREFELT $ 31)))
...
(SDEFUN |FNGRPH;unit;LS$;14| ((|objs| |List| S) (|arrowName| |String|) ($ $))
        (SPROG ((#1=#:G479 NIL) (|x| NIL) (#2=#:G478 NIL))
               (SEQ
                (LETT |objs|
                      (PROGN
                       (LETT #2# NIL)
...
(SDEFUN |FNGRPH;indexProd|
        ((|aObj| $) (|a| |NonNegativeInteger|) (|b| |NonNegativeInteger|)
         ($ |NonNegativeInteger|))
        (SPROG ((|x| (|NonNegativeInteger|)) (#1=#:G492 NIL))
               (SEQ
                (LETT |x|
                      (+ |a|
                         (*
...
(SDEFUN |FNGRPH;*;2$Fg;19|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #5=(|NonNegativeInteger|)) (|bi| (S)) (#6=#:G505 NIL)
...
(SDEFUN |FNGRPH;closedTensor;2$M$;20|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#5=#:G514 NIL) (|boi| NIL) (|ani| #3#)
          (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#6=#:G513 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
...
(SDEFUN |FNGRPH;map;$LL2I$;21|
        ...
        (SPROG
         ((|nwob|
          ...
          (#5=#:G519 NIL) (|newX| (|NonNegativeInteger|)) (#6=#:G518 NIL)
          (|newObj| (S)) (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G530 NIL)
          (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;mapContra;$LL2I$;22|
        ...
        (SPROG
         ((|nwob|
          ...
          (|newY| (|NonNegativeInteger|)) (#5=#:G536 NIL)
          (|newX| (|NonNegativeInteger|)) (#6=#:G535 NIL) (|newObj| (S))
          (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G548 NIL) (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;coAdjoint;$LU;23|
        ...
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G566 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G573 NIL) (|ri| NIL)
          (#3=#:G572 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G571 NIL)
          (#5=#:G570 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G569 NIL) (#7=#:G568 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G567 NIL)
                ...
                (SEQ (LETT |ri| NIL) (LETT #2# |retOpt|) G190
                     (COND
                      ((OR (ATOM #2#) (PROGN (LETT |ri| (CAR #2#)) NIL))
                       (GO G191)))
                     (SEQ (LETT |x| (SPADCALL |s| |ri| (QREFELT $ 78)))
                          (COND
                           ((EQL |x| 0)
                            (PROGN
...
(SDEFUN |FNGRPH;contraAdjoint;$LU;24|
        ((|s| $) (|m| |List| (|NonNegativeInteger|))
         ($ |Union| (|List| (|NonNegativeInteger|)) "failed"))
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G587 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G594 NIL) (|ri| NIL)
          (#3=#:G593 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G592 NIL)
          (#5=#:G591 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G590 NIL) (#7=#:G589 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G588 NIL)
          (|domainSize| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |domainSize| (LENGTH (QCAR |s|))) (LETT |codomainSize| 0)
                ...
                (SEQ (LETT |ri| NIL) (LETT #2# |retOpt|) G190
                     (COND
                      ((OR (ATOM #2#) (PROGN (LETT |ri| (CAR #2#)) NIL))
                       (GO G191)))
                     (SEQ (LETT |x| (SPADCALL |s| |ri| (QREFELT $ 81)))
                          (COND
                           ((EQL |x| 0)
                            (PROGN
                             (LETT #1# (CONS 1 "failed"))
...
(SDEFUN |FNGRPH;limit;$NniL;26| ((|s| $) (|a| |NonNegativeInteger|) ($ |Loop|))
        (SPROG
         ((|ptr| (|NonNegativeInteger|)) (#1=#:G604 NIL)
          (|lp| (|List| (|Loop|))) (#2=#:G605 NIL) (|s1| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ptr| |a|)
                (SEQ (LETT |s1| NIL) (LETT #2# (QCAR |s|)) G190
                     (COND
                      ((OR (ATOM #2#) (PROGN (LETT |s1| (CAR #2#)) NIL))
                       (GO G191)))
                     (SEQ (LETT |lp| (SPADCALL |s| |ptr| (QREFELT $ 85)))
                          (COND
...
(MAKEPROP '|FunctionGraph| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|List| 6)
              ...
              (|List| 95) (|Tree| 14) (|DirectedGraph| $) (|SingleInteger|)
           ...
           '#(~= 187 |unit| 193 |terminal| 199 |subdiagramSvg| 204
              ...
              |distanceMatrix| 477 |distance| 482 |diagramsSvg| 489
              |diagramWidth| 496 |diagramSvg| 501 |diagramHeight| 508
              |deepDiagramSvg| 513 |cycleOpen| 520 |cycleClosed| 526 |createY|
              532 |createX| 538 |createWidth| 544 |contraAdjoint| 549 |coerce|
              555 |coAdjoint| 560 |closedTensor| 566 |arrowsToNode| 573
              |arrowsToArrow| 579 |arrowsFromNode| 585 |arrowsFromArrow| 591
              |arrowName| 597 |apply| 604 |adjacencyMatrix| 610 |addObject!|
              615 |addArrow!| 627 = 658 + 664 * 670)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 99
                                            '(3 15 13 0 14 13 16 2 18 17 0 14
                                              ...
                                              1 0 0 6 48 4 0 89 91 0 27 27 1 2
                                              0 95 0 13 1 2 0 95 0 13 1 1 0 94
                                              0 1 1 0 94 0 1 3 0 15 0 13 13 1 3
                                              ...
                                              41 0 1 1 0 92 0 1 2 0 0 8 41 52 3
                                              0 27 0 13 13 1 1 0 27 0 1 2 0 27
                                              0 13 1 0 0 27 1 3 0 27 0 13 13 1
                                              1 0 27 0 1 0 0 0 47 1 0 92 0 1 2
                                              0 13 0 13 1 2 0 98 98 0 1 1 0 97
                                              0 1 1 0 18 0 44 2 0 13 0 6 1 1 0
                                              23 0 46 3 0 13 0 13 13 1 1 0 0 35
                                              36 2 0 0 18 23 24 1 0 0 8 9 1 0 0
                                              11 12 1 0 0 96 1 1 0 92 0 1 3 0
                                              14 0 13 13 1 3 0 89 41 90 27 1 1
                                              0 13 0 56 3 0 89 41 0 27 1 1 0 13
                                              0 57 3 0 89 41 0 27 1 2 0 0 8 41
                                              49 2 0 0 8 41 50 2 0 13 13 13 34
                                              2 0 13 13 13 33 1 0 13 13 1 2 0
                                              79 0 15 82 1 0 99 0 1 2 0 79 0 15
                                              80 3 0 0 0 0 66 67 2 0 15 0 13 1
                                              2 0 15 0 13 1 2 0 15 0 13 1 2 0
                                              15 0 13 1 3 0 41 0 13 13 1 2 0 13
                                              0 13 83 1 0 93 0 1 2 0 0 0 6 38 2
                                              0 0 0 17 39 4 0 0 0 41 6 6 1 4 0
                                              0 0 41 13 13 42 5 0 0 0 41 13 13
                                              15 1 2 0 0 0 22 1 2 0 27 0 0 1 2
                                              0 0 0 0 54 2 0 63 0 0 65)))))
           '|lookupComplete|)) 
