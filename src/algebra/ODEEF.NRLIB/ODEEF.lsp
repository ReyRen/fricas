        ...
        ((|leq| |List| (|Equation| F)) (|lop| |List| (|BasicOperator|))
         ...
         ($ |Union|
          (|Record| (|:| |particular| (|Vector| F))
                    (|:| |basis| (|List| (|Vector| F))))
          "failed"))
        (SPROG ((#1=#:G412 NIL) (|eq| NIL) (#2=#:G411 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
          ...
          (|u|
           (|Union|
            (|Record| (|:| |index| (|Integer|)) (|:| |row| (|Vector| F))
                      (|:| |rh| F))
            "failed"))
          (#2=#:G524 NIL) (|eq| NIL) (|lk1| (|List| (|Kernel| F)))
          (#3=#:G523 NIL) (|f| NIL) (#4=#:G522 NIL)
          (|lk0| (|List| (|Kernel| F))) (#5=#:G521 NIL) (#6=#:G520 NIL)
          (|lf| (|List| F)) (#7=#:G519 NIL) (|y| NIL) (#8=#:G518 NIL)
                  ...
                  (SEQ (LETT |eq| NIL) (LETT #2# |eqs|) G190
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((QEQCAR |u| 1)
                           (PROGN (LETT #1# (CONS 1 "failed")) (GO #9=#:G516)))
                          ('T
                           (SEQ (LETT |rec| (QCDR |u|))
...
(SDEFUN |ODEEF;parseSYSeq|
        ((|eq| F) (|l0| |List| (|Kernel| F)) (|l1| |List| (|Kernel| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|ci| (F)) (#1=#:G549 NIL) (|y| NIL) (|i| NIL) (|v| (|Vector| F))
          (|c| (F)) (|n| (|Integer|)) (|k| (|Kernel| F))
          (|l| (|List| (|Kernel| F))) (#2=#:G548 NIL) (#3=#:G547 NIL))
         (SEQ
          (LETT |l|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |ODEEF;parseODE|
        ...
        (SPROG
         ((|eqrhs| (F)) (|d| (F)) (|u| (|Union| F "failed")) (|k| (|Kernel| F))
          ...
          (#1=#:G574 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (#2=#:G557 NIL) (|m| (|NonNegativeInteger|)) (#3=#:G573 NIL))
         (SEQ
          (LETT |f|
          ...
          (LETT |diffeq|
                (SPADCALL |diffeq|
                          (SPADCALL |c| (SPADCALL |k| (QREFELT $ 72))
                                    (QREFELT $ 73))
                          (QREFELT $ 11)))
          (LETT |ny| (SPADCALL |y| (QREFELT $ 79))) (LETT |l| (CDR |l|))
          (EXIT
           (COND
...
(SDEFUN |ODEEF;parseLODE|
        ((|diffeq| F) (|l| |List| (|Kernel| F))
         ...
         ($ |Record| (|:| |left| (|SparseUnivariatePolynomial| F))
          (|:| |right| F)))
        (SPROG
         ((|d| (|Integer|)) (#1=#:G577 NIL) (|c| (F)) (#2=#:G582 NIL)
          (|k| NIL))
         (SEQ
          (COND
...
(SDEFUN |ODEEF;getfreelincoeff1|
        ...
        (SPROG ((#1=#:G589 NIL) (#2=#:G590 NIL) (|y| NIL) (|c| (F)))
               ...
               ((OR (QEQCAR |r| 1)
                    (SPADCALL
                     (SPADCALL
                      ...
                      (QREFELT $ 95))
                     1 (QREFELT $ 77)))
                (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G604))))))
            (EXIT
             (CONS 0
...
(DEFUN |ElementaryFunctionODESolver| (&REST #1=#:G607)
  (SPROG NIL
         (PROG (#2=#:G608)
           (RETURN
            (COND
