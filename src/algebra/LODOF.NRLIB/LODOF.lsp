...
(SDEFUN |LODOF;expsols|
        ((|l| |LinearOrdinaryDifferentialOperator1| (|Fraction| UP))
         ...
         ($ |List| (|Fraction| UP)))
        (SPROG
         ((|sol| (|List| (|Fraction| UP))) (#1=#:G410 NIL) (|f| NIL)
          (#2=#:G409 NIL))
         (SEQ
          (LETT |sol|
                (PROGN
           ...
           (SEQ (LETT |n| (SPADCALL |l| (QREFELT $ 36)))
                (EXIT
                 (COND ((SPADCALL |n| 1 (QREFELT $ 53)) (LIST |l|))
                       ('T
                        (SEQ (LETT |ll| (SPADCALL |l| (QREFELT $ 54)))
...
(SDEFUN |LODOF;zro|
        ...
        (SPROG ((#1=#:G475 NIL) (|r| NIL) (#2=#:G474 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |LinearOrdinaryDifferentialOperatorFactorizer| (&REST #1=#:G495)
  (SPROG NIL
         (PROG (#2=#:G496)
           (RETURN
            (COND
...
(MAKEPROP '|LinearOrdinaryDifferentialOperatorFactorizer| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|PositiveInteger|) (163 . *)
              (|Record| (|:| |factor| 7) (|:| |exponent| 35)) (|List| 58)
              (|Factored| 7) (169 . |factors|) (|List| $) (|List| 6)
              (174 . |concat|) (|SparseUnivariatePolynomial| 6) (|Mapping| 6 6)
