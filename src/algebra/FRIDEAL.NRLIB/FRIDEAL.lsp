...
(SDEFUN |FRIDEAL;agcd| ((|l| |List| A) ($ R))
        (SPROG ((#1=#:G412 NIL) (|a| NIL) (#2=#:G411 NIL))
               (SEQ
                (SPADCALL (ELT $ 39)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;oldnorm| ((|i| $) ($ F))
        (SPROG ((#1=#:G422 NIL) (|u| NIL) (#2=#:G421 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |FRIDEAL;norm;$F;11| ((|i| $) ($ F))
        (SPROG
         ((#1=#:G436 NIL) (|j| NIL) (#2=#:G435 NIL)
          (|dv| (|SingletonAsOrderedSet|))
          (|pp| (|SparseUnivariatePolynomial| A)) (#3=#:G434 NIL)
...
(SDEFUN |FRIDEAL;tryRange|
        ((|range| |NonNegativeInteger|) (|nm| |Vector| A) (|nrm| R) (|i| $)
         ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G448 NIL) (#3=#:G441 NIL) (|a| (A)) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FRIDEAL;summat| ((|i| $) ($ |Matrix| UP))
        (SPROG
         ((#1=#:G456 NIL) (|j| NIL) (#2=#:G455 NIL) (|m| (|Integer|))
          (|v| (|Vector| A)))
         (SEQ
          (LETT |m|
...
(SDEFUN |FRIDEAL;inv;2$;14| ((|i| $) ($ $))
        (SPROG
         ((#1=#:G592 NIL) (|j| NIL) (#2=#:G591 NIL)
          (|d| (|NonNegativeInteger|)) (#3=#:G590 NIL) (|p| NIL)
          (#4=#:G589 NIL) (|invd| (F))
          (|cd2| (|Record| (|:| |num| (|List| R)) (|:| |den| R)))
          (|cd| (|Record| (|:| |num| (|Matrix| UP)) (|:| |den| UP)))
          (|m| (|Matrix| (|Fraction| UP))) (#5=#:G464 NIL))
         (SEQ
          (LETT |m|
                (PROG2
                    (LETT #5#
...
(SDEFUN |FRIDEAL;ideal;V$;15| ((|v| |Vector| A) ($ $))
        (SPROG
         ((#1=#:G607 NIL) (|i| NIL) (#2=#:G606 NIL) (|d| (R)) (#3=#:G605 NIL)
          (#4=#:G604 NIL))
         (SEQ
          (LETT |d|
                (SPADCALL (ELT $ 112)
...
(SDEFUN |FRIDEAL;intIdeal| ((|l| |List| A) (|d| R) ($ $))
        (SPROG
         ((|va| (|Vector| A)) (#1=#:G622 NIL) (#2=#:G624 NIL) (|m| NIL)
          (#3=#:G623 NIL) (|invb| (F)) (|a| (A)) (|b| (R)) (|g| (R)) (|r| (R))
...
(SDEFUN |FRIDEAL;vgcd| ((|v| |Vector| F) ($ R))
        (SPROG ((#1=#:G628 NIL) (|i| NIL) (#2=#:G627 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;poly| ((|i| $) ($ |SparseUnivariatePolynomial| A))
        (SPROG
         ((#1=#:G630 NIL) (#2=#:G629 #3=(|SparseUnivariatePolynomial| A))
          (#4=#:G631 #3#) (#5=#:G634 NIL) (|m| (|Integer|)) (|v| (|Vector| A)))
         (SEQ
          (LETT |m|
                (SPADCALL (LETT |v| (SPADCALL |i| (QREFELT $ 15)))
                          (QREFELT $ 59)))
...
(SDEFUN |FRIDEAL;^;$I$;20| ((|i| $) (|m| |Integer|) ($ $))
        (SPROG
         ((#1=#:G642 NIL) (|j| NIL) (#2=#:G641 NIL) (|v| (|Vector| A))
          (|n| (|NonNegativeInteger|)) (#3=#:G637 NIL))
         (SEQ
          (COND
           ((< |m| 0)
...
(SDEFUN |FRIDEAL;num2O| ((|v| |Vector| A) ($ |OutputForm|))
        (SPROG ((#1=#:G646 NIL) (|i| NIL) (#2=#:G645 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;basis;$V;22| ((|i| $) ($ |Vector| A))
        (SPROG
         ((#1=#:G651 NIL) (#2=#:G653 NIL) (|j| NIL) (#3=#:G652 NIL) (|d| (F))
          (|v| (|Vector| A)))
         (SEQ (LETT |v| (SPADCALL |i| (QREFELT $ 15)))
              (LETT |d|
                    (SPADCALL
...
(SDEFUN |FRIDEAL;randomLC;NniVA;24|
        ...
        (SPROG
         ((#1=#:G658 NIL) (#2=#:G657 (A)) (#3=#:G659 (A)) (#4=#:G661 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;randomLC;NniVA;25|
        ((|m| |NonNegativeInteger|) (|v| |Vector| A) ($ A))
        (SPROG
         ((#1=#:G663 NIL) (#2=#:G662 (A)) (#3=#:G664 (A)) (#4=#:G666 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;minimize;2$;26| ((|i| $) ($ $))
        (SPROG
         ((#1=#:G675 NIL) (#2=#:G676 NIL) (|u| (|Union| $ "failed"))
...
(DEFUN |FractionalIdeal| (&REST #1=#:G677)
  (SPROG NIL
         (PROG (#2=#:G678)
           (RETURN
            (COND
