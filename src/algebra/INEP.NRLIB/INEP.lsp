...
(SDEFUN |INEP;evalvect|
        ((|vect| |Matrix| (|SparseUnivariatePolynomial| K)) (|alg| F)
         ($ |Matrix| F))
        (SPROG
         ((|v| (F)) (|polf| (|SparseUnivariatePolynomial| F)) (#1=#:G403 NIL)
...
(SDEFUN |INEP;inteigen|
        ...
        (SPROG
         ((|res|
          ...
          (#1=#:G450 NIL) (|i| NIL)
          (|wk| (|Matrix| (|SparseUnivariatePolynomial| K))) (#2=#:G449 NIL)
          (|vec| NIL) (|sln2| (|List| (|Vector| MM))) (#3=#:G448 NIL) (|j| NIL)
          (#4=#:G447 NIL) (B (AM)) (|alg| (MM))
          (|ppol| (|SparseUnivariatePolynomial| K))
          (|lr| (|List| (|Matrix| F))) (#5=#:G446 NIL) (|wf| (|Matrix| F))
          (#6=#:G445 NIL) (|vecr| NIL) (#7=#:G444 NIL) (#8=#:G443 NIL)
          (B1 (|Matrix| K)) (|alpha| (K))
          (|pol| #9=(|SparseUnivariatePolynomial| K)) (#10=#:G442 NIL)
          (|ff| NIL)
          (|lff|
           (|List|
...
(SDEFUN |INEP;solve1;SupParL;8|
        ...
        (SPROG
         ((|upi| (|SparseUnivariatePolynomial| (|Integer|)))
          (|denom| #1=(|Integer|)) (#2=#:G452 NIL) (#3=#:G451 #1#)
          (#4=#:G453 #1#) (#5=#:G457 NIL) (|c| NIL))
         (SEQ
          (LETT |denom|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INEP;solve1;SupParL;9|
        ...
        (SPROG
         ((|upgi| (|SparseUnivariatePolynomial| (|Complex| (|Integer|))))
          (|denom| #1=(|Integer|)) (#2=#:G459 NIL) (#3=#:G458 #1#)
          (#4=#:G460 #1#) (#5=#:G464 NIL) (|c| NIL))
         (SEQ
          (LETT |denom|
                (PROGN
                 (LETT #2# NIL)
        ...
        (SPROG
         ((|sln|
          ...
          (|nsl|
           (|Record| (|:| |outval| F) (|:| |outmult| (|Integer|))
                     (|:| |outvect| (|List| (|Matrix| F)))))
          (#1=#:G479 NIL) (|ep| NIL) (#2=#:G478 NIL) (#3=#:G477 NIL)
          ...
          (|leva|
           (|Record| (|:| |algpol| (|SparseUnivariatePolynomial| K))
                     ...
                     (|:| |poleigen|
                          (|List|
                           (|Matrix| (|SparseUnivariatePolynomial| K))))))
          (#4=#:G476 NIL) (|lev| NIL) (|n| (|NonNegativeInteger|))
          (|sln1|
           (|List|
            (|Union|
             (|Record| (|:| |outval| F) (|:| |outmult| (|Integer|))
...
(SDEFUN |INEP;charpol;MSup;11|
        ...
        (SPROG
         ((#1=#:G487 NIL) (|j| NIL) (#2=#:G486 NIL) (|i| NIL)
...
(DEFUN |InnerNumericEigenPackage| (&REST #1=#:G488)
  (SPROG NIL
         (PROG (#2=#:G489)
           (RETURN
            (COND
