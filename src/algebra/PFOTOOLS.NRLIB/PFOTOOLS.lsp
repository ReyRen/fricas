...
(SDEFUN |PFOTOOLS;mix;LI;1|
        ((|l| |List|
         ...
         ($ |Integer|))
        (SPROG
         ((#1=#:G391 NIL) (|p| NIL) (#2=#:G390 NIL) (#3=#:G389 NIL)
          (#4=#:G388 NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |PFOTOOLS;badNum;UPUPI;2| ((|p| UPUP) ($ |Integer|))
        (SPROG ((#1=#:G396 NIL) (|c| NIL) (#2=#:G395 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |PFOTOOLS;polyred;2UPUP;3| ((|r| UPUP) ($ UPUP))
        (SPROG
         ((|ld| (|List| (|Integer|))) (#1=#:G401 NIL) (|c| NIL)
          (#2=#:G400 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
...
(SDEFUN |PFOTOOLS;getGoodPrime;IPi;5| ((|n| |Integer|) ($ |PositiveInteger|))
        (SPROG ((|p| (|PositiveInteger|)) (#1=#:G409 NIL))
               (SEQ (LETT |p| 3)
...
(DEFUN |PointsOfFiniteOrderTools| (&REST #1=#:G418)
  (SPROG NIL
         (PROG (#2=#:G419)
           (RETURN
            (COND
