...
(SDEFUN |RDETRS;SPDEsys|
        ((|a| UP) (|b| UP) (|h| UP) (|c1| UP) (|c2| UP) (|n| |Integer|)
         ...
         ($ |Union| (|List| UP) #1#))
        (SPROG
         ((#2=#:G490 NIL) (|rh| #3=(|Union| F "failed")) (|rb| #3#) (|ra| (F))
          ...
          (|u|
           (|Union|
            (|Record| (|:| |z1| UP) (|:| |z2| UP) (|:| |r1| UP) (|:| |r2| UP))
            "failed"))
          (|da| (|NonNegativeInteger|)) (#4=#:G461 NIL) (#5=#:G491 NIL)
                     ...
                     (EXIT
                      (COND
                       ...
                       (#8#
                        (SEQ
                         (EXIT
                          (SEQ (LETT |ra| (SPADCALL |a| (QREFELT $ 56)))
                               (SEQ (LETT |rb| (SPADCALL |b| (QREFELT $ 58)))
                                    (EXIT
                                     (COND
                                      ((QEQCAR |rb| 1)
                                       (PROGN
...
(SDEFUN |RDETRS;DSPDEsys|
        ...
        (SPROG
         ...
         (SEQ (LETT |bb| (SPADCALL |b| (QREFELT $ 54)))
              ...
              (LETT |lb| (SPADCALL |b| (QREFELT $ 59)))
              (LETT |lh| (SPADCALL |h| (QREFELT $ 59)))
              (EXIT
               (COND
                ((< |bb| |hh|)
...
(SDEFUN |RDETRS;DSPDEsys0|
        ...
        (SPROG
         ((|ans2| (UP)) (|ans1| (UP)) (|q2| (UP)) (|q1| (UP))
          (|lq| (|List| UP)) (#3=#:G516 NIL) (#4=#:G517 NIL) (|u| #1#)
          (#5=#:G510 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |RDETRS;DSPDEhdom|
        ...
        (SPROG
         ((|q2| (UP)) (#1=#:G537 NIL) (|d2| #2=(|Integer|)) (|q1| (UP))
          (|d1| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RDETRS;DSPDEbdom|
        ((|c1| UP) (|c2| UP) (|lb| F) (|lh| F) (|n| |NonNegativeInteger|)
         (|d| |Integer|) ($ |Union| (|List| UP) "failed"))
        (SPROG
         ((|q2| (UP)) (#1=#:G547 NIL) (|d1| #2=(|Integer|)) (|q1| (UP))
          (|d2| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |TranscendentalRischDESystem| (&REST #1=#:G558)
  (SPROG NIL
         (PROG (#2=#:G559)
           (RETURN
            (COND
