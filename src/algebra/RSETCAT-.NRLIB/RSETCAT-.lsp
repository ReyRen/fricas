...
(SDEFUN |RSETCAT-;purelyAlgebraic?;SB;5| ((|ts| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G461 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G450 NIL)
          (|v| (V)) (#3=#:G462 NIL) (|p| NIL) (|lp| (|List| P)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |RSETCAT-;intersect;L2L;13|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| S))))
          (#1=#:G533 NIL) (|us| NIL) (#2=#:G532 NIL) (|lus| (|List| S))
          (|p| (P)) (|toSave| (|List| S)) (|ts| (S))
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| S)))
          (#3=#:G531 NIL) (#4=#:G530 NIL) (#5=#:G529 NIL) (#6=#:G528 NIL))
         (SEQ
