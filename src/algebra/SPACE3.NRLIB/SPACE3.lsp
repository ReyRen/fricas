...
(SDEFUN |SPACE3;convertSpace| ((|space| $) ($ $))
        (SPROG
         ((|lllipt| (|List| (|List| (|List| (|NonNegativeInteger|)))))
          ...
          (|tmplipt| (|List| (|NonNegativeInteger|))) (#1=#:G426 NIL)
          (|point| NIL) (|tmplprop| (|List| (|SubSpaceComponentProperty|)))
          (#2=#:G425 NIL) (|curve| NIL)
          (|lprop| (|List| (|SubSpaceComponentProperty|))) (#3=#:G424 NIL)
          (|component| NIL))
         (SEQ
...
(SDEFUN |SPACE3;polygon;$L$;2|
        ...
        (SPROG ((#1=#:G431 NIL) (|p| NIL) (|pt| (|SubSpace| 3 R)))
               (SEQ
                (COND
                 ((< (LENGTH |points|) 3)
...
(SDEFUN |SPACE3;merge;L$;7| ((|listOfThreeSpaces| |List| $) ($ $))
        (SPROG
         ((#1=#:G446 NIL) (|ts| NIL) (|newspace| ($)) (#2=#:G445 NIL)
          (#3=#:G444 NIL))
         (SEQ
          (LETT |newspace|
                (SPADCALL
...
(SDEFUN |SPACE3;composite;L$;9| ((|listOfThreeSpaces| |List| $) ($ $))
        (SPROG ((#1=#:G452 NIL) (|s| NIL) (#2=#:G451 NIL) (|space| ($)))
...
(SDEFUN |SPACE3;components;$L;10| ((|space| $) ($ |List| $))
        (SPROG ((#1=#:G456 NIL) (|s| NIL) (#2=#:G455 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |s| NIL)
...
(SDEFUN |SPACE3;composites;$L;11| ((|space| $) ($ |List| $))
        (SPROG ((#1=#:G460 NIL) (|s| NIL) (#2=#:G459 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SPACE3;copy;2$;12| ((|space| $) ($ $))
        (SPROG ((#1=#:G465 NIL) (|s| NIL) (#2=#:G464 NIL) (|spc| ($)))
               (SEQ
                (LETT |spc|
...
(SDEFUN |SPACE3;point;$L$;19| ((|space| $) (|l| |List| R) ($ $))
        (SPROG ((|pt| (|Point| R)))
               (SEQ (LETT |pt| (SPADCALL |l| (QREFELT $ 53)))
...
(SDEFUN |SPACE3;curve;$L;22| ((|space| $) ($ |List| (|Point| R)))
        (SPROG
         ((#1=#:G493 NIL) (|s| NIL) (#2=#:G492 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;curve;$L$;24| ((|space| $) (|points| |List| (|Point| R)) ($ $))
        (SPROG
         ((#1=#:G498 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
...
(SDEFUN |SPACE3;curve;$L$;25| ((|space| $) (|points| |List| (|List| R)) ($ $))
        (SPROG ((|pts| (|List| (|Point| R))))
               (SEQ (LETT |pts| (SPADCALL (ELT $ 53) |points| (QREFELT $ 64)))
...
(SDEFUN |SPACE3;closedCurve;$L;27| ((|space| $) ($ |List| (|Point| R)))
        (SPROG
         ((#1=#:G512 NIL) (|s| NIL) (#2=#:G511 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;closedCurve;$L$;29|
        ((|space| $) (|points| |List| (|Point| R)) ($ $))
        (SPROG
         ((#1=#:G517 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
          (SPADCALL (QVELT |space| 0) NIL (|SPADfirst| |points|)
                    (QREFELT $ 51))
          (LETT |path|
...
(SDEFUN |SPACE3;mesh?;$B;35| ((|space| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G544 NIL) (|eachCurve| NIL)
          (|whatSizes| (|Set| (|NonNegativeInteger|)))
          (|kid| #2=(|List| (|SubSpace| 3 R))) (|c| #2#))
         (SEQ
          (COND
           ((SPADCALL
             (LENGTH (LETT |c| (SPADCALL (QVELT |space| 0) (QREFELT $ 10)))) 1
             (QREFELT $ 43))
            (|error| "This ThreeSpace has more than one component"))
           ((SPADCALL
             (LENGTH (LETT |kid| (SPADCALL (|SPADfirst| |c|) (QREFELT $ 10))))
             1 (QREFELT $ 43))
            (SEQ (LETT |whatSizes| (SPADCALL (QREFELT $ 79)))
...
(SDEFUN |SPACE3;mesh;$L;36| ((|space| $) ($ |List| (|List| (|Point| R))))
        (SPROG
         ((|llp| (|List| (|List| (|Point| R)))) (#1=#:G552 NIL) (|s| NIL)
          (#2=#:G551 NIL) (#3=#:G550 NIL) (|lpSpace| NIL))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;mesh;$LLSscp$;39|
        ((|space| $) (|llpoints| |List| (|List| (|List| R)))
         ...
         ($ $))
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G561 NIL) (|points| NIL)
          (#3=#:G560 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;$LLSscp$;40|
        ((|space| $) (|llp| |List| (|List| (|Point| R)))
         ...
         ($ $))
        (SPROG
         ((#2=#:G571 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G569 NIL) (|lp| NIL) (#4=#:G570 NIL) (|aProp| NIL)
          (|count| NIL) (#5=#:G568 NIL))
         (SEQ
                    ...
                    (LETT |path|
                          (LIST
                           (LENGTH
                            (SPADCALL (QVELT |space| 0) (QREFELT $ 10)))))
                    |prop| (QREFELT $ 93))
          (LETT |path| (SPADCALL |path| (LIST 1) (QREFELT $ 94)))
...
(SDEFUN |SPACE3;mesh;$L2B$;41|
        ...
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G578 NIL) (|points| NIL)
          (#3=#:G577 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;$L2B$;42|
        ((|space| $) (|llp| |List| (|List| (|Point| R)))
         (|prop1| . #1=(|Boolean|)) (|prop2| . #1#) ($ $))
        (SPROG
         ((#2=#:G587 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G586 NIL) (|lp| NIL) (|count| NIL) (#4=#:G585 NIL)
          (|propB| #5=(|SubSpaceComponentProperty|)) (|propA| #5#))
         (SEQ (LETT |propA| (SPADCALL (QREFELT $ 96)))
              (SPADCALL |propA| |prop1| (QREFELT $ 97))
              (LETT |propB| (SPADCALL (QREFELT $ 96)))
              ...
              (SEQ (LETT |p| NIL) (LETT #4# (CDR (|SPADfirst| |llp|))) G190
                   ...
                   (SEQ
                    (EXIT
                     (SPADCALL (QVELT |space| 0) |path| |p| (QREFELT $ 51))))
              ...
              (SEQ (LETT |count| 2) (LETT |lp| NIL) (LETT #3# (CDR |llp|)) G190
                   ...
                   (SEQ
                    (SPADCALL (QVELT |space| 0)
                              ...
                              (|SPADfirst| |lp|) (QREFELT $ 51))
                    (LETT |path|
                          (SPADCALL |path| (LIST |count|) (QREFELT $ 94)))
                    (SPADCALL (QVELT |space| 0) |path| |propA| (QREFELT $ 93))
                    (EXIT
                     (SEQ (LETT |p| NIL) (LETT #2# (CDR |lp|)) G190
                          (COND
