...
(SDEFUN |OREMAT;rowEchelon;MFLR;2|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ($ |Record| (|:| |mat| (|Matrix| LO))
          (|:| |vecs| (|List| (|Vector| F)))))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G434 NIL) (|w| NIL) (#2=#:G433 NIL)
          (|k1| NIL) (|r| (LO)) (|q| (LO))
          (|#G18| (|Record| (|:| |quotient| LO) (|:| |remainder| LO)))
          (|mkj| (LO)) (#3=#:G432 NIL) (|k| NIL) (|elf2| (F)) (|elf1| (F))
          (#4=#:G431 NIL) (|el2| (LO)) (|el1| (LO)) (#5=#:G430 NIL) (|v| (LO))
          (|u| (LO)) (|d| (LO)) (|c| (LO)) (|mij| (LO))
          (|#G14|
           (|Record| (|:| |generator| LO) (|:| |coef1| LO) (|:| |coef2| LO)
                     (|:| |coefu| LO) (|:| |coefv| LO)))
          (#6=#:G429 NIL) (#7=#:G428 NIL) (|mm| (|Matrix| LO))
          (|dpiv| (|Integer|)) (|pivk| (|Integer|))
          (|dp1| (|NonNegativeInteger|)) (#8=#:G427 NIL) (#9=#:G422 NIL)
          (#10=#:G426 NIL) (|j| NIL) (#11=#:G425 NIL)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|))
          (|lw| (|List| (|Vector| F))) (#12=#:G424 NIL) (|vv| NIL)
          (#13=#:G423 NIL))
                     ...
                     (SEQ
                      (COND
                       ((SPADCALL |i| |nr| (QREFELT $ 22))
                        (PROGN (LETT #9# |$NoValue|) (GO #14=#:G419))))
...
(SDEFUN |OREMAT;triangular_solve|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#4=#:G513 NIL) (|ba| NIL) (#5=#:G514 NIL) (|bv| #6=(|Vector| F))
          (#7=#:G512 NIL) (|bvl| (|List| (|Vector| F))) (|cba| (|List| #6#))
          (|cb| (|List| #6#)) (|ncba| (|List| (|Vector| F)))
          (|na| (|Vector| F)) (|ncb| (|List| (|Vector| F))) (#8=#:G511 NIL)
          (|k| NIL) (|nbcv2| #6#) (#9=#:G510 NIL) (|nbcv1| #6#)
          (#10=#:G508 NIL) (|j| NIL) (#11=#:G509 NIL) (|slj| NIL)
          (|nsl2| (|List| F)) (|nbvl| (|List| (|Vector| F))) (#12=#:G507 NIL)
          (|nbcv| #6#) (#13=#:G479 NIL) (#14=#:G478 NIL)
          (|nrl1| (|NonNegativeInteger|)) (#15=#:G506 NIL) (#16=#:G505 NIL)
          (|ss| (F)) (#17=#:G504 NIL) (|slk| NIL) (#18=#:G503 NIL)
          (|noff| (|NonNegativeInteger|)) (|cm2| (|Matrix| F))
          (|cm1| (|Matrix| F)) (#19=#:G502 NIL) (|ncv| NIL) (#20=#:G501 NIL)
          (|nsl1| (|List| F)) (#21=#:G500 NIL) (|pr| NIL) (#22=#:G499 NIL)
          (|ncvl| (|List| #3#)) (#23=#:G498 NIL) (#24=#:G497 NIL)
          (|nrl| (|NonNegativeInteger|)) (|prl| #2#) (#25=#:G496 NIL)
          (|be| NIL) (|resi| #1#) (|lvi| (|List| F)) (|lvi2| (|List| F))
          (|vvi| (F)) (#26=#:G495 NIL) (#27=#:G493 NIL) (#28=#:G494 NIL)
          (|lvi1| (|List| F)) (#29=#:G492 NIL) (#30=#:G491 NIL)
          (|nbas| #31=(|NonNegativeInteger|)) (|nlvi| (|NonNegativeInteger|))
          (#32=#:G490 NIL) (#33=#:G489 NIL) (|lvi0| (|List| F))
          (#34=#:G488 NIL) (|v| NIL) (#35=#:G487 NIL) (#36=#:G480 NIL)
          (|i| NIL) (#37=#:G485 NIL) (#38=#:G486 NIL) (#39=#:G484 NIL)
          (#40=#:G483 NIL) (#41=#:G482 NIL) (#42=#:G481 NIL) (|n| #31#)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(DEFUN |OrePolynomialMatrixOperations| (&REST #1=#:G529)
  (SPROG NIL
         (PROG (#2=#:G530)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 69
                                            '(0 6 0 8 0 7 0 9 1 11 0 0 15 1 16
                                              0 0 17 2 19 18 0 0 20 2 21 18 0 0
                                              22 0 6 0 23 0 7 0 24 3 11 7 0 21
                                              21 25 1 7 18 0 26 1 7 19 0 27 3
                                              11 0 0 21 21 28 3 16 29 0 21 21
                                              30 2 7 31 0 0 32 2 7 0 0 0 33 2 7
                                              0 0 0 34 3 7 6 0 6 6 35 2 6 0 0 0
                                              36 2 7 37 0 0 38 2 7 0 0 0 39 2 6
                                              0 0 0 40 2 19 18 0 0 41 3 16 6 0
                                              21 6 42 2 7 18 0 0 43 2 16 6 0 21
                                              44 2 46 6 16 45 47 2 45 0 0 0 48
                                              2 12 0 0 0 49 1 16 45 0 50 1 52 0
                                              51 53 2 11 0 19 7 54 2 52 0 19 6
                                              55 2 52 0 0 0 56 1 52 0 0 57 3 52
                                              6 0 21 21 58 2 6 0 0 0 59 2 6 18
                                              0 0 60 2 46 16 16 12 61 3 46 16
                                              16 16 12 62 4 0 65 11 6 12 68 69
                                              1 0 11 11 14 3 0 10 11 6 12
                                              13)))))
           '|lookupComplete|)) 
