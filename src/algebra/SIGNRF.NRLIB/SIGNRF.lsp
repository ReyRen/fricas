...
(SDEFUN |SIGNRF;psign| ((|p| |Polynomial| R) ($ |Union| (|Integer|) "failed"))
        (SPROG
         ((|ans| (|Integer|)) (#1=#:G432 NIL)
          (|u| (|Union| (|Integer|) "failed")) (#2=#:G433 NIL) (|term| NIL)
...
(SDEFUN |SIGNRF;listSign|
        ...
        (SPROG
         ((#2=#:G447 NIL) (#3=#:G448 NIL) (|u| (|Union| (|Integer|) #1#))
          (#4=#:G449 NIL) (|term| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |term| NIL) (LETT #4# |l|) G190
                 ...
                 (SEQ (LETT |u| (|SIGNRF;termSign| |term| $))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #3# (CONS 1 "failed")) (GO #5=#:G446)))
                        ('T
                         (SEQ
                          (EXIT
                           (COND
...
(SDEFUN |SIGNRF;termSign|
        ...
        (SPROG ((#1=#:G457 NIL) (#2=#:G458 NIL) (#3=#:G459 NIL) (|var| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |RationalFunctionSign| (#1=#:G460)
  (SPROG NIL
         (PROG (#2=#:G461)
           (RETURN
            (COND
