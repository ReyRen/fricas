...
(SDEFUN |MHROWRED;non0|
        ((|v| |Vector| R) (|rown| |Integer|)
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#2=#:G415 NIL) (|ans| #1#) (|allZero| (|Boolean|)) (#3=#:G416 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |allZero| 'T)
...
(SDEFUN |MHROWRED;mkMat|
        ...
        (SPROG
         ((|ll| (|List| (|List| R))) (#1=#:G434 NIL) (|i| NIL) (#2=#:G433 NIL))
         (SEQ
          (COND
           ((NULL
             (LETT |ll|
...
(SDEFUN |MHROWRED;diagSubMatrix|
        ((|x| |Matrix| R)
         ($ |Union| (|Record| (|:| |val| R) (|:| |mat| (|Matrix| R)))
          "failed"))
        (SPROG
         ((#1=#:G483 NIL) (#2=#:G484 NIL) (#3=#:G495 NIL) (|r| NIL)
          (#4=#:G494 NIL) (#5=#:G493 NIL) (|z| NIL) (#6=#:G492 NIL)
          (#7=#:G491 NIL) (#8=#:G490 NIL) (#9=#:G487 NIL) (#10=#:G489 NIL)
          (#11=#:G488 NIL) (|a| NIL)
          (|l|
           (|List|
...
(SDEFUN |MHROWRED;determinantOfMinor| ((|x| |Matrix| R) ($ R))
        (SPROG
         ((#1=#:G504 NIL) (#2=#:G505 NIL) (|j| (|Integer|)) (|d| (R))
          (#3=#:G510 NIL) (|n| (|Integer|)) (|i| NIL)
          (|lr| (|List| (|Integer|))) (#4=#:G509 NIL) (#5=#:G508 NIL)
          (|lc| (|List| (|Integer|))) (#6=#:G507 NIL) (#7=#:G506 NIL)
...
(SDEFUN |MHROWRED;enumerateBinomial|
        ((|l| |List| (|Integer|)) (|m| |Integer|) (|i| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((#1=#:G516 NIL) (|b| (|Integer|)) (#2=#:G517 NIL) (|n| (|Integer|))
          (|j| NIL) (|m1| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |MHROWRED;order| ((|m| R) (|p| R) ($ |Integer|))
        (SPROG ((#1=#:G534 NIL) (|mm| (|Union| R "failed")) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |MHROWRED;rowEchelonLocal;M2RM;13|
        ...
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G585 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G584 NIL) (|k| NIL) (|v2| (R)) (#4=#:G583 NIL) (|q| (R))
          (#5=#:G560 NIL) (#6=#:G582 NIL) (#7=#:G581 NIL) (|pivot| (R))
          (|d| (R)) (|b| (R)) (|a| (R))
          (|#G79|
           (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (|x| (|Matrix| R)) (#8=#:G577 NIL) (|pivord| #9=(|Integer|))
          (|rown| (|Integer|)) (|npivord| #9#) (#10=#:G580 NIL)
          (#11=#:G578 NIL) (#12=#:G579 NIL) (|j| NIL) (|minr| #1#)
          (|ncols| (|Integer|)) (|nrows| (|Integer|)) (#13=#:G551 NIL))
         (SEQ
          (LETT |m|
                (SPADCALL |p|
                 ...
                 (SEQ
                  (COND
                   ((SPADCALL |i| |nrows| (QREFELT $ 64))
                    (PROGN (LETT #11# |$NoValue|) (GO #14=#:G574))))
                  (LETT |rown| (- |minr| 1))
...
(SDEFUN |MHROWRED;rowEchelon1| ((|y| |Matrix| R) (|m| R) ($ |Matrix| R))
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G624 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G623 NIL) (|k| NIL) (|xij| (R)) (#4=#:G622 NIL) (|jj| NIL)
          (|un|
           (|Record| (|:| |unit| R) (|:| |canonical| R) (|:| |associate| R)))
          (|v2| (R)) (|v1| (R)) (#5=#:G621 NIL) (|a1| (R)) (|b1| (R))
          (|#G98| (R)) (#6=#:G597 NIL) (|#G97| (R)) (|d| (R)) (|b| (R))
          (|a| (R))
          (|#G96|
           (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (#7=#:G620 NIL) (|x| (|Matrix| R)) (|rown| (|Integer|))
          (#8=#:G619 NIL) (#9=#:G617 NIL) (#10=#:G618 NIL) (|j| NIL)
               ...
               (EXIT
                (SEQ (LETT |j| (PROGN |x| 1)) (LETT #10# |ncols|) G190
                     ...
                     (SEQ
                      (COND
                       ((SPADCALL |i| |nrows| (QREFELT $ 64))
                        (PROGN (LETT #9# |$NoValue|) (GO #11=#:G614))))
                      (LETT |rown| (- |minr| 1))
...
(DEFUN |ModularHermitianRowReduction| (#1=#:G625)
  (SPROG NIL
         (PROG (#2=#:G626)
           (RETURN
            (COND
