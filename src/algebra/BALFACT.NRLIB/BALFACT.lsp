...
(SDEFUN |BALFACT;balSqfr1|
        ...
        (SPROG ((#1=#:G387 NIL) (|fa| (|Factored| UP)) (|g| (UP)))
...
(SDEFUN |BALFACT;balSqfr|
        ...
        (SPROG
         ((#1=#:G393 NIL) (#2=#:G392 #3=(|Factored| UP)) (#4=#:G394 #3#)
          (#5=#:G397 NIL) (|f| NIL) (|b| (UP)))
...
(SDEFUN |BALFACT;balancedFactorisation;UPLF;4|
        ...
        (SPROG
         ((#1=#:G401 NIL) (#2=#:G400 #3=(|Factored| UP)) (#4=#:G402 #3#)
          (#5=#:G406 NIL) (|f| NIL) (|sa| (|Factored| UP)) (|ll| (|List| UP)))
         (SEQ
          (COND
           ((NULL
             (LETT |ll|
...
(DEFUN |BalancedFactorisation| (&REST #1=#:G407)
  (SPROG NIL
         (PROG (#2=#:G408)
           (RETURN
            (COND
