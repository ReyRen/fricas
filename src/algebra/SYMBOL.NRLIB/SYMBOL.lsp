...
(SDEFUN |SYMBOL;coerce;$Of;9| ((|x| $) ($ |OutputForm|))
        (SPROG
         ((|a| (|List| (|OutputForm|))) (|x0| (|OutputForm|))
          (|sl| (|List| (|OutputForm|))) (|se| (|OutputForm|)) (#1=#:G2236 NIL)
         ...
         (SEQ
          (COND
           ...
           ('T
            (SEQ (LETT |ss| (SPADCALL |x| (QREFELT $ 45)))
                 (LETT |rsl|
         ...
         ((|s| (|String|)) (|sc| (|String|)) (|lo| (|List| (|OutputForm|)))
          (|ss|
           (|Record| (|:| |sub| (|List| (|OutputForm|)))
                     ...
                     (|:| |presub| (|List| (|OutputForm|)))
                     (|:| |args| (|List| (|OutputForm|))))))
         (SEQ (LETT |s| (PNAME (SPADCALL |e| (QREFELT $ 48))))
              (COND
...
(SDEFUN |SYMBOL;scripts;$R;31|
        ((|sy| $)
         ($ |Record| (|:| |sub| (|List| (|OutputForm|)))
          ...
          (|:| |args| (|List| (|OutputForm|)))))
        (SPROG
         ((|allscripts| (|List| (|OutputForm|))) (|i| NIL) (#1=#:G2348 NIL)
          (|n| NIL) (|m| (|Integer|))
          (|nscripts| (|List| (|NonNegativeInteger|))) (#2=#:G2340 NIL)
          (#3=#:G2347 NIL) (|j| NIL) (|nstr| (|NonNegativeInteger|))
          ...
          (COND
           ...
           ('T
            (SEQ (LETT |nscripts| (LIST 0 0 0 0 0))
                 ...
                 (LETT |m| (SPADCALL |nscripts| (QREFELT $ 106)))
                 ...
                 (LETT |m| (SPADCALL |lscripts| (QREFELT $ 109)))
