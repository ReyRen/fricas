...
(SDEFUN |SYMTAB;externalList;$L;9| ((|tab| $) ($ |List| (|Symbol|)))
        (SPROG ((#1=#:G406 NIL) (|u| NIL) (#2=#:G405 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SYMTAB;typeList;Fst$L;10|
        ...
        (SPROG
         ((|arrayList|
          ...
          (#1=#:G424 NIL) (|v| NIL) (#2=#:G423 NIL)
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G422 NIL) (|u| NIL))
        ...
        (SPROG
         ((|tl|
          ...
          (|uDim|
           (|List|
            (|Union| (|:| S (|Symbol|)) (|:| P (|Polynomial| (|Integer|))))))
          (#1=#:G441 NIL) (|v| NIL) (#2=#:G440 NIL)
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G439 NIL) (|u| NIL)
          (|symbolType| (|Symbol|)))
         (SEQ (LETT |tl| NIL)
...
(SDEFUN |SYMTAB;newTypeLists;$Se;13| ((|tab| $) ($ |SExpression|))
        (SPROG
         ((|tl| (|SExpression|)) (|lType| (|SExpression|))
          (|lDims| (|List| (|SExpression|))) (#1=#:G455 NIL) (|v| NIL)
          (#2=#:G454 NIL) (|dims| (|List| (|Polynomial| (|Integer|))))
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G453 NIL) (|u| NIL))
...
(SDEFUN |SYMTAB;oForm|
        ((|v| |Union| (|:| |name| (|Symbol|))
         ...
         ($ |OutputForm|))
        (SPROG
         ((|ll| (|List| (|OutputForm|))) (#1=#:G468 NIL) (#2=#:G428 NIL)
          (|uu| NIL) (#3=#:G467 NIL))
         (SEQ
                   ...
                   (|:| |bounds|
                        (|List|
                         (|Union| (|:| S (|Symbol|))
                                  (|:| P (|Polynomial| (|Integer|))))))))
         ($ |List| (|OutputForm|)))
        (SPROG ((#1=#:G472 NIL) (|u| NIL) (#2=#:G471 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SYMTAB;printTypes;$V;18| ((|tab| $) ($ |Void|))
        (SPROG
         ((|el| (|List| (|OutputForm|))) (#1=#:G480 NIL) (|u| NIL)
          (#2=#:G479 NIL) (|otl| (|List| (|OutputForm|)))
          (|tl|
           (|List|
            (|Union| (|:| |name| (|Symbol|))
                     (|:| |bounds|
                          (|List|
                           (|Union| (|:| S (|Symbol|))
                                    (|:| P (|Polynomial| (|Integer|)))))))))
          (#3=#:G478 NIL) (|ty| NIL) (|ft| (|List| (|FortranScalarType|))))
         (SEQ
          (LETT |ft|
