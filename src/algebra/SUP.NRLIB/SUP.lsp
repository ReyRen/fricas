...
(SDEFUN |SUP;^;$Nni$;4| ((|p| $) (|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|rn| #1=(|NonNegativeInteger|)) (|qn| #2=(|NonNegativeInteger|))
          ...
          (#3=#:G437 NIL) (|t| NIL) (#4=#:G436 NIL) (#5=#:G435 NIL) (|y| ($))
          (|cc| (R)))
         (SEQ
          (EXIT
...
(SDEFUN |SUP;multiplyExponents;$Nni$;8|
        ...
        (SPROG ((#1=#:G452 NIL) (|u| NIL) (#2=#:G451 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SUP;karatsubaDivide;$NniR;10|
        ...
        (SPROG
         ((|highp| (|Rep|)) (#1=#:G471 NIL) (|lowp| (|Rep|)) (#2=#:G479 NIL)
                       ...
                       (EXIT
                        (SEQ G190 NIL
                             (SEQ
                              (COND
                               ((NULL |lowp|)
                                (PROGN (LETT #2# |$NoValue|) (GO #3=#:G474))))
...
(SDEFUN |SUP;shiftRight;$Nni$;11| ((|p| $) (|n| |NonNegativeInteger|) ($ $))
        (SPROG ((#1=#:G482 NIL) (#2=#:G487 NIL) (|t| NIL) (#3=#:G486 NIL))
               (SEQ
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |SUP;shiftLeft;$Nni$;12| ((|p| $) (|n| |NonNegativeInteger|) ($ $))
        (SPROG ((#1=#:G492 NIL) (|t| NIL) (#2=#:G491 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
        ...
        (SPROG ((|lc| ($)))
               (SEQ
                (COND ((SPADCALL |supp| (QREFELT $ 56)) (|spadConstant| $ 16))
                      (#1='T
                       (SEQ (LETT |lc| (SPADCALL |supp| (QREFELT $ 57)))
                            (EXIT
                             (COND
...
(SDEFUN |SUP;outputForm;$2Of;24| ((|p| $) (|v| |OutputForm|) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (#1=#:G534 NIL) (|t| NIL)
          (#2=#:G533 NIL))
         (SEQ
          (LETT |l|
                (PROGN
...
(SDEFUN |SUP;elt;$2R;26| ((|p| $) (|val| R) ($ R))
        (SPROG
         ((#1=#:G540 NIL) (|co| (R)) (#2=#:G537 NIL)
          (|n| (|NonNegativeInteger|)) (#3=#:G544 NIL) (|tm| NIL))
         (SEQ
...
(SDEFUN |SUP;elt;3$;27| ((|p| $) (|val| $) ($ $))
        (SPROG
         ((#1=#:G549 NIL) (|coef| ($)) (#2=#:G546 NIL)
          (|n| (|NonNegativeInteger|)) (#3=#:G553 NIL) (|tm| NIL))
         (SEQ
...
(SDEFUN |SUP;content;$R;32| ((|p| $) ($ R))
        (SPROG
         ((#1=#:G575 NIL) (#2=#:G574 (R)) (#3=#:G576 (R)) (#4=#:G579 NIL)
          (|tm| NIL))
         (SEQ
          (COND ((NULL |p|) (|spadConstant| $ 37))
                (#5='T
...
(SDEFUN |SUP;primitivePart;2$;33| ((|p| $) ($ $))
        (SPROG ((#1=#:G582 NIL) (|ct| (R)))
               (SEQ
                (COND ((NULL |p|) |p|)
                      ('T
                       (SEQ (LETT |ct| (SPADCALL |p| (QREFELT $ 124)))
                            (EXIT
                             (SPADCALL
                              (PROG2
                                  (LETT #1#
                                        (SPADCALL |p| |ct| (QREFELT $ 125)))
                                  (QCDR #1#)
                                (|check_union2| (QEQCAR #1# 0) $
                                                (|Union| $ "failed") #1#))
                              (QREFELT $ 126))))))))) 
                    ...
                    (SEQ G190
                         ...
                         (SEQ
                          ...
                          (EXIT
                           (COND
                            ((QEQCAR |u| 1)
                             (PROGN (LETT #1# |$NoValue|) (GO #2=#:G596)))
                            ('T
                             (SEQ
                              (LETT |rout|
                                    (CONS
...
(DEFUN |SparseUnivariatePolynomial| (#1=#:G651)
  (SPROG NIL
         (PROG (#2=#:G652)
           (RETURN
            (COND
...
(DEFUN |SparseUnivariatePolynomial;| (|#1|)
  (SPROG
   ((#1=#:G650 NIL) (|pv$| NIL) (#2=#:G642 NIL) (#3=#:G643 NIL) (#4=#:G644 NIL)
    (#5=#:G645 NIL) (#6=#:G646 NIL) (#7=#:G647 NIL) (#8=#:G648 NIL)
    (#9=#:G649 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|UnivariatePolynomialCategory| 6)
                 ...
                 (|RetractableTo| 44) (|additiveValuation|) (|TwoSidedRecip|)
                 (|noZeroDivisors|)
