...
(SDEFUN |BRILL;primeEnough?| ((|n| |Integer|) (|b| |Integer|) ($ |Boolean|))
        (SPROG
         ((#1=#:G405 NIL) (#2=#:G406 NIL) (|bb| (|Float|)) (#3=#:G398 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G407 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G424 NIL) (#2=#:G425 NIL) (|small| (|Integer|)) (#3=#:G426 NIL)
