...
(SDEFUN |LPOLY;eval;$VarSet2$;3| ((|p| $) (|v| |VarSet|) (|nv| $) ($ $))
        (SPROG
         ((#1=#:G416 NIL) (#2=#:G415 ($)) (#3=#:G417 ($)) (#4=#:G419 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;eval;$LL$;4|
        ...
        (SPROG
         ((#1=#:G421 NIL) (#2=#:G420 ($)) (#3=#:G422 ($)) (#4=#:G424 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;rquo;Xrp$Xrp;9|
        ((|p| |XRecursivePolynomial| |VarSet| R) (|lp| $)
         ($ |XRecursivePolynomial| |VarSet| R))
        (SPROG
         ((#1=#:G438 NIL) (#2=#:G437 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G439 #3#) (#5=#:G441 NIL) (|t| NIL))
         (SEQ
          (COND
           ((SPADCALL |lp| (|spadConstant| $ 23) (QREFELT $ 44))
            (|spadConstant| $ 35))
...
(SDEFUN |LPOLY;cr1| ((|l| |LyndonWord| |VarSet|) (|p| $) ($ $))
        (SPROG
         ((#1=#:G463 NIL) (#2=#:G462 ($)) (#3=#:G464 ($)) (#4=#:G466 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;cr2| ((|p| $) (|l| |LyndonWord| |VarSet|) ($ $))
        (SPROG
         ((#1=#:G468 NIL) (#2=#:G467 ($)) (#3=#:G469 ($)) (#4=#:G471 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;construct;3$;19| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G480 NIL) (#2=#:G479 ($)) (#3=#:G481 ($)) (#4=#:G483 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;coerce;$Xdp;23|
        ...
        (SPROG
         ((#1=#:G488 NIL) (#2=#:G487 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G489 #3#) (#5=#:G491 NIL) (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LPOLY;coerce;$Xrp;24| ((|p| $) ($ |XRecursivePolynomial| |VarSet| R))
        (SPROG
         ((#1=#:G493 NIL) (#2=#:G492 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G494 #3#) (#5=#:G496 NIL) (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |t| NIL) (LETT #5# |p|) G190
...
(SDEFUN |LPOLY;varList;$L;26| ((|p| $) ($ |List| |VarSet|))
        (SPROG
         ((|le| #1=(|List| |VarSet|)) (#2=#:G499 NIL) (#3=#:G498 #1#)
          (#4=#:G500 #1#) (#5=#:G503 NIL) (|t| NIL))
         (SEQ
          (LETT |le|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LPOLY;mirror;2$;27| ((|p| $) ($ $))
        (SPROG ((#1=#:G508 NIL) (|t| NIL) (#2=#:G507 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LPOLY;coerce;$Of;31| ((|a| $) ($ |OutputForm|))
        (SPROG ((#1=#:G520 NIL) (|t| NIL) (#2=#:G519 NIL))
               (SEQ
                (COND
...
(DEFUN |LiePolynomial| (&REST #1=#:G529)
  (SPROG NIL
         (PROG (#2=#:G530)
           (RETURN
            (COND
...
(DEFUN |LiePolynomial;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G528 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|LiePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|FreeModule| 7 10) (|local| |#1|)
              ...
              |LPOLY;coerce;$Of;31| (|Record| (|:| |k| 10) (|:| |c| 7))
              (|List| 102) (|Mapping| 7 10) (|Union| 10 '"failed")
              (|Mapping| 7 7) (|List| 10) (|List| 7) (|String|)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 111
                                  '(1 10 9 0 11 2 9 12 6 0 13 1 10 15 0 16 2 6
                                    ...
                                    0 107 0 1 2 3 0 0 0 1 2 9 55 0 0 1 2 12 12
                                    0 0 1 0 8 0 1 2 0 33 33 0 48 1 2 105 0 1 1
                                    2 10 0 1 1 11 0 0 90 2 8 12 0 0 1 1 0 87 0
                                    1 1 0 31 0 1 1 0 12 0 1 2 0 0 7 10 68 1 0 0
                                    0 86 2 4 0 0 0 1 2 4 0 0 0 1 2 0 0 106 0 1
                                    2 0 33 33 0 47 1 0 103 0 1 2 10 7 104 0 1 1
                                    11 102 0 1 1 11 10 0 1 1 11 0 0 1 1 11 7 0
                                    1 1 0 109 0 1 2 0 111 111 0 1 1 0 110 0 1 3
                                    0 0 0 9 31 32 3 0 0 0 6 0 30 1 0 87 0 88 1
                                    11 0 103 1 2 0 0 10 0 75 2 0 0 0 10 76 2 0
                                    0 10 10 77 1 0 0 103 1 2 0 0 0 0 20 1 2 0
                                    10 25 1 0 33 0 41 1 0 0 6 74 1 0 49 0 58 1
                                    0 93 0 101 1 0 108 0 1 2 0 7 0 10 1 2 0 7
                                    33 0 43 0 8 0 23 1 0 55 49 60 1 0 0 10 14 2
                                    4 12 0 0 1 2 4 12 0 0 1 2 0 12 0 0 44 2 4
                                    12 0 0 1 2 4 12 0 0 1 2 7 0 0 7 1 1 1 0 0
                                    66 2 1 0 0 0 1 2 0 0 0 0 29 2 8 0 87 0 1 2
                                    1 0 21 0 1 2 0 0 10 7 1 2 0 0 7 10 1 2 0 0
                                    0 7 1 2 0 0 83 0 1 2 0 0 7 0 28)))))
           '|lookupComplete|)) 
