...
(SDEFUN |GROUPP;mapGen|
        ((|a| |Integer|)
         ...
         ($ |Integer|))
        (SPROG ((#1=#:G453 NIL) (#2=#:G454 NIL) (|m| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |GROUPP;refactor;2$;5| ((|a| $) ($ $))
        (SPROG
         ((|gens1| (|List| (|NonNegativeInteger|))) (#1=#:G471 NIL) (|gn| NIL)
          (#2=#:G470 NIL) (|rels1| (|List| (|List| (|Integer|))))
          (|newRel| (|List| (|Integer|))) (|newEle| (|Integer|))
          (#3=#:G469 NIL) (|ele| NIL) (#4=#:G468 NIL) (|rel| NIL)
          (|gms|
           (|List|
            (|Record| (|:| |OldGen| (|NonNegativeInteger|))
                      (|:| |NewGen| (|NonNegativeInteger|)))))
...
(SDEFUN |GROUPP;=;2$B;6| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((|brs| #1=(|List| (|List| (|Integer|)))) (|ars| #1#) (#2=#:G476 NIL)
...
(SDEFUN |GROUPP;outputGen| ((|i2| |Integer|) ($ |OutputForm|))
        (SPROG
         ((#1=#:G480 NIL) (|n| (|OutputForm|)) (|letters| (|String|))
...
(SDEFUN |GROUPP;outputRel| ((|r| |List| (|Integer|)) ($ |OutputForm|))
        (SPROG
         ((|seperator| #1=(|OutputForm|)) (|eleout| #1#)
          (|newterm| (|OutputForm|)) (#2=#:G485 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;outputRelList|
        ...
        (SPROG
         ((#1=#:G490 NIL) (|rels1| (|List| (|OutputForm|))) (#2=#:G491 NIL)
          (|r| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |rels1| NIL)
...
(SDEFUN |GROUPP;outputGenList|
        ...
        (SPROG
         ((#1=#:G496 NIL) (|gens1| (|List| (|OutputForm|))) (#2=#:G497 NIL)
          (|p| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| NIL)
...
(SDEFUN |GROUPP;indexesOfRelUsingGen|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G504 NIL) (|rel| NIL)
          (#2=#:G505 NIL) (|reln| NIL) (|r| (|List| (|List| (|Integer|)))))
...
(SDEFUN |GROUPP;removeGen2|
        ((|rels1| |List| (|List| (|Integer|))) (|val| |NonNegativeInteger|)
         ($ |List| (|List| (|Integer|))))
        (SPROG ((#1=#:G510 NIL) (|rel| NIL) (#2=#:G509 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GROUPP;replaceGen|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|e| (|Integer|)) (#1=#:G519 NIL) (|ele| NIL) (#2=#:G518 NIL)
          (|rel| NIL))
         (SEQ (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveGeneratorIfIdentity|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G525 NIL)
          (|toBeRemoved| (|NonNegativeInteger|)) (#2=#:G526 NIL) (|rel| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |toBeRemoved| 0) (PROGN (LETT #1# |s|) (GO #3=#:G524))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRenameGenerator| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G534 NIL)
          ...
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |replaceFrom| 0) (PROGN (LETT #1# |s|) (GO #3=#:G533))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRemoveEmpty| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G540 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveEleTimesInverse| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|lastele| (|Integer|)) (|changed| (|Boolean|)) (#1=#:G558 NIL)
          (|ele| NIL) (#2=#:G557 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
...
(SDEFUN |GROUPP;invertRelation|
        ...
        (SPROG
         ((|relationOut| (|List| (|Integer|))) (#1=#:G562 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;relationEquivalent|
        ...
        (SPROG
         ((#1=#:G572 NIL) (|relBCycle| (|List| (|Integer|))) (#2=#:G573 NIL)
          (|n| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;TTRemoveDuplicateRelation| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|include| (|Boolean|))
          (#1=#:G584 NIL) (|relb| NIL) (#2=#:G585 NIL) (|nrelb| NIL)
          (#3=#:G582 NIL) (|rela| NIL) (#4=#:G583 NIL) (|nrela| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTMinimiseInverses| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          ...
          (#2=#:G592 NIL) (|ele| NIL) (#3=#:G591 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;generatorOccurrences|
        ((|rel| |List| (|Integer|)) (|gen| |NonNegativeInteger|)
         ($ |NonNegativeInteger|))
        (SPROG ((|res| (|NonNegativeInteger|)) (#1=#:G599 NIL) (|g| NIL))
               (SEQ (LETT |res| 0)
...
(SDEFUN |GROUPP;removeRelations|
        ((|rels1| |List| (|List| (|Integer|))) (|val| |NonNegativeInteger|)
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#1=#:G605 NIL) (|rel| NIL))
         (SEQ (LETT |res| NIL)
              (SEQ (LETT |rel| NIL) (LETT #1# |rels1|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |rel| (CAR #1#)) NIL))
...
(SDEFUN |GROUPP;isSimpler?| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G636 NIL) (|relationCompleityB| #2=(|NonNegativeInteger|))
          (#3=#:G638 NIL) (|rel| NIL) (|relationCompleityA| #2#)
          (#4=#:G637 NIL) (|relsb| #5=(|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;simplify;$B$;30| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|lastpass| ($)) (|level| #1=(|NonNegativeInteger|)) (#2=#:G646 NIL)
          (|res| ($)) (|loopBreaker| #1#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;offsetIndexes| ((|a| $) (|offset| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|rb| (|List| (|List| (|Integer|)))) (#1=#:G657 NIL) (|y| NIL)
          (#2=#:G656 NIL) (#3=#:G655 NIL) (|z| NIL) (#4=#:G654 NIL)
          (|gb| (|List| (|NonNegativeInteger|))) (#5=#:G653 NIL) (|x| NIL)
          (#6=#:G652 NIL) (|ra| (|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;quotient;$L$;32|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G662 NIL)
          (|toBeRemoved| NIL))
...
(SDEFUN |GROUPP;directProduct;3$;34| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|rc| (|List| (|List| (|Integer|)))) (|gcx| (|List| (|Integer|)))
          (#1=#:G671 NIL) (|gbx| NIL) (#2=#:G670 NIL) (|gax| NIL)
...
(SDEFUN |GROUPP;cyclicGroup;Pi$;35| ((|n| |PositiveInteger|) ($ $))
        (SPROG
         ((|ra| (|List| (|List| (|Integer|)))) (#1=#:G676 NIL) (|x| NIL)
          (#2=#:G675 NIL) (|ga| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |ga| (LIST 1))
              (LETT |ra|
                    (LIST
                     (PROGN
...
(SDEFUN |GROUPP;symmetricGroup;Pi$;37| ((|n| |PositiveInteger|) ($ $))
        (SPROG
         ((|r| (|List| (|List| (|Integer|)))) (|y| (|List| (|Integer|)))
          (#1=#:G695 NIL) (|b| NIL) (#2=#:G694 NIL) (|a| NIL)
          (|ga| (|List| (|NonNegativeInteger|))) (#3=#:G693 NIL) (|x| NIL)
          (#4=#:G692 NIL) (|m| (|PositiveInteger|)) (#5=#:G679 NIL)
          (#6=#:G691 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< |n| 2)
              (PROGN (LETT #6# (SPADCALL NIL (QREFELT $ 12))) (GO #7=#:G690))))
            (LETT |m|
                  (PROG1 (LETT #5# (- |n| 1))
...
(SDEFUN |GROUPP;outCosetTable|
        ...
        (SPROG
         ((|cts| (|List| (|TwoDimensionalArray| (|NonNegativeInteger|))))
          (|part2| (|NonNegativeInteger|)) (#2=#:G697 NIL) (|part1| #1#)
          (#3=#:G703 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;infer_coincidencies|
        ((|ct| |TwoDimensionalArray| (|NonNegativeInteger|))
         ...
         (|trace| |Boolean|) ($ |Void|))
        (SPROG
         ((|i2| #3=(|NonNegativeInteger|)) (|i1| #3#) (#4=#:G724 NIL) (|i| NIL)
          (#5=#:G723 NIL) (|nn| (|Integer|)) (|#G135| #1#) (|#G134| #2#))
         (SEQ
          (COND
           (|trace|
            (SPADCALL
...
(SDEFUN |GROUPP;inferFromRelations|
        ...
        (SPROG
         ((#6=#:G767 NIL) (|npb| #7=(|NonNegativeInteger|)) (|npe| #7#)
          ...
          (#13=#:G771 NIL) (|prel| #5#) (|add_to| #9#) (#14=#:G780 NIL)
          (#15=#:G779 NIL) (#16=#:G778 NIL) (#17=#:G777 NIL) (|pe| #8#)
          (|ge| #9#) (#18=#:G768 NIL) (|genInv| (|Integer|)) (#19=#:G776 NIL)
          (|genIndex| NIL) (#20=#:G769 NIL) (#21=#:G775 NIL) (#22=#:G772 NIL)
          (|rel| NIL) (#23=#:G773 NIL) (|rrel| NIL) (#24=#:G774 NIL)
          (|r_len| NIL) (#25=#:G770 NIL) (|closed| (|Boolean|)) (|pn| #8#)
...
(SDEFUN |GROUPP;invertMap|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#1=#:G788 NIL) (|x| NIL)
...
(SDEFUN |GROUPP;generators2Permutation|
        ...
        (SPROG
         ((|pl| (|List| (|Permutation| (|Integer|))))
          ...
          (#5=#:G829 NIL) (|j| (|SingleInteger|)) (|kk| (|NonNegativeInteger|))
          (#6=#:G828 NIL) (#7=#:G827 NIL) (|i| NIL)
          (|perm_lists| (|Vector| (|List| (|Integer|)))) (#8=#:G826 NIL)
...
(SDEFUN |GROUPP;convert_words|
        ...
        (SPROG
         ((|nrwords| (|List| (|List| (|NonNegativeInteger|))))
          (|nwords| (|List| (|List| (|NonNegativeInteger|)))) (#2=#:G848 NIL)
          (|i| NIL) (#3=#:G847 NIL) (|nword| (|List| (|NonNegativeInteger|)))
          (|gen| #1#) (#4=#:G846 NIL) (#5=#:G845 NIL) (|word| NIL))
...
(SDEFUN |GROUPP;toPermutationIfCan;$LBU;49|
        ((|a| $) (|sg| |List| (|List| (|Integer|))) (|trace| |Boolean|)
         ($ |Union| (|PermutationGroup| (|Integer|)) "failed"))
        (SPROG
         ((#1=#:G868 NIL) (#2=#:G869 NIL) (#3=#:G870 NIL)
          (|changedByDeduction| #4=(|Boolean|)) (|dummy| #4#)
          (|sgens_lens| (|List| #5=(|NonNegativeInteger|))) (#6=#:G875 NIL)
          (|word| NIL) (#7=#:G874 NIL) (|nrsgens| NIL)
          ...
          (|rel_lens| (|List| (|NonNegativeInteger|))) (#9=#:G873 NIL)
          (|rel| NIL) (#10=#:G872 NIL) (|nrrels| NIL) (|#G186| #8#)
          (|nrels| NIL) (|#G185| #8#) (#11=#:G871 NIL) (|i| NIL)
