...
(SDEFUN |DBASE;elt;$SDl;2|
        ...
        (SPROG ((#1=#:G386 NIL) (|x| NIL) (#2=#:G385 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |DBASE;elt;$Qe$;3| ((|data| $) (|eq| |QueryEquation|) ($ $))
        (SPROG
         ((#1=#:G391 NIL) (|x| NIL) (#2=#:G390 NIL) (|val| (|String|))
          (|field| (|Symbol|)))
...
(SDEFUN |DBASE;fullDisplay;$2PiV;9|
        ...
        (SPROG ((#1=#:G403 NIL) (|x| NIL) (#2=#:G404 NIL) (|i| NIL))
