...
(SDEFUN |ALGPKG;convVM| ((|v| |Vector| R) ($ |Matrix| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G390 NIL) (|j| NIL) (#2=#:G389 NIL) (|i| NIL)
          (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;basisOfLeftAnnihilator;AL;3| ((|a| A) ($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (#1=#:G400 NIL) (#2=#:G402 NIL) (|i| NIL)
          (#3=#:G401 NIL) (|ca| (|Matrix| R)))
         (SEQ
          (LETT |ca|
                (SPADCALL
...
(SDEFUN |ALGPKG;basisOfRightAnnihilator;AL;4| ((|a| A) ($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (#1=#:G409 NIL) (#2=#:G411 NIL) (|i| NIL)
          (#3=#:G410 NIL) (|ca| (|Matrix| R)))
         (SEQ
          (LETT |ca|
                (SPADCALL
                 (SPADCALL (SPADCALL |a| (QREFELT $ 32)) (QREFELT $ 33))
...
(SDEFUN |ALGPKG;basisOfLeftNucloid;L;5| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G427 NIL) (|sol| NIL) (#2=#:G426 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G425 NIL) (|r| NIL) (|z| (|Integer|))
          (#4=#:G424 NIL) (|k| NIL) (#5=#:G423 NIL) (|j| NIL) (#6=#:G422 NIL)
...
(SDEFUN |ALGPKG;basisOfCommutingElements;L;6| (($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (|gam| (|Matrix| R)) (#1=#:G434 NIL)
          (#2=#:G436 NIL) (|i| NIL) (#3=#:G435 NIL))
         (SEQ
          (LETT |cond|
                (SPADCALL (ELT $ 35)
                          (PROGN
...
(SDEFUN |ALGPKG;basisOfLeftNucleus;L;7| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G451 NIL) (|l| NIL) (#2=#:G450 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G449 NIL) (|s| NIL) (#4=#:G448 NIL) (|j| NIL)
          (#5=#:G447 NIL) (|k| NIL) (|condi| (|Matrix| R)))
         (SEQ
          (LETT |condi|
...
(SDEFUN |ALGPKG;basisOfRightNucleus;L;8| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G466 NIL) (|l| NIL) (#2=#:G465 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G464 NIL) (|s| NIL) (#4=#:G463 NIL) (|j| NIL)
          (#5=#:G462 NIL) (|k| NIL) (|condo| (|Matrix| R)))
         (SEQ
          (LETT |condo|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basisOfMiddleNucleus;L;9| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G481 NIL) (|l| NIL) (#2=#:G480 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G479 NIL) (|s| NIL) (#4=#:G478 NIL) (|j| NIL)
          (#5=#:G477 NIL) (|k| NIL) (|conda| (|Matrix| R)))
         (SEQ
          (LETT |conda|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basisOfNucleus;L;10| (($ |List| A))
        (SPROG
         ((|ent| (R)) (|enter| (R)) (|entry| (R)) (#1=#:G497 NIL) (|l| NIL)
          (#2=#:G496 NIL) (|i| NIL) (|w| (|Integer|)) (|u| (|Integer|))
          (|z| (|Integer|)) (#3=#:G495 NIL) (|s| NIL) (#4=#:G494 NIL) (|j| NIL)
          (#5=#:G493 NIL) (|k| NIL) (|condi| (|Matrix| R)))
         (SEQ
          (LETT |condi|
...
(SDEFUN |ALGPKG;basisOfCenter;L;11| (($ |List| A))
        (SPROG
         ((D #1=(|Matrix| R)) (|enter| (R)) (|entry| (R)) (#2=#:G516 NIL)
          (|l| NIL) (#3=#:G515 NIL) (|i| NIL) (|u| (|Integer|))
          (|z| (|Integer|)) (#4=#:G514 NIL) (|s| NIL) (#5=#:G513 NIL) (|j| NIL)
          (#6=#:G512 NIL) (|k| NIL) (|condi| (|Matrix| R)) (B #1#)
          (|cond| (|Matrix| R)) (|gammak| (|Matrix| R)) (#7=#:G511 NIL)
          (|gamma1| (|Matrix| R)))
...
(SDEFUN |ALGPKG;basisOfRightNucloid;L;12| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G532 NIL) (|sol| NIL) (#2=#:G531 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G530 NIL) (|r| NIL) (|z| (|Integer|))
          (#4=#:G529 NIL) (|k| NIL) (#5=#:G528 NIL) (|j| NIL) (#6=#:G527 NIL)
          (|i| NIL) (|condo| #7=(|Matrix| R)) (|cond| #7#))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 11)
...
(SDEFUN |ALGPKG;basisOfCentroid;L;13| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G548 NIL) (|sol| NIL) (#2=#:G547 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G546 NIL) (|r| NIL) (|u| (|Integer|))
          (|z| (|Integer|)) (#4=#:G545 NIL) (|k| NIL) (#5=#:G544 NIL) (|j| NIL)
          (#6=#:G543 NIL) (|i| NIL) (|condo| #7=(|Matrix| R)) (|cond| #7#))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;doubleRank;ANni;14| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|enter| (R)) (|entry| (R)) (#1=#:G559 NIL) (|i| NIL)
          (|u| (|Integer|)) (|z| (|Integer|)) (#2=#:G558 NIL) (|j| NIL)
          (#3=#:G557 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;weakBiRank;ANni;15| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G573 NIL) (|s| NIL) (#2=#:G572 NIL) (|l| NIL)
          (#3=#:G571 NIL) (|k| NIL) (|z| (|Integer|)) (#4=#:G570 NIL) (|j| NIL)
          (#5=#:G569 NIL) (|i| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;biRank;ANni;16| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|enter| (R)) (|entry| (R)) (#1=#:G596 NIL) (|i| NIL) (#2=#:G595 NIL)
          (|k| NIL) (|w| (|Integer|)) (|u| (|Integer|)) (#3=#:G594 NIL)
          (|j| NIL) (|c| (|PositiveInteger|)) (#4=#:G593 NIL) (|s| NIL)
          (#5=#:G592 NIL) (|l| NIL) (#6=#:G591 NIL) (|z| (|Integer|))
          (#7=#:G590 NIL) (#8=#:G589 NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;leftRank;ANni;17| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G605 NIL) (|i| NIL) (#2=#:G604 NIL) (|j| NIL)
          (#3=#:G603 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 10) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;rightRank;ANni;18| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G614 NIL) (|i| NIL) (#2=#:G613 NIL) (|j| NIL)
          (#3=#:G612 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 10) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basis;2V;19| ((|va| |Vector| A) ($ |Vector| A))
        (SPROG
         ((#1=#:G627 NIL) (#2=#:G629 NIL) (|j| (|Integer|)) (#3=#:G628 NIL)
          (|finished?| (|Boolean|)) (|h| (|Integer|))
          (|lj| (|List| (|Integer|))) (|mCI| (|Integer|)) (|mRI| (|Integer|))
          (|m| (|Matrix| R)) (#4=#:G626 NIL) (|i| NIL) (|v| (|Vector| A)))
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (PROGN
                    ...
                    (SEQ (LETT |j| NIL) (LETT #2# #5#) (LETT #1# 0) G190
                         (COND
...
(DEFUN |AlgebraPackage| (&REST #1=#:G630)
  (SPROG NIL
         (PROG (#2=#:G631)
           (RETURN
            (COND
