...
(DEFUN |JetBundleSymAna| (&REST #1=#:G429)
  (SPROG NIL
         (PROG (#2=#:G430)
           (RETURN
            (COND
...
(DEFUN |JetBundleSymAna;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G428 NIL) (|i| NIL) (#2=#:G427 NIL) (#3=#:G426 NIL) (#4=#:G425 NIL)
    (#5=#:G424 NIL) (|jv| NIL) (#6=#:G423 NIL) (#7=#:G392 NIL) (#8=#:G422 NIL)
    (#9=#:G421 NIL) (#10=#:G389 NIL) (#11=#:G420 NIL) (#12=#:G419 NIL)
