...
(SDEFUN |FFNBP;basis;PiV;14| ((|n| |PositiveInteger|) ($ |Vector| $))
        (SPROG ((#1=#:G442 NIL) (|i| NIL) (#2=#:G441 NIL))
               (SEQ
                (COND
...
(SDEFUN |FFNBP;coerce;$Of;22| ((|x| $) ($ |OutputForm|))
        (SPROG
         ((|r| (|OutputForm|)) (|l| (|List| (|OutputForm|)))
          (|mon| (|OutputForm|)) (#1=#:G468 NIL) (|i| NIL) (#2=#:G469 NIL)
...
(SDEFUN |FFNBP;initializeLog| (($ |Void|))
        (SPROG
         ((#1=#:G482 NIL) (|a| ($)) (#2=#:G488 NIL) (#3=#:G476 NIL) (|i| NIL)
          (|tbl| (|Table| (|PositiveInteger|) (|NonNegativeInteger|)))
          (|n| (|Integer|)) (|d| (|Integer|)) (|l| (|Integer|)) (|base| ($))
          (|fac| (|Integer|)) (#4=#:G487 NIL) (|f| NIL) (|limit| (|Integer|)))
...
(SDEFUN |FFNBP;trace;$Pi$;31| ((|a| $) (|d| |PositiveInteger|) ($ $))
        (SPROG ((|erg| ($)) (#1=#:G506 NIL) (|i| NIL) (|v| ($)))
               (SEQ (LETT |v| (SPADCALL |a| |d| (QREFELT $ 148)))
                    (LETT |erg| |v|)
...
(SDEFUN |FFNBP;basis;V;40| (($ |Vector| $))
        (SPROG
         ((#1=#:G520 NIL) (|e| NIL) (#2=#:G519 NIL)
          (|a| (|Vector| (|Vector| GF))))
         (SEQ (LETT |a| (SPADCALL (QREFELT $ 17) (QREFELT $ 161)))
              (EXIT
               (SPADCALL
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |e| NIL) (LETT #1# (SPADCALL |a| (QREFELT $ 163)))
                      G190
                      (COND
...
(SDEFUN |FFNBP;inGroundField?;$B;50| ((|x| $) ($ |Boolean|))
        (SPROG ((#1=#:G546 NIL) (|erg| (|Boolean|)) (#2=#:G547 NIL) (|i| NIL))
               (SEQ (LETT |erg| 'T)
                    (SEQ
                     (EXIT
...
(DEFUN |FiniteFieldNormalBasisExtensionByPolynomial| (&REST #1=#:G578)
  (SPROG NIL
         (PROG (#2=#:G579)
           (RETURN
            (COND
...
(DEFUN |FiniteFieldNormalBasisExtensionByPolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G400 NIL) (#2=#:G577 NIL) (|i| NIL) (#3=#:G576 NIL) (|qs| NIL)
    (|pv$| NIL) (#4=#:G575 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (SEQ
    (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|FiniteAlgebraicExtensionField| 6) (|ExtensionField| 6)
                 ...
                 (|BasicType|) (|CoercibleTo| 11) (|ConvertibleTo| 195))
