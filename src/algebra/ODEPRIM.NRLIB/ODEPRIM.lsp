...
(SDEFUN |ODEPRIM;splitDenominator;LQLR;4|
        ...
        (SPROG
         ((#1=#:G400 NIL) (|g| NIL) (#2=#:G399 NIL) (|l| (L))
          (|f| (|Fraction| UP))
...
(SDEFUN |ODEPRIM;UPfact| ((|n| |NonNegativeInteger|) ($ UP))
        (SPROG
         ((#1=#:G416 NIL) (#2=#:G415 (UP)) (#3=#:G417 (UP)) (#4=#:G421 NIL)
          (#5=#:G414 NIL) (|i| NIL) (|z| (UP)))
         (SEQ
...
(SDEFUN |ODEPRIM;indicialEq|
        ((|c| UP) (|lamb| |List| (|NonNegativeInteger|)) (|lf| |List| UP)
         ($ UP))
        (SPROG
         ((|s| (|SparseUnivariatePolynomial| UP)) (#1=#:G425 NIL) (|i| NIL)
          (#2=#:G426 NIL) (|f| NIL) (|cc| (|SparseUnivariatePolynomial| UP))
          (|cp| (UP)))
...
(SDEFUN |ODEPRIM;NPbound| ((|c| UP) (|l| L) (|e| UP) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G440 NIL) (#2=#:G435 NIL) (|n| (|Integer|))
          (|rec|
           (|Record| (|:| |mu| (|Integer|))
                     (|:| |lambda| (|List| (|NonNegativeInteger|)))
                     (|:| |func| (|List| UP)))))
...
(SDEFUN |ODEPRIM;hdenom| ((|l| L) (|d| UP) (|e| UP) ($ UP))
        (SPROG
         ((#1=#:G445 NIL) (#2=#:G444 (UP)) (#3=#:G446 (UP)) (#4=#:G448 NIL)
          (|dd| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ODEPRIM;denom0|
        ...
        (SPROG
         ((#1=#:G451 NIL) (#2=#:G450 (UP)) (#3=#:G452 (UP)) (#4=#:G454 NIL)
          (#5=#:G456 NIL) (|hh| NIL))
         (SEQ
...
(SDEFUN |ODEPRIM;indicialEquations;LUPL;17|
        ((|op| L) (|p| UP)
         ($ |List| (|Record| (|:| |center| UP) (|:| |equation| UP))))
        (SPROG ((#1=#:G469 NIL) (|dd| NIL) (#2=#:G468 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |dd| NIL)
...
(SDEFUN |ODEPRIM;denomLODE;LLUP;19|
        ...
        (SPROG
         ((|h| (UP)) (|e| (UP)) (#1=#:G483 NIL) (#2=#:G482 (UP))
          (#3=#:G484 (UP)) (#4=#:G488 NIL) (|g| NIL) (|d| (UP))
          (#5=#:G480 NIL))
         (SEQ
          (COND
           ((NULL |lg|)
...
(DEFUN |PrimitiveRatDE| (&REST #1=#:G489)
  (SPROG NIL
         (PROG (#2=#:G490)
           (RETURN
            (COND
