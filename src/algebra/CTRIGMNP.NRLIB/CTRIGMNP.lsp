...
(SDEFUN |CTRIGMNP;complexForm;FC;5| ((|f| F) ($ |Complex| (|Expression| R)))
...
(SDEFUN |CTRIGMNP;complexElementary;FSF;10| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G415 NIL) (|g| (F)) (|k| NIL) (#2=#:G414 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |CTRIGMNP;complexNormalize;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G422 NIL) (|g| (F)) (|k| NIL) (#2=#:G421 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(DEFUN |ComplexTrigonometricManipulations| (&REST #1=#:G428)
  (SPROG NIL
         (PROG (#2=#:G429)
           (RETURN
            (COND
