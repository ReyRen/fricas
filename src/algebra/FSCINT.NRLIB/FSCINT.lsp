...
(SDEFUN |FSCINT;internalIntegrate;FSIr;7|
        ((|f| F) (|x| |Symbol|) ($ |IntegrationResult| F))
        (SPROG
         ((|g| (F)) (|h| (|Expression| (|Complex| R))) (#1=#:G415 NIL)
          (|k| NIL) (#2=#:G414 NIL) (#3=#:G413 NIL) (#4=#:G412 NIL))
         (SEQ
          (LETT |f|
...
(DEFUN |FunctionSpaceComplexIntegration| (&REST #1=#:G416)
  (SPROG NIL
         (PROG (#2=#:G417)
           (RETURN
            (COND
...
(MAKEPROP '|FunctionSpaceComplexIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'RTRIG
              ...
              |FSCINT;complexIntegrate;FSF;2| '#:G382
