...
(SDEFUN |REP2;blockMultiply|
        ((|a| |Matrix| R) (|b| |Matrix| R) (|li| |List| (|Integer|))
         (|n| |Integer|) ($ |Matrix| R))
        (SPROG
         ((#1=#:G405 NIL) (#2=#:G404 (R)) (#3=#:G406 (R)) (#4=#:G414 NIL)
          (|s| NIL) (#5=#:G413 NIL) (|j| NIL) (#6=#:G412 NIL) (#7=#:G411 NIL)
          (|i| NIL) (#8=#:G410 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |REP2;fingerPrint|
        ((|i| |NonNegativeInteger|) (|a| |Matrix| R) (|b| |Matrix| R)
         (|x| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G430 NIL) (#2=#:G428 NIL) (#3=#:G426 NIL) (#4=#:G424 NIL)
          (#5=#:G422 NIL) (#6=#:G420 NIL))
         (SEQ
          (COND
           ((EQL
             (PROG1 (LETT #6# |i|)
...
(SDEFUN |REP2;completeEchelonBasis;VM;3|
        ...
        (SPROG
         ((#1=#:G445 NIL) (|j| NIL) (|newStart| #2=(|NonNegativeInteger|))
          (|indexOfVectorToBeScanned| #2#) (|row| #3=(|NonNegativeInteger|))
          (#4=#:G444 NIL) (|completedBasis| (|Matrix| R)) (#5=#:G443 NIL)
...
(SDEFUN |REP2;cyclicSubmodule;LVV;5|
        ...
        (SPROG
         ((#1=#:G462 NIL) (|i| NIL) (#2=#:G461 NIL)
          (|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#3=#:G460 NIL)
          (#4=#:G459 NIL) (|basis| (|Matrix| R)) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#5=#:G458 NIL)
          (#6=#:G457 NIL))
         (SEQ
          (LETT |basis|
                (SPADCALL
...
(SDEFUN |REP2;standardBasisOfCyclicSubmodule;LVM;6|
        ...
        (SPROG
         ((|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#1=#:G474 NIL) (|i| NIL)
          (#2=#:G473 NIL) (|basis| (|Matrix| R))
          (|standardBasis| (|List| (|List| R))) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#3=#:G472 NIL)
          (#4=#:G471 NIL) (|dim| (|NonNegativeInteger|)))
...
(SDEFUN |REP2;splitInternal|
        ...
        (SPROG
         ((|factormoduleRepresentation| (|List| (|Matrix| R)))
          ...
          (|helpMatrix| (|Matrix| R)) (#1=#:G491 NIL) (|i| NIL)
          (|inverseTransitionMatrix| (|Matrix| R)) (#2=#:G478 NIL)
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G490 NIL)
          (#4=#:G489 NIL) (|submoduleIndices| (|List| (|Integer|)))
          (#5=#:G488 NIL) (#6=#:G487 NIL) (|rankOfSubmodule| (|Integer|))
...
(SDEFUN |REP2;irreducibilityTestInternal|
        ((|algebraGenerators| |List| (|Matrix| R))
         ...
         ($ |List| (|List| (|Matrix| R))))
        (SPROG
         ((#1=#:G496 NIL) (|mat| (|Matrix| R)) (#2=#:G508 NIL) (|j| NIL)
          (#3=#:G507 NIL) (|i| NIL) (|result| (|List| (|List| (|Matrix| R))))
          (|kernel| (|List| (|Vector| R))) (|xt| (|Matrix| R))
          (|algebraGeneratorsTranspose| (|List| (|Matrix| R))) (#4=#:G506 NIL)
          (#5=#:G505 NIL))
         (SEQ
...
(SDEFUN |REP2;areEquivalent?;2LBIM;11|
        ...
        (SPROG
         ((|transitionM| (|Matrix| R)) (|result| #1=(|Boolean|))
          (#2=#:G540 NIL) (|j| NIL) (|foundResult| #1#) (#3=#:G521 NIL)
          (|baseChange1| #4=(|Matrix| R)) (|baseChange0| #4#)
          (|kernel1| #5=(|List| (|Vector| R))) (|kernel0| #5#)
          (|rk1| #6=(|NonNegativeInteger|)) (|rk0| #6#) (|x1| #7=(|Matrix| R))
          (|x0| #7#) (|randomIndex| (|Integer|)) (#8=#:G538 NIL) (|i| NIL)
          (#9=#:G539 NIL) (|n| (|NonNegativeInteger|))
          (|numberOfGenerators| (|NonNegativeInteger|)))
         (SEQ (LETT |result| NIL)
...
(SDEFUN |REP2;isAbsolutelyIrreducible?;LIB;13|
        ...
        (SPROG
         ((|result| #1=(|Boolean|)) (|kernel| (|List| (|Vector| R)))
          ...
          (|randomIndex| (|Integer|)) (#2=#:G550 NIL) (|i| NIL) (#3=#:G551 NIL)
...
(SDEFUN |REP2;split;LVL;15|
        ...
        (SPROG
         ((|factormoduleRepresentation| (|List| (|Matrix| R)))
          (|submoduleRepresentation| (|List| (|Matrix| R)))
          (|helpMatrix| (|Matrix| R)) (#1=#:G566 NIL) (|i| NIL)
          (|inverseTransitionMatrix| (|Matrix| R)) (#2=#:G556 NIL)
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G565 NIL)
          (#4=#:G564 NIL) (|submoduleIndices| (|List| (|Integer|)))
          (#5=#:G563 NIL) (#6=#:G562 NIL) (|rankOfSubmodule| (|Integer|))
          (|n| (|NonNegativeInteger|)))
...
(SDEFUN |REP2;my_min| ((|m| |Matrix| R) (|n| |Integer|) ($ |Smp|))
        (SPROG
         ((|xi| (|Smp|)) (|res| (|Smp|)) (#1=#:G585 NIL) (|i| NIL)
          (|x| (|Smp|)) (|j| (|Integer|)) (|depe| (|Matrix| R))
          (|depm| (|Matrix| R)) (#2=#:G584 NIL) (|v| #3=(|Vector| R))
          (#4=#:G583 NIL) (|depl| (|List| (|Vector| R))) (#5=#:G582 NIL)
          (#6=#:G581 NIL) (#7=#:G580 NIL) (|zz| #3#) (#8=#:G568 NIL))
         (SEQ
          (LETT |zz|
                (SPADCALL
                 (PROG1 (LETT #8# |n|)
...
(SDEFUN |REP2;m_eval|
        ...
        (SPROG
         ((|old_deg| #1=(|NonNegativeInteger|)) (|res| (|Matrix| R))
          (#2=#:G596 NIL) (|i| NIL) (|ndeg| #1#) (|c0| (R)) (|id| (|Matrix| R))
          (#3=#:G593 NIL) (#4=#:G595 NIL) (#5=#:G594 NIL)
          (|nn| (|NonNegativeInteger|)) (#6=#:G586 NIL))
         (SEQ
          (LETT |nn|
                (PROG1 (LETT #6# |n|)
...
(SDEFUN |REP2;meatAxe1|
        ...
        (SPROG
         ((#1=#:G608 NIL) (|pres| (|List| (|List| (|Matrix| R))))
          (|v| (|Vector| R)) (|good| (|Boolean|))
          (|kernel| (|List| (|Vector| R))) (|xx| (|Matrix| R))
          (|mm| (|NonNegativeInteger|)) (|fpol| (|Smp|)) (#2=#:G609 NIL)
          (|fac| NIL)
          (|fl|
           (|List|
...
(SDEFUN |REP2;meatAxe;LB2IL;19|
        ((|algebraGenerators| |List| (|Matrix| R)) (|randomelements| |Boolean|)
         ...
         ($ |List| (|List| (|Matrix| R))))
        (SPROG
         ((|result| (|List| (|List| (|Matrix| R)))) (#1=#:G625 NIL)
          (#2=#:G627 NIL) (|j| NIL) (|numberOfTests| (|Integer|))
          ...
          (|randomIndex| (|Integer|)) (#3=#:G626 NIL) (|i| NIL)
          (|q| (|PositiveInteger|)) (#4=#:G610 NIL)
          (|numberOfGenerators| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |REP2;scanOneDimSubspaces;LIV;23|
        ...
        (SPROG
         ((#1=#:G643 NIL) (|j| NIL) (|newAdd| (|Vector| R)) (#2=#:G642 NIL)
          (|i| (|Integer|)) (|result| #3=(|Vector| R)) (#4=#:G633 NIL)
          (#5=#:G641 NIL) (|iR| (|List| (|Integer|))) (|coefficients| #3#)
          (|nred| #6=(|Integer|)) (|pos| #6#) (#7=#:G640 NIL)
...
(DEFUN |RepresentationPackage2| (#1=#:G645)
  (SPROG NIL
         (PROG (#2=#:G646)
           (RETURN
            (COND
...
(DEFUN |RepresentationPackage2;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G644 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
