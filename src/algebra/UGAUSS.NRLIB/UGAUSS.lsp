...
(SDEFUN |UGAUSS;pre_gauss0|
        ...
        (SPROG
         ((#1=#:G410 NIL) (|l| NIL) (|pp| (|Integer|)) (#2=#:G409 NIL)
          (|n| NIL) (|ml| #3=(|Integer|)) (|l0| (|Integer|)) (#4=#:G406 NIL)
          (|pv| #3#) (#5=#:G408 NIL) (#6=#:G407 NIL) (|i| NIL)
...
(SDEFUN |UGAUSS;pre_lr;M2VM;2|
        ...
        (SPROG
         ((#1=#:G434 NIL) (|l| NIL) (#2=#:G433 NIL) (|pp| (|Integer|))
          (#3=#:G432 NIL) (|n| NIL) (|ml| #4=(|Integer|)) (|l0| (|Integer|))
          (#5=#:G429 NIL) (|pv| #4#) (#6=#:G431 NIL) (#7=#:G430 NIL) (|i| NIL)
          (|k| (|NonNegativeInteger|)) (|j| (|NonNegativeInteger|))
          (|m2| (|Matrix| (|Integer|))))
...
(SDEFUN |UGAUSS;pre_smith;2M;4|
        ((|m| |Matrix| (|Integer|)) ($ |Matrix| (|Integer|)))
        (SPROG
         ((|l0| #1=(|NonNegativeInteger|)) (#2=#:G452 NIL) (|l| NIL) (|i0| #1#)
          (#3=#:G451 NIL) (|i| NIL) (|ress| (|Matrix| (|Integer|)))
          (#4=#:G440 NIL) (#5=#:G439 NIL) (|count| #1#) (#6=#:G450 NIL)
