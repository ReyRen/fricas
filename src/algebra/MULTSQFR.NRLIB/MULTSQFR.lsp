         ...
         ((#1=#:G434 NIL)
          ...
          (|nsqlead|
           (|List|
            (|Record| (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|nff| (P)) (|lcr| (P)) (#3=#:G453 NIL) (|hh1| (P)) (#4=#:G437 NIL)
          (|h1| (|Union| P #5="failed")) (|unitsq| (P)) (#6=#:G455 NIL)
          ...
          (#10=#:G427 NIL) (|ldeg| (|List| (|NonNegativeInteger|)))
         ...
         ((|lfs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      ...
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#1=#:G493 NIL) (|fu| #2=(|Factored| P)) (#3=#:G492 NIL)
          (|partSq|
           (|Record| (|:| |unitPart| P)
                     (|:| |suPart|
                          (|List|
                           (|Record|
                            (|:| |factor| (|SparseUnivariatePolynomial| P))
                            (|:| |exponent| (|NonNegativeInteger|)))))))
          (#4=#:G491 NIL) (|ff| NIL) (#5=#:G490 NIL) (|lcSq| #2#)
          (#6=#:G475 NIL) (|lcf| (P)) (#7=#:G489 NIL) (#8=#:G488 NIL)
          (|usqfr| (|Factored| (|SparseUnivariatePolynomial| R)))
          (|upol| (|SparseUnivariatePolynomial| R)) (|lvar| #9=(|List| OV))
          (#10=#:G466 NIL) (#11=#:G465 #9#) (#12=#:G467 #9#) (#13=#:G487 NIL)
          (|cf| NIL) (#14=#:G486 NIL) (#15=#:G485 NIL))
         (SEQ
          (COND
                     ...
                     (|:| |suPart|
                          (|List|
                           (|Record|
                            (|:| |factor| (|SparseUnivariatePolynomial| P))
                            (|:| |exponent| (|NonNegativeInteger|)))))))
          (#3=#:G515 NIL) (|lcont| (P)) (|f0| (|SparseUnivariatePolynomial| P))
          (|lvar| (|List| OV)) (|x| (OV)) (|i| (|Integer|)) (#4=#:G528 NIL)
          (|j| NIL) (|m| #5=(|NonNegativeInteger|)) (#6=#:G511 NIL)
          (#7=#:G510 #5#) (#8=#:G512 #5#) (#9=#:G527 NIL) (|ldeg| (|List| #5#))
          (|result| (|Factored| P)) (#10=#:G525 NIL) (#11=#:G504 NIL) (|p| (P))
          (|y| (OV)) (|n| (|NonNegativeInteger|)) (#12=#:G526 NIL) (|im| NIL)
...
(SDEFUN |MULTSQFR;intChoose;SupLLR;4|
        ...
        (SPROG
         ((|d1| #1=(|Integer|)) (|lval1| (|List| R)) (|ctf1| (R))
          ...
          (|try_n| (|NonNegativeInteger|)) (#2=#:G548 NIL) (|d0| #1#)
          (|lfact|
           (|List|
            (|Record| (|:| |factor| (|SparseUnivariatePolynomial| R))
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#3=#:G535 NIL) (|ctf| (R)) (|f0| (|SparseUnivariatePolynomial| R))
          (|lval| (|List| R)) (#4=#:G550 NIL) (|i| NIL) (#5=#:G549 NIL)
...
(SDEFUN |MULTSQFR;coefChoose;IPLP;5|
        ((|exp| |Integer|) (|unitsq| P)
         ...
         ($ P))
        (SPROG
         ((|lcoef| (P)) (#1=#:G553 NIL) (|texp| (|NonNegativeInteger|))
          (#2=#:G558 NIL) (|term| NIL))
...
(SDEFUN |MULTSQFR;univcase;POVF;8| ((|f| P) (|x| OV) ($ |Factored| P))
        (SPROG
         ((#1=#:G591 NIL) (|term| NIL) (#2=#:G590 NIL)
          (|result| (|Factored| (|SparseUnivariatePolynomial| R)))
          (|uf| (|SparseUnivariatePolynomial| R)) (#3=#:G578 NIL) (|cf| (R)))
...
(SDEFUN |MULTSQFR;compdegd;LI;9|
        ((|lfact| |List|
          (|Record| (|:| |factor| (|SparseUnivariatePolynomial| R))
                    (|:| |exponent| (|NonNegativeInteger|))))
         ($ |Integer|))
        (SPROG ((|ris| (|Integer|)) (#1=#:G596 NIL) (|pfact| NIL))
               (SEQ (LETT |ris| 0)
...
(SDEFUN |MULTSQFR;myDegree;SupLNniL;11|
        ...
        (SPROG ((#1=#:G608 NIL) (|n| NIL) (#2=#:G607 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |n| NIL)
...
(DEFUN |MultivariateSquareFree| (&REST #1=#:G609)
  (SPROG NIL
         (PROG (#2=#:G610)
           (RETURN
            (COND
