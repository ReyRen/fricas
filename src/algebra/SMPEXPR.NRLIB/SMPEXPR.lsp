...
(DEFUN |SparseMultivariatePolynomialExpressions| (#1=#:G450)
  (SPROG NIL
         (PROG (#2=#:G451)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomialExpressions;| (|#1|)
  (SPROG
   ((#1=#:G449 NIL) (|pv$| NIL) (#2=#:G441 NIL) (#3=#:G442 NIL) (#4=#:G443 NIL)
    (#5=#:G444 NIL) (#6=#:G445 NIL) (#7=#:G446 NIL) (#8=#:G447 NIL)
    (#9=#:G448 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
