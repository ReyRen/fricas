        ...
        (SPROG
         ((|lla|
          ...
          (|m|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#3=#:G451 NIL) (|ru| (|Union| $ "failed")) (#4=#:G445 NIL)
          (|lar| #1#) (|la0| #1#))
         (SEQ
          (EXIT
           (COND
        ...
        (SPROG
         ((|Nlar| (|Integer|))
          ...
          (|l|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#2=#:G488 NIL) (#3=#:G489 NIL) (#4=#:G474 NIL)
...
(SDEFUN |FMONOID;hclf;3$;14| ((|f| $) (|g| $) ($ $))
        (SPROG
         ((#1=#:G496 NIL) (#2=#:G497 NIL)
          (|h|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#3=#:G498 NIL) (|f0| NIL) (#4=#:G499 NIL) (|g0| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |h| NIL)
                     ...
                     (COND
                      ((OR
                        ...
                        (SPADCALL (QCDR |a0|) (QCDR (|SPADfirst| |laq|))
                                  (QREFELT $ 50)))
                       (PROGN (LETT #2# (CONS 1 "failed")) (GO #4=#:G513)))
...
(SDEFUN |FMONOID;rquo;$SU;18| ((|w| $) (|l| S) ($ |Union| $ "failed"))
        (SPROG ((|r| (|Union| $ "failed")) (|u| ($)))
               (SEQ (LETT |u| (SPADCALL |w| (QREFELT $ 22)))
                    (LETT |r| (SPADCALL |u| |l| (QREFELT $ 63)))
                    (EXIT
...
(SDEFUN |FMONOID;length;$Nni;19| ((|x| $) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G542 NIL) (|f| NIL) (#2=#:G541 NIL))
               (SEQ
                (SPADCALL (ELT $ 65)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FMONOID;varList1| ((|x| $) ($ |List| S))
        (SPROG ((|le| (|List| S)) (#1=#:G548 NIL) (|t| NIL) (#2=#:G547 NIL))
               (SEQ
                (LETT |le|
                      (PROGN
                       (LETT #2# NIL)
...
(SDEFUN |FMONOID;lexico;2$B;26| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((|la|
           #1=(|List|
               (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (|lb| #1#) (#2=#:G568 NIL) (#3=#:G565 NIL) (#4=#:G578 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |FMONOID;<;2$B;27| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG ((|lb| #1=(|NonNegativeInteger|)) (|la| #1#))
               (SEQ (LETT |la| (SPADCALL |a| (QREFELT $ 69)))
                    (LETT |lb| (SPADCALL |b| (QREFELT $ 69)))
                    (EXIT
        ...
        (SPROG
         ((|na| (|Integer|))
          (|la|
           #1=(|List|
               (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (|lb| #1#) (#2=#:G589 NIL) (|nb| (|Integer|)) (#3=#:G586 NIL)
          (#4=#:G599 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |la| (SPADCALL |a| (QREFELT $ 12)))
...
(DEFUN |FreeMonoid;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G603 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
