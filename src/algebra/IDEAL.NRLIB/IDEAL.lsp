...
(SDEFUN |IDEAL;contractGrob| ((I1 |List| |newPoly|) ($ $))
        (SPROG
         ((#1=#:G418 NIL) (#2=#:G435 NIL) (|f| NIL) (#3=#:G434 NIL)
          (J1 (|List| |newPoly|)))
...
(SDEFUN |IDEAL;subset|
        ...
        (SPROG
         ((|l1| (|List| (|List| |VarSet|))) (#2=#:G449 NIL) (|set| NIL)
          (#3=#:G448 NIL) (|ll| #1#) (|v| (|VarSet|)))
         (SEQ
...
(SDEFUN |IDEAL;monomDim|
        ...
        (SPROG
         ((#2=#:G461 NIL) (|ldif| #1#) (#3=#:G464 NIL)
          (|mvset| (|List| |VarSet|)) (#4=#:G463 NIL) (|subs| NIL)
          (|lsubset| (|List| (|List| |VarSet|)))
          (|monvar| (|List| (|List| |VarSet|))) (#5=#:G462 NIL) (|f| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |monvar| NIL)
                (SEQ (LETT |f| NIL)
...
(SDEFUN |IDEAL;in?;2$B;12| ((I $) (J $) ($ |Boolean|))
        (SPROG
         ((#1=#:G471 NIL) (#2=#:G470 #3=(|Boolean|)) (#4=#:G472 #3#)
          (#5=#:G475 NIL) (|f| NIL))
...
(SDEFUN |IDEAL;groebner;2$;13| ((I $) ($ $))
        (SPROG
         ((#1=#:G477 NIL) (#2=#:G476 #3=(|Boolean|)) (#4=#:G478 #3#)
          (#5=#:G483 NIL) (|f| NIL))
         (SEQ
          (COND
           ((QCDR I)
...
(SDEFUN |IDEAL;intersect;3$;14| ((I $) (J $) ($ $))
        (SPROG
         ((#1=#:G494 NIL) (|f| NIL) (#2=#:G493 NIL) (#3=#:G492 NIL)
          (#4=#:G491 NIL) (|tp1| (|newPoly|)) (|tp| (|newPoly|))
...
(SDEFUN |IDEAL;intersect;L$;15| ((|lid| |List| $) ($ $))
        (SPROG
         ((#1=#:G496 NIL) (#2=#:G495 ($)) (#3=#:G497 ($)) (#4=#:G499 NIL)
          (|l| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |IDEAL;quotient;$DPoly$;16| ((I $) (|f| |DPoly|) ($ $))
        (SPROG ((#1=#:G418 NIL) (#2=#:G505 NIL) (|g| NIL) (#3=#:G504 NIL))
               (SEQ
                (CONS
                 (SPADCALL
                  (PROGN
...
(SDEFUN |IDEAL;quotient;3$;17| ((I $) (J $) ($ $))
        (SPROG
         ((#1=#:G510 NIL) (#2=#:G509 ($)) (#3=#:G511 ($)) (#4=#:G514 NIL)
...
(SDEFUN |IDEAL;*;3$;19| ((I $) (J $) ($ $))
        (SPROG
         ((#1=#:G517 NIL) (#2=#:G516 #3=(|List| |DPoly|)) (#4=#:G518 #3#)
          (#5=#:G523 NIL) (|f| NIL) (#6=#:G522 NIL) (#7=#:G521 NIL) (|g| NIL))
         (SEQ
          (CONS
           (SPADCALL
            (PROGN
...
(SDEFUN |IDEAL;saturate;$DPoly$;21| ((I $) (|f| |DPoly|) ($ $))
        (SPROG ((#1=#:G530 NIL) (|g| NIL) (#2=#:G529 NIL) (|tp| (|newPoly|)))
               (SEQ
                (COND
                 ((SPADCALL |f| (|spadConstant| $ 13) (QREFELT $ 15))
                  (|error| "f is zero"))
...
(SDEFUN |IDEAL;saturate;$DPolyL$;22|
        ...
        (SPROG
         ((#1=#:G556 NIL) (|g| NIL) (#2=#:G555 NIL)
          (|fullPol| (|List| |DPoly|)) (#3=#:G554 NIL) (|vv| NIL)
          (#4=#:G553 NIL) (|s| (|DPoly|)) (#5=#:G539 NIL) (#6=#:G538 (|DPoly|))
          (#7=#:G540 (|DPoly|)) (#8=#:G552 NIL) (|ltg| NIL)
          (|ltJ| (|List| |DPoly|)) (#9=#:G551 NIL) (#10=#:G550 NIL)
          (J (|List| |DPoly|)) (#11=#:G549 NIL) (#12=#:G548 NIL)
          (|subVars| (|List| |DPoly|)) (#13=#:G547 NIL) (#14=#:G546 NIL)
          (|newVars| (|List| |VarSet|)) (|fullVars| #15=(|List| |VarSet|))
          (#16=#:G532 NIL) (#17=#:G531 #15#) (#18=#:G533 #15#) (#19=#:G545 NIL)
          (|Id| (|List| |DPoly|)))
         (SEQ (LETT |Id| (QCAR I))
              (LETT |fullVars|
                    (PROGN
...
(SDEFUN |IDEAL;zeroDim?;$LB;23| ((I $) (|lvar| |List| |VarSet|) ($ |Boolean|))
        (SPROG
         ((|x| (|VarSet|)) (#1=#:G559 NIL) (#2=#:G568 NIL) (|f| NIL)
...
(SDEFUN |IDEAL;zeroDim?;$B;24| ((I $) ($ |Boolean|))
        (SPROG
         ((#1=#:G570 NIL) (#2=#:G569 #3=(|List| |VarSet|)) (#4=#:G571 #3#)
          (#5=#:G574 NIL) (|g| NIL))
         (SEQ
          (SPADCALL I
                    (PROGN
...
(SDEFUN |IDEAL;inRadical?;DPoly$B;25| ((|f| |DPoly|) (I $) ($ |Boolean|))
        (SPROG
         ((#1=#:G637 NIL) (|g| NIL) (#2=#:G636 NIL) (|Id| (|List| |DPoly|))
          (|tp| (|newPoly|)))
         (SEQ
...
(SDEFUN |IDEAL;dimension;$LI;26| ((I $) (|lvar| |List| |VarSet|) ($ |Integer|))
        (SPROG
         ((|n1| (|Integer|)) (|leadid| ($)) (|ed| (|Integer|))
          (|truelist| #1=(|List| |VarSet|)) (#2=#:G643 NIL)
          (#3=#:G642 #4=(|Boolean|)) (#5=#:G644 #4#) (#6=#:G652 NIL) (|vv| NIL)
          (#7=#:G639 NIL) (#8=#:G638 #1#) (#9=#:G640 #1#) (#10=#:G651 NIL)
          (|f| NIL))
...
(SDEFUN |IDEAL;dimension;$I;27| ((I $) ($ |Integer|))
        (SPROG
         ((#1=#:G654 NIL) (#2=#:G653 #3=(|List| |VarSet|)) (#4=#:G655 #3#)
          (#5=#:G658 NIL) (|g| NIL))
         (SEQ
          (SPADCALL I
                    (PROGN
...
(SDEFUN |IDEAL;leadingIdeal;2$;28| ((I $) ($ $))
        (SPROG
         ((#1=#:G663 NIL) (|f| NIL) (#2=#:G662 NIL) (|Idl| (|List| |DPoly|)))
...
(SDEFUN |IDEAL;monompol|
        ((|df| |List| (|NonNegativeInteger|)) (|lcf| F) (|lv| |List| |VarSet|)
         ($ |Polynomial| F))
        (SPROG
         ((|g| (|Polynomial| F)) (#1=#:G667 NIL) (|dd| NIL) (#2=#:G668 NIL)
          (|v| NIL))
...
(SDEFUN |IDEAL;relationsIdeal;LSt;30|
        ...
        (SPROG
         ((|solsn| (|List| (|Polynomial| F))) (|g| #1=(|Polynomial| F))
          (#2=#:G688 NIL) (#3=#:G687 #4=(|Polynomial| F)) (#5=#:G689 #4#)
          (#6=#:G712 NIL) (|p| NIL) (|j| NIL)
          (|vdq| (|Vector| (|NonNegativeInteger|))) (|q| (|nPoly|)) (|lcq| (F))
          (|dq| (|nExponent|)) (#7=#:G711 NIL) (|lf| (|List| |nPoly|))
          (#8=#:G697 NIL) (|n| (|Expon|))
          (|leq| (|List| (|Equation| (|Polynomial| F)))) (#9=#:G709 NIL)
          (#10=#:G710 NIL) (|pol| #1#) (#11=#:G708 NIL)
          (|npol| (|List| (|Polynomial| F))) (#12=#:G707 NIL) (|v| NIL)
          (#13=#:G706 NIL) (|lp| (|List| (|Polynomial| F))) (|f| (|DPoly|))
          (|lcf| (F)) (|df| (|List| (|NonNegativeInteger|)))
          (|vec2| (|Vector| (|NonNegativeInteger|))) (#14=#:G705 NIL) (|i| NIL)
          (|gp|
           (CATEGORY |package|
          ...
          (|lv1| (|List| |VarSet1|)) (#15=#:G676 NIL) (#16=#:G704 NIL)
          (|vv| NIL) (#17=#:G703 NIL)
          (|VarSet1|
          ...
          (|nvar| (|List| (|Symbol|))) (#18=#:G702 NIL) (#19=#:G701 NIL)
          (|vl| (|List| (|Symbol|))) (#20=#:G700 NIL) (#21=#:G699 NIL)
          (|lvint| #22=(|List| |VarSet|)) (#23=#:G670 NIL) (#24=#:G669 #22#)
          (#25=#:G671 #22#) (#26=#:G698 NIL) (|nf| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |IDEAL;ideal;L$;33| ((|Id| |List| |DPoly|) ($ $))
        (SPROG ((#1=#:G719 NIL) (|f| NIL) (#2=#:G718 NIL))
               (SEQ
                (CONS
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |PolynomialIdeal| (&REST #1=#:G726)
  (SPROG NIL
         (PROG (#2=#:G727)
           (RETURN
            (COND
