           ...
           (SEQ
            (SEQ (LETT |q| (|GOSPER;RF2QIfCan| |aquo| $))
                 (EXIT
                  (COND
                   ((QEQCAR |q| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G404)))
                   ('T
                    (SEQ
                     (LETT |u|
...
(SDEFUN |GOSPER;GosperF|
        ...
        (SPROG
         ((#1=#:G452 NIL)
          ...
          (#11=#:G441 NIL) (#12=#:G440 #10#) (#13=#:G442 #10#) (#14=#:G457 NIL)
...
(SDEFUN |GOSPER;GosperPQR|
        ...
        (SPROG
         ((|pn| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          ...
          (#6=#:G472 #5#) (#7=#:G480 NIL) (|i| NIL) (|rn| #2#) (#8=#:G465 NIL)
          (|qn| #1#)
          (|gn| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          (|rtp| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          (#9=#:G479 NIL) (|rt| (|Union| (|Integer|) #10="failed"))
          (|js| (|List| (|Integer|))) (#11=#:G461 NIL) (#12=#:G478 NIL)
          (|fe| NIL) (#13=#:G477 NIL)
          (|fres|
           (|Factored|
            (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V)))
              ...
              (LETT |js|
                    (PROGN
                     ...
                     (SEQ (LETT |fe| NIL)
                          ...
                          (EXIT (NREVERSE #13#)))))
              (SEQ (LETT |rt| NIL) (LETT #9# |js|) G190
                   (COND
...
(SDEFUN |GOSPER;GosperDegBd|
        ...
        (SPROG
         ((|k0| (|Union| (|Integer|) "failed")) (#1=#:G482 NIL)
        ...
        (SPROG
         ((|up|
           #1=(|SparseUnivariatePolynomial|
               (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V)))
          (|pow| (|NonNegativeInteger|)) (|unom| #1#) (#2=#:G495 NIL) (|v| NIL)
          (|vlist| (|List| V)))
         (SEQ
          (COND
...
(SDEFUN |GOSPER;linearAndNNIntRoot|
        ...
        (SPROG
         ((|rt| (|Fraction| (|Integer|))) (#1=#:G508 NIL)
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((QEQCAR |p1| 1)
                        (PROGN (LETT #1# (CONS 1 #4="failed")) (GO #5=#:G505)))
                       (#3#
                        (SEQ
                         (LETT |p0|
...
(DEFUN |GosperSummationMethod| (&REST #1=#:G509)
  (SPROG NIL
         (PROG (#2=#:G510)
           (RETURN
            (COND
