...
(SDEFUN |PWFFINTB;compLocalBasisOverExt|
        ...
        (SPROG
         ((|bDen| (R)) (|p| (|Union| R #1="failed")) (|bInv| (|Matrix| R))
          ...
          (|deg| (|PositiveInteger|)) (#9=#:G411 NIL)
          (|primaries|
           (|List|
            (|SparseUnivariatePolynomial| (|SparseUnivariatePolynomial| E))))
          (#10=#:G432 NIL) (|ff| NIL) (#11=#:G431 NIL)
          (|redFactors| (|List| (|SparseUnivariatePolynomial| |sae|)))
          (#12=#:G430 NIL) (|f| NIL) (#13=#:G429 NIL)
          (|factorListSAE|
           (|List|
            (|Record|
             (|:| |flag|
                   ...
                   (CATEGORY |package|
                    (IF (|has| K . #4#)
                        (IF (|has| K . #5#)
                            . #6#)
                        . #7#))))
          (|irrPoly| (|SparseUnivariatePolynomial| K)) (#20=#:G403 NIL)
        ...
        (SPROG
         ((|index| (R))
          ...
          (|base|
           (|Record| (|:| |basis| (|Matrix| R)) (|:| |basisDen| R)
                     (|:| |basisInv| (|Matrix| R))))
          (|degPp| (|NonNegativeInteger|)) (#1=#:G469 NIL) (|pp| NIL)
          (#2=#:G470 NIL) (|k| NIL) (#3=#:G471 NIL) (|qq| NIL)
          (|degPrime| (|NonNegativeInteger|)) (|henselFactors| #4=(|List| UP))
          (|henselInfo| (|Record| (|:| |plist| #4#) (|:| |modulo| R)))
          (|deg| (|PositiveInteger|)) (#5=#:G448 NIL) (|primaries| (|List| UP))
          (#6=#:G468 NIL) (|ff| NIL) (#7=#:G467 NIL)
          (|redPrimaries| (|List| (|SparseUnivariatePolynomial| |sae|)))
          (#8=#:G466 NIL) (|f| NIL) (#9=#:G465 NIL)
          (|expons| (|List| (|NonNegativeInteger|))) (#10=#:G464 NIL)
          (#11=#:G463 NIL) (|primes| (|List| UP)) (#12=#:G462 NIL)
          (#13=#:G461 NIL)
          (|redPrimes| (|List| (|SparseUnivariatePolynomial| |sae|)))
          (#14=#:G460 NIL) (#15=#:G459 NIL)
          (|factorListSAE|
           (|List|
            (|Record|
             (|:| |flag|
...
(SDEFUN |PWFFINTB;localIntegralBasis;RR;5|
        ...
        (SPROG
         ...
         (SEQ (LETT |p| (SPADCALL (QREFELT $ 70)))
...
(SDEFUN |PWFFINTB;listSquaredFactors| ((|px| R) ($ |List| R))
        (SPROG
         ((|ans| (|List| R)) (#1=#:G481 NIL) (|f| NIL)
          (|factored| (|Factored| R)))
         (SEQ (LETT |ans| NIL) (LETT |factored| (SPADCALL |px| (QREFELT $ 74)))
              (SEQ (LETT |f| NIL)
                   (LETT #1# (SPADCALL |factored| (QREFELT $ 78))) G190
                   (COND
         ...
         ((|runningRbinv| #1=(|Matrix| R)) (|runningRb| #1#)
          ...
          (|lb|
           (|Record| (|:| |basis| #3#) (|:| |basisDen| R) (|:| |basisInv| #2#)
                     (|:| |discr| R)))
          (#4=#:G489 NIL) (|prime| NIL) (|redDisc| (R)) (|singList| (|List| R))
          (|n| (|PositiveInteger|)) (|p| (UP)))
         (SEQ (LETT |p| (SPADCALL (QREFELT $ 70)))
              (LETT |disc| (SPADCALL |p| (QREFELT $ 37)))
              (LETT |n| (SPADCALL (QREFELT $ 66)))
...
(DEFUN |PAdicWildFunctionFieldIntegralBasis| (&REST #1=#:G490)
  (SPROG NIL
         (PROG (#2=#:G491)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 86
                                            '(1 10 0 7 11 2 14 12 13 8 15 1 12
                                              ...
                                              0 59 4 62 60 8 61 7 43 63 2 35 64
                                              0 0 65 0 9 43 66 3 68 51 61 67 35
                                              69 0 9 8 70 1 73 72 7 74 1 72 77
                                              0 78 2 40 0 7 0 79 2 40 0 0 0 80
                                              2 81 40 40 7 82 1 40 0 0 83 2 84
                                              40 40 7 85 1 0 7 8 34 1 0 51 7 71
                                              0 0 51 86)))))
           '|lookupComplete|)) 
