...
(SDEFUN |SETLAT;complement;2$;4| ((|a| $) ($ $))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G391 NIL) (|c| NIL)
          (#2=#:G390 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;complement;$L$;5| ((|a| $) (|pseudoTop| |List| S) ($ $))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G398 NIL) (|c| NIL)
          (#2=#:G397 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;coerce;$Of;9| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|oup| (|List| (|OutputForm|))) (#1=#:G405 NIL) (|x| NIL)
          (|inp| ($)))
...
(DEFUN |SubsetLattice| (&REST #1=#:G406)
  (SPROG NIL
         (PROG (#2=#:G407)
           (RETURN
            (COND
