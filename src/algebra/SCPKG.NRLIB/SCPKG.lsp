         ...
         ((#1=#:G404 NIL)
          (|res|
           (|Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
                     (|:| |basis| (|List| (|Vector| R)))))
          (#2=#:G408 NIL) (|i| NIL) (|transitionMatrix| (|Matrix| R))
...
(SDEFUN |SCPKG;structuralConstants;LV;3|
        ...
        (SPROG
         ((#1=#:G422 NIL) (|k| NIL) (|covec| (|Vector| R)) (#2=#:G421 NIL)
          (|j| NIL) (#3=#:G420 NIL) (|i| NIL) (|sC| (|Vector| (|Matrix| R)))
          (#4=#:G417 NIL) (#5=#:G419 NIL) (#6=#:G418 NIL)
          (|m| (|NonNegativeInteger|)) (#7=#:G409 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |SCPKG;structuralConstants;LMV;4|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|p| (|Polynomial| R)) (#1=#:G435 NIL) (|j| NIL) (#2=#:G434 NIL)
...
(SDEFUN |SCPKG;structuralConstants;LMV;5|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|r| (|Fraction| (|Polynomial| R))) (#1=#:G449 NIL) (|j| NIL)
          (#2=#:G448 NIL) (|i| NIL) (|s| (|Symbol|))
...
(DEFUN |StructuralConstantsPackage| (#1=#:G450)
  (SPROG NIL
         (PROG (#2=#:G451)
           (RETURN
            (COND
