...
(SDEFUN |IBPTOOLS;mapMatrixIfCan;MMU;4|
        ...
        (SPROG
         ((#1=#:G436 NIL) (|poly| (|Union| R "failed")) (#2=#:G438 NIL)
          (|j| NIL) (#3=#:G437 NIL) (|i| NIL) (|matOut| (|Matrix| R))
...
(DEFUN |IntegralBasisPolynomialTools| (&REST #1=#:G445)
  (SPROG NIL
         (PROG (#2=#:G446)
           (RETURN
            (COND
