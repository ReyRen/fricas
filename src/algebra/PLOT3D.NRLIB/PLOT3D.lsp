...
(SDEFUN |PLOT3D;join|
        ...
        (SPROG
         ((|u| (|Segment| (|DoubleFloat|))) (#1=#:G411 NIL) (|r| NIL)
          (|rr|
           (|Record|
            (|:| |source|
...
(SDEFUN |PLOT3D;tValues;$L;22| ((|plot| $) ($ |List| (|List| (|DoubleFloat|))))
        (SPROG
         ((|outList| (|List| (|List| (|DoubleFloat|)))) (#1=#:G434 NIL)
          (|curve| NIL))
...
(SDEFUN |PLOT3D;select|
        ((|l| |List| (|Point| (|DoubleFloat|)))
         ...
         ($ |DoubleFloat|))
        (SPROG ((|m| #1#) (|fp| #1#) (#2=#:G439 NIL) (|p| NIL))
...
(SDEFUN |PLOT3D;rangeRefine|
        ...
        (SPROG
         ((|zRange| #4=(|Segment| (|DoubleFloat|))) (|yRange| #4#)
          ...
          (#5=#:G481 NIL) (|i| NIL) (|d| #6=(|DoubleFloat|)) (|n| (|Integer|))
          (|q| (|List| (|Point| (|DoubleFloat|))))
          (|c| (|List| (|DoubleFloat|))) (|s| #6#) (#7=#:G480 NIL) (|f| #1#)
...
(SDEFUN |PLOT3D;adaptivePlot|
        ...
        (SPROG
         ((|p| #3#) (|t| #2#) (|tj| #4=(|DoubleFloat|)) (|n| (|Integer|))
          (#5=#:G523 NIL) (|sp| #6=(|List| (|Point| (|DoubleFloat|))))
...
(SDEFUN |PLOT3D;basicPlot|
        ...
        (SPROG
         ((|zRange| #1=(|Segment| (|DoubleFloat|))) (|yRange| #1#)
          ...
          (|t| (|List| (|DoubleFloat|))) (|l| (|DoubleFloat|)) (#2=#:G548 NIL)
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (|scrres| (|Integer|)) (#2=#:G589 NIL) (|c| NIL) (#3=#:G588 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G587 NIL) (#5=#:G586 NIL)
          (|tRange| (|Segment| (|DoubleFloat|))))
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#2=#:G599 NIL) (|c| NIL) (#3=#:G598 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G597 NIL) (#5=#:G596 NIL))
         (SEQ (SETELT $ 10 0)
              (LETT |curves|
                    (PROGN
                     (LETT #5# NIL)
...
(SDEFUN |PLOT3D;pointPlot;M4S$;33|
        ((|f| |Mapping| (|Point| (|DoubleFloat|)) (|DoubleFloat|))
         ...
         (|zRange| |Segment| (|DoubleFloat|)) ($ $))
        (SPROG ((|p| ($)))
               (SEQ (LETT |p| (SPADCALL |f| |tRange| (QREFELT $ 75)))
                    (QSETVELT |p| 0
...
(SDEFUN |PLOT3D;coerce;$Of;37| ((|r| $) ($ |OutputForm|))
        (SPROG
         ((|f| (|List| (|OutputForm|))) (|l| (|List| #1=(|OutputForm|)))
          (#2=#:G636 NIL) (|p| NIL) (#3=#:G635 NIL) (|h| (|OutputForm|))
          (|zRange| #1#) (|yRange| #1#) (|xRange| #1#) (#4=#:G634 NIL)
          (|curve| NIL) (|tRange| (|OutputForm|)) (|tSymbol| #5=(|OutputForm|))
          (|zSymbol| #5#) (|ySymbol| #5#) (|xSymbol| #5#) (|spaces| #5#))
         (SEQ (LETT |spaces| (SPADCALL "   " (QREFELT $ 82)))
              (LETT |xSymbol| (SPADCALL "x = " (QREFELT $ 82)))
              (LETT |ySymbol| (SPADCALL "y = " (QREFELT $ 82)))
              (LETT |zSymbol| (SPADCALL "z = " (QREFELT $ 82)))
              (LETT |tSymbol| (SPADCALL "t = " (QREFELT $ 82)))
              (LETT |tRange|
              ...
              (SEQ (LETT |curve| NIL) (LETT #4# (QVELT |r| 4)) G190
                   ...
                   (SEQ
                    (LETT |xRange|
                          (SPADCALL
                           (SPADCALL (QVELT |curve| 1) 1 (QREFELT $ 84))
                           (QREFELT $ 83)))
                    (LETT |yRange|
                          (SPADCALL
                           (SPADCALL (QVELT |curve| 1) 2 (QREFELT $ 84))
                           (QREFELT $ 83)))
                    (LETT |zRange|
                          (SPADCALL
                           (SPADCALL (QVELT |curve| 1) 3 (QREFELT $ 84))
                           (QREFELT $ 83)))
                    (LETT |l|
                    ...
                    (EXIT
                     (LETT |f|
                           (CONS (SPADCALL (CONS |h| |l|) (QREFELT $ 90))
                                 |f|))))
