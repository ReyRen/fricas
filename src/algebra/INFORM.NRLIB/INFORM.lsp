...
(SDEFUN |INFORM;flatten;2$;9| ((|s| $) ($ $))
        (SPROG
         ((#1=#:G415 NIL) (|u| NIL) (#2=#:G414 NIL) (#3=#:G413 NIL)
          (#4=#:G412 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (|n| (|NonNegativeInteger|)) (#5=#:G411 NIL) (|l| (|List| $))
          (|x| NIL) (#6=#:G410 NIL) (|sy| (|Symbol|)))
         (SEQ
          (COND
           ((OR (SPADCALL |s| (QREFELT $ 25))
            ...
            |s|)
           ('T
            (SEQ (LETT |sy| (SPADCALL (QREFELT $ 30))) (LETT |n| 0)
                 (LETT |l2|
                       (PROGN
                        (LETT #6# NIL)
                        (SEQ (LETT |x| NIL)
...
(SDEFUN |INFORM;flatten0|
        ...
        (SPROG
         ((#1=#:G428 NIL) (|u| NIL) (#2=#:G427 NIL) (#3=#:G426 NIL)
          (#4=#:G425 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (#5=#:G424 NIL) (|l| (|List| $)) (|x| NIL) (#6=#:G423 NIL) (|a| ($)))
         (SEQ
...
(SDEFUN |INFORM;unparse;$S;12| ((|x| $) ($ |String|))
        (SPROG ((#1=#:G436 NIL) (|a| NIL) (#2=#:G435 NIL) (|s| ($)))
               (SEQ
                (COND
                 ((SPADCALL (LETT |s| (|unparseInputForm| |x|)) (QREFELT $ 25))
                  (|INFORM;strsym| |s| $))
                 ('T
                  (SPADCALL
                   (PROGN
                    (LETT #2# NIL)
                    (SEQ (LETT |a| NIL)
                         (LETT #1# (SPADCALL |s| (QREFELT $ 26))) G190
                         (COND
...
(SDEFUN |INFORM;declare;LS;14| ((|signature| |List| $) ($ |Symbol|))
        (SPROG ((|name| (|Symbol|)))
               (SEQ
                (|declare| (LETT |name| (SPADCALL (QREFELT $ 30))) |signature|)
                (EXIT |name|)))) 
...
(SDEFUN |INFORM;binary;$L$;17| ((|op| $) (|args| |List| $) ($ $))
        (SPROG ((|n| (|NonNegativeInteger|)))
               (SEQ (LETT |n| (SPADCALL |args| (QREFELT $ 52)))
                    (EXIT
...
(SDEFUN |INFORM;tuplify| ((|l| |List| (|Symbol|)) ($ $))
        (SPROG ((#1=#:G449 NIL) (|x| NIL) (#2=#:G448 NIL))
               (SEQ
                (COND
...
(SDEFUN |INFORM;function;$LS$;19|
        ...
        (SPROG ((#1=#:G454 NIL) (|x| NIL) (#2=#:G453 NIL) (|nn| ($)))
               (SEQ
                (LETT |nn|
                      (SPADCALL
                       (SPADCALL (+ 1 (LENGTH |l|))
