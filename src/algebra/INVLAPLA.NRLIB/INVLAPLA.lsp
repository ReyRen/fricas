...
(SDEFUN |INVLAPLA;freeOf?|
        ...
        (SPROG
         ((#1=#:G397 NIL) (#2=#:G396 #3=(|Boolean|)) (#4=#:G398 #3#)
          (#5=#:G400 NIL) (|c| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |INVLAPLA;iltsqfr|
        ((|r| |Fraction| (|SparseUnivariatePolynomial| F)) (|t| F) ($ F))
        (SPROG
         ((#1=#:G419 NIL) (#2=#:G418 (F)) (#3=#:G420 (F)) (#4=#:G426 NIL)
          (|a| NIL) (#5=#:G427 NIL) (|b| NIL)
          (|nl| (|List| (|SparseUnivariatePolynomial| F))) (#6=#:G416 NIL)
          (|ql| (|List| (|SparseUnivariatePolynomial| F))) (#7=#:G425 NIL)
          (|qq| NIL) (#8=#:G424 NIL) (|q| (|SparseUnivariatePolynomial| F))
...
(SDEFUN |INVLAPLA;iltirred|
        ...
        (SPROG
         ((#1=#:G433 NIL) (#2=#:G432 (F)) (#3=#:G434 (F)) (#4=#:G439 NIL)
...
(DEFUN |InverseLaplaceTransform| (&REST #1=#:G440)
  (SPROG NIL
         (PROG (#2=#:G441)
           (RETURN
            (COND
