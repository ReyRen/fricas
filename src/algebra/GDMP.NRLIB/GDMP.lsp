...
(SDEFUN |GDMP;totalDegree;$Nni;2| ((|p| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G410 NIL) (#2=#:G409 #3=(|NonNegativeInteger|)) (#4=#:G411 #3#)
          (#5=#:G416 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;monomial;$OvlNni$;3|
        ((|p| $) (|v| |OrderedVariableList| |vl|) (|e| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G421 NIL) (#2=#:G423 NIL) (|z| NIL) (#3=#:G422 NIL)
...
(SDEFUN |GDMP;listCoef| ((|p| $) ($ |List| R))
        (SPROG ((#1=#:G429 NIL) (|rec| NIL) (#2=#:G428 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;mainVariable;$U;6|
        ...
        (SPROG
         ((#2=#:G441 NIL) (|vv| (|OrderedVariableList| |vl|)) (#3=#:G431 NIL)
          (#4=#:G442 NIL) (|v| NIL))
         (SEQ
          (EXIT
                         ...
                         (EXIT
                          (COND
                           ((SPADCALL (SPADCALL |p| |vv| (QREFELT $ 35)) 0
                                      (QREFELT $ 36))
                            (PROGN (LETT #2# (CONS 0 |vv|)) (GO #5=#:G440))))))
...
(SDEFUN |GDMP;degree;$LL;13|
        ...
        (SPROG ((#1=#:G469 NIL) (|v| NIL) (#2=#:G468 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;minimumDegree;$LL;14|
        ((|p| $) (|lv| |List| (|OrderedVariableList| |vl|))
         ($ |List| (|NonNegativeInteger|)))
        (SPROG ((#1=#:G473 NIL) (|v| NIL) (#2=#:G472 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |v| NIL) (LETT #1# |lv|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #2#
                              (CONS (SPADCALL |p| |v| (QREFELT $ 50)) #2#))))
                      (LETT #1# (CDR #1#)) (GO G190) G191
                      (EXIT (NREVERSE #2#))))))) 
...
(SDEFUN |GDMP;maxNorm| ((|p| $) ($ R))
        (SPROG ((|m| (R)) (#1=#:G482 NIL) (|r| NIL) (|l| (|List| R)))
               (SEQ (LETT |l| NIL) (LETT |m| (|spadConstant| $ 60))
                    (SEQ (LETT |r| NIL) (LETT #1# (|GDMP;listCoef| |p| $)) G190
                         ...
                         (SEQ
                          (EXIT
                           (COND
                            ((SPADCALL |r| |m| (QREFELT $ 61)) (LETT |m| |r|))
                            ((SPADCALL (SPADCALL |r| (QREFELT $ 62)) |m|
                                       (QREFELT $ 61))
                             (LETT |m| (SPADCALL |r| (QREFELT $ 62)))))))
...
(SDEFUN |GDMP;variables;$L;19|
        ...
        (SPROG
         ((#1=#:G492 NIL) (#2=#:G498 NIL) (|i| NIL) (#3=#:G497 NIL)
          (#4=#:G496 NIL) (|tdeg| (E))
          (|maxdeg| (|Vector| (|NonNegativeInteger|))))
         (SEQ (LETT |maxdeg| (SPADCALL (QREFELT $ 11) 0 (QREFELT $ 66)))
              (SEQ G190
                   (COND
                    ((NULL (NULL (SPADCALL |p| (QREFELT $ 13)))) (GO G191)))
                   (SEQ (LETT |tdeg| (SPADCALL |p| (QREFELT $ 67)))
                        (LETT |p| (SPADCALL |p| (QREFELT $ 68)))
                        (EXIT
...
(SDEFUN |GDMP;reorder;$L$;20| ((|p| $) (|perm| |List| (|Integer|)) ($ $))
        (SPROG
         ((|q| ($)) (#1=#:G508 NIL) (#2=#:G510 NIL) (|j| NIL) (#3=#:G509 NIL)
          (#4=#:G507 NIL) (|term| NIL) (#5=#:G506 NIL))
         (SEQ
          (COND
...
(SDEFUN |GDMP;univariate;$OvlSup;21|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G517 NIL)
          (#2=#:G519 NIL) (|i| NIL) (#3=#:G518 NIL)
          (|locv| (|PositiveInteger|)) (|exp| (E)))
         (SEQ
          (COND ((SPADCALL |p| (QREFELT $ 13)) (|spadConstant| $ 79))
                ('T
                 (SEQ (LETT |exp| (SPADCALL |p| (QREFELT $ 67)))
                      (LETT |locv| (SPADCALL |v| (QREFELT $ 24)))
                      (LETT |deg| 0)
                      (LETT |nexp|
                            (SPADCALL
                       ...
                       (SPADCALL
                        (SPADCALL
                         (SPADCALL (SPADCALL |p| (QREFELT $ 40)) |nexp|
                                   (QREFELT $ 28))
                         |deg| (QREFELT $ 80))
                        (SPADCALL (SPADCALL |p| (QREFELT $ 68)) |v|
                                  (QREFELT $ 47))
                        (QREFELT $ 81))))))))) 
...
(SDEFUN |GDMP;eval;$LL$;26|
        ((|p| $) (|Lvar| |List| (|OrderedVariableList| |vl|))
         (|Lpval| |List| $) ($ $))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G535 NIL) (|mvar| NIL) (#2=#:G534 NIL)
          (|nlvar| (|List| (|OrderedVariableList| |vl|))))
         (SEQ (LETT |nlvar| (SPADCALL (ELT $ 91) |Lvar| (QREFELT $ 100)))
              (LETT |nlpval|
         ...
         (SEQ (LETT |v| (SPADCALL |p| (QREFELT $ 38)))
              (EXIT
               (COND
                ...
                ('T
                 (SEQ (LETT |q| (SPADCALL |p| (QCDR |v|) (QREFELT $ 47)))
                      (LETT |ans| (|spadConstant| $ 114))
                      (SEQ G190
                           (COND
                            ((NULL
                              (SPADCALL |q| (|spadConstant| $ 79)
                                        (QREFELT $ 115)))
                             (GO G191)))
                           (SEQ
                            (LETT |ans|
                                  (SPADCALL |ans|
                                            (SPADCALL
                                             ...
                                             (QREFELT $ 113))
                                            (QREFELT $ 117)))
                            (EXIT (LETT |q| (SPADCALL |q| (QREFELT $ 110)))))
                           NIL (GO G190) G191 (EXIT NIL))
                      (EXIT |ans|)))))))) 
...
(SDEFUN |GDMP;content;$R;30| ((|p| $) ($ R))
        (SPROG
         ((#1=#:G550 NIL) (#2=#:G549 (R)) (#3=#:G551 (R)) (#4=#:G554 NIL)
          (|t| NIL))
         (SEQ
                       ...
                       (SEQ
                        (EXIT
                         (PROGN
                          (LETT #3# (QCDR |t|))
                          (COND
                           (#1# (LETT #2# (SPADCALL #2# #3# (QREFELT $ 124))))
...
(SDEFUN |GDMP;gcd;3$;31| ((|p| $) (|q| $) ($ $))
        (SPROG
         ((|r| (R)) (|qv| #1=(|Union| (|OrderedVariableList| |vl|) "failed"))
          (|pv| #1#))
         (SEQ (LETT |pv| (SPADCALL |p| (QREFELT $ 38)))
              (EXIT
               (COND
                ((QEQCAR |pv| 1)
                 (COND
                  ((SPADCALL (LETT |r| (SPADCALL |p| (QREFELT $ 40)))
                  ...
                  (#2='T
                   (SPADCALL
                    ...
                    (QREFELT $ 84)))))
                (#2#
                 (SEQ (LETT |qv| (SPADCALL |q| (QREFELT $ 38)))
                      (EXIT
                       (COND
                        ((QEQCAR |qv| 1)
                         (COND
                          ((SPADCALL (LETT |r| (SPADCALL |q| (QREFELT $ 40)))
                                     (|spadConstant| $ 60) (QREFELT $ 126))
                           |p|)
                          (#2#
                           (SPADCALL
...
(SDEFUN |GDMP;coerce;$Of;34| ((|p| $) ($ |OutputForm|))
        (SPROG
         ((|lt| (|List| #1=(|OutputForm|))) (|l| (|List| #1#)) (#2=#:G591 NIL)
          (|i| NIL) (#3=#:G590 NIL) (|t| NIL) (|vl1| (|List| (|OutputForm|)))
          (#4=#:G589 NIL) (|v| NIL) (#5=#:G588 NIL))
         (SEQ
          (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial| (&REST #1=#:G627)
  (SPROG NIL
         (PROG (#2=#:G628)
           (RETURN
            (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G626 NIL) (|pv$| NIL) (#2=#:G618 NIL) (#3=#:G619 NIL) (#4=#:G620 NIL)
    (#5=#:G621 NIL) (#6=#:G622 NIL) (#7=#:G623 NIL) (#8=#:G624 NIL)
    (#9=#:G625 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
