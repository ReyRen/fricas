...
(SDEFUN |DELTAC;dim1todim0|
        ((|dim1| |List| (|List| (|Integer|))) (|n| . #1=(|NonNegativeInteger|))
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#2=#:G418 NIL) (|x| NIL)
          (#3=#:G417 NIL) (|m3| (|NonNegativeInteger|)) (#4=#:G405 NIL)
          (#5=#:G416 NIL) (|m2| NIL) (#6=#:G415 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #1#) (#7=#:G401 NIL)
          (#8=#:G414 NIL) (#9=#:G413 NIL))
         (SEQ (LETT |m| |n|)
...
(SDEFUN |DELTAC;deltaComplex;FscB$;4|
        ...
        (SPROG
         ((|vs| #1=(|List| VS)) (|previousFaceList| (|List| (|OrientedFacet|)))
          ...
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#2=#:G458 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|OrientedFacet|)))
          (#3=#:G457 NIL) (|oldFaceHigh| NIL) (#4=#:G456 NIL) (|x| NIL)
          (#5=#:G455 NIL) (|m3| (|NonNegativeInteger|)) (#6=#:G430 NIL)
          (#7=#:G454 NIL) (|m2| NIL) (#8=#:G453 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #9=(|NonNegativeInteger|))
          (#10=#:G426 NIL) (#11=#:G452 NIL) (#12=#:G451 NIL)
          (|map2| (|List| (|List| (|Integer|)))) (|fm| (|List| (|Integer|)))
          (#13=#:G450 NIL) (#14=#:G448 NIL) (|gradeList| NIL) (#15=#:G449 NIL)
          (|grn| NIL) (|allFacetsGraded| (|List| (|List| (|OrientedFacet|))))
          (#16=#:G447 NIL) (|l| NIL) (#17=#:G446 NIL)
...
(SDEFUN |DELTAC;deltaComplex;Fcc$;5| ((|fsc| |FiniteCubicalComplex| VS) ($ $))
        (SPROG
         ((|fp| (|List| (|List| (|List| (|Integer|)))))
          ...
          (|faceMaps| (|List| (|List| (|List| (|Integer|)))))
          (|map1| (|List| (|List| (|Integer|))))
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#1=#:G475 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|CubicalFacet|)))
          (#2=#:G474 NIL) (|oldFaceHigh| NIL) (#3=#:G472 NIL) (|gradeList| NIL)
          (#4=#:G473 NIL) (|grn| NIL)
          (|allFacetsGraded| (|List| (|List| (|CubicalFacet|))))
          (#5=#:G471 NIL) (|gradedList| NIL)
...
(SDEFUN |DELTAC;faceMap;$NniL;8|
        ...
        (SPROG
         ((#1=#:G483 NIL) (|maps1| (|List| (|List| (|List| (|Integer|))))))
         (SEQ
          (EXIT
           (SEQ (LETT |maps1| (REVERSE (QCDR |s|)))
                (COND
                 ((SPADCALL |n| (LENGTH |maps1|) (QREFELT $ 10))
                  (PROGN (LETT #1# NIL) (GO #2=#:G482))))
...
(SDEFUN |DELTAC;chain;$Cc;9| ((|s| $) ($ |ChainComplex|))
        (SPROG
         ((|res| (|List| (|Matrix| (|Integer|)))) (|m| (|Matrix| (|Integer|)))
          ...
          (|v2| (|Integer|)) (#1=#:G495 NIL) (|v| NIL) (#2=#:G493 NIL)
          (|u| NIL) (#3=#:G494 NIL) (|nu| NIL)
          (|n_cols| (|NonNegativeInteger|)) (#4=#:G492 NIL) (|faces| NIL)
...
(SDEFUN |DELTAC;oneSkeleton;$Ug;13|
        ...
        (SPROG
         ((|nodes|
          ...
          (|to1| #3=(|NonNegativeInteger|)) (|from1| #3#) (#4=#:G512 NIL)
...
(SDEFUN |DELTAC;linksInTree|
        ((|res| |List| (|List| (|Integer|))) (|a| |Tree| (|Integer|))
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((#1=#:G520 NIL) (|x| NIL) (|newLink| (|List| #2=(|Integer|)))
          (|toNode| #2#) (#3=#:G519 NIL) (|fromNode| #2#))
...
(SDEFUN |DELTAC;containsEdge?|
        ((|edge| |List| (|Integer|)) (|edges| |List| (|List| (|Integer|)))
         ($ |Boolean|))
        (SPROG
         ((#1=#:G531 NIL) (|t2| #2=(|Integer|)) (|s2| #2#) (#3=#:G532 NIL)
          (|e| NIL) (|t| #2#) (|s| #2#))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< (LENGTH |edge|) 2) (PROGN (LETT #1# NIL) (GO #4=#:G530))))
...
(SDEFUN |DELTAC;fundamentalGroup;$2BGp;17|
        ((|s| $) (|simplify| |Boolean|) (|trace| |Boolean|)
         ($ |GroupPresentation|))
        (SPROG
         ((#1=#:G546 NIL) (|gp| (|GroupPresentation|))
          (|generators| (|List| (|NonNegativeInteger|))) (#2=#:G553 NIL)
          (|x| NIL) (|m| (|NonNegativeInteger|))
          (|rules| (|List| (|List| (|Integer|)))) (|rule| (|List| (|Integer|)))
          (#3=#:G552 NIL) (|vertn| NIL) (#4=#:G551 NIL) (|t| NIL)
          (|polygons| #5=(|List| (|List| (|Integer|)))) (#6=#:G549 NIL)
          (|edge| NIL) (#7=#:G550 NIL) (|edgen| NIL)
          (|edgesInTree| (|List| (|Boolean|))) (#8=#:G548 NIL) (|y| NIL)
          (#9=#:G547 NIL) (|res| (|List| (|List| (|Integer|)))) (|edges| #5#)
          (|span| (|Tree| (|Integer|)))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND ((NULL |simplify|) (PROGN (LETT #1# |gp|) (GO #10=#:G545))))
...
(SDEFUN |DELTAC;equalSimplex|
        ...
        (SPROG
         ((|offset| (|Integer|)) (#1=#:G561 NIL) (#2=#:G562 NIL) (|n| NIL)
...
(SDEFUN |DELTAC;=;2$B;19| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G566 NIL) (|len| (|NonNegativeInteger|))
