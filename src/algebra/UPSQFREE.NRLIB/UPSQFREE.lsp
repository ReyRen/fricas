...
(SDEFUN |UPSQFREE;squareFreePart;2P;2| ((|p| P) ($ P))
        (SPROG
         ((#1=#:G393 NIL) (#2=#:G392 (P)) (#3=#:G394 (P)) (#4=#:G396 NIL)
          (|f| NIL) (|s| (|Factored| P)))
         (SEQ
          (SPADCALL
          ...
          (|lffe|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|lcp| (RC)) (#2=#:G435 NIL) (|i| (|NonNegativeInteger|)) (|pi| (P))
          (|di| (P)) (#3=#:G432 NIL) (|ci| (P)) (|a| (P)) (|c| (P)) (|u| (P))
          (|#G11|
               ...
               (COND
                ...
                ('T
                 (SEQ (LETT |i| 0) (LETT |lffe| NIL)
                           ...
                           (SEQ
                            (EXIT
                             (SEQ
                              ...
                              (EXIT
                               (COND
                                ((SPADCALL (SPADCALL |pi| (QREFELT $ 30)) 0
                                           (QREFELT $ 40))
                                 (PROGN
                                  (LETT #1#
                                        (SEQ
                      ...
                      (EXIT
                       (SPADCALL (SPADCALL |lcp| (QREFELT $ 43)) |lffe|
                                 (QREFELT $ 35)))))))))) 
         ...
         ((|lffe|
          ...
          (|lsnil|
           (|List|
            (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#5=#:G468 NIL) (|ffe| NIL) (#6=#:G467 NIL)
          (|redSqfr| (|Factored| P)) (#7=#:G453 NIL) (|dunit| (P)) (|pi| (P))
          (|lc| (RC)) (#8=#:G456 NIL) (|i| (|NonNegativeInteger|)) (|ci| (P))
            ...
            (#9='T
             (SEQ
              ...
              (SEQ G190
                         ...
                         (COND
                          ((EQL (SPADCALL |diprev| (QREFELT $ 30))
                           ...
                           (SEQ
                            ...
                            (EXIT
                             (LETT |dunit|
                                   (SPADCALL (SPADCALL |lc| |i| (QREFELT $ 41))
                                             |dunit| (QREFELT $ 44))))))
                          ('T
                           (SEQ
                            (LETT |pi|
                   ...
                   NIL (GO G190) G191 (EXIT NIL))
              (LETT |dunit|
                    (SPADCALL |dunit| (SPADCALL |di| (+ |i| 1) (QREFELT $ 45))
                              (QREFELT $ 20)))
              (EXIT
               (COND
                ((EQL (SPADCALL |ci| (QREFELT $ 30)) 0)
                  ...
                  (LETT |lsnil|
                        (PROGN
                         ...
                         (SEQ (LETT |ffe| NIL)
                              ...
                              (EXIT (NREVERSE #6#)))))
                  (LETT |lffe| (SPADCALL |lsnil| |lffe| (QREFELT $ 47)))
                  (EXIT
                   (SPADCALL
...
(DEFUN |UnivariatePolynomialSquareFree| (&REST #1=#:G469)
  (SPROG NIL
         (PROG (#2=#:G470)
           (RETURN
            (COND
...
(MAKEPROP '|UnivariatePolynomialSquareFree| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (148 . ^) (154 . |divideExponents|) (160 . |append|))
           '#(|squareFreePart| 166 |squareFree| 171 |BumInSepFFE| 176) 'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 47
                                            '(1 7 0 0 8 2 7 0 0 0 9 2 7 10 0 0
                                              ...
                                              7 0 0 0 39 2 25 37 0 0 40 2 6 0 0
                                              25 41 2 6 10 0 0 42 1 7 0 6 43 2
                                              7 0 6 0 44 2 7 0 0 25 45 2 7 10 0
                                              25 46 2 18 0 0 0 47 1 0 7 7 12 1
