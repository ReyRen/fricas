               ...
               (EXIT
                (COND
                 ((OR (< |d| 2)
                      (OR
                       (SPADCALL
                        (SPADCALL (LETT |pp| (SPADCALL |p| (QREFELT $ 52)))
                                  (QREFELT $ 51))
                        1 (QREFELT $ 53))
                       (OR
                        (OR
                         ...
                         (SPADCALL
                          (LETT |b|
                                (SPADCALL (SPADCALL |p| (QREFELT $ 56))
                                          (QREFELT $ 27)))
                          |y| (QREFELT $ 45))))))
                  (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G432)))))))
             ('T (EXIT (CONS 1 #2#))))
            (EXIT
             (CONS 0
...
(SDEFUN |NODE1;solveRiccati|
        ...
        (SPROG
         ((|gsol| (|Record| (|:| |particular| F) (|:| |basis| (|List| F))))
          (#1=#:G461 NIL) (|deq| (F)) (|u| (|Union| F "failed")))
                   ...
                   ((QEQCAR |gsol| 0)
                    (COND
                     ((NULL (LETT |bas| (QCDR (QCDR |gsol|))))
                      (PROGN (LETT #1# (CONS 1 #3="failed")) (GO #4=#:G477)))))
...
(DEFUN |NonLinearFirstOrderODESolver| (&REST #1=#:G480)
  (SPROG NIL
         (PROG (#2=#:G481)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 74
                                            '(0 8 0 9 1 11 0 8 12 1 7 0 8 14 2
                                              ...
                                              0 7 0 38 2 7 0 0 0 39 1 7 40 0 41
                                              2 40 36 8 0 42 2 29 7 7 8 43 1 7
                                              0 0 44 2 7 36 0 0 45 1 7 23 0 46
                                              2 25 47 0 11 48 1 50 49 0 51 1 50
                                              0 0 52 2 49 36 0 0 53 0 50 0 54 2
                                              50 36 0 0 55 1 50 25 0 56 0 6 0
                                              57 2 7 0 58 0 59 3 62 61 7 15 8
                                              63 2 7 0 0 58 64 2 49 36 0 0 65 0
                                              6 0 66 0 7 0 67 2 50 25 0 49 68 2
                                              69 7 0 58 70 2 7 0 71 0 72 1 7 0
                                              0 73 3 7 0 0 8 49 74 4 0 34 7 7
                                              15 8 35)))))
           '|lookupComplete|)) 
