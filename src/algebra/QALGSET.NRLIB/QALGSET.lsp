...
(SDEFUN |QALGSET;factorset| ((|y| |Dpoly|) ($ |List| |Dpoly|))
        (SPROG ((#1=#:G407 NIL) (|j| NIL) (#2=#:G406 NIL))
               (SEQ
...
(SDEFUN |QALGSET;simplify;2$;2| ((|x| $) ($ $))
        (SPROG
         ((#1=#:G419 NIL) (#2=#:G418 (|Dpoly|)) (#3=#:G420 (|Dpoly|))
          (#4=#:G431 NIL) (#5=#:G383 NIL) (|zro| (|List| |Dpoly|))
          (#6=#:G415 NIL) (#7=#:G414 (|Dpoly|)) (#8=#:G416 (|Dpoly|))
          (#9=#:G430 NIL) (#10=#:G382 NIL) (#11=#:G429 NIL) (|s| NIL)
          (#12=#:G428 NIL) (|mset| (|List| (|List| |Dpoly|))) (#13=#:G427 NIL)
          (#14=#:G426 NIL) (#15=#:G425 NIL) (|p| NIL) (#16=#:G424 NIL)
...
(SDEFUN |QALGSET;coerce;$Of;5| ((|x| $) ($ |OutputForm|))
        (SPROG ((#1=#:G452 NIL) (|f| NIL) (#2=#:G451 NIL))
               (SEQ
                (COND
...
(SDEFUN |QALGSET;minset|
        ...
        (SPROG ((#1=#:G499 NIL) (|s| NIL) (#2=#:G498 NIL))
               (SEQ
                (COND ((NULL |lset|) |lset|)
                      ('T
                       (PROGN
...
(SDEFUN |QALGSET;overset?|
        ...
        (SPROG
         ((#1=#:G501 NIL) (#2=#:G500 #3=(|Boolean|)) (#4=#:G502 #3#)
          (#5=#:G505 NIL) (|q| NIL))
         (SEQ
          (COND ((NULL |qlist|) NIL)
                (#6='T
...
(DEFUN |QuasiAlgebraicSet| (&REST #1=#:G506)
  (SPROG NIL
         (PROG (#2=#:G507)
           (RETURN
            (COND
