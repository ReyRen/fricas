...
(SDEFUN |ISUPS;iPlus2|
        ...
        (SPROG
         ((|refer| (|Reference| (|OrderedCompletion| (|Integer|))))
          (|deg| (|Integer|)) (|yDeg| #1=(|Integer|)) (#2=#:G884 NIL)
...
(SDEFUN |ISUPS;*;3$;49| ((|ups1| $) (|ups2| $) ($ $))
        (SPROG
         ((|refer| (|Reference| (|OrderedCompletion| (|Integer|))))
          (|deg| (|Integer|)) (|yDeg| #1=(|Integer|)) (#2=#:G964 NIL)
          (|y| #3=(|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          (|yRefer| #4=(|Reference| (|OrderedCompletion| (|Integer|))))
          (|xDeg| #1#) (|x| #3#) (|xRefer| #4#))
         (SEQ
                ...
                (SEQ G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |y| (QREFELT $ 44))
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #7=#:G1018)))
                        ('T
                         (SEQ
                          (EXIT
...
(SDEFUN |ISUPS;compose0!2| (($$ NIL))
        (PROG (|x| $ |refer| |n| |yOrd| |xRefer| |y| |yRefer| |y1| |yn0| |n0|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|nn| NIL) (|yyOrd| NIL) (|x_ord| NIL) (#1=#:G1070 NIL)
              (|xTerm| NIL) (|xCoef| NIL) (|n1| NIL) (#2=#:G1061 NIL)
                                 ...
                                 (NULL
                                  (SPADCALL
                                   (SPADCALL |yOrd|
                                             ...
                                             (QREFELT $ 104))
                                   |n| (QREFELT $ 80))))
                                (PROGN (LETT #1# |$NoValue|) (GO #3=#:G1058)))
                               ('T (SPADCALL |x| (QREFELT $ 46))))))
                            NIL (GO G190) G191 (EXIT NIL)))
                      #3# (EXIT #1#))
                     (EXIT
...
(SDEFUN |ISUPS;iCompose;3$;55| ((|ups1| $) (|ups2| $) ($ $))
        (SPROG
         ((|compRefer| (|Reference| (|OrderedCompletion| (|Integer|))))
          (|yOrd| (|Integer|)) (#1=#:G1081 NIL) (#2=#:G1082 NIL) (|i| NIL)
          (|n| (|Integer|))
                ...
                (SEQ (LETT |n| 0) G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |x| (QREFELT $ 44))
                         (PROGN (LETT #1# (CONS 0 -1)) (GO #2=#:G1150)))
                        ((SPADCALL |x| (QREFELT $ 45))
                         (PROGN
                          (LETT #1#
                                (CONS 0
...
(SDEFUN |ISUPS;cRationalPower;$F$;67|
        ...
        (SPROG
         ((|uts2| ($)) (|uts1| ($)) (|ccPow| (|Coef|)) (#1=#:G1166 NIL)
          (#2=#:G1160 NIL) (|num| (|Integer|))
...
(SDEFUN |ISUPS;cSec;2$;75| ((|uts| $) ($ $))
        (SPROG ((#1=#:G1203 NIL) (|cosUts| ($)) (|cc| (|Coef|)))
               (SEQ
                (COND
                 ((SPADCALL (LETT |cc| (SPADCALL |uts| 0 (QREFELT $ 57)))
                            (QREFELT $ 16))
...
(SDEFUN |ISUPS;cAtan;2$;79| ((|uts| $) ($ $))
        (SPROG ((|y| (|Union| $ #1="failed")) (#2=#:G1251 NIL) (|cc| (|Coef|)))
               (SEQ
                (COND
                 ((SPADCALL (LETT |cc| (SPADCALL |uts| 0 (QREFELT $ 57)))
                            (QREFELT $ 16))
...
(SDEFUN |ISUPS;cAsech;2$;94| ((|uts| $) ($ $))
        (SPROG
         ((|utsInv| (|Union| $ "failed")) (#1=#:G1392 NIL)
          (|order| (|Integer|)) (|ord| (|Union| (|Integer|) "failed"))
          (|x| ($)) (|cc| (|Coef|)))
         (SEQ
          (EXIT
...
(SDEFUN |ISUPS;cAcsch;2$;95| ((|uts| $) ($ $))
        (SPROG
         ((|utsInv| (|Union| $ "failed")) (#1=#:G1407 NIL)
          (|order| (|Integer|)) (|ord| (|Union| (|Integer|) "failed"))
          (|x| ($)) (|cc| (|Coef|)))
         (SEQ
          (EXIT
...
(DEFUN |InnerSparseUnivariatePowerSeries| (#1=#:G1436)
  (SPROG NIL
         (PROG (#2=#:G1437)
           (RETURN
            (COND
...
(DEFUN |InnerSparseUnivariatePowerSeries;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1430 NIL) (#2=#:G1431 NIL) (#3=#:G1432 NIL)
    (#4=#:G1435 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|InnerSparseUnivariatePowerSeries| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|Reference| 18)
              ...
              (|List| 197) (|List| 37) (|Stream| 6) (|HashState|) (|String|))
           '#(~= 686 |zero?| 692 |variable| 697 |unitNormal| 702
              ...
              |leftRecip| 853 |leftPower| 858 |leadingMonomial| 870
              |leadingCoefficient| 875 |latex| 880 |integrate| 885 |iExquo| 890
              |iCompose| 897 |hashUpdate!| 903 |hash| 909 |getStream| 914
              |getRef| 919 |extend| 924 |exquo| 930 |eval| 936 |elt| 942
              |differentiate| 954 |degree| 991 |complete| 996 |commutator| 1001
              |coerce| 1007 |coefficient| 1032 |charthRoot| 1038
              |characteristic| 1043 |center| 1047 |cTanh| 1052 |cTan| 1057
              |cSinh| 1062 |cSin| 1067 |cSech| 1072 |cSec| 1077
              |cRationalPower| 1082 |cPower| 1088 |cLog| 1094 |cExp| 1099
              ...
              1174 |cAcot| 1179 |cAcosh| 1184 |cAcos| 1189 |associator| 1194
              |associates?| 1201 |approximate| 1207 |antiCommutator| 1213
              |annihilate?| 1219 ^ 1225 |Zero| 1237 |One| 1241 D 1245 = 1282 /
              1288 - 1294 + 1305 * 1311)
           'NIL
           (CONS
            (|makeByteWordVec2| 23
            ...
            (CONS
             ...
             (CONS
              '#((|UnivariatePowerSeriesCategory| 6 21)
                 ...
                 (|BiModule| 109 109) (|NonAssociativeRing|) (|LeftModule| 6)
              ...
              (|makeByteWordVec2| 216
                                  '(0 10 0 14 1 6 15 0 16 2 10 0 9 0 17 0 18 0
