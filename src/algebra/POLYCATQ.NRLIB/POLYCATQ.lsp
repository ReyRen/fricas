...
(SDEFUN |POLYCATQ;univ_root|
        ...
        (SPROG
         ((|nd| (F)) (|cofact| (|SparseUnivariatePolynomial| F))
          (|cf2| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G396 NIL)
         ...
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |modulus| (QREFELT $ 43)) 4 (QREFELT $ 45))
            (COND
             ((SPADCALL (LETT |m0| (SPADCALL |modulus| (QREFELT $ 46)))
                        (QREFELT $ 47))
              (EXIT
         ...
         (SEQ
          (COND
           ((SPADCALL (LETT |den| (SPADCALL |f| (QREFELT $ 12)))
            ...
            (COND
             ((SPADCALL (SPADCALL |f| (QREFELT $ 11)) (|spadConstant| $ 22)
              ...
              (CONS 1 "failed"))
             (#1='T
              (SEQ (LETT |ur| (SPADCALL |den| (QREFELT $ 69)))
                   (EXIT
                    (COND
                     ((QEQCAR |ur| 1)
           ...
           (#1#
            (SEQ
             (LETT |ur|
                   (SPADCALL (SPADCALL |f| (QREFELT $ 11)) (QREFELT $ 69)))
             (EXIT
...
(DEFUN |PolynomialCategoryQuotientFunctions| (&REST #1=#:G487)
  (SPROG NIL
         (PROG (#2=#:G488)
           (RETURN
            (COND
