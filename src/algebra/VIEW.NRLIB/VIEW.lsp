...
(SDEFUN |VIEW;graphCurves;L2PPiLGi;3|
        ((|listOfListsOfPoints| |List| (|List| (|Point| (|DoubleFloat|))))
         ...
         ($ |GraphImage|))
        (SPROG
         ((|listOfPointSizes| (|List| (|PositiveInteger|))) (#1=#:G394 NIL)
          (|i| NIL) (#2=#:G393 NIL) (|listOfLineColors| (|List| (|Palette|)))
          (#3=#:G392 NIL) (#4=#:G391 NIL)
          (|listOfPointColors| (|List| (|Palette|))) (#5=#:G390 NIL)
          (#6=#:G389 NIL) (|len| (|NonNegativeInteger|)))
