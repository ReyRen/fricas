...
(SDEFUN |EF;dropfun| ((|x| F) ($ F))
        (SPROG ((#1=#:G606 NIL) (|k| (|Union| (|Kernel| F) "failed")))
               (SEQ
                (EXIT
                 (SEQ
                 ...
                 (#1='T
                  (COND
                   ((SPADCALL |x|
                              ...
                              (QREFELT $ 125))
                    (SPADCALL
                     (SPADCALL 3 (SPADCALL (QREFELT $ 42)) (QREFELT $ 124))
                     (SPADCALL 4 (QREFELT $ 58)) (QREFELT $ 100)))
                   (#1#
                    (SEQ (LETT |r3| (SPADCALL (QREFELT $ 55)))
                         (EXIT
                          (COND
                           ...
                           (#1#
                            (SEQ
                             (LETT |xx| (SPADCALL |x| |r3| (QREFELT $ 122)))
                             (EXIT
                              (COND
...
(SDEFUN |EF;iexp| ((|x| F) ($ F))
        (SPROG
         ((|u| (|Union| F "failed")) (|s3| (F)) (|s2| (F)) (|h| (F)) (|y| (F))
          (|xi| (F)) (|i| (F)) (#1=#:G817 NIL) (|kx| (|Kernel| F))
...
(SDEFUN |EF;localReal?;FB;71| ((|x| F) ($ |Boolean|))
        (SPROG ((|u| (|Union| R "failed")))
               (SEQ (LETT |u| (SPADCALL |x| (QREFELT $ 131)))
                    (EXIT
                     (COND
                      ((QEQCAR |u| 0)
                       (SPADCALL (QCDR |u|)
                                 (SPADCALL (QCDR |u|) (QREFELT $ 132))
                                 (QREFELT $ 133)))
                      ('T NIL)))))) 
         ...
         (SEQ
          (COND ((SPADCALL |x| (QREFELT $ 116)) (|error| "Invalid argument"))
                ((SPADCALL |x| (|spadConstant| $ 48) (QREFELT $ 125))
                 (|spadConstant| $ 89))
                (#1='T
                 (SEQ (LETT |u| (SPADCALL |x| (QREFELT $ 15) (QREFELT $ 137)))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 0)
                         (SEQ (LETT |rec| (QCDR |u|))
         ...
         (SEQ
          (EXIT
           (SEQ
            (SEQ
             (LETT |num1|
                   (SPADCALL (LETT |num| (SPADCALL |x| (QREFELT $ 140)))
              ...
              (COND
               ((OR |num1|
                    (SPADCALL |num|
                              ...
                              (QREFELT $ 143)))
                (COND
                 ((SPADCALL (LETT |den| (SPADCALL |x| (QREFELT $ 144)))
...
(SDEFUN |EF;iilog;2F;76| ((|x| F) ($ F))
        (SPROG ((|r| (|Union| R "failed")))
               (SEQ (LETT |r| (SPADCALL |x| (QREFELT $ 131)))
                    (EXIT
...
(DEFUN |ElementaryFunction| (&REST #1=#:G1098)
  (SPROG NIL
         (PROG (#2=#:G1099)
           (RETURN
            (COND
...
(MAKEPROP '|ElementaryFunction| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ELEM
              ...
              (|Union| 7 '#2="failed") (148 . |specialTrigs|) (154 . |zero?|)
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 206
                                            '(1 11 9 10 12 0 6 0 40 1 7 0 6 41
