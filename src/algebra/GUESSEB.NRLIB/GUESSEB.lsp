...
(SDEFUN |GUESSEB;ord1| ((|x| |List| (|Integer|)) (|i| |Integer|) ($ |Integer|))
        (SPROG
         ((#1=#:G432 NIL) (|k| NIL) (#2=#:G431 NIL) (#3=#:G430 NIL) (|j| NIL)
          (#4=#:G429 NIL) (#5=#:G428 NIL) (#6=#:G427 NIL) (|n| (|Integer|)))
...
(SDEFUN |GUESSEB;ord2| ((|x| |List| (|Integer|)) (|i| |Integer|) ($ |Integer|))
        (SPROG ((#1=#:G440 NIL) (|j| NIL) (#2=#:G439 NIL) (|n| (|Integer|)))
               (SEQ
                (COND
                 ((ZEROP |i|)
                  (SEQ (LETT |n| (- (- (LENGTH |x|) 3) |i|))
...
(SDEFUN |GUESSEB;deg1| ((|x| |List| (|Integer|)) (|i| |Integer|) ($ |Integer|))
        (SPROG
         ((#1=#:G457 NIL) (|k| NIL) (#2=#:G456 NIL) (#3=#:G455 NIL) (|j| NIL)
          (#4=#:G454 NIL) (#5=#:G453 NIL) (#6=#:G452 NIL) (|m| (|Integer|)))
...
(SDEFUN |GUESSEB;deg2| ((|x| |List| (|Integer|)) (|i| |Integer|) ($ |Integer|))
        (SPROG ((#1=#:G464 NIL) (|j| NIL) (#2=#:G463 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (- (LENGTH |x|) 3))
                    (EXIT
                     (+ (|GUESSEB;deg1| |x| |i| $)
                        (*
...
(SDEFUN |GUESSEB;checkResult|
        ((|res| EXPRR) (|n| |Symbol|) (|l| |Integer|) (|list| |List| F)
         ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G471 NIL) (#2=#:G466 NIL) (|num| (EXPRR)) (#3=#:G465 NIL)
          (|den| (EXPRR)) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GUESSEB;evalResultant|
        ...
        (SPROG
         ((|res| (|List| S)) (#1=#:G494 NIL) (#2=#:G492 NIL) (|lead| (S))
          (#3=#:G490 NIL) (#4=#:G488 NIL) (|d2atk| #5=(|NonNegativeInteger|))
          (|d1atk| #5#) (|p2atk| #6=(|SparseUnivariatePolynomial| S))
          (|p1atk| #6#) (#7=#:G500 NIL) (|k| NIL)
...
(SDEFUN |GUESSEB;guessExpRatAux|
        ((|xx| |Symbol|) (|list| |List| F) (|basis| |Mapping| EXPRR EXPRR)
         ...
         ($ |List| EXPRR))
        (SPROG
         ((#1=#:G560 NIL) (|res| (|List| EXPRR)) (|res4| (EXPRR))
          ...
          (|t2|
           #3=(|SparseMultivariatePolynomial| F
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A))))
          (|t1| #3#) (|a1v| (F)) (#4=#:G567 NIL) (|g| NIL)
          (|evalPoly|
           (|SparseMultivariatePolynomial| F
                                           (|OrderedVariableList|
                                            (|construct| '|a1| 'A))))
          (|Av| (F)) (#5=#:G566 NIL) (|f| NIL)
            ...
            (|SparseUnivariatePolynomial|
             (|Fraction|
              (|SparseMultivariatePolynomial| S
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A)))))))
          (#8=#:G538 NIL) (#9=#:G565 NIL) (|i| NIL) (|maxDeg| (|Integer|))
          ...
          (|x3|
           #13=(|Fraction|
                (|SparseMultivariatePolynomial| S
                                                (|OrderedVariableList|
                                                 (|construct| '|a1| 'A)))))
          (|x2| #13#) (|x1| #13#) (|xlist| (|List| #13#)) (#14=#:G562 NIL)
          (#15=#:G561 NIL) (|len| (|NonNegativeInteger|)) (#16=#:G513 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL 1 (QREFELT $ 73)))
                ...
                (COND ((< |len| 4) (PROGN (LETT #1# NIL) (GO #18=#:G559)))
                      (#19='T
                       (LETT |len|
                             (PROG1 (LETT #16# (- |len| 3))
                               (|check_subtype2| (>= #16# 0)
...
(SDEFUN |GUESSEB;guessExpRatAux0|
        ...
        (SPROG
         ((|res| (|List| EXPRR)) (#1=#:G585 NIL) (|f| NIL) (#2=#:G584 NIL)
          (|xValues| (|List| (|Integer|))) (|newlist| (|List| F))
          (|i| (|Integer|)) (#3=#:G583 NIL) (|x| NIL) (|zeros| (EXPRR))
          (#4=#:G582 NIL) (|shortlist| (|List| F)) (#5=#:G570 NIL)
          (#6=#:G581 NIL) (|len| (|Integer|)) (|xx| (|Symbol|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |GUESSEB;guessBinRatAux|
        ((|xx| |Symbol|) (|list| |List| F) (|basis| |Mapping| EXPRR EXPRR)
         ...
         ($ |List| EXPRR))
        (SPROG
         ((#1=#:G630 NIL) (|res| (|List| EXPRR)) (|res4| (EXPRR))
          (|denr| #2=(|SparseUnivariatePolynomial| F)) (|numr| #2#)
          (|ri1|
           (|Fraction|
            (|SparseUnivariatePolynomial|
          ...
          (|t2|
           #3=(|SparseMultivariatePolynomial| F
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A))))
          (|t1| #3#) (|a1v| (F)) (#4=#:G637 NIL) (|g| NIL)
          (|evalPoly|
           (|SparseMultivariatePolynomial| F
                                           (|OrderedVariableList|
                                            (|construct| '|a1| 'A))))
          (|Av| (F)) (#5=#:G636 NIL) (|f| NIL)
          (|res3| (|SparseUnivariatePolynomial| F))
          (|res2| #6=(|SparseUnivariatePolynomial| S)) (|res1| #6#)
          (|n| (|Integer|))
          (|poly3|
            ...
            (|SparseUnivariatePolynomial|
             (|Fraction|
              (|SparseMultivariatePolynomial| S
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A)))))))
          (#8=#:G612 NIL) (#9=#:G635 NIL) (|i| NIL) (|maxDeg| (|Integer|))
          (|maxD| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (|y3|
           #10=(|Fraction|
                (|SparseMultivariatePolynomial| S
          ...
          (|x3|
           #13=(|Fraction|
                (|SparseMultivariatePolynomial| S
                                                (|OrderedVariableList|
                                                 (|construct| '|a1| 'A)))))
          (|x2| #13#) (|x1| #13#) (|xlist| (|List| #13#)) (#14=#:G632 NIL)
          (#15=#:G631 NIL) (|len| (|NonNegativeInteger|)) (#16=#:G600 NIL)
          (A #17=(|OrderedVariableList| (|construct| '|a1| 'A))) (|a1| #17#))
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL 1 (QREFELT $ 73)))
                (LETT A (SPADCALL 2 (QREFELT $ 73)))
                (LETT |len| (LENGTH |list|))
                (COND ((< |len| 4) (PROGN (LETT #1# NIL) (GO #18=#:G629)))
                      (#19='T
                       (LETT |len|
                             (PROG1 (LETT #16# (- |len| 3))
                               (|check_subtype2| (>= #16# 0)
...
(SDEFUN |GUESSEB;guessBinRatAux0|
        ((|list| |List| F) (|basis| |Mapping| EXPRR EXPRR)
         ...
         (|options| |List| (|GuessOption|)) ($ |List| EXPRR))
        (SPROG
         ((|res| (|List| EXPRR)) (#1=#:G661 NIL) (|f| NIL) (#2=#:G660 NIL)
          (|xValues| (|List| (|Integer|))) (|newlist| (|List| F))
          (|i| (|Integer|)) (#3=#:G659 NIL) (|x| NIL) (|zeros| (EXPRR))
          (#4=#:G658 NIL) (|shortlist| (|List| F)) (#5=#:G640 NIL)
          (#6=#:G657 NIL) (|len| (|Integer|)) (|xx| (|Symbol|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
