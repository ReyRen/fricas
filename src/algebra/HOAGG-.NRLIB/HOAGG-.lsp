...
(SDEFUN |HOAGG-;any?;MAB;3|
        ...
        (SPROG ((#1=#:G402 NIL) (#2=#:G403 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |HOAGG-;every?;MAB;4|
        ((|f| |Mapping| (|Boolean|) S) (|c| A) ($ |Boolean|))
        (SPROG ((#1=#:G408 NIL) (#2=#:G409 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |x| NIL) (LETT #2# (SPADCALL |c| (QREFELT $ 14)))
...
(SDEFUN |HOAGG-;count;MANni;5|
        ...
        (SPROG
         ((#1=#:G411 NIL) (#2=#:G410 #3=(|NonNegativeInteger|)) (#4=#:G412 #3#)
          (#5=#:G414 NIL) (|x| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |HOAGG-;max;MAS;7| ((|p| |Mapping| (|Boolean|) S S) (|u| A) ($ S))
        (SPROG ((|r| (S)) (#1=#:G422 NIL) (|x| NIL) (|l| (|List| S)))
               (SEQ
                (COND
...
(SDEFUN |HOAGG-;=;2AB;12| ((|x| A) (|y| A) ($ |Boolean|))
        (SPROG
         ((#1=#:G434 NIL) (#2=#:G435 NIL) (|a| NIL) (#3=#:G436 NIL) (|b| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |HOAGG-;coerce;AOf;13| ((|x| A) ($ |OutputForm|))
        (SPROG ((#1=#:G440 NIL) (|a| NIL) (#2=#:G439 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
