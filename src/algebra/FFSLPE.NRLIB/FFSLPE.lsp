...
(SDEFUN |FFSLPE;solveLinearPolynomialEquation;LFPPU;1|
        ...
        (SPROG
         ((|answer| (|Union| (|List| FPP) "failed")) (#1=#:G392 NIL)
          (#2=#:G395 NIL) (|ans| (|Union| (|Vector| (|List| FPP)) #3="failed"))
          (|deg| #4=(|NonNegativeInteger|)) (#5=#:G389 NIL) (#6=#:G388 #4#)
          (#7=#:G390 #4#) (#8=#:G407 NIL) (|u| NIL))
         (SEQ
          (COND
...
(DEFUN |FiniteFieldSolveLinearPolynomialEquation| (&REST #1=#:G408)
  (SPROG NIL
         (PROG (#2=#:G409)
           (RETURN
            (COND
