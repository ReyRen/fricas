...
(SDEFUN |MCALCFN;localGradient| ((|v| F) (|xlist| |List| S) ($ |Vector| F))
        (SPROG ((#1=#:G385 NIL) (|x| NIL) (#2=#:G384 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |MCALCFN;localDivergence| ((|vf| |Vector| F) (|xlist| |List| S) ($ F))
        (SPROG
         ((|ans| (F)) (#1=#:G392 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (#2=#:G388 NIL))
         (SEQ
          (LETT |n|
                (MIN (LENGTH |xlist|)
...
(SDEFUN |MCALCFN;divergence;FLAFFLASF;4| ((|vf| FLAF) (|xflas| FLAS) ($ F))
        (SPROG
         ((|ans| (F)) (#1=#:G397 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (#2=#:G393 NIL) (|xlist| (|List| S)))
         (SEQ (LETT |xlist| (SPADCALL |xflas| (QREFELT $ 15)))
              (LETT |n|
                    (MIN (LENGTH |xlist|)
...
(SDEFUN |MCALCFN;hessian;FFLASM;6| ((|v| F) (|xflas| FLAS) ($ |Matrix| F))
        (SPROG
         ((#1=#:G407 NIL) (|x| NIL) (#2=#:G406 NIL) (#3=#:G405 NIL) (|y| NIL)
          (#4=#:G404 NIL) (|xlist| (|List| S)))
         (SEQ (LETT |xlist| (SPADCALL |xflas| (QREFELT $ 15)))
              (EXIT
               (SPADCALL
                (PROGN
...
(SDEFUN |MCALCFN;jacobian;FLAFFLASM;7|
        ...
        (SPROG
         ((#1=#:G415 NIL) (|x| NIL) (#2=#:G414 NIL) (#3=#:G413 NIL) (|i| NIL)
          (#4=#:G412 NIL) (|xlist| (|List| S)))
         (SEQ (LETT |xlist| (SPADCALL |xflas| (QREFELT $ 15)))
              (EXIT
               (SPADCALL
                (PROGN
...
(SDEFUN |MCALCFN;bandedHessian;FFLASNniM;8|
        ...
        (SPROG
         ((#1=#:G423 NIL) (|j| NIL) (#2=#:G422 NIL) (|iw| NIL) (#3=#:G421 NIL)
...
(SDEFUN |MCALCFN;jacobian;FLAFFLASM;9|
        ((|vf| FLAF) (|xflas| FLAS) ($ |Matrix| F))
        (SPROG
         ((#1=#:G431 NIL) (|x| NIL) (#2=#:G430 NIL) (#3=#:G429 NIL) (|i| NIL)
          (#4=#:G428 NIL) (|xlist| (|List| S)))
         (SEQ (LETT |xlist| (SPADCALL |xflas| (QREFELT $ 15)))
              (EXIT
               (SPADCALL
                (PROGN
...
(SDEFUN |MCALCFN;bandedJacobian;FLAFFLAS2NniM;10|
        ...
        (SPROG
         ((#1=#:G443 NIL) (|j| NIL) (#2=#:G442 NIL) (|iw| NIL) (#3=#:G441 NIL)
          (#4=#:G440 NIL) (#5=#:G439 NIL) (|bandM| (|Matrix| F))
...
(DEFUN |MultiVariableCalculusFunctions| (&REST #1=#:G444)
  (SPROG NIL
         (PROG (#2=#:G445)
           (RETURN
            (COND
