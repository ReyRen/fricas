          ...
          (D
           (|List|
            #2=(|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (|dd1| (|List| #2#)) (#3=#:G494 NIL) (|x| NIL) (#4=#:G493 NIL)
          (|leh| (|Dom|)) (|e| (|Expon|)) (|eh| (|Dpol|)) (|ep| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                     (|:| |poli| |Dpol|) (|:| |polj| |Dpol|)))
          (#5=#:G492 NIL) (#6=#:G491 NIL) (|lch| (|Dom|)) (|en| (|Expon|))
...
(SDEFUN |GBEUCLID;updatH|
        ...
        (SPROG
         ((|hp| (|Dpol|)) (|hpp| (|List| |Dpol|)) (#1=#:G519 NIL)
          (|plc|
...
(SDEFUN |GBEUCLID;esPol|
        ((|p| |Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
         ...
         ($ |Dpol|))
        (SPROG
         ((#1=#:G546 NIL) (#2=#:G543 NIL) (|lij| (|Dom|)) (|fj| (|Dpol|))
          (|fi| (|Dpol|)) (|Tij| (|Expon|)))
...
(SDEFUN |GBEUCLID;eRed|
        ...
        (SPROG
         ((|q1| (|Dom|))
          ...
          (#1=#:G559 NIL) (|e| (|Union| |Expon| "failed")) (|ls| (|Dom|))
...
(SDEFUN |GBEUCLID;ecritM|
        ...
        (SPROG ((#1=#:G572 NIL) (|en| (|Union| |Expon| "failed")))
               (SEQ
                (EXIT
                 (SEQ
...
(DEFUN |EuclideanGroebnerBasisPackage| (&REST #1=#:G608)
  (SPROG NIL
         (PROG (#2=#:G609)
           (RETURN
            (COND
