...
(SDEFUN |LSQM;conv| ((|v| |DirectProduct| |n2| R) ($ |SquareMatrix| |n| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G389 NIL) (|j| NIL) (#2=#:G388 NIL) (|i| NIL)
          (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |LSQM;canonical_coordinates| ((|a| $) ($ |Vector| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G396 NIL) (|j| NIL) (#2=#:G395 NIL) (|i| NIL)
...
(SDEFUN |LSQM;coordinates;$VV;4| ((|a| $) (|b| |Vector| $) ($ |Vector| R))
        (SPROG
         ((|canonical| (|Boolean|)) (#1=#:G403 NIL) (|j| NIL)
          (|bv| (|Vector| R)) (#2=#:G402 NIL) (|i| NIL))
...
(SDEFUN |LSQM;basis;V;6| (($ |Vector| $))
        (SPROG
         ((|res| (|Vector| $)) (|ldp| (|List| (|DirectProduct| |n2| R)))
          (#1=#:G407 NIL) (#2=#:G413 NIL) (|i| NIL) (#3=#:G412 NIL))
...
(DEFUN |LieSquareMatrix| (&REST #1=#:G423)
  (SPROG NIL
         (PROG (#2=#:G424)
           (RETURN
            (COND
