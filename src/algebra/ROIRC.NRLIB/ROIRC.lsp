...
(SDEFUN |ROIRC;evalOne| ((|p| |ThePolDom|) ($ |TheField|))
        (SPROG
         ((#1=#:G477 NIL) (#2=#:G476 (|TheField|)) (#3=#:G478 (|TheField|))
          (#4=#:G480 NIL) (#5=#:G382 NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ROIRC;sturmNthRoot|
        ((|lp| |List| |ThePolDom|) (|l| |TheField|) (|r| |TheField|)
         ...
         ($ |Union| (|Record| (|:| |low| |TheField|) (|:| |high| |TheField|))
          "failed"))
        (SPROG
         ((#1=#:G494 NIL) (|o| (|Integer|)) (|vi| (|NonNegativeInteger|))
          (|lt| (|List| |TheField|)) (#2=#:G498 NIL) (|t| NIL)
          (|int| (|TheField|)) (|nv| (|NonNegativeInteger|)) (#3=#:G492 NIL))
         (SEQ
          (LETT |nv|
                (PROG1 (LETT #3# (- |vl| |vr|))
...
(SDEFUN |ROIRC;sturmIsolate|
        ...
        (SPROG
         ((|vi| (|NonNegativeInteger|)) (#1=#:G508 NIL) (|t| NIL)
          (#2=#:G507 NIL) (|int| (|TheField|)) (|n| (|NonNegativeInteger|))
          (#3=#:G500 NIL))
         (SEQ
          (COND
...
(SDEFUN |ROIRC;isolate|
        ...
        (SPROG
         ((|l2| #1=(|List| |TheField|)) (|l1| #2=(|List| |TheField|))
          ...
          (|#G38| #3#) (#4=#:G514 NIL) (|t| NIL) (|#G36| #1#) (|#G35| #2#)
          (|b| (|TheField|)))
...
(SDEFUN |ROIRC;rootOf;ThePolDomPiU;14|
        ...
        (SPROG
         ((|res|
          ...
          (|#G51| #3#) (#4=#:G532 NIL) (|t| NIL) (|#G49| #1#) (|#G48| #2#)
          (|b| (|TheField|)) (|ls| (|List| |ThePolDom|)))
         (SEQ (LETT |ls| (SPADCALL |pol| (QREFELT $ 59)))
              (LETT |pol| (SPADCALL (|SPADfirst| |ls|) (QREFELT $ 60)))
              (EXIT
               (COND
...
(SDEFUN |ROIRC;allRootsOf;ThePolDomL;15| ((|pol| |ThePolDom|) ($ |List| $))
        (SPROG
         ((#1=#:G540 NIL) (|term| NIL) (#2=#:G539 NIL)
          (|ls| (|List| |ThePolDom|)))
         (SEQ
...
(SDEFUN |ROIRC;hasVarsl| ((|l| |List| |TheField|) ($ |Boolean|))
        (SPROG ((#1=#:G546 NIL) (#2=#:G547 NIL) (|term| NIL) (|f| (|Integer|)))
               (SEQ
                (EXIT
                 (COND ((NULL |l|) NIL)
                       ('T
        ...
        (SPROG
         ((|d|
           (|Record| (|:| |coef1| |ThePolDom|) (|:| |coef2| |ThePolDom|)
                     (|:| |generator| |ThePolDom|)))
          (#2=#:G577 NIL) (|c| (|TheField|)) (|newPol| (|ThePolDom|)))
         (SEQ
          (COND
...
(SDEFUN |ROIRC;refine!| ((|rootChar| $) ($ $))
        (SPROG ((|s2| #1=(|Integer|)) (|s1| #1#) (|int| (|TheField|)))
               (SEQ (LETT |int| (SPADCALL |rootChar| (QREFELT $ 98)))
                    (LETT |s1|
                          (SPADCALL
...
(DEFUN |RightOpenIntervalRootCharacterization| (&REST #1=#:G638)
  (SPROG NIL
         (PROG (#2=#:G639)
           (RETURN
            (COND
