...
(SDEFUN |ODEPAL;rat_solve|
        ...
        (SPROG
         ((|bl| (|List| (|Fraction| UP))) (|s| (|Fraction| UP)) (#1=#:G411 NIL)
          (|k| NIL) (#2=#:G412 NIL) (|bf| NIL) (#3=#:G410 NIL) (|i| NIL)
          (|sl|
           (|List|
            (|Record| (|:| |ratpart| (|Fraction| UP))
                      (|:| |coeffs| (|Vector| (|Fraction| UP))))))
          (#4=#:G408 NIL) (#5=#:G409 NIL) (#6=#:G407 NIL)
          (|cv| (|Vector| (|Fraction| UP))) (#7=#:G403 NIL) (|i0| (|Integer|))
          (|j| (|Integer|)) (#8=#:G406 NIL) (|nr| (|NonNegativeInteger|))
          (|m3| (|Matrix| F)) (|nn1| (|NonNegativeInteger|)) (#9=#:G390 NIL)
          (|nc| (|NonNegativeInteger|)) (|nn| #10=(|NonNegativeInteger|))
          (|m1| (|Matrix| F)) (#11=#:G405 NIL) (|kv| NIL) (#12=#:G404 NIL)
...
(SDEFUN |ODEPAL;algDsolve;LodoLR;4|
        ...
        (SPROG
         ((|part|
          ...
          (#1=#:G432 NIL) (|be| NIL) (#2=#:G431 NIL) (|bas| (|List| R))
          (#3=#:G430 NIL) (|v| NIL) (#4=#:G429 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|List|
...
(DEFUN |PureAlgebraicLODE| (&REST #1=#:G446)
  (SPROG NIL
         (PROG (#2=#:G447)
           (RETURN
            (COND
