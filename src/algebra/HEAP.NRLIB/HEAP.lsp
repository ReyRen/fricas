...
(SDEFUN |HEAP;siftUp| ((|r| $) (|i| |Integer|) (|n| |Integer|) ($ |Void|))
        (SPROG ((#1=#:G395 NIL) (|j| #2=(|Integer|)) (|k| #2#) (|t| (S)))
...
(SDEFUN |HEAP;insert!;S2$;5| ((|x| S) (|r| $) ($ $))
        (SPROG ((|j| (|Integer|)) (#1=#:G405 NIL) (|i| (|Integer|)))
...
(DEFUN |Heap;| (|#1|)
  (SPROG
   ((#1=#:G425 NIL) (#2=#:G426 NIL) (|pv$| NIL) (#3=#:G422 NIL) (#4=#:G423 NIL)
    (#5=#:G424 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
