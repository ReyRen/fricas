...
(SDEFUN |SUTS;univariatePolynomial;$NniUp;14|
        ...
        (SPROG
         ((|st| (|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          ...
          (|oldDeg| (|Integer|)) (|pow| (|NonNegativeInteger|)) (#1=#:G448 NIL)
          (#2=#:G454 NIL) (|xExpon| (|Integer|))
...
(SDEFUN |SUTS;polynomial;$NniP;15|
        ...
        (SPROG
         ((|st| (|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          ...
          (|oldDeg| (|Integer|)) (|pow| (|NonNegativeInteger|)) (#1=#:G456 NIL)
          (#2=#:G462 NIL) (|xExpon| (|Integer|))
          (|xTerm| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|)))
          (|mon| (|Polynomial| |Coef|)))
         (SEQ
          (EXIT
            ...
            (SPROG
             ...
             (SEQ
              (COND ((SPADCALL |x| (QREFELT $ 81)) (SPADCALL (QREFELT $ 83)))
                    ('T
                     (SEQ (LETT |nn| (SPADCALL |n| (QREFELT $ 84)))
                          (SEQ G190
                               (COND
                                ((NULL
                                  (SPADCALL
                                   (LETT |nx|
                                         (SPADCALL |refer| (QREFELT $ 85)))
                                   |nn| (QREFELT $ 86)))
                                 (GO G191)))
...
(SDEFUN |SUTS;coefficients;$S;20| ((|uts| $) ($ |Stream| |Coef|))
        (SPROG
         ((|x| (|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          (|refer| (|Reference| (|OrderedCompletion| (|Integer|)))))
         (SEQ (LETT |refer| (SPADCALL |uts| (QREFELT $ 94)))
                     ...
                     ('T
                      (SEQ
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL
                           (LETT |coef| (SPADCALL |st| (QREFELT $ 102)))
                           (QREFELT $ 30))
...
(SDEFUN |SUTS;order;$Nni;30| ((|x| $) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G506 NIL))
               (PROG1 (LETT #1# (SPADCALL |x| (QREFELT $ 113)))
...
(SDEFUN |SUTS;order;$2Nni;31|
        ...
        (SPROG ((#2=#:G508 NIL))
               (PROG1 (LETT #2# (SPADCALL |x| |n| (QREFELT $ 115)))
...
(DEFUN |SparseUnivariateTaylorSeries| (&REST #1=#:G622)
  (SPROG NIL
         (PROG (#2=#:G623)
           (RETURN
            (COND
...
(DEFUN |SparseUnivariateTaylorSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G616 NIL) (#2=#:G617 NIL) (#3=#:G618 NIL) (#4=#:G621 NIL)
