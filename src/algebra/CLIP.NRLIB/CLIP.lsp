...
(SDEFUN |CLIP;iClipParametric|
        ...
        (SPROG
         ((|yseg| #1=(|Segment| (|DoubleFloat|))) (|xseg| #1#)
          ...
          (|xDiff| #7#) (#8=#:G450 NIL) (|k| NIL) (#9=#:G451 NIL) (|pt| NIL)
...
(SDEFUN |CLIP;clip;P2FR;9|
        ((|plot| |Plot|) (|fraction| |Fraction| (|Integer|))
         ...
         ($ |Record| (|:| |brans| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|:| |yValues| (|Segment| (|DoubleFloat|)))))
        (SPROG
         ((|yMax| #1=(|DoubleFloat|)) (|yMin| #1#) (#2=#:G490 NIL) (|pt| NIL)
          (#3=#:G489 NIL) (|list| NIL)
...
(SDEFUN |CLIP;findPt|
        ...
        (SPROG
         ((#1=#:G508 NIL) (#2=#:G507 NIL) (#3=#:G509 NIL) (#4=#:G511 NIL)
          (|p| NIL) (#5=#:G510 NIL) (|list| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
...
(SDEFUN |CLIP;clipWithRanges;L4DfR;13|
        ((|pointLists| |List| (|List| (|Point| (|DoubleFloat|))))
         ...
         ($ |Record| (|:| |brans| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|:| |yValues| (|Segment| (|DoubleFloat|)))))
        (SPROG
         ((#1=#:G546 NIL) (|pt| (|Union| (|Point| (|DoubleFloat|)) "failed"))
          (#2=#:G545 NIL) (|list| NIL) (|firstPt| (|Point| (|DoubleFloat|)))
          (|lists| (|List| (|List| (|Point| (|DoubleFloat|))))) (#3=#:G544 NIL)
          (|pointList| NIL))
         (SEQ (LETT |lists| NIL)
