...
(SDEFUN |FSPRMELT;K2P|
        ...
        (SPROG ((#1=#:G396 NIL) (|v| (|Union| (|Symbol|) "failed")))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |FSPRMELT;primitiveElement;LR;3|
        ...
        (SPROG
         ((#1=#:G404 NIL) (#2=#:G403 (F)) (#3=#:G405 (F)) (#4=#:G418 NIL)
          (|c| NIL) (#5=#:G419 NIL) (|a| NIL)
          (|rec|
           (|Record| (|:| |coef| (|List| (|Integer|)))
                     (|:| |poly| (|List| (|SparseUnivariatePolynomial| F)))
                     (|:| |prim| (|SparseUnivariatePolynomial| F))))
          (|pols| (|List| (|Polynomial| F))) (#6=#:G416 NIL) (|k| NIL)
          (#7=#:G417 NIL) (|v| NIL) (#8=#:G415 NIL)
          (|kers| (|List| (|Kernel| F))) (#9=#:G414 NIL) (#10=#:G413 NIL)
          (|vv| (|List| F)) (#11=#:G412 NIL) (#12=#:G411 NIL)
          (|vars| (|List| (|Symbol|))) (#13=#:G410 NIL) (|i| NIL)
          (#14=#:G409 NIL) (|u| (|String|)) (|uu| (|Symbol|)))
         (SEQ
          (LETT |u|
...
(DEFUN |FunctionSpacePrimitiveElement| (&REST #1=#:G439)
  (SPROG NIL
         (PROG (#2=#:G440)
           (RETURN
            (COND
