...
(SDEFUN |TBAGG-;coerce;SOf;5| ((|t| S) ($ |OutputForm|))
        (SPROG ((#1=#:G406 NIL) (|k| NIL) (#2=#:G405 NIL))
               (SEQ
...
(SDEFUN |TBAGG-;parts;SL;10|
        ...
        (SPROG ((#1=#:G431 NIL) (|k| NIL) (#2=#:G430 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;parts;SL;11| ((|t| S) ($ |List| |Entry|))
        (SPROG ((#1=#:G435 NIL) (|k| NIL) (#2=#:G434 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;=;2SB;13| ((|s| S) (|t| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G448 NIL) (|e| (|Union| |Entry| "failed"))
          (#3=#:G449 NIL) (|k| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |TBAGG-;find;MSU;17|
        ((|f| |Mapping| (|Boolean|)
         ...
         ($ |Union| (|Record| (|:| |key| |Key|) (|:| |entry| |Entry|))
          "failed"))
        (SPROG ((#1=#:G482 NIL) (#2=#:G483 NIL) (|ke| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |ke| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 58)))
                       ...
                       (SEQ
                        (EXIT
                         (COND
                          ((SPADCALL |ke| |f|)
                           (PROGN (LETT #1# (CONS 0 |ke|)) (GO #3=#:G481))))))
...
(SDEFUN |TBAGG-;any?;MSB;21|
        ...
        (SPROG ((#1=#:G502 NIL) (#2=#:G503 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |TBAGG-;every?;MSB;22|
        ((|f| |Mapping| (|Boolean|) |Entry|) (|t| S) ($ |Boolean|))
        (SPROG ((#1=#:G508 NIL) (#2=#:G509 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;count;MSNni;23|
        ...
        (SPROG ((|tally| (|NonNegativeInteger|)) (#1=#:G513 NIL) (|k| NIL))
               (SEQ (LETT |tally| 0)
                    (SEQ (LETT |k| NIL)
                         (LETT #1# (SPADCALL |t| (QREFELT $ 18))) G190
                         (COND
