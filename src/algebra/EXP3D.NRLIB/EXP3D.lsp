...
(SDEFUN |EXP3D;faceIndex|
        ...
        (SPROG
         ((|faceIndexList| (|List| (|NonNegativeInteger|))) (#1=#:G390 NIL)
          (|poly| NIL))
...
(SDEFUN |EXP3D;writePolygon|
        ((|f1| |TextFile|) (|curves| |List| (|SubSpace| 3 (|DoubleFloat|)))
         ($ |Void|))
        (SPROG
         ((|s| (|String|)) (#1=#:G397 NIL) (|i| NIL)
          (|faceIndexList| (|List| (|NonNegativeInteger|))) (#2=#:G396 NIL)
          (|curve| NIL))
         (SEQ (LETT |faceIndexList| NIL)
...
(SDEFUN |EXP3D;writeObj;SsSV;5|
        ((|subSp| |SubSpace| 3 (|DoubleFloat|)) (|filename| |String|)
         ($ |Void|))
        (SPROG
         ((|curves| (|List| (|SubSpace| 3 (|DoubleFloat|)))) (#1=#:G418 NIL)
          (|component| NIL) (#2=#:G417 NIL) (|v| NIL)
