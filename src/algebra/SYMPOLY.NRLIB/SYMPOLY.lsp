...
(SDEFUN |SYMPOLY;*;3$;1| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((#1=#:G391 NIL) (#2=#:G390 ($)) (#3=#:G392 ($)) (#4=#:G400 NIL)
          (|t2| NIL) (#5=#:G399 NIL) (#6=#:G398 NIL) (|t1| NIL))
         (SEQ
...
(SDEFUN |SYMPOLY;*;3$;2| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((#1=#:G402 NIL) (#2=#:G401 ($)) (#3=#:G403 ($)) (|r| (R))
          (#4=#:G411 NIL) (|t2| NIL) (#5=#:G410 NIL) (#6=#:G409 NIL)
          (|t1| NIL))
         (SEQ
          (COND ((OR (NULL |p1|) (NULL |p2|)) (|spadConstant| $ 9))
                ((SPADCALL (QCAR (|SPADfirst| |p1|)) (QREFELT $ 12))
...
(DEFUN |SymmetricPolynomial| (#1=#:G430)
  (SPROG NIL
         (PROG (#2=#:G431)
           (RETURN
            (COND
...
(DEFUN |SymmetricPolynomial;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G427 NIL) (#2=#:G428 NIL) (#3=#:G429 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
