...
(SDEFUN |FORTRAN;outputAsFortran;$V;3| ((|p| $) ($ |Void|))
        (SPROG
         ((#1=#:G411 NIL) (|expr| NIL) (|intrinsics| (|List| (|String|)))
          (|body| (|List| (|List| (|String|)))) (#2=#:G410 NIL) (|l| NIL)
          (#3=#:G409 NIL) (|tempName| (|Symbol|)))
...
(SDEFUN |FORTRAN;coerce;E$;7|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|MachineInteger|)))))
          (#1=#:G436 NIL) (|w| NIL) (#2=#:G437 NIL) (|v| NIL) (#3=#:G435 NIL)
          (|aeList| (|List| (|Expression| (|MachineInteger|)))) (#4=#:G434 NIL)
          (#5=#:G433 NIL) (|veList| (|List| (|Expression| (|MachineInteger|))))
          (#6=#:G432 NIL) (#7=#:G431 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(SDEFUN |FORTRAN;coerce;E$;9|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|MachineFloat|)))))
          (#1=#:G456 NIL) (|w| NIL) (#2=#:G457 NIL) (|v| NIL) (#3=#:G455 NIL)
          (|aeList| (|List| (|Expression| (|MachineFloat|)))) (#4=#:G454 NIL)
          (#5=#:G453 NIL) (|veList| (|List| (|Expression| (|MachineFloat|))))
          (#6=#:G452 NIL) (#7=#:G451 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(SDEFUN |FORTRAN;coerce;E$;11|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|MachineComplex|)))))
          (#1=#:G476 NIL) (|w| NIL) (#2=#:G477 NIL) (|v| NIL) (#3=#:G475 NIL)
          (|aeList| (|List| (|Expression| (|MachineComplex|)))) (#4=#:G474 NIL)
          (#5=#:G473 NIL) (|veList| (|List| (|Expression| (|MachineComplex|))))
          (#6=#:G472 NIL) (#7=#:G471 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(SDEFUN |FORTRAN;coerce;E$;17|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|Integer|)))))
          (#1=#:G502 NIL) (|w| NIL) (#2=#:G503 NIL) (|v| NIL) (#3=#:G501 NIL)
          (|aeList| (|List| (|Expression| (|Integer|)))) (#4=#:G500 NIL)
          (#5=#:G499 NIL) (|veList| (|List| (|Expression| (|Integer|))))
          (#6=#:G498 NIL) (#7=#:G497 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(SDEFUN |FORTRAN;coerce;E$;19|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|Float|)))))
          (#1=#:G522 NIL) (|w| NIL) (#2=#:G523 NIL) (|v| NIL) (#3=#:G521 NIL)
          (|aeList| (|List| (|Expression| (|Float|)))) (#4=#:G520 NIL)
          (#5=#:G519 NIL) (|veList| (|List| (|Expression| (|Float|))))
          (#6=#:G518 NIL) (#7=#:G517 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(SDEFUN |FORTRAN;coerce;E$;21|
        ...
        (SPROG
         ((|eList| (|List| (|Equation| (|Expression| (|Complex| (|Float|))))))
          (#1=#:G542 NIL) (|w| NIL) (#2=#:G543 NIL) (|v| NIL) (#3=#:G541 NIL)
          (|aeList| (|List| (|Expression| (|Complex| (|Float|)))))
          (#4=#:G540 NIL) (#5=#:G539 NIL)
          (|veList| (|List| (|Expression| (|Complex| (|Float|)))))
          (#6=#:G538 NIL) (#7=#:G537 NIL) (|vList| (|List| (|Symbol|))))
         (SEQ
          (COND
...
(DEFUN |FortranProgram| (&REST #1=#:G544)
  (SPROG NIL
         (PROG (#2=#:G545)
           (RETURN
            (COND
