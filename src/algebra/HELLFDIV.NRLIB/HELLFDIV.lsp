...
(SDEFUN |HELLFDIV;+;3$;8| ((|d1| $) (|d2| $) ($ $))
        (SPROG
         ((|dd| ($)) (|b| (UP)) (#1=#:G400 NIL) (|a| (UP)) (|h| #2=(|List| UP))
...
(SDEFUN |HELLFDIV;reduce;2$;14| ((|d| $) ($ $))
        (SPROG
         ((|g| (R)) (|b0| (UP)) (|a0| (UP)) (#1=#:G400 NIL) (|b| (UP))
          (|a| (UP)))
         (SEQ
          (COND ((QVELT |d| 3) |d|)
...
(SDEFUN |HELLFDIV;intReduce| ((|h| R) (|b| UP) ($ R))
        (SPROG
         ((#1=#:G479 NIL) (#2=#:G481 NIL) (|i| NIL) (#3=#:G480 NIL)
          (|v| (|Vector| UP)))
...
(DEFUN |HyperellipticFiniteDivisor| (&REST #1=#:G488)
  (SPROG NIL
         (PROG (#2=#:G489)
           (RETURN
            (COND
...
(DEFUN |HyperellipticFiniteDivisor;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G406 NIL) (#2=#:G400 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL)
