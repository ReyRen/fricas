...
(SDEFUN |DPOLCAT-;differentiate;AMA;2| ((|p| A) (|d| |Mapping| R R) ($ A))
        (SPROG
         ((#1=#:G411 NIL) (|ans| (A)) (#2=#:G417 NIL) (#3=#:G416 (A))
          (#4=#:G418 (A)) (#5=#:G424 NIL) (|v| NIL) (#6=#:G414 NIL) (|lc| (R))
...
(SDEFUN |DPOLCAT-;order;ANni;3| ((|p| A) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G426 NIL) (#2=#:G425 #3=(|NonNegativeInteger|)) (#4=#:G427 #3#)
          (#5=#:G430 NIL) (|v| NIL))
         (SEQ
...
(SDEFUN |DPOLCAT-;order;ASNni;4| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G433 NIL) (#2=#:G432 #3=(|NonNegativeInteger|)) (#4=#:G434 #3#)
          (#5=#:G440 NIL) (#6=#:G382 NIL) (|vv| (|List| #3#)) (#7=#:G439 NIL)
          (|v| NIL) (#8=#:G438 NIL))
         (SEQ
          (COND
...
(SDEFUN |DPOLCAT-;degree;ASNni;5| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((|d| (|NonNegativeInteger|)) (#1=#:G443 NIL)
          (#2=#:G442 #3=(|NonNegativeInteger|)) (#4=#:G444 #3#) (#5=#:G452 NIL)
          (#6=#:G383 NIL) (|lv| (|List| V)) (#7=#:G451 NIL) (|v| NIL)
          (#8=#:G450 NIL) (#9=#:G449 NIL) (|lp| NIL))
         (SEQ (LETT |d| 0)
...
(SDEFUN |DPOLCAT-;weights;AL;6| ((|p| A) ($ |List| (|NonNegativeInteger|)))
        (SPROG
         ((|ws| (|List| (|NonNegativeInteger|)))
          (|w| #1=(|NonNegativeInteger|)) (#2=#:G455 NIL) (#3=#:G454 #1#)
          (#4=#:G456 #1#) (#5=#:G464 NIL) (#6=#:G466 NIL) (|v| NIL)
          (#7=#:G467 NIL) (|d| NIL) (#8=#:G465 NIL) (#9=#:G384 NIL)
          (|dv| (|List| (|NonNegativeInteger|))) (|lv| (|List| V))
          (#10=#:G463 NIL) (|lp| NIL) (|mp| (|List| A)))
         (SEQ (LETT |ws| NIL)
              (EXIT
...
(SDEFUN |DPOLCAT-;weight;ANni;7| ((|p| A) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G469 NIL) (#2=#:G468 #3=(|NonNegativeInteger|)) (#4=#:G470 #3#)
          (#5=#:G473 NIL) (#6=#:G385 NIL) (|ws| (|List| #3#)))
         (SEQ
...
(SDEFUN |DPOLCAT-;weights;ASL;8|
        ...
        (SPROG
         ((|ws| (|List| (|NonNegativeInteger|)))
          (|w| #1=(|NonNegativeInteger|)) (#2=#:G477 NIL) (#3=#:G476 #1#)
          (#4=#:G478 #1#) (#5=#:G488 NIL) (#6=#:G490 NIL) (|v| NIL)
          (#7=#:G491 NIL) (|d| NIL) (#8=#:G489 NIL) (#9=#:G386 NIL)
          (|dv| (|List| (|NonNegativeInteger|))) (|lv| (|List| V))
          (#10=#:G487 NIL) (#11=#:G486 NIL) (#12=#:G485 NIL) (|lp| NIL)
          (|mp| (|List| A)))
         (SEQ (LETT |ws| NIL)
              (EXIT
               (COND ((NULL (LETT |mp| (SPADCALL |p| (QREFELT $ 41)))) |ws|)
...
(SDEFUN |DPOLCAT-;weight;ASNni;9| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G493 NIL) (#2=#:G492 #3=(|NonNegativeInteger|)) (#4=#:G494 #3#)
          (#5=#:G497 NIL) (#6=#:G387 NIL) (|ws| (|List| #3#)))
         (SEQ
...
(SDEFUN |DPOLCAT-;leader;AV;11| ((|p| A) ($ V))
        (SPROG
         ((#1=#:G500 NIL) (#2=#:G499 (V)) (#3=#:G501 (V)) (#4=#:G504 NIL)
          (#5=#:G388 NIL) (|vl| (|List| V)))
...
(SDEFUN |DPOLCAT-;differentialVariables;AL;16| ((|p| A) ($ |List| S))
        (SPROG ((#1=#:G519 NIL) (|v| NIL) (#2=#:G518 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |DPOLCAT-;eval;ALLA;18| ((|p| A) (|sl| |List| S) (|rl| |List| R) ($ A))
        (SPROG
         ((|rrl| (|List| R)) (|t| (R)) (#1=#:G539 NIL) (|i| NIL)
          (#2=#:G538 NIL) (#3=#:G537 NIL) (|r| NIL) (|vl| (|List| V))
          (#4=#:G536 NIL) (|j| NIL) (#5=#:G535 NIL) (#6=#:G534 NIL) (|s| NIL)
          (#7=#:G533 NIL) (|ordp| (|NonNegativeInteger|)))
...
(SDEFUN |DPOLCAT-;eval;ALLA;19| ((|p| A) (|sl| |List| S) (|rl| |List| A) ($ A))
        (SPROG
         ((|rrl| (|List| A)) (|t| (A)) (#1=#:G557 NIL) (|i| NIL)
          (#2=#:G556 NIL) (#3=#:G555 NIL) (|r| NIL) (|vl| (|List| V))
          (#4=#:G554 NIL) (|j| NIL) (#5=#:G553 NIL) (#6=#:G552 NIL) (|s| NIL)
          (#7=#:G551 NIL) (|ordp| (|NonNegativeInteger|)))
         (SEQ (LETT |ordp| (SPADCALL |p| (QREFELT $ 77)))
              (LETT |vl|
                    (SPADCALL
                     (PROGN
...
(SDEFUN |DPOLCAT-;eval;ALA;20| ((|p| A) (|l| |List| (|Equation| A)) ($ A))
        (SPROG
         ((#1=#:G564 NIL) (|e| NIL) (#2=#:G563 NIL) (#3=#:G562 NIL)
          (#4=#:G561 NIL))
         (SEQ
          (SPADCALL |p|
                    (PROGN
