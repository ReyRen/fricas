...
(SDEFUN |LZSTAGG-;#;ANni;5| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G509 NIL) (|y| (A)) (#2=#:G510 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;any?;MAB;6|
        ...
        (SPROG ((#1=#:G520 NIL) (#2=#:G521 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;every?;MAB;7|
        ((|f| |Mapping| (|Boolean|) S) (|x| A) ($ |Boolean|))
        (SPROG ((#1=#:G530 NIL) (#2=#:G531 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;entries;AL;8| ((|x| A) ($ |List| S))
        (SPROG
         ((#1=#:G539 NIL) (|y| (A)) (|l| (|List| S)) (#2=#:G540 NIL) (|i| NIL))
         (SEQ
          (EXIT
                 ...
                 (SEQ (LETT |i| 0) G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((SPADCALL |y| (QREFELT $ 27))
                          (PROGN (LETT #2# (NREVERSE |l|)) (GO #3=#:G538)))
                         ((SPADCALL |y| (QREFELT $ 28))
                          (|error| "infinite stream"))
                         ('T
                          (SEQ
...
(SDEFUN |LZSTAGG-;indices;AL;14| ((|x| A) ($ |List| (|Integer|)))
        (SPROG
         ((#1=#:G563 NIL) (|y| (A)) (|l| (|List| (|Integer|))) (#2=#:G564 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                 ...
                 (SEQ (LETT |i| 1) G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((SPADCALL |y| (QREFELT $ 27))
                          (PROGN (LETT #2# (NREVERSE |l|)) (GO #3=#:G562)))
                         ((SPADCALL |y| (QREFELT $ 28))
...
(SDEFUN |LZSTAGG-;maxIndex;AI;15| ((|x| A) ($ |Integer|))
        (SPROG ((#1=#:G573 NIL) (|y| (A)) (#2=#:G574 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |LZSTAGG-;delete;AUsA;18|
        ...
        (SPROG
         ((#1=#:G589 NIL) (#2=#:G585 NIL) (#3=#:G584 NIL) (|high| (|Integer|))
          (|low| (|Integer|)))
...
(SDEFUN |LZSTAGG-;elt;AUsA;19|
        ((|x| A) (|seg| |UniversalSegment| (|Integer|)) ($ A))
        (SPROG
         ((#1=#:G600 NIL) (#2=#:G596 NIL) (#3=#:G595 NIL) (|high| (|Integer|))
          (|low| (|Integer|)))
         (SEQ (LETT |low| (SPADCALL |seg| (QREFELT $ 52)))
              (EXIT
               (COND
...
(SDEFUN |LZSTAGG-;insert;SAIA;20| ((|s| S) (|x| A) (|n| |Integer|) ($ A))
        (SPROG ((|nn| (|NonNegativeInteger|)) (#1=#:G605 NIL))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT $ 46)))
...
(SDEFUN |LZSTAGG-;insert;2AIA;21| ((|y| A) (|x| A) (|n| |Integer|) ($ A))
        (SPROG ((|nn| (|NonNegativeInteger|)) (#1=#:G609 NIL))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT $ 46)))
                  (|error| "insert: index out of range"))
...
(SDEFUN |LZSTAGG-;distance;2AI;26| ((|x| A) (|z| A) ($ |Integer|))
        (SPROG ((#1=#:G633 NIL) (|y| (A)) (#2=#:G634 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;node?;2AB;27| ((|z| A) (|x| A) ($ |Boolean|))
        (SPROG ((#1=#:G642 NIL) (#2=#:G643 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;nodes;AL;28| ((|x| A) ($ |List| A))
        (SPROG
         ((#1=#:G651 NIL) (|y| (A)) (|l| (|List| A)) (#2=#:G652 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                (SEQ (LETT |i| 0) G190 NIL
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |y| (QREFELT $ 27))
                         (PROGN (LETT #2# (NREVERSE |l|)) (GO #3=#:G650)))
                        ((SPADCALL |y| (QREFELT $ 28))
...
(SDEFUN |LZSTAGG-;leaves;AL;29| ((|x| A) ($ |List| S))
        (SPROG ((#1=#:G661 NIL) (|y| (A)) (#2=#:G662 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;cycleTail;2A;35| ((|x| A) ($ A))
        (SPROG
         ((|z| (A)) (|y| (A)) (#1=#:G685 NIL) (|cycElt| (|Union| A "failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |cycElt| (|LZSTAGG-;cycleElt| |x| $))
                (EXIT
...
(SDEFUN |LZSTAGG-;last;AS;41| ((|x| A) ($ S))
        (SPROG
         ((#1=#:G706 NIL) (|y2| (A)) (|y1| (A)) (#2=#:G707 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |LZSTAGG-;last;ANniA;42| ((|x| A) (|n| |NonNegativeInteger|) ($ A))
        (SPROG ((#1=#:G708 NIL) (|m| (|NonNegativeInteger|)))
               (SEQ
                (COND
...
(SDEFUN |LZSTAGG-;tail;2A;44| ((|x| A) ($ A))
        (SPROG
         ((#1=#:G721 NIL) (|y2| (A)) (|y1| (A)) (#2=#:G722 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |LZSTAGG-;possiblyInfinite?;AB;45| ((|x| A) ($ |Boolean|))
        (SPROG ((#1=#:G730 NIL) (#2=#:G731 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
