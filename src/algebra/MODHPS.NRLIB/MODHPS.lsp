          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G510)))
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G553)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G614)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G657)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G736)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G779)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G840)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G883)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G993)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1036)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1097)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1140)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1219)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1262)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1323)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ (LETT |checkPF| |check|)
                ...
                (EXIT
                 (COND
                  ((QEQCAR |pp| 0)
                   (PROGN (LETT #4# (CONS 0 (QCDR |pp|))) (GO #5=#:G1366)))
                  ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|))) (GO #5#)))))))
          #5# (EXIT #4#)))) 
...
(SDEFUN |MODHPS;check_sol_mod_diff|
        ...
        (SPROG
         ((#1=#:G1422 NIL) (|min_ord| #2=(|NonNegativeInteger|))
          (#3=#:G1420 NIL) (|delta| (|Integer|)) (|sigma0| #2#)
          (|pa| (|U32Vector|)) (#4=#:G1425 NIL) (|j| NIL) (|c0| (|Integer|))
          (#5=#:G1421 NIL) (|ord| #2#) (#6=#:G1424 NIL) (|i| NIL)
          (|nres| (|Vector| (|U32Vector|))) (|gv0| (|U32Vector|))
          (|gvl| (|List| (|U32Vector|)))
          (|gv0p| (|Union| (|List| (|U32Vector|)) "failed"))
          (|lpt| (|List| (|Integer|))) (|qval| (|Integer|)) (#7=#:G1423 NIL)
...
(DEFUN |ModularHermitePadeSolver| (&REST #1=#:G1426)
  (SPROG NIL
         (PROG (#2=#:G1427)
           (RETURN
            (COND
...
(DEFUN |ModularHermitePadeSolver;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1349 NIL) (#2=#:G1347 NIL) (#3=#:G1306 NIL) (#4=#:G1304 NIL)
    (#5=#:G1245 NIL) (#6=#:G1243 NIL) (#7=#:G1202 NIL) (#8=#:G1200 NIL)
    (#9=#:G1123 NIL) (#10=#:G1121 NIL) (#11=#:G1080 NIL) (#12=#:G1078 NIL)
    (#13=#:G1019 NIL) (#14=#:G1017 NIL) (#15=#:G976 NIL) (#16=#:G974 NIL)
    (#17=#:G866 NIL) (#18=#:G864 NIL) (#19=#:G823 NIL) (#20=#:G821 NIL)
    (#21=#:G762 NIL) (#22=#:G760 NIL) (#23=#:G719 NIL) (#24=#:G717 NIL)
    (#25=#:G640 NIL) (#26=#:G638 NIL) (#27=#:G597 NIL) (#28=#:G595 NIL)
    (#29=#:G536 NIL) (#30=#:G534 NIL) (#31=#:G493 NIL) (#32=#:G491 NIL)
