...
(SDEFUN |GUESS;termAsEXPRR|
        ...
        (SPROG
         ((|fl| (|List| EXPRR)) (#1=#:G560 NIL) (#2=#:G559 NIL) (#3=#:G568 NIL)
          (|part| NIL) (#4=#:G567 NIL) (|ll| (|List| (|List| (|Integer|)))))
         (SEQ
...
(SDEFUN |GUESS;termAsU32VectorDiff|
        ...
        (SPROG
         ((|fl| (|List| (|U32Vector|))) (#1=#:G572 NIL) (#2=#:G571 NIL)
          (#3=#:G581 NIL) (|part| NIL) (#4=#:G580 NIL)
          (|ll| (|List| (|List| (|Integer|)))) (|d| (|NonNegativeInteger|))
          (#5=#:G570 NIL) (#6=#:G579 NIL) (|i| NIL) (#7=#:G578 NIL))
         (SEQ
          (COND
           ((NULL |partition|)
            (SPADCALL
...
(SDEFUN |GUESS;termAsU32VectorShift|
        ((|f| |U32Vector|) (|partition| |List| (|Integer|)) (|prime| |Integer|)
         (|degreeLoss| |NonNegativeInteger|) ($ |U32Vector|))
        (SPROG
         ((#1=#:G599 NIL) (|e| NIL) (#2=#:G598 NIL) (|i| NIL)
          (|r| (|U32Vector|)) (|fl| (|List| (|U32Vector|))) (#3=#:G584 NIL)
          (#4=#:G597 NIL) (|j| NIL) (#5=#:G596 NIL) (#6=#:G595 NIL)
          (|part| NIL) (#7=#:G594 NIL) (|ll| (|List| (|List| (|Integer|))))
          (|d| (|NonNegativeInteger|)) (#8=#:G583 NIL) (#9=#:G593 NIL)
          (#10=#:G592 NIL))
         (SEQ
          (COND
           ((NULL |partition|)
...
(SDEFUN |GUESS;termAsUFPSF|
        ...
        (SPROG
         ((|fl| (|List| (|UnivariateFormalPowerSeries| F))) (#1=#:G608 NIL)
          (#2=#:G607 NIL) (#3=#:G616 NIL) (|part| NIL) (#4=#:G615 NIL)
...
(SDEFUN |GUESS;termAsUFPSF2|
        ((|f| |UnivariateFormalPowerSeries| F) (|partition| |List| (|Integer|))
         ...
         ($ |UnivariateFormalPowerSeries| F))
        (SPROG
         ((|fl| (|List| (|UnivariateFormalPowerSeries| F))) (#1=#:G620 NIL)
          (#2=#:G628 NIL) (|part| NIL) (#3=#:G627 NIL)
          (|ll| (|List| (|List| (|Integer|)))))
         (SEQ
          (COND ((NULL |partition|) D1)
                ('T
        ...
        (SPROG
         ((|fl|
           (|List|
            (|UnivariateFormalPowerSeries|
             (|SparseMultivariatePolynomial| F (|NonNegativeInteger|)))))
          (#1=#:G631 NIL) (#2=#:G639 NIL) (|part| NIL) (#3=#:G638 NIL)
          (|ll| (|List| (|List| (|Integer|)))))
         (SEQ
...
(SDEFUN |GUESS;guessModGenCached|
        ...
        (SPROG
         ((#1=#:G661 NIL) (|i| NIL) (#2=#:G662 NIL) (|r| NIL)
          (|res| (|Vector| (|U32Vector|))) (#3=#:G659 NIL) (#4=#:G660 NIL)
          (|res1| (|U32Vector|)) (#5=#:G650 NIL) (|nt| (|NonNegativeInteger|))
          (#6=#:G657 NIL) (#7=#:G658 NIL) (|pp| NIL))
         (SEQ
...
(SDEFUN |GUESS;DEPguessModGenCached|
        ((|fl| |List| (|U32Vector|)) (|addOne| |Boolean|)
         ...
         ($ |Vector| (|U32Vector|)))
        (SPROG
         ((#1=#:G667 NIL) (|i| NIL) (#2=#:G668 NIL) (|f| (|U32Vector|))
...
(SDEFUN |GUESS;ADEguessModGenCached|
        ((|fl| |List| (|U32Vector|)) (|addOne| |Boolean|)
         ...
         ($ |Vector| (|U32Vector|)))
        (SPROG
         ((#1=#:G673 NIL) (|i| NIL) (|cache| (|PrimitiveArray| (|U32Vector|)))
        ...
        ((|f| |UnivariateFormalPowerSeries|
         ...
         ($ |Vector|
          (|UnivariateFormalPowerSeries|
           (|SparseMultivariatePolynomial| F (|NonNegativeInteger|)))))
        (SPROG
         ((#1=#:G687 NIL) (|i| NIL) (#2=#:G688 NIL) (|r| NIL)
          (|res|
           (|Vector|
            (|UnivariateFormalPowerSeries|
             (|SparseMultivariatePolynomial| F (|NonNegativeInteger|)))))
          (#3=#:G685 NIL) (#4=#:G686 NIL) (|nt| (|NonNegativeInteger|))
          (#5=#:G683 NIL) (#6=#:G684 NIL) (|pp| NIL) (#7=#:G682 NIL)
          (|cache|
           (|PrimitiveArray|
            (|UnivariateFormalPowerSeries|
             (|SparseMultivariatePolynomial| F (|NonNegativeInteger|)))))
...
(SDEFUN |GUESS;multiplyExponents|
        ...
        (SPROG
         ((#1=#:G692 NIL) (|i| NIL) (|deg| (|Integer|)) (|f0| (|U32Vector|))
...
(SDEFUN |GUESS;FEguessModGenCached|
        ((|fl| |List| (|U32Vector|)) (|addOne| |Boolean|)
         ...
         ($ |Vector| (|U32Vector|)))
        (SPROG
         ((#1=#:G697 NIL) (|i| NIL) (|cache| (|PrimitiveArray| (|U32Vector|)))
          (|np| (|NonNegativeInteger|)) (|sigma| (|NonNegativeInteger|))
          (|f| (|U32Vector|)))
         (SEQ
          (COND
...
(SDEFUN |GUESS;optimiseFactor|
        ...
        (SPROG
         ((#1=#:G717 NIL) (|j| (|Integer|))
          (|r| (|Union| (|Partition|) "failed")) (#2=#:G718 NIL) (|p| NIL)
          (#3=#:G719 NIL) (|i| NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |GUESS;optimiseProducts|
        ((|partitions| |List| (|List| (|Integer|)))
         ($ |Record| (|:| |addOne| (|Boolean|))
          ...
          (|:| |terms| (|List| (|Integer|)))))
        (SPROG
         ((#1=#:G735 NIL) (|terms0| (|List| (|Integer|))) (#2=#:G740 NIL)
          (|p| NIL) (|parts0| (|Reference| (|List| (|Partition|)))) (|i| NIL)
          (#3=#:G739 NIL)
          (|prods0| (|Reference| (|List| (|List| (|Integer|)))))
          (|maxD0| (|Integer|)) (#4=#:G738 NIL) (|addOne0| (|Boolean|)))
         (SEQ
          (EXIT
...
(SDEFUN |GUESS;ADEguessModGen2!0| ((|fl| NIL) (|prime| NIL) (|q| NIL) ($$ NIL))
        (PROG ($ |partitions| |d|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G764 NIL) (|p| NIL) (#2=#:G763 NIL) (|f| NIL))
                   (SEQ
                    (COND
...
(SDEFUN |GUESS;ADEtestGen2!0| ((|f| NIL) ($$ NIL))
        (PROG (|partitions| DSF D1F $)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G777 NIL) (|p| NIL) (#2=#:G776 NIL))
                   (SEQ
                    (SPADCALL
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;diffHP;LR;43!2| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G812 NIL) (|i| NIL) (#2=#:G811 NIL))
                   (SEQ
...
(SDEFUN |GUESS;monomialAsEXPRR|
        ...
        (SPROG
         ((|fl| (|List| EXPRR)) (#1=#:G848 NIL) (#2=#:G847 NIL) (#3=#:G856 NIL)
          (|part| NIL) (#4=#:G855 NIL) (|ll| (|List| (|List| (|Integer|)))))
         (SEQ
...
(SDEFUN |GUESS;get_fnames|
        ...
        (SPROG
         ((#1=#:G871 NIL) (|sym| NIL) (#2=#:G870 NIL)
          (|syms| (|List| (|Symbol|))) (#3=#:G869 NIL) (|i| NIL)
          (#4=#:G868 NIL) (|snums| (|List| (|String|))) (#5=#:G867 NIL)
          (|q| NIL) (#6=#:G866 NIL) (|n1| (|NonNegativeInteger|)))
...
(SDEFUN |GUESS;algDepHP;LLR;47!5| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $ |fakeDSF|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G890 NIL) (|i| NIL) (#2=#:G889 NIL))
                   (SEQ
                    (|GUESS;ADEtestOptimisedGen|
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;substHP;LR;51!3| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G926 NIL) (|i| NIL) (#2=#:G925 NIL))
                   (SEQ
                    (|GUESS;ADEtestOptimisedGen|
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;qDiffDSV|
        ((|f| |U32Vector|) (|n| |NonNegativeInteger|) (|prime| |Integer|)
         (|q| |Integer|) ($ |U32Vector|))
        (SPROG
         ((Q (|Integer|)) (#1=#:G958 NIL) (|i| NIL) (|qn| (|Integer|))
          (|r| (|U32Vector|)) (#2=#:G951 NIL) (|d| (|Integer|)))
         (SEQ
          (COND ((ZEROP |n|) |f|)
                ('T
...
(SDEFUN |GUESS;termAsU32VectorqDiff|
        ...
        (SPROG
         ((|fl| (|List| (|U32Vector|))) (#1=#:G965 NIL) (#2=#:G964 NIL)
          (#3=#:G975 NIL) (|part| NIL) (#4=#:G974 NIL)
          (|ll| (|List| (|List| (|Integer|)))) (|d| (|NonNegativeInteger|))
          (#5=#:G963 NIL) (#6=#:G973 NIL) (|i| NIL) (#7=#:G972 NIL))
         (SEQ
          (COND
           ((NULL |partition|)
            (SPADCALL
...
(SDEFUN |GUESS;ADEguessModGenq!0| ((|fl| NIL) (|prime| NIL) (|q| NIL) ($$ NIL))
        (PROG ($ |partitions| |d|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G981 NIL) (|p| NIL) (#2=#:G980 NIL) (|f| NIL))
                   (SEQ
                    (COND
                     ((SPADCALL (SPADCALL |fl| (QREFELT $ 175))
                                (|spadConstant| $ 176) (QREFELT $ 147))
...
(SDEFUN |GUESS;diffHP;SM;58!5| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $ |q|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G997 NIL) (|i| NIL) (#2=#:G996 NIL))
                   (SEQ
                    (|GUESS;ADEtestOptimisedGen|
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;ShiftSXGF|
        ((|expr| EXPRR) (|x| |Symbol|) (|n| |NonNegativeInteger|) ($ EXPRR))
        (SPROG
         ((|l| (|List| EXPRR)) (#1=#:G1024 NIL) (|i| NIL) (#2=#:G1023 NIL))
         (SEQ
          (COND ((ZEROP |n|) |expr|)
                ('T
                 (SEQ
...
(SDEFUN |GUESS;ShiftAXGF|
        ((|l| |NonNegativeInteger|) (|x| |Symbol|) (|f| EXPRR) ($ EXPRR))
        (SPROG
         ((|s| (|List| EXPRR)) (#1=#:G1035 NIL) (|i| NIL) (#2=#:G1034 NIL))
         (SEQ
          (COND ((ZEROP |l|) |f|)
                ('T
                 (SEQ
...
(SDEFUN |GUESS;shiftHP;LR;68!2| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G1054 NIL) (|i| NIL) (#2=#:G1053 NIL))
                   (SEQ
                    (|GUESS;ADEtestGen2|
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;qSubstEXPRR|
        ...
        (SPROG ((#1=#:G1084 NIL) (|i| NIL) (#2=#:G1083 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0) (LETT #1# |maxMD|) G190
...
(SDEFUN |GUESS;ADEguessModGen2Mixed!0|
        ...
        (PROG ($ |dl| |o| |maxMD| |partitions|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|l| NIL) (|vv| NIL) (#1=#:G1114 NIL) (|e| NIL) (|vn| NIL)
              (#2=#:G1113 NIL) (|i| NIL) (|r| NIL) (#3=#:G1112 NIL)
              (#4=#:G1111 NIL) (|lastv| NIL) (#5=#:G1109 NIL) (|v| NIL)
              (#6=#:G1110 NIL) (|w| NIL) (|vv1| NIL) (#7=#:G1108 NIL) (|p| NIL)
              (#8=#:G1107 NIL) (O NIL) (#9=#:G1092 NIL) (#10=#:G1106 NIL)
              (|qv| NIL) (|d| NIL) (#11=#:G1090 NIL) (|f| NIL))
             (SEQ
              (COND
               ((SPADCALL (SPADCALL |fl| (QREFELT $ 175))
                          (|spadConstant| $ 176) (QREFELT $ 147))
...
(SDEFUN |GUESS;ADEdegreeStreamMixShift!0| ((|z1| NIL) ($$ NIL))
        (PROG ($ |maxMD|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G1119 NIL) (|i| NIL) (#2=#:G1118 NIL))
                   (SEQ
                    (PROGN
                     (LETT #2# NIL)
...
(SDEFUN |GUESS;ADEtestMixShiftGen!0| ((|f| NIL) ($$ NIL))
        (PROG (|l| $ |maxMD| |partitions| |q|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|res| NIL) (#1=#:G1142 NIL) (|i| NIL) (#2=#:G1141 NIL)
              (|f0| NIL) (|exponents| NIL) (#3=#:G1129 NIL)
              (|oldPartition| NIL) (#4=#:G1140 NIL) (#5=#:G1139 NIL)
              (|newPartition| NIL) (#6=#:G1123 NIL) (#7=#:G1138 NIL) (|p| NIL)
              (#8=#:G1122 NIL))
...
(SDEFUN |GUESS;shift_hp_aux!2| ((|l| NIL) ($$ NIL))
        (PROG (|partitions| $)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G1165 NIL) (|i| NIL) (#2=#:G1164 NIL))
                   (SEQ
                    (|GUESS;ADEtestGen2|
                     (PROGN
                      (LETT #2# NIL)
...
(SDEFUN |GUESS;guessInterpolateModular|
        ...
        (SPROG
         ((|check|
          ...
          (#1=#:G1274 NIL) (|i| NIL) (#2=#:G1273 NIL)
          (|deg|
           (|Record| (|:| |quotient| (|NonNegativeInteger|))
                     (|:| |remainder| (|NonNegativeInteger|))))
          (#3=#:G1272 NIL) (#4=#:G1271 NIL) (#5=#:G1270 NIL) (#6=#:G1269 NIL)
          (|maxD| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (#7=#:G1225 NIL) (#8=#:G1267 NIL) (|del| (|Integer|))
          (|leadingZeros| (|Integer|)) (#9=#:G1268 NIL) (|el| NIL)
          (|sigma| (|NonNegativeInteger|)) (#10=#:G1223 NIL)
          (|list| (|List| F)))
         (SEQ
          (EXIT
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL |del| |guessDegree| (QREFELT $ 158))
                          (PROGN (LETT #8# (CONS 1 NIL)) (GO #11=#:G1266)))
                         (#12='T
                          (LETT |guessDegree|
...
(SDEFUN |GUESS;guessInterpolateFFFG|
        ...
        (SPROG
         ((#2=#:G1358 NIL) (#3=#:G1380 NIL) (|j| NIL) (|c| (S))
          (|cl| (|List| S)) (#4=#:G1379 NIL) (#5=#:G1378 NIL) (#6=#:G1377 NIL)
          (#7=#:G1375 NIL) (|i1| NIL) (#8=#:G1376 NIL) (|i2| NIL)
          (|Mr| (|Matrix| (|SparseUnivariatePolynomial| S)))
          (|m| (|NonNegativeInteger|)) (|rl| (|List| (|Integer|)))
          (|ce| (|List| (|SparseUnivariatePolynomial| S))) (#9=#:G1374 NIL)
          ...
          (|eta| (|List| (|NonNegativeInteger|))) (#11=#:G1373 NIL)
          (#12=#:G1372 NIL)
          (|deg|
           (|Record| (|:| |quotient| (|NonNegativeInteger|))
                     (|:| |remainder| (|NonNegativeInteger|))))
          (#13=#:G1300 NIL) (#14=#:G1371 NIL) (#15=#:G1370 NIL)
          (#16=#:G1289 NIL) (#17=#:G1369 NIL) (#18=#:G1368 NIL)
          (|maxD| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (#19=#:G1277 NIL) (#20=#:G1367 NIL) (|d| NIL) (#21=#:G1366 NIL)
          (|list| (|List| F)))
         (SEQ (LETT |list| (|SPADfirst| |lists|))
              (COND
               ((SPADCALL |options| (QREFELT $ 363))
...
(SDEFUN |GUESS;guessInterpolate3!1| (($$ NIL))
        (PROG (|vs| $ |lists| |o| |degreeLoss| |guessDegree| D |options|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|degs| NIL) (M0 NIL) (#1=#:G1397 NIL) (M NIL))
                   (SEQ
                    (EXIT
                     (COND
...
(SDEFUN |GUESS;precCheck|
        ...
        (SPROG
         ((#1=#:G1455 NIL) (#2=#:G1453 NIL) (|res2| (S)) (|p2val| (S))
          (|p2| (|SparseUnivariatePolynomial| S)) (#3=#:G1465 NIL) (|j| NIL)
          (#4=#:G1452 NIL) (#5=#:G1464 NIL) (|si| (S)) (#6=#:G1463 NIL)
          (|i| NIL) (#7=#:G1454 NIL) (|res1| (S)) (#8=#:G1462 NIL)
          (#9=#:G1461 NIL) (|gl| (|Vector| S)) (#10=#:G1450 NIL)
          (#11=#:G1460 NIL) (#12=#:G1449 NIL) (#13=#:G1459 NIL)
          (#14=#:G1458 NIL) (#15=#:G1451 NIL) (|cden| (S)) (|c2| (S))
          (#16=#:G1419 NIL) (|c1| (S)) (|pp| (S)) (|vd| (S)) (|vi| (F))
          (#17=#:G1457 NIL) (#18=#:G1456 NIL) (|order| (|Integer|))
...
(SDEFUN |GUESS;checkInterpolant|
        ...
        (SPROG
         ((#2=#:G1518 NIL) (#3=#:G1516 NIL) (|order| (|Integer|))
          ...
          (|resiSUPF|
           (|List|
            (|SparseUnivariatePolynomial|
             (|SparseMultivariatePolynomial| F (|NonNegativeInteger|)))))
          (#4=#:G1523 NIL) (|i| NIL) (#5=#:G1522 NIL) (|testList| #1#)
          (|flist| (|List| (|PositiveInteger|))) (#6=#:G1497 NIL)
          (#7=#:G1521 NIL) (#8=#:G1520 NIL) (|maxPow| (|Integer|))
          (|maxP| (|Union| (|PositiveInteger|) "arbitrary"))
                   ...
                   (SEQ
                    (COND
                     ((NULL (SPADCALL |options| (QREFELT $ 423)))
                      (COND
                       ((EQL |d| |sigma|)
                        (PROGN (LETT #2# (CONS 0 "good")) (GO #13=#:G1515))))))
                    (COND
                     (|reject_one_term|
                      (COND
                       ((EQL |d| |sigma|)
                    ...
                    (COND
                     ((NULL (SPADCALL |c| (QREFELT $ 454)))
                      (SEQ (LETT |order| |d|)
                           (EXIT
                            (PROGN (LETT #3# |$NoValue|) (GO #14=#:G1508))))))
                    (EXIT
                     (COND
...
(SDEFUN |GUESS;wrapInterpolant|
        ...
        (SPROG
         ((|ex| (|List| EXPRR)) (#1=#:G1554 NIL) (|p| NIL) (#2=#:G1555 NIL)
          (|e| NIL) (#3=#:G1553 NIL) (|eq| (EXPRR)) (#4=#:G1551 NIL)
          (#5=#:G1552 NIL) (#6=#:G1550 NIL) (|dk| (|Symbol|)))
...
(SDEFUN |GUESS;guessHPaux|
        ...
        (SPROG
         ((#3=#:G1626 NIL) (|reslist| (|List| EXPRR)) (|res| (EXPRR))
          ...
          (M (|Matrix| (|SparseUnivariatePolynomial| S))) (#5=#:G1624 NIL)
          (#6=#:G1606 NIL) (#7=#:G1627 NIL) (#8=#:G1621 NIL) (#9=#:G1569 NIL)
          (|maxD| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (|guessDegree| #10=(|Integer|)) (|degreeLoss| (|Integer|))
          (#11=#:G1625 NIL) (#12=#:G1560 NIL) (|o| NIL) (|exprS| #2#)
          (#13=#:G1620 NIL) (|dk| (|Symbol|)) (|degreeS| #1#)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |reslist| NIL) (LETT |list| (|SPADfirst| |lists|))
                ...
                (COND
                 ((< |listDegree| 0)
                  (PROGN (LETT #3# |reslist|) (GO #14=#:G1619))))
                (LETT |op|
                         ...
                         (COND
                          ((SPADCALL
                            (SPADCALL |degreeS|
                                      ...
                                      (QREFELT $ 475))
                            (QREFELT $ 476))
                           (PROGN (LETT #11# |$NoValue|) (GO #16=#:G1617)))
                          ('T
                           (SEQ
                            (LETT |degreeLoss|
                                  (SPADCALL |degreeS| |o| (QREFELT $ 270)))
...
(SDEFUN |GUESS;processOptions|
        ...
        (SPROG
         ((#1=#:G1678 NIL) (#2=#:G1672 NIL) (#3=#:G1670 NIL) (#4=#:G1682 NIL)
          (#5=#:G1636 NIL) (|i| NIL) (#6=#:G1681 NIL)
          (|minP| (|PositiveInteger|))
          (|hom?| (|Union| (|PositiveInteger|) (|Boolean|))) (#7=#:G1645 NIL)
          (#8=#:G1680 NIL) (#9=#:G1679 NIL) (|maxSomos| (|PositiveInteger|))
          (#10=#:G1630 NIL) (#11=#:G1641 NIL) (#12=#:G1639 NIL)
          (|maxD| (|NonNegativeInteger|)) (#13=#:G1633 NIL)
...
(SDEFUN |GUESS;guessAlgDep;LLL;98|
        ((|lists| |List| (|List| F)) (|options| |List| (|GuessOption|))
         ($ |List| EXPRR))
        (SPROG
         ((|lres| (|List| EXPRR)) (#1=#:G1698 NIL) (|res| (|List| EXPRR))
          (#2=#:G1700 NIL) (|opts| NIL)
          (|lopts| (|List| (|List| (|GuessOption|)))) (#3=#:G1688 NIL)
          (#4=#:G1697 NIL) (#5=#:G1699 NIL) (|li| NIL)
...
(SDEFUN |GUESS;guessADE;LLL;100|
        ((|list| |List| F) (|options| |List| (|GuessOption|)) ($ |List| EXPRR))
        (SPROG
         ((|lres| (|List| EXPRR)) (#1=#:G1709 NIL) (|res| (|List| EXPRR))
          (#2=#:G1710 NIL) (|opts| NIL)
...
(SDEFUN |GUESS;guessFE;LLL;108|
        ((|list| |List| F) (|options| |List| (|GuessOption|)) ($ |List| EXPRR))
        (SPROG
         ((|lres| (|List| EXPRR)) (#1=#:G1738 NIL) (|res| (|List| EXPRR))
          (#2=#:G1739 NIL) (|opts| NIL)
          (|lopts| (|List| (|List| (|GuessOption|)))))
         (SEQ
          (EXIT
           (SEQ (SPADCALL |options| (QREFELT $ 496))
...
(SDEFUN |GUESS;guessADE;SM;110!0| ((|list| NIL) (|options| NIL) ($$ NIL))
        (PROG ($ |q|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|lres| NIL) (#1=#:G1748 NIL) (|res| NIL) (#2=#:G1749 NIL)
              (|opts| NIL) (|lopts| NIL))
             (SEQ
              (EXIT
               (SEQ (SPADCALL |options| (QREFELT $ 496))
...
(SDEFUN |GUESS;guessRec;LLL;112|
        ((|list| |List| F) (|options| |List| (|GuessOption|)) ($ |List| EXPRR))
        (SPROG
         ((|lres| (|List| EXPRR)) (#1=#:G1763 NIL) (|res| (|List| EXPRR))
          (#2=#:G1764 NIL) (|opts| NIL)
          (|lopts| (|List| (|List| (|GuessOption|)))))
         (SEQ
          (EXIT
           (SEQ (SPADCALL |options| (QREFELT $ 496))
...
(SDEFUN |GUESS;guessRec;SM;118!0| ((|list| NIL) (|options| NIL) ($$ NIL))
        (PROG ($ |q|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|lres| NIL) (#1=#:G1787 NIL) (|res| NIL) (#2=#:G1788 NIL)
              (|opts| NIL) (|lopts| NIL))
             (SEQ
              (EXIT
               (SEQ (SPADCALL |options| (QREFELT $ 496))
...
(SDEFUN |GUESS;guess;LLLLL;121|
        ((|list| |List| F)
         ...
         ($ |List| EXPRR))
        (SPROG
         ((|res| (|List| EXPRR)) (#1=#:G1899 NIL) (|guess| NIL)
          (|sumGuess| (|List| EXPRR)) (|summ| (EXPRR)) (|init| (EXPRR))
          (#2=#:G1898 NIL) (|var| (|Symbol|)) (|sumList| (|List| F))
          (#3=#:G1897 NIL) (|i| NIL) (#4=#:G1896 NIL) (#5=#:G1890 NIL)
          (#6=#:G1895 NIL) (|prodGuess| (|List| EXPRR)) (|prod| (EXPRR))
          (#7=#:G1894 NIL) (|prodList| (|List| F)) (#8=#:G1893 NIL)
          (#9=#:G1892 NIL)
          (|newMaxLevel| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (#10=#:G1811 NIL) (#11=#:G1891 NIL) (|guesser| NIL)
          (|len| (|PositiveInteger|)) (#12=#:G1807 NIL) (|xx| (EXPRR)))
         (SEQ
          (EXIT
