...
(SDEFUN |IRSN;aIdInverse| (($ |Void|))
        (SPROG
         ((#1=#:G518 NIL) (#2=#:G456 NIL) (#3=#:G433 NIL) (|i| NIL)
          (#4=#:G529 NIL) (|k| NIL) (#5=#:G421 NIL) (#6=#:G405 NIL) (|j| NIL)
          (#7=#:G528 NIL) (|l| NIL) (#8=#:G527 NIL)
          (|idperm| (|List| (|Integer|))) (#9=#:G525 NIL) (#10=#:G526 NIL))
         (SEQ
          (EXIT
           (SEQ (SETELT $ 13 (MAKE_MATRIX1 (QREFELT $ 7) (QREFELT $ 7) 0))
                ...
                (COND
                 ((< (QREFELT $ 10) 5)
                  (PROGN (LETT #9# (QREFELT $ 13)) (GO #11=#:G524))))
                (LETT |idperm| NIL)
...
(SDEFUN |IRSN;alreadyComputed?| ((|lambda| |List| #1=(|Integer|)) ($ |Void|))
        (SPROG
         ((#2=#:G538 NIL) (#3=#:G536 NIL) (#4=#:G535 #1#) (#5=#:G537 #1#)
          (#6=#:G541 NIL) (#7=#:G382 NIL) (#8=#:G531 NIL) (#9=#:G530 NIL))
         (SEQ
          (COND
...
(SDEFUN |IRSN;sumPartition|
        ...
        (SPROG
         ((#1=#:G565 NIL) (|prev| (|Integer|)) (|ok| (|Boolean|))
          (|sum| (|Integer|)) (#2=#:G568 NIL) (|x| NIL))
...
(SDEFUN |IRSN;testPermutation|
        ...
        (SPROG
         ((#1=#:G576 NIL) (#2=#:G580 NIL) (|i| NIL)
          (|test| (|Vector| (|Boolean|))) (#3=#:G573 NIL) (|ok| (|Boolean|))
          (#4=#:G579 NIL))
...
(SDEFUN |IRSN;dimensionOfIrreducibleRepresentation;LNni;7|
        ((|lambda| |List| (|Integer|)) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G583 NIL) (|dd| (|Integer|)) (#2=#:G587 NIL) (|j| NIL)
          (#3=#:G586 NIL) (|i| NIL) (|lambdaprime| (|List| (|Integer|)))
          (|nn| (|Integer|)))
         (SEQ (LETT |nn| (|IRSN;sumPartition| |lambda| $)) (LETT |dd| 1)
              (LETT |lambdaprime| (SPADCALL |lambda| (QREFELT $ 22)))
              (SEQ (LETT |i| 1)
                   (LETT #3# (SPADCALL |lambdaprime| 1 (QREFELT $ 32))) G190
                   (COND ((|greater_SI| |i| #3#) (GO G191)))
                   (SEQ
                    (EXIT
                     (SEQ (LETT |j| 1)
                          (LETT #2# (SPADCALL |lambda| |i| (QREFELT $ 32)))
              ...
              (EXIT
               (PROG1
                   (LETT #1# (QUOTIENT2 (SPADCALL |nn| (QREFELT $ 39)) |dd|))
                 (|check_subtype2| (>= #1# 0) '(|NonNegativeInteger|)
                                   '(|Integer|) #1#)))))) 
...
(SDEFUN |IRSN;irreducibleRepresentation;LPM;8|
        ((|lambda| |List| (|Integer|)) (|pi| |Permutation| (|Integer|))
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G594 NIL) (|l| NIL) (#2=#:G593 NIL) (|k| NIL)
                    ...
                    (COND
                     ...
                     ('T
                      (SEQ
                       ...
                       (EXIT
                        (CONS (SPADCALL (LIST 1 2) (QREFELT $ 44))
                              |listperm|))))))
...
(SDEFUN |IRSN;irreducibleRepresentation;LLL;10|
        ((|lambda| |List| (|Integer|))
         (|listperm| |List| (|Permutation| (|Integer|)))
         ($ |List| (|Matrix| (|Integer|))))
        (SPROG ((#1=#:G603 NIL) (|pi| NIL) (#2=#:G602 NIL))
