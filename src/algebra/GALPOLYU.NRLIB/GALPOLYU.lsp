...
(SDEFUN |GALPOLYU;factorsOfDegree;PiFL;1|
        ...
        (SPROG
         ((|lfact| (|List| UP)) (#1=#:G390 NIL) (|i| NIL) (#2=#:G389 NIL)
          (|fr| NIL))
         (SEQ (LETT |lfact| NIL)
...
(SDEFUN |GALPOLYU;factorOfDegree;PiFUP;2|
        ...
        (SPROG ((#1=#:G396 NIL) (|factor| (UP)) (#2=#:G397 NIL) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |GALPOLYU;degreePartition;FM;3|
        ...
        (SPROG ((#1=#:G402 NIL) (|i| NIL) (#2=#:G401 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |GALPOLYU;reverse;2UP;5| ((|p| UP) ($ UP))
        (SPROG
         ((|r| (UP)) (#1=#:G404 NIL) (#2=#:G408 NIL) (|i| NIL)
...
(DEFUN |GaloisGroupPolynomialUtilities| (&REST #1=#:G424)
  (SPROG NIL
         (PROG (#2=#:G425)
           (RETURN
            (COND
