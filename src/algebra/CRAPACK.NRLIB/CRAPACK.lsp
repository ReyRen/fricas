...
(SDEFUN |CRAPACK;chineseRemainder;2LR;2|
        ...
        (SPROG
         ((|y| (BB)) (|l| (|List| R)) (#1=#:G406 NIL) (|v| NIL) (#2=#:G407 NIL)
          (|u| (|Union| (|Record| (|:| |coef1| R) (|:| |coef2| R)) "failed"))
          (#3=#:G408 NIL) (|m| NIL) (#4=#:G405 NIL) (|linv| (|List| R))
          (|inv| (R)) (|x| (BB)))
         (SEQ
          (COND
...
(SDEFUN |CRAPACK;chineseRemainder;L2L;3|
        ...
        (SPROG
         ((|retVal| (|List| R)) (|y| (BB)) (|l| (|List| R)) (#1=#:G425 NIL)
          (|v| NIL) (#2=#:G426 NIL) (|u3| NIL) (#3=#:G427 NIL) (|m| NIL)
          (#4=#:G424 NIL) (#5=#:G423 NIL) (|lv| NIL) (|linv| (|List| R))
          (|inv| (R))
          (|u| (|Union| (|Record| (|:| |coef1| R) (|:| |coef2| R)) "failed"))
          (|x| (BB)))
         (SEQ
