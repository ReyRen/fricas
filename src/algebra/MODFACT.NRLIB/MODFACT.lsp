...
(SDEFUN |MODFACT;mvmul|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#1=#:G396 NIL) (|j| NIL) (#2=#:G395 NIL)
...
(SDEFUN |MODFACT;mmul;2UmIUm;2|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#1=#:G406 NIL) (|k| NIL) (#2=#:G405 NIL)
          (|j| NIL) (#3=#:G404 NIL) (|i| NIL) (|res| (|U32Matrix|))
...
(SDEFUN |MODFACT;red_pol;UvLV;4|
        ((|pol| |U32Vector|)
         ...
         ($ |Void|))
        (SPROG
         ((#1=#:G420 NIL) (|i| NIL) (|tmp| (|U32Vector|))
          (|mi| (|NonNegativeInteger|)) (|ni| #2=(|Integer|))
          (|ii| #3=(|NonNegativeInteger|)) (#4=#:G419 NIL) (|ri| NIL)
...
(SDEFUN |MODFACT;mod_exp;UvILUv;5|
        ((|pol| |U32Vector|) (|n| |Integer|)
         ...
         ($ |U32Vector|))
        (SPROG
         ((|pow1| #1=(|U32Vector|)) (#2=#:G430 NIL) (|has_res| (|Boolean|))
            ...
            (SEQ (LETT |r0| (|SPADfirst| |rdata|)) (LETT |p| (QCAR |r0|))
                 ...
                 (SEQ
                  (EXIT
                   (SEQ G190
                        (COND
                         ((NULL (SPADCALL |n| 0 (QREFELT $ 23))) (GO G191)))
                        (SEQ
                         (COND
                          ((ODDP |n|)
                           (COND
                         ...
                         (EXIT
                          (COND
                           ((EQL |n| 0)
                            (PROGN (LETT #2# |$NoValue|) (GO #4=#:G427)))
                           ('T
                            (SEQ
                             (LETT |pow1|
                                   (SPADCALL |pow| |pow| |p| (QREFELT $ 24)))
...
(SDEFUN |MODFACT;power_matrix;UvNniLR;6|
        ...
        (SPROG
         ((#1=#:G442 NIL) (|k| NIL) (|nn1| (|Integer|)) (|pow1| (|U32Vector|))
          (#2=#:G441 NIL) (#3=#:G440 NIL) (|j| NIL) (|n1| (|SingleInteger|))
         ...
         (SEQ (LETT |r0| (|SPADfirst| |rdata|)) (LETT |p| (QCAR |r0|))
              ...
              (SEQ (LETT |j| 1) (LETT #3# |l1|) G190
                   ...
                   (SEQ
                    ...
                    (LETT |pow1| (SPADCALL |xp| |pow| |p| (QREFELT $ 24)))
                    (SPADCALL |pow1| |rdata| (QREFELT $ 20))
                    (LETT |nn1|
...
(SDEFUN |MODFACT;modular_compose;UvUmUv2NniLUv;7|
        ((|pol| |U32Vector|) (|pm| |U32Matrix|) (|xp1| |U32Vector|)
         ...
         ($ |U32Vector|))
        (SPROG
         ((|res1| (|U32Vector|)) (#1=#:G455 NIL) (|i| (|SingleInteger|))
          (|k| NIL) (|ns1| (|SingleInteger|)) (|res| #2=(|U32Vector|))
          (|p1| #2#) (|m2| (|U32Matrix|)) (#3=#:G454 NIL) (#4=#:G453 NIL)
        ...
        ((|pol| |U32Vector|) (|p| |Integer|)
         ($ |List|
          #1=(|Record| (|:| |ind| (|NonNegativeInteger|))
                       (|:| |poly| (|U32Vector|)))))
        (SPROG
         ((|res| (|List| #1#)) (|tmp1| #2=(|U32Vector|)) (#3=#:G464 NIL)
         ...
         (SEQ (LETT |n| (SPADCALL |pol| (QREFELT $ 14)))
              ...
              (LETT |ni| (LETT |n1| (- |n| 1)))
              (LETT |tmp| (GETREFV_U32 (SPADCALL 2 |n1| (QREFELT $ 31)) 0))
              (SEQ G190
                   (COND ((NULL (SPADCALL |ni| 10 (QREFELT $ 23))) (GO G191)))
...
(SDEFUN |MODFACT;floor_sqrt| ((|n| |Integer|) ($ |Integer|))
        (SPROG ((|res| (|Integer|)))
               (SEQ (LETT |res| (SPADCALL |n| (QREFELT $ 35)))
                    (EXIT
                     (COND
                      ((SPADCALL |n| (* |res| |res|) (QREFELT $ 21)) |res|)
                      ('T (+ |res| 1))))))) 
...
(SDEFUN |MODFACT;eqfact|
        ...
        (SPROG
         ((|dg| #3=(|NonNegativeInteger|)) (|dp| (|NonNegativeInteger|))
          ...
          (|tr| #5#) (#6=#:G484 NIL) (|i| NIL) (#7=#:G483 NIL) (#8=#:G482 NIL)
          (|kk| (|Integer|)) (#9=#:G481 NIL) (|n0| (|Integer|)) (|rpol| #5#)
         ...
         ((|res|
           (|List|
            (|Record| (|:| |poly| (|U32Vector|))
                      ...
                      (|:| |separate_factors|
                           (|Mapping| (|List| (|U32Vector|)))))))
          (#1=#:G502 NIL) (|dg| (|Integer|)) (|pk| (|U32Vector|))
          (#2=#:G509 NIL) (#3=#:G507 NIL) (#4=#:G508 NIL)
          (|n| #5=(|NonNegativeInteger|)) (|tmp| #6=(|U32Vector|))
          (#7=#:G513 NIL) (|g1| NIL) (|res1| (|List| (|U32Vector|)))
          (|g| (|U32Vector|)) (|i| (|NonNegativeInteger|)) (#8=#:G512 NIL)
          (|pj| #9=(|U32Vector|)) (#10=#:G511 NIL) (|i1| NIL)
          (|xp2| #11=(|U32Vector|)) (|pmat2| #12=(|U32Matrix|)) (|#G72| #11#)
          (|#G71| #12#)
          (|#G70| #13=(|Record| (|:| |matr| #12#) (|:| |poly| #11#)))
          (|pk1| #6#) (|lpj| (|List| #6#)) (#14=#:G510 NIL)
         ...
         (SEQ (LETT |rdata| (SPADCALL |pol| |p| (QREFELT $ 32)))
              ...
              (COND
               ((SPADCALL |k1| 1 (QREFELT $ 40))
                (PROGN
                 (LETT |#G70| (SPADCALL |pj| |l1| |rdata| (QREFELT $ 27)))
                 (LETT |pmat2| (QCAR |#G70|))
                 (LETT |xp2| (QCDR |#G70|))
                 |#G70|))
               (#15#
                ...
                (SEQ (LETT |i1| 1) (LETT #10# |k2|) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((>= |i| (QUOTIENT2 |n| 2))
                         (PROGN (LETT #2# |$NoValue|) (GO #18=#:G500)))
                        ('T
                         (LETT |pk|
