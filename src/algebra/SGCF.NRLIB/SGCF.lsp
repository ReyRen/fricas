...
(SDEFUN |SGCF;numberOfImproperPartitionsInternal|
        ...
        (SPROG ((|s| (|Integer|)) (#1=#:G395 NIL) (|i| NIL))
               (SEQ
...
(SDEFUN |SGCF;numberOfImproperPartitions;3I;2|
        ...
        (SPROG ((|s| (|Integer|)) (#1=#:G400 NIL) (|i| NIL) (#2=#:G399 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((OR (< |n| 0) (< |m| 1))
                    (PROGN (LETT #2# 0) (GO #3=#:G398))))
                  (COND
                   ((OR (EQL |m| 1) (EQL |n| 0))
                    (PROGN (LETT #2# 1) (GO #3#))))
                  (LETT |s| 0)
...
(SDEFUN |SGCF;unrankImproperPartitions0;3IL;3|
        ((|n| |Integer|) (|m| |Integer|) (|k| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((|l| (|List| (|Integer|))) (#1=#:G409 NIL) (|s| #2=(|Integer|))
          (|sOld| #2#) (#3=#:G411 NIL) (|y| NIL) (#4=#:G410 NIL) (|t| NIL))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(SDEFUN |SGCF;unrankImproperPartitions1;3IL;4|
        ((|n| |Integer|) (|m| . #1=(|Integer|)) (|k| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((#2=#:G424 NIL) (|i| NIL) (|nonZeroPos| (|List| (|Integer|)))
          (|nonZeros| (|List| (|Integer|))) (#3=#:G423 NIL)
          (|s| #4=(|Integer|)) (|sOld| #4#) (|y| NIL) (|cm| #1#)
          (|partition| (|Vector| (|Integer|))) (#5=#:G413 NIL))
...
(SDEFUN |SGCF;subSet;3IL;5|
        ((|n| |Integer|) (|m| . #1=(|Integer|)) (|k| . #2=(|Integer|))
         ($ |List| (|Integer|)))
        (SPROG
         ((|s| #1#) (|mm| #2#) (|l| (|List| (|Integer|))) (#3=#:G433 NIL)
          (#4=#:G435 NIL) (|y| NIL) (#5=#:G434 NIL) (|t| NIL)
          (|bin| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |SGCF;nextLatticePermutation;2LBL;6|
        ...
        (SPROG
         ((#2=#:G466 NIL) (|l| NIL) (|i| NIL)
          (|rightPosition| #3=(|NonNegativeInteger|)) (#4=#:G454 NIL)
          (|j| (|NonNegativeInteger|)) (#5=#:G465 NIL) (|ready| (|Boolean|))
          (|leftEntry| #6=(|NonNegativeInteger|)) (#7=#:G446 NIL)
          (|rightEntry| #6#) (#8=#:G464 NIL) (#9=#:G445 NIL)
          (|help| (|Vector| (|Integer|))) (|n| #3#) (#10=#:G444 NIL)
          (#11=#:G442 NIL) (#12=#:G441 #1#) (#13=#:G443 #1#) (#14=#:G463 NIL)
          (#15=#:G382 NIL) (|rows| (|NonNegativeInteger|)) (#16=#:G437 NIL)
          (|columns| (|NonNegativeInteger|)) (#17=#:G436 NIL)
          (|lprime| (|List| (|Integer|))))
...
(SDEFUN |SGCF;makeYoungTableau;2LM;7|
        ((|lambda| |List| (|Integer|)) (|gitter| |List| (|Integer|))
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((|i| (|Integer|)) (|j| (|Integer|)) (#1=#:G473 NIL) (|l| NIL)
          (|help| (|Vector| (|Integer|))) (|ytab| (|Matrix| (|Integer|)))
          (|rows| (|NonNegativeInteger|)) (#2=#:G468 NIL)
          (|columns| (|NonNegativeInteger|)) (#3=#:G467 NIL)
          (|lprime| (|List| (|Integer|))))
         (SEQ (LETT |lprime| (SPADCALL |lambda| (QREFELT $ 24)))
              (LETT |columns|
...
(SDEFUN |SGCF;listYoungTableaus;LL;8|
        ...
        (SPROG
         ((|lattice| (|List| (|Integer|)))
          ...
          (|ytab| (|Matrix| (|Integer|))) (#1=#:G478 NIL))
...
(SDEFUN |SGCF;nextColeman;2L2M;9|
        ...
        (SPROG
         ((|vrest| #1=(|Vector| (|Integer|)))
          ...
          (#2=#:G494 NIL) (|i| (|NonNegativeInteger|)) (#3=#:G487 NIL)
          (|j| (|Integer|)) (#4=#:G480 NIL) (#5=#:G493 NIL) (#6=#:G479 NIL)
...
(SDEFUN |SGCF;nextPartition;LVIV;11|
        ((|gamma| |List| (|Integer|)) (|part| |Vector| (|Integer|))
         (|number| |Integer|) ($ |Vector| (|Integer|)))
        (SPROG
         ((#1=#:G508 NIL) (|k| NIL) (|j| (|NonNegativeInteger|))
          (|sum| (|Integer|)) (|i| (|NonNegativeInteger|)) (#2=#:G507 NIL)
...
(SDEFUN |SGCF;inverseColeman;2LML;12|
        ...
        (SPROG
         ((|pi| (|List| (|Integer|))) (#1=#:G520 NIL) (|k| NIL) (#2=#:G519 NIL)
          (|i| NIL) (#3=#:G518 NIL) (|j| NIL) (|sum| (|Integer|))
          (#4=#:G517 NIL) (|help| (|Vector| (|Integer|)))
...
(SDEFUN |SGCF;coleman;3LM;13|
        ...
        (SPROG
         ((#1=#:G538 NIL) (|j| NIL) (|betasum| #2=(|NonNegativeInteger|))
          (#3=#:G530 NIL) (|help| (|List| (|Integer|))) (#4=#:G528 NIL)
          (#5=#:G537 NIL) (|i| NIL) (|temp| (|List| (|List| (|Integer|))))
          (|alphasum| #2#) (#6=#:G524 NIL) (#7=#:G522 NIL) (#8=#:G536 NIL)
