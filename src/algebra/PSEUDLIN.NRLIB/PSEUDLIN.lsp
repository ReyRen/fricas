        ...
        (SPROG
         ((|i| #1=(|Integer|))
          (|l|
           (|List|
            (|Record| (|:| C (|Matrix| K)) (|:| |lg| (|List| (|Vector| K))))))
          (|lv| (|List| (|Vector| K))) (#2=#:G435 NIL) (|k| NIL)
          (|v| (|Vector| K)) (#3=#:G424 NIL) (#4=#:G434 NIL) (|w| NIL)
...
(SDEFUN |PSEUDLIN;normalForm0|
        ...
        (SPROG
         ((|i| (|Integer|)) (|Binv| (|Matrix| K)) (B (|Matrix| K))
          (E (|Matrix| K)) (#1=#:G470 NIL) (#2=#:G472 NIL) (|k| NIL)
          (#3=#:G471 NIL)
          (|recOfMatrices|
           (|Record| (|:| R (|Matrix| K)) (|:| A (|Matrix| K))
                     (|:| |Ainv| (|Matrix| K))))
          (|j| (|Integer|)) (#4=#:G469 NIL) (#5=#:G468 NIL) (#6=#:G464 NIL)
          (#7=#:G465 NIL) (#8=#:G467 NIL) (#9=#:G466 NIL)
                ...
                (LETT B
                      (SPADCALL
                       (PROGN
                        ...
                        #9#)
                       (QREFELT $ 35)))
                (LETT |Binv| (SPADCALL B (QREFELT $ 36)))
                (COND
                 ((SPADCALL M (QREFELT $ 37))
                  (PROGN (LETT #6# (VECTOR M B |Binv|)) (GO #10=#:G463))))
                (LETT |i| 1)
...
(SDEFUN |PSEUDLIN;mulMatrix|
        ...
        (SPROG
         ((M (|Matrix| K)) (#1=#:G476 NIL) (#2=#:G478 NIL) (|j| NIL)
          (#3=#:G477 NIL))
         (SEQ
          (LETT M
                (SPADCALL
...
(SDEFUN |PSEUDLIN;addMatrix|
        ...
        (SPROG
         ((A (|Matrix| K)) (#1=#:G482 NIL) (#2=#:G484 NIL) (|j| NIL)
          (#3=#:G483 NIL))
         (SEQ
          (LETT A
                (SPADCALL
...
(SDEFUN |PSEUDLIN;permutationMatrix|
        ...
        (SPROG
         ((P (|Matrix| K)) (#1=#:G488 NIL) (#2=#:G490 NIL) (|j| NIL)
          (#3=#:G489 NIL))
         (SEQ
          (LETT P
                (SPADCALL
...
(DEFUN |PseudoLinearNormalForm| (#1=#:G491)
  (SPROG NIL
         (PROG (#2=#:G492)
           (RETURN
            (COND
