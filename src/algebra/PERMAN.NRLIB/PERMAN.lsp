...
(SDEFUN |PERMAN;permanent3| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((|a| (R)) (|j| (|Integer|)) (|vv| (|Vector| (|Vector| (|Integer|))))
          (|b| (R)) (#1=#:G397 NIL) (|i| NIL) (|k| (R)) (|sgn| (R))
          (|w| (|Vector| R)))
...
(SDEFUN |PERMAN;permanent;SmR;2| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((|a| (R)) (|j| #1=(|Integer|))
          (|vv| (|Vector| (|Vector| (|Integer|)))) (#2=#:G409 NIL) (|b| (R))
          (#3=#:G419 NIL) (|i| NIL) (|k| #1#) (|sgn| (R)) (#4=#:G418 NIL)
          (#5=#:G404 NIL) (#6=#:G417 NIL) (|rowi| #7=(|Vector| R))
          (#8=#:G416 NIL) (|w| #7#) (#9=#:G415 NIL)
...
(SDEFUN |PERMAN;permanent2| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((#1=#:G436 NIL) (|b| (R)) (#2=#:G434 NIL) (|a| (R))
          (|j| #3=(|Integer|)) (|vv| (|Vector| (|Vector| (|Integer|))))
          (#4=#:G429 NIL) (#5=#:G445 NIL) (|i| NIL) (|c| (R)) (|k| #3#)
          (|sgn| (R)) (#6=#:G444 NIL) (#7=#:G424 NIL) (#8=#:G443 NIL)
          (|rowi| #9=(|Vector| R)) (#10=#:G442 NIL) (|w| #9#) (|two| (R))
          (#11=#:G441 NIL))
         (SEQ
          (EXIT
