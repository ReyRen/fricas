...
(SDEFUN |FRIMOD;rowdiv| ((|r| |Vector| R) (|f| R) ($ |Vector| F))
        (SPROG ((#1=#:G388 NIL) (#2=#:G390 NIL) (|i| NIL) (#3=#:G389 NIL))
               (SEQ
                (PROGN
                 (LETT #3#
                       (GETREFV
...
(SDEFUN |FRIMOD;getinvintmat| (($ |Boolean|))
        (SPROG
         ((#1=#:G402 NIL) (|j| NIL) (#2=#:G401 NIL) (|i| NIL)
          (|m| (|Matrix| F)) (#3=#:G395 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |FRIMOD;getintmat| (($ |Boolean|))
        (SPROG
         ((#1=#:G408 NIL) (|j| NIL) (#2=#:G407 NIL) (|i| NIL)
          (|m| (|Matrix| F)))
...
(SDEFUN |FRIMOD;vectProd| ((|v1| |Vector| A) (|v2| |Vector| A) ($ |Vector| A))
        (SPROG
         ((|k| (|Integer|)) (#1=#:G419 NIL) (|j| NIL) (#2=#:G418 NIL) (|i| NIL)
          (|v| (|Vector| A)))
         (SEQ
          (LETT |k|
                (SPADCALL
...
(SDEFUN |FRIMOD;*;3$;14| ((|m1| $) (|m2| $) ($ $))
        (SPROG
         ((|u| (A)) (#1=#:G427 NIL) (|i| NIL) (#2=#:G426 NIL)
          (|m| (|Matrix| R))
...
(DEFUN |FractionalIdealAsModule| (&REST #1=#:G429)
  (SPROG NIL
         (PROG (#2=#:G430)
           (RETURN
            (COND
