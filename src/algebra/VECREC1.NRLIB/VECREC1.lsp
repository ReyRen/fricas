...
(SDEFUN |VECREC1;empty;2I$;1| ((|npoly| |Integer|) (|np| |Integer|) ($ $))
        (SPROG
         ((|state| ($)) (#1=#:G402 NIL) (|i| NIL)
          (|polyvec| (|PrimitiveArray| (|U32Vector|))) (#2=#:G397 NIL))
         (SEQ
          (LETT |polyvec|
                (MAKEARR1
                 (PROG1 (LETT #2# |npoly|)
...
(SDEFUN |VECREC1;add_slots;L$V;2|
        ...
        (SPROG
         ((|j| (|Integer|)) (|li| (|Integer|)) (#1=#:G405 NIL) (#2=#:G414 NIL)
...
(SDEFUN |VECREC1;double_poly_space| ((|statearg| $) ($ |Void|))
        (SPROG
         ((|op| (|U32Vector|)) (|np| (|U32Vector|)) (#1=#:G416 NIL)
          (#2=#:G422 NIL) (|i| NIL) (|n| (|Integer|)) (|m| (|Integer|))
          (|polyvec| (|PrimitiveArray| (|U32Vector|))) (|state| (|Rep|)))
         (SEQ (LETT |state| |statearg|) (LETT |polyvec| (QVELT |state| 6))
              (LETT |m| (QVELT |state| 5))
              (LETT |n| (SPADCALL 2 |m| (QREFELT $ 16)))
...
(SDEFUN |VECREC1;chinese_update;UvI$V;4|
        ...
        (SPROG
         ((|mtvec| (|U32Vector|)) (|nmt| (|U32Vector|)) (#1=#:G428 NIL)
          (|cor| #2=(|Integer|)) (|pol| (|U32Vector|)) (#3=#:G434 NIL)
         ...
         (SEQ (LETT |state| |statearg|) (LETT |mtvec| (QVELT |state| 1))
              ...
              (EXIT
               (COND ((EQL |mtval| 0) (|error| "Duplicate point in update"))
                     ('T
                      (SEQ (LETT |mtcor| (SPADCALL |mtval| |p| (QREFELT $ 21)))
...
(SDEFUN |VECREC1;rational_reconstruction;2Uv2IU;5|
        ...
        (SPROG
         ((|c| #1=(|Integer|)) (|ds1| #2=(|Integer|)) (|s1| #3=(|U32Vector|))
          ...
          (|ds0a| (|Integer|)) (#6=#:G456 NIL) (|c0| #1#) (|c1| #4#)
          (|delta| #4#) (|j| #5#))
         (SEQ (LETT |j| (SPADCALL |y| (QREFELT $ 29)))
              (LETT |r0| (GETREFV_U32 (+ |j| 1) 0))
              (SPADCALL |r0| |y| (+ |j| 1) (QREFELT $ 19)) (LETT |dr0| |j|)
              (LETT |s0| (GETREFV_U32 (+ |j| 1) 0)) (LETT |ds0| 0)
              (LETT |r1| (GETREFV_U32 (+ |j| 1) 0))
              (LETT |dr1| (SPADCALL |x| (QREFELT $ 29)))
              (SPADCALL |r1| |x| (+ |dr1| 1) (QREFELT $ 19))
              (LETT |s1| (GETREFV_U32 (+ |j| 1) 0)) (SETELT_U32 |s1| 0 1)
              (LETT |ds1| 0)
              (SEQ G190
                   (COND
                    ((NULL (SPADCALL |dr1| |i| (QREFELT $ 22))) (GO G191)))
                   (SEQ
               ...
               (COND
                ...
                ('T
                 (SEQ (LETT |c| (ELT_U32 |s1| |ds1|))
                      (LETT |c| (SPADCALL |c| |p| (QREFELT $ 21)))
...
(SDEFUN |VECREC1;rational_reconstruction;$U;6|
        ...
        (SPROG
         ((#1=#:G488 NIL) (|cden| #2=(|U32Vector|))
          ...
          (|nums| (|PrimitiveArray| (|U32Vector|))) (#4=#:G468 NIL)
          (#5=#:G466 NIL) (|n| (|Integer|)) (|ok| (|Boolean|))
                ...
                (EXIT
                 (COND
                  ((SPADCALL |m| (QVELT |state| 7) (QREFELT $ 37))
                   (PROGN (LETT #1# (CONS 1 "failed")) (GO #6=#:G487)))
                  (#7='T
                   (SEQ
                    (QSETVELT |state| 7
...
(SDEFUN |VECREC1;repack_polys;IVSevPaR;7|
        ((|var_cnt| |Integer|) (|poly_offsets| |Vector| (|Integer|))
         ...
         ($ |Record| (|:| |nvars| (|Integer|))
          ...
          (|:| |coeffdata| (|U32Vector|))))
        (SPROG
         ((#1=#:G513 NIL) (|i| NIL) (|oei| #2=(|SingleInteger|)) (|nei| #2#)
          (|oei0| #2#) (#3=#:G512 NIL) (|i1| NIL) (|nm| #2#)
          (|cij| (|Integer|)) (#4=#:G511 NIL) (|j| NIL)
          (|k| (|NonNegativeInteger|)) (|ci| (|U32Vector|)) (|opi| (|Integer|))
          (|pi| (|Integer|)) (#5=#:G510 NIL) (|npo| (|Vector| (|Integer|)))
          (|pi_cnt| (|NonNegativeInteger|)) (|ncoeffs| (|U32Vector|))
          (|nexps| (|SortedExponentVector|)) (|nnvars| (|Integer|))
          (|m| (|Integer|)) (#6=#:G509 NIL) (#7=#:G508 NIL)
         ...
         (SEQ (LETT |m| 0) (LETT |n| (QVSIZE |coeffs|))
              ...
              (LETT |opi| (SPADCALL |poly_offsets| |pi| (QREFELT $ 44)))
...
(SDEFUN |VECREC1;remove_denoms;V2PaIPa;8|
        ...
        (SPROG
         ((|dt| #1=(|Integer|)) (#2=#:G532 NIL) (|j| NIL)
          (|tmpp2| #3=(|U32Vector|)) (|tmpp1| #3#) (|dtmp| #1#) (|dresi| #1#)
          (|resi| (|U32Vector|)) (#4=#:G531 NIL) (|i| NIL) (|dcf| #1#)
          (|cfactor| (|U32Vector|)) (#5=#:G530 NIL) (#6=#:G529 NIL)
          (|dcden| #1#) (|cden| (|U32Vector|)) (|hi| #7=(|Integer|)) (|li| #7#)
          (#8=#:G528 NIL) (|ib| NIL) (|res| (|PrimitiveArray| (|U32Vector|)))
         ...
         (SEQ (LETT |nb| (QVSIZE |block_offsets|)) (LETT |np| (QVSIZE |nums|))
              ...
              (SEQ (LETT |ib| 1) (LETT #8# |nb|) G190
                   ...
                   (SEQ
                    ...
                    (LETT |hi| (- |hi| 1))
                    (LETT |cden|
                          (SPADCALL |dens| |li| |hi| |p| (QREFELT $ 49)))
                    (LETT |dcden| (SPADCALL |cden| (QREFELT $ 29)))
                    ...
                    (SEQ (LETT |i| |li|) (LETT #6# |hi|) G190
                         ...
                         (LETT |i| (+ |i| 1)) (GO G190) G191 (EXIT NIL))
                    (LETT |cfactor|
                          (SPADCALL |res| |li| |hi| |p| (QREFELT $ 51)))
                    (LETT |dcf| (SPADCALL |cfactor| (QREFELT $ 29)))
                    (LETT |dtmp| |dcden|)
                    (EXIT
                     (COND
                      ((>= |dcf| 1)
...
(SDEFUN |VECREC1;reconstruct;$I2VSevU;10|
        ...
        (SPROG
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |pp| (SPADCALL |statearg| (QREFELT $ 42)))
                (EXIT
                 (COND
                  ((QEQCAR |pp| 1)
                   (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G549)))
                  ('T
