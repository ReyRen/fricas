...
(SDEFUN |SQMATRIX;matrix;L$;4| ((|l| |List| (|List| R)) ($ $))
        (SPROG
         ((#1=#:G401 NIL) (|j| NIL) (#2=#:G402 NIL) (|r| NIL) (#3=#:G399 NIL)
          (|i| NIL) (#4=#:G400 NIL) (|ll| NIL) (|ans| (|Matrix| R))
          (#5=#:G397 NIL) (#6=#:G398 NIL))
         (SEQ
          (COND
...
(SDEFUN |SQMATRIX;columnSpace;$L;18|
        ...
        (SPROG ((#1=#:G423 NIL) (|c| NIL) (#2=#:G422 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SQMATRIX;nullSpace;$L;21|
        ((|x| $) ($ |List| (|DirectProduct| |ndim| R)))
        (SPROG ((#1=#:G429 NIL) (|c| NIL) (#2=#:G428 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |SquareMatrix| (&REST #1=#:G470)
  (SPROG NIL
         (PROG (#2=#:G471)
           (RETURN
            (COND
...
(DEFUN |SquareMatrix;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G467 NIL) (#2=#:G469 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
           ...
           (CONS
            (|makeByteWordVec2| 25
                                '(0 4 4 1 4 5 6 7 8 0 3 8 0 1 0 0 4 0 0 0 0 8 2
                                  2 3 3 0 0 0 3 9 0 0 0 9 0 0 0 18 0 0 0 0 0 0
                                  0 18 10 11 25 12))
            (CONS
             ...
             (CONS
              '#((|SquareMatrixCategory| 6 7 (|DirectProduct| 6 7)
                 ...
                 (|InnerEvalable| 7 7) (|RetractableTo| 91)
