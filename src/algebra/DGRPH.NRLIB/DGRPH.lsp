...
(SDEFUN |DGRPH;directedGraph;L$;1| ((|objs| |List| S) ($ $))
        (SPROG
         ((|obs|
          ...
          (|o| #1#) (#2=#:G412 NIL) (|ob| NIL) (#3=#:G413 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|edges|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (#1=#:G435 NIL) (|ar| NIL) (#2=#:G436 NIL) (|arn| NIL)
          (|nodes|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#3=#:G433 NIL) (|ob| NIL) (#4=#:G434 NIL) (|obn| NIL))
         (SEQ (LETT |nodes| NIL)
         ...
         ((|ars|
           (|List|
            #1=(|Record| (|:| |fromOb| (|NonNegativeInteger|))
                         (|:| |toOb| (|NonNegativeInteger|)))))
          (|z| #1#) (#2=#:G445 NIL) (|y| NIL) (#3=#:G446 NIL) (|yn| NIL)
          (#4=#:G443 NIL) (|x| NIL) (#5=#:G444 NIL) (|xn| NIL)
         ...
         ((|ar|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G461 NIL) (|j| NIL) (#3=#:G460 NIL) (|i| NIL)
          (|obs|
           (|List|
            #4=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #4#) (#5=#:G458 NIL) (|ob| NIL) (#6=#:G459 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G637 NIL) (|arrNum| NIL)
          (|verts|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #3#) (#4=#:G635 NIL) (|vert| NIL) (#5=#:G636 NIL) (|i| NIL)
          (#6=#:G612 NIL) (#7=#:G611 NIL) (|pout| #8=(|Integer|)) (|pin| #8#)
          (#9=#:G634 NIL) (|pt| NIL) (|preim| #10=(|List| S))
          (|im| #11=(|List| S))
          (|lr| (|Record| (|:| |preimage| #10#) (|:| |image| #11#)))
          (#12=#:G632 NIL) (|perm| NIL) (#13=#:G633 NIL) (|pi| NIL)
          (|tab| (|List| (|List| (|NonNegativeInteger|)))) (#14=#:G631 NIL)
          (#15=#:G630 NIL) (#16=#:G629 NIL) (|b| NIL) (#17=#:G628 NIL)
          (|obs| (|List| S)) (#18=#:G627 NIL) (|v| NIL) (#19=#:G625 NIL)
          (#20=#:G626 NIL) (|px| NIL))
         (SEQ (LETT |obs| NIL)
...
(SDEFUN |DGRPH;flatten;Dg$;15| ((|n| |DirectedGraph| $) ($ $))
        (SPROG
         ((|a|
          ...
          (|toOb3| #7=(|NonNegativeInteger|)) (|fromOb3| #7#) (#8=#:G686 NIL)
          (|endi| NIL) (#9=#:G687 NIL) (|starti| NIL) (|map3| #6#)
          ...
          (|fromOb2| #7#) (|arrType2| #3#) (|name2| #2#) (#11=#:G684 NIL)
          (|a3| NIL) (#12=#:G682 NIL) (|a2| NIL) (#13=#:G683 NIL) (|a2n| NIL)
          (|iv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          ...
          (|obs2|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|ob2| #14#) (|py| #7#) (|px| #7#) (#15=#:G681 NIL) (|ob| NIL)
          (|obs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|v3| ($)) (#16=#:G680 NIL) (|v2| NIL)
          (|v|
           (|List|
          ...
          (|obs|
           (|List|
            #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #2#) (#3=#:G704 NIL) (|ob| NIL) (#4=#:G705 NIL) (|obn| NIL))
         ...
         ((|arn| (|Integer|))
          ...
          (|obs|
           (|List|
            #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #2#) (#3=#:G715 NIL) (|ob| NIL) (#4=#:G716 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
              (SEQ (LETT |obn| 1) (LETT #4# (LENGTH |objs|)) (LETT |ob| NIL)
                   (LETT #3# |objs|) G190
                   (COND
         ...
         ((|arn| (|Integer|))
          ...
          (|obs|
           (|List|
            #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #2#) (#3=#:G723 NIL) (|ob| NIL) (#4=#:G724 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
              (SEQ (LETT |obn| 1) (LETT #4# (LENGTH |objs|)) (LETT |ob| NIL)
                   (LETT #3# |objs|) G190
                   (COND
          ...
          (|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G736 NIL) (|obm| NIL)
          (|obs|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #3#) (#4=#:G734 NIL) (|ob| NIL) (#5=#:G735 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
...
(SDEFUN |DGRPH;merge;3$;23| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|la|
          ...
          (#3=#:G765 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G753 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| (|Integer|)) (#6=#:G764 NIL) (|bob| NIL) (#7=#:G763 NIL)
          (|x| NIL) (#8=#:G762 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
...
(SDEFUN |DGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #3=(|NonNegativeInteger|)) (|bi| (S)) (#4=#:G776 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #3#) (|ai| (S)) (#5=#:G775 NIL)
          (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G799 NIL) (|bv| NIL)
          (#3=#:G798 NIL) (|bu| NIL) (#4=#:G797 NIL) (|av| NIL) (#5=#:G796 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G824 NIL) (|bv| NIL)
          (#3=#:G823 NIL) (|bu| NIL) (#4=#:G822 NIL) (|av| NIL) (#5=#:G821 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
...
(SDEFUN |DGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|x| #3#) (|byi| #2#) (|bxi| #1#) (|bi| (S)) (#4=#:G833 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#5=#:G832 NIL)
          (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G854 NIL) (|bv| NIL)
          (#3=#:G853 NIL) (|bu| NIL) (#4=#:G852 NIL) (|av| NIL) (#5=#:G851 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G880 NIL) (|bv| NIL)
          (#3=#:G879 NIL) (|bu| NIL) (#4=#:G878 NIL) (|av| NIL) (#5=#:G877 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
          ...
          (|newArr|
           (|Record| (|:| |name| (|String|))
                     ...
                     (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (#1=#:G891 NIL) (|j| NIL) (#2=#:G890 NIL) (|i| NIL)
          (|ars|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G908 NIL) (|oldArrow| NIL) (#4=#:G896 NIL)
          (#5=#:G895 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G907 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G906 NIL) (|o| NIL) (#8=#:G905 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G925 NIL) (|oldArrow| NIL) (#4=#:G913 NIL)
          (#5=#:G912 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G924 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G923 NIL) (|o| NIL) (#8=#:G922 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
        ...
        (SPROG
         ((|arn| (|Integer|))
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#2=#:G934 NIL) (|ob| NIL) (#3=#:G935 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL) (LETT |ars| NIL) (LETT |arn| 1)
