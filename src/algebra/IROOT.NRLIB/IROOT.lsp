...
(SDEFUN |IROOT;perfectNthRoot;IR;3|
        ...
        (SPROG
         ((|p| (|NonNegativeInteger|)) (#1=#:G407 NIL)
          (|e| (|NonNegativeInteger|)) (#2=#:G404 NIL)
...
(SDEFUN |IROOT;approxNthRoot;INniI;4|
        ...
        (SPROG
         ((|z| (I)) (|y| (I)) (|xn| (I)) (|x| (I))
          (|n1| (|NonNegativeInteger|)) (#1=#:G414 NIL) (|l| (I)))
         (SEQ
                   ...
                   (COND
                    ((SPADCALL
                      (SPADCALL (QUOTIENT2 (SPADCALL 3 |n| (QREFELT $ 35)) 2)
                                (QREFELT $ 10))
                      (LETT |l| (SPADCALL |a| (QREFELT $ 23))) (QREFELT $ 36))
                     (QREFELT $ 12))
                    (#2#
                     (SEQ
                      (LETT |y|
                      ...
                      (SEQ
                       ...
                       (LETT |s|
                             (SPADCALL
                              (SPADCALL |a|
                                        (SPADCALL
                                         (SPADCALL 2 |n| (QREFELT $ 49))
                                         (QREFELT $ 22))
                                        (QREFELT $ 39))
                              (QREFELT $ 31)))
                       (LETT |s| (SPADCALL |s| |n| (QREFELT $ 39)))
                       (EXIT
                        (PROGN
                         (LETT #1#
                               (SPADCALL
