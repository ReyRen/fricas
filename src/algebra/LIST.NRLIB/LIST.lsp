...
(SDEFUN |LIST;tails;$L;3| ((|x| $) ($ |List| $))
        (SPROG ((#1=#:G1807 NIL) (|i| NIL) (#2=#:G1806 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;$If;10| ((|x| $) ($ |InputForm|))
        (SPROG ((#1=#:G1848 NIL) (|a| NIL) (#2=#:G1847 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1858 NIL) (#2=#:G1859 NIL) (#3=#:G1861 NIL) (#4=#:G1860 NIL)
    (|pv$| NIL) (#5=#:G1855 NIL) (#6=#:G1856 NIL) (#7=#:G1857 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
