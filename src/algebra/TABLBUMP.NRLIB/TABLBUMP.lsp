...
(SDEFUN |TABLBUMP;slex;LL;7| ((|ls| |List| S) ($ |List| (|List| S)))
        (SPROG
         ((#1=#:G418 NIL) (|i| NIL) (#2=#:G419 NIL) (|j| NIL) (#3=#:G417 NIL))
         (SEQ
          (SPADCALL
           (PROGN
            (LETT #3# NIL)
...
(SDEFUN |TABLBUMP;inverse;2L;8| ((|ls| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G424 NIL) (#2=#:G426 NIL) (|i| NIL) (#3=#:G427 NIL) (|j| NIL)
          (#4=#:G425 NIL) (|lss| NIL) (#5=#:G423 NIL))
         (SEQ
          (PROGN
           (LETT #5# NIL)
           (SEQ (LETT |lss| NIL)
...
(SDEFUN |TABLBUMP;bat1;LL;13|
        ...
        (SPROG ((#1=#:G447 NIL) (|lls| NIL) (#2=#:G446 NIL))
               (SEQ
                (SPADCALL NIL
                          (PROGN
                           (LETT #2# NIL)
