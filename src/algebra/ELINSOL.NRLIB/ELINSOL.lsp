...
(SDEFUN |ELINSOL;F_to_LF| ((|x| F) (|vl| |List| (|Kernel| F)) ($ |List| F))
        (SPROG
         ((#1=#:G408 NIL) (|v| NIL) (#2=#:G407 NIL)
          ...
          (#3=#:G405 NIL) (#4=#:G406 NIL) (|c| NIL) (#5=#:G404 NIL)
          (|res0| (|List| F)) (#6=#:G403 NIL) (#7=#:G402 NIL)
         ...
         ((#1=#:G418 NIL)
          (|ss|
           (|Record| (|:| |particular| (|Union| (|Vector| F) #2="failed"))
                     (|:| |basis| (|List| (|Vector| F)))))
          (|eqm| (|Matrix| F)) (#3=#:G432 NIL) (|ll| NIL) (#4=#:G431 NIL)
          (|rh| (|Vector| F)) (#5=#:G430 NIL) (#6=#:G429 NIL)
          (|eqll| (|List| (|List| F))) (#7=#:G428 NIL) (|p| NIL)
          (#8=#:G427 NIL) (|coefk| (|List| (|Kernel| F))) (#9=#:G426 NIL)
          (|c| NIL) (#10=#:G425 NIL))
         (SEQ
          (LETT |coefk|
                (PROGN
...
(DEFUN |ExpressionLinearSolve| (&REST #1=#:G433)
  (SPROG NIL
         (PROG (#2=#:G434)
           (RETURN
            (COND
