...
(SDEFUN |PBWLB;varList;$L;3| ((|x| $) ($ |List| |VarSet|))
        (SPROG
         ((|le| #1=(|List| |VarSet|)) (#2=#:G394 NIL) (#3=#:G393 #1#)
          (#4=#:G395 #1#) (#5=#:G398 NIL) (|l| NIL))
         (SEQ
          (COND ((NULL |x|) NIL)
                (#6='T
                 (LETT |le|
...
(SDEFUN |PBWLB;coerce;$Of;10| ((|x| $) ($ |OutputForm|))
        (SPROG ((#1=#:G412 NIL) (|l| NIL) (#2=#:G411 NIL))
               (SEQ
...
(SDEFUN |PBWLB;length;$Nni;14| ((|x| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G428 NIL) (|n| #2=(|Integer|)) (#3=#:G426 NIL) (#4=#:G425 #2#)
          (#5=#:G427 #2#) (#6=#:G431 NIL) (|l| NIL))
         (SEQ
          (LETT |n|
                (PROGN
                 (LETT #3# NIL)
...
(DEFUN |PoincareBirkhoffWittLyndonBasis| (#1=#:G438)
  (SPROG NIL
         (PROG (#2=#:G439)
           (RETURN
            (COND
