...
(SDEFUN |PADE;pade;2Nni2PSU;5|
        ...
        (SPROG
         ((|approx| (|Fraction| UP)) (#1=#:G415 NIL) (|d| NIL) (#2=#:G416 NIL)
...
(SDEFUN |PADE;padecf;2Nni2PSU;6|
        ...
        (SPROG
         ((|blist| (|List| UP)) (#1=#:G428 NIL) (|d| NIL) (#2=#:G427 NIL)
          (|alist| (|List| UP))
          (|ad|
           (|Union|
            (|Record| (|:| |ais| (|List| UP))
...
(SDEFUN |PADE;padeInner|
        ((|l| . #1=(|NonNegativeInteger|)) (|m| . #2=(|NonNegativeInteger|))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|#G44| (|NonNegativeInteger|)) (#3=#:G449 NIL) (|#G43| #2#)
          (|d| (UP)) (|g| (UP)) (|degbd| (|NonNegativeInteger|))
          (#4=#:G448 NIL) (|h| (UP)) (#5=#:G444 NIL)
          (|alist| (|List| (|NonNegativeInteger|))) (#6=#:G456 NIL)
          (|alpha| (|NonNegativeInteger|)) (|plist| (|List| UP)) (|s| (UP))
          (|p| (UP)) (#7=#:G442 NIL) (|pk| (R)) (#8=#:G457 NIL) (|k| NIL)
          (#9=#:G441 NIL) (|d0| (R)) (|j| NIL) (|#G40| (PS)) (|#G39| (PS))
          (|#G38| (|NonNegativeInteger|)) (#10=#:G438 NIL) (|#G37| #2#)
           ...
           (SEQ
              ...
              (SEQ (LETT |alpha| (SPADCALL |gps| (QREFELT $ 34)))
                   (COND
                    ((SPADCALL |alpha| |l| (QREFELT $ 37))
                     (PROGN (LETT #6# (CONS 1 "failed")) (GO #11=#:G455))))
            ...
            (EXIT
             (SEQ (LETT |j| 0) G190 NIL
                  (SEQ (LETT |d0| (SPADCALL |d| 0 (QREFELT $ 39)))
                       (LETT |d|
                             (SPADCALL
                       ...
                       (SEQ (LETT |k| 1) (LETT #8# |degbd|) G190
                            ...
                            (SEQ (LETT |pk| (SPADCALL |s| 0 (QREFELT $ 39)))
                                 (LETT |p|
                                       (SPADCALL |p|
                                                 (SPADCALL |pk|
                                                           (PROG1
...
(DEFUN |PadeApproximants| (&REST #1=#:G458)
  (SPROG NIL
         (PROG (#2=#:G459)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 49
                                            '(1 8 9 0 10 1 8 0 0 11 0 8 0 12 2
                                              ...
                                              0 35 0 7 0 36 2 9 32 0 0 37 1 6
                                              32 0 38 2 8 6 0 9 39 0 8 0 40 2 8
                                              0 0 6 41 2 8 0 0 0 42 2 8 0 6 0
                                              43 2 8 0 0 0 44 2 7 0 6 9 45 2 8
                                              46 0 0 47 2 8 32 0 0 48 1 8 9 0
                                              49 4 0 30 9 9 7 7 31 4 0 23 9 9 7
                                              7 24)))))
           '|lookupComplete|)) 
