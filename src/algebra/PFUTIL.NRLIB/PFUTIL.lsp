...
(SDEFUN |PFUTIL;decompose;UP2L;1| ((|nn| UP) (|dens| |List| UP) ($ |List| UP))
        (SPROG
         ((#1=#:G397 NIL) (|res| (|List| UP)) (#2=#:G401 NIL) (|c| NIL)
          (#3=#:G400 NIL) (|fden| NIL) (|pfr| (|PartialFraction| UP))
          (|nd| (|Factored| UP)) (|fdens| (|List| (|Factored| UP)))
          (#4=#:G399 NIL) (|nden| NIL) (#5=#:G398 NIL))
         (SEQ
          (LETT |fdens|
                (PROGN
                 (LETT #5# NIL)
...
(DEFUN |PartialFractionUtilities| (&REST #1=#:G402)
  (SPROG NIL
         (PROG (#2=#:G403)
           (RETURN
            (COND
