...
(SDEFUN |INTAF;algextint;2KMMMMLL;8|
        ...
        (SPROG
         ((#1=#:G455 NIL) (|be| NIL) (#2=#:G454 NIL)
          (|res1|
           (|List|
            (|Record| (|:| |ratpart| |curve|) (|:| |coeffs| (|Vector| F)))))
          (#3=#:G453 NIL) (|f| NIL) (#4=#:G452 NIL)
...
(SDEFUN |INTAF;algextint_base;2KMMLL;9|
        ((|x| |Kernel| F) (|y| |Kernel| F)
         ...
         ($ |List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
        (SPROG
         ((#1=#:G479 NIL) (|be| NIL) (#2=#:G478 NIL)
          (|res1|
           (|List|
            (|Record| (|:| |ratpart| |curve|) (|:| |coeffs| (|Vector| F)))))
          (#3=#:G477 NIL) (|f| NIL) (#4=#:G476 NIL)
          (|red|
           (|Mapping| |curve|
                      (|SparseUnivariatePolynomial|
                       (|Fraction| (|SparseUnivariatePolynomial| F)))))
...
(SDEFUN |INTAF;UPUP2F|
        ((|p| |SparseUnivariatePolynomial|
          (|Fraction| (|SparseUnivariatePolynomial| F)))
         (|cf| |Fraction| (|SparseUnivariatePolynomial| F)) (|t| |Kernel| F)
         (|k| |Kernel| F) ($ F))
        (SPROG NIL
               (SPADCALL
...
(DEFUN |AlgebraicIntegration| (&REST #1=#:G493)
  (SPROG NIL
         (PROG (#2=#:G494)
           (RETURN
            (COND
