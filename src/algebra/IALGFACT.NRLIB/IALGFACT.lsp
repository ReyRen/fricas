...
(SDEFUN |IALGFACT;perturbfactor|
        ((|f| |AlPol|) (|k| |Integer|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |List| |AlPol|))
        (SPROG
         ((#1=#:G391 NIL) (|pp| NIL) (#2=#:G390 NIL) (|pol| (|AlPol|))
...
(SDEFUN |IALGFACT;irrfactor|
        ((|f| |AlPol|) (|k| |Integer|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |List| |AlPol|))
        (SPROG
         ((|listerm| (|List| |AlPol|)) (|newf| (|AlPol|)) (#1=#:G397 NIL)
          (|g| (|AlPol|)) (#2=#:G407 NIL) (|pelt| NIL)
          (|listfact|
           (|List|
...
(SDEFUN |IALGFACT;factor;AlPolMF;3|
        ((|f| |AlPol|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |Factored| |AlPol|))
        (SPROG
         ((#1=#:G410 NIL) (#2=#:G409 #3=(|Factored| |AlPol|)) (#4=#:G411 #3#)
          (#5=#:G414 NIL) (#6=#:G413 #3#) (#7=#:G415 #3#) (#8=#:G420 NIL)
          (|pol| NIL) (#9=#:G419 NIL) (|sqterm| NIL)
          (|sqf| (|Factored| |AlPol|)))
...
(DEFUN |InnerAlgFactor| (&REST #1=#:G426)
  (SPROG NIL
         (PROG (#2=#:G427)
           (RETURN
            (COND
