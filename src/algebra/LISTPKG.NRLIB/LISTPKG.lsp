...
(SDEFUN |LISTPKG;splitList;MLR;1|
        ...
        (SPROG
         ((|resno| #1=(|List| T$)) (|resyes| #1#) (#2=#:G403 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |LISTPKG;topologicalSort;L2L;4|
        ...
        (SPROG
         ((#1=#:G430 NIL) (|p| NIL) (#2=#:G429 NIL)
          ...
          (#4=#:G428 NIL) (|x| NIL) (|x0| (|NonNegativeInteger|))
          (#5=#:G427 NIL) (|n| NIL) (#6=#:G426 NIL))
         (SEQ
          (LETT |xi|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |LISTPKG;shiftLeft;2L;5| ((|xx| |List| T$) ($ |List| T$))
        (SPROG ((#1=#:G433 NIL))
               (SEQ
                (EXIT
                 (COND ((NULL |xx|) (PROGN (LETT #1# |xx|) (GO #2=#:G432)))
                       ('T
...
(SDEFUN |LISTPKG;minShift;2L;6| ((|xx| . #1=(|List| T$)) ($ |List| T$))
        (SPROG
         ((|res| #1#) (|xx1| #1#) (#2=#:G441 NIL) (|k| NIL) (#3=#:G440 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL |xx|) (NULL (CDR |xx|)))
             (PROGN (LETT #3# |xx|) (GO #4=#:G439)))
            ('T
...
(SDEFUN |LISTPKG;cartesian;2L;7|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G452 NIL) (|s| NIL)
          (#2=#:G451 NIL) (|x| NIL) (#3=#:G448 NIL) (#4=#:G450 NIL)
          (#5=#:G449 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |LISTPKG;cartesianPower;LNniL;8|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G465 NIL) (|s| NIL)
          (#2=#:G464 NIL) (|x| NIL) (#3=#:G461 NIL) (#4=#:G463 NIL)
          (#5=#:G462 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL S) (ZEROP |n|)) (PROGN (LETT #3# NIL) (GO #6=#:G460)))
            ('T
             (COND
              ((EQL |n| 1)
               (PROGN
