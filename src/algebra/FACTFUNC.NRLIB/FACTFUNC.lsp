...
(SDEFUN |FACTFUNC;nthRoot;FNniR;1|
        ((|ff| |Factored| M) (|n| |NonNegativeInteger|)
         ($ |Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| M)
          (|:| |radicand| (|List| M))))
        (SPROG
         ((#1=#:G400 NIL) (|radi| (|List| M)) (|coeff| (M))
          (|qr|
           (|Record| (|:| |quotient| (|NonNegativeInteger|))
                     (|:| |remainder| (|NonNegativeInteger|))))
          (#2=#:G403 NIL) (|term| NIL) (|d| (|NonNegativeInteger|))
          (#3=#:G392 NIL) (#4=#:G402 NIL) (|t| NIL) (#5=#:G401 NIL)
          (|lf|
           (|List|
...
(SDEFUN |FACTFUNC;log;FL;2|
        ...
        (SPROG ((#1=#:G412 NIL) (|term| NIL) (#2=#:G411 NIL) (|ans| (M)))
...
(DEFUN |FactoredFunctions| (#1=#:G413)
  (SPROG NIL
         (PROG (#2=#:G414)
           (RETURN
            (COND
