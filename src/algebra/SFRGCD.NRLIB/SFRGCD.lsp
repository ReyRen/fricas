...
(SDEFUN |SFRGCD;stoseInvertible?;PTSB;5| ((|p| P) (|ts| TS) ($ |Boolean|))
        (SPROG
         ((#1=#:G480 NIL) (#2=#:G482 NIL) (|g| (P)) (#3=#:G484 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v-| (TS)) (|ts_v| (P)) (#4=#:G470 NIL) (#5=#:G481 NIL)
          (#6=#:G483 NIL) (|bwt| NIL)
          (|toCheck|
...
(SDEFUN |SFRGCD;stosePrepareSubResAlgo;2PTSL;6|
        ...
        (SPROG
         ((|toSee| (|List| #1#))
          ...
          (|newp2| (P)) (|s| (P)) (#2=#:G489 NIL) (|p3| (P)) (#3=#:G502 NIL)
          (|bwt| NIL)
...
(SDEFUN |SFRGCD;stoseInternalLastSubResultant;2PTS2BL;8|
        ...
        (SPROG
         ((|toSave| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          ...
          (|s| (P)) (#1=#:G519 NIL) (|p3| (P)) (#2=#:G525 NIL)
          (|e|
                 ...
                 (COND ((QEQCAR |e| 0) (QCDR |e|))
                       ((SPADCALL |ts| (QREFELT $ 79))
                        (SEQ
                         ...
                         (EXIT (PROGN (LETT #2# |toSave|) (GO #3=#:G524)))))
                       (#4='T
                        (SEQ
                         (COND
                          (|b1|
...
(SDEFUN |SFRGCD;stoseInternalLastSubResultant;LVBL;9|
        ...
        (SPROG
         ((#1=#:G550 NIL)
          ...
          (#2=#:G549 NIL) (|p3| (P)) (|delta| (|NonNegativeInteger|))
          (#3=#:G536 NIL)
          (|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#4=#:G546 NIL) (#5=#:G548 NIL) (|bwt| NIL)
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|ts| (TS)) (#6=#:G547 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |SFRGCD;stoseSquareFreePart_wip|
        ...
        (SPROG
         ((|lpwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|sfp| (P)) (|g| (P)) (|us| (TS)) (#1=#:G573 NIL) (|gwt| NIL)
...
(SDEFUN |SFRGCD;stoseInvertible?_sqfreg;PTSL;14|
        ...
        (SPROG
         ((|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (#1=#:G608 NIL) (|ts_h| NIL) (|lts_h| #2=(|List| TS)) (|h| (P))
          (#3=#:G607 NIL) (|ts_g| NIL) (|lts_g| #2#) (|g| (P)) (#4=#:G606 NIL)
          (|lts| #2#) (#5=#:G605 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#6=#:G583 NIL)
          (#7=#:G603 NIL) (|newq| (P)) (#8=#:G604 NIL) (|bwt| NIL)
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|v| (V)) (|q| (P)))
         (SEQ
...
(SDEFUN |SFRGCD;stoseInvertibleSet_sqfreg;PTSL;15|
        ...
        (SPROG
         ((|toSave| (|List| TS)) (|lts_h| #1=(|List| TS)) (|h| (P)) (|g| (P))
          (|lts| #1#) (#2=#:G637 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#3=#:G620 NIL)
          (#4=#:G635 NIL) (|newq| (P)) (#5=#:G636 NIL) (|bwt| NIL)
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
...
(SDEFUN |SFRGCD;stoseInvertible?_reg;PTSL;16|
        ...
        (SPROG
         ((|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (#1=#:G675 NIL) (|bwt| NIL) (#2=#:G674 NIL)
          (|inv|
           #3=(|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (#4=#:G673 NIL) (|ts_h| NIL) (|lts_h| #5=(|List| TS)) (|h| (P))
          (#6=#:G672 NIL) (|ts_g| NIL) (|lts_g| #5#) (|g| (P)) (#7=#:G671 NIL)
          (|lts| #5#) (#8=#:G670 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#9=#:G645 NIL)
          (#10=#:G668 NIL) (|newq| (P)) (#11=#:G669 NIL) (|toCheck| #3#)
          (|v| (V)) (|q| (P)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SFRGCD;stoseInvertibleSet_reg;PTSL;17|
        ((|p| P) (|ts| TS) ($ |List| TS))
        (SPROG
         ((|toSave| (|List| TS)) (|inv| (|List| TS)) (#1=#:G707 NIL)
          (|ts_h| NIL) (|lts_h| #2=(|List| TS)) (|h| (P)) (|g| (P)) (|lts| #2#)
          (#3=#:G706 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#4=#:G687 NIL)
          (#5=#:G704 NIL) (|newq| (P)) (#6=#:G705 NIL) (|bwt| NIL)
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|v| (V)) (|q| (P)) (|e| (|Union| (|List| TS) "failed"))
          (|k| (|Record| (|:| |arg1| P) (|:| |arg3| TS))))
...
(DEFUN |SquareFreeRegularTriangularSetGcdPackage| (&REST #1=#:G714)
  (SPROG NIL
         (PROG (#2=#:G715)
           (RETURN
            (COND
