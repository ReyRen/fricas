...
(SDEFUN |BEZOUT;sylvesterMatrix;2UPM;1| ((|p| UP) (|q| UP) ($ M))
        (SPROG
         ((#1=#:G402 NIL) (|i| NIL) (|q0| (UP))
          (|deg| #2=(|NonNegativeInteger|)) (|coef| (R)) (#3=#:G401 NIL)
...
(SDEFUN |BEZOUT;bezoutMatrix;2UPM;4| ((|p| UP) (|q| UP) ($ M))
        (SPROG
         ((#1=#:G501 NIL) (|k| NIL) (#2=#:G500 NIL) (|i| NIL) (|p0| (UP))
          (|c| (R)) (#3=#:G499 NIL) (|coef| (R))
          (|deg| #4=(|NonNegativeInteger|)) (|q0| (UP)) (#5=#:G498 NIL)
          (|bound| #6=(|Integer|)) (#7=#:G497 NIL) (|bezmat| (M))
          (#8=#:G496 NIL) (#9=#:G495 NIL) (|maxC| (|Integer|))
          (|maxR| (|Integer|)) (|minC| (|Integer|)) (|minR| (|Integer|))
...
(SDEFUN |BEZOUT;subresultant| ((|m| M) (|j| |NonNegativeInteger|) ($ UP))
        (SPROG
         ((#1=#:G503 NIL) (#2=#:G502 (UP)) (#3=#:G504 (UP)) (#4=#:G507 NIL)
          (|k| NIL) (|x| (UP)))
         (SEQ
          (COND
           ((EQL |j| 0)
...
(SDEFUN |BEZOUT;subresultants;2UPIv;6|
        ...
        (SPROG
         ((#1=#:G514 NIL) (|i| NIL) (#2=#:G513 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G508 NIL) (|m| (M))
...
(SDEFUN |BEZOUT;bezoutDiscriminant;UPR;8| ((|f| UP) ($ R))
        (SPROG ((#1=#:G517 NIL) (|degMod4| (|Integer|)))
...
(DEFUN |BezoutMatrix| (&REST #1=#:G524)
  (SPROG NIL
         (PROG (#2=#:G525)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 71
                                            '(0 6 0 11 0 7 0 12 2 7 13 0 0 14 1
                                              ...
                                              18 0 40 3 8 0 0 41 38 42 2 15 13
                                              0 0 44 2 15 0 45 0 46 1 38 0 18
                                              47 3 8 0 0 38 41 48 1 7 13 0 51 3
                                              8 6 0 18 18 52 2 6 0 0 0 53 2 6 0
                                              0 0 54 1 6 0 0 55 1 8 6 0 56 1 7
                                              0 6 57 2 7 0 6 15 58 2 7 0 0 15
                                              59 2 7 0 0 6 60 2 7 0 0 0 61 1 63
                                              0 62 64 2 0 63 7 7 65 2 0 6 7 7
                                              66 1 7 0 0 67 2 6 68 0 0 69 1 0 6
                                              7 70 2 6 13 0 0 71 2 0 8 7 7 27 2
                                              1 63 7 7 65 3 0 8 8 15 15 49 2 0
                                              8 8 15 43 2 1 6 7 7 66 2 0 8 7 7
                                              50 1 1 6 7 70)))))
           '|lookupComplete|)) 
