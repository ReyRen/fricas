...
(SDEFUN |LODOOPS;vec2LODO| ((|v| |Vector| A) ($ L))
        (SPROG
         ((#1=#:G384 NIL) (#2=#:G383 (L)) (#3=#:G385 (L)) (#4=#:G386 NIL)
          (#5=#:G388 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LODOOPS;killer|
        ((|u|
         ...
         (|diff| |Mapping| A A) ($ L))
        (SPROG
         ((|lu| (|List| #1#)) (#2=#:G406 NIL) (|l| (|List| (|Vector| A)))
          (|mat| (|Matrix| A)) (#3=#:G407 NIL) (|q| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |lu| (LIST |u|))
...
(DEFUN |LinearOrdinaryDifferentialOperatorsOps| (&REST #1=#:G418)
  (SPROG NIL
         (PROG (#2=#:G419)
           (RETURN
            (COND
