...
(SDEFUN |GBF;createGroebnerBases|
        ((|basis| |List|
         ...
         ($ |List| (|List| |Dpol|)))
        (SPROG
         ((|newBasis| (|List| |Dpol|)) (#1=#:G439 NIL) (|p| (|Dpol|))
          (#2=#:G438 NIL) (|newInputPolys| (|List| |Dpol|)) (#3=#:G437 NIL)
          (|fnP| (|Dpol|)) (#4=#:G433 NIL) (|nP| (|Dpol|))
          (|allReducedFactors| (|List| |Dpol|)) (#5=#:G436 NIL)
          (|doSplitting?| #6=(|Boolean|))
          (|irreducibleFactors| (|List| |Dpol|)) (|terminateWithBasis| #6#)
          (|stopDividing| #6#) (#7=#:G400 NIL)
          (|nPq| (|Union| |Dpol| #8="failed")) (#9=#:G435 NIL) (#10=#:G434 NIL)
          (|q| NIL) (|h| (|Dpol|)))
         (SEQ (LETT |doSplitting?| NIL) (LETT |terminateWithBasis| NIL)
              ...
              (EXIT
               (COND
                (|doSplitting?|
                 (SEQ
                  (SEQ (LETT |fnP| NIL) (LETT #3# |allReducedFactors|) G190
                       (COND
...
(SDEFUN |GBF;createAllFactors| ((|p| |Dpol|) ($ |List| |Dpol|))
        (SPROG
         ((|loF| (|List| |Dpol|)) (#1=#:G446 NIL) (|el| NIL) (#2=#:G445 NIL))
         (SEQ
          (LETT |loF|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GBF;factorGroebnerBasis;LBL;7|
        ...
        (SPROG
         ((|foundAReducible| (|Boolean|)) (#1=#:G473 NIL) (|el| NIL)
          (#2=#:G472 NIL) (#3=#:G471 NIL) (|p| NIL))
...
(SDEFUN |GBF;groebnerFactorize;2LBL;9|
        ...
        (SPROG ((#1=#:G484 NIL) (|p| NIL) (#2=#:G483 NIL))
               (SEQ
...
(DEFUN |GroebnerFactorizationPackage| (&REST #1=#:G487)
  (SPROG NIL
         (PROG (#2=#:G488)
           (RETURN
            (COND
