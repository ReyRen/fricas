...
(SDEFUN |ODEINT;mkprod|
        ((|l| |List|
         ...
         ($ F))
        (SPROG
         ((#1=#:G402 NIL) (#2=#:G401 (F)) (#3=#:G403 (F)) (#4=#:G408 NIL)
          (|r| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |coef| (|Fraction| (|Integer|))) (|:| |logand| F))))
...
(SDEFUN |ODEINT;isQ|
        ...
        (SPROG
         ((|prod| (|Fraction| (|Integer|))) (#1=#:G433 NIL)
          (|u| (|Union| (|Fraction| (|Integer|)) "failed")) (#2=#:G434 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
...
(DEFUN |ODEIntegration| (&REST #1=#:G457)
  (SPROG NIL
         (PROG (#2=#:G458)
           (RETURN
            (COND
