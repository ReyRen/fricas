...
(DEFUN |MultivariatePolynomial| (&REST #1=#:G426)
  (SPROG NIL
         (PROG (#2=#:G427)
           (RETURN
            (COND
...
(DEFUN |MultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G425 NIL) (|pv$| NIL) (#2=#:G417 NIL) (#3=#:G418 NIL) (#4=#:G419 NIL)
    (#5=#:G420 NIL) (#6=#:G421 NIL) (#7=#:G422 NIL) (#8=#:G423 NIL)
    (#9=#:G424 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|MultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 7 24)
              ...
              (|List| 41) (|Union| 26 '#3="failed")
              (|Record| (|:| |var| 24) (|:| |exponent| 21)) (|Union| 44 '#3#)
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7
                 ...
                 (|RetractableTo| 7) (|BasicType|) (|CoercibleTo| 55)
