...
(SDEFUN |SHDP;lessThanRlex|
        ...
        (SPROG
         ((#1=#:G394 NIL) (#2=#:G396 NIL) (|i| NIL) (|n2| (S)) (|n1| (S))
          (#3=#:G395 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |SHDP;<;2$B;2| ((|v1| $) (|v2| $) ($ |Boolean|))
        (SPROG ((#1=#:G402 NIL) (#2=#:G403 NIL) (|i| NIL))
               (SEQ
                (EXIT
...
(DEFUN |SplitHomogeneousDirectProduct| (&REST #1=#:G430)
  (SPROG NIL
         (PROG (#2=#:G431)
           (RETURN
            (COND
...
(DEFUN |SplitHomogeneousDirectProduct;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G421 NIL) (#2=#:G422 NIL) (#3=#:G423 NIL) (#4=#:G424 NIL)
    (#5=#:G425 NIL) (#6=#:G426 NIL) (#7=#:G427 NIL) (#8=#:G428 NIL)
    (#9=#:G429 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
