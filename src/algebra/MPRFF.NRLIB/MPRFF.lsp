...
(SDEFUN |MPRFF;factor;PRFF;1| ((|p| PRF) ($ |Factored| PRF))
        (SPROG
         ((#1=#:G393 NIL) (#2=#:G392 #3=(|Factored| PRF)) (#4=#:G394 #3#)
          (#5=#:G402 NIL) (|ff| NIL)
          (|ffact|
           (|List|
            (|Record| (|:| |irr| PRF) (|:| |pow| (|NonNegativeInteger|)))))
          (#6=#:G401 NIL) (#7=#:G400 NIL) (|fcont| (PRF)) (#8=#:G399 NIL)
          (|x| NIL) (#9=#:G398 NIL) (|u| NIL) (#10=#:G397 NIL)
...
(SDEFUN |MPRFF;pushup;PRFOVPRF;4| ((|f| PRF) (|x| OV) ($ PRF))
        (SPROG
         ((|g| (|SparseUnivariatePolynomial| PRF)) (|v| (OV)) (#1=#:G411 NIL))
         (SEQ
          (COND
...
(SDEFUN |MPRFF;totalfract;PRFR;7|
        ((|p| PRF)
         ($ |Record| (|:| |sup| (|Polynomial| R))
          (|:| |inf| (|Polynomial| R))))
        (SPROG ((|g| (|Fraction| (|Polynomial| R))) (#1=#:G429 NIL) (|x| NIL))
               (SEQ
                (COND
...
(DEFUN |MPolyCatRationalFunctionFactorizer| (&REST #1=#:G430)
  (SPROG NIL
         (PROG (#2=#:G431)
           (RETURN
            (COND
