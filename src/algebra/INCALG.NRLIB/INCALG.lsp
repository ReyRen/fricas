...
(SDEFUN |INCALG;*;P2$;7| ((|p| |Permutation| (|Integer|)) (A $) ($ $))
        (SPROG
         ((|newA| (|Matrix| R)) (|indic| (|List| (|Integer|))) (#1=#:G415 NIL)
          (|i| NIL) (#2=#:G414 NIL) (|newindices| (|OneDimensionalArray| S))
          (#3=#:G413 NIL) (#4=#:G412 NIL) (|n| (|Integer|))
          (|mp| (|Set| (|Integer|))))
...
(DEFUN |IncidenceAlgebra| (&REST #1=#:G432)
  (SPROG NIL
         (PROG (#2=#:G433)
           (RETURN
            (COND
