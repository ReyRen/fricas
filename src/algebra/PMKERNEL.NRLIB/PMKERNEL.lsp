...
(SDEFUN |PMKERNEL;patternMatchArg|
        ...
        (SPROG
         ((#1=#:G404 NIL) (#2=#:G406 NIL) (#3=#:G409 NIL) (|p| NIL)
          (#4=#:G410 NIL) (|s| NIL) (#5=#:G405 NIL) (#6=#:G407 NIL)
          (#7=#:G408 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PMKERNEL;patternMatchInner|
        ...
        (SPROG
         ((#1=#:G429 NIL) (|w| (|Union| (|Symbol|) "failed"))
...
(SDEFUN |PMKERNEL;patternMatchMonoid|
        ((|s| |Kernel| E) (|p| |Pattern| S) (|l| |PatternMatchResult| S E)
         ($ |Union| (|PatternMatchResult| S E) "failed"))
        (SPROG
         ((|w| (|Union| (|List| (|Pattern| S)) "failed")) (#1=#:G458 NIL)
...
(DEFUN |PatternMatchKernel| (&REST #1=#:G478)
  (SPROG NIL
         (PROG (#2=#:G479)
           (RETURN
            (COND
