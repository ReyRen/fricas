...
(SDEFUN |POLYROOT;zroot|
        ...
        (SPROG
         ((#1=#:G391 NIL) (#2=#:G390 #3=(|Integer|)) (#4=#:G392 #3#)
          (#5=#:G395 NIL) (#6=#:G382 NIL)
          (|s|
           (|Record| (|:| |exponent| (|NonNegativeInteger|))
...
(SDEFUN |POLYROOT;qroot;FNniR;3|
        ((|x| |Fraction| (|Integer|)) (|n| |NonNegativeInteger|)
         ($ |Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
          (|:| |radicand| F)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G403 NIL)
          (|sd|
...
(SDEFUN |POLYROOT;qroot;FNniR;4|
        ((|x| |Fraction| (|Integer|)) (|n| |NonNegativeInteger|)
         ($ |Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
          (|:| |radicand| F)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G409 NIL)
          (|sd|
...
(SDEFUN |POLYROOT;rsplit|
        ...
        (SPROG
         ((|r| (R)) (|p| (P)) (|u| (|Union| R "failed")) (#1=#:G434 NIL)
          (|q| NIL))
...
(SDEFUN |POLYROOT;froot;FNniR;11|
        ((|x| F) (|n| |NonNegativeInteger|)
         ($ |Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
          (|:| |radicand| F)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G449 NIL)
          (|rd|
           #2=(|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                        (|:| |radicand| F)))
...
(DEFUN |PolynomialRoots| (&REST #1=#:G452)
  (SPROG NIL
         (PROG (#2=#:G453)
           (RETURN
            (COND
