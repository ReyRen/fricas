...
(SDEFUN |ULSCONS;=;2$B;23| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG ((#1=#:G513 NIL) (#2=#:G504 NIL) (|expDiff| (|Integer|)))
               (SEQ
                (COND ((EQ |x| |y|) 'T)
                      (#3='T
                       (SEQ
...
(SDEFUN |ULSCONS;+;3$;25| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G530 NIL) (#2=#:G526 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|ULSCONS;getExpon| |x| $)
                         (|ULSCONS;getExpon| |y| $)))
...
(SDEFUN |ULSCONS;-;3$;26| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G541 NIL) (#2=#:G537 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|ULSCONS;getExpon| |x| $)
                         (|ULSCONS;getExpon| |y| $)))
...
(SDEFUN |ULSCONS;elt;3$;30| ((|uls1| $) (|uls2| $) ($ $))
        (SPROG
         ((#1=#:G571 NIL) (|uts1| (UTS)) (|recipr| (|Union| $ "failed"))
...
(SDEFUN |ULSCONS;eval;$CoefS;31| ((|uls| $) (|r| |Coef|) ($ |Stream| |Coef|))
        (SPROG
         ((#1=#:G590 NIL) (#2=#:G583 NIL) (|recipr| (|Union| |Coef| "failed"))
          (|n| (|Integer|)) (|uts| (UTS)))
         (SEQ
          (SEQ (LETT |n| (|ULSCONS;getExpon| |uls| $))
               (EXIT
           ...
           (COND
            ((< |n| 0)
             (COND
              ...
              (#3='T
               (SEQ (LETT |recipr| (SPADCALL |r| (QREFELT $ 80)))
                    (EXIT
                     (COND
                      ((QEQCAR |recipr| 1)
...
(SDEFUN |ULSCONS;order;$2I;37| ((|x| $) (|n| . #1=(|Integer|)) ($ . #1#))
        (SPROG ((#2=#:G606 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |ULSCONS;truncate;$I$;38| ((|x| $) (|n| |Integer|) ($ $))
        (SPROG ((#1=#:G610 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
               (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
                    (EXIT
...
(SDEFUN |ULSCONS;truncate;$2I$;39|
        ((|x| $) (|n1| . #1=(|Integer|)) (|n2| . #1#) ($ $))
        (SPROG
         ((#2=#:G616 NIL) (#3=#:G615 NIL) (|m1| (|Integer|)) (|e| (|Integer|))
          (|#G61| #1#) (|#G60| #1#))
         (SEQ
          (COND
           ((< |n2| |n1|)
...
(SDEFUN |ULSCONS;rationalFunction;$IF;40|
        ...
        (SPROG
         ((#1=#:G624 NIL) (#2=#:G623 NIL)
          (|c| (|Fraction| (|Polynomial| |Coef|)))
          (|v| (|Fraction| (|Polynomial| |Coef|)))
          (|poly| (|Fraction| (|Polynomial| |Coef|))) (#3=#:G620 NIL)
          (|m| (|Integer|)) (|e| (|Integer|)))
         (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
              (EXIT
...
(SDEFUN |ULSCONS;rationalFunction;$2IF;41|
        ...
        (SPROG
         ((#2=#:G636 NIL) (#3=#:G635 NIL)
          (|c| (|Fraction| (|Polynomial| |Coef|)))
          (|v| (|Fraction| (|Polynomial| |Coef|)))
          (|poly| (|Fraction| (|Polynomial| |Coef|))) (#4=#:G632 NIL)
          (#5=#:G631 NIL) (|m1| (|Integer|)) (|e| (|Integer|)) (|#G68| #1#)
          (|#G67| #1#))
         (SEQ
          (COND
           ((< |n2| |n1|)
...
(SDEFUN |ULSCONS;approximate;$ICoef;43| ((|x| $) (|n| |Integer|) ($ |Coef|))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G652 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
         (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
              (EXIT
...
(SDEFUN |ULSCONS;extend;$I$;45| ((|x| $) (|n| |Integer|) ($ $))
        (SPROG ((#1=#:G658 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |ULSCONS;^;$I$;54| ((|x| $) (|n| |Integer|) ($ $))
        (SPROG
         ((|minusN| (|NonNegativeInteger|)) (#1=#:G689 NIL) (|xInv| ($))
          (#2=#:G688 NIL))
         (SEQ
          (COND ((ZEROP |n|) (|spadConstant| $ 16))
                ((SPADCALL |n| 0 (QREFELT $ 63))
                 (SPADCALL (* |n| (|ULSCONS;getExpon| |x| $))
                           ...
                           (QREFELT $ 10)))
                ('T
                 (SEQ (LETT |xInv| (SPADCALL |x| (QREFELT $ 145)))
                      (LETT |minusN|
                            (PROG1 (LETT #1# (- |n|))
                              (|check_subtype2| (>= #1# 0)
                                                '(|NonNegativeInteger|)
...
(SDEFUN |ULSCONS;inv;2$;57| ((|x| $) ($ $))
        (SPROG ((|xInv| (|Union| $ "failed")))
               (SEQ (LETT |xInv| (SPADCALL |x| (QREFELT $ 77)))
                    (EXIT
                     (COND
                      ((QEQCAR |xInv| 1)
...
(SDEFUN |ULSCONS;/;3$;58| ((|x| $) (|y| $) ($ $))
        (SPROG ((|yInv| (|Union| $ "failed")))
               (SEQ (LETT |yInv| (SPADCALL |y| (QREFELT $ 77)))
                    (EXIT
                     (COND
                      ((QEQCAR |yInv| 1)
...
(SDEFUN |ULSCONS;integrateWithOneAnswer|
        ...
        (SPROG ((|res| (|Union| |Coef| (|List| |Coef|))))
               (SEQ (LETT |res| (SPADCALL |f| |s| (QREFELT $ 222)))
                    (EXIT
...
(SDEFUN |ULSCONS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G793 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(SDEFUN |ULSCONS;coerce;$Of;98| ((|x| $) ($ |OutputForm|))
        (SPROG
         ...
         (SEQ (LETT |x| (SPADCALL |$streamCount| |x| (QREFELT $ 24)))
              ...
              (LETT |var| (SPADCALL |uts| (QREFELT $ 87)))
              (LETT |cen| (SPADCALL |uts| (QREFELT $ 89)))
              (LETT |xxx|
                    (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor| (&REST #1=#:G839)
  (SPROG NIL
         (PROG (#2=#:G840)
           (RETURN
            (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor;| (|#1| |#2|)
  (SPROG
   ((#1=#:G838 NIL) (|pv$| NIL) (#2=#:G827 NIL) (#3=#:G828 NIL) (#4=#:G830 NIL)
    (#5=#:G831 NIL) (#6=#:G832 NIL) (#7=#:G833 NIL) (#8=#:G834 NIL)
    (#9=#:G836 NIL) (#10=#:G837 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
