...
(SDEFUN |PLEQN;inconsistent?;LB;1| ((|pl| |List| GR) ($ |Boolean|))
        (SPROG ((#1=#:G420 NIL) (#2=#:G421 NIL) (#3=#:G422 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |p| (QREFELT $ 11))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G419)))
                              (GO #5=#:G417))))))
...
(SDEFUN |PLEQN;inconsistent?;LB;2|
        ...
        (SPROG ((#1=#:G427 NIL) (#2=#:G428 NIL) (#3=#:G429 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |p| (QREFELT $ 15))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G426)))
                              (GO #5=#:G424))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |PLEQN;B1solve;RR;3|
        ...
        (SPROG
         ((|pbas| (|List| (|Vector| (|Fraction| (|Polynomial| R)))))
          (|pb| #1=(|Vector| (|Fraction| (|Polynomial| R)))) (#2=#:G454 NIL)
          (|j| NIL) (|j1| NIL) (#3=#:G453 NIL) (|i| NIL) (|i1| NIL)
          (#4=#:G452 NIL) (#5=#:G451 NIL)
          (|augmat| (|Matrix| (|Fraction| (|Polynomial| R)))) (#6=#:G450 NIL)
          (#7=#:G449 NIL) (#8=#:G448 NIL) (|p| #1#)
        ...
        (SPROG
         ((|test|
           (|Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
                     (|:| |n0| (|List| GR))))
          (|yzero| (|List| GR)) (#3=#:G490 NIL) (|pw| NIL) (#4=#:G489 NIL)
          (|wcd| (|List| (|Polynomial| R))) (#5=#:G481 NIL)
          (|wnum| (|Polynomial| R)) (|weqn| #6=(|Fraction| (|Polynomial| R)))
          (#7=#:G466 NIL) (#8=#:G465 #6#) (#9=#:G467 #6#) (#10=#:G488 NIL)
          (|j| NIL) (#11=#:G487 NIL) (|i| NIL) (|frows| (|List| (|Integer|)))
          ...
          (|sys|
           (|Record| (|:| |mat| (|Matrix| (|Fraction| (|Polynomial| R))))
                     ...
                     (|:| |cols| (|List| (|Integer|)))))
          (|nss| #2#) (|rss| #1#)
          (|nc| (|Matrix| (|Fraction| (|Polynomial| R)))) (#13=#:G459 NIL)
          (#14=#:G458 (GR)) (#15=#:G460 (GR)) (#16=#:G486 NIL) (#17=#:G382 NIL)
          (#18=#:G485 NIL) (|x| NIL) (#19=#:G484 NIL) (#20=#:G483 NIL)
          (#21=#:G482 NIL) (|ydetf| (|List| GR)))
         (SEQ
          (EXIT
                     ...
                     (|:| |bsoln|
                          (|Record|
                           ...
                           (|:| |basis|
                                (|List|
                                 (|Vector| (|Fraction| (|Polynomial| R)))))))))
          (#1=#:G512 NIL) (|y| NIL) (|psbf| (|List| (|List| GR)))
          (#2=#:G511 NIL) (|x| NIL) (#3=#:G510 NIL) (|psb| #4=(|List| GR))
          (|pc|
           #5=(|List|
...
(SDEFUN |PLEQN;factorset;GRL;6| ((|y| GR) ($ |List| GR))
        (SPROG ((#1=#:G518 NIL) (|j| NIL) (#2=#:G517 NIL))
               (SEQ
        ...
        (SPROG
         ((|rcl|
          ...
          (|test|
           (|Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
                     (|:| |n0| (|List| GR))))
          (|p| (GR)) (#4=#:G536 NIL) (|rc| NIL) (#5=#:G537 NIL)
          (|maxrk| (|Integer|))
          (|pc|
           (|List|
            (|Record| (|:| |det| GR) (|:| |rows| (|List| (|Integer|)))
                      (|:| |cols| (|List| (|Integer|))))))
          (#6=#:G534 NIL) (|k| NIL) (#7=#:G535 NIL)
...
(SDEFUN |PLEQN;redpps;RLR;8|
        ...
        (SPROG
         ((#3=#:G555 NIL) (|i| NIL)
          (|pbj| (|Vector| (|Fraction| (|Polynomial| R)))) (#4=#:G554 NIL)
          (|j| NIL) (#5=#:G553 NIL) (|denmat| #6=(|Matrix| GR)) (|nummat| #6#)
          (#7=#:G552 NIL) (#8=#:G551 NIL) (#9=#:G550 NIL)
...
(SDEFUN |PLEQN;dmp2rfi;MM;9|
        ...
        (SPROG
         ((#1=#:G561 NIL) (|j| NIL) (#2=#:G560 NIL) (|i| NIL)
...
(SDEFUN |PLEQN;dmp2rfi;LL;10|
        ...
        (SPROG ((#1=#:G565 NIL) (|v| NIL) (#2=#:G564 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                    ...
                    (|:| |bsoln|
                         (|Record|
                          ...
                          (|:| |basis|
                               (|List|
                                (|Vector| (|Fraction| (|Polynomial| R))))))))))
        (SPROG ((#1=#:G592 NIL) (|i| NIL) (#2=#:G591 NIL))
               (SEQ
                (QCAR
                 (SPADCALL |mat|
                           (PROGN
...
(SDEFUN |PLEQN;psolve;MSI;19|
        ...
        (SPROG ((#1=#:G602 NIL) (|i| NIL) (#2=#:G601 NIL))
               (SEQ
                (QCDR
                 (SPADCALL |mat|
                           (PROGN
...
(SDEFUN |PLEQN;nextSublist;2IL;20|
        ...
        (SPROG
         ((|mslist| (|List| (|List| (|Integer|)))) (#1=#:G606 NIL) (|ms| NIL))
         (SEQ
                 ...
                 (SEQ
                  ...
                  (SEQ (LETT |ms| NIL)
                       ...
                       (SEQ
                        (EXIT
                         (LETT |mslist|
                               (CONS (SPADCALL |ms| (LIST |n|) (QREFELT $ 129))
                                     |mslist|))))
                       (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                  (EXIT
                   (SPADCALL (SPADCALL (- |n| 1) |k| (QREFELT $ 128)) |mslist|
                             (QREFELT $ 130))))))))) 
...
(SDEFUN |PLEQN;psolve;MPiSI;23|
        ((|mat| |Matrix| GR) (|h| |PositiveInteger|) (|outname| |String|)
         ($ |Integer|))
        (SPROG ((#1=#:G616 NIL) (|i| NIL) (#2=#:G615 NIL))
               (SEQ
                (QCDR
                 (SPADCALL |mat|
                           (PROGN
...
(SDEFUN |PLEQN;hasoln;2LR;24|
        ((|zro| |List| GR) (|nzro| |List| GR)
         ($ |Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
          (|:| |n0| (|List| GR))))
        (SPROG
         ((#1=#:G649 NIL) (|p| NIL) (#2=#:G648 NIL) (#3=#:G647 NIL)
          (#4=#:G646 NIL) (#5=#:G624 NIL) (#6=#:G623 (GR)) (#7=#:G625 (GR))
          (#8=#:G645 NIL) (#9=#:G384 NIL) (#10=#:G644 NIL) (|x| NIL)
          (#11=#:G643 NIL) (|psbf| (|List| (|List| GR))) (#12=#:G642 NIL)
          (#13=#:G641 NIL) (#14=#:G640 NIL) (#15=#:G639 NIL) (|pnzro| (GR))
          (#16=#:G619 NIL) (#17=#:G618 (GR)) (#18=#:G620 (GR)) (#19=#:G638 NIL)
          (#20=#:G383 NIL))
         (SEQ
...
(SDEFUN |PLEQN;se2rfi;LL;25|
        ...
        (SPROG ((#1=#:G653 NIL) (|wi| NIL) (#2=#:G652 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |PLEQN;pr2dmp;PGR;26| ((|p| |Polynomial| R) ($ GR))
        (COND
         ((SPADCALL |p| (QREFELT $ 15))
          (SPADCALL (SPADCALL |p| (QREFELT $ 138)) (QREFELT $ 139)))
         ('T
...
(SDEFUN |PLEQN;wrregime;LSI;27|
        ((|lrec3| |List|
         ...
         (|outname| |String|) ($ |Integer|))
        (SPROG
         ((|count| (|Integer|)) (#1=#:G661 NIL) (|rec3| NIL)
          (|rksoln|
           (|File|
            (|Record| (|:| |eqzro| (|List| GR)) (|:| |neqzro| (|List| GR))
                      (|:| |wcond| (|List| (|Polynomial| R)))
...
(SDEFUN |PLEQN;dmp2rfi;GRF;28| ((|p| GR) ($ |Fraction| (|Polynomial| R)))
        (SPADCALL (CONS #'|PLEQN;dmp2rfi;GRF;28!0| $)
                  (CONS #'|PLEQN;dmp2rfi;GRF;28!1| $) |p| (QREFELT $ 147))) 

(SDEFUN |PLEQN;dmp2rfi;GRF;28!1| ((|r1| NIL) ($ NIL))
        (SPADCALL (SPADCALL |r1| (QREFELT $ 143)) (QREFELT $ 137))) 

(SDEFUN |PLEQN;dmp2rfi;GRF;28!0| ((|v1| NIL) ($ NIL))
        (SPADCALL (SPADCALL |v1| (QREFELT $ 141)) (QREFELT $ 142))) 
...
(SDEFUN |PLEQN;rdregime;SL;29|
        ...
        (SPROG
         ((|rec3|
          ...
          (|infilename| (|FileName|)))
         (SEQ
          (LETT |infilename| (SPADCALL "" |inname| "regime" (QREFELT $ 148)))
          (LETT |infile| (SPADCALL |infilename| "input" (QREFELT $ 149)))
          (LETT |rksoln| NIL) (LETT |rec3| (SPADCALL |infile| (QREFELT $ 151)))
                      ...
                      (CONS
                       (PROG2 (LETT #1# |rec3|)
                         ...
                         (|check_union2| (QEQCAR #1# 0)
                                         ...
                                         #1#))
                       |rksoln|))
                (EXIT (LETT |rec3| (SPADCALL |infile| (QREFELT $ 151)))))
...
(SDEFUN |PLEQN;maxrank;LNni;30|
        ((|rcl| |List|
         ...
         ($ |NonNegativeInteger|))
        (SPROG
         ((#2=#:G675 NIL) (#3=#:G674 #1#) (#4=#:G676 #1#) (#5=#:G679 NIL)
          (|j| NIL))
         (SEQ
          (COND ((NULL |rcl|) 0)
                (#6='T
...
(SDEFUN |PLEQN;minrank;LNni;31|
        ((|rcl| |List|
         ...
         ($ |NonNegativeInteger|))
        (SPROG
         ((#2=#:G682 NIL) (#3=#:G681 #1#) (#4=#:G683 #1#) (#5=#:G686 NIL)
          (|j| NIL))
         (SEQ
          (COND ((NULL |rcl|) 0)
                (#6='T
...
(SDEFUN |PLEQN;minset;2L;32|
        ...
        (SPROG ((#1=#:G692 NIL) (|x| NIL) (#2=#:G691 NIL))
               (SEQ
                (COND ((NULL |lset|) |lset|)
                      ('T
                       (PROGN
                        ...
                        (SEQ (LETT |x| NIL) (LETT #1# |lset|) G190
                             ...
                             (SEQ
                              (EXIT
                               (COND
                                ((NULL (SPADCALL |x| |lset| (QREFELT $ 153)))
                                 (LETT #2# (CONS |x| #2#))))))
                             (LETT #1# (CDR #1#)) (GO G190) G191
                             (EXIT (NREVERSE #2#))))))))) 
...
(SDEFUN |PLEQN;sqfree;2GR;33| ((|p| GR) ($ GR))
        (SPROG
         ((#1=#:G695 NIL) (#2=#:G694 (GR)) (#3=#:G696 (GR)) (#4=#:G698 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |j| NIL)
                (LETT #4#
                      (SPADCALL (SPADCALL |p| (QREFELT $ 155)) (QREFELT $ 95)))
                G190
                (COND
...
(SDEFUN |PLEQN;ParCond;MNniL;34|
        ...
        (SPROG
         ((|DetEqn|
          ...
          (|matsub| (|SquareMatrix| |j| GR)) (#3=#:G711 NIL) (|nss| NIL)
          (#4=#:G712 NIL) (#5=#:G709 NIL) (|rss| NIL) (#6=#:G710 NIL)
...
(SDEFUN |PLEQN;ParCond;MNniL;34!0| ((|z1| NIL) (|z2| NIL) ($ NIL))
        (SPADCALL (SPADCALL (QVELT |z1| 0) (QREFELT $ 159))
                  (SPADCALL (QVELT |z2| 0) (QREFELT $ 159)) (QREFELT $ 160))) 

(SDEFUN |PLEQN;overset?;LLB;35|
        ((|p| |List| GR) (|qlist| |List| (|List| GR)) ($ |Boolean|))
        (SPROG
         ((#1=#:G714 NIL) (#2=#:G713 #3=(|Boolean|)) (#4=#:G715 #3#)
          (#5=#:G718 NIL) (|q| NIL))
         (SEQ
          (COND ((NULL |qlist|) NIL)
                (#6='T
                  ...
                  (SEQ (LETT |q| NIL) (LETT #5# |qlist|) G190
                       ...
                       (SEQ
                        (EXIT
                         (PROGN
                          (LETT #4#
                                (SPADCALL (SPADCALL |q| (QREFELT $ 164))
...
(SDEFUN |PLEQN;redmat;MLM;36|
        ...
        (SPROG
         ((|p| (GR)) (#1=#:G725 NIL) (|j| NIL) (#2=#:G724 NIL) (|i| NIL)
...
(DEFUN |ParametricLinearEquations| (&REST #1=#:G726)
  (SPROG NIL
         (PROG (#2=#:G727)
           (RETURN
            (COND
...
(MAKEPROP '|ParametricLinearEquations| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              |PLEQN;psolve;MLL;11| (|List| 135) |PLEQN;se2rfi;LL;25|
              ...
              |PLEQN;psolve;MLSI;18| |PLEQN;psolve;MSI;19| (284 . <=) (290 . >)
              (|List| 23) |PLEQN;nextSublist;2IL;20| (296 . |append|)
              (302 . |append|) |PLEQN;psolve;MLPiSI;21|
              |PLEQN;psolve;MLPiSI;22| |PLEQN;psolve;MPiSI;23| (308 . |entry?|)
              (|Symbol|) (314 . |monomial|) (321 . |coerce|) (326 . |ground|)
              (331 . |coerce|) |PLEQN;wrregime;LSI;27| (336 . |convert|)
              (341 . |coerce|) (346 . |coerce|) (|Mapping| 28 7)
              (|Mapping| 28 6) (|PolynomialCategoryLifting| 8 7 6 9 28)
              (351 . |map|) (358 . |filename|) (365 . |open|)
              (|Union| 69 '"failed") (371 . |readIfCan!|)
           ...
           '#(|wrregime| 422 |sqfree| 428 |se2rfi| 433 |regime| 438 |redpps|
              ...
              |maxrank| 573 |inconsistent?| 578 |hasoln| 588 |factorset| 594
