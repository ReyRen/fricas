...
(SDEFUN |TSEREXPP;rescale|
        ((|p| UPS) (|r0| |Fraction| (|Integer|)) (|rn| |Fraction| (|Integer|))
         ($ ULS))
        (SPROG ((|s| (|PositiveInteger|)) (#1=#:G382 NIL))
               (SEQ
                (LETT |s|
                      (PROG1
                          (LETT #1#
...
(SDEFUN |TSEREXPP;common_rep|
        ...
        (SPROG
         ((#1=#:G427 NIL) (|p| NIL) (#2=#:G428 NIL) (|r| NIL) (#3=#:G426 NIL)
          (|rn| (|Fraction| (|Integer|))) (#4=#:G425 NIL) (#5=#:G424 NIL)
          (#6=#:G423 NIL) (#7=#:G422 NIL)
          (|lr| (|List| (|Fraction| (|Integer|)))) (#8=#:G421 NIL)
          (#9=#:G420 NIL))
         (SEQ
          (LETT |lr|
                (PROGN
...
(DEFUN |TaylorSeriesExpansionPuiseux| (&REST #1=#:G438)
  (SPROG NIL
         (PROG (#2=#:G439)
           (RETURN
            (COND
