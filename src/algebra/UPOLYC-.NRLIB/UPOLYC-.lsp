...
(SDEFUN |UPOLYC-;factor;SF;20| ((|p| S) ($ |Factored| S))
        (SPROG
         ((#1=#:G500 NIL) (|w| NIL) (#2=#:G499 NIL) (|ansR| (|Factored| R)))
         (SEQ
          (COND
           ((ZEROP (SPADCALL |p| (QREFELT $ 11)))
            (SEQ
...
(SDEFUN |UPOLYC-;vectorise;SNniV;21|
        ...
        (SPROG
         ((#1=#:G501 NIL) (#2=#:G505 NIL) (|i| NIL) (|m| (|Integer|))
          (|v| (|Vector| R)))
         (SEQ
          (LETT |m|
...
(SDEFUN |UPOLYC-;unvectorise;VS;22| ((|v| |Vector| R) ($ S))
        (SPROG ((|p| (S)) (#1=#:G506 NIL) (#2=#:G510 NIL) (|i| NIL))
...
(SDEFUN |UPOLYC-;nextItemInner| ((|n| S) ($ |Union| S #1="failed"))
        (SPROG
         ((|n3| #2=(|Union| R #3="failed")) (#4=#:G528 NIL)
...
(SDEFUN |UPOLYC-;nextItem;SU;27| ((|n| S) ($ |Union| S #1="failed"))
        (SPROG ((#2=#:G541 NIL) (|n1| (|Union| S "failed")))
...
(SDEFUN |UPOLYC-;differentiate;SM2S;31|
        ...
        (SPROG
         ((|d| (S)) (#1=#:G558 NIL) (|lc| (R)) (|dg| (|NonNegativeInteger|)))
         (SEQ (LETT |d| (|spadConstant| $ 60))
              (SEQ G190
                   (COND
                    ((NULL
                      (SPADCALL (LETT |dg| (SPADCALL |x| (QREFELT $ 11))) 0
                                (QREFELT $ 123)))
                     (GO G191)))
...
(SDEFUN |UPOLYC-;ncdiff| ((|n| |NonNegativeInteger|) (|x'| S) ($ S))
        (SPROG ((|n1| (|NonNegativeInteger|)) (#1=#:G574 NIL))
        ...
        (SPROG ((|d| (S)) (|lc| (R)) (|dg| (|NonNegativeInteger|)))
               (SEQ (LETT |d| (|spadConstant| $ 60))
                    (SEQ G190
                         (COND
                          ((NULL
                            (SPADCALL (LETT |dg| (SPADCALL |x| (QREFELT $ 11)))
                                      0 (QREFELT $ 123)))
                           (GO G191)))
                         (SEQ (LETT |lc| (SPADCALL |x| (QREFELT $ 53)))
                              (LETT |d|
...
(SDEFUN |UPOLYC-;differentiate;2S;35| ((|x| S) ($ S))
        (SPROG ((|d| (S)) (#1=#:G584 NIL) (|dg| (|NonNegativeInteger|)))
               (SEQ (LETT |d| (|spadConstant| $ 60))
                    (SEQ G190
                         (COND
                          ((NULL
...
(SDEFUN |UPOLYC-;pseudoRemainder;3S;37| ((|p| S) (|q| S) ($ S))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G596 NIL) (#2=#:G603 NIL)
          (|u| (|Union| (|NonNegativeInteger|) "failed")) (#3=#:G590 NIL)
                        ...
                        (SEQ
                         (SEQ
                          ...
                          (EXIT
                           (COND
                            ((QEQCAR |u| 1)
                             (PROGN (LETT #2# |$NoValue|) (GO #5=#:G598))))))
                         (LETT |p|
                               (SPADCALL
...
(SDEFUN |UPOLYC-;pseudoQuotient;3S;39| ((|p| S) (|q| S) ($ S))
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G607 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G606 NIL) (|delta| (|Integer|)) (#3=#:G605 NIL) (|lcQ| (R))
...
(SDEFUN |UPOLYC-;pseudoDivide;2SR;40|
        ...
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G618 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G617 NIL) (|delta| (|Integer|)) (|co| (R)) (#3=#:G616 NIL)
                     ...
                     (LETT |i|
                           (PROG1 (LETT #3# (+ (- |degP| |degQ|) 1))
                             (|check_subtype2| (>= #3# 0)
                                               '(|NonNegativeInteger|)
                                               '(|Integer|) #3#)))
                     (LETT |co| (SPADCALL |lcQ| |i| (QREFELT $ 136)))
                     (LETT |quot| (|spadConstant| $ 60))
                     (SEQ G190
                          (COND
                           ((NULL
...
(SDEFUN |UPOLYC-;composite;2SU;42| ((|p| S) (|q| S) ($ |Union| S #1="failed"))
        (SPROG
         ((#2=#:G650 NIL) (|w| #3=(|Union| S "failed")) (|u| (|Union| S #1#))
          (|v| #3#)
          (|cqr|
           (|Record| (|:| |coef| R) (|:| |quotient| S) (|:| |remainder| S))))
         (SEQ
          (COND ((SPADCALL |p| (QREFELT $ 153)) (CONS 0 |p|))
                ('T
                 (SEQ
                  (EXIT
                   (SEQ (LETT |cqr| (SPADCALL |p| |q| (QREFELT $ 154)))
                        (COND
...
(SDEFUN |UPOLYC-;elt;S2F;43| ((|p| S) (|f| |Fraction| S) ($ |Fraction| S))
        (SPROG
         ((|ans| (|Fraction| S)) (#1=#:G655 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |UPOLYC-;order;2SNni;44| ((|p| S) (|q| S) ($ |NonNegativeInteger|))
        (SPROG
         ((|ans| (|NonNegativeInteger|)) (#1=#:G670 NIL)
          (|u| (|Union| S "failed")))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |UPOLYC-;divide;2SR;51|
        ...
        (SPROG
         ((|quot| (S)) (|n| (|NonNegativeInteger|)) (#1=#:G684 NIL) (|f| (R))
          (|lc| (R)))
         (SEQ
          (COND
...
(MAKEPROP '|UnivariatePolynomialCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) (|Boolean|)
              ...
              (|Union| 140 '#4="failed") (454 . |composite|) (460 . |ground?|)
              ...
              (|Symbol|) (|Equation| $) (|Union| 188 '#5="failed")
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 192
                                            '(1 6 8 0 9 1 6 10 0 11 0 12 0 13 1
                                              ...
