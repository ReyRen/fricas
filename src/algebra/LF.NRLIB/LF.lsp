...
(SDEFUN |LF;eqint| ((|k1| |Kernel| F) (|k2| |Kernel| F) ($ |Boolean|))
        (SPROG
         ((|res| (|Boolean|)) (#1=#:G443 NIL) (|a2| #2=(|List| F)) (|a1| #2#))
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL |k1| (QREFELT $ 70)))
                ...
                (COND ((NULL |res|) (PROGN (LETT #1# |res|) (GO #3=#:G442))))
        ...
        (SPROG ((|k| (|Kernel| F)))
               (SEQ
                ...
                (EXIT
                 (SPADCALL
                  (SPADCALL
                   (SPADCALL (SPADCALL |l| (QREFELT $ 55)) |x| (QREFELT $ 78))
                   (|LF;integrand| |l| $) (QREFELT $ 79))
                  (SPADCALL (QREFELT $ 16)
                            (LIST
                             (SPADCALL (|SPADfirst| |l|) |x| (QREFELT $ 78))
...
(SDEFUN |LF;dviint| ((|l| |List| F) (|v| |Symbol|) ($ F))
        (SPROG
         ((|m| (|Integer|)) (|lv| (|List| (|Symbol|))) (#1=#:G461 NIL)
          (|vf| NIL) (#2=#:G460 NIL) (|lvf| (|List| F))
...
(DEFUN |LiouvillianFunction| (&REST #1=#:G547)
  (SPROG NIL
         (PROG (#2=#:G548)
           (RETURN
            (COND
