...
(SDEFUN |INTPM;splitConstant;FSR;2|
        ...
        (SPROG
         ((#1=#:G457 NIL) (|rec| (|Record| (|:| |const| F) (|:| |nconst| F)))
          (|vv| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #2="failed"))
          (|cc| (F)) (#3=#:G459 NIL) (|g| NIL) (|nc| (F))
          (|u| (|Union| (|List| F) #2#)) (#4=#:G458 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INTPM;matchdilog| ((|f| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((#1=#:G486 NIL) (#2=#:G487 NIL) (|l| (|List| F)) (#3=#:G488 NIL)
          (|k| NIL) (|df| (F))
                            ...
                            (NULL
                             (LETT |l|
                                   (|INTPM;matchdilog0| |f| |k| |x| |n| |df|
                                    $))))
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |l|) (GO #4=#:G485)))
                            (GO #5=#:G483))))))
...
(SDEFUN |INTPM;matchli| ((|f| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((#1=#:G497 NIL) (#2=#:G498 NIL) (|l| (|List| F)) (#3=#:G499 NIL)
                        ...
                        (EXIT
                         (COND
                          ((NULL
                           ...
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |l|) (GO #4=#:G496)))
                            (GO #5=#:G494))))))
                       (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                 #5# (EXIT #1#))
                (EXIT NIL)))
                  ...
                  (EXIT
                   (COND
                    ((OR (QEQCAR |u| 1)
                         (OR
                          (SPADCALL
                           (SPADCALL (LETT |p| (QCDR |u|)) (QREFELT $ 119)) 1
                           (QREFELT $ 120))
                          (NULL
                           (SPADCALL
                            (SPADCALL
        ...
        (SPROG
         ((|rec|
           (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                     (|:| |radicand| F))))
         (SEQ (LETT |rec| (SPADCALL |y| 2 (QREFELT $ 130)))
              (EXIT
               (COND
                ((EQL (QVELT |rec| 0) 1)
         ...
         (SEQ
          (COND
           ((SPADCALL (QCAR (LETT |rc| (SPADCALL |f| |x| (QREFELT $ 63))))
            ...
            (SEQ (LETT |u| (SPADCALL (QCDR |rc|) |x| (QREFELT $ 135)))
                 (EXIT
        ...
        (SPROG
         ...
         (SEQ
          (COND
           ((SPADCALL (QCAR (LETT |rc| (SPADCALL |f| |x| (QREFELT $ 63))))
                      (|spadConstant| $ 44) (QREFELT $ 132))
            (SEQ (LETT |u| (SPADCALL (QCDR |rc|) |x| (QREFELT $ 142)))
                 (EXIT
                  (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                        (#3='T
                         (SEQ (LETT |rec| (QCDR |u|))
...
(SDEFUN |INTPM;formula1|
        ...
        (SPROG
         ((#1=#:G554 NIL) (|mmi| (|Integer|)) (|mm| (F)) (#2=#:G558 NIL)
            ...
            (SEQ
             (EXIT
              (SEQ (LETT |mw| (|SPADfirst| |l|))
                   (COND
                    ((SPADCALL (LETT |ms| (SPADCALL |l| (QREFELT $ 138)))
                               (QREFELT $ 90))
                   ...
                   (LETT |mmi|
                         (SPADCALL (LETT |mm| (SPADCALL |l| (QREFELT $ 136)))
                                   (QREFELT $ 143)))
                   (EXIT
                    (CONS 0
                          (SPADCALL
...
(DEFUN |PatternMatchIntegration| (&REST #1=#:G583)
  (SPROG NIL
         (PROG (#2=#:G584)
           (RETURN
            (COND
...
(MAKEPROP '|PatternMatchIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) (|Symbol|)
              ...
              (|Union| 133 '#3="failed") (348 . |pmintegrate|) (354 . |second|)
              ...
              (|Union| 7 '#4="failed") (451 . |pmintegrate|))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 159
                                            '(0 8 0 9 1 8 0 0 11 1 7 0 8 18 1
                                              ...
                                              117 1 118 77 0 119 2 77 24 0 0
                                              120 2 118 7 0 77 121 1 118 7 0
                                              122 2 129 128 7 77 130 2 77 24 0
                                              0 131 2 7 24 0 0 132 2 0 134 7 8
                                              135 1 105 7 0 136 1 7 0 0 137 1
                                              105 7 0 138 1 7 0 0 139 1 7 0 0
                                              140 1 7 0 0 141 2 0 134 7 8 142 1
                                              7 37 0 143 1 105 7 0 144 2 7 0 37
                                              0 145 1 7 0 0 146 3 7 0 0 8 77
                                              147 1 75 0 8 148 3 7 0 0 149 150
                                              151 1 153 152 0 154 1 153 7 0 155
                                              1 19 7 7 156 2 7 24 0 8 157 4 0
                                              158 7 8 153 153 159 2 0 62 7 8 63
                                              2 2 134 7 8 135 4 1 158 7 8 153
                                              153 159 2 2 134 7 8 142)))))
           '|lookupComplete|)) 
