                       ...
                       (COND
                        ...
                        (#2#
                         (SEQ
                          (EXIT
                           (SEQ
                            (SEQ (LETT |rx| (SPADCALL |x| (QREFELT $ 61)))
                                 (EXIT
                                  (COND
                                   ((QEQCAR |rx| 0)
...
(SDEFUN |AF;UP2R|
        ...
        (SPROG
         ((|ans| (|SparseUnivariatePolynomial| R)) (#1=#:G492 NIL)
          (|r| (|Union| R "failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| (|spadConstant| $ 66))
                (SEQ G190
                     (COND
                      ((NULL
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |r| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G491)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
                                          (SPADCALL (QCDR |r|)
                                                    ...
                                                    (QREFELT $ 71))
                                          (QREFELT $ 72)))
                          (EXIT (LETT |p| (SPADCALL |p| (QREFELT $ 58)))))))))
...
(SDEFUN |AF;eqopalg| ((|k1| |Kernel| F) (|k2| |Kernel| F) ($ |Boolean|))
        (SPROG
         ...
         (SEQ (LETT |al1| (SPADCALL |k1| (QREFELT $ 73)))
              (LETT |al2| (SPADCALL |k2| (QREFELT $ 73)))
              (LETT |dv1|
                    (SPADCALL (SPADCALL |al1| 2 (QREFELT $ 75))
                              (QREFELT $ 42)))
              (LETT |dv2|
                    (SPADCALL (SPADCALL |al2| 2 (QREFELT $ 75))
                              (QREFELT $ 42)))
              (LETT |pe1| (SPADCALL |al1| 1 (QREFELT $ 75)))
              (LETT |pe2| (SPADCALL |al2| 1 (QREFELT $ 75)))
              (EXIT
               (COND
                 ...
                 (SEQ
                  ...
                  (LETT |p2|
                        (SPADCALL (SPADCALL |pe2| (QREFELT $ 79)) |dv2|
                                  (QREFELT $ 81)))
                  (LETT |lc1| (SPADCALL |p1| (QREFELT $ 83)))
                  (LETT |lc2| (SPADCALL |p2| (QREFELT $ 83)))
                  (EXIT
                   (COND
...
(SDEFUN |AF;root_sum1|
        ...
        (SPROG
         ((|nexpr| (|SparseUnivariatePolynomial| F)) (|res| (F))
          (#1=#:G519 NIL) (|i| NIL) (|xs| (|Symbol|)) (|a| (F))
          (|k| (|Kernel| F)))
         (SEQ
          (COND
           ((SPADCALL |expr| (|spadConstant| $ 54) (QREFELT $ 77))
            (|spadConstant| $ 54))
           (#2='T
            (SEQ (LETT |k| (SPADCALL |x| (QREFELT $ 42)))
                 (EXIT
                  (COND
...
(SDEFUN |AF;irootsum| ((|l| |List| F) ($ F))
        (SPROG ((|p| (|Fraction| (|SparseUnivariatePolynomial| F))) (|x| (F)))
               (SEQ
                (LETT |p|
                      (SPADCALL (LETT |p| (SPADCALL |l| 3 (QREFELT $ 75)))
                                (SPADCALL
                                 (LETT |x| (SPADCALL |l| 2 (QREFELT $ 75)))
                                 (QREFELT $ 42))
                                (QREFELT $ 33)))
                (EXIT
                 (COND
...
(SDEFUN |AF;dvrootsum| ((|l| |List| F) (|x| |Symbol|) ($ F))
        (SPROG
         ...
         (SEQ
          (LETT |dv|
                (SPADCALL (LETT |alpha| (SPADCALL |l| 2 (QREFELT $ 75)))
                          (QREFELT $ 42)))
          (LETT |dvs| (SPADCALL |alpha| (QREFELT $ 96)))
          (LETT |p|
                (SPADCALL
          ...
          (LETT |dalpha|
                (SPADCALL
                 (SPADCALL
                  ...
                  (QREFELT $ 50))
                 (QREFELT $ 51)))
          (LETT |expr| (SPADCALL |l| 1 (QREFELT $ 75)))
          (LETT |nexpr|
                (SPADCALL
...
(SDEFUN |AF;hackroot| ((|x| F) (|n| |Integer|) ($ F))
        (SPROG
         ((#1=#:G663 NIL) (|rx| (|Union| (|Integer|) "failed"))
          ...
          (EXIT
           (COND
            ...
            ('T
             (SEQ
              (COND
               ((SPADCALL (LETT |dx| (SPADCALL |x| (QREFELT $ 126)))
                          (|spadConstant| $ 118) (QREFELT $ 127))
                (SEQ (LETT |rx| (SPADCALL |dx| (QREFELT $ 129)))
                     (EXIT
                      (COND
                       ((QEQCAR |rx| 0)
                        (COND
...
(SDEFUN |AF;inroot| ((|l| |List| F) ($ F))
        (SPROG
         ((|r| (|Union| R "failed")) (#1=#:G671 NIL) (|x| (F))
          (|n| (|Integer|)))
         (SEQ
          (COND
           ((ZEROP
                    ...
                    (EXIT
                     (COND
                      ((OR (SPADCALL |x| (|spadConstant| $ 57) (QREFELT $ 77))
                           (EQL |n| 1))
                       (PROGN (LETT #1# |x|) (GO #3=#:G668))))))
               (LETT |r| (SPADCALL |x| (QREFELT $ 70)))
               (EXIT
                (COND
         ...
         ((#1=#:G673 NIL)
          (|rec|
           (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                     (|:| |radicand| F)))
          (#2=#:G682 NIL) (#3=#:G679 NIL) (#4=#:G675 NIL)
...
(SDEFUN |AF;iroot;RIF;23| ((|r| R) (|n| |Integer|) ($ F))
        (SPADCALL (SPADCALL |r| |n| (QREFELT $ 141)) (QREFELT $ 64))) 
...
(SDEFUN |AF;iroot;RIF;25| ((|r| R) (|n| |Integer|) ($ F))
        (COND
         ((OR (ODDP |n|)
              (NULL (SPADCALL |r| (|spadConstant| $ 39) (QREFELT $ 142))))
          (SPADCALL (SPADCALL |r| |n| (QREFELT $ 141)) (QREFELT $ 64)))
         ('T (|AF;hackroot| (SPADCALL |r| (QREFELT $ 64)) |n| $)))) 
...
(SDEFUN |AF;definingPolynomial;2F;29| ((|x| F) ($ F))
        (SPROG ((|k| (|Kernel| F)) (|r| (|Union| (|Kernel| F) "failed")))
               (SEQ (LETT |r| (SPADCALL |x| (QREFELT $ 145)))
                    (EXIT
                     (COND
                      ((QEQCAR |r| 0)
                       (COND
                        ...
                        ((SPADCALL |k| (QREFELT $ 14) (QREFELT $ 146))
                         (SPADCALL
                          ...
                          (QREFELT $ 147)))
                        (#1='T
                         (SPADCALL (QREFELT $ 113) |x| (QREFELT $ 147)))))
                      (#1# (SPADCALL (QREFELT $ 113) |x| (QREFELT $ 147)))))))) 

(SDEFUN |AF;minPoly;KSup;30|
        ((|k| |Kernel| F) ($ |SparseUnivariatePolynomial| F))
        (SPROG ((#1=#:G709 NIL))
               (COND
                ((SPADCALL |k| (QREFELT $ 13) (QREFELT $ 146))
                 (SPADCALL
...
(SDEFUN |AF;droot;LOf;31| ((|l| |List| F) ($ |OutputForm|))
        (SPROG ((|n| (F)) (|x| (|OutputForm|)))
               (SEQ (LETT |x| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 23)))
                    ...
                    (EXIT
                     (COND
                      ((SPADCALL |n| (SPADCALL 2 (QREFELT $ 122))
                                 (QREFELT $ 77))
...
(SDEFUN |AF;minPoly;KSup;32|
        ...
        (COND
         ...
         ('T
          (SPADCALL (SPADCALL (|spadConstant| $ 57) 1 (QREFELT $ 103))
                    (SPADCALL (SPADCALL |k| (QREFELT $ 30)) (QREFELT $ 149))
                    (QREFELT $ 150))))) 

(DECLAIM (NOTINLINE |AlgebraicFunction;|)) 

(DEFUN |AlgebraicFunction| (&REST #1=#:G722)
  (SPROG NIL
         (PROG (#2=#:G723)
           (RETURN
            (COND
  ...
  (SPROG ((|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
         (PROGN
          ...
          (COND
           ...
           ('T
            (PROGN
             (QSETREFV $ 117 (CONS (|dispatchFunction| |AF;droot;LOf;31|) $))
             (QSETREFV $ 151
...
(MAKEPROP '|AlgebraicFunction| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (484 . |qroot|) (|Union| $ '"failed") (490 . |exquo|)
              (496 . |nthRoot|) (502 . |smaller?|) (508 . |rroot|)
              (|Union| 29 '#1#) (514 . |retractIfCan|) (519 . |is?|) (525 . -)
              (531 . |definingPolynomial|) (536 . |coerce|) (541 . -)
              (547 . |minPoly|) (|List| 87) (552 . |derivative|))
           '#(|rootSum| 558 |rootOf| 565 |operator| 571 |minPoly| 576 |iroot|
