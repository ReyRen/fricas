        ...
        ((|m| |Matrix| (|Fraction| (|Polynomial| R)))
         ($ |List|
          (|Record|
           ...
           (|:| |eigvec| (|List| (|Matrix| (|Fraction| (|Polynomial| R))))))))
        (SPROG
         ((#1=#:G449 NIL) (|v| NIL) (#2=#:G448 NIL) (#3=#:G447 NIL) (|ri| NIL)
          (#4=#:G446 NIL)
          (|res1|
           (|List|
            (|Record|
         ...
         ($ |List|
          (|Record|
           ...
           (|:| |geneigvec|
                (|List| (|Matrix| (|Fraction| (|Polynomial| R))))))))
        (SPROG
         ((#1=#:G461 NIL) (|v| NIL) (#2=#:G460 NIL) (#3=#:G459 NIL) (|ri| NIL)
          (#4=#:G458 NIL)
          (|res1|
           (|List|
            (|Record|
