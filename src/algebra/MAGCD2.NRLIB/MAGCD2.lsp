...
(SDEFUN |MAGCD2;algebraicGcd1a|
        ((|x| MP) (|y| MP) (|mu| MD) (|vx| |Symbol|) (|lvz| |List| (|Symbol|))
         ($ |Union| MPT "failed"))
        (SPROG
         ((|yu| (MPT)) (|xu| (MPT)) (#1=#:G423 NIL) (|w1| (MPT))
...
(SDEFUN |MAGCD2;compare_coeff1|
        ...
        (SPROG
         ((#1=#:G429 NIL) (#2=#:G430 NIL) (#3=#:G431 NIL) (|i| NIL)
          (|nn| #4=(|Integer|)) (|ne| #4#))
         (SEQ
          (EXIT
...
(SDEFUN |MAGCD2;algebraicGcd2|
        ...
        (SPROG
         ((#9=#:G489 NIL)
          ...
          (|jl| (|Integer|)) (|ndl| #10=(|List| (|Integer|))) (#11=#:G495 NIL)
          ...
          (|gtf|
           (|Record| (|:| |nvars| (|Integer|))
                     ...
                     (|:| |expdata| (|SortedExponentVector|))
                     (|:| |coeffdata| (|U32Vector|))))
          (#12=#:G486 NIL) (|gtfp| #8#) (#13=#:G487 NIL) (|lcbad| (|Boolean|))
          (#14=#:G492 NIL) (|m| NIL) (#15=#:G493 NIL) (|deg| NIL)
          (#16=#:G494 NIL) (|z| NIL) (|lmt| (|List| MP)) (#17=#:G491 NIL)
          (#18=#:G490 NIL) (|yt| (MP)) (|xt| (MP)) (|lt| (|List| (|Integer|)))
...
(SDEFUN |MAGCD2;algebraicGcd3a|
        ((|x| MP) (|y| MP) (|lm| |List| MP) (|lv| |List| (|Symbol|))
         ...
         ($ |Polynomial| (|Integer|)))
        (SPROG
         ((#8=#:G533 NIL) (|res| (|Polynomial| (|Integer|)))
          (|pp| (|Union| (|PrimitiveArray| (|Integer|)) "failed"))
          (|coeffs| (|U32Vector|)) (|i| (|Integer|)) (|jl| (|Integer|))
          (|ndl| #9=(|List| (|Integer|))) (#10=#:G539 NIL) (|j| NIL)
          (|ncoeffs| (|U32Vector|)) (|n1| (|NonNegativeInteger|))
          (|nn| (|NonNegativeInteger|)) (|n0| (|NonNegativeInteger|))
          (|rstate| (|VectorIntegerReconstructor|)) (#11=#:G512 NIL)
          ...
          (|gtpp|
           (|Union|
            (|Record| (|:| |nvars| (|Integer|))
                      ...
                      (|:| |coeffdata| (|U32Vector|)))
            "failed"))
          (|lcbad| (|Boolean|)) (#12=#:G536 NIL) (|m| NIL) (#13=#:G537 NIL)
          (|deg| NIL) (#14=#:G538 NIL) (|z| NIL) (|lmp| (|List| MP))
          (#15=#:G535 NIL) (#16=#:G534 NIL) (|yp| (MP)) (|xp| (MP))
...
(SDEFUN |MAGCD2;algebraicGcd;2PTLLSLP;7|
        ((|x| PT) (|y| PT) (|lm| |List| PT) (|lv| |List| (|Symbol|))
         ...
         ($ |Polynomial| (|Integer|)))
        (SPROG
         ((|sval| (|List| (|Polynomial| (|Integer|)))) (#1=#:G564 NIL)
          (|v| NIL) (#2=#:G563 NIL) (|ress| (|Polynomial| (|Integer|)))
          (|pss|
          ...
          (|msize| (|Integer|)) (|ldeg| (|List| (|Integer|))) (#3=#:G561 NIL)
          (|m| NIL) (#4=#:G562 NIL) (|vz| NIL) (#5=#:G560 NIL)
          (|nlm| (|List| MP)) (#6=#:G559 NIL) (#7=#:G558 NIL) (|ny| (MP))
...
(DEFUN |ModularAlgebraicGcd2| (&REST #1=#:G565)
  (SPROG NIL
         (PROG (#2=#:G566)
           (RETURN
            (COND
