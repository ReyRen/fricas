...
(SDEFUN |SMITH;test1|
        ...
        (SPROG ((|km| #1#) (#2=#:G399 NIL) (|m0| (|Integer|)))
               (SEQ
                (EXIT
...
(SDEFUN |SMITH;test2|
        ((|sm| M) (|b| |Col|) (|n1| |NonNegativeInteger|) (|dk| |Integer|)
         ($ |Union| |Col| "failed"))
        (SPROG
         ((|sol| (|List| R)) (#1=#:G414 NIL) (|k| NIL) (#2=#:G412 NIL)
          (|c| (|Union| R "failed")) (#3=#:G413 NIL) (|m0| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |SMITH;isDiagonal?| ((|m| M) ($ |Boolean|))
        (SPROG
         ((#1=#:G420 NIL) (#2=#:G422 NIL) (|j| NIL) (#3=#:G421 NIL) (|i| NIL)
...
(SDEFUN |SMITH;ijDivide|
        ...
        (SPROG
         ((|rMat| (M)) (|lMat| (M)) (|mjj| (R)) (#1=#:G439 NIL) (|mii| (R))
          (|d| (R))
          (|extGcd|
...
(SDEFUN |SMITH;lastStep|
        ((|sf| |Record| (|:| |Smith| M) (|:| |leftEqMat| M)
         ...
         ($ |Record| (|:| |Smith| M) (|:| |leftEqMat| M) (|:| |rightEqMat| M)))
        (SPROG
         ((#1=#:G452 NIL) (#2=#:G454 NIL) (|j| NIL) (|mii| (R)) (#3=#:G453 NIL)
...
(SDEFUN |SMITH;findEqMat|
        ...
        (SPROG
         ((#1=#:G485 NIL) (|u1| (|Matrix| (|Fraction| R))) (#2=#:G467 NIL)
          (#3=#:G477 NIL) (#4=#:G476 (R)) (#5=#:G478 (R)) (#6=#:G496 NIL)
          (|k| NIL) (|j0| (|NonNegativeInteger|)) (|tjj| (R)) (#7=#:G495 NIL)
          (|j| (|NonNegativeInteger|)) (#8=#:G494 NIL) (|i| NIL) (|t11| (R))
          (|mm| (M)) (|t1| (M)) (|u| (M)) (|mmh| (M)) (#9=#:G491 NIL)
          (#10=#:G460 NIL) (#11=#:G459 #12=(|Boolean|)) (#13=#:G461 #12#)
          (#14=#:G493 NIL) (#15=#:G457 NIL) (#16=#:G456 #12#) (#17=#:G458 #12#)
          (#18=#:G492 NIL) (|n1| (|NonNegativeInteger|))
...
(SDEFUN |SMITH;diophantineSystem;MColR;18|
        ((|m| M) (|b| |Col|)
         ($ |Record| (|:| |particular| (|Union| |Col| "failed"))
          (|:| |basis| (|List| |Col|))))
        (SPROG
         ((|lsol| (|List| |Col|)) (#1=#:G525 NIL) (|i| NIL) (#2=#:G524 NIL)
...
(DEFUN |SmithNormalForm| (&REST #1=#:G526)
  (SPROG NIL
         (PROG (#2=#:G527)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 84
                                            '(1 9 10 0 11 3 9 6 0 10 10 12 1 6
                                              ...
                                              52 2 22 13 0 0 53 2 6 0 0 0 54 1
                                              55 0 6 56 2 59 57 58 9 60 1 55 6
                                              0 61 1 57 17 0 62 2 64 9 63 57 65
                                              2 71 69 69 70 72 1 0 9 9 73 2 71
                                              74 69 75 76 1 0 77 9 78 1 9 0 0
                                              79 2 9 0 0 0 80 2 9 8 0 8 81 1 0
                                              9 9 73 1 0 9 9 66 2 0 83 9 8 84 1
                                              0 77 9 78 1 0 67 9 68)))))
           '|lookupComplete|)) 
