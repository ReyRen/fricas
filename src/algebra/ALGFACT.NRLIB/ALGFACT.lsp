...
(SDEFUN |ALGFACT;allk|
        ...
        (SPROG ((#1=#:G391 NIL) (|x| NIL) (#2=#:G390 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |ALGFACT;split;UPF;7| ((|p| UP) ($ |Factored| UP))
        (SPROG
         ((#1=#:G399 NIL) (#2=#:G398 #3=(|Factored| UP)) (#4=#:G400 #3#)
          (#5=#:G403 NIL) (|fc| NIL) (|fp| (|Factored| UP)))
...
(SDEFUN |ALGFACT;fact|
        ((|p| UP) (|l| |List| #1=(|Kernel| (|AlgebraicNumber|)))
         ($ |Factored| UP))
        (SPROG
         ((#2=#:G434 NIL) (#3=#:G433 #4=(|Factored| UP)) (#5=#:G435 #4#)
          (#6=#:G443 NIL) (|fc| NIL) (|newalpha| (|AlgebraicNumber|))
          (|fr| (|Factored| |ups|))
          (|ups|
          ...
          (|alpha| #1#) (#8=#:G424 NIL) (#9=#:G423 #1#) (#10=#:G425 #1#)
          (#11=#:G442 NIL) (#12=#:G382 NIL) (#13=#:G420 NIL) (#14=#:G419 #4#)
          (#15=#:G421 #4#) (#16=#:G441 NIL) (|dc| NIL)
          (|dr|
           (|Factored|
                       ...
                       (CONS
                        '#((|Join|
                            (|mkCategory|
                             ...
                             (LIST) NIL NIL)))
                        (|makeByteWordVec2| 74
                                            '(1 8 7 0 9 1 11 0 10 12 1 11 0 0
                                              13 1 8 0 14 15 2 18 6 16 17 19 1
                                              8 14 0 20 2 22 17 21 6 23 1 6 24
                                              0 25 2 24 0 0 0 28 1 24 0 0 29 1
                                              26 6 0 31 1 26 34 0 35 2 26 0 0 0
                                              36 0 26 0 37 2 26 0 6 0 38 1 6 40
                                              0 41 2 26 0 6 40 42 0 6 0 43 0 8
                                              0 44 2 6 0 8 40 45 1 8 0 46 47 1
                                              6 0 8 48 2 6 0 0 0 49 2 6 50 0 0
                                              51 2 26 0 0 40 52 2 34 53 0 40 55
                                              1 57 56 17 58 1 56 17 0 59 1 56
                                              61 0 62 2 63 0 0 0 64 1 8 46 65
                                              66 2 63 53 0 0 67 2 11 0 68 0 69
                                              3 71 70 8 63 70 72 1 8 0 65 73 2
                                              70 8 0 8 74 1 0 26 6 39 1 0 26 6
