...
(SDEFUN |INTALG;algintexp|
        ...
        (SPROG
         ((|u|
          ...
          (#1=#:G463 NIL) (|i| NIL) (|vf| (|Vector| (|Fraction| UP)))
         ...
         ((|res|
          ...
          (|rr|
           (|List|
            (|Record| (|:| |factor| UP)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|nfac| (|Fraction| (|Integer|))) (#1=#:G485 NIL)
          (|nfac_ok| (|Boolean|)) (|ndu| #2=(|Union| (|Integer|) #3="failed"))
          (|nnu| #2#) (|facu| (|Union| (|Fraction| (|Integer|)) "failed"))
          (|fac| (F)) (|cp| (F)) (|p| (UP)) (#4=#:G501 NIL) (|f| NIL)
          (|n| #5=(|NonNegativeInteger|)) (|rp1| (UP)) (#6=#:G500 NIL)
               ...
               (EXIT
                (SEQ G190
                     ...
                     (SEQ (LETT |cp1| (SPADCALL |rp1| (QREFELT $ 68)))
                          ...
                          (COND
                           ((ODDP (- |k| |l|))
                            (PROGN (LETT #6# |$NoValue|) (GO #7=#:G480))))
...
(SDEFUN |INTALG;handle_multiples1|
        ...
        (SPROG
         ((|llg|
          ...
          (|nfac| #1#) (#4=#:G517 NIL) (|peq| NIL) (|alpha| (F)) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
          ...
          (|fu|
           (|Union|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))))
            "failed"))
          (|nfac| #2#) (#4=#:G540 NIL) (|peq| NIL) (|lp1| (|List| #1#))
          (#5=#:G539 NIL) (#6=#:G538 NIL)
          (|llg|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                      (|:| |coeff| (|SparseUnivariatePolynomial| R))
...
(SDEFUN |INTALG;get_coeffs0| ((|lp| |List| UP) ($ |List| F))
        (SPROG ((|res| (|List| F)) (#1=#:G544 NIL) (|p| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |INTALG;get_lf|
        ((|ll1| |List|
         ...
         ($ |List| UP))
        (SPROG
         ((#1=#:G582 NIL) (|peq| NIL) (#2=#:G581 NIL) (#3=#:G580 NIL)
          (#4=#:G579 NIL))
         ...
         (|ll2| |List|
          (|List|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
         ($ |List| F))
        (SPROG ((#1=#:G588 NIL) (|lfac| NIL) (#2=#:G587 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |lfac| NIL)
...
(SDEFUN |INTALG;get_ld|
        ...
        (SPROG
         ((#1=#:G604 NIL) (|peq| NIL) (#2=#:G603 NIL) (#3=#:G602 NIL) (|a| NIL)
          (#4=#:G601 NIL))
         (SEQ (COND ((NULL |ll1|) (COND ((NULL |ll2|) (EXIT NIL)))))
              (EXIT
               (COND
          ...
          (|nfl1|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))) (|:| |scalar| F)
                      (|:| |divisor| (|FiniteDivisor| F UP UPUP R)))))
          (#5=#:G690 NIL) (|nfl| NIL) (#6=#:G689 NIL) (#7=#:G688 NIL)
          (#8=#:G687 NIL)
          (|nlins2|
           (|List|
            (|List|
           ...
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                       ...
                       (|:| |logand| (|SparseUnivariatePolynomial| R))))
            "failed"))
          (#9=#:G686 NIL) (|nlins1| (|List| #4#)) (#10=#:G685 NIL)
          (#11=#:G684 NIL) (|nfacs2| (|List| #2#)) (|nfacs1| (|List| #4#))
          (|ppr|
           (|Record|
            (|:| |result1|
                 (|List|
...
(SDEFUN |INTALG;varRoot?| ((|p| UP) (|derivation| |Mapping| F F) ($ |Boolean|))
        (SPROG ((#1=#:G710 NIL) (#2=#:G711 NIL) (#3=#:G712 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |c| |derivation|)
                             ...
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G709)))
                              (GO #5=#:G707))))))
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G752 NIL)
          (#3=#:G751 #1#) (#4=#:G753 #1#) (#5=#:G763 NIL) (|a| NIL)
          (#6=#:G764 NIL) (|dv| NIL)
          (|cd|
...
(SDEFUN |INTALG;palgintegrate;RMIr;26|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((|difFirstKind| (R)) (#1=#:G825 NIL) (#2=#:G824 (R)) (#3=#:G826 (R))
          (#4=#:G833 NIL) (|lg| NIL) (#5=#:G832 NIL)
          (|u|
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
...
(SDEFUN |INTALG;algintegrate;RMIr;27|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((#1=#:G847 NIL) (|xx| (|Union| UP "failed")) (|x'| (UP)) (|x| (UP)))
         (SEQ
          (LETT |x'|
                (SPADCALL
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G852)
  (SPROG NIL
         (PROG (#2=#:G853)
           (RETURN
            (COND
