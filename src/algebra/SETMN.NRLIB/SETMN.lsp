...
(SDEFUN |SETMN;reallyEnumerate| (($ |Vector| $))
        (SPROG
         ((#1=#:G408 NIL) (|i| NIL) (#2=#:G410 NIL) (|b| NIL) (#3=#:G409 NIL))
         (SEQ
          (PROGN
           (LETT #3#
                 (GETREFV
...
(SDEFUN |SETMN;enum|
        ...
        (SPROG
         ((#1=#:G428 NIL) (|s| NIL) (|l| (|List| (|Bits|))) (#2=#:G421 NIL)
          (|q1| (|NonNegativeInteger|)) (#3=#:G420 NIL) (#4=#:G427 NIL)
          (|i| NIL) (|b| (|Bits|)))
         (SEQ
...
(SDEFUN |SETMN;setOfMinN;L$;10| ((|l| |List| (|PositiveInteger|)) ($ $))
        (SPROG
         ((|count| (|NonNegativeInteger|)) (#1=#:G449 NIL) (|i| NIL)
          (|s| (|Bits|)))
...
(SDEFUN |SETMN;incrementKthElement;$PiU;12|
        ...
        (SPROG
         ((#1=#:G464 NIL) (|newb| (|Bits|)) (|i| (|NonNegativeInteger|))
...
(DEFUN |SetOfMIntegersInOneToN| (&REST #1=#:G487)
  (SPROG NIL
         (PROG (#2=#:G488)
           (RETURN
            (COND
