...
(SDEFUN |ODERTRIC;logDerOnly|
        ((|l| |LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP))
         ($ |List| (|Fraction| UP)))
        (SPROG ((#1=#:G397 NIL) (|s| NIL) (#2=#:G396 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |s| NIL)
...
(SDEFUN |ODERTRIC;FifCan|
        ...
        (SPROG ((#2=#:G416 NIL) (|d| #3=(|Union| F "failed")) (|n| #3#))
               (SEQ
                (COND
                 ((QEQCAR
                   (LETT |n|
...
(SDEFUN |ODERTRIC;ratsln|
        ((|l| |List| (|Equation| (|Fraction| (|Polynomial| F))))
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|ls| (|List| (|Symbol|))) (|lv| (|List| F)) (#1=#:G444 NIL)
          (#2=#:G445 NIL) (|v| (|Union| (|Symbol|) "failed"))
          (|u| (|Union| F "failed")) (#3=#:G446 NIL) (|eq| NIL))
         (SEQ
          (EXIT
                       ...
                       (|:| |eq|
                            (|LinearOrdinaryDifferentialOperator2| UP
                                                                   (|Fraction|
                                                                    UP))))))
        (SPROG
         ((|ans| (|List| #1#)) (|p| (UP)) (#2=#:G480 NIL) (|a| NIL)
          (#3=#:G479 NIL) (|rec| NIL)
          (|lc|
           (|List|
...
(SDEFUN |ODERTRIC;reverseUP|
        ...
        (SPROG
         ((|ans| (|UnivariateTaylorSeries| F |dummy| (|Zero|))) (#1=#:G481 NIL)
          (|n| (|Integer|)))
...
(SDEFUN |ODERTRIC;reverseUTS|
        ...
        (SPROG
         ((#1=#:G487 NIL) (#2=#:G486 (UP)) (#3=#:G488 (UP)) (#4=#:G489 NIL)
          (#5=#:G491 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ODERTRIC;newtonSolution|
        ((|l| . #1=(|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         ...
         ($ UP))
        (SPROG
         ((|sols| (|List| UP)) (#2=#:G514 NIL) (|sol| NIL) (#3=#:G513 NIL)
          ...
          (|s| (|UnivariateTaylorSeries| F |dummy| (|Zero|))) (#4=#:G501 NIL)
         ...
         (SEQ (LETT |m| 0) (LETT |aeq| (|spadConstant| $ 92)) (LETT |op| |l|)
              (SEQ G190
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (COND
                      ((SPADCALL |mu| |m| (QREFELT $ 99)) (LETT |m| |mu|)))))
                   NIL (GO G190) G191 (EXIT NIL))
              (SEQ G190
                   (COND
...
(SDEFUN |ODERTRIC;newtonSolve|
        ((|eq| |SparseUnivariatePolynomial|
         ...
         ($ |Union| (|UnivariateTaylorSeries| F |dummy| (|Zero|)) "failed"))
        (SPROG
         ((|sol| (|UnivariateTaylorSeries| F |dummy| (|Zero|))) (#1=#:G522 NIL)
          (|xquo|
           (|Union| (|UnivariateTaylorSeries| F |dummy| (|Zero|)) "failed"))
          (#2=#:G523 NIL) (|i| NIL)
          (|deq|
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |deq| (SPADCALL |eq| (QREFELT $ 105)))
                (LETT |sol| (SPADCALL |a| (QREFELT $ 106)))
                (SEQ (LETT |i| 1) (LETT #2# |n|) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |xquo| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #3=#:G521)))
                        ('T
                         (LETT |sol|
                               (SPADCALL
                                (SPADCALL |sol| (QCDR |xquo|) (QREFELT $ 110))
                                |i| (QREFELT $ 111)))))))
                     (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                (EXIT (CONS 0 |sol|))))
          #3# (EXIT #1#)))) 
...
(SDEFUN |ODERTRIC;ricDsolve;LodoMML;17|
        ((|l| |LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP))
         ...
         (|ezfactor| |Mapping| (|Factored| UP) UP) ($ |List| (|Fraction| UP)))
        (SPROG
         ((#1=#:G533 NIL) (#2=#:G534 NIL) (|ans| (|List| (|Fraction| UP)))
          (#3=#:G537 NIL) (|f| NIL) (#4=#:G536 NIL) (#5=#:G535 NIL) (|rec| NIL)
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |ans|) (GO #6=#:G532)))
                            (GO #7=#:G529)))))))
                      #7# (EXIT #1#))
...
(SDEFUN |ODERTRIC;nonSingSolve|
        ((|n| |NonNegativeInteger|)
         ...
         (|zeros| |Mapping| (|List| F) UP) ($ |List| (|Fraction| UP)))
        (SPROG
         ((#1=#:G548 NIL) (#2=#:G549 NIL) (|ans| (|List| (|Fraction| UP)))
          (#3=#:G550 NIL) (|rec| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| NIL)
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |ans|) (GO #4=#:G547)))
                            (GO #5=#:G544)))))))
                      #5# (EXIT #1#))
                     (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL))
                (EXIT |ans|)))
...
(SDEFUN |ODERTRIC;nopoly|
        ((|n| |NonNegativeInteger|) (|p| UP)
         ...
         (|zeros| |Mapping| (|List| F) UP) ($ |List| (|Fraction| UP)))
        (SPROG
         ((#1=#:G561 NIL) (#2=#:G562 NIL) (|ans| (|List| (|Fraction| UP)))
          (#3=#:G565 NIL) (|f| NIL) (#4=#:G564 NIL) (#5=#:G563 NIL)
          (|rec| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| NIL)
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |ans|) (GO #6=#:G560)))
                            (GO #7=#:G557)))))))
                      #7# (EXIT #1#))
                     (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
                (EXIT |ans|)))
                ...
                (LETT |unk|
                      (SPADCALL |unk|
                                (SPADCALL
                                 ...
                                 (QREFELT $ 126))
                                (QREFELT $ 65)))
                (EXIT (LETT |h| (SPADCALL |h| (QREFELT $ 127)))))
               NIL (GO G190) G191 (EXIT NIL))
          (LETT |sol|
                (|ODERTRIC;ratsol|
                 (SPADCALL
...
(SDEFUN |ODERTRIC;zro|
        ...
        (SPROG ((#1=#:G593 NIL) (|r| NIL) (#2=#:G592 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |RationalRicDE| (&REST #1=#:G597)
  (SPROG NIL
         (PROG (#2=#:G598)
           (RETURN
            (COND
