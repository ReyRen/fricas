...
(SDEFUN |LGROBP;reduceRow|
        ...
        (SPROG
         ((|a1| (F)) (#1=#:G393 NIL) (#2=#:G403 NIL) (|kk| NIL) (#3=#:G402 NIL)
          (|vk| (F)) (|b| (F)) (|k| (|Integer|)) (|mj| (|Vector| F))
          (#4=#:G401 NIL) (|j| NIL) (|dim| (|NonNegativeInteger|)))
...
(SDEFUN |LGROBP;totolex;LL;3|
        ...
        (SPROG
         ((|nBasis| (|List| #1=(|DistributedMultivariatePolynomial| |lv| F)))
          ...
          (#3=#:G426 NIL) (#4=#:G425 #2#) (#5=#:G427 #2#) (#6=#:G437 NIL)
          (|c| NIL) (#7=#:G438 NIL) (|b| NIL) (|cordlist| (|List| F))
          (#8=#:G436 NIL) (|k| NIL) (#9=#:G435 NIL)
          (|j| #10=(|NonNegativeInteger|)) (|lm| (|Vector| F)) (#11=#:G434 NIL)
          (|orecfmon|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (|ofirstmon| #1#) (|veccoef| (|Vector| F)) (#12=#:G418 NIL)
          (#13=#:G415 NIL) (|cc| (F))
          (|recfmon|
           (|Record|
            (|:| |poly|
...
(SDEFUN |LGROBP;minPol;2LOvlHdmp;5|
        ...
        (SPROG
         ((#1=#:G458 NIL)
          ...
          (#2=#:G451 NIL) (#3=#:G461 NIL) (|k| NIL)
          (|j| (|NonNegativeInteger|)) (|lm| (|Vector| F)) (#4=#:G460 NIL)
          (|veccoef| (|Vector| F)) (|omult| (F)) (#5=#:G446 NIL)
          (|f| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#6=#:G443 NIL) (|cc| (F))
          (|recf|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (#7=#:G459 NIL) (|i| NIL) (|pivots| (|Vector| (|Integer|)))
          (|linmat| (|Matrix| F)) (|ndim1| (|NonNegativeInteger|))
          (|ndim| (|PositiveInteger|)) (#8=#:G441 NIL)
...
(SDEFUN |LGROBP;anticoord;LDmpLDmp;10|
        ...
        (SPROG ((#1=#:G487 NIL) (|f| NIL) (#2=#:G488 NIL) (|c| NIL))
               (SEQ
...
(SDEFUN |LGROBP;choosemon;DmpLDmp;11|
        ((|mf| |DistributedMultivariatePolynomial| |lv| F)
         ...
         ($ |DistributedMultivariatePolynomial| |lv| F))
        (SPROG
         ((#1=#:G492 NIL) (|dx| (|NonNegativeInteger|)) (#2=#:G498 NIL)
          (|xx| (|DistributedMultivariatePolynomial| |lv| F)) (#3=#:G499 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |LGROBP;linGenPos;LR;12|
        ...
        (SPROG
         ((|nBasis| (|List| #1=(|DistributedMultivariatePolynomial| |lv| F)))
          ...
          (|result| (|List| (|DistributedMultivariatePolynomial| |lv| F)))
          (|antc| #2=(|DistributedMultivariatePolynomial| |lv| F))
          (#3=#:G524 NIL) (#4=#:G523 #2#) (#5=#:G525 #2#) (#6=#:G539 NIL)
          (|c| (|Integer|)) (#7=#:G540 NIL) (|b| NIL) (|cordlist| (|List| F))
          (#8=#:G538 NIL) (|j| (|NonNegativeInteger|)) (#9=#:G537 NIL)
          (|lm| (|Vector| F)) (#10=#:G536 NIL)
          (|orecfmon|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (|ofirstmon| #1#) (|veccoef| (|Vector| F)) (#11=#:G517 NIL)
          (#12=#:G514 NIL) (|cc| (F))
          (|recfmon|
           (|Record|
            (|:| |poly|
          ...
          (#13=#:G506 NIL)
          (#14=#:G505 #15=(|DistributedMultivariatePolynomial| |lv| F))
          (#16=#:G507 #15#) (#17=#:G534 NIL) (|r| NIL) (#18=#:G535 NIL)
          (|vv| NIL) (|rval| (|List| (|Integer|))) (#19=#:G533 NIL) (|ii| NIL)
...
(SDEFUN |LGROBP;groebgen;LR;13|
        ...
        (SPROG
         ((LL (|List| (|DistributedMultivariatePolynomial| |lv| F)))
          (#1=#:G555 NIL) (|f| NIL) (#2=#:G554 NIL)
          (|val| (|DistributedMultivariatePolynomial| |lv| F)) (#3=#:G545 NIL)
          (#4=#:G544 #5=(|DistributedMultivariatePolynomial| |lv| F))
          (#6=#:G546 #5#) (#7=#:G553 NIL) (|i| NIL) (|ll| (|List| (|Integer|)))
          (#8=#:G552 NIL) (#9=#:G551 NIL) (|nvar1| (|NonNegativeInteger|))
          (#10=#:G542 NIL) (|xn| (|OrderedVariableList| |lv|)))
...
(DEFUN |LinGroebnerPackage| (&REST #1=#:G558)
  (SPROG NIL
         (PROG (#2=#:G559)
           (RETURN
            (COND
...
(DEFUN |LinGroebnerPackage;| (|#1| |#2|)
  (SPROG
   ((#1=#:G389 NIL) (#2=#:G557 NIL) (|yx| NIL) (#3=#:G556 NIL) (|pv$| NIL)
