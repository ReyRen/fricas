...
(SDEFUN |NFINTBAS;frobMatrix|
        ((|rb| |Matrix| (|Integer|)) (|rbinv| |Matrix| (|Integer|))
         ...
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G397 NIL) (|mat| (|Matrix| (|Integer|))) (|a| (F))
          (#2=#:G403 NIL) (|j| NIL) (#3=#:G404 NIL) (|jj| NIL) (#4=#:G401 NIL)
          (|i| NIL) (#5=#:G402 NIL) (|ii| NIL) (|v| (|Vector| F))
...
(SDEFUN |NFINTBAS;wildPrimes|
        ((|factoredDisc| |Factored| (|Integer|)) (|n| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG ((|ans| (|List| (|Integer|))) (#1=#:G411 NIL) (|f| NIL))
               (SEQ (LETT |ans| NIL)
                    (SEQ (LETT |f| NIL)
...
(SDEFUN |NFINTBAS;tameProduct|
        ...
        (SPROG ((|ans| (|Integer|)) (#1=#:G418 NIL) (|f| NIL))
               (SEQ (LETT |ans| 1)
                    (SEQ (LETT |f| NIL)
                         (LETT #1# (SPADCALL |factoredDisc| (QREFELT $ 33)))
                         G190
...
(SDEFUN |NFINTBAS;integralBasis;R;4|
        ...
        (SPROG
         ((|runningRbinv| #1=(|Matrix| (|Integer|))) (|runningRb| #1#)
          ...
          (#6=#:G430 NIL) (|p| NIL) (|matrixOut| #1#) (|sing| (|Integer|))
          (|wilds| (|List| (|Integer|)))
...
(SDEFUN |NFINTBAS;iTameLocalIntegralBasis|
        ((|traceMat| . #1=(|Matrix| (|Integer|))) (|disc| . #2=(|Integer|))
         ...
         ($ |Record| (|:| |basis| (|Matrix| (|Integer|)))
          ...
          (|:| |discr| (|Integer|))))
        (SPROG
         ((|tfm| #1#) (#3=#:G441 NIL) (#4=#:G448 NIL) (|oldIndex| (|Integer|))
...
(SDEFUN |NFINTBAS;discriminant;I;8| (($ |Integer|))
        (SPROG
         ((#1=#:G496 NIL) (|index| (|Integer|)) (|rbden| #2=(|Integer|))
          (|rb| #3=(|Matrix| (|Integer|)))
          (|intBas|
...
(DEFUN |NumberFieldIntegralBasis| (&REST #1=#:G500)
  (SPROG NIL
         (PROG (#2=#:G501)
           (RETURN
            (COND
