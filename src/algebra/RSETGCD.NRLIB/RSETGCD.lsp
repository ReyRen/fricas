...
(SDEFUN |RSETGCD;toseInvertible?;PTSB;5| ((|p| P) (|ts| TS) ($ |Boolean|))
        (SPROG
         ((#1=#:G462 NIL) (#2=#:G464 NIL) (|g| (P)) (#3=#:G466 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v-| (TS)) (|ts_v| (P)) (#4=#:G452 NIL) (#5=#:G463 NIL)
          (#6=#:G465 NIL) (|bwt| NIL)
          (|toCheck|
...
(SDEFUN |RSETGCD;toseInvertible?;PTSL;6|
        ...
        (SPROG
         ((|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (#1=#:G497 NIL) (|bwt| NIL) (#2=#:G496 NIL)
          (|inv|
           #3=(|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|ts_h| (TS)) (|h| (P)) (|ts_g| (TS)) (|g| (P)) (#4=#:G495 NIL)
          (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#5=#:G474 NIL)
          (#6=#:G493 NIL) (|newq| (P)) (#7=#:G494 NIL) (|toCheck| #3#)
          (|v| (V)) (|q| (P)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RSETGCD;toseInvertibleSet;PTSL;7| ((|p| P) (|ts| TS) ($ |List| TS))
        (SPROG
         ((|toSave| (|List| TS)) (|inv| (|List| TS)) (|ts_h| (TS)) (|h| (P))
          (|g| (P)) (#1=#:G527 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#2=#:G509 NIL)
          (#3=#:G525 NIL) (|newq| (P)) (#4=#:G526 NIL) (|bwt| NIL)
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
...
(SDEFUN |RSETGCD;toseSquareFreePart_wip|
        ...
        (SPROG
         ((|lpwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|sfp| (P)) (|g| (P)) (|us| (TS)) (#1=#:G536 NIL) (|gwt| NIL)
...
(SDEFUN |RSETGCD;prepareSubResAlgo;2PTSL;11|
        ...
        (SPROG
         ((|toSee| (|List| #1#))
          ...
          (|newp2| (P)) (|s| (P)) (#2=#:G543 NIL) (|p3| (P)) (#3=#:G556 NIL)
          (|bwt| NIL)
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
                              ...
                              (SEQ
                               (COND
                                ((|BooleanEquality| (QCAR |bwt|) 'T)
                                 (COND
                                  ((SPADCALL (SPADCALL |p2| |v| (QREFELT $ 85))
                                             0 (QREFELT $ 86))
                                   (EXIT
                                    (SEQ
                                     (LETT |p3|
...
(SDEFUN |RSETGCD;integralLastSubResultant;2PTSL;12|
        ...
        (SPROG ((|ex| (|Union| P "failed")) (|gi1i2| (P)) (|lsr| (P)))
               (SEQ (LETT |lsr| (SPADCALL |p1| |p2| (QREFELT $ 95)))
                    (EXIT
                     (COND
...
(SDEFUN |RSETGCD;internalLastSubResultant;2PTS2BL;13|
        ...
        (SPROG
         ((|toSave| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          ...
          (|s| (P)) (#1=#:G571 NIL) (|p3| (P)) (#2=#:G577 NIL)
          (|e|
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |k| (VECTOR |p1| |p2| |ts| |b2|))
                (LETT |e| (SPADCALL |k| (QREFELT $ 102)))
                (EXIT
                 (COND ((QEQCAR |e| 0) (QCDR |e|))
                       ((SPADCALL |ts| (QREFELT $ 103))
                        (SEQ
                         (LETT |toSave|
                               (SPADCALL |p1| |p2| |ts| (QREFELT $ 100)))
                         (SPADCALL |k| |toSave| (QREFELT $ 104))
                         (EXIT (PROGN (LETT #2# |toSave|) (GO #3=#:G576)))))
                       (#4='T
                        (SEQ
                         (COND
                          (|b1|
...
(SDEFUN |RSETGCD;internalLastSubResultant;LVBL;14|
        ...
        (SPROG
         ((#1=#:G601 NIL)
          ...
          (#2=#:G600 NIL) (|p3| (P)) (|delta| (|NonNegativeInteger|))
          (#3=#:G587 NIL)
          (|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#4=#:G597 NIL) (#5=#:G599 NIL) (|bwt| NIL)
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|ts| (TS)) (#6=#:G598 NIL))
         (SEQ
          (EXIT
...
(DEFUN |RegularTriangularSetGcdPackage| (&REST #1=#:G615)
  (SPROG NIL
         (PROG (#2=#:G616)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 111
                                            '(0 14 11 15 2 14 11 16 16 17 1 14
                                              ...
                                              2 9 76 0 8 85 2 82 21 0 0 86 1 9
                                              0 0 87 2 9 0 0 0 88 2 9 0 0 76 89
                                              0 9 0 90 0 9 0 91 2 9 0 0 0 95 2
                                              9 0 0 0 96 2 9 0 0 0 97 2 9 98 0
                                              0 99 1 14 101 12 102 1 10 21 0
                                              103 2 14 11 12 48 104 1 82 21 0
                                              106 4 9 0 0 0 0 76 107 4 9 0 0 0
                                              0 0 108 2 10 21 9 0 109 2 10 21 9
                                              0 110 2 0 48 9 10 81 3 0 48 9 9
                                              10 111 2 0 69 9 10 70 2 0 43 9 10
                                              44 2 0 21 9 10 52 0 0 11 35 0 0
                                              11 25 3 0 11 16 16 16 31 3 0 11
                                              16 16 16 20 3 0 93 9 9 10 94 5 0
                                              48 9 9 10 21 21 49 3 0 48 93 8 21
