...
(SDEFUN |XPR;coef;$ER;6| ((|p| $) (|e| E) ($ R))
        (SPROG ((#1=#:G416 NIL) (#2=#:G417 NIL) (#3=#:G418 NIL) (|tm| NIL))
               (SEQ
                (EXIT
                 (SEQ
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (QCAR |tm|) |e| (QREFELT $ 21))
                           (PROGN (LETT #2# (QCDR |tm|)) (GO #4=#:G415)))
                          ('T
                           (SEQ
                            (EXIT
                             (COND
...
(SDEFUN |XPR;quasiRegular;2$;10| ((|p| $) ($ $))
        (SPROG ((#1=#:G430 NIL) (|t| NIL) (#2=#:G429 NIL))
               (SEQ
...
(SDEFUN |XPR;*;3$;14| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((#1=#:G448 NIL) (#2=#:G447 ($)) (#3=#:G449 ($)) (#4=#:G457 NIL)
          (|t2| NIL) (#5=#:G456 NIL) (#6=#:G455 NIL) (|t1| NIL))
         (SEQ
...
(SDEFUN |XPR;*;3$;15| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((#1=#:G460 NIL) (#2=#:G459 ($)) (#3=#:G461 ($)) (|r| (R))
          (#4=#:G470 NIL) (|t2| NIL) (#5=#:G469 NIL) (#6=#:G468 NIL)
          (|t1| NIL))
         (SEQ
          (COND ((OR (NULL |p1|) (NULL |p2|)) (|spadConstant| $ 25))
                ((SPADCALL (QCAR (|SPADfirst| |p1|)) (|spadConstant| $ 9)
...
(SDEFUN |XPR;coerce;$Of;19| ((|a| $) ($ |OutputForm|))
        (SPROG ((#1=#:G484 NIL) (|t| NIL) (#2=#:G483 NIL))
               (SEQ
                (COND
...
(DEFUN |XPolynomialRing| (&REST #1=#:G494)
  (SPROG NIL
         (PROG (#2=#:G495)
           (RETURN
            (COND
...
(DEFUN |XPolynomialRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G493 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
