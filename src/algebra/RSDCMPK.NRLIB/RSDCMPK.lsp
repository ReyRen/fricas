...
(SDEFUN |RSDCMPK;numberOfVariables;LLNni;2|
        ((|lp| |List| P) (|lts| |List| TS) ($ |NonNegativeInteger|))
        (SPROG ((|lv| (|List| V)) (#1=#:G437 NIL) (|ts| NIL))
               (SEQ
                (LETT |lv|
...
(SDEFUN |RSDCMPK;algebraicDecompose;PTSBR;3|
        ...
        (SPROG
         ((|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#1=#:G462 NIL) (|vs| NIL) (#2=#:G461 NIL) (|f| NIL)
          (|lus| (|List| TS)) (|lsfp| (|List| P)) (|b| (|Boolean|)) (|h| (P))
          (|lts| (|List| TS)) (|us| (TS)) (|g| (P)) (#3=#:G460 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v| (P)) (#4=#:G440 NIL) (|ts_v+| (TS)) (|ts_v-| (TS))
...
(SDEFUN |RSDCMPK;printInfo;LNniV;11|
        ...
        (SPROG
         ((|s| (|String|)) (|m| (|NonNegativeInteger|)) (#1=#:G531 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
...
(SDEFUN |RSDCMPK;decompose;LL5BL;12|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (|bound| (|NonNegativeInteger|)) (#1=#:G550 NIL) (|br| NIL)
          (#2=#:G549 NIL)
          (|branches|
           (|List|
...
(SDEFUN |RSDCMPK;upDateBranches;LLLRNniL;13|
        ...
        (SPROG
         ((|branches|
          ...
          (#2=#:G570 NIL) (|us| (TS)) (|branches1| (|List| #1#))
          (|newleq| (|List| P)) (#3=#:G569 NIL) (|branch| NIL)
...
(DEFUN |RegularSetDecompositionPackage| (&REST #1=#:G571)
  (SPROG NIL
         (PROG (#2=#:G572)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 105
                                            '(1 10 11 0 12 2 11 0 0 0 13 2 15
                                              ...
                                              2 10 93 9 0 94 1 90 18 18 96 2 11
                                              28 0 0 97 2 10 28 0 0 98 2 9 28 0
                                              0 99 2 17 0 0 0 100 2 17 0 101 0
                                              102 2 90 28 10 18 103 1 72 0 43
                                              104 1 90 72 72 105 5 0 72 17 18
