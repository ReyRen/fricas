...
(SDEFUN |CKP;displayCartan|
        ...
        (SPROG ((#1=#:G431 NIL) (|cc| NIL) (#2=#:G430 NIL))
               (SEQ
...
(SDEFUN |CKP;stirling;4Nni;11|
        ...
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G462 NIL) (#2=#:G461 NIL)
          (#3=#:G460 NIL) (#4=#:G472 NIL) (|j| NIL) (#5=#:G471 NIL)
          (#6=#:G470 NIL) (#7=#:G469 NIL)
...
(SDEFUN |CKP;alpha;Nni2L;12|
        ...
        (SPROG
         ((#1=#:G473 NIL) (#2=#:G477 NIL) (|bi| NIL) (#3=#:G478 NIL) (|i| NIL)
          (#4=#:G476 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |CKP;hilbert;LSup;13|
        ...
        (SPROG
         ((|ifac| #1=(|Integer|))
          ...
          (|coeff| (|Fraction| (|Integer|))) (#2=#:G479 NIL) (|kfac| #1#)
          (#3=#:G487 NIL) (|k| NIL) (#4=#:G486 NIL) (|i| NIL))
...
(SDEFUN |CKP;alphaHilbert;SupL;14|
        ((|hilp| |SparseUnivariatePolynomial| (|Fraction| (|Integer|)))
         ($ |List| (|NonNegativeInteger|)))
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G596 NIL)
          (|ai| (|Integer|)) (#2=#:G594 NIL) (|kfac| #3=(|Integer|))
          (|sum| (|Fraction| (|Integer|))) (#4=#:G491 NIL) (#5=#:G490 NIL)
          (#6=#:G601 NIL) (|k| NIL) (|ifac| #3#) (|i| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |CKP;arbFunctions;NniILL;15|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G639 NIL) (#2=#:G638 NIL) (#3=#:G629 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#4=#:G602 NIL) (#5=#:G646 NIL)
...
(SDEFUN |CKP;gauge;NniILL;16|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G666 NIL) (#2=#:G665 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#3=#:G656 NIL) (#4=#:G676 NIL)
          (|k| NIL) (|ifac| (|Integer|)) (#5=#:G654 NIL) (#6=#:G653 NIL)
          (#7=#:G674 NIL) (|l| NIL) (#8=#:G675 NIL) (|g| NIL) (|i| NIL)
...
(SDEFUN |CKP;gaugeHilbert;NniLSup;17|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|t| (|NonNegativeInteger|)) (#1=#:G678 NIL) (#2=#:G677 NIL)
          (#3=#:G686 NIL) (|l| NIL) (#4=#:G687 NIL) (|g| NIL) (#5=#:G685 NIL)
...
(SDEFUN |CKP;bound;4Nni;18|
        ...
        (SPROG
         ((#1=#:G692 NIL) (#2=#:G689 NIL) (|tmp| (|NonNegativeInteger|))
          (#3=#:G688 NIL))
         (SEQ
          (COND
           ((EQL |qq| 1)
...
(SDEFUN |CKP;complete2;JdeR;20|
        ...
        (SPROG
         ((|Cartan| (|List| (|NonNegativeInteger|)))
          ...
          (#4=#:G717 NIL) (|ProjDe| (|JetDifferentialEquation| JB D))
          ...
          (#7=#:G704 NIL) (#8=#:G702 NIL) (#9=#:G726 NIL)
          (|solved?| (|Boolean|)))
...
(DEFUN |CartanKuranishi| (&REST #1=#:G727)
  (SPROG NIL
         (PROG (#2=#:G728)
           (RETURN
            (COND
