...
(SDEFUN |JCT;transform;JB1Jbe;4| ((|jv| JB1) ($ |JetBundleExpression| JB2))
        (SPROG
         ((|res| (|JetBundleExpression| JB2)) (#1=#:G415 NIL) (#2=#:G421 NIL)
          (#3=#:G423 NIL) (|k| NIL) (#4=#:G422 NIL)
          (|qint| (|JetBundleExpression| JB2)) (|pint| (JB1)) (#5=#:G405 NIL)
...
(SDEFUN |JCT;transform;JbeJbe;5|
        ...
        (SPROG
         ((|e2| (|JetBundleExpression| JB2)) (#1=#:G430 NIL) (|jv| NIL)
          (#2=#:G431 NIL) (|je| NIL) (JE (|List| (|JetBundleExpression| JB2)))
          (#3=#:G429 NIL) (#4=#:G428 NIL) (JV (|List| JB1)))
...
(DEFUN |JetCoordinateTransformation| (&REST #1=#:G432)
  (SPROG NIL
         (PROG (#2=#:G433)
           (RETURN
            (COND
