...
(SDEFUN |MODMON;setPoly;2Rep;1| ((|mon| |Rep|) ($ |Rep|))
        (SPROG
         ((#1=#:G402 NIL) (|i| NIL) (#2=#:G391 NIL) (|copymon| (|Rep|))
          (|oldm| (|Rep|)))
         (SEQ
                 ...
                 (SEQ (LETT |oldm| (QREFELT $ 12))
                      (EXIT
                       (COND
                        ...
                        (#3#
                         (SEQ (LETT |copymon| (|spadConstant| $ 20))
                              (SEQ G190
                                   (COND
                                    ((NULL
                                      (NULL (SPADCALL |mon| (QREFELT $ 30))))
                                     (GO G191)))
                                   (SEQ
                                    (LETT |copymon|
                                          (SPADCALL
...
(SDEFUN |MODMON;random;$;4| (($ $))
        (SPROG ((#1=#:G408 NIL) (|i| NIL) (#2=#:G407 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
...
(SDEFUN |MODMON;*;3$;21| ((|x| $) (|y| $) ($ $))
        (SPROG ((|p| (|Rep|)) (|ans| ($)) (|n| (|Integer|)))
               (SEQ (LETT |p| (SPADCALL |x| |y| (QREFELT $ 73)))
                    (LETT |ans| (|spadConstant| $ 52))
                    (SEQ G190
                         (COND
                          ((NULL
                            (SPADCALL (LETT |n| (SPADCALL |p| (QREFELT $ 31)))
...
(SDEFUN |MODMON;UnVectorise;V$;23| ((|vect| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G435 NIL) (#2=#:G434 (|Rep|)) (#3=#:G436 (|Rep|))
          (#4=#:G438 NIL) (|i| NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |MODMON;computePowers;Pa;24| (($ |PrimitiveArray| $))
        (SPROG
         ((#1=#:G443 NIL) (|i| NIL) (|w| ($)) (|mat| (|PrimitiveArray| $)))
         (SEQ
          (LETT |mat|
...
(SDEFUN |MODMON;computeFrobeniusPowers| (($ |PrimitiveArray| $))
        (SPROG
         ((#1=#:G447 NIL) (|i| NIL) (|mult| ($)) (|mat| (|PrimitiveArray| $)))
         (SEQ
          (LETT |mat|
...
(SDEFUN |MODMON;frobenius;2$;26| ((|a| $) ($ $))
        (SPROG ((|aq| ($)))
               (SEQ (LETT |aq| (|spadConstant| $ 20))
                    (SEQ G190
                         (COND
                          ((NULL
                            (SPADCALL |a| (|spadConstant| $ 20)
                                      (QREFELT $ 79)))
                           (GO G191)))
                         (SEQ
                          (LETT |aq|
                                (SPADCALL |aq|
                                          (SPADCALL
                                           ...
                                           (QREFELT $ 55))
                                          (QREFELT $ 32)))
                          (EXIT (LETT |a| (SPADCALL |a| (QREFELT $ 33)))))
                         NIL (GO G190) G191 (EXIT NIL))
                    (EXIT |aq|)))) 
...
(SDEFUN |MODMON;monomial;RNni$;28| ((|c| R) (|e| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|k2| (|NonNegativeInteger|)) (#1=#:G453 NIL)
          ...
          (COND ((< |e| (QREFELT $ 14)) (SPADCALL |c| |e| (QREFELT $ 11)))
                ((SPADCALL |e| (QREFELT $ 18) (QREFELT $ 82))
                 (SPADCALL |c|
                           ...
                           (QREFELT $ 55)))
                ('T
                 (SEQ (LETT |k1| (QUOTIENT2 |e| (QREFELT $ 18)))
                      (LETT |k2|
                            (PROG1 (LETT #1# (- |e| (* |k1| (QREFELT $ 18))))
                              (|check_subtype2| (>= #1# 0)
                                                '(|NonNegativeInteger|)
                                                '(|Integer|) #1#)))
                      (EXIT
                       (SPADCALL
                        (SPADCALL
                         (SPADCALL
                          (SPADCALL (QREFELT $ 24) (QREFELT $ 15)
                                    (QREFELT $ 40))
                          |k1| (QREFELT $ 83))
...
(SDEFUN |MODMON;divide;2$R;31|
        ...
        (SPROG ((|q| (|Union| $ "failed")))
               (SEQ (LETT |q| (SPADCALL |x| |y| (QREFELT $ 87)))
                    (EXIT
...
(DEFUN |ModMonic| (|#1| |#2|)
  (SPROG
   ((#1=#:G387 NIL) (#2=#:G519 NIL) (|pv$| NIL) (#3=#:G514 NIL) (#4=#:G515 NIL)
    (#5=#:G516 NIL) (#6=#:G517 NIL) (#7=#:G518 NIL) ($ NIL) (|dv$| NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
