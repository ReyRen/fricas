...
(SDEFUN |NBLM;naiveBeckermannLabahn1;VVNniIM2ML;5|
        ...
        (SPROG
         ((|p| (|SparseUnivariatePolynomial| (|Integer|)))
          (|l| (|NonNegativeInteger|)) (|vk| (|U32Vector|)) (#1=#:G438 NIL)
          (|k| NIL) (|vpa| (|Vector| (|U32Vector|))) (#2=#:G437 NIL)
          (#3=#:G436 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (COND
           ((SPADCALL (LETT |m| (QVSIZE |vp|)) (QVSIZE |vn|) (QREFELT $ 28))
            (|error|
           ...
           ('T
            (SEQ
             ...
             (SEQ (LETT |k| 1) (LETT #1# |m|) G190
                  ...
                  (SEQ (LETT |p| (SPADCALL |vp| |k| (QREFELT $ 32)))
                       (LETT |vk| (SPADCALL |vpa| |k| (QREFELT $ 33)))
                       (EXIT
                        (SEQ G190
                             (COND
                              ((NULL (NULL (SPADCALL |p| (QREFELT $ 34))))
                               (GO G191)))
                             (SEQ (LETT |l| (SPADCALL |p| (QREFELT $ 35)))
                                  (COND
                                   ((< |l| |sigma|)
                                    (SETELT_U32 |vk| |l|
                                                (SPADCALL |p|
...
(SDEFUN |NBLM;naiveBeckermannLabahn1;VVNniIM2ML;6|
        ((|vpa| |Vector| (|U32Vector|)) (|vn| |Vector| (|Integer|))
         ...
         ($ |List| (|Any|)))
        (SPROG
         ((|vd| (|Vector| (|Integer|))) (#1=#:G456 NIL) (|k| NIL)
          (#2=#:G455 NIL) (|m2| (|Integer|)) (|vk| (|U32Vector|))
          (#3=#:G454 NIL) (|mp| (|Vector| (|U32Vector|))) (|m1| (|Integer|))
          (#4=#:G453 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (COND
           ((SPADCALL (LETT |m| (QVSIZE |vpa|)) (QVSIZE |vn|) (QREFELT $ 28))
            (|error|
             "Number of polynomials and number of degrees do not agree"))
           ('T
            (SEQ (LETT |m1| 0)
                 ...
                 (SEQ (LETT |k| 1) (LETT #3# |m|) G190
                      ...
                      (SEQ
                       ...
                       (LETT |vk| (SPADCALL |mp| |k| (QREFELT $ 33)))
                       (SETELT_U32 |vk| |m2| 1)
                       (EXIT
                        (LETT |m2|
                              (+ (+ |m2| (SPADCALL |vn| |k| (QREFELT $ 38)))
                                 1))))
                      (LETT |k| (|inc_SI| |k|)) (GO G190) G191 (EXIT NIL))
                 (LETT |vd|
                       (SPADCALL
...
(SDEFUN |NBLM;mul_by_binomial_pointwise|
        ((|v| |U32Vector|) (|pt| |Integer|) (|pts| |U32Vector|) (|p| |Integer|)
         ($ |Void|))
        (SPROG
         ((|pp| (|Integer|)) (#1=#:G465 NIL) (|i| NIL) (|n| (|SingleInteger|)))
...
(SDEFUN |NBLM;critical_index|
        ...
        (SPROG
         ((#1=#:G489 NIL) (#2=#:G490 NIL) (|pa| (|U32Vector|))
          (|nj| (|Integer|)) (#3=#:G491 NIL) (|j| NIL)
...
(SDEFUN |NBLM;swap_rows|
        ((|m| |TwoDimensionalArray| (|U32Vector|)) (|i| |Integer|)
         (|j| |Integer|) ($ |Void|))
        (SPROG
         ((|t2| #1=(|U32Vector|)) (|t1| #1#) (#2=#:G496 NIL) (|k| NIL)
...
(SDEFUN |NBLM;mult_vector|
        ...
        (SPROG ((#1=#:G500 NIL) (|i| NIL) (|n| (|NonNegativeInteger|)))
               (SEQ (LETT |n| (QV_LEN_U32 |v|))
                    (EXIT
...
(SDEFUN |NBLM;mult_row|
        ...
        (SPROG ((#1=#:G504 NIL) (|j| NIL) (|jmax| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;add_vector|
        ((|v1| |U32Vector|) (|v2| |U32Vector|) (|c| |Integer|) (|k| |Integer|)
         (|p| |Integer|) ($ |Void|))
        (SPROG ((#1=#:G508 NIL) (|i| NIL) (|n| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;add_row|
        ((|m| |TwoDimensionalArray| (|U32Vector|)) (|j1| |Integer|)
         ...
         ($ |Void|))
        (SPROG ((#1=#:G512 NIL) (|i| NIL) (|imax| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;reduce_row_by_row1|
        ...
        (SPROG
         ((#1=#:G516 NIL) (|c| (|Integer|)) (|k| (|Integer|))
          (|rj0| (|U32Vector|)))
...
(SDEFUN |NBLM;top_reduce_by_row|
        ...
        (SPROG
         ((#1=#:G520 NIL) (|j| NIL) (|minv| (|Integer|)) (|mcoeff| (|Integer|))
          (|cdeg| (|Integer|)) (|mdeg| (|Integer|))
          (|nr| (|NonNegativeInteger|)))
         (SEQ (LETT |nr| (QVSIZE |vd|))
              (LETT |mdeg| (SPADCALL |vn| |ci| (QREFELT $ 38)))
              (LETT |cdeg| (- |mdeg| (SPADCALL |vd| |i| (QREFELT $ 38))))
              (LETT |mcoeff| (ELT_U32 (QAREF2O |m| |i| |ci| 1 1) |cdeg|))
              (LETT |minv| (SPADCALL |mcoeff| |p| (QREFELT $ 50)))
...
(SDEFUN |NBLM;final_reduce|
        ((|m| |TwoDimensionalArray| (|U32Vector|)) (|civ| |Vector| (|Integer|))
         ...
         (|p| |Integer|) ($ |Void|))
        (SPROG
         ((|ci| #1=(|Integer|)) (#2=#:G529 NIL) (|vdi| #1#) (#3=#:G532 NIL)
          (|i| NIL) (#4=#:G531 NIL) (|d| NIL) (|vdj| #1#) (#5=#:G530 NIL)
          (|j| NIL) (|mvd| #1#) (|ns| (|NonNegativeInteger|)))
         (SEQ (LETT |ns| (QVSIZE |vd|))
              (LETT |mvd| (SPADCALL |vd| 1 (QREFELT $ 38)))
              (EXIT
               (SEQ (LETT |j| 1) (LETT #5# |ns|) G190
                    (COND ((|greater_SI| |j| #5#) (GO G191)))
                    (SEQ (LETT |vdj| (SPADCALL |vd| |j| (QREFELT $ 38)))
                         (EXIT
...
(SDEFUN |NBLM;reduceBasis0;Tda2VIR;19|
        ...
        (SPROG
         ((|tmp| #1=(|Integer|)) (|maxj| (|Integer|)) (|ci| #2=(|Integer|))
          (|nci| #2#) (|maxd| (|Integer|)) (|cd| #1#) (#3=#:G545 NIL) (|j| NIL)
          (#4=#:G544 NIL) (|i| NIL) (|civ| (|Vector| (|Integer|)))
         ...
         (SEQ (LETT |nc| (QVSIZE |vn|)) (LETT |ns| (QVSIZE |vd|))
              ...
              (SEQ (LETT |i| 1) (LETT #4# |ns|) G190
                   ...
                   (SEQ (LETT |maxd| -1)
                        ...
                        (LETT |tmp| (SPADCALL |vd| |i| (QREFELT $ 38)))
                        (SPADCALL |vd| |i|
...
(SDEFUN |NBLM;reduceBasis;V2VIR;20|
        ((|m| |Vector| (|U32Vector|)) (|vn| |Vector| (|Integer|))
         ...
         ($ |Record| (|:| |basis| (|TwoDimensionalArray| (|U32Vector|)))
          ...
          (|:| |cinds| (|Vector| (|Integer|)))))
        (SPROG
         ((|j| (|NonNegativeInteger|)) (|m2| (|SingleInteger|)) (#1=#:G560 NIL)
          (|i1| NIL) (|resjk| (|U32Vector|)) (|vnk1| (|SingleInteger|))
          (#2=#:G559 NIL) (|k| NIL) (|mi| (|U32Vector|)) (#3=#:G558 NIL)
          (|i| NIL) (|nvd| (|Vector| (|Integer|)))
          (|res| (|TwoDimensionalArray| (|U32Vector|)))
          (|ns| (|NonNegativeInteger|)) (#4=#:G557 NIL)
         ...
         (SEQ (LETT |nr| (QVSIZE |vd|)) (LETT |nc| (QVSIZE |vn|)) (LETT |ns| 0)
              ...
              (SEQ (LETT |i| 1) (LETT #3# |nr|) G190
                   (COND ((|greater_SI| |i| #3#) (GO G191)))
                   (SEQ (LETT |mi| (SPADCALL |m| |i| (QREFELT $ 33)))
                        (LETT |m2| 0)
                        (EXIT
                         (COND
                          ((>= (SPADCALL |vd| |i| (QREFELT $ 38)) 0)
