...
(SDEFUN |HDP;<;2$B;1| ((|v1| $) (|v2| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G392 NIL) (|i| NIL) (|n2| (S)) (|n1| (S)) (#2=#:G393 NIL))
         (SEQ
          (EXIT
...
(DEFUN |HomogeneousDirectProduct| (&REST #1=#:G420)
  (SPROG NIL
         (PROG (#2=#:G421)
           (RETURN
            (COND
...
(DEFUN |HomogeneousDirectProduct;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G411 NIL) (#2=#:G412 NIL) (#3=#:G413 NIL) (#4=#:G414 NIL)
    (#5=#:G415 NIL) (#6=#:G416 NIL) (#7=#:G417 NIL) (#8=#:G418 NIL)
    (#9=#:G419 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
