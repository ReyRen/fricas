...
(SDEFUN |GENEEZ;compBound;BPLNni;1|
        ...
        (SPROG
         ((#1=#:G407 NIL) (|normprod| #2=(|NonNegativeInteger|))
          (#3=#:G402 NIL) (#4=#:G401 #2#) (#5=#:G403 #2#) (#6=#:G405 NIL)
          (#7=#:G417 NIL) (|g| NIL) (#8=#:G418 NIL) (|df| NIL)
          (|nm| #9=(|NonNegativeInteger|)) (#10=#:G399 NIL) (#11=#:G398 #9#)
          (#12=#:G400 #9#) (#13=#:G416 NIL) (|u| NIL) (|normlist| (|List| #9#))
          (#14=#:G395 NIL) (#15=#:G394 #9#) (#16=#:G396 #9#) (#17=#:G415 NIL)
          (#18=#:G414 NIL) (|f| NIL) (#19=#:G413 NIL)
          (|n| #20=(|NonNegativeInteger|)) (#21=#:G392 NIL) (#22=#:G391 #20#)
          (#23=#:G393 #20#) (#24=#:G412 NIL) (|ldeg| (|List| #20#))
          (#25=#:G411 NIL) (#26=#:G410 NIL))
         (SEQ
          (LETT |ldeg|
                (PROGN
                 (LETT #26# NIL)
...
(SDEFUN |GENEEZ;compBound;BPLNni;2|
        ((|m| BP) (|listpolys| |List| BP) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G423 NIL) (#2=#:G422 #3=(|NonNegativeInteger|)) (#4=#:G424 #3#)
          (#5=#:G426 NIL) (#6=#:G425 #3#) (#7=#:G427 #3#) (#8=#:G431 NIL)
          (|u| NIL) (#9=#:G430 NIL) (|p| NIL) (#10=#:G420 NIL) (#11=#:G419 #3#)
          (#12=#:G421 #3#) (#13=#:G429 NIL))
         (SEQ
          (+
           (PROGN
            (LETT #10# NIL)
...
(SDEFUN |GENEEZ;reduceList| ((|lp| |List| BP) (|lmod| R) ($ |List| FP))
        (SPROG ((#1=#:G469 NIL) (|ff| NIL) (#2=#:G468 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GENEEZ;coerceLFP| ((|lf| |List| FP) ($ |List| BP))
        (SPROG ((#1=#:G473 NIL) (|fm| NIL) (#2=#:G472 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GENEEZ;liftSol|
        ...
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G490 NIL) (|fs| (BP)) (#3=#:G483 NIL)
          (#4=#:G482 (BP)) (#5=#:G484 (BP)) (#6=#:G502 NIL) (|f| NIL)
          (#7=#:G503 NIL) (|g| NIL) (|nsol| (|List| BP)) (#8=#:G501 NIL)
          (|slp| NIL) (#9=#:G500 NIL) (#10=#:G498 NIL) (#11=#:G499 NIL)
          (#12=#:G497 NIL) (|sln| (|List| FP)) (#13=#:G495 NIL) (|pp| NIL)
          (#14=#:G496 NIL) (#15=#:G494 NIL) (|cc| (R)) (#16=#:G493 NIL)
          (|i| NIL) (#17=#:G492 NIL) (|xx| NIL) (#18=#:G491 NIL)
                 ...
                 (EXIT
                  (COND
                   ((SPADCALL (SPADCALL |lmodk| (QREFELT $ 12)) |bound|
                              (QREFELT $ 43))
                    (PROGN (LETT #2# (CONS 1 "failed")) (GO #19=#:G489)))
                   ('T
...
(SDEFUN |GENEEZ;makeProducts| ((|listPol| |List| BP) ($ |List| BP))
        (SPROG
         ((#1=#:G514 NIL) (|g| NIL) (#2=#:G513 NIL) (#3=#:G505 NIL)
          (#4=#:G504 (BP)) (#5=#:G506 (BP)) (#6=#:G512 NIL) (#7=#:G382 NIL)
          (|ll| (|List| BP)) (|f| (BP)))
         (SEQ
...
(SDEFUN |GENEEZ;testModulus;RLB;13|
        ...
        (SPROG
         ((#1=#:G524 NIL) (#2=#:G526 NIL) (#3=#:G529 NIL) (|rpol2| NIL)
          (|redListPol| (|List| FP)) (|rpol| (FP)) (#4=#:G525 NIL)
          (#5=#:G527 NIL) (|pol| NIL) (#6=#:G528 NIL))
         (SEQ
          (EXIT
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (SPADCALL |pol| (QREFELT $ 9))
                                     ...
                                     (QREFELT $ 60))
                           (PROGN
                            (LETT #4# (PROGN (LETT #2# NIL) (GO #7=#:G523)))
                            (GO #8=#:G516))))))
...
(SDEFUN |GENEEZ;tablePow;NniRLU;14|
        ...
        (SPROG
         ((#1=#:G543 NIL) (|tpol| NIL) (#2=#:G544 NIL) (|fpol| NIL)
          (#3=#:G542 NIL) (#4=#:G541 NIL) (|i| NIL) (|x| (BP))
...
(SDEFUN |GENEEZ;solveid;BPRVU;15|
        ...
        (SPROG
         ((|sln| (|List| BP)) (#1=#:G557 NIL) (|pp| NIL) (#2=#:G558 NIL)
          (|slp| NIL) (#3=#:G556 NIL) (#4=#:G555 NIL) (|i| NIL) (#5=#:G554 NIL)
          (|xx| NIL) (#6=#:G553 NIL) (|d| (|NonNegativeInteger|)))
...
(SDEFUN |GENEEZ;tablePow;NniRLU;16|
        ((|mdeg| |NonNegativeInteger|) (|pmod| R) (|listPol| |List| BP)
         ($ |Union| (|Vector| (|List| BP)) "failed"))
        (SPROG
         ((|ptable| (|Vector| (|List| BP))) (#1=#:G576 NIL) (|tpol| NIL)
          (#2=#:G577 NIL) (|fpol| NIL) (#3=#:G575 NIL) (#4=#:G574 NIL)
          (|i| NIL) (|x| (FP)) (|fl| (|List| FP))
          (|ftable| (|Vector| (|List| FP)))
          (|multiE| (|Union| (|List| FP) "failed")) (|listP| (|List| FP))
          (#5=#:G573 NIL) (|pol| NIL) (#6=#:G572 NIL))
         (SEQ
          (LETT |listP|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |GENEEZ;solveid;BPRVU;17|
        ((|m| BP) (|pmod| R) (|table| |Vector| (|List| BP))
         ($ |Union| (|List| BP) "failed"))
        (SPROG
         ((|a| (BP)) (#1=#:G447 NIL) (|bound| (|NonNegativeInteger|))
          (|fs| (BP)) (#2=#:G584 NIL) (#3=#:G583 (BP)) (#4=#:G585 (BP))
          (#5=#:G597 NIL) (|f| NIL) (#6=#:G598 NIL) (|g| NIL)
          (|soln| (|List| BP)) (#7=#:G596 NIL) (|slp| NIL) (#8=#:G595 NIL)
          (|sln| (|List| FP)) (#9=#:G593 NIL) (|pp| NIL) (#10=#:G594 NIL)
          (#11=#:G592 NIL) (#12=#:G591 NIL) (|i| NIL) (#13=#:G590 NIL)
          (|xx| NIL) (#14=#:G589 NIL) (|lpolys| (|List| BP))
