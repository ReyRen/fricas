...
(SDEFUN |COMBINAT;partition;2I;1| ((|n| I) ($ I))
        (SPROG
         ((|s| (I)) (|t| (I)) (#1=#:G409 NIL) (|u| (|Integer|))
          (|l| (|Integer|)) (|k| NIL) (#2=#:G410 NIL) (|i| NIL) (#3=#:G398 NIL)
...
(SDEFUN |COMBINAT;distinct_partition;2I;2| ((|n| I) ($ I))
        (SPROG
         ((|s| (I)) (|t| (I)) (#1=#:G422 NIL) (|u| (|Integer|))
          (|l| (|Integer|)) (|l1| (|Integer|)) (|k| NIL) (#2=#:G423 NIL)
          (|i| NIL) (Q (|IndexedOneDimensionalArray| I (|Zero|)))
          (#3=#:G411 NIL) (|nz| (|Integer|)))
...
(SDEFUN |COMBINAT;binomial;3I;4| ((|n| I) (|m| I) ($ I))
        (SPROG
         ((|b| (I)) (#1=#:G442 NIL) (|k| NIL) (|s| (I)) (|#G20| (I))
          (|#G19| (I)) (#2=#:G441 NIL) (|#G18| (I)) (|#G17| (I)))
         (SEQ
          (EXIT
           (COND
            ((OR
...
(SDEFUN |COMBINAT;multinomial;ILI;5| ((|n| I) (|m| |List| I) ($ I))
        (SPROG
         ((|s| (I)) (#1=#:G455 NIL) (|t| NIL) (#2=#:G445 NIL) (#3=#:G444 (I))
          (#4=#:G446 (I)) (#5=#:G454 NIL) (#6=#:G382 NIL) (#7=#:G451 NIL)
          (#8=#:G452 NIL) (#9=#:G453 NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
...
(SDEFUN |COMBINAT;permutation;3I;6| ((|n| I) (|m| I) ($ I))
        (SPROG ((|p| (I)) (|t| (I)) (#1=#:G460 NIL) (|k| NIL))
               (SEQ
                (COND
...
(SDEFUN |COMBINAT;stirling1;3I;7| ((|n| I) (|m| I) ($ I))
        (SPROG
         ((#1=#:G463 NIL) (#2=#:G468 NIL) (|k| NIL)
          (|x| (|SparseUnivariatePolynomial| I)) (#3=#:G461 NIL))
         (SEQ
          (COND
           ((OR
             (OR (SPADCALL |n| (|spadConstant| $ 7) (QREFELT $ 24))
...
(SDEFUN |COMBINAT;stirling2;3I;8| ((|n| I) (|m| I) ($ I))
        (SPROG ((|t| (I)) (#1=#:G471 NIL) (|s| (I)) (#2=#:G476 NIL) (|k| NIL))
               (SEQ
                (COND
                 ((OR
                   (OR (SPADCALL |n| (|spadConstant| $ 7) (QREFELT $ 24))
...
(DEFUN |IntegerCombinatoricFunctions| (#1=#:G481)
  (SPROG NIL
         (PROG (#2=#:G482)
           (RETURN
            (COND
