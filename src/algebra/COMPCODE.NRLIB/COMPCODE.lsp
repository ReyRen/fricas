...
(SDEFUN |COMPCODE;genFuncDeclar|
        ((|content| |ILogic|) (|numb| |NonNegativeInteger|)
         ($ |List| (|String|)))
        (SPROG
         ((|resStr| (|String|)) (|notfst| (|Boolean|)) (#1=#:G398 NIL)
          (|thisTerm| NIL) (|resType| (|ILogic|))
          (|deduct| (|List| (|ILogic|))) (#2=#:G397 NIL)
          (|fac| (|List| (|ILogic|))))
         (SEQ
          (EXIT
...
(SDEFUN |COMPCODE;genLambdaTerm|
        ...
        (SPROG
         ((|s| (|String|)) (|ch| (|List| (|Lambda| (|Typed|))))
          ...
          (#1=#:G412 NIL) (|i| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |s| "")
                (COND
...
(SDEFUN |COMPCODE;genFuncDefn|
        ((|content| |Lambda| (|Typed|)) (|numb| |NonNegativeInteger|)
         ($ |List| (|String|)))
        (SPROG
         ((#1=#:G417 NIL) (|lhst| (|String|)) (|lhsn| (|String|))
...
(SDEFUN |COMPCODE;writeCategory;L3SV;8|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|line| NIL) (|lines| (|List| (|String|)))
          (|fnNum| (|NonNegativeInteger|)) (#2=#:G424 NIL) (|thisEq| NIL)
          (|f1| (|TextFile|)))
         (SEQ
          (LETT |f1|
...
(SDEFUN |COMPCODE;writePackage;L4SV;9|
        ((|content| |List| (|Lambda| (|Typed|))) (|filename| |String|)
         ...
         ($ |Void|))
        (SPROG
         ((#1=#:G432 NIL) (|line| NIL) (|lines| (|List| (|String|)))
          (|fnNum| (|NonNegativeInteger|)) (#2=#:G431 NIL) (|thisEq| NIL)
          (|f1| (|TextFile|)))
         (SEQ
          (LETT |f1|
                (SPADCALL (SPADCALL |filename| (QREFELT $ 38)) "output"
