...
(DEFUN |UnivariateLaurentSeries| (&REST #1=#:G441)
  (SPROG NIL
         (PROG (#2=#:G442)
           (RETURN
            (COND
...
(DEFUN |UnivariateLaurentSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G440 NIL) (|pv$| NIL) (#2=#:G429 NIL) (#3=#:G430 NIL) (#4=#:G431 NIL)
    (#5=#:G433 NIL) (#6=#:G434 NIL) (#7=#:G435 NIL) (#8=#:G436 NIL)
    (#9=#:G438 NIL) (#10=#:G439 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
