...
(SDEFUN |ORTHPOL;laguerreL;Nni2R;1| ((|n| |NonNegativeInteger|) (|x| R) ($ R))
        (SPROG
         ((|p0| (R)) (|p1| (R)) (|#G9| (R)) (|#G8| (R)) (#1=#:G385 NIL)
          (|i| NIL) (|#G6| (R)) (|#G5| (R)))
         (SEQ
...
(SDEFUN |ORTHPOL;laguerreL;2Nni2R;2|
        ...
        (SPROG
         ((|p1| (R)) (|p0| (R)) (|cx| (|Integer|)) (#1=#:G387 NIL)
          (#2=#:G393 NIL) (|j| NIL) (|mi| (|Integer|)) (|ni| (|Integer|)))
...
(SDEFUN |ORTHPOL;chebyshevT;Nni2R;3| ((|n| |NonNegativeInteger|) (|x| R) ($ R))
        (SPROG
         ((|p0| (R)) (|p1| (R)) (|#G20| (R)) (|#G19| (R)) (#1=#:G397 NIL)
          (|i| NIL) (|#G17| (R)) (|#G16| (R)))
         (SEQ
          (COND ((EQL |n| 0) (|spadConstant| $ 8))
                ('T
...
(SDEFUN |ORTHPOL;chebyshevU;Nni2R;4| ((|n| |NonNegativeInteger|) (|x| R) ($ R))
        (SPROG
         ((|p0| (R)) (|p1| (R)) (|#G27| (R)) (|#G26| (R)) (#1=#:G401 NIL)
          (|i| NIL) (|#G24| (R)) (|#G23| (R)))
         (SEQ
          (COND ((EQL |n| 0) (|spadConstant| $ 8))
                ('T
...
(SDEFUN |ORTHPOL;hermiteH;Nni2R;5| ((|n| |NonNegativeInteger|) (|x| R) ($ R))
        (SPROG
         ((|p0| (R)) (|p1| (R)) (|#G34| (R)) (|#G33| (R)) (#1=#:G405 NIL)
          (|i| NIL) (|#G31| (R)) (|#G30| (R)))
         (SEQ
          (COND ((EQL |n| 0) (|spadConstant| $ 8))
                ('T
...
(SDEFUN |ORTHPOL;legendreP;Nni2R;6| ((|n| |NonNegativeInteger|) (|x| R) ($ R))
        (SPROG
         ((|p0| (R)) (|p1| (R)) (|#G39| (R)) (|#G38| (R))
          (|c| (|Fraction| (|Integer|))) (#1=#:G410 NIL) (|i| NIL))
         (SEQ
          (COND ((EQL |n| 0) (|spadConstant| $ 8))
                ('T
                 (SEQ (LETT |p0| (|spadConstant| $ 8)) (LETT |p1| |x|)
                      (SEQ (LETT |i| 1) (LETT #1# (- |n| 1)) G190
                           (COND ((|greater_SI| |i| #1#) (GO G191)))
                           (SEQ
                            (LETT |c| (SPADCALL 1 (+ |i| 1) (QREFELT $ 32)))
                            (EXIT
                             (PROGN
                              (LETT |#G38|
                                    (SPADCALL |c|
...
(DEFUN |OrthogonalPolynomialFunctions| (#1=#:G411)
  (SPROG NIL
         (PROG (#2=#:G412)
           (RETURN
            (COND
