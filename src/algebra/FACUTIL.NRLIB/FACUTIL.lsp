...
(SDEFUN |FACUTIL;degree;SupLL;4|
        ...
        (SPROG
         ((|ldeg| #1#) (#2=#:G392 NIL) (#3=#:G391 #4=(|NonNegativeInteger|))
          (#5=#:G393 #4#) (#6=#:G399 NIL) (|fc| NIL) (#7=#:G398 NIL) (|xx| NIL)
          (#8=#:G397 NIL) (|coefs| (|List| P)))
...
(SDEFUN |FACUTIL;variables;SupL;5|
        ...
        (SPROG
         ((#1=#:G401 NIL) (#2=#:G400 #3=(|List| OV)) (#4=#:G402 #3#)
          (#5=#:G404 NIL) (|cf| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |FactoringUtilities| (&REST #1=#:G415)
  (SPROG NIL
         (PROG (#2=#:G416)
           (RETURN
            (COND
