...
(SDEFUN |EXPR;poly_to_MP|
        ...
        (SPROG
         ((|vl2| (|List| (|Kernel| $))) (#1=#:G460 NIL) (|z| NIL)
          (#2=#:G459 NIL) (|vl1| (|List| (|Symbol|)))
...
(SDEFUN |EXPR;root_reduce| ((|x| $) (|r| |Kernel| $) ($ $))
        (SPROG
         ...
         (SEQ
          ...
          (LETT |c1| (SPADCALL |dp| (QREFELT $ 122)))
          (LETT |c0|
                (SPADCALL (SPADCALL |dp| (QREFELT $ 123)) (QREFELT $ 122)))
          (LETT |n1|
                (SPADCALL |dn|
...
(SDEFUN |EXPR;algreduc| ((|x| $) (|ckl| |List| (|Kernel| $)) ($ $))
        (SPROG
         ((|x1| ($)) (|q| (|SparseUnivariatePolynomial| $)) (#1=#:G521 NIL)
          (|k| NIL) (|sas| (|SingletonAsOrderedSet|)) (#2=#:G520 NIL)
...
(SDEFUN |EXPR;commonk0|
        ((|x| |List| (|Kernel| $)) (|y| |List| (|Kernel| $))
         ($ |List| (|Kernel| $)))
        (SPROG ((|ans| (|List| (|Kernel| $))) (#1=#:G536 NIL) (|k| NIL))
               (SEQ (LETT |ans| NIL)
...
(SDEFUN |EXPR;reduc| ((|x| $) (|l| |List| (|Kernel| $)) ($ $))
        (SPROG
         ((|p| (|SparseUnivariatePolynomial| $)) (#1=#:G666 NIL) (|k| NIL))
         (SEQ
                            ...
                            (NULL
                             (|EXPR;algkernels|
                              (SPADCALL (SPADCALL |p| (QREFELT $ 413))
                                        (QREFELT $ 75))
                              $)))
                           (PROGN (LETT #1# NIL) (GO #2=#:G674)))
                          ('T (LETT |p| (SPADCALL |p| (QREFELT $ 414)))))))
...
(SDEFUN |EXPR;def_poly|
        ((|k| |Kernel| $)
         ($ |SparseUnivariatePolynomial|
          (|SparseMultivariatePolynomial| R (|Kernel| $))))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G697 NIL)
              ...
              (EXIT
               (COND
                ...
                ((SPADCALL |k| '|nthRoot| (QREFELT $ 116))
                 (SEQ
                  (LETT |n|
                        (PROG1 (LETT #1# (SPADCALL |arg2| (QREFELT $ 424)))
...
(SDEFUN |EXPR;varmap1|
        ((|k0| |Kernel| $) (|lk| |List| (|Kernel| $)) (|ls| |List| (|Symbol|))
         ($ |Symbol|))
        (SPROG
         ((#1=#:G705 NIL) (#2=#:G706 NIL) (|k| NIL) (#3=#:G707 NIL) (|s| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |EXPR;varmap2|
        ((|s0| |Symbol|) (|lk| |List| (|Kernel| $)) (|ls| |List| (|Symbol|))
         ($ |Kernel| $))
        (SPROG
         ((#1=#:G711 NIL) (#2=#:G712 NIL) (|k| NIL) (#3=#:G713 NIL) (|s| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |s| NIL) (LETT #3# |ls|) (LETT |k| NIL) (LETT #2# |lk|)
                 ...
                 (SEQ
                  (EXIT
                   (COND
                    ((EQUAL |s| |s0|) (PROGN (LETT #1# |k|) (GO #4=#:G710))))))
                 (LETT #2# (PROG1 (CDR #2#) (LETT #3# (CDR #3#)))) (GO G190)
                 G191 (EXIT NIL))
...
(SDEFUN |EXPR;SUPP_to_PI|
        ...
        (SPROG ((|p2| (|SparseMultivariatePolynomial| R (|Kernel| $))))
               (SEQ (LETT |p2| (SPADCALL |p| |xk| (QREFELT $ 438)))
...
(SDEFUN |EXPR;PI_to_SUP|
        ...
        (SPROG
         ...
         (SEQ
          ...
          (LETT |p2| (SPADCALL |p1| |xk| (QREFELT $ 120)))
          (EXIT (LETT |p3| (SPADCALL (ELT $ 104) |p2| (QREFELT $ 449))))))) 
...
(SDEFUN |EXPR;SUPP_to_PT|
        ...
        (SPROG
         ...
         (SEQ (LETT |p2| (SPADCALL |p| |k| (QREFELT $ 438)))
              (LETT |up|
                    (SPADCALL
...
(SDEFUN |EXPR;gcdPolynomial;3Sup;172|
        ...
        (SPROG
         ((|g2| (|Polynomial| (|Integer|)))
           ...
           (|List|
            (|Record| (|:| |var| (|Symbol|))
                      (|:| |coef|
                           (|SparseUnivariatePolynomial|
                            (|Fraction| (|Polynomial| (|Integer|))))))))
          (#2=#:G762 NIL) (|m| NIL) (#3=#:G763 NIL) (|k| NIL) (#4=#:G761 NIL)
          (|q2|
           #5=(|Record| (|:| |var| (|Symbol|))
                        (|:| |coef|
                             (|SparseUnivariatePolynomial|
          ...
          (#6=#:G760 NIL) (#7=#:G759 NIL)
          (|lm1| (|List| (|Polynomial| (|Integer|)))) (#8=#:G757 NIL)
          (#9=#:G758 NIL) (#10=#:G756 NIL)
          (|q1| #11=(|Polynomial| (|Integer|))) (|p1| #11#) (#12=#:G755 NIL)
          (#13=#:G754 NIL)
          (|lm|
           (|List|
            (|SparseUnivariatePolynomial|
             (|SparseMultivariatePolynomial| R (|Kernel| $)))))
          (#14=#:G753 NIL) (#15=#:G752 NIL) (|all_syms| (|List| (|Symbol|)))
          (|all_kers| (|List| (|Kernel| $))) (|xk| (|Kernel| $))
          (|x| #16=(|Symbol|)) (|all_syms0| (|List| #16#)) (#17=#:G751 NIL)
          (#18=#:G750 NIL) (|akers| (|List| (|Kernel| $)))
                   ...
                   (SEQ
                    ...
                    (LETT |cl|
                          (SPADCALL (SPADCALL |p| (QREFELT $ 418))
                                    ...
                                    (QREFELT $ 464)))
                    (LETT |akers| (SPADCALL |cl| (QREFELT $ 465)))
                          ...
                          (PROGN
                           ...
                           (SEQ (LETT |k| NIL) (LETT #17# |all_kers0|) G190
                                ...
                                (SEQ
                                 (EXIT
                                  (LETT #18#
                                        (CONS (SPADCALL (QREFELT $ 469))
                                              #18#))))
                                (LETT #17# (CDR #17#)) (GO G190) G191
                                (EXIT (NREVERSE #18#)))))
                    (LETT |x| (SPADCALL (QREFELT $ 469)))
                    (LETT |xk| (SPADCALL |x| (QREFELT $ 30)))
                    (LETT |all_kers|
                          (SPADCALL |xk| |all_kers0| (QREFELT $ 470)))
...
(SDEFUN |EXPR;retractIfCan;$U;184|
        ...
        (SPROG
         ((#1=#:G792 NIL) (|d| #2=(|Union| (|AlgebraicNumber|) "failed"))
          (|n| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |EXPR;k2an| ((|k| |Kernel| $) ($ |Union| (|AlgebraicNumber|) "failed"))
        (SPROG
         ((|arg| (|List| (|AlgebraicNumber|))) (#1=#:G824 NIL)
          (|a| #2=(|Union| (|AlgebraicNumber|) #3="failed")) (#4=#:G825 NIL)
          (|x| NIL)
          (|eq|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| R (|Kernel| $))))
                    ...
                    (SEQ (LETT |x| NIL)
                         ...
                         (COND
                          ((OR (ATOM #4#) (PROGN (LETT |x| (CAR #4#)) NIL))
                           (GO G191)))
                         (SEQ (LETT |a| (SPADCALL |x| (QREFELT $ 513)))
                              (EXIT
                               (COND
                                ((QEQCAR |a| 1)
        ...
        (SPROG
         ((|c| (|Union| (|AlgebraicNumber|) #1#))
          (|up|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| R (|Kernel| $))))
          (|ans| (|AlgebraicNumber|)) (#2=#:G840 NIL)
          (|t| (|Union| (|AlgebraicNumber|) "failed")) (|k| (|Kernel| $))
          (|x1| (|Union| (|Kernel| $) "failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |x1| (SPADCALL |p| (QREFELT $ 532)))
                (EXIT
                 (COND
                  ((QEQCAR |x1| 1)
...
(SDEFUN |EXPR;eval;$LLS$;190|
        ((|f| $) (|ls| |List| (|BasicOperator|)) (|lg| |List| $) (|x| |Symbol|)
         ($ $))
        (SPROG
         ((|res| ($)) (#1=#:G871 NIL) (|g| NIL) (#2=#:G870 NIL)
          (|nlg| (|List| $)) (#3=#:G869 NIL) (#4=#:G868 NIL)
          (|lbackwardSubs| (|List| (|Equation| $))) (#5=#:G866 NIL) (|i| NIL)
          (#6=#:G867 NIL) (|j| NIL) (#7=#:G865 NIL)
          (|lforwardSubs| (|List| (|Equation| $))) (#8=#:G863 NIL)
          (#9=#:G864 NIL) (#10=#:G862 NIL) (|ns| (|List| (|Symbol|)))
          (#11=#:G861 NIL) (#12=#:G860 NIL) (#13=#:G859 NIL) (#14=#:G858 NIL)
          (|lsd| (|List| (|Symbol|))) (|lsym| (|List| (|Symbol|)))
          (|llsym| (|List| (|List| (|Symbol|)))) (#15=#:G857 NIL)
          (#16=#:G856 NIL))
         (SEQ
          (LETT |llsym|
                (PROGN
...
(SDEFUN |EXPR;kernels;$L;216| ((|x| $) ($ |List| (|Kernel| $)))
        (SPROG ((#1=#:G908 NIL) (|f| NIL) (#2=#:G907 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |f| NIL) (LETT #1# (SPADCALL |x| (QREFELT $ 590)))
                      G190
                      (COND
...
(SDEFUN |EXPR;subeval!0| ((|x| NIL) ($$ NIL))
        (PROG ($ |lk| |lv|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G932 NIL) (|a| NIL) (#2=#:G931 NIL))
                   (SEQ
...
(SDEFUN |EXPR;isPlus;$U;222| ((|x| $) ($ |Union| (|List| $) "failed"))
        (SPROG
         ((#1=#:G947 NIL) (|t| NIL) (#2=#:G946 NIL)
          (|l|
           (|List| (|Record| (|:| |k| (|Kernel| $)) (|:| |c| (|Integer|))))))
         (SEQ
          (COND
           ((OR (NULL (LETT |l| (SPADCALL |x| (QREFELT $ 590))))
                (NULL (CDR |l|)))
            (CONS 1 "failed"))
           ('T
            (CONS 0
         ...
         (SEQ
          (COND
           ((OR (NULL (LETT |l| (SPADCALL |x| (QREFELT $ 590))))
            ...
            (CONS 1 "failed"))
           ('T
            (SEQ (LETT |t| (SPADCALL |l| (QREFELT $ 606)))
                 (EXIT (CONS 0 (CONS (QCDR |t|) (QCAR |t|)))))))))) 

(SDEFUN |EXPR;eval;$LL$;224|
        ((|x| $) (|lk| |List| (|Kernel| $)) (|lv| |List| $) ($ $))
        (SPROG
         ((#1=#:G963 NIL) (#2=#:G962 ($)) (#3=#:G964 ($)) (#4=#:G966 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |t| NIL) (LETT #4# (SPADCALL |x| (QREFELT $ 590))) G190
                (COND
...
(SDEFUN |EXPR;subst;$LL$;225|
        ((|x| $) (|lk| |List| (|Kernel| $)) (|lv| |List| $) ($ $))
        (SPROG
         ((#1=#:G969 NIL) (#2=#:G968 ($)) (#3=#:G970 ($)) (#4=#:G972 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |EXPR;subst;$LL$;237!0| ((|x1| NIL) ($$ NIL))
        (PROG ($ |lk| |lv|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G1008 NIL) (|a| NIL) (#2=#:G1007 NIL))
                   (SEQ
...
(DEFUN |Expression;| (|#1|)
  (SPROG
   ((#1=#:G1053 NIL) (|pv$| NIL) (#2=#:G1049 NIL) (#3=#:G1050 NIL)
    (#4=#:G1051 NIL) (#5=#:G1052 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
