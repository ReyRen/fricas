...
(SDEFUN |LODEEF;simp_roots| ((|f| F) (|la| |List| F) ($ F))
        (SPROG
         ((|k1| (F)) (#1=#:G405 NIL) (|k| NIL) (|ta| (|List| (|Kernel| F)))
          (|tf| (|List| (|Kernel| F))))
...
(SDEFUN |LODEEF;algSolve|
        ((|op| L) (|g| F) (|k| . #1=(|Kernel| F)) (|l| |List| (|Kernel| F))
         ...
         ($ |Union| (|Record| (|:| |particular| F) (|:| |basis| (|List| F)))
          #2="failed"))
        (SPROG
         ((#3=#:G425 NIL) (|f| NIL) (#4=#:G424 NIL) (|kz| (|Kernel| F))
...
(SDEFUN |LODEEF;expsols|
        ((|op| |LinearOrdinaryDifferentialOperator1|
          (|Fraction| (|SparseUnivariatePolynomial| F)))
         (|k| |Kernel| F) (|x| |Symbol|) ($ |List| F))
        (SPROG ((#1=#:G467 NIL) (|h| NIL) (#2=#:G466 NIL))
               (SEQ
                (COND
...
(SDEFUN |LODEEF;ratlogsol|
        ((|oper| |LinearOrdinaryDifferentialOperator1|
         ...
         (|k| |Kernel| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((#1=#:G484 NIL) (|e| NIL) (#2=#:G483 NIL) (#3=#:G482 NIL) (|h| NIL)
          (#4=#:G481 NIL) (|int| (|List| F)) (#5=#:G480 NIL) (#6=#:G479 NIL)
          (|le| (|List| F))
          (|rec|
           (|Record|
            (|:| |eq|
          ...
          (|bas| (|List| F)) (#7=#:G478 NIL) (#8=#:G477 NIL))
         (SEQ
          (LETT |bas|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |LODEEF;homosolve1|
        ((|oper| L) (|sols| |List| F) (|k| |Kernel| F) (|x| |Symbol|)
         ($ |List| F))
        (SPROG
         ((#1=#:G517 NIL) (|e| NIL) (#2=#:G516 NIL) (|int| (|List| F))
          (#3=#:G515 NIL) (|h| NIL) (#4=#:G514 NIL)
          (|rec| (|Record| (|:| |eq| L) (|:| |op| (|List| F))))
          (|n| (|NonNegativeInteger|)) (#5=#:G507 NIL))
         (SEQ
          (COND
           ((ZEROP
             (LETT |n|
...
(SDEFUN |LODEEF;kovode|
        ((|op| |LinearOrdinaryDifferentialOperator1|
         ...
         (|k| |Kernel| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((|y2| (F)) (|y1| (F)) (#1=#:G542 NIL) (|e| NIL) (#2=#:G541 NIL)
          (|zp| (|List| F)) (|lc| (|List| F)) (#3=#:G540 NIL) (|crf| NIL)
          (#4=#:G539 NIL)
...
(SDEFUN |LODEEF;solve;LFSFLU;20|
        ((|op| L) (|g| F) (|x| |Symbol|) (|a| F) (|y0| |List| F)
         ($ |Union| F "failed"))
        (SPROG
         ((|hp| (F)) (#1=#:G589 NIL) (|f| NIL) (|i| NIL) (|s| (|Vector| F))
          (|sol| (|Union| (|Vector| F) "failed")) (|h| (F)) (#2=#:G587 NIL)
          (#3=#:G588 NIL) (|yy| NIL) (|kx| (|Kernel| F)) (|v| (|Vector| F))
...
(DEFUN |ElementaryFunctionLODESolver| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
