...
(SDEFUN |RETSOL;LEQQ2F|
        ...
        (SPROG ((#1=#:G387 NIL) (|eq| NIL) (#2=#:G386 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |RETSOL;solveRetract;LLL;4|
        ...
        (SPROG
         ((#1=#:G398 NIL) (|l| NIL) (#2=#:G397 NIL) (#3=#:G396 NIL) (|p| NIL)
          (#4=#:G395 NIL)
...
(SDEFUN |RETSOL;QIfCan|
        ...
        (SPROG
         ((|ans| (|List| (|Fraction| (|Polynomial| Q)))) (#1=#:G409 NIL)
...
(SDEFUN |RETSOL;PQIfCan|
        ...
        (SPROG
         ((|up| (|SparseUnivariatePolynomial| (|Polynomial| R)))
          (|ans| (|Fraction| (|Polynomial| Q))) (#2=#:G427 NIL)
...
(DEFUN |RetractSolvePackage| (&REST #1=#:G428)
  (SPROG NIL
         (PROG (#2=#:G429)
           (RETURN
            (COND
