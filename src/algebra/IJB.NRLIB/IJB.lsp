...
(SDEFUN |IJB;CheckZeroIndex|
        ...
        (SPROG ((#1=#:G403 NIL) (#2=#:G404 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |IJB;U;Pi$;8| ((|up| |PositiveInteger|) ($ $))
        (SPROG ((#1=#:G409 NIL) (|i| NIL) (#2=#:G408 NIL))
               (SEQ
                (COND
...
(SDEFUN |IJB;name;$S;13| ((|jv| $) ($ |Symbol|))
        (SPROG
         ((#1=#:G430 NIL) (|j| NIL) (#2=#:G429 NIL) (#3=#:G428 NIL)
          (#4=#:G427 NIL) (#5=#:G426 NIL) (|i| NIL) (#6=#:G425 NIL)
          (#7=#:G424 NIL) (#8=#:G423 NIL) (|jt| (|Symbol|)))
...
(SDEFUN |IJB;coerce;$E;15| ((|jv| $) ($ |Expression| (|Integer|)))
        (SPROG
         ((|arg| (|List| (|Expression| (|Integer|)))) (#1=#:G441 NIL) (|j| NIL)
          (#2=#:G440 NIL) (#3=#:G439 NIL) (|i| NIL) (#4=#:G438 NIL)
         ...
         (SEQ
          (COND
           ((EQUAL (SPADCALL |jv| (QREFELT $ 24)) '|Const|)
            (|spadConstant| $ 50))
           (#5='T
            (SEQ (LETT |opname| (SPADCALL |jv| (QREFELT $ 48)))
                 (LETT |jop| (SPADCALL |opname| (QREFELT $ 52)))
                 (SPADCALL |jop| (CONS (|function| |IJB;opdisp|) $)
                           (QREFELT $ 54))
                 (LETT |tmp| (SPADCALL |jv| (QREFELT $ 57)))
                 (LETT |jop| (SPADCALL |jop| '|%symbol| |tmp| (QREFELT $ 58)))
                 (LETT |tmp|
                       (SPADCALL (SPADCALL |jv| (QREFELT $ 59))
                                 (QREFELT $ 61)))
                 (LETT |jop| (SPADCALL |jop| '|%weight| |tmp| (QREFELT $ 58)))
                 (LETT |tmp|
                       (SPADCALL (SPADCALL |jv| (QREFELT $ 24))
                                 (QREFELT $ 63)))
                 (LETT |jop| (SPADCALL |jop| '|%jet| |tmp| (QREFELT $ 58)))
                 (COND
                  ((EQUAL (SPADCALL (QREFELT $ 18)) '|Multi|)
                   (LETT |arg|
                         (PROGN
...
(DEFUN |IndexedJetBundle| (&REST #1=#:G448)
  (SPROG NIL
         (PROG (#2=#:G449)
           (RETURN
            (COND
