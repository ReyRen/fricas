...
(SDEFUN |PRS;divide;2polRR;3|
        ...
        (SPROG
         ((#1=#:G571 NIL) (|quot| (|polR|)) (|mon| (|polR|)) (#2=#:G564 NIL)
          (#3=#:G562 NIL) (|delta| (|Integer|)) (#4=#:G558 NIL)
...
(SDEFUN |PRS;resultant_naif| ((P |polR|) (Q |polR|) ($ R))
        (SPROG
         ((|#G19| (|polR|)) (|#G18| (|polR|)) (|a| (R)) (#1=#:G577 NIL)
          (U (|polR|)) (#2=#:G584 NIL) (|degQ| #3=(|NonNegativeInteger|))
          (|degP| #3#) (|#G17| #3#) (|#G16| #3#))
         (SEQ
          (EXIT
...
(SDEFUN |PRS;resultantEuclidean_naif|
        ...
        (SPROG
         ((|cf2| (|polR|)) (|cf1| (|polR|)) (|old_cf2| (|polR|))
          ...
          (|#G24| (|polR|)) (|a| (R)) (#1=#:G596 NIL)
          (|divid| (|Record| (|:| |quotient| |polR|) (|:| |remainder| |polR|)))
          (#2=#:G602 NIL) (#3=#:G590 NIL) (|degQ| #4=(|NonNegativeInteger|))
          (|degP| #4#) (|#G23| #4#) (|#G22| #4#))
         (SEQ
          (EXIT
           (SEQ (LETT |a| (|spadConstant| $ 8))
...
(SDEFUN |PRS;semiResultantEuclidean_naif|
        ...
        (SPROG
         ((|cf2| (|polR|)) (|old_cf2| (|polR|)) (|#G37| (|polR|))
          ...
          (#1=#:G614 NIL)
          (|divid| (|Record| (|:| |quotient| |polR|) (|:| |remainder| |polR|)))
          (#2=#:G620 NIL) (#3=#:G608 NIL) (|degQ| #4=(|NonNegativeInteger|))
          (|degP| #4#) (|#G33| #4#) (|#G32| #4#))
         (SEQ
          (EXIT
           (SEQ (LETT |a| (|spadConstant| $ 8))
...
(SDEFUN |PRS;LazardQuotient;2RNniR;8|
        ...
        (SPROG
         ((#1=#:G628 NIL) (|c| (R)) (|a| (|NonNegativeInteger|))
          (#2=#:G635 NIL) (#3=#:G627 NIL) (|b| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |PRS;LazardQuotient2;polR2RNnipolR;9|
        ...
        (SPROG ((#1=#:G643 NIL) (#2=#:G638 NIL) (#3=#:G636 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |PRS;next_sousResultant2;3polRRpolR;11|
        ...
        (SPROG
         ((#1=#:G659 NIL) (A (|polR|)) (#2=#:G649 NIL) (H (|polR|))
          (#3=#:G660 NIL) (|i| NIL) (|#G64| (|polR|)) (|#G63| (|polR|))
          ...
          (EXIT
           (SEQ
            ...
            (PROGN
             ...
             (LETT |#G64|
                   (SPADCALL (SPADCALL Z (QREFELT $ 23)) (QREFELT $ 41)))
             (LETT P |#G62|)
             (LETT Q |#G63|)
             (LETT H |#G64|))
            (LETT A
                  (SPADCALL (SPADCALL P |e| (QREFELT $ 42)) H (QREFELT $ 36)))
...
(SDEFUN |PRS;next_sousResultant3|
        ((VP |Vector| |polR|) (VQ |Vector| |polR|) (|s| R) (|ss| R)
         ($ |Vector| |polR|))
        (SPROG
         ((#1=#:G674 NIL) (#2=#:G665 NIL) (#3=#:G675 NIL) (|i| NIL)
          (|divid| (|Record| (|:| |quotient| |polR|) (|:| |remainder| |polR|)))
          (|rr| (R)) (|r| (R)) (|#G75| (R)) (|#G74| (R)) (#4=#:G661 NIL)
          ...
          (EXIT
           (SEQ
            (PROGN
             ...
             (LETT |#G71| (SPADCALL VQ 1 (QREFELT $ 45)))
             (LETT P |#G70|)
             (LETT Q |#G71|))
            (PROGN
            ...
            (EXIT
             (PROGN
              (LETT #1#
                    (COND ((ODDP |delta|) VP)
                          (#5# (SPADCALL VP (QREFELT $ 49)))))
              (GO #7=#:G673)))))
          #7# (EXIT #1#)))) 

(SDEFUN |PRS;algo_new| ((P |polR|) (Q |polR|) ($ R))
        (SPROG
         ((|s| (R)) (|#G82| (|polR|)) (|#G81| (|polR|)) (#1=#:G684 NIL)
          (Z (|polR|)) (|delta| (|NonNegativeInteger|)) (#2=#:G677 NIL)
          (|#G80| (|polR|)) (|#G79| (|polR|)) (#3=#:G676 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |delta|
             ...
             (SEQ G190 NIL
                  (SEQ
                   (EXIT
                    (COND
                     ((SPADCALL Q (QREFELT $ 31))
                      (PROGN (LETT #1# (|spadConstant| $ 21)) (GO #4=#:G683)))
                     ('T
                      (SEQ
                       (LETT |delta|
                             (PROG1
               ...
               (SEQ
                ...
                (EXIT
                 (COND
                  ((ODDP |degP|)
                   (COND
                    ((ODDP |degQ|) (LETT Q (SPADCALL Q (QREFELT $ 41)))))))))))
             (EXIT
              (COND
               ((ZEROP |degQ|)
...
(SDEFUN |PRS;subResultantEuclidean|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G104| (|Vector| |polR|)) (|#G103| #1#) (|ss| (R)) (#2=#:G708 NIL)
          (|l| (|Vector| |polR|)) (|delta| (|NonNegativeInteger|))
          (#3=#:G700 NIL) (|degQ| (|NonNegativeInteger|)) (|#G102| (|polR|))
          (|#G101| (|polR|))
          (|pdiv|
           ...
           (SEQ
            ...
            (EXIT
             (SEQ G190 NIL
                  (SEQ
                   (PROGN
                    (LETT |#G101| (SPADCALL VP 1 (QREFELT $ 45)))
                    (LETT |#G102| (SPADCALL VQ 1 (QREFELT $ 45)))
                    (LETT P |#G101|)
                    (LETT Q |#G102|))
                   (EXIT
                    (COND
...
(SDEFUN |PRS;semiSubResultantEuclidean|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G118| (|Vector| |polR|)) (|#G117| #1#) (|ss| (R)) (#2=#:G743 NIL)
          (|l| (|Vector| |polR|)) (|delta| (|NonNegativeInteger|))
          (#3=#:G735 NIL) (|degQ| (|NonNegativeInteger|)) (|#G116| (|polR|))
          (|#G115| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
           ...
           (SEQ
            ...
            (EXIT
             (SEQ G190 NIL
                  (SEQ
                   (PROGN
                    (LETT |#G115| (SPADCALL VP 1 (QREFELT $ 45)))
                    (LETT |#G116| (SPADCALL VQ 1 (QREFELT $ 45)))
                    (LETT P |#G115|)
                    (LETT Q |#G116|))
                   (EXIT
                    (COND
...
(SDEFUN |PRS;semiResultantEuclidean2;2polRR;20|
        ((P |polR|) (Q |polR|)
         ($ |Record| (|:| |coef2| |polR|) (|:| |resultant| R)))
        (SPROG
         ((|s| (R)) (#1=#:G746 NIL) (|degQ| #2=(|NonNegativeInteger|))
...
(SDEFUN |PRS;semiResultantEuclidean2;2polRR;21|
        ((P |polR|) (Q |polR|)
         ($ |Record| (|:| |coef2| |polR|) (|:| |resultant| R)))
        (SPROG
         ((|s| (R)) (#1=#:G756 NIL) (|degQ| #2=(|NonNegativeInteger|))
...
(SDEFUN |PRS;semiResultantEuclidean1;2polRR;22|
        ...
        (SPROG
         ((|result|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |resultant| R))))
         (SEQ (LETT |result| (SPADCALL P Q (QREFELT $ 57)))
...
(SDEFUN |PRS;indiceSubResultant;2polRNnipolR;23|
        ...
        (SPROG
         ((|s| (R)) (|#G139| (|polR|)) (|#G138| (|polR|)) (#1=#:G788 NIL)
          (Z (|polR|)) (#2=#:G780 NIL) (|degQ| #3=(|NonNegativeInteger|))
          (|degP| #3#) (|#G137| #3#) (|#G136| #3#) (|#G135| (|polR|))
          (|#G134| (|polR|)) (#4=#:G778 NIL) (#5=#:G773 NIL)
          (|delta| (|NonNegativeInteger|)) (#6=#:G771 NIL) (|#G133| (|polR|))
          (|#G132| (|polR|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PRS;indiceSubResultantEuclidean;2polRNniR;24|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G152| (|Vector| |polR|)) (|#G151| #1#) (|ss| (R)) (#2=#:G814 NIL)
          (VZ (|Vector| |polR|)) (#3=#:G805 NIL)
          (|degQ| #4=(|NonNegativeInteger|)) (|degP| #4#) (|#G150| #4#)
          (|#G149| #4#) (|#G148| (|polR|)) (|#G147| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#5=#:G803 NIL) (#6=#:G798 NIL) (|delta| (|NonNegativeInteger|))
          (#7=#:G796 NIL)
          (|l|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |subResultant| |polR|)))
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (SEQ G190 NIL
                        (SEQ
                         (PROGN
                          (LETT |#G147| (SPADCALL VP 1 (QREFELT $ 45)))
                          (LETT |#G148| (SPADCALL VQ 1 (QREFELT $ 45)))
                          (LETT P |#G147|)
                          (LETT Q |#G148|))
                         (EXIT
                          (COND
...
(SDEFUN |PRS;semiIndiceSubResultantEuclidean;2polRNniR;25|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G161| (|Vector| |polR|)) (|#G160| #1#) (|ss| (R)) (#2=#:G838 NIL)
          (VZ (|Vector| |polR|)) (#3=#:G827 NIL)
          (|degQ| #4=(|NonNegativeInteger|)) (|degP| #4#) (|#G159| #4#)
          (|#G158| #4#) (|#G157| (|polR|)) (|#G156| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#5=#:G825 NIL) (#6=#:G820 NIL) (|delta| (|NonNegativeInteger|))
          (#7=#:G818 NIL))
         (SEQ
          (EXIT
           (COND
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (SEQ G190 NIL
                          (SEQ
                           (PROGN
                            (LETT |#G156| (SPADCALL VP 1 (QREFELT $ 45)))
                            (LETT |#G157| (SPADCALL VQ 1 (QREFELT $ 45)))
                            (LETT P |#G156|)
                            (LETT Q |#G157|))
                           (EXIT
                            (COND
...
(SDEFUN |PRS;degreeSubResultant;2polRNnipolR;26|
        ...
        (SPROG
         ((|s| (R)) (|#G174| (|polR|)) (|#G173| (|polR|)) (Z (|polR|))
          (#1=#:G852 NIL) (#2=#:G859 NIL) (|#G172| (|polR|)) (|#G171| (|polR|))
          (#3=#:G849 NIL) (#4=#:G844 NIL) (|delta| (|NonNegativeInteger|))
          (#5=#:G842 NIL) (|#G170| (|polR|)) (|#G169| (|polR|)))
         (SEQ
          (EXIT
           (COND
            ((OR (SPADCALL Q (QREFELT $ 31)) (SPADCALL P (QREFELT $ 31)))
...
(SDEFUN |PRS;degreeSubResultantEuclidean;2polRNniR;27|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G184| (|Vector| |polR|)) (|#G183| #1#) (|ss| (R)) (#2=#:G876 NIL)
          (#3=#:G883 NIL) (|#G182| (|polR|)) (|#G181| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#4=#:G872 NIL) (#5=#:G867 NIL) (|delta| (|NonNegativeInteger|))
          (#6=#:G865 NIL)
          (|l|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |subResultant| |polR|))))
           ...
           (COND
            ...
            ('T
             (SEQ
              (COND
               ((< (SPADCALL P (QREFELT $ 20)) (SPADCALL Q (QREFELT $ 20)))
                (SEQ (LETT |l| (SPADCALL Q P |i| (QREFELT $ 69)))
                     (EXIT
                      (PROGN
                       (LETT #3#
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (SEQ G190 NIL
                        (SEQ
                         (PROGN
                          (LETT |#G181| (SPADCALL VP 1 (QREFELT $ 45)))
                          (LETT |#G182| (SPADCALL VQ 1 (QREFELT $ 45)))
                          (LETT P |#G181|)
                          (LETT Q |#G182|))
                         (COND
                          ((OR (SPADCALL Q (QREFELT $ 31))
...
(SDEFUN |PRS;semiDegreeSubResultantEuclidean;2polRNniR;28|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G191| (|Vector| |polR|)) (|#G190| #1#) (|ss| (R)) (#2=#:G898 NIL)
          (#3=#:G906 NIL) (|#G189| (|polR|)) (|#G188| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#4=#:G894 NIL) (#5=#:G889 NIL) (|delta| (|NonNegativeInteger|))
          (#6=#:G887 NIL))
         (SEQ
          (EXIT
           (COND
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (SEQ G190 NIL
                          (SEQ
                           (PROGN
                            (LETT |#G188| (SPADCALL VP 1 (QREFELT $ 45)))
                            (LETT |#G189| (SPADCALL VQ 1 (QREFELT $ 45)))
                            (LETT P |#G188|)
                            (LETT Q |#G189|))
                           (COND
                            ((OR (SPADCALL Q (QREFELT $ 31))
...
(SDEFUN |PRS;lastSubResultant;3polR;29| ((P |polR|) (Q |polR|) ($ |polR|))
        (SPROG
         ((|s| (R)) (|#G202| (|polR|)) (|#G201| (|polR|)) (#1=#:G920 NIL)
          (Z (|polR|)) (#2=#:G912 NIL) (|#G200| (|polR|)) (|#G199| (|polR|))
          (#3=#:G911 NIL) (|#G198| (|polR|)) (|#G197| (|polR|)))
         (SEQ
          (EXIT
           (COND
            ((OR (SPADCALL Q (QREFELT $ 31)) (SPADCALL P (QREFELT $ 31)))
...
(SDEFUN |PRS;lastSubResultantEuclidean;2polRR;30|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G208| (|Vector| |polR|)) (|#G207| #1#) (|ss| (R)) (#2=#:G941 NIL)
          (VZ (|Vector| |polR|)) (#3=#:G934 NIL) (Z (|polR|))
          (|#G206| (|polR|)) (|#G205| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#4=#:G932 NIL) (#5=#:G927 NIL) (|degP| (|NonNegativeInteger|))
          (|l|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |subResultant| |polR|))))
         (SEQ
           ...
           (COND
            ...
            ('T
             (SEQ
              (COND
               ((< (SPADCALL P (QREFELT $ 20)) (SPADCALL Q (QREFELT $ 20)))
                (SEQ (LETT |l| (SPADCALL Q P (QREFELT $ 72)))
                     (EXIT
                      (PROGN
                       (LETT #2#
                             (VECTOR (QVELT |l| 1) (QVELT |l| 0)
              ...
              (LETT VQ
                    (VECTOR (QVELT |pdiv| 2)
                            (SPADCALL (QVELT |pdiv| 0) (QREFELT $ 12))
                            (QVELT |pdiv| 1)))
              (LETT VZ (SPADCALL VP (QREFELT $ 73)))
              (EXIT
               (SEQ G190 NIL
                    (SEQ
                     (PROGN
                      (LETT |#G205| (SPADCALL VQ 1 (QREFELT $ 45)))
                      (LETT |#G206| (SPADCALL VZ 1 (QREFELT $ 45)))
                      (LETT Q |#G205|)
                      (LETT Z |#G206|))
                     (EXIT
                      (COND
...
(SDEFUN |PRS;semiLastSubResultantEuclidean;2polRR;31|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G214| (|Vector| |polR|)) (|#G213| #1#) (|ss| (R)) (#2=#:G961 NIL)
          (VZ (|Vector| |polR|)) (#3=#:G953 NIL) (Z (|polR|))
          (|#G212| (|polR|)) (|#G211| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
          (#4=#:G951 NIL) (#5=#:G946 NIL) (|degP| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (COND
            ((OR (SPADCALL Q (QREFELT $ 31)) (SPADCALL P (QREFELT $ 31)))
               ...
               (SEQ
                ...
                (EXIT
                 (SEQ G190 NIL
                      (SEQ
                       (PROGN
                        (LETT |#G211| (SPADCALL VQ 1 (QREFELT $ 45)))
                        (LETT |#G212| (SPADCALL VZ 1 (QREFELT $ 45)))
                        (LETT Q |#G211|)
                        (LETT Z |#G212|))
                       (EXIT
                        (COND
...
(SDEFUN |PRS;chainSubResultants;2polRL;32|
        ...
        (SPROG
         ((|s| (R)) (|#G224| (|polR|)) (|#G223| (|polR|)) (#1=#:G977 NIL)
          (L (|List| |polR|)) (Z (|polR|)) (|delta| (|NonNegativeInteger|))
          (#2=#:G969 NIL) (|#G222| (|polR|)) (|#G221| (|polR|)) (#3=#:G968 NIL)
          (|#G220| (|polR|)) (|#G219| (|polR|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PRS;schema;2polRL;33|
        ...
        (SPROG
         ((|s| (R)) (|#G232| (|polR|)) (|#G231| (|polR|)) (#1=#:G991 NIL)
          (L (|List| (|NonNegativeInteger|))) (Z (|polR|))
          (|delta| (|NonNegativeInteger|)) (#2=#:G983 NIL)
          (|e| (|NonNegativeInteger|)) (|#G230| (|polR|)) (|#G229| (|polR|))
          (#3=#:G982 NIL) (|#G228| (|polR|)) (|#G227| (|polR|)))
         (SEQ
          (EXIT
           (COND
            ((OR (SPADCALL Q (QREFELT $ 31)) (SPADCALL P (QREFELT $ 31))) NIL)
               ...
               (COND ((ZEROP (SPADCALL Q (QREFELT $ 20))) (LIST 0))
                     ('T
                      (SEQ (LETT L NIL)
                           ...
                           (PROGN
                            (LETT |#G229| Q)
                            (LETT |#G230| (SPADCALL P Q (QREFELT $ 50)))
                            (LETT P |#G229|)
                            (LETT Q |#G230|))
                           (EXIT
                            (SEQ G190 NIL
...
(SDEFUN |PRS;subResultantGcd;3polR;34| ((P |polR|) (Q |polR|) ($ |polR|))
        (SPROG
         ((|s| (R)) (|#G240| (|polR|)) (|#G239| (|polR|)) (Z (|polR|))
          (#1=#:G997 NIL) (#2=#:G1007 NIL) (|#G238| (|polR|))
          (|#G237| (|polR|)) (#3=#:G996 NIL) (|#G236| (|polR|))
          (|#G235| (|polR|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |PRS;subResultantGcdEuclidean;2polRR;35|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G246| (|Vector| |polR|)) (|#G245| #1#) (|ss| (R)) (#2=#:G1016 NIL)
          (#3=#:G1026 NIL) (|e| (|NonNegativeInteger|)) (|#G244| (|polR|))
          (|#G243| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
             ...
             (COND
              ...
              (#5='T
               (SEQ
                (COND
                 ((< (SPADCALL P (QREFELT $ 20)) (SPADCALL Q (QREFELT $ 20)))
                  (SEQ (LETT |l| (SPADCALL Q P (QREFELT $ 81)))
                       (EXIT
                        (PROGN
                         (LETT #3#
                               (VECTOR (QVELT |l| 1) (QVELT |l| 0)
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (SEQ G190 NIL
                          (SEQ
                           (PROGN
                            (LETT |#G243| (SPADCALL VP 1 (QREFELT $ 45)))
                            (LETT |#G244| (SPADCALL VQ 1 (QREFELT $ 45)))
                            (LETT P |#G243|)
                            (LETT Q |#G244|))
                           (EXIT
                            (COND
...
(SDEFUN |PRS;semiSubResultantGcdEuclidean2;2polRR;36|
        ...
        (SPROG
         ((|s| (R)) (VQ #1=(|Vector| |polR|)) (VP (|Vector| |polR|))
          (|#G252| (|Vector| |polR|)) (|#G251| #1#) (|ss| (R)) (#2=#:G1033 NIL)
          (#3=#:G1045 NIL) (|e| (|NonNegativeInteger|)) (|#G250| (|polR|))
          (|#G249| (|polR|))
          (|pdiv|
           (|Record| (|:| |coef| R) (|:| |quotient| |polR|)
                     (|:| |remainder| |polR|)))
...
(SDEFUN |PRS;semiSubResultantGcdEuclidean1;2polRR;37|
        ...
        (SPROG
         ((|result|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |gcd| |polR|))))
         (SEQ (LETT |result| (SPADCALL P Q (QREFELT $ 81)))
              (EXIT (CONS (QVELT |result| 0) (QVELT |result| 2)))))) 

(SDEFUN |PRS;discriminant;polRR;38| ((P |polR|) ($ R))
        (SPROG
         ((#1=#:G1062 NIL) (#2=#:G1057 NIL) (#3=#:G1053 NIL) (|d| (|Integer|))
          (|r| (R)) (|dP| (|polR|)) (|a| (|Integer|)) (#4=#:G1051 NIL))
         (SEQ
          (EXIT
                              ...
                              (EXPT -1
                                    (PROG1 (LETT #4# |a|)
                                      (|check_subtype2| (>= #4# 0)
                                                        '(|NonNegativeInteger|)
                                                        '(|Integer|) #4#))))
                        (LETT |dP| (SPADCALL P (QREFELT $ 86)))
                        (LETT |r| (SPADCALL P |dP| (QREFELT $ 52)))
...
(SDEFUN |PRS;discriminantEuclidean;polRR;39|
        ((P |polR|)
         ($ |Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
          (|:| |discriminant| R)))
        (SPROG
         ((#1=#:G1089 NIL) (|cr| (R)) (#2=#:G1082 NIL) (|c2| (|polR|))
          (#3=#:G1079 NIL) (|c1| (|polR|)) (#4=#:G1075 NIL) (#5=#:G1069 NIL)
          (#6=#:G1066 NIL) (|d| (|Integer|))
          (|rE|
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |resultant| R)))
          (|dP| (|polR|)) (|a| (|Integer|)) (#7=#:G1064 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |d| (SPADCALL P (QREFELT $ 20)))
                (EXIT
...
(SDEFUN |PRS;semiDiscriminantEuclidean;polRR;40|
        ...
        (SPROG
         ((#1=#:G1112 NIL) (|cr| (R)) (#2=#:G1105 NIL) (|c2| (|polR|))
          (#3=#:G1102 NIL) (#4=#:G1096 NIL) (#5=#:G1093 NIL) (|d| (|Integer|))
          (|rE| (|Record| (|:| |coef2| |polR|) (|:| |resultant| R)))
          (|dP| (|polR|)) (|a| (|Integer|)) (#6=#:G1091 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |d| (SPADCALL P (QREFELT $ 20)))
                (EXIT
                              ...
                              (EXPT -1
                                    (PROG1 (LETT #6# |a|)
                                      (|check_subtype2| (>= #6# 0)
                                                        ...
                                                        '(|Integer|) #6#))))
                        (LETT |dP| (SPADCALL P (QREFELT $ 86)))
                        (LETT |rE| (SPADCALL P |dP| (QREFELT $ 59)))
                        (LETT |d| (- (- |d| (SPADCALL |dP| (QREFELT $ 20))) 1))
                        (COND
                         ((ZEROP |d|)
                          (SEQ
...
(SDEFUN |PRS;resultantReduit;2polRR;41| ((P |polR|) (Q |polR|) ($ R))
        (SPROG
         ((#1=#:G1120 NIL) (#2=#:G1115 NIL) (|l| (|List| R)) (|UVs| (|polR|))
          (UV
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |gcd| |polR|))))
         (SEQ
          (EXIT
           (SEQ (LETT UV (SPADCALL P Q (QREFELT $ 81)))
                (LETT |UVs| (QVELT UV 2))
                (EXIT
                 (COND
...
(SDEFUN |PRS;resultantReduitEuclidean;2polRR;42|
        ((P |polR|) (Q |polR|)
         ($ |Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
          (|:| |resultantReduit| R)))
        (SPROG
         ((#1=#:G1133 NIL) (|rr| (R)) (#2=#:G1127 NIL) (|c2| (|polR|))
          (#3=#:G1124 NIL) (|c1| (|polR|)) (|gl| (R)) (|l| (|List| R))
          (|UVs| (|polR|))
          (UV
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |gcd| |polR|))))
...
(SDEFUN |PRS;semiResultantReduitEuclidean;2polRR;43|
        ...
        (SPROG
         ((#1=#:G1146 NIL) (|rr| (R)) (#2=#:G1140 NIL) (|c2| (|polR|))
          (#3=#:G1137 NIL) (|gl| (R)) (|l| (|List| R)) (|UVs| (|polR|))
          (UV
           (|Record| (|:| |coef1| |polR|) (|:| |coef2| |polR|)
                     (|:| |gcd| |polR|))))
         (SEQ
                    ...
                    (LETT |rr|
                          (PROG2
                            ...
                            (|check_union2| (QEQCAR #2# 0) (QREFELT $ 6)
                                            ...
                                            #2#)))
                    (EXIT
                     (PROGN (LETT #1# (CONS |c2| |rr|)) (GO #4=#:G1145)))))))))
          #4# (EXIT #1#)))) 

(SDEFUN |PRS;gcd_naif| ((P |polR|) (Q |polR|) ($ |polR|))
        (SPROG
         ((|#G272| (|polR|)) (|#G271| (|polR|)) (#1=#:G1156 NIL)
          (#2=#:G1148 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PRS;gcd;3polR;46| ((P |polR|) (Q |polR|) ($ |polR|))
        (SPROG ((G (|polR|)) (#1=#:G1159 NIL) (|cQ| (R)) (|cP| (R)))
               (SEQ
                (COND ((SPADCALL P (QREFELT $ 31)) Q)
                      ((SPADCALL Q (QREFELT $ 31)) P)
                      ('T
                       (SEQ (LETT |cP| (SPADCALL P (QREFELT $ 105)))
                            (LETT |cQ| (SPADCALL Q (QREFELT $ 105)))
                            (LETT P
                                  (PROG2
                                      (LETT #1#
                            ...
                            (LETT Q
                                  (PROG2
                                    ...
                                    (|check_union2| (QEQCAR #1# 0)
                                                    ...
                                                    (|Union| (QREFELT $ 7) #2#)
                                                    #1#)))
                            (LETT G (SPADCALL P Q (QREFELT $ 79)))
                            (EXIT
...
(DEFUN |PseudoRemainderSequence| (&REST #1=#:G1165)
  (SPROG NIL
         (PROG (#2=#:G1166)
           (RETURN
            (COND
