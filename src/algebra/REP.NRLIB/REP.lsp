...
(SDEFUN |REP;evalvect|
        ...
        (SPROG
         ((|v| (|Expression| (|Integer|))) (#1=#:G391 NIL) (|i| NIL)
...
(SDEFUN |REP;radicalEigenvector;EML;5|
        ...
        (SPROG
         ((#1=#:G406 NIL) (|v| NIL) (#2=#:G405 NIL) (#3=#:G404 NIL) (|j| NIL)
          (#4=#:G403 NIL) (|i| NIL) (B (|Matrix| (|Expression| (|Integer|))))
          (|n| (|NonNegativeInteger|)))
         ...
         ((|sln|
           (|List|
            (|Record| (|:| |radval| (|Expression| (|Integer|)))
                      ...
                      (|:| |radvect|
                           (|List| (|Matrix| (|Expression| (|Integer|))))))))
          (|nsl| #1#) (#2=#:G431 NIL) (|ep| NIL) (#3=#:G430 NIL)
          (#4=#:G429 NIL) (|alg| NIL)
          (|lval| (|List| (|Expression| (|Integer|)))) (|xx| (|Symbol|))
          (|sym| (|SuchThat| (|Symbol|) (|Polynomial| (|Integer|))))
          (#5=#:G411 NIL) (#6=#:G410 NIL)
          (|veclist| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (#7=#:G428 NIL) (|i| NIL) (|m| (|Matrix| (|Expression| (|Integer|))))
          (#8=#:G427 NIL) (|ll| NIL) (#9=#:G426 NIL) (|eig| NIL)
          (|n| (|NonNegativeInteger|))
          (|leig|
           (|List|
            (|Record|
...
(SDEFUN |REP;gramschmidt;2L;7|
        ...
        (SPROG
         ((|orth| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (|pol| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G439 NIL)
          (#2=#:G438 (RMR)) (#3=#:G440 (RMR)) (#4=#:G446 NIL) (|w| NIL)
          (#5=#:G445 NIL) (|v| (|Matrix| (|Expression| (|Integer|))))
          (RMR
           (|Join|
...
(SDEFUN |REP;eigenMatrix;MU;8|
        ...
        (SPROG
         ((|d| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G462 NIL) (|v| NIL)
          (|n| (|NonNegativeInteger|))
          (|lef| #2=(|List| (|Matrix| (|Expression| (|Integer|)))))
          (#3=#:G452 NIL) (#4=#:G451 #2#) (#5=#:G453 #2#) (#6=#:G461 NIL)
          (|eiv| NIL))
         (SEQ
          (LETT |lef|
                (PROGN
...
(SDEFUN |REP;orthonormalBasis;ML;9|
        ...
        (SPROG
         ((|basis| (|List| (|Matrix| (|Expression| (|Integer|)))))
          ...
          (#1=#:G471 NIL) (|alterm| NIL) (|n| (|NonNegativeInteger|))
          (|alglist|
           (|List|
            (|Record| (|:| |radval| (|Expression| (|Integer|)))
                      (|:| |radmult| (|Integer|))
