...
(SDEFUN |PSQFR;pPolRoot| ((|f| P) ($ P))
        (SPROG
         ((|uf| (|SparseUnivariatePolynomial| P)) (#1=#:G391 NIL)
...
(SDEFUN |PSQFR;pthPower| ((|f| P) ($ |Factored| P))
        (SPROG
         ((#1=#:G419 NIL) (|u| NIL) (#2=#:G418 NIL) (#3=#:G417 NIL)
          (#4=#:G416 NIL) (|psqfr| (|Factored| P)) (|isSq| (|Boolean|))
...
(SDEFUN |PSQFR;finSqFr| ((|f| P) (|lvar| |List| |VarSet|) ($ |Factored| P))
        (SPROG
         ((|pfaclist|
          ...
          (|flistfin1| (|List| #1#)) (#3=#:G441 NIL) (|uu| NIL) (#4=#:G440 NIL)
          (|listfin1| #2#) (|uexp| (|NonNegativeInteger|)) (#5=#:G439 NIL)
          (|u| NIL) (|squf| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|uf| (|SparseUnivariatePolynomial| P)) (#6=#:G421 NIL)
          (|mv| (|VarSet|)))
         (SEQ
          ...
          (|pfaclist|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#1=#:G462 NIL) (|u| NIL) (#2=#:G461 NIL)
          (|squp| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|up| (|SparseUnivariatePolynomial| P)) (#3=#:G447 NIL) (|cont| (P))
...
(DEFUN |PolynomialSquareFree| (&REST #1=#:G463)
  (SPROG NIL
         (PROG (#2=#:G464)
           (RETURN
            (COND
