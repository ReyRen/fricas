...
(SDEFUN |TRIGMNIP;complexKernels|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          (|u| (|Union| F "failed")) (#1=#:G407 NIL) (|k| NIL))
...
(SDEFUN |TRIGMNIP;kcomplex| ((|k| |Kernel| F) ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G423 NIL) (|u| (|Union| (|Integer|) "failed")) (|a| (F))
          (#2=#:G422 NIL) (|n| (F)) (|arg| (|List| F))
          (|op| (|BasicOperator|)))
...
(SDEFUN |TRIGMNIP;complexNormalize;FSF;9| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G437 NIL) (|g| (F)) (|k| NIL) (#2=#:G436 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;complexElementary;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G450 NIL) (|g| (F)) (|k| NIL) (#2=#:G449 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;localexplogs|
        ...
        (SPROG ((#1=#:G458 NIL) (|k| NIL) (#2=#:G457 NIL))
               (SEQ
...
(DEFUN |TrigonometricManipulations| (&REST #1=#:G462)
  (SPROG NIL
         (PROG (#2=#:G463)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 86
                                            '(0 7 0 9 1 7 0 0 10 1 7 0 0 11 0 7
                                              ...
                                              1 16 7 0 39 1 7 40 0 41 1 40 25 0
                                              42 1 44 43 7 45 0 6 0 46 0 7 0 47
                                              1 7 0 40 48 2 7 0 0 0 49 3 7 0 35
                                              0 0 50 2 7 0 35 0 51 2 7 0 0 0 52
                                              2 27 0 7 7 53 3 7 0 0 33 54 55 1
                                              20 27 19 56 2 35 25 0 37 57 1 58
                                              7 7 59 1 7 60 0 61 2 60 25 62 0
                                              63 2 58 7 7 37 64 1 7 0 23 65 1 7
                                              66 0 67 2 66 25 37 0 68 2 70 25
                                              69 0 71 2 73 72 19 37 74 1 20 7
                                              19 75 2 58 76 7 37 77 2 73 72 19
                                              66 79 2 58 76 7 66 80 2 20 19 19
                                              84 85 1 0 7 7 86 1 0 25 7 26 1 0
                                              7 7 30 1 0 7 7 32 2 0 7 7 37 78 1
                                              0 7 7 81 1 0 27 7 28 2 0 7 7 37
                                              82 1 0 7 7 83)))))
           '|lookupComplete|)) 
