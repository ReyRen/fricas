...
(SDEFUN |UPDECOMP;rightFactorIfCan0|
        ...
        (SPROG
         ((|q| (UP)) (#1=#:G393 NIL) (#2=#:G403 NIL)
          (|cquo| (|Union| R "failed")) (|c| (R)) (#3=#:G405 NIL) (|i| NIL)
          (#4=#:G404 NIL) (|k| NIL) (|lcp| (R)) (|s| (|NonNegativeInteger|))
...
(SDEFUN |UPDECOMP;rightFactorIfCan;UPNniRU;2|
        ((|p| UP) (|dq| |NonNegativeInteger|) (|lcq| R)
         ($ |Union| UP "failed"))
        (SPROG
         ((|q| (UP)) (#1=#:G428 NIL) (|cu| #2=(|Union| R "failed")) (|c| (R))
          (#3=#:G430 NIL) (|j| NIL) (|k| (|NonNegativeInteger|))
          (|k1| (|NonNegativeInteger|)) (|p1| (UP)) (|qn| (UP)) (|qn1| (UP))
          (#4=#:G429 NIL) (|i| NIL) (|cc2| (R)) (|cc1| (R)) (|cc0| (R))
          (|cc0u| #2#) (|lcn1| (R)) (|lcn| (R)) (|n1| (|NonNegativeInteger|))
          (#5=#:G411 NIL) (|nr| (R)) (|n| (|NonNegativeInteger|))
...
(SDEFUN |UPDECOMP;monicDecomposeIfCan;UPU;5|
        ...
        (SPROG
         ((#1=#:G462 NIL) (|g| (|Union| UP "failed"))
          (|h| (|Union| UP "failed")) (#2=#:G463 NIL) (#3=#:G450 NIL)
...
(DEFUN |UnivariatePolynomialDecompositionPackage| (&REST #1=#:G480)
  (SPROG NIL
         (PROG (#2=#:G481)
           (RETURN
            (COND
