...
(SDEFUN |INTLOCP;split|
        ((|z| . #1=(|Integer|))
         ($ |Record| (|:| |ppow| (|NonNegativeInteger|))
          (|:| |pfree| (|Integer|))))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|a| #1#) (#2=#:G412 NIL)
        ...
        (SPROG ((|q| (|Fraction| (|Integer|))) (|po| (|OutputForm|)))
               (SEQ
                (COND
                 ...
                 (#1='T
                  (SEQ (LETT |po| (SPADCALL (QREFELT $ 6) (QREFELT $ 34)))
                       (COND
                        ((SPADCALL (SPADCALL |x| (QREFELT $ 15)) 1
                                   (QREFELT $ 35))
                         (LETT |po|
                               (SPADCALL |po|
                                         (SPADCALL
          ...
          (COND
           ...
           ('T
            (SEQ (LETT |ex| (SPADCALL |x| (QREFELT $ 15)))
                 ...
                 (EXIT
                  (VECTOR (CONS |emax| (SPADCALL |ux| |uy| (QREFELT $ 49)))
                          |cx| |cy|)))))))) 

(DECLAIM (NOTINLINE |IntegerLocalizedAtPrime;|)) 

(DEFUN |IntegerLocalizedAtPrime| (#1=#:G544)
  (SPROG NIL
         (PROG (#2=#:G545)
           (RETURN
            (COND
...
(MAKEPROP '|IntegerLocalizedAtPrime| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|Boolean|) (|Integer|)
              (|IntegerPrimesPackage| 8) (0 . |prime?|) '#:G382
           ...
           (CONS
            ...
            (CONS
             '#(|EuclideanDomain&| NIL |GcdDomain&| NIL NIL NIL |EntireRing&|
                ...
                |AbelianSemiGroup&| NIL |SetCategory&| NIL |RetractableFrom&|
             ...
             (CONS
              '#((|EuclideanDomain|) (|PrincipalIdealDomain|) (|GcdDomain|)
                 ...
                 (|CommutativeStar|) (|SetCategory|) (|canonicalUnitNormal|)
                 (|RetractableFrom| 16) (|RetractableTo| 8) (|noZeroDivisors|)
