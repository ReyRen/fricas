...
(SDEFUN |JVF;coerce;$Of;6| ((|v| $) ($ |OutputForm|))
        (SPROG
         ((#1=#:G414 NIL) (|c| NIL) (#2=#:G415 NIL) (|jb| NIL) (#3=#:G413 NIL))
         (SEQ
          (COND
...
(SDEFUN |JVF;-;2$;13| ((|v| $) ($ $))
        (SPROG ((#1=#:G426 NIL) (|c| NIL) (#2=#:G425 NIL))
               (SEQ
                (CONS
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |JVF;+;3$;14| ((|v| $) (|w| $) ($ $))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G443 NIL) (|c1| NIL)
          (#2=#:G444 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JVF;*;D2$;15| ((|f| D) (|v| $) ($ $))
        (SPROG ((#1=#:G449 NIL) (|c| NIL) (#2=#:G448 NIL))
               (SEQ
...
(SDEFUN |JVF;prolong;$Nni$;16| ((|v| $) (|q| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|oldDir| (|List| JB)) (|oldCo| #1=(|List| D)) (|newDir| (|List| JB))
          (|newCo| #1#) (|res| ($)) (|newco| (D))
          (|nu| (|List| (|NonNegativeInteger|))) (#2=#:G510 NIL) (|i| NIL)
          (|j| (|Integer|)) (#3=#:G485 NIL) (|newjv| (JB)) (#4=#:G480 NIL)
          (#5=#:G478 NIL) (#6=#:G509 NIL) (|k| NIL)
          (|mu| (|List| (|NonNegativeInteger|))) (|a| (|PositiveInteger|))
          (|jm| (|SparseEchelonMatrix| JB D)) (#7=#:G507 NIL) (|jv| NIL)
          (#8=#:G508 NIL) (|co| NIL) (#9=#:G506 NIL) (|qq| NIL)
          (#10=#:G469 NIL) (#11=#:G505 NIL) (#12=#:G504 NIL) (#13=#:G503 NIL)
          (#14=#:G501 NIL) (#15=#:G502 NIL) (#16=#:G458 NIL) (#17=#:G500 NIL)
          (#18=#:G499 NIL) (|dxi| (|Matrix| D))
          (|ind2| #19=(|List| (|PositiveInteger|))) (|eta| #1#) (|ind1| #19#)
          (|xi| #1#) (|jt| (|Symbol|)) (#20=#:G497 NIL) (#21=#:G498 NIL)
                      ...
                      (SEQ (LETT |co| NIL) (LETT #21# |coeffs|) (LETT |jv| NIL)
                           ...
                           (COND
                            ((OR (ATOM #20#) (PROGN (LETT |jv| (CAR #20#)) NIL)
                             ...
                             (GO G191)))
                           (SEQ (LETT |jt| (SPADCALL |jv| (QREFELT $ 65)))
                                (EXIT
                                 (COND
                                  ((EQUAL |jt| '|Indep|)
...
(SDEFUN |JVF;eval;$2D;17| ((|v| $) (|f| D) ($ D))
        (SPROG
         ((|res| (D)) (#1=#:G514 NIL) (|c| NIL) (#2=#:G515 NIL) (|jb| NIL))
...
(SDEFUN |JVF;commutator;3$;18| ((|v| $) (|w| $) ($ $))
        (SPROG
         ((|res2| ($)) (|rjb| (|List| JB)) (|rco| (|List| D)) (|sum| (D))
          (#1=#:G532 NIL) (|c1| NIL) (#2=#:G533 NIL) (|j1| NIL) (#3=#:G530 NIL)
          (|c2| NIL) (#4=#:G531 NIL) (|j2| NIL) (|res1| ($)) (#5=#:G528 NIL)
          (#6=#:G529 NIL) (#7=#:G526 NIL) (#8=#:G527 NIL))
...
(SDEFUN |JVF;table;LTda;19| ((|lv| |List| $) ($ |TwoDimensionalArray| $))
        (SPROG
         ((|c| ($)) (#1=#:G542 NIL) (|v2| NIL) (|j| NIL) (|v1| ($)) (|i| NIL)
          (#2=#:G541 NIL) (|res| (|TwoDimensionalArray| $))
          (|len| (|NonNegativeInteger|)))
         (SEQ (LETT |len| (SPADCALL |lv| (QREFELT $ 91)))
              (EXIT
                     ...
                     ('T
                      (SEQ
                       ...
                       (SEQ (LETT #2# NIL) (LETT |i| 1) G190
                            (COND (#2# (GO G191)))
                            (SEQ (LETT |v1| (SPADCALL |lv| (QREFELT $ 94)))
                                 (LETT |lv| (SPADCALL |lv| (QREFELT $ 95)))
                                 (EXIT
...
(DEFUN |JetVectorField| (&REST #1=#:G548)
  (SPROG NIL
         (PROG (#2=#:G549)
           (RETURN
            (COND
...
(DEFUN |JetVectorField;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G547 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
