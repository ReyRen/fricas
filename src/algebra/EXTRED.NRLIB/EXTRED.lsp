...
(SDEFUN |EXTRED;denominatorFreeTopReduce|
        ((|x| |Record| (|:| |poly| R) (|:| |repr| (|Vector| R)) (|:| |mult| C))
         ...
         ($ |Record| (|:| |poly| R) (|:| |repr| (|Vector| R)) (|:| |mult| C)))
        (SPROG
         ((#2=#:G415 NIL) (|bas| #1#) (|f2| (R)) (|f1| (C)) (|a| (C))
         ...
         ((|x|
          ...
          (|bas|
           (|List|
            (|Record| (|:| |poly| R) (|:| |repr| (|Vector| R))
                      (|:| |mult| C))))
          (#1=#:G429 NIL) (|b| NIL) (#2=#:G430 NIL) (|i| NIL) (#3=#:G428 NIL)
...
(DEFUN |ExtendedPolynomialReduction| (&REST #1=#:G431)
  (SPROG NIL
         (PROG (#2=#:G432)
           (RETURN
            (COND
