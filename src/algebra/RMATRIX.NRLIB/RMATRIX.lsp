...
(SDEFUN |RMATRIX;matrix;L$;3| ((|l| |List| (|List| R)) ($ $))
        (SPROG
         ((#1=#:G399 NIL) (|j| NIL) (#2=#:G400 NIL) (|r| NIL) (#3=#:G397 NIL)
          (|i| NIL) (#4=#:G398 NIL) (|ll| NIL) (|ans| (|Matrix| R))
          (#5=#:G395 NIL) (#6=#:G396 NIL))
         (SEQ
          (COND
...
(SDEFUN |RMATRIX;columnSpace;$L;9| ((|x| $) ($ |List| (|DirectProduct| |m| R)))
        (SPROG ((#1=#:G412 NIL) (|c| NIL) (#2=#:G411 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |RMATRIX;nullSpace;$L;12| ((|x| $) ($ |List| (|DirectProduct| |m| R)))
        (SPROG ((#1=#:G418 NIL) (|c| NIL) (#2=#:G417 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |RectangularMatrix| (&REST #1=#:G433)
  (SPROG NIL
         (PROG (#2=#:G434)
           (RETURN
            (COND
...
(DEFUN |RectangularMatrix;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G432 NIL) (|pv$| NIL) (#2=#:G428 NIL) (#3=#:G429 NIL) (#4=#:G431 NIL)
