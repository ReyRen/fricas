...
(SDEFUN |MLIFT;corrPoly;SupLLLLMU;1|
        ...
        (SPROG
         ((|diff| (|SparseUnivariatePolynomial| P)) (#2=#:G439 NIL)
          (#3=#:G438 #4=(|SparseUnivariatePolynomial| P)) (#5=#:G440 #4#)
          (#6=#:G459 NIL) (|i| NIL)
          (|lcoef| (|List| (|SparseUnivariatePolynomial| P))) (#7=#:G458 NIL)
          (#8=#:G457 NIL) (|beta| (|List| (|SparseUnivariatePolynomial| P)))
          (#9=#:G447 NIL)
          (|fbeta|
           #10=(|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|ddiff| #11=(|SparseUnivariatePolynomial| P))
          (|pol| (|SparseUnivariatePolynomial| P)) (#12=#:G456 NIL) (|l| NIL)
          (#13=#:G412 NIL) (#14=#:G411 #4#) (#15=#:G413 #4#) (#16=#:G455 NIL)
          (|polc| (|SparseUnivariatePolynomial| P))
          (|listcong| (|List| (|SparseUnivariatePolynomial| P)))
          (#17=#:G408 NIL) (#18=#:G407 #19=(|SparseUnivariatePolynomial| P))
          (#20=#:G409 #19#) (#21=#:G454 NIL) (#22=#:G453 NIL) (#23=#:G452 NIL)
          (|flcoef| #10#) (|um| #11#)
          (|listpolv| (|List| (|SparseUnivariatePolynomial| P)))
          (#24=#:G451 NIL) (|f1| NIL) (#25=#:G450 NIL) (|y| (OV)) (|a| (P))
          (|np| (|NonNegativeInteger|)) (|deg1| (|NonNegativeInteger|))
          (#26=#:G449 NIL) (|mp| NIL) (#27=#:G448 NIL)
           ...
           (COND
            ((EQL (LENGTH |lvar|) 0)
             (SEQ
              ...
              (COND
               ((QEQCAR |lp| 1)
                (PROGN (LETT #9# (CONS 1 "failed")) (GO #28=#:G446))))
              (EXIT
               (LETT |lcoef|
                     (CONS 0
                           (PROGN
...
(SDEFUN |MLIFT;lifting1|
        ((|m| |SparseUnivariatePolynomial| P) (|lvar| . #1=(|List| OV))
         ...
         ($ |Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
        (SPROG
         ((#5=#:G492 NIL) (|idegj| (|Integer|)) (#6=#:G511 NIL) (|term| NIL)
          (#7=#:G509 NIL) (#8=#:G510 NIL) (|alpha| NIL) (#9=#:G508 NIL)
          (|lalpha| #10=(|List| (|SparseUnivariatePolynomial| P)))
          (|flalpha|
           (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|mc| (|SparseUnivariatePolynomial| P)) (#11=#:G491 NIL)
          (#12=#:G474 NIL) (#13=#:G473 #2#) (#14=#:G475 #2#) (#15=#:G507 NIL)
          (|pol| (P)) (#16=#:G506 NIL) (|k| NIL) (|polc| (P))
          (|mj| (|SparseUnivariatePolynomial| P)) (#17=#:G504 NIL) (|tpol| NIL)
          (#18=#:G505 NIL) (|clist| NIL) (#19=#:G503 NIL) (#20=#:G501 NIL)
          (|p| NIL) (#21=#:G502 NIL) (|lcp| NIL) (#22=#:G500 NIL)
          (|clv|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          (|tlv| (|List| P)) (|#G41| #4#) (|#G40| #3#) (#23=#:G499 NIL)
          (#24=#:G498 NIL) (#25=#:G497 NIL) (#26=#:G496 NIL) (#27=#:G495 NIL)
          (#28=#:G494 NIL) (|subsval| (|List| R)) (|subsvar| (|List| OV))
          (|ldeg| (|List| (|NonNegativeInteger|)))
          (|degj| (|NonNegativeInteger|)) (|v| (R)) (|conglist| #10#)
          (|li| #1#) (|x| (OV)) (#29=#:G493 NIL) (|j| NIL)
         ...
         ((#1=#:G542 NIL)
          ...
          (|coeflist|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          (#2=#:G530 NIL) (#3=#:G527 NIL)
          (#4=#:G526 #5=(|SparseUnivariatePolynomial| P)) (#6=#:G528 #5#)
          (#7=#:G547 NIL) (|pol| NIL)
          (|nplist| (|List| (|SparseUnivariatePolynomial| P))) (#8=#:G546 NIL)
          (|pp| NIL) (#9=#:G545 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ
            (LETT |nplist|
                  (PROGN
                   ...
                   (SEQ (LETT |pp| NIL) (LETT #10# |plist|) G190
                        (COND
                         ((OR (ATOM #10#) (PROGN (LETT |pp| (CAR #10#)) NIL))
                          (GO G191)))
                        (SEQ
                         (EXIT
                          (LETT #11#
                  ...
                  (SEQ
                   (COND
                    ((EQL (LENGTH |listdet|) (LENGTH |plist|))
                     (PROGN (LETT #1# (CONS 0 |listdet|)) (GO #12=#:G541))))
                   (LETT |plist| (QVELT |ldcoef| 2))
                   (LETT |nplist|
                         (PROGN
                          (LETT #9# NIL)
                          (SEQ (LETT |pp| NIL) (LETT #8# |plist|) G190
                               (COND
                                ((OR (ATOM #8#)
                                     (PROGN (LETT |pp| (CAR #8#)) NIL))
                                 (GO G191)))
                               (SEQ
                                (EXIT
                                 (LETT #9#
            ...
            (COND
             ((QEQCAR |ffl| 1) (PROGN (LETT #1# (CONS 1 "failed")) (GO #12#))))
...
(SDEFUN |MLIFT;gen_solv|
        ...
        (SPROG
         ((|table| (|Vector| (|List| (|SparseUnivariatePolynomial| R))))
          ...
          (|ldeg| (|List| (|NonNegativeInteger|))) (#1=#:G567 NIL) (|p| NIL)
          (#2=#:G566 NIL))
         (SEQ
          (LETT |ldeg|
                (PROGN
                 ...
                 (SEQ (LETT |p| NIL) (LETT #1# |plist|) G190
                      ...
                      (EXIT (NREVERSE #2#)))))
          (LETT |du| (SPADCALL (ELT $ 71) |ldeg| (QREFELT $ 73)))
          (LETT |tab| (SPADCALL |du| |pmod| |plist| (QREFELT $ 76)))
          (EXIT
           (COND
...
(SDEFUN |MLIFT;normalDeriv|
        ...
        (SPROG
         ((|n| #1=(|Integer|)) (|ris| (|SparseUnivariatePolynomial| P))
          (#2=#:G581 NIL) (|n1| #1#) (|k| (|Integer|))
          (|#G1| (|NonNegativeInteger|)))
         (SEQ (LETT |#G1| (SPADCALL |f| (QREFELT $ 83))) (LETT |n1| |#G1|)
              (EXIT
               (COND ((< |#G1| |m|) (|spadConstant| $ 44))
                     ((EQL |n1| |m|)
                      (SPADCALL (SPADCALL |f| (QREFELT $ 55)) (QREFELT $ 42)))
                     ('T
                      (SEQ (LETT |k| (SPADCALL |n1| |m| (QREFELT $ 85)))
...
(SDEFUN |MLIFT;subscoef|
        ...
        (SPROG
         ((|new| (|SparseUnivariatePolynomial| P)) (|i| (|NonNegativeInteger|))
          (#1=#:G590 NIL) (|k| NIL) (|dm| (|NonNegativeInteger|)))
...
(DEFUN |MultivariateLifting| (&REST #1=#:G597)
  (SPROG NIL
         (PROG (#2=#:G598)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 89
                                            '(1 9 8 0 10 2 14 11 12 13 15 1 9 0
                                              ...
                                              2 27 0 0 0 66 1 11 32 0 69 2 11 0
                                              0 0 70 2 32 0 0 0 71 2 26 32 72 0
