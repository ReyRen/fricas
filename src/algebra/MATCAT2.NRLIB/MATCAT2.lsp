...
(SDEFUN |MATCAT2;map;MM1M2;1| ((|f| |Mapping| R2 R1) (|m| M1) ($ M2))
        (SPROG
         ((#1=#:G389 NIL) (|j| NIL) (#2=#:G390 NIL) (|l| NIL) (#3=#:G387 NIL)
          (|i| NIL) (#4=#:G388 NIL) (|k| NIL) (|ans| (M2)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |MATCAT2;map;MM1U;2|
        ((|f| |Mapping| (|Union| R2 "failed") R1) (|m| M1)
         ($ |Union| M2 "failed"))
        (SPROG
         ((#1=#:G395 NIL) (#2=#:G409 NIL) (|r| (|Union| R2 #3="failed"))
          (#4=#:G412 NIL) (|j| NIL) (#5=#:G413 NIL) (|l| NIL) (#6=#:G410 NIL)
          (|i| NIL) (#7=#:G411 NIL) (|k| NIL) (|ans| (M2)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |ans|
...
(SDEFUN |MATCAT2;reduce;MM12R2;3|
        ...
        (SPROG ((|s| (R2)) (#1=#:G420 NIL) (|j| NIL) (#2=#:G419 NIL) (|i| NIL))
               (SEQ (LETT |s| |ident|)
...
(DEFUN |MatrixCategoryFunctions2| (&REST #1=#:G421)
  (SPROG NIL
         (PROG (#2=#:G422)
           (RETURN
            (COND
