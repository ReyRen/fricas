...
(SDEFUN |LEADCDET;polCase;ZNniLB;1|
        ...
        (SPROG
         ((|distlist| (|List| Z)) (#1=#:G403 NIL) (|q| (Z)) (#2=#:G393 NIL)
          (|y| (Z)) (#3=#:G391 NIL) (#4=#:G405 NIL) (#5=#:G390 NIL) (|j| NIL)
          (#6=#:G404 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |LEADCDET;checkpow| ((|a| Z) (|b| Z) ($ |NonNegativeInteger|))
        (SPROG ((#1=#:G413 NIL) (|qt| (|Union| Z "failed")) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LEADCDET;distribute|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|i| NIL) (#2=#:G416 NIL) (|d| (Z)) (|lcp| (Z))
          (#3=#:G424 NIL) (|nf| (|NonNegativeInteger|)))
...
(SDEFUN |LEADCDET;distFact;ZLRLLLU;4|
        ((|contm| Z) (|unilist| |List| (|SparseUnivariatePolynomial| Z))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G467 NIL) (|i| NIL) (#2=#:G466 NIL) (#3=#:G457 NIL)
          (#4=#:G465 NIL) (|k| NIL) (|c| (Z)) (#5=#:G438 NIL) (|d| (Z))
          (|h| (|NonNegativeInteger|)) (#6=#:G464 NIL) (#7=#:G463 NIL)
          (|aux| (|List| P)) (#8=#:G462 NIL) (#9=#:G461 NIL) (|vlp| (|List| Z))
          (#10=#:G460 NIL) (#11=#:G459 NIL) (|lexp| (|List| (|Integer|)))
          (|lpol| (|List| P)) (#12=#:G458 NIL) (|fpl| NIL)
...
(DEFUN |LeadingCoefDetermination| (&REST #1=#:G468)
  (SPROG NIL
         (PROG (#2=#:G469)
           (RETURN
            (COND
