...
(SDEFUN |SYMANA;ansatz;Jvf;1|
        ...
        (SPROG
         ((|res| (|JetVectorField| JB1 (|JetBundleExpression| JB1)))
          (#1=#:G411 NIL) (|f| (|JetBundleExpression| JB1)) (|s| (|Symbol|))
          (#2=#:G417 NIL) (|i| NIL) (#3=#:G407 NIL) (#4=#:G416 NIL))
...
(SDEFUN |SYMANA;transform;JbeJbe;2|
        ...
        (SPROG
         ((|g| (|Expression| (|Integer|)))
          ...
          (|lower| (|List| (|PositiveInteger|))) (#1=#:G453 NIL)
          (|id| #2=(|Integer|)) (#3=#:G469 NIL) (|d| NIL)
          (|up| (|PositiveInteger|)) (#4=#:G451 NIL) (#5=#:G449 NIL)
          (|diff| (|List| (|JetBundleExpression| JB1)))
          (|rarg| (|List| (|JetBundleExpression| JB1)))
          (|arg| (|List| (|JetBundleExpression| JB1))) (#6=#:G468 NIL)
          (|i| NIL) (|num| #2#) (|pos| (|Integer|)) (|fname| (|Symbol|))
          (#7=#:G440 NIL) (#8=#:G430 NIL) (#9=#:G426 NIL) (|ind| #2#)
          (|typ| (|Symbol|)) (#10=#:G420 NIL) (#11=#:G466 NIL) (|Ke| NIL)
          (#12=#:G467 NIL) (|Op| NIL) (|LOps| (|List| (|BasicOperator|)))
          (#13=#:G465 NIL) (#14=#:G464 NIL)
...
(SDEFUN |SYMANA;detSys;LL;3|
        ...
        (SPROG
         ((#1=#:G477 NIL) (|eq| NIL) (#2=#:G476 NIL)
          (|ds| (|List| (|JetBundleExpression| JB1))) (#3=#:G475 NIL)
          (#4=#:G474 NIL))
         (SEQ
          (LETT |ds|
                (SPADCALL |sys|
...
(SDEFUN |SYMANA;detSys;LJvfL;4|
        ...
        (SPROG ((#1=#:G481 NIL) (|eq| NIL) (#2=#:G480 NIL))
               (SEQ
                (SPADCALL |sys|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SYMANA;ncDetSys;LL;6|
        ((|sys| |List| (|JetBundleExpression| JB1))
         ($ |List| (|JetBundleExpression| (|JetBundleSymAna| JB1 |xi| |eta|))))
        (SPROG
         ((#1=#:G551 NIL) (|eq| NIL) (#2=#:G550 NIL)
          (|ds| (|List| (|JetBundleExpression| JB1))) (#3=#:G549 NIL)
          (#4=#:G548 NIL))
         (SEQ
          (LETT |ds|
                (SPADCALL |sys|
...
(SDEFUN |SYMANA;ncDetSys;LJvfL;7|
        ((|sys| |List| (|JetBundleExpression| JB1))
         (|vf| |JetVectorField| JB1 (|JetBundleExpression| JB1))
         ($ |List| (|JetBundleExpression| JB1)))
        (SPROG ((#1=#:G555 NIL) (|eq| NIL) (#2=#:G554 NIL))
               (SEQ
                (SPADCALL |sys|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SYMANA;ncDetSys;LLJvfL;8|
        ...
        (SPROG
         ((|isc| #1=(|List| (|JetBundleExpression| JB1))) (|ijb| (|List| JB1))
          (|cond| (|JetBundleExpression| JB1)) (|jv| (JB1)) (#2=#:G567 NIL)
          (#3=#:G583 NIL) (|x| NIL) (#4=#:G584 NIL) (|i| NIL) (#5=#:G581 NIL)
          (|e| NIL) (#6=#:G582 NIL) (|j| (|Integer|)) (|Eta| #1#)
          (#7=#:G580 NIL) (#8=#:G578 NIL) (|co| NIL) (#9=#:G579 NIL)
          (|ind2| #10=(|List| (|PositiveInteger|))) (|tmp| #1#) (|ind1| #10#)
          (|Xi| #1#) (|jt| (|Symbol|)) (#11=#:G576 NIL) (#12=#:G577 NIL)
...
(DEFUN |SymmetryAnalysis| (&REST #1=#:G597)
  (SPROG NIL
         (PROG (#2=#:G598)
           (RETURN
            (COND
...
(DEFUN |SymmetryAnalysis;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G596 NIL) (|jv| NIL) (#2=#:G595 NIL) (#3=#:G594 NIL) (|i| NIL)
    (#4=#:G593 NIL) (#5=#:G592 NIL) (#6=#:G591 NIL) (#7=#:G590 NIL)
    (#8=#:G589 NIL) (#9=#:G400 NIL) (#10=#:G588 NIL) (#11=#:G587 NIL)
    (#12=#:G397 NIL) (#13=#:G586 NIL) (#14=#:G585 NIL) (|pv$| NIL) ($ NIL)
