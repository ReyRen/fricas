...
(SDEFUN |GCNAALG;eval|
        ...
        (SPROG
         ((|bot| #1=(|Polynomial| R)) (|top| #1#)
          (|lEq| (|List| (|Equation| (|Polynomial| R)))) (#2=#:G397 NIL)
          (|i| NIL) (#3=#:G396 NIL) (|s| NIL) (#4=#:G395 NIL)
...
(SDEFUN |GCNAALG;genericLeftDiscriminant;F;3| (($ |Fraction| (|Polynomial| R)))
        (SPROG
         ((|m| (|Matrix| (|Fraction| (|Polynomial| R)))) (#1=#:G406 NIL)
          (|a| NIL) (#2=#:G405 NIL) (#3=#:G404 NIL) (|b| NIL) (#4=#:G403 NIL)
          (|listBasis| (|List| $)))
         (SEQ
          (LETT |listBasis|
...
(SDEFUN |GCNAALG;genericRightDiscriminant;F;5|
        (($ |Fraction| (|Polynomial| R)))
        (SPROG
         ((|m| (|Matrix| (|Fraction| (|Polynomial| R)))) (#1=#:G415 NIL)
          (|a| NIL) (#2=#:G414 NIL) (#3=#:G413 NIL) (|b| NIL) (#4=#:G412 NIL)
          (|listBasis| (|List| $)))
         (SEQ
          (LETT |listBasis|
                (SPADCALL (SPADCALL (QREFELT $ 56)) (QREFELT $ 59)))
...
(SDEFUN |GCNAALG;generic;VV$;19|
        ...
        (SPROG
         ((|v| (|Vector| (|Polynomial| R))) (#1=#:G452 NIL) (#2=#:G454 NIL)
          (|i| NIL) (#3=#:G453 NIL))
         (SEQ
          (COND
...
(SDEFUN |GCNAALG;generic;SV$;20| ((|s| |Symbol|) (|ve| |Vector| $) ($ $))
        (SPROG
         ((|sFC| (|Vector| (|Symbol|))) (#1=#:G461 NIL) (#2=#:G463 NIL)
          (|i| NIL) (#3=#:G462 NIL) (|lON| (|List| (|String|))) (#4=#:G460 NIL)
          (|q| NIL) (#5=#:G459 NIL))
         (SEQ
          (LETT |lON|
                (PROGN
...
(SDEFUN |GCNAALG;generic;V$;21| ((|ve| |Vector| $) ($ $))
        (SPROG
         ((|v| (|Vector| (|Polynomial| R))) (#1=#:G475 NIL) (#2=#:G477 NIL)
          (|i| NIL) (#3=#:G476 NIL) (|sFC| (|Vector| (|Symbol|)))
          (#4=#:G472 NIL) (#5=#:G474 NIL) (#6=#:G473 NIL)
          (|lON| (|List| (|String|))) (#7=#:G471 NIL) (|q| NIL)
          (#8=#:G470 NIL))
         (SEQ
          (LETT |lON|
                (PROGN
...
(DEFUN |GenericNonAssociativeAlgebra| (&REST #1=#:G495)
  (SPROG NIL
         (PROG (#2=#:G496)
           (RETURN
            (COND
...
(DEFUN |GenericNonAssociativeAlgebra;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|v| NIL) (#1=#:G492 NIL) (#2=#:G494 NIL) (|i| NIL) (#3=#:G493 NIL)
    (#4=#:G489 NIL) (#5=#:G491 NIL) (#6=#:G490 NIL) (#7=#:G488 NIL) (|q| NIL)
    (#8=#:G487 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (SEQ
    (PROGN
