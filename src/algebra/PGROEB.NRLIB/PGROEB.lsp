...
(SDEFUN |PGROEB;lexGroebner;LLL;1|
        ((|lp| |List| (|Polynomial| F)) (|lv| |List| (|Symbol|))
         ($ |List| (|Polynomial| F)))
        (SPROG
         ((#1=#:G389 NIL) (|pp| NIL) (#2=#:G388 NIL) (|gb| (|List| |DPoly|))
          (|b| (|List| |DPoly|)) (#3=#:G387 NIL) (|pol| NIL) (#4=#:G386 NIL)
          (OV
...
(SDEFUN |PGROEB;totalGroebner;LLL;2|
        ((|lp| |List| (|Polynomial| F)) (|lv| |List| (|Symbol|))
         ($ |List| (|Polynomial| F)))
        (SPROG
         ((#1=#:G397 NIL) (|pp| NIL) (#2=#:G396 NIL) (|gb| (|List| |HDPoly|))
          (|b| (|List| |HDPoly|)) (#3=#:G395 NIL) (|pol| NIL) (#4=#:G394 NIL)
          (OV
           (|Join| (|OrderedFinite|) (|ConvertibleTo| (|Symbol|))
                   (|ConvertibleTo| (|InputForm|))
                   (|ConvertibleTo| (|Pattern| (|Float|)))
