...
(SDEFUN |NLINSOL;solveInField;LL;1|
        ...
        (SPROG
         ((#1=#:G388 NIL) (#2=#:G387 #3=(|List| (|Symbol|))) (#4=#:G389 #3#)
          (#5=#:G391 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;solve;LL;2|
        ((|l| |List| (|Polynomial| R))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG
         ((#1=#:G393 NIL) (#2=#:G392 #3=(|List| (|Symbol|))) (#4=#:G394 #3#)
          (#5=#:G396 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;solve;LLL;3|
        ((|lp| |List| (|Polynomial| R)) (|lv| |List| (|Symbol|))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG ((#1=#:G400 NIL) (|sol| NIL) (#2=#:G399 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |NLINSOL;addRoot|
        ((|eq| |Equation| (|Fraction| (|Polynomial| R)))
         ...
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG ((#1=#:G404 NIL) (|sol| NIL) (#2=#:G403 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |NLINSOL;evalSol|
        ...
        (SPROG ((#1=#:G408 NIL) (|eq| NIL) (#2=#:G407 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |NLINSOL;allRoots|
        ((|l| |List| (|Polynomial| R))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG
         ((#1=#:G417 NIL) (|a| NIL) (#2=#:G416 NIL)
          (|s| (|Fraction| (|Polynomial| R))) (#3=#:G410 NIL)
          (|p| (|Polynomial| R))
...
(SDEFUN |NLINSOL;RIfCan|
        ...
        (SPROG ((#1=#:G447 NIL) (|d| #2=(|Union| R "failed")) (|n| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |NLINSOL;solveInField;LLL;13|
        ((|lp| |List| (|Polynomial| R)) (|lv| |List| (|Symbol|))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG ((#1=#:G455 NIL) (|p| NIL) (#2=#:G454 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |NonLinearSolvePackage| (#1=#:G456)
  (SPROG NIL
         (PROG (#2=#:G457)
           (RETURN
            (COND
