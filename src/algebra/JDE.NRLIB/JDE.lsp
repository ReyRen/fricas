...
(SDEFUN |JDE;adapt|
        ...
        (SPROG
         ((|resPro?| (|List| (|Boolean|)))
          ...
          (#1=#:G444 NIL) (|i| NIL) (#2=#:G443 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G442 NIL) (#4=#:G441 NIL)
          (#5=#:G440 NIL) (|d| NIL) (#6=#:G439 NIL) (#7=#:G438 NIL)
          (#8=#:G437 NIL) (#9=#:G436 NIL))
         (SEQ
          (COND
           ((QEQCAR |dep| 0)
            (CONS
...
(SDEFUN |JDE;copy;2$;3| ((|De| $) ($ $))
        (SPROG
         ((|newOrd| (|List| (|NonNegativeInteger|)))
          (|newSys| (|List| |SysRec|)) (#1=#:G455 NIL) (|sys| NIL)
          (#2=#:G454 NIL))
         (SEQ
          (LETT |newSys|
                (PROGN
...
(SDEFUN |JDE;retract;$L;5| ((|De| $) ($ |List| D))
        (SPROG
         ((|LSys| (|List| (|List| D))) (#1=#:G464 NIL) (|sys| NIL)
          (#2=#:G463 NIL))
         (SEQ
          (LETT |LSys|
                (PROGN
...
(SDEFUN |JDE;jacobiMatrix;$L;6|
        ...
        (SPROG ((#1=#:G468 NIL) (|sys| NIL) (#2=#:G467 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |sys| NIL) (LETT #1# (QCAR |De|)) G190
...
(SDEFUN |JDE;printSys;LOf;7| ((|sys| |List| D) ($ |OutputForm|))
        (SPROG
         ((|tmp| (|List| (|OutputForm|))) (#1=#:G476 NIL) (|eq| NIL)
          (|leq| (|List| (|Equation| D))) (#2=#:G475 NIL) (#3=#:G474 NIL))
         (SEQ
...
(SDEFUN |JDE;display;$V;9| ((|De| $) ($ |Void|))
        (SPROG ((#1=#:G484 NIL) (|sys| NIL) (#2=#:G485 NIL) (|ord| NIL))
               (SEQ
...
(SDEFUN |JDE;makeSystem2|
        ...
        (SPROG
         ((|resSys| (|List| |SysRec|)) (|rec| (|SysRec|)) (#1=#:G506 NIL)
          (|ord| NIL) (|i| NIL) (|pos| (|Integer|)) (#2=#:G503 NIL) (|eq| NIL)
          (#3=#:G504 NIL) (#4=#:G505 NIL) (|q| NIL) (|j| NIL)
          (|vjm| (|Vector| (|SparseEchelonMatrix| JB D)))
          (|vder| (|Vector| (|List| (|NonNegativeInteger|))))
          (|vsys| (|Vector| (|List| D)))
          (|ljm| (|List| (|SparseEchelonMatrix| JB D))) (|inds| (|List| JB))
          (#5=#:G502 NIL) (|nord| (|NonNegativeInteger|))
          (|resOrd| (|List| (|NonNegativeInteger|)))
          (|lord| (|List| (|NonNegativeInteger|))) (#6=#:G501 NIL)
          (#7=#:G500 NIL))
         (SEQ
          (LETT |lord|
                (PROGN
...
(SDEFUN |JDE;makeSystem;L$;11| ((|sys| |List| D) ($ $))
        (SPROG
         ((|jm| (|SparseEchelonMatrix| JB D))
          (|der| (|List| (|NonNegativeInteger|))) (#1=#:G515 NIL) (|eq| NIL)
          (#2=#:G514 NIL) (|nsys| (|List| D)) (#3=#:G513 NIL) (#4=#:G512 NIL))
         (SEQ
...
(SDEFUN |JDE;dimension;$2Nni;14|
        ...
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G542 NIL)
          (|resSys| (|List| |SysRec|)) (|d| (|NonNegativeInteger|))
          (|simp?| (|Boolean|)) (|qq| (|Integer|)) (#2=#:G548 NIL) (|j| NIL)
          (#3=#:G546 NIL) (|sys| NIL) (#4=#:G547 NIL) (|ord| NIL)
...
(SDEFUN |JDE;simplify;$R;15|
        ...
        (SPROG
         ((|u?| (|Boolean|)) (#1=#:G600 NIL) (#2=#:G613 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G614 NIL) (|lj| (|List| JB))
          (#4=#:G612 NIL) (|eq| NIL) (|i| NIL)
          ...
          (|o| (|NonNegativeInteger|)) (#9=#:G610 NIL) (#10=#:G611 NIL)
          (|pro?| NIL)
          (|ad|
           (|Record| (|:| |Der| (|List| (|NonNegativeInteger|)))
                     (|:| |Pro?| (|List| (|Boolean|)))))
...
(SDEFUN |JDE;prolong;$R;17|
        ...
        (SPROG
         ((|tmp| (|Record| (|:| |SDe| $) (|:| IC (|List| D)))) (|res| ($))
          ...
          (|lastOrd| #1=(|NonNegativeInteger|)) (#2=#:G667 NIL) (|j| NIL)
          (#3=#:G666 NIL) (|lastRec| (|SysRec|)) (|pRec| (|SysRec|))
          (#4=#:G665 NIL) (|i| NIL) (#5=#:G664 NIL) (#6=#:G663 NIL)
          (#7=#:G662 NIL) (|pJM| (|SparseEchelonMatrix| JB D))
          (|pIC| #8=(|List| D)) (|pJV| (|List| (|List| JB)))
          (|pDer| (|List| (|NonNegativeInteger|))) (|pEqs| #8#)
          (|FDiff| (|Record| (|:| |DPhi| D) (|:| |JVars| (|List| JB))))
          (#9=#:G632 NIL) (#10=#:G661 NIL)
          (|jmeq| (|SparseEchelonMatrix| JB D)) (#11=#:G658 NIL) (|eq| NIL)
          (#12=#:G659 NIL) (#13=#:G660 NIL) (|pro?| NIL) (|k| NIL)
          (#14=#:G656 NIL) (|rec| (|SysRec|)) (#15=#:G657 NIL) (|ord| NIL)
          (#16=#:G655 NIL) (#17=#:G654 NIL) (#18=#:G653 NIL) (#19=#:G652 NIL)
          (#20=#:G623 NIL) (#21=#:G651 NIL) (#22=#:G649 NIL) (#23=#:G650 NIL)
          (|q| #1#))
...
(SDEFUN |JDE;prolong;$NniR;18|
        ...
        (SPROG
         ((|tmp| (|Record| (|:| |SDe| $) (|:| IC (|List| D)))) (|res| ($))
          ...
          (|lastRec| (|SysRec|)) (#3=#:G716 NIL) (|j| NIL) (#4=#:G715 NIL)
          (|pRec| (|SysRec|)) (#5=#:G714 NIL) (|i| NIL) (#6=#:G713 NIL)
          (#7=#:G712 NIL) (#8=#:G711 NIL) (|pIC| #9=(|List| D))
          (|pJM| (|SparseEchelonMatrix| JB D)) (|pDer| #1#)
          (|pJV| (|List| (|List| JB))) (|pEqs| #9#)
          (|FDiff| (|Record| (|:| |DPhi| D) (|:| |JVars| (|List| JB))))
          (#10=#:G682 NIL) (#11=#:G710 NIL)
          (|jmeq| (|SparseEchelonMatrix| JB D)) (#12=#:G707 NIL) (|eq| NIL)
          (#13=#:G708 NIL) (#14=#:G709 NIL) (|pro?| NIL) (|k| NIL)
          (#15=#:G705 NIL) (|rec| (|SysRec|)) (#16=#:G706 NIL) (|ord| #2#)
          (#17=#:G704 NIL) (#18=#:G703 NIL) (#19=#:G672 NIL) (#20=#:G702 NIL)
          (#21=#:G700 NIL) (#22=#:G701 NIL)
          (|tord| (|List| (|NonNegativeInteger|))) (|tsys| (|List| |SysRec|))
          (|cDe| ($)))
         (SEQ (LETT |cDe| (SPADCALL |De| (QREFELT $ 37)))
              (LETT |tsys| (QCAR |cDe|)) (LETT |tord| (QCDR |cDe|))
...
(SDEFUN |JDE;analyseSymbol;SemR;20|
        ...
        (SPROG
         ((|LBeta| (|List| (|NonNegativeInteger|))) (#1=#:G733 NIL) (|k| NIL)
          (|MSum| #2=(|NonNegativeInteger|))
          (|LastClass| (|NonNegativeInteger|)) (|BetaI| #2#) (#3=#:G732 NIL)
          (|CurClass| (|NonNegativeInteger|)) (#4=#:G731 NIL) (|jv| NIL)
          (|pivs|
...
(SDEFUN |JDE;prolongSymbol;2Sem;21|
        ...
        (SPROG
         ((|ninds| (|List| JB)) (#1=#:G743 NIL) (#2=#:G756 NIL) (#3=#:G768 NIL)
          (|jv| NIL) (#4=#:G767 NIL) (|i| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| D))))
          (#5=#:G766 NIL) (|j| NIL) (|res| (|SparseEchelonMatrix| JB D))
          (|newInds| (|List| JB)) (#6=#:G741 NIL) (#7=#:G765 NIL)
          (#8=#:G764 NIL) (|oldInds| (|List| JB)))
...
(SDEFUN |JDE;extPower|
        ...
        (SPROG
         ((|res| (D)) (|prod| (D)) (#1=#:G788 NIL) (|si| NIL) (#2=#:G789 NIL)
          (|mi| NIL) (#3=#:G787 NIL) (|s| NIL) (|q| (|NonNegativeInteger|))
...
(SDEFUN |JDE;tableau;SemJdSem;25|
        ...
        (SPROG
         ((|le| (|List| D)) (|li| (|List| JB)) (#1=#:G798 NIL) (#2=#:G813 NIL)
          (|i| NIL) (#3=#:G814 NIL) (|s| NIL)
          (|mu| (|List| (|NonNegativeInteger|))) (|a| #4=(|PositiveInteger|))
          (#5=#:G811 NIL) (|jv| NIL) (#6=#:G812 NIL) (|ent| NIL)
          (|sum| (|Vector| D))
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| D))))
          (#7=#:G810 NIL) (|k| NIL) (|res| (|SparseEchelonMatrix| JB D))
          (#8=#:G792 NIL) (#9=#:G809 NIL) (|cinds| (|List| #4#))
          (#10=#:G808 NIL) (|d| NIL) (#11=#:G807 NIL) (|coeffs| (|List| D))
          (|diffs| (|List| JB)))
        ...
        (SPROG
         ((|rres|
           #1=(|Record| (|:| |Indices| (|List| JB))
                        (|:| |Entries| (|List| D))))
          (|s| (D)) (|mu| #2=(|List| (|NonNegativeInteger|))) (#3=#:G836 NIL)
          (|jv| NIL) (#4=#:G837 NIL) (|ent| NIL) (|r| #1#) (#5=#:G835 NIL)
          (|k| NIL) (|nu| #2#) (|a| (|PositiveInteger|)) (#6=#:G834 NIL)
          (|vv| NIL) (|res| (|SparseEchelonMatrix| JB D)) (#7=#:G818 NIL)
          (#8=#:G833 NIL) (|j| NIL) (|i| NIL) (#9=#:G832 NIL) (|chi| NIL)
          (|mco| (|Matrix| D)) (|inds| (|List| JB)) (#10=#:G816 NIL)
...
(DEFUN |JetDifferentialEquation| (&REST #1=#:G838)
  (SPROG NIL
         (PROG (#2=#:G839)
           (RETURN
            (COND
