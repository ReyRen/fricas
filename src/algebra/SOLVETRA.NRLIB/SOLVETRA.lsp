...
(SDEFUN |SOLVETRA;solve;ESL;5|
        ((|lside| |Expression| R) (|x| |Symbol|)
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG ((#1=#:G491 NIL) (|sol| NIL) (#2=#:G490 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |sol| NIL)
...
(SDEFUN |SOLVETRA;solveInner|
        ((|lside| |Expression| R) (|x| |Symbol|)
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG
         ((#1=#:G521 NIL) (|sols| (|List| (|Equation| (|Expression| R))))
          (#2=#:G528 NIL) (|frec| NIL)
          (|lfacts|
           (|List|
            (|Record|
          ...
          (|newlist| (|List| (|Equation| (|Expression| R)))) (#8=#:G527 NIL)
          (|j| NIL) (|secondsol| #9=(|List| (|Expression| R))) (#10=#:G507 NIL)
          (#11=#:G506 #9#) (#12=#:G508 #9#) (#13=#:G526 NIL) (|ff| NIL)
          (|lfatt|
           (|List|
          ...
          (|elR| (|Expression| R)) (#14=#:G525 NIL) (|i| NIL) (#15=#:G502 NIL)
          (#16=#:G501 #17=(|List| (|Equation| (|Expression| R))))
          (#18=#:G503 #17#) (#19=#:G524 NIL) (|ri| NIL)
          (|bigX_back| (|Expression| R)) (#20=#:G497 NIL)
          (|r1| (|List| (|Expression| R)))
          (|finv| (|Union| (|Expression| R) #21="failed")) (#22=#:G523 NIL)
          (|lr| #9#) (#23=#:G494 NIL) (#24=#:G493 #9#) (#25=#:G495 #9#)
          (#26=#:G522 NIL) (|fatt| NIL) (|eq1| (|Expression| R))
...
(SDEFUN |SOLVETRA;solveRetract|
        ...
        (SPROG
         ((|nlexpr| (|List| (|Fraction| (|Polynomial| R)))) (#1=#:G551 NIL)
...
(SDEFUN |SOLVETRA;subsTan|
        ...
        (SPROG
         ((#1=#:G571 NIL) (|resultnew| #2=(|Expression| R))
           ...
           (SEQ (LETT Z (SPADCALL (QREFELT $ 33)))
                ...
                (COND
                 ((EQL (LENGTH |listofkern|) 1)
                  (COND
                   ((NULL |test|)
                    (PROGN (LETT #1# |exprvar|) (GO #5=#:G570)))))
...
(SDEFUN |SOLVETRA;logsumtolog| ((|var| |Expression| R) ($ |Expression| R))
        (SPROG
         ((|var2| (|Expression| R)) (#1=#:G603 NIL) (|i| NIL)
          (|kernelofvar| (|List| (|Kernel| (|Expression| R))))
          (|newexpr| (|Expression| R)) (|exprlist| (|List| (|Expression| R)))
          (#2=#:G602 NIL) (|gcdcoeff| (|Expression| R))
          (|listforgcd| (|List| R)) (|exprcoeff| (R)) (#3=#:G601 NIL)
...
(SDEFUN |SOLVETRA;buildnexpr|
        ...
        (SPROG
         ((|ansmant| (|Expression| R)) (|anscoeff| (|Expression| R))
          (#1=#:G626 NIL) (|i| NIL) (|n2list| (|List| (|Expression| R)))
...
(SDEFUN |SOLVETRA;combineLog|
        ...
        (SPROG
         ((|ansexpr| #1=(|Expression| R)) (#2=#:G644 NIL) (|i| NIL) (|ans| #1#)
...
(SDEFUN |SOLVETRA;tableXkernels|
        ...
        (SPROG
         ((|listkOfvar| (|List| (|Expression| R))) (#1=#:G656 NIL) (|i| NIL)
...
(SDEFUN |SOLVETRA;dropfun| ((|x| |Expression| R) ($ |Expression| R))
        (SPROG
         ((#1=#:G682 NIL) (|k| (|Union| (|Kernel| (|Expression| R)) "failed")))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SOLVETRA;makeREpol|
        ...
        (SPROG
         ((|lval| (|List| (|Expression| R))) (#1=#:G745 NIL) (|v| NIL)
          (#2=#:G744 NIL) (|lvar| (|List| (|Symbol|))))
...
(SDEFUN |SOLVETRA;solve1Pol|
        ...
        (SPROG
         ((#1=#:G751 NIL) (|vsol| NIL) (#2=#:G750 NIL)
...
(SDEFUN |SOLVETRA;solve1Sys|
        ...
        (SPROG
         ((|sols| (|List| (|List| (|Equation| (|Expression| R)))))
          (#1=#:G753 NIL)
          (#2=#:G752 #3=(|List| (|List| (|Equation| (|Expression| R)))))
          (#4=#:G754 #3#) (#5=#:G760 NIL) (|sol| NIL) (#6=#:G758 NIL) (|p| NIL)
          (#7=#:G759 NIL) (|v| NIL) (|rlvar| (|List| (|Symbol|)))
...
(SDEFUN |SOLVETRA;tryLinear|
        ((|lexpr| |List| (|Expression| R)) (|lvar| |List| (|Symbol|))
         ($ |Union| (|List| (|List| (|Equation| (|Expression| R)))) "failed"))
        (SPROG
         ((|eqs| (|List| (|Equation| (|Expression| R)))) (#1=#:G825 NIL)
          (|i| NIL) (#2=#:G824 NIL) (|sym| (|Expression| R)) (#3=#:G823 NIL)
          (|p| NIL) (|zeron| (|Vector| (|Expression| R)))
          (|rhs| (|Vector| (|Expression| R))) (#4=#:G796 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|Union| (|Vector| (|Expression| R)) #5="failed"))
            (|:| |basis| (|List| (|Vector| (|Expression| R))))))
          (|vece| (|Vector| (|Expression| R))) (#6=#:G822 NIL) (|q| NIL)
          (#7=#:G821 NIL) (|mate| (|Matrix| (|Expression| R))) (#8=#:G820 NIL)
          (#9=#:G819 NIL) (#10=#:G818 NIL) (|row| NIL) (#11=#:G817 NIL)
          (|r|
           (|Record|
            (|:| |mat|
                 (|Matrix|
          ...
          (|ps|
           (|List|
            (|SparseMultivariatePolynomial| R (|Kernel| (|Expression| R)))))
          (#12=#:G816 NIL) (|expr| NIL) (#13=#:G815 NIL) (#14=#:G807 NIL)
          (#15=#:G814 NIL) (|ker| NIL)
          (|kers| (|List| (|Kernel| (|Expression| R))))
          (|llk| (|List| (|List| (|Kernel| (|Expression| R)))))
          (#16=#:G813 NIL) (#17=#:G812 NIL) (#18=#:G767 NIL)
          (#19=#:G766 #20=(|Boolean|)) (#21=#:G768 #20#) (#22=#:G811 NIL)
          (#23=#:G764 NIL) (#24=#:G763 #25=(|Boolean|)) (#26=#:G765 #25#)
          (#27=#:G810 NIL) (|lvk| (|List| (|Kernel| (|Expression| R))))
          (#28=#:G809 NIL) (|v| NIL) (#29=#:G808 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lvk|
...
(SDEFUN |SOLVETRA;solve;LLL;37|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((|lexpr| (|List| (|Expression| R))) (#1=#:G842 NIL) (|eq| NIL)
          (#2=#:G841 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;38|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G869 NIL) (|neq| NIL) (#2=#:G868 NIL) (#3=#:G867 NIL)
          (|sol| NIL) (#4=#:G866 NIL) (|lval2| (|List| (|Expression| R)))
          (#5=#:G865 NIL) (|k| NIL) (#6=#:G864 NIL)
          (|lker2| (|List| (|Kernel| (|Expression| R)))) (#7=#:G863 NIL)
          (|v| NIL) (#8=#:G862 NIL)
          (|ans| (|List| (|List| (|Equation| (|Expression| R)))))
          (|nlexpr| (|List| (|Expression| R))) (#9=#:G861 NIL) (|expr| NIL)
          (#10=#:G860 NIL) (|lval| (|List| (|Expression| R))) (#11=#:G859 NIL)
          (#12=#:G858 NIL) (|lvar| (|List| (|Symbol|))) (#13=#:G857 NIL)
          (#14=#:G856 NIL) (|lexpr| (|List| (|Expression| R))) (#15=#:G855 NIL)
          (|eq| NIL) (#16=#:G854 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;40|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((|lker| (|List| (|Kernel| (|Expression| R)))) (#1=#:G879 NIL)
          (|e| NIL) (#2=#:G878 NIL))
         (SEQ
          (LETT |lker|
                (PROGN
...
(DEFUN |TransSolvePackage| (#1=#:G880)
  (SPROG NIL
         (PROG (#2=#:G881)
           (RETURN
            (COND
                 ...
                 (CONS '#(NIL)
                       (CONS
                        ...
                        (|makeByteWordVec2| 268
                                            '(1 8 7 0 9 1 8 10 0 11 0 6 0 12 2
                                              13 7 0 0 14 1 19 8 0 20 1 19 8 0
                                              21 2 8 0 0 0 22 1 8 25 0 26 1 8
                                              27 0 28 2 8 0 0 29 30 1 31 8 8 32
                                              0 16 0 33 1 8 0 16 34 2 19 0 8 8
                                              35 2 8 7 0 0 36 1 37 0 16 38 2 8
                                              39 0 40 41 1 43 42 0 44 1 46 45
                                              42 47 1 45 50 0 51 2 8 52 53 16
                                              54 2 55 0 0 0 56 2 55 8 0 57 58 2
                                              15 0 0 0 59 1 8 60 0 61 1 8 0 60
                                              62 1 8 63 53 64 1 65 8 8 66 1 69
                                              67 68 70 1 67 72 0 73 2 8 75 0 16
                                              76 1 37 55 0 77 2 8 0 57 0 78 1 8
                                              0 0 79 0 80 0 81 1 8 82 0 83 2 86
                                              84 85 10 87 1 88 8 8 89 2 31 8 8
                                              16 90 2 91 8 8 16 92 1 8 93 0 94
                                              1 8 0 0 95 1 8 0 57 96 2 8 0 0 0
