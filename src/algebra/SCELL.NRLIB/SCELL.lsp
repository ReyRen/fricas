...
(SDEFUN |SCELL;separate|
        ...
        (SPROG
         ((|new_left| (|TheField|)) (|new_right| (|TheField|))
          ...
          (#1=#:G409 NIL) (|ll| (|List| |TheField|)) (|middle| (|TheField|)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |middle|
...
(SDEFUN |SCELL;allSimpleCells;LSL;8|
        ...
        (SPROG
         ((|l1| (|List| |TheField|)) (|res| (|List| $))
          (|l| #1=(|List| |TheField|)) (#2=#:G417 NIL) (#3=#:G416 #1#)
          (#4=#:G418 #1#) (#5=#:G427 NIL) (|p| NIL) (|b| (|TheField|))
          (#6=#:G414 NIL) (#7=#:G413 (|TheField|)) (#8=#:G415 (|TheField|))
          (#9=#:G426 NIL) (|lp1| (|List| |ThePols|)))
         (SEQ (LETT |lp1| (SPADCALL |lp| (QREFELT $ 40)))
              (EXIT
               (COND
                ((NULL |lp1|)
                        ...
                        (PROGN
                         ...
                         (SEQ (LETT |p| NIL) (LETT #9# |lp1|) G190
                              ...
                              (SEQ
                               (EXIT
                                (PROGN
                                 (LETT #8# (SPADCALL |p| (QREFELT $ 42)))
                                 (COND
                                  (#6#
                                   (LETT #7#
                                         (SPADCALL #7# #8# (QREFELT $ 43))))
                               ...
                               (EXIT
                                (PROGN
                                 ...
                                 (COND
                                  (#2#
                                   (LETT #3#
                                         (SPADCALL #3# #4# (QREFELT $ 33))))
                                  ('T (PROGN (LETT #3# #4#) (LETT #2# 'T)))))))
                              (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
                         (COND (#2# #3#) (#10# NIL))))
                  (LETT |l| (SPADCALL |l| (QREFELT $ 49)))
                  (LETT |l1|
