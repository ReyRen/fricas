...
(SDEFUN |GRIMAGE;numberCheck| ((|nums| |Point| (|DoubleFloat|)) ($ |Void|))
        (SPROG ((#1=#:G404 NIL) (#2=#:G400 NIL) (#3=#:G405 NIL) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |GRIMAGE;putColorInfo;LLL;3|
        ...
        (SPROG
         ((|llp2| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (#1=#:G420 NIL) (|daShade| (|DoubleFloat|)) (|daHue| (|DoubleFloat|))
          (#2=#:G418 NIL) (|lp| NIL) (#3=#:G419 NIL) (|pal| NIL))
         (SEQ (LETT |llp2| NIL)
                        ...
                        (SEQ (LETT |p| NIL) (LETT #1# |lp|) G190
                             (COND
                              ((OR (ATOM #1#) (PROGN (LETT |p| (CAR #1#)) NIL))
                               (GO G191)))
                             (SEQ
                              (SEQ (LETT |d| (SPADCALL |p| (QREFELT $ 38)))
                                   (EXIT
                                    (COND
                                     ((< |d| 3)
                                      (LETT |p|
...
(SDEFUN |GRIMAGE;scaleStep|
        ...
        (SPROG
         ...
         (SEQ
          ...
          (LETT |numerals|
                (STRINGIMAGE
                 (SPADCALL (SPADCALL |tryStep| (QREFELT $ 49))
                           (QREFELT $ 50))))
          (LETT |scaleDown|
         ...
         (SEQ
          (LETT |single_eps|
                (|expt_DF_I|
                 ...
                 -19))
          (LETT |low| (SPADCALL |range| (QREFELT $ 46)))
          (LETT |low|
                (COND
                 ...
                 (#1='T
                  (|mul_DF|
                   (|sub_DF|
                    ...
                    |single_eps|)
                   |low|))))
          (LETT |high| (SPADCALL |range| (QREFELT $ 45)))
          (LETT |high|
                (COND
...
(SDEFUN |GRIMAGE;plotLists|
        ...
        (SPROG
         ((#1=#:G467 NIL) (|givenLen| #2=(|NonNegativeInteger|))
          (#3=#:G457 NIL) (#4=#:G447 NIL) (|len| #2#) (#5=#:G472 NIL) (|l| NIL)
          (#6=#:G471 NIL))
...
(SDEFUN |GRIMAGE;sendGraphImage;$V;10| ((|graf| $) ($ |Void|))
        (SPROG
         ((|hueShade| (|Integer|)) (|aPoint| #1=(|Point| (|DoubleFloat|)))
          (#2=#:G489 NIL) (|p| NIL) (#3=#:G485 NIL) (|aList| NIL)
          (#4=#:G486 NIL) (|pColor| NIL) (#5=#:G487 NIL) (|lColor| NIL)
          (#6=#:G488 NIL) (|s| (|NonNegativeInteger|))
...
(SDEFUN |GRIMAGE;makeGraphImage;L$;18|
        ((|llp| |List| (|List| (|Point| (|DoubleFloat|)))) ($ $))
        (SPROG
         ((#1=#:G511 NIL) (|i| NIL) (#2=#:G510 NIL) (#3=#:G509 NIL)
          (#4=#:G508 NIL) (#5=#:G507 NIL) (|l| (|Integer|)) (#6=#:G506 NIL))
         (SEQ
          (SPADCALL |llp|
                    (PROGN
                     (LETT #6# NIL)
...
(SDEFUN |GRIMAGE;makeGraphImage;L2LLL$;20|
        ((|llp| |List| (|List| (|Point| (|DoubleFloat|))))
         ...
         ($ $))
        (SPROG
         ((|aPoint| #1=(|Point| (|DoubleFloat|))) (#2=#:G520 NIL) (|p| NIL)
          (#3=#:G519 NIL) (|aList| NIL)
...
(SDEFUN |GRIMAGE;coerce;L$;26|
        ((|llp| |List| (|List| (|Point| (|DoubleFloat|)))) ($ $))
        (SPROG
         ((#1=#:G538 NIL) (|i| NIL) (#2=#:G537 NIL) (#3=#:G536 NIL)
          (#4=#:G535 NIL) (#5=#:G534 NIL) (|l| (|Integer|)) (#6=#:G533 NIL))
         (SEQ
          (SPADCALL |llp|
                    (PROGN
                     (LETT #6# NIL)
