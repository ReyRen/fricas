...
(SDEFUN |CHARPOL2;danilewski;MR;1|
        ...
        (SPROG
         ((#1=#:G418 NIL) (|j| NIL) (#2=#:G417 NIL) (|i| NIL) (|s| (F))
          (#3=#:G416 NIL) (#4=#:G415 NIL) (|val| (F)) (#5=#:G414 NIL)
          (|cc| (F)) (#6=#:G413 NIL) (|piv| (F))
          (|blocks| (|List| (|Integer|))) (|nn| (|Integer|)) (#7=#:G410 NIL)
          (|has_block| (|Boolean|)) (#8=#:G412 NIL) (|kk| NIL)
          (|k1| (|Integer|)) (|n1| (|Integer|)) (#9=#:G411 NIL) (|nc| NIL)
...
(SDEFUN |CHARPOL2;char_pol;MSup;2|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| F))
          (|res1| (|SparseUnivariatePolynomial| F)) (#1=#:G424 NIL)
          (#2=#:G422 NIL) (#3=#:G430 NIL) (|i| NIL) (|i1| (|Integer|))
...
(DEFUN |CharacteristicPolynomial2| (#1=#:G431)
  (SPROG NIL
         (PROG (#2=#:G432)
           (RETURN
            (COND
