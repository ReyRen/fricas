...
(SDEFUN |INFSP;makeEq;LLL;2|
        ...
        (SPROG
         ((#1=#:G397 NIL) (|x| NIL) (#2=#:G398 NIL) (|r| NIL) (#3=#:G396 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |INFSP;findGenZeros|
        ((|lp| |List| (|Polynomial| K)) (|rlvar| |List| (|Symbol|))
         (|eps| |Par|) ($ |List| (|List| F)))
        (SPROG
         ((|ebits| (|PositiveInteger|)) (|etol| (|Integer|)) (#1=#:G450 NIL)
          (|sol| (|List| (|List| F))) (|sol1| (|List| F)) (#2=#:G449 NIL)
          (|ok| (|Boolean|)) (|ppi| (|Complex| (|Interval| (|Float|))))
          (|pp| (|Union| (|Complex| (|Interval| (|Float|))) "failed"))
          (#3=#:G452 NIL) (|pol| NIL) (#4=#:G453 NIL) (|xvar| NIL)
          (#5=#:G451 NIL) (|z| NIL) (|lz| (|List| F)) (|nfeps| (|Float|))
...
(SDEFUN |INFSP;oldCoord|
        ...
        (SPROG
         ((#1=#:G455 NIL) (#2=#:G454 (F)) (#3=#:G456 (F)) (#4=#:G459 NIL)
          (|n| NIL) (#5=#:G460 NIL) (|nr| NIL) (|rnumres| (|List| F)))
...
(SDEFUN |INFSP;innerSolve;2LLParL;18|
        ...
        (SPROG
         ((|result| (|List| (|List| F))) (#1=#:G610 NIL) (|r| NIL)
          (#2=#:G609 NIL) (|lris| #3=(|List| (|List| F)))
          (|lgen1| (|List| (|Polynomial| K))) (#4=#:G608 NIL) (|pf| NIL)
          (#5=#:G607 NIL) (|neps| (|Par|)) (|lnorm| (|Integer|))
          (|laval| (|List| (|Integer|))) (#6=#:G606 NIL) (|i| NIL)
          (#7=#:G605 NIL) (|lval| #8=(|List| (|Integer|)))
          (|lgen| #9=(|List| (|DistributedMultivariatePolynomial| |lv| K)))
          (|genRecord| (|Record| (|:| |dpolys| #9#) (|:| |coords| #8#)))
          (#10=#:G604 NIL) (|gres| NIL)
          (|partRes|
           (|List| (|List| (|DistributedMultivariatePolynomial| |lv| K))))
          (#11=#:G603 NIL) (#12=#:G558 NIL) (#13=#:G557 #3#) (#14=#:G559 #3#)
          (#15=#:G602 NIL) (|res| NIL)
          (|listG| (|List| (|List| (|Polynomial| K)))) (#16=#:G601 NIL)
          (#17=#:G600 NIL) (#18=#:G599 NIL) (|pr| NIL) (#19=#:G598 NIL)
          (#20=#:G585 NIL) (|listGen| (|List| (|List| |dmp|))) (#21=#:G479 NIL)
          (#22=#:G478 #23=(|Boolean|)) (#24=#:G480 #23#) (#25=#:G551 NIL)
          (#26=#:G550 #27=(|NonNegativeInteger|)) (#28=#:G552 #27#)
          (#29=#:G597 NIL) (#30=#:G382 NIL) (#31=#:G596 NIL) (|f| NIL)
          (|res1| (|List| (|DistributedMultivariatePolynomial| |lv| K)))
          (#32=#:G595 NIL) (|rrlvv| (|List| OV)) (|rlv| (|List| (|Symbol|)))
          (#33=#:G473 NIL) (#34=#:G472 #35=(|Boolean|)) (#36=#:G474 #35#)
          (#37=#:G594 NIL) (|fq| NIL) (#38=#:G593 NIL) (#39=#:G592 NIL)
          (|gb|
           (CATEGORY |package|
          ...
          (|lq| (|List| |dmp|)) (#41=#:G591 NIL) (|q1| NIL) (#42=#:G590 NIL)
          (|dmp|
           (|Join|
          ...
          (DP
           (|DirectProductCategory| (|call| LENGTH |lv|)
                                    (|NonNegativeInteger|)))
          (|lvv| (|List| OV)) (#43=#:G467 NIL) (#44=#:G589 NIL) (|vv| NIL)
          (#45=#:G588 NIL)
          (OV
...
(DEFUN |InnerNumericFloatSolvePackage| (&REST #1=#:G611)
  (SPROG NIL
         (PROG (#2=#:G612)
           (RETURN
            (COND
