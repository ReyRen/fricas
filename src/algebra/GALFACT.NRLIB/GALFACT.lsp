...
(SDEFUN |GALFACT;eisensteinIrreducible?;UPB;11| ((|f| UP) ($ |Boolean|))
        (SPROG
         ((#1=#:G471 NIL) (#2=#:G472 NIL) (|p| NIL) (|rf| (UP))
...
(SDEFUN |GALFACT;numberOfFactors;LNni;12|
        ((|ddlist| |List|
         ...
         ($ |NonNegativeInteger|))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G474 NIL) (|d| (|Integer|))
          (#2=#:G481 NIL) (|dd| NIL))
...
(SDEFUN |GALFACT;nextRecNum|
        ...
        (SPROG
         ((|b| (|Integer|)) (|lr| #1=(|Integer|)) (#2=#:G494 NIL) (|l| #1#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GALFACT;fullSet|
        ...
        (SPROG ((#1=#:G498 NIL) (|i| NIL) (#2=#:G497 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |GALFACT;do_separate|
        ((|sfl| |List| (|Mapping| #1=(|List| (|U32Vector|)))) (|c| |Integer|)
         ($ |List| UP))
        (SPROG
         ((|res| (|List| UP)) (#2=#:G511 NIL) (|v| NIL) (|vl| #1#)
          (#3=#:G510 NIL) (|sf| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |GALFACT;do_ddfact|
        ...
        (SPROG
         ((|degs| (|List| (|NonNegativeInteger|))) (#1=#:G522 NIL)
          (#2=#:G529 NIL) (|rl| NIL)
          (|res1|
           (|List| (|Record| (|:| |factor| UP) (|:| |degree| (|Integer|)))))
          (|sfl| (|List| (|Mapping| (|List| (|U32Vector|))))) (#3=#:G516 NIL)
          (#4=#:G528 NIL) (|fr| NIL)
          (|ul1|
           (|List|
...
(SDEFUN |GALFACT;modularFactor;UPSR;22|
        ...
        (SPROG
         ((|fl| (|List| UP)) (|cprime| (|Integer|)) (|res_prime| (|Integer|))
          ...
          (#2=#:G546 NIL) (|s| (|Set| (|NonNegativeInteger|))) (#3=#:G548 NIL)
          (|degfact| (|NonNegativeInteger|))
          (|ddlist| (|List| (|NonNegativeInteger|))) (|dd_res1| #1#)
          (|small| (|Boolean|)) (#4=#:G547 NIL) (|i| NIL) (|diffp| (UP))
...
(SDEFUN |GALFACT;degreePartition;LM;23|
        ...
        (SPROG
         ((|dp| (|Multiset| (|NonNegativeInteger|)))
          (|dd| #1=(|NonNegativeInteger|)) (#2=#:G550 NIL) (|d| #1#)
          (#3=#:G556 NIL) (|f| NIL))
...
(SDEFUN |GALFACT;henselfact|
        ((|f| UP) (|pdecomp| |Boolean|) (|d| |Set| (|NonNegativeInteger|))
         ($ . #1=(|List| UP)))
        (SPROG
         ((#2=#:G571 NIL) (#3=#:G570 #1#) (#4=#:G572 #1#) (#5=#:G577 NIL)
          (|g| NIL) (|d1| (|Set| (|NonNegativeInteger|)))
          (|dh| (|NonNegativeInteger|))
          (|lrf| (|Record| (|:| |left| UP) (|:| |right| UP)))
          (|b| (|PositiveInteger|)) (#6=#:G567 NIL) (|cprime| #7=(|Integer|))
...
(SDEFUN |GALFACT;completeFactor|
        ...
        (SPROG
         ((|level| (|Integer|)) (|found?| (|Boolean|))
          ...
          (|ic| (|Union| (|Integer|) "End of level")) (#1=#:G643 NIL)
          (#2=#:G629 NIL)
          (|llg|
           (|Record| (|:| |plist| (|List| UP)) (|:| |modulo| (|Integer|))))
          (|b| (|PositiveInteger|)) (#3=#:G628 NIL) (|ltrue| #4=(|List| UP))
          (|degf| #5=(|NonNegativeInteger|)) (#6=#:G625 NIL) (|lg| #4#)
          (|gpk| (|PositiveInteger|)) (#7=#:G612 NIL) (#8=#:G609 NIL)
          (#9=#:G608 NIL) (|rg| #5#) (#10=#:G607 NIL)
          (|dg| (|Set| (|NonNegativeInteger|))) (|f0| (|Integer|))
          (|lc| (|Integer|)) (#11=#:G597 NIL) (#12=#:G595 NIL)
          (|nb| (|Integer|)) (#13=#:G646 NIL) (|j| NIL)
          (|f1| (|Union| UP "failed")) (|g| (UP)) (#14=#:G645 NIL)
          (|g0| (|Integer|)) (|degg| #5#) (#15=#:G644 NIL) (|i| (|Integer|))
          (#16=#:G487 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |lc| (SPADCALL |f| (QREFELT $ 28)))
...
(SDEFUN |GALFACT;divideSet|
        ...
        (SPROG
         ((|l| (|List| (|NonNegativeInteger|)))
          (|ee| (|Union| (|NonNegativeInteger|) "failed")) (#1=#:G654 NIL)
          (|e| NIL))
         (SEQ (LETT |l| (LIST 0))
...
(SDEFUN |GALFACT;btwFactor|
        ...
        (SPROG
         ((#2=#:G708 NIL) (|i| NIL) (|lf| #3=(|List| UP)) (#4=#:G707 NIL)
          (|fact| NIL) (#5=#:G706 NIL) (#6=#:G694 NIL) (|lfg| #1#)
          (#7=#:G685 NIL) (|df| #8=(|NonNegativeInteger|)) (#9=#:G675 NIL)
          (|dgh| (|NonNegativeInteger|)) (|dg| #8#) (|g| (UP)) (#10=#:G705 NIL)
          (|lg| #1#) (|dh| #8#)
          (|lrf| (|Record| (|:| |left| UP) (|:| |right| UP)))
          (|pk| (|PositiveInteger|)) (#11=#:G670 NIL)
          (|lm| (|Record| (|:| |plist| #3#) (|:| |modulo| (|Integer|))))
          (|b| (|PositiveInteger|)) (#12=#:G668 NIL) (|f0| (|Integer|))
          (|lc| (|Integer|)) (#13=#:G704 NIL) (|cprime| #14=(|Integer|))
...
(SDEFUN |GALFACT;makeFR;RF;30|
        ...
        (SPROG
         ((|fflist|
          ...
          (#1=#:G725 NIL) (|fc| NIL) (#2=#:G724 NIL) (|ff| NIL)
...
(SDEFUN |GALFACT;quadratic| ((|p| UP) ($ |List| UP))
        (SPROG
         ((#1=#:G731 NIL) (|f| (UP)) (|b| (|Integer|)) (|a| (|Integer|))
...
(SDEFUN |GALFACT;henselFact;UPBR;34|
        ...
        (SPROG
         ((|factorlist|
           (|List|
            (|Record| (|:| |irr| UP) (|:| |pow| (|NonNegativeInteger|)))))
          (#1=#:G782 NIL) (|pf| NIL) (#2=#:G781 NIL) (#3=#:G780 NIL)
          (#4=#:G779 NIL) (|d| (|NonNegativeInteger|)) (|sqff| (UP))
          (|mult| #5=(|NonNegativeInteger|)) (#6=#:G778 NIL) (|sqfr| NIL)
          (|sqfflist|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| UP) (|:| |exponent| #5#))))
          (#7=#:G777 NIL) (#8=#:G776 NIL) (|fac| (UP)) (#9=#:G775 NIL)
          (|sfac| NIL) (#10=#:G774 NIL) (|lcPol| (UP)) (|c| (|Integer|))
          (#11=#:G744 NIL))
          ...
          (|:| |factors|
               (|List|
                (|Record| (|:| |irr| UP)
                          (|:| |pow| (|NonNegativeInteger|)))))))
        (SPROG
         ((|maxd| (|NonNegativeInteger|)) (#1=#:G831 NIL)
          (|factorlist|
           (|List|
            (|Record| (|:| |irr| UP) (|:| |pow| (|NonNegativeInteger|)))))
          (#2=#:G849 NIL) (|pf| NIL) (#3=#:G848 NIL) (#4=#:G826 NIL)
          (#5=#:G847 NIL) (#6=#:G846 NIL) (#7=#:G822 NIL)
          (|d| (|NonNegativeInteger|)) (|sqff| (UP))
          (|mult| #8=(|NonNegativeInteger|)) (#9=#:G845 NIL) (|sqfr| NIL)
          (|sqfflist|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| UP) (|:| |exponent| #8#))))
          (#10=#:G844 NIL) (#11=#:G843 NIL) (|fac| (UP)) (#12=#:G842 NIL)
          (|sfac| NIL) (#13=#:G841 NIL) (|lcPol| (UP)) (#14=#:G802 NIL)
          (#15=#:G800 NIL) (|c| (|Integer|)) (#16=#:G787 NIL))
...
(SDEFUN |GALFACT;errorsum?|
        ((|d| |NonNegativeInteger|) (|ld| |List| #1=(|NonNegativeInteger|))
         ($ |Boolean|))
        (SPROG
         ((#2=#:G853 NIL) (#3=#:G852 #1#) (#4=#:G854 #1#) (#5=#:G857 NIL)
          (#6=#:G382 NIL))
         (SEQ
          (NULL
           (EQL |d|
...
(SDEFUN |GALFACT;makeSet|
        ...
        (SPROG ((|s| (|Set| (|NonNegativeInteger|))) (#1=#:G861 NIL) (|d| NIL))
...
(SDEFUN |GALFACT;factorOfDegree;PiUPLNniBU;48|
        ...
        (SPROG
         ((#1=#:G900 NIL) (#2=#:G901 NIL) (#3=#:G902 NIL) (|f| NIL)
          (|lf|
           (|List|
            (|Record| (|:| |irr| UP) (|:| |pow| (|NonNegativeInteger|)))))
...
(DEFUN |GaloisGroupFactorizer| (#1=#:G919)
  (SPROG NIL
         (PROG (#2=#:G920)
           (RETURN
            (COND
