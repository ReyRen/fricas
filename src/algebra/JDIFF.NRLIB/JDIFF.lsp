...
(SDEFUN |JDIFF;coerce;$Of;6| ((|om| $) ($ |OutputForm|))
        (SPROG
         ((#1=#:G415 NIL) (|c| NIL) (#2=#:G416 NIL) (|jb| NIL) (#3=#:G414 NIL))
         (SEQ
          (COND
...
(SDEFUN |JDIFF;-;2$;13| ((|om| $) ($ $))
        (SPROG ((#1=#:G427 NIL) (|c| NIL) (#2=#:G426 NIL))
               (SEQ
                (CONS
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |JDIFF;+;3$;14| ((|om1| $) (|om2| $) ($ $))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G444 NIL) (|c1| NIL)
          (#2=#:G445 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JDIFF;*;D2$;15| ((|f| D) (|om| $) ($ $))
        (SPROG ((#1=#:G450 NIL) (|c| NIL) (#2=#:G449 NIL))
               (SEQ
...
(SDEFUN |JDIFF;d;D$;16| ((|f| D) ($ $))
        (SPROG
         ((|Co| (|List| D)) (#1=#:G456 NIL) (|jv| NIL) (#2=#:G455 NIL)
          (JV (|List| JB)))
         (SEQ (LETT JV (NREVERSE (SPADCALL |f| (QREFELT $ 60))))
              (EXIT
...
(SDEFUN |JDIFF;eval;$JvfD;17| ((|om| $) (|v| |JetVectorField| JB D) ($ D))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|res| (D)) (#1=#:G469 NIL)
          (|c1| NIL) (#2=#:G470 NIL) (|j1| NIL))
         (SEQ
          (COND
...
(DEFUN |JetDifferential| (&REST #1=#:G476)
  (SPROG NIL
         (PROG (#2=#:G477)
           (RETURN
            (COND
...
(DEFUN |JetDifferential;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G475 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
