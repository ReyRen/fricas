...
(SDEFUN |M3D;matrixConcat3D;S3$;1|
        ...
        (SPROG
         ((|retVal| ($)) (#1=#:G410 NIL) (|j| NIL)
          (|temp| (|PrimitiveArray| (|PrimitiveArray| R))) (#2=#:G409 NIL)
          (|i| NIL) (#3=#:G408 NIL)
          (|matRep2|
...
(SDEFUN |M3D;identityMatrix;Nni$;8| ((|iLength| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#1=#:G424 NIL) (|count| NIL)
...
(SDEFUN |M3D;plus;3$;9| ((|mat1| $) (|mat2| $) ($ $))
        (SPROG
         ((|resultMatrix| ($)) (|sum| (R)) (#1=#:G435 NIL) (|k| NIL)
          (#2=#:G434 NIL) (|j| NIL) (#3=#:G433 NIL) (|i| NIL)
...
(SDEFUN |M3D;construct;L$;10| ((|listRep| |List| (|List| (|List| R))) ($ $))
        (SPROG
         ((|resultMatrix| ($)) (|element| (R)) (#1=#:G457 NIL) (|k| NIL)
          (#2=#:G456 NIL) (|j| NIL) (#3=#:G455 NIL) (|i| NIL)
          (|row3| (|PrimitiveArray| (|PrimitiveArray| (|PrimitiveArray| R))))
          (|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#4=#:G452 NIL) (#5=#:G454 NIL)
          (|subSubList| NIL) (#6=#:G453 NIL) (|subList| NIL)
...
(DEFUN |ThreeDimensionalMatrix| (#1=#:G463)
  (SPROG NIL
         (PROG (#2=#:G464)
           (RETURN
            (COND
...
(DEFUN |ThreeDimensionalMatrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G461 NIL) (#2=#:G462 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
