        ...
        (SPROG
         ((|x2| (F)) (|x1| (F)) (|done| (|Boolean|)) (|pts| (|Integer|))
          ...
          (|ans|
           (|Record| (|:| |value| F) (|:| |error| F)
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#1=#:G399 NIL) (|i| NIL) (|io| (|List| (|OutputForm|))) (|hh| (F)))
        ...
        (SPROG
         ((|x2| (F)) (|x1| (F)) (|done| (|Boolean|)) (|pts| (|Integer|))
          ...
          (|ans|
           (|Record| (|:| |value| F) (|:| |error| F)
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#1=#:G408 NIL) (|i| NIL) (|io| (|List| (|OutputForm|))) (|hh| (F)))
         (SEQ (LETT |sum| (|spadConstant| $ 7))
              (LETT |err| (|spadConstant| $ 7)) (LETT |pts| 1) (LETT |done| 'T)
              (LETT |hh|
                    (SPADCALL (SPADCALL |b| |a| (QREFELT $ 8)) |nint|
        ...
        (SPROG
         ((|x2| (F)) (|x1| (F)) (|done| (|Boolean|)) (|pts| (|Integer|))
          ...
          (|ans|
           (|Record| (|:| |value| F) (|:| |error| F)
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#1=#:G417 NIL) (|i| NIL) (|io| (|List| (|OutputForm|))) (|hh| (F)))
         (SEQ (LETT |sum| (|spadConstant| $ 7))
              (LETT |err| (|spadConstant| $ 7)) (LETT |pts| 1) (LETT |done| 'T)
              (LETT |hh|
                    (SPADCALL (SPADCALL |b| |a| (QREFELT $ 8)) |nint|
...
(SDEFUN |NUMQUAD;romberg;M4F2IR;4|
        ...
        (SPROG
         ((|qx1| (F)) (|pts| (|Integer|)) (|delta| (F)) (|oldest| (F))
          (|oldsum| (F)) (#1=#:G433 NIL) (|change| (F))
          (|four| (|PositiveInteger|)) (|i| (|Integer|)) (#2=#:G435 NIL)
          (|j| NIL) (|newest| (F)) (|newsum| (F)) (#3=#:G434 NIL) (|n| NIL)
          (|table| (|Vector| F)) (#4=#:G419 NIL) (|length| (F)))
         (SEQ
          (EXIT
...
(SDEFUN |NUMQUAD;simpson;M4F2IR;5|
        ...
        (SPROG
         ((|pts| (|Integer|)) (|delta| (F)) (|oldest| (F)) (|oldsum| (F))
          (#1=#:G448 NIL) (|change| (F)) (|newest| (F)) (|newsum| (F))
          (#2=#:G449 NIL) (|n| NIL) (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
                (LETT |delta| |length|)
...
(SDEFUN |NUMQUAD;trapezoidal;M4F2IR;6|
        ((|func| |Mapping| F F) (|a| F) (|b| F) (|epsrel| F) (|epsabs| F)
         ...
         ($ |Record| (|:| |value| F) (|:| |error| F)
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((|pts| (|Integer|)) (|delta| (F)) (#1=#:G462 NIL) (|change| (F))
          (|newsum| (F)) (|oldsum| (F)) (#2=#:G463 NIL) (|n| NIL)
          (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
...
(SDEFUN |NUMQUAD;rombergo;M4F2IR;7|
        ...
        (SPROG
         ((|qx1| (F)) (|pts| (|Integer|)) (|delta| (F)) (|oldest| (F))
          (|oldsum| (F)) (#1=#:G474 NIL) (|change| (F))
          (|nine| (|PositiveInteger|)) (|i| (|Integer|)) (#2=#:G476 NIL)
          (|j| NIL) (|newest| (F)) (|newsum| (F)) (#3=#:G475 NIL) (|n| NIL)
          (|table| (|Vector| F)) (#4=#:G465 NIL) (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
                               ...
                               ((OR
                                ...
                                (PROGN
                                 (LETT #1#
                                       (VECTOR
                                        (SPADCALL |table| 1 (QREFELT $ 43))
                                        (SPADCALL (SPADCALL 3 2 (QREFELT $ 47))
                                                  |change| (QREFELT $ 48))
                                        (SPADCALL 3 |pts| (QREFELT $ 45)) 'T))
                                 (GO #5=#:G473))))))))
                          (SPADCALL (SPADCALL |table| (QREFELT $ 50))
                                    (QREFELT $ 49))
                          (LETT |oldsum| |newsum|) (LETT |oldest| |newest|)
                          (LETT |delta| (SPADCALL |delta| 3 (QREFELT $ 10)))
                          (LETT |pts| (SPADCALL 3 |pts| (QREFELT $ 45)))
                          (EXIT
                           (LETT |qx1| (SPADCALL |table| 1 (QREFELT $ 43)))))
                     (LETT |n| (|inc_SI| |n|)) (GO G190) G191 (EXIT NIL))
                (EXIT
...
(SDEFUN |NUMQUAD;simpsono;M4F2IR;8|
        ...
        (SPROG
         ((|pts| (|Integer|)) (|delta| (F)) (|oldest| (F)) (|oldsum| (F))
          (#1=#:G484 NIL) (|change| (F)) (|newest| (F)) (|newsum| (F))
          (#2=#:G485 NIL) (|n| NIL) (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
                (LETT |delta| (SPADCALL |length| 3 (QREFELT $ 10)))
...
(SDEFUN |NUMQUAD;trapezoidalo;M4F2IR;9|
        ((|func| |Mapping| F F) (|a| F) (|b| F) (|epsrel| F) (|epsabs| F)
         ...
         ($ |Record| (|:| |value| F) (|:| |error| F)
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((|pts| (|Integer|)) (|delta| (F)) (#1=#:G493 NIL) (|change| (F))
          (|newsum| (F)) (|oldsum| (F)) (#2=#:G494 NIL) (|n| NIL)
          (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
...
(SDEFUN |NUMQUAD;trapclosed|
        ((|func| |Mapping| F F) (|start| F) (|h| F) (|oldsum| F)
         (|numpoints| |Integer|) ($ F))
        (SPROG ((|x| (F)) (|sum| (F)) (#1=#:G499 NIL) (|i| NIL))
               (SEQ
                (LETT |x|
...
(SDEFUN |NUMQUAD;trapopen|
        ((|func| |Mapping| F F) (|start| F) (|del| F) (|oldsum| F)
         (|numpoints| |Integer|) ($ F))
        (SPROG ((|x| (F)) (|sum| (F)) (#1=#:G504 NIL) (|i| NIL) (|ddel| (F)))
...
(DEFUN |NumericalQuadrature| (#1=#:G505)
  (SPROG NIL
         (PROG (#2=#:G506)
           (RETURN
            (COND
