...
(SDEFUN |INTFACT;squareFree;IF;1| ((|n| I) ($ |Factored| I))
        (SPROG
         ((|y|
          ...
          (#2=#:G410 NIL) (#3=#:G411 NIL) (|l| #1#) (|sv| (|Factored| I))
          (|rec| NIL) (|u| (I)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |INTFACT;PollardSmallFactor;IU;2| ((|n| I) ($ |Union| I "failed"))
        (SPROG
         ((G (I)) (|x| (I)) (|y| (I)) (#1=#:G438 NIL) (#2=#:G437 NIL) (|i| NIL)
          (|l| (I)) (|ys| (I)) (#3=#:G436 NIL) (|r| (I)) (|k| (I)) (|q| (I))
          (#4=#:G435 NIL) (#5=#:G434 NIL) (#6=#:G433 NIL) (#7=#:G432 NIL)
          (|m| (I)) (|x0| (I)))
...
(SDEFUN |INTFACT;PollardSmallFactor20| ((|n| I) ($ |Union| I "failed"))
        (SPROG ((#1=#:G446 NIL) (|r| (|Union| I "failed")) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 1) G190
          ...
          (|ls|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| I)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|n| (I)) (|m| NIL) (#1=#:G460 NIL) (#2=#:G461 NIL) (|s| NIL)
          (|l| (|List| I)))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |IntegerFactorizationPackage| (#1=#:G497)
  (SPROG NIL
         (PROG (#2=#:G498)
           (RETURN
            (COND
