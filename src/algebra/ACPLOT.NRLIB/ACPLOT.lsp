...
(SDEFUN |ACPLOT;findPtOnList|
        ...
        (SPROG ((#1=#:G468 NIL) (#2=#:G469 NIL) (#3=#:G470 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |ACPLOT;listPtsOnHorizBdry|
        ...
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G495 NIL)
...
(SDEFUN |ACPLOT;listPtsOnVertBdry|
        ((|pRN| |Polynomial| (|Fraction| (|Integer|))) (|x| |Symbol|)
         ...
         ($ |List| (|Point| (|DoubleFloat|))))
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G499 NIL)
          (|root| NIL) (|roots| (|List| (|Float|)))
          (|f| (|Polynomial| (|Fraction| (|Integer|))))
          (|xSF| (|DoubleFloat|)))
...
(SDEFUN |ACPLOT;ptsSuchThat?|
        ...
        (SPROG ((#1=#:G509 NIL) (#2=#:G510 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |ACPLOT;makeOneVarSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|rt| (|List| (|Point| (|DoubleFloat|)))) (|pt1| #1#) (#2=#:G560 NIL)
          (|rootSF| NIL) (|xMaxSF| #3=(|DoubleFloat|)) (|xMinSF| #3#)
          (|bt| (|List| (|Point| (|DoubleFloat|))))
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#4=#:G559 NIL)
          (|yMaxSF| #3#) (|yMinSF| #3#)
          (|sketchRoots| (|List| (|DoubleFloat|))) (#5=#:G558 NIL) (|root| NIL)
          (|roots| (|List| (|Float|)))
...
(SDEFUN |ACPLOT;singValBetween?|
        ...
        (SPROG ((#1=#:G571 NIL) (#2=#:G572 NIL) (#3=#:G573 NIL) (|xVal| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                           ...
                           (COND
                            ((|less_DF| |xCurrent| |xVal|)
                             (COND
                              ((|less_DF| |xVal| |xNext|)
                               (PROGN
                                (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G570)))
                                (GO #5=#:G568))))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |ACPLOT;segmentInfo|
        ...
        (SPROG
         ((#2=#:G597 NIL) (|val| #1#) (|nextFrom| #3=(|String|))
...
(SDEFUN |ACPLOT;makeRatFcnSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (#5=#:G670 NIL) (|segment| NIL) (#6=#:G661 NIL)
          ...
          (|top| #8=(|DoubleFloat|)) (|bot| #8#) (#9=#:G662 NIL)
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#10=#:G669 NIL)
          (|val| NIL) (|bt| (|List| (|Point| (|DoubleFloat|))))
          (#11=#:G668 NIL) (|rt| (|List| (|Point| (|DoubleFloat|))))
          (|lf| (|List| (|Point| (|DoubleFloat|)))) (#12=#:G667 NIL)
          (#13=#:G666 NIL) (|rightVal| #14=(|DoubleFloat|)) (|leftVal| #14#)
          (|denUPolyRN|
           (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|outList| (|List| (|DoubleFloat|))) (#15=#:G665 NIL) (|root| NIL)
          (|roots| (|List| (|Float|))) (#16=#:G664 NIL)
          (|singList| (|List| (|DoubleFloat|))) (#17=#:G663 NIL)
                ...
                (SEQ G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((EQL |i| |bound|)
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #3=#:G816)))
                        ('T
...
(SDEFUN |ACPLOT;coerce;$Of;42| ((|acplot| $) ($ |OutputForm|))
        (SPROG
         ((|ff| (|OutputForm|)) (|f| (|List| (|OutputForm|)))
          (|ll| (|List| (|OutputForm|))) (#1=#:G826 NIL) (|p| NIL)
          (#2=#:G825 NIL) (#3=#:G824 NIL) (|branch| NIL)
...
(MAKEPROP '|PlaneAlgebraicCurvePlot| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL '|Rep| (|Float|) (0 . |One|) (|Integer|)
              ...
              (449 . |eval|) (456 . |ground|) (461 . |member?|)
              (467 . |remove|) (473 . |second|) (478 . =) (484 . =)
              (490 . |eval|) (497 . |differentiate|)
              |ACPLOT;listBranches;$L;41| (|OutputForm|) (502 . |coerce|)
              (507 . |coerce|) (512 . |coerce|) (|String|) (517 . |message|)
              (522 . |coerce|) (|List| $) (527 . |vconcat|) (532 . |hconcat|)
              (537 . |vconcat|) |ACPLOT;coerce;$Of;42|)
           '#(|yRange| 543 |xRange| 548 |refine| 553 |makeSketch| 559
              |listBranches| 568 |coerce| 573)
           'NIL
           (CONS (|makeByteWordVec2| 1 '(0 0))
                 (CONS '#(NIL NIL)
                       (CONS
                        '#((|PlottablePlaneCurveCategory|) (|CoercibleTo| 144))
                        (|makeByteWordVec2| 155
                                            '(0 7 0 8 3 7 0 9 9 10 11 3 13 0 9
                                              ...
                                              116 0 117 2 119 0 118 0 120 1 94
                                              123 0 124 2 101 0 0 0 125 2 44 0
                                              9 9 126 2 44 0 0 0 127 2 44 0 0
                                              44 128 1 44 0 0 129 2 119 0 0 0
                                              130 1 116 119 0 132 1 116 119 0
                                              133 3 30 0 0 80 23 134 1 30 13 0
                                              135 2 119 29 24 0 136 2 119 0 24
                                              0 137 1 119 24 0 138 2 24 29 0 0
                                              139 2 119 29 0 0 140 3 30 0 0 62
                                              13 141 1 32 0 0 142 1 52 144 0
                                              145 1 62 144 0 146 1 44 144 0 147
                                              1 144 0 148 149 1 24 144 0 150 1
                                              144 0 151 152 1 144 0 151 153 2
                                              144 0 0 0 154 1 0 91 0 1 1 0 91 0
                                              1 2 0 0 0 13 131 5 0 0 52 62 62
                                              76 76 86 1 0 116 0 143 1 0 144 0
                                              155)))))
           '|lookupComplete|)) 
