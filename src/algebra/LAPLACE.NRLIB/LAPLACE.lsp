...
(SDEFUN |LAPLACE;algebraic?| ((|f| F) (|t| |Symbol|) ($ |Boolean|))
        (SPROG
         ((#1=#:G426 NIL) (#2=#:G427 NIL) (#3=#:G430 NIL) (|k| NIL)
          (|m| (|NonNegativeInteger|)) (#4=#:G429 NIL) (#5=#:G428 NIL)
          (|l| (|List| (|Kernel| F))))
         (SEQ
          (EXIT
           (SEQ
                      ...
                      ((EQL (SPADCALL |k| (QREFELT $ 25)) |m|)
                       (COND
                        ((SPADCALL (SPADCALL |k| (QREFELT $ 29)) (QREFELT $ 8)
                                   (QREFELT $ 31))
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# 'T) (GO #6=#:G425)))
                          (GO #7=#:G423))))))))
...
(SDEFUN |LAPLACE;isLinear|
        ...
        (SPROG
         ((|c| (F)) (|b| (F)) (#1=#:G447 NIL) (|d| (|Union| F "failed"))
              ...
              (COND
               ((OR (QEQCAR |d| 1)
                    (SPADCALL
                     ...
                     (QREFELT $ 53)))
                (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G445))))))
            (COND
             ((SPADCALL
               (LETT |b|
                     (SPADCALL
...
(SDEFUN |LAPLACE;atn|
        ((|f| F) (|t| |Symbol|)
         ($ |Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
          #1="failed"))
        (SPROG
         ((#2=#:G470 NIL) (|c| (F)) (|d| (|NonNegativeInteger|))
          (|r| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|))))
          (|rec|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    #1#))
          (#3=#:G476 NIL) (|g| NIL) (|u| (|Union| (|List| F) #4="failed"))
          (#5=#:G474 NIL) (#6=#:G475 NIL) (#7=#:G459 NIL)
                                  ...
                                  (COND
                                   ((EQUAL (QCDR |vv|) |t|)
                                    (PROGN
                                     ...
                                     (GO #9=#:G460)))))))))
                             #9# (EXIT #5#))))))))))
            (LETT |u| (SPADCALL |f| (QREFELT $ 66)))
            (EXIT
             (COND
              ((QEQCAR |u| 0)
               (SEQ (LETT |c| (|spadConstant| $ 64)) (LETT |d| 0)
               ...
               (SEQ
                (COND
                 ((SPADCALL |k| '|nthRoot| (QREFELT $ 67))
                  (SEQ (LETT |args| (SPADCALL |k| (QREFELT $ 68)))
                       (EXIT
                        (COND
                         ((OR
           ...
           (COND ((SPADCALL |nk| 2 (QREFELT $ 53)) (CONS 1 "failed"))
                 (#3='T
                  (SEQ
                   (LETT |rru|
                         (|LAPLACE;is_root|
                          (LETT |rk| (SPADCALL |vkl| |nk| (QREFELT $ 77))) |t|
                          $))
                   (EXIT
         ...
         ((#2=#:G532 NIL) (#3=#:G533 NIL)
          ...
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #4="failed"))
          (|c| (F)) (|c1| (F)) (|c0| (F)) (#5=#:G534 NIL) (|g| NIL)
          (|u| (|Union| (|List| F) #4#)))
         (SEQ
          (EXIT
           (COND
                     ...
                     (#6='T
                      (CONS 0
                            (VECTOR (|spadConstant| $ 64) (QCDR (QCDR |v|))
                                    (QCAR (QCDR |v|)))))))))
            (#6#
             (SEQ (LETT |u| (SPADCALL |f| (QREFELT $ 66)))
                  (EXIT
                   (COND
                    ((QEQCAR |u| 0)
                     (SEQ (LETT |c| (|spadConstant| $ 64))
                          (LETT |c1| (LETT |c0| (|spadConstant| $ 80)))
                    ...
                    (#6#
                     (SEQ
                      (SEQ (LETT |v| (SPADCALL |f| (QREFELT $ 85)))
                           (EXIT
                            (COND
                             ((QEQCAR |v| 0)
                              (SEQ (LETT |w| (QCDR |v|))
         ...
         (SEQ
          ...
          (EXIT
           (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                 ('T
                  (SEQ (LETT |d| (SPADCALL |f| (QREFELT $ 93)))
                       (EXIT
                        (CONS 0
                              (PROGN
                               (LETT #2# NIL)
         ...
         ((|l1| #1=(|SingleInteger|)) (|u1| #1#) (|ll| (|OrderedCompletion| F))
          ...
          (|l|
           #2=(|Union| (|OrderedCompletion| F)
                       ...
                       "failed"))
          (|u| #2#) (#4=#:G566 NIL) (|i| (|Union| F (|List| F))))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ...
             (#6='T
              (SEQ (LETT |i| (SPADCALL |g| |v| (QREFELT $ 100)))
                   (EXIT
                    (COND
                     ((QEQCAR |i| 1)
                      (PROGN (LETT #4# (CONS 1 #5#)) (GO #7=#:G564))))))))
            (LETT |u|
                  (SPADCALL (QCDR |i|)
                 ...
                 (COND
                  ((QEQCAR |l| 0)
                   (SEQ (LETT |uu| (QCDR |u|)) (LETT |ll| (QCDR |l|))
                        (LETT |u1| (SPADCALL |uu| (QREFELT $ 112)))
                        (LETT |l1| (SPADCALL |ll| (QREFELT $ 112)))
                        (COND
                         ((|eql_SI| |u1| 0)
                          (COND
                           ((|eql_SI| |l1| 0)
...
(SDEFUN |LAPLACE;lapkernel|
        ...
        (SPROG
         ...
         (SEQ (LETT |k| (SPADCALL |f| (QREFELT $ 117)))
              (EXIT
               (COND
                ((OR (QEQCAR |k| 1)
                     (NULL (LETT |arg| (SPADCALL (QCDR |k|) (QREFELT $ 68)))))
                 (CONS 1 "failed"))
                  ...
                  (#1='T
                   (SEQ
                    ...
                    (EXIT
                     (CONS 0
                           (SPADCALL
                            (SPADCALL (SPADCALL |f| |t| (QREFELT $ 127)) |t|
                                      |s| (QREFELT $ 17))
                            |ss| (QREFELT $ 41))))))))
                ('T
                 (COND
                                ...
                                (SPADCALL
                                 (SPADCALL
                                  (SPADCALL (|spadConstant| $ 64)
                                            (QREFELT $ 133))
                                  (SPADCALL |a| (QREFELT $ 131))
                                  (QREFELT $ 115))
                                 (SPADCALL |ss| (QREFELT $ 131))
                                 (QREFELT $ 115))
                                |ss| (QREFELT $ 41))))))))
                    (EXIT (CONS 1 "failed"))))))))))) 
        ...
        (SPROG
         ((|x| (|Union| F "failed")) (|res1| (F))
          ...
          (|v|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    "failed"))
          (|rec| (|Record| (|:| |const| F) (|:| |nconst| F))) (#1=#:G598 NIL)
          (#2=#:G597 (F)) (#3=#:G599 (F)) (#4=#:G621 NIL) (|g| (F))
...
(DEFUN |LaplaceTransform| (&REST #1=#:G626)
  (SPROG NIL
         (PROG (#2=#:G627)
           (RETURN
            (COND
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 142
                                            '(2 11 0 9 10 12 2 14 7 7 9 15 1 7
                                              ...
                                              0 52 2 10 30 0 0 53 2 46 7 0 10
                                              54 2 7 30 0 9 55 1 7 57 0 58 2 59
                                              30 0 0 60 1 24 61 0 62 0 6 0 63 0
                                              7 0 64 1 7 65 0 66 2 24 30 0 9 67
                                              1 24 32 0 68 2 32 7 0 59 69 1 7 0
                                              59 70 2 7 30 0 0 71 1 7 0 44 72 1
                                              7 73 0 74 2 73 30 9 0 75 1 20 0 0
                                              76 2 20 24 0 59 77 2 7 30 0 9 78
                                              1 7 44 0 79 0 7 0 80 2 7 0 0 0 81
                                              1 7 30 0 82 1 7 84 0 85 2 59 30 0
                                              0 86 2 7 0 0 59 87 2 7 0 59 0 88
                                              1 7 89 0 90 1 91 65 0 92 1 7 89 0
                                              93 2 7 0 89 89 94 2 91 95 0 0 96
                                              2 7 30 0 11 97 2 99 98 7 9 100 1
                                              101 0 7 102 0 101 0 103 2 104 0
                                              101 101 105 2 109 108 7 104 110 1
                                              101 111 0 112 0 6 0 113 1 101 7 0
                                              114 2 7 0 0 0 115 1 7 116 0 117 2
                                              11 30 0 9 118 3 7 0 0 0 0 119 1
                                              11 9 0 120 2 7 30 0 0 121 2 122 0
                                              7 7 123 2 7 0 0 124 125 1 7 0 0
                                              126 2 7 0 0 9 127 1 7 0 0 128 2 7
                                              0 0 129 130 1 7 0 0 131 2 7 0 129
                                              0 132 1 7 0 0 133 1 7 0 0 134 0 9
                                              0 135 2 137 136 7 9 138 3 7 0 0 9
                                              10 139 0 7 0 140 3 11 0 0 9 141
                                              142 3 0 7 7 9 9 17)))))
           '|lookupComplete|)) 
