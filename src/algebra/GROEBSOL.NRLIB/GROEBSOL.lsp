         ...
         ((|g| (|DistributedMultivariatePolynomial| |lv| F))
          (|linp|
           (|SparseUnivariatePolynomial|
            (|DistributedMultivariatePolynomial| |lv| F)))
          (|lc| (|DistributedMultivariatePolynomial| |lv| F)) (#2=#:G401 NIL)
          ...
          (#3=#:G403 NIL) (|df| (|NonNegativeInteger|)))
...
(SDEFUN |GROEBSOL;genPos|
        ...
        (SPROG
         ((#1=#:G408 NIL) (|testfail| (|Boolean|))
          ...
          (#3=#:G441 NIL) (|p| NIL) (#4=#:G440 NIL)
          (|val| #5=(|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#6=#:G427 NIL) (#7=#:G426 #5#) (#8=#:G428 #5#) (#9=#:G438 NIL)
          (|vv| NIL) (#10=#:G439 NIL) (|rv| NIL)
          (|ranvals| (|List| (|Integer|))) (#11=#:G437 NIL) (#12=#:G436 NIL)
          (|count| NIL) (|rlvar| (|List| (|OrderedVariableList| |lv|)))
          (|x| (|OrderedVariableList| |lv|))
          (|lnp|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#13=#:G435 NIL) (|f| NIL) (#14=#:G434 NIL))
         ...
         ($
          . #1=(|List|
                (|List|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))))
        (SPROG
         ((#2=#:G447 NIL) (#3=#:G446 #1#) (#4=#:G448 #1#) (#5=#:G453 NIL)
          (|lsel| NIL) (#6=#:G452 NIL) (#7=#:G451 NIL) (|f| NIL))
         (SEQ
          (COND
...
(SDEFUN |GROEBSOL;findCompon|
        ...
        (SPROG
         ((#1=#:G478 NIL) (|ll| NIL) (#2=#:G477 NIL)
          (|ans|
           (|List| #3=(|List| (|DistributedMultivariatePolynomial| |lv| F))))
          (#4=#:G476 NIL) (|p| NIL) (#5=#:G475 NIL) (#6=#:G474 NIL) (|lp| NIL)
          (#7=#:G473 NIL)
          (|val| #8=(|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#9=#:G459 NIL) (#10=#:G458 #8#) (#11=#:G460 #8#) (#12=#:G471 NIL)
          (|vv| NIL) (#13=#:G472 NIL) (|rv| NIL)
          ...
          (|tlfact|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#14=#:G470 NIL) (|tfact| NIL)
          (|lfact|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#15=#:G469 NIL) (|ff| NIL) (#16=#:G468 NIL)
          (|fg|
           (|Factored|
            (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
...
(SDEFUN |GROEBSOL;zeroDim?|
        ...
        (SPROG
         ((|lvint1| #1#) (|x| (|OrderedVariableList| |lv|)) (#2=#:G481 NIL)
          (|g| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#3=#:G489 NIL) (|f| NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
          (COND ((NULL |lp|) NIL)
                (#4='T
        ...
        (SPROG
         ((|result|
          ...
          (|lfact|
           (|List|
            (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))))
          (#3=#:G510 NIL) (|ff| NIL) (#4=#:G509 NIL) (#5=#:G508 NIL)
          (|llf| NIL) (#6=#:G507 NIL) (#7=#:G503 NIL)
          (|llfact|
           (|List|
            (|Factored|
             (|HomogeneousDistributedMultivariatePolynomial| |lv| F))))
                      ...
                      (EXIT
                       (COND
                        ((EQL (SPADCALL |g| |x| (QREFELT $ 84))
                              (LENGTH |basis|))
                         (PROGN (LETT #7# |$NoValue|) (GO #11=#:G495))))))
...
(DEFUN |GroebnerSolve| (&REST #1=#:G523)
  (SPROG NIL
         (PROG (#2=#:G524)
           (RETURN
            (COND
